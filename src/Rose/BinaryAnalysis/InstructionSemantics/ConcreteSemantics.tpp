#ifndef ROSE_BinaryAnalysis_InstructionSemantics_ConcreteSemantics_TPP
#define ROSE_BinaryAnalysis_InstructionSemantics_ConcreteSemantics_TPP
...
RiscOperators::fpBinaryOp(const BaseSemantics::SValuePtr &lhs,
    ...
    ASSERT_require2(lhs->isConcrete(), "concrete values only");
    ASSERT_require2(rhs->isConcrete(), "concrete values only");
