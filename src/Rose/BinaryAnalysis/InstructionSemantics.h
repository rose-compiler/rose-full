#ifndef ROSE_BinaryAnalysis_InstructionSemantics_H
#define ROSE_BinaryAnalysis_InstructionSemantics_H
 ...
 *      // defined in BinarySemantics::InstructionSemantics::BaseSemantics--lets
