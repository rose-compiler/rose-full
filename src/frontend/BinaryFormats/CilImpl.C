...
namespace // anonymous namespace for auxiliary functions
{
  ...
  auto
  readExpected(Reader rd, const std::vector<uint8_t>& buf, size_t& index, decltype(rd(buf, index)) expected, const char* msg) -> decltype(rd(buf, index))
  {
  ...
  uint8_t read8bitPadding(const std::vector<uint8_t>& buf, size_t& index, uint8_t expected, const char* msg)
  {
    return readExpected(read8bitValue, buf, index, expected, msg);
  }
              ...
              )
  {
    ...
    for (size_t i = 0; i < numberOfStreams; ++i)
    {
      ...
      {
        dataStream = new SgAsmCilErrorHeap(streamHeader.offset(), streamHeader.size(), streamHeader.name(), streamHeader.namePadding());
...
void SgAsmCilAssemblyOS::parse(const std::vector<uint8_t>& buf, size_t& index, uint64_t)
{
...
void SgAsmCilAssemblyProcessor::parse(const std::vector<uint8_t>& buf, size_t& index, uint64_t)
{
...
void SgAsmCilConstant::parse(const std::vector<uint8_t>& buf, size_t& index, uint64_t uses4byteIndexing)
{
  ...
  p_Padding = read8bitPadding(buf,index,0,"[constant:padding]");
...
const std::uint8_t*
SgAsmCilParam::get_Name_string() const
{
  return getMetadataRoot(this).get_StringHeap()->get_Stream().data() + get_Name();
}
...
{
const char*
asString ( SgAsmCilMetadataHeap::TableKind e )
{
...
const char*
asString ( SgAsmCilMetadataHeap::ReferenceKind e )
{
  const char* res = nullptr;

  switch (e)
  {
    case SgAsmCilMetadataHeap::e_ref_string_heap: res = "e_ref_string_heap"; break;
    case SgAsmCilMetadataHeap::e_ref_guid_heap: res = "e_ref_guid_heap"; break;
    case SgAsmCilMetadataHeap::e_ref_blob_heap: res = "e_ref_blob_heap"; break;
    case SgAsmCilMetadataHeap::e_ref_assembly_ref: res = "e_ref_assembly_ref"; break;
    case SgAsmCilMetadataHeap::e_ref_type_def: res = "e_ref_type_def"; break;
    case SgAsmCilMetadataHeap::e_ref_event: res = "e_ref_event"; break;
    case SgAsmCilMetadataHeap::e_ref_field: res = "e_ref_field"; break;
    case SgAsmCilMetadataHeap::e_ref_generic_param: res = "e_ref_generic_param"; break;
    case SgAsmCilMetadataHeap::e_ref_module_ref: res = "e_ref_module_ref"; break;
    case SgAsmCilMetadataHeap::e_ref_method_def: res = "e_ref_method_def"; break;
    case SgAsmCilMetadataHeap::e_ref_param: res = "e_ref_param"; break;
    case SgAsmCilMetadataHeap::e_ref_property: res = "e_ref_property"; break;
    case SgAsmCilMetadataHeap::e_ref_has_constant: res = "e_ref_has_constant"; break;
    case SgAsmCilMetadataHeap::e_ref_has_custom_attribute: res = "e_ref_has_custom_attribute"; break;
    case SgAsmCilMetadataHeap::e_ref_has_decl_security: res = "e_ref_has_decl_security"; break;
    case SgAsmCilMetadataHeap::e_ref_has_field_marshall: res = "e_ref_has_field_marshall"; break;
    case SgAsmCilMetadataHeap::e_ref_has_semantics: res = "e_ref_has_semantics"; break;
    case SgAsmCilMetadataHeap::e_ref_method_def_or_ref: res = "e_ref_method_def_or_ref"; break;
    case SgAsmCilMetadataHeap::e_ref_type_def_or_ref: res = "e_ref_type_def_or_ref"; break;
    case SgAsmCilMetadataHeap::e_ref_implementation: res = "e_ref_implementation"; break;
    case SgAsmCilMetadataHeap::e_ref_member_forwarded: res = "e_ref_member_forwarded"; break;
    case SgAsmCilMetadataHeap::e_ref_member_ref_parent: res = "e_ref_member_ref_parent"; break;
    case SgAsmCilMetadataHeap::e_ref_type_or_method_def: res = "e_ref_type_or_method_def"; break;
    case SgAsmCilMetadataHeap::e_ref_custom_attribute_type: res = "e_ref_custom_attribute_type"; break;
    case SgAsmCilMetadataHeap::e_ref_resolution_scope: res = "e_ref_resolution_scope"; break;
                 ...
                 )
{
  ...
  if (tables.size() == 1)
    return AccessTuple{ tables.front(), refcode };
    ...
    switch (kind)
    {
      ...
      default:
        mlog[ERROR]
              ...
              << "\nAborting CIL metadata processing ..."
              << std::endl;

        SgAsmCilMetadataRoot* root = isSgAsmCilMetadataRoot(this->get_parent());
        ASSERT_not_null(root);

        root->set_ErrorFree(false);
        return;
    }
  }
}
...
template <class T>
std::ostream& operator<<(std::ostream& os, RangePrinter<T> rp)
{
  os << "{ ";
  for (auto i: rp.r)
    os << std::to_string(i) << ' ';
...
using MethodHeaderBase = std::tuple<std::uint16_t, std::uint16_t, std::uint32_t, std::uint32_t>;

struct MethodHeader : MethodHeaderBase
{
              ...
              )
{
  ...
  const std::uint32_t  codeSize = Rose::BinaryAnalysis::ByteOrder::leToHost(*reinterpret_cast<uint32_t*>(buf+4));
  const std::uint32_t  localIni = Rose::BinaryAnalysis::ByteOrder::leToHost(*reinterpret_cast<uint32_t*>(buf+8));
...
using LastInstructionValidator = std::function<void(const std::vector<SgAsmStatement*>&)>;

void noValidationOfLastInstruction(const std::vector<SgAsmStatement*>&) {}

void validationLastCilInstruction(const std::vector<SgAsmStatement*>& lst)
{
  SgAsmInstruction* instr = isSgAsmInstruction(lst.back());
...
disassemble( rb::Address base_va,
             SgAsmCilMethodDef::BodyState bdyState,
             std::vector<std::uint8_t>& buf,
             rb::Architecture::BasePtr arch,
             LastInstructionValidator validateLastInstr = noValidationOfLastInstruction
           )
{
  ...
  SgAsmBlock* const             blk = sb::buildBasicBlock(std::vector<SgAsmInstruction*>{});
  ASSERT_not_null(blk);

  SgAsmStatementPtrList&        lst = blk->get_statementList();
  auto                          disasm = arch->newInstructionDecoder();

  MemoryMap::Ptr map = MemoryMap::instance();
  map->insert(rb::AddressInterval::baseSize(base_va, sz),
              MemoryMap::Segment::staticInstance(buf.data(), sz,
                                                 MemoryMap::READABLE|MemoryMap::EXECUTABLE, "Code segment"));

  while (addr < sz)
  {
    SgAsmInstruction* insn = disasm->disassembleOne(map, base_va + addr);
    ASSERT_not_null(insn);

    //~ mlog[WARN]
      //~ << std::setw(6) << std::setfill('0') << std::hex << addr << std::dec
      //~ << " " << insn->get_mnemonic()
      //~ << std::endl;
    ...
    if (disasm->architecture()->isUnknown(insn))
    {
      ...
      while (addr < sz)
      {
        SgAsmCilInstruction* insn2 = new SgAsmCilInstruction(base_va+addr, *disasm->architecture()->registrationId(),
                                                            Rose::BinaryAnalysis::CilInstructionKind::Cil_nop);
        insn2->set_rawBytes(rawBytes);
        ASSERT_require(insn2->get_rawBytes().size() == 1);
        lst.push_back(insn2);
        addr += insn2->get_size();
      }
    }
  ...
  if (addr > sz)
  {
    mlog[ERROR]
        ...
        << "\n   // |addr| " << sizeof(addr) << "  codelen=" << buf.size()
        << std::endl;
...
//   https://github.com/stakx/ecma-335/blob/master/docs/ii.23.1.11-flags-for-methods-methodimplattributes.md
// \{
...
inline
CodeTypeMask operator&(int lhs, CodeTypeMask rhs)
{
  return static_cast<CodeTypeMask>(lhs & int(rhs));
}

inline
CodeTypeMask operator&(CodeTypeMask lhs, int rhs)
{
  return static_cast<CodeTypeMask>(int(lhs) & rhs);
}

inline
CodeTypeMask operator&(CodeTypeMask lhs, CodeTypeMask rhs)
{
  return static_cast<CodeTypeMask>(int(lhs) & int(rhs));
}


enum struct ManagedMask
{
  unmanaged      = 0x0004,
  managed        = 0x0000,
  mask           = unmanaged | managed,
};

enum struct ImplementationInfo
{
  forwardRef        = 0x0010,
  preserveSig       = 0x0080,
  internalCall      = 0x1000,
             ...
             )
{
  ...
  res->set_standardConforming(compliant);
  res->set_flags(f);
  ...
  return { res,
           compliant ? SgAsmCilMethodDef::BDY_NOT_PROCESSED
                     : SgAsmCilMethodDef::BDY_INVALID_CLAUSE_LENGTH
         };
}

SgAsmCilMethodData*
methodData(std::uint32_t rawHeader, std::vector<SgAsmCilExceptionData*> clauses)
{
  SgAsmCilMethodData* res = new SgAsmCilMethodData;

  res->get_Clauses().swap(clauses);
  res->set_rawHeader(rawHeader);

  // set parent pointers
  for (SgAsmCilExceptionData* clause : clauses)
    clause->set_parent(res);

  return res;
}

std::tuple<SgAsmCilExceptionData*, SgAsmCilMethodDef::BodyState>
parseFatEHClause(SgAsmPEFileHeader& fhdr, Rose::BinaryAnalysis::Address sectionRva, std::uint8_t bytesToParse)
{
  ...
  std::size_t  nread = fhdr.get_loaderMap()->readQuick(buf, sectionRva, bytesToParse);

  return exceptionData( nread == SECLEN,
                        leToHost(*reinterpret_cast<const std::uint32_t*>(buf + 0)),
                        leToHost(*reinterpret_cast<const std::uint32_t*>(buf + 4)),
                        leToHost(*reinterpret_cast<const std::uint32_t*>(buf + 8)),
                        leToHost(*reinterpret_cast<const std::uint32_t*>(buf + 12)),
                        leToHost(*reinterpret_cast<const std::uint32_t*>(buf + 16)),
                        leToHost(*reinterpret_cast<const std::uint32_t*>(buf + 20))
                      );
}

std::tuple<SgAsmCilExceptionData*, SgAsmCilMethodDef::BodyState>
parseTinyEHClause(SgAsmPEFileHeader& fhdr, Rose::BinaryAnalysis::Address sectionRva, std::uint8_t bytesToParse)
{
  using Rose::BinaryAnalysis::ByteOrder::leToHost;
  ...
  return exceptionData( nread == SECLEN,
                        leToHost(*reinterpret_cast<const std::uint16_t*>(buf + 0)),
...
using ParseClauseFn = std::function<ParseClauseReturn(SgAsmPEFileHeader&, Rose::BinaryAnalysis::Address, std::uint8_t)>;
...
parseEHClauses(SgAsmPEFileHeader& fhdr, Rose::BinaryAnalysis::Address sectionRva, std::size_t len, std::size_t elemLen,
               ParseClauseFn parseClause, const char* headerKind)
{
  std::vector<SgAsmCilExceptionData*> res;
  bool const                          lenHasExpectedValue = (len % elemLen) == 0;

  // Some compilers seem to set invalid section lengths
  // (most likely they forget to add 4 bytes for the header).
  // Instead of giving up, we continue processing such files by:
  //     just reading len bytes and set the remaining data to 0.
  // other options include:
  //     (1) assuming that the compiler should have added 4 to len, or
  //     (2) not processing the last exception handler [inconsistent with other tools].
  if (!lenHasExpectedValue)
  {
    mlog[WARN] << "parseEHClauses: invalid segment length "
                << len << " % " << elemLen << "[" << headerKind << "] != 0."
                << "\n  will use 0 padding for missing data in SgAsmCilExceptionData."
                << std::endl;
  }

  SgAsmCilMethodDef::BodyState bodyState = SgAsmCilMethodDef::BDY_NOT_PROCESSED;

  for (std::size_t ofs = 0; ofs < len; ofs+=elemLen)
  {
    SgAsmCilExceptionData* clause = nullptr;

    // in the last loop iteration, do not read more than len bytes
    //   when processing non-standard exception handler clauses.
    if (ofs + elemLen > len)
      elemLen = len-ofs;

    std::tie(clause, bodyState) = parseClause(fhdr, sectionRva+ofs, elemLen);
...
{
  static constexpr std::uint8_t FAT_FLAG = SgAsmCilMethodData::CorILMethod_Sect_FatFormat;
  if ((sectionRva % 4) != 0)
    return { nullptr, 0, SgAsmCilMethodDef::BDY_INVALID_SECTION_ALIGN };

  std::vector<std::uint8_t> rawHeaderBytes(4, 0);
  std::size_t    nread1   = fhdr.get_loaderMap()->readQuick(&rawHeaderBytes.at(0), sectionRva, 1);
  if (nread1 != 1)
  {
    mlog[ERROR] << "parseSection: expected 1 byte "
  ...
  // buffer for 3 bytes
  std::uint8_t   kind     = rawHeaderBytes.at(0);
  bool const     fat      = (kind & FAT_FLAG) == FAT_FLAG;
  std::size_t    nread3   = fhdr.get_loaderMap()->readQuick(&rawHeaderBytes.at(1), sectionRva+1, 3);
  if (nread3 != 3)
  {
    mlog[ERROR] << "parseSection: expected 3 bytes "
  ...
  std::uint32_t  buf0 = rawHeaderBytes.at(1);
  std::uint32_t  buf1 = rawHeaderBytes.at(2);
  std::uint32_t  buf2 = rawHeaderBytes.at(3);
  bool const     headerIsInvalid = (!fat && ((buf1 != 0) || (buf2 != 0)));

  if (headerIsInvalid)
  {
    mlog[INFO]
        << "tiny section header require uv xy 00 00 byte sequence, instead got:"
        << std::hex
        << " " << std::setw(2) << std::setfill('0') << std::uint32_t(kind)
        << " " << std::setw(2) << std::setfill('0') << buf0
        << " " << std::setw(2) << std::setfill('0') << buf1
        << " " << std::setw(2) << std::setfill('0') << buf2
        << std::dec
                            << std::endl;

    // set the buf1/2 = 0, so length can be computed correctly
    // (other tools also process non-standard binaries)
    buf1 = buf2 = 0;
  }

  std::uint32_t const                 dataSize = buf0 + (buf1 << 8) + (buf2 << 16);
  std::uint32_t const                 rawHeader = kind + (dataSize << 8);

  std::vector<SgAsmCilExceptionData*> clauses;
  SgAsmCilMethodDef::BodyState        bodyState;

  // \todo SUPPORT_NON_STANDARD_DATASIZE
  //       tolerate non-standard data sizes.
  //       according to ii.25.4.5,
  //          dataSize = (n * sizeof(fat|tiny)) + 4, where n is number of exception clauses
  //       some compiler use a datasize that is 4 bytes short.
  //       see note SUPPORT_NON_STANDARD_DATASIZE in parseEHClauses for resolution strategies.
  std::tie(clauses, bodyState) = fat ? parseEHClauses(fhdr, sectionRva+4, dataSize-4, 24, parseFatEHClause, "FAT")
                                     : parseEHClauses(fhdr, sectionRva+4, dataSize-4, 12, parseTinyEHClause, "tiny");

  return { methodData(rawHeader, std::move(clauses)), sectionRva + dataSize, bodyState };
}
                    ...
                    size_t /*dbg_bufbeg*/, size_t /*dbg_buflim*/)
{
  ...
  for (SgAsmCilMethodDef* m : mtbl->get_elements())
  {
    ...
    ++methodCtr;
    rb::Address rva = static_cast<std::uint32_t>(m->get_RVA());

    //~ mlog[TRACE]
              //~ << "processing #" << methodCtr << " " << m->get_Name_string() << " @" << std::hex << rva << std::dec
              //~ << std::endl;
    ...
    if ((m->get_ImplFlags() & CodeTypeMask::mask) == CodeTypeMask::native)
    {
      m->set_bodyState(SgAsmCilMethodDef::BDY_NOT_AVAILABLE);
      continue;
    }

    if ((m->get_ImplFlags() & CodeTypeMask::mask) == CodeTypeMask::runtime)
    {
      mlog[ERROR] << "Code is runtime provided. Please share specimen with ROSE developers."
                  << "\n  #" << methodCtr << " " << m->get_Name_string() << " @" << std::hex << rva << std::dec
                  << std::endl;
      m->set_bodyState(SgAsmCilMethodDef::BDY_RUNTIME_SUPPORTED);
      continue;
    }

    if ((m->get_ImplFlags() & CodeTypeMask::mask) == CodeTypeMask::optil_reserved)
    {
      mlog[ERROR] << "OPTIL code is not supported."
                  << "\n  #" << methodCtr << " " << m->get_Name_string() << " @" << std::hex << rva << std::dec
                  << std::endl;
      m->set_bodyState(SgAsmCilMethodDef::BDY_RUNTIME_SUPPORTED);
      continue;
    ...
    {
      mlog[ERROR]
            << "unable to parse method #" << methodCtr << " " << m->get_Name_string() << " @" << std::hex << rva << std::dec
    ...
    std::uint32_t const           codeLen = mh.codeSize();

    if (codeLen == 0)
    {
      mlog[ERROR]
              << "0-length body #" << methodCtr << " " << m->get_Name_string() << " @" << std::hex << rva << std::dec
              << std::endl;
      continue;
    }
    ...
    {
      mlog[ERROR]
              << "unable to read body of method #" << methodCtr << " " << m->get_Name_string() << " @" << std::hex << rva << std::dec
    ...
    std::tie(blk,bodyState) = disassemble(base_va + codeRVA, bodyState, code, arch, validationLastCilInstruction);

    m->set_body(blk);
    if (blk) blk->set_parent(m);

    if (bodyState != SgAsmCilMethodDef::BDY_NOT_PROCESSED)
    {
      mlog[ERROR] << "Body processing incomplete #" << methodCtr << " " << m->get_Name_string() << " @" << std::hex << rva << std::dec
                  << std::endl;
    ...
    Rose::BinaryAnalysis::Address secRva     = codeRVA + codeLen;
    Rose::BinaryAnalysis::Address sectionRva = base_va + secRva;
    ...
    while (hasMoreSections)
    {
      ...
      //~ mlog[WARN]
        //~ << "parse: " << m->get_Name_string()
        //~ << " +s@ 0x" << std::setw(8) << std::setfill('0') << std::hex << (alignedSectionRva-base_va) << std::dec
        //~ << " m@ 0x" << std::setw(8) << std::setfill('0') << std::hex << rva << std::dec
        //~ << " base_va=" << std::setfill('0') << std::hex << base_va << std::dec
        //~ << std::endl;
    ...
    if (bodyState != SgAsmCilMethodDef::BDY_FULLY_DECODED)
      root->set_ErrorFree(false);
  }
}
...
void SgAsmCilErrorHeap::dump(std::ostream& os) const
{
  os << "Cil Error Heap Object" << std::endl
     << "  Name = " << get_Name() << std::endl
     << "  Offset = " << get_Offset() << std::endl
     << "  Size = " << get_Size() << std::endl
     << "  NamePadding = " << get_NamePadding() << std::endl;
}

// unknown streams do neither parse nor unparse
void SgAsmCilErrorHeap::unparse(std::vector<unsigned char, std::allocator<unsigned char> >&, unsigned long) const {}
void SgAsmCilErrorHeap::parse(std::vector<unsigned char, std::allocator<unsigned char> > const&, unsigned long) {}
...
namespace Cil
{
  void initDiagnostics()
  {
    ...
    if (!initialized) {
        initialized = true;
        Rose::Diagnostics::initAndRegister(&mlog, "Rose::BinaryAnalysis::Cil");
        mlog.comment("operating on CIL binaries");
    }
  }
}
}
