...
/// \throws a runtime error if a node is passed for which no direct name mangling exists.
///         examples include: SgFunctionParameterList, SgVariableDeclaration
/// \details
...
/// \note INVALIDATES all returned string references.
