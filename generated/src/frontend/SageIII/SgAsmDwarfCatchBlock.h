...
#ifndef ROSE_SgAsmDwarfCatchBlock_H
#define ROSE_SgAsmDwarfCatchBlock_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmDwarfCatchBlock

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfCatchBlock.h" */
...
// Class Definition for SgAsmDwarfCatchBlock
class ROSE_DLL_API SgAsmDwarfCatchBlock  : public SgAsmDwarfConstruct
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfCatchBlock.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 28688 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmDwarfCatchBlock;
          enum { static_variant = V_SgAsmDwarfCatchBlock };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmDwarfCatchBlock* isSgAsmDwarfCatchBlock(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmDwarfCatchBlock* isSgAsmDwarfCatchBlock( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmDwarfCatchBlock * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmDwarfCatchBlockStorageClass *); // 
          ...
          /// \private
          static SgAsmDwarfCatchBlock * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmDwarfCatchBlock * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmDwarfCatchBlock::operator delete (pointer,sizeof(SgAsmDwarfCatchBlock));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmDwarfCatchBlock* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmDwarfCatchBlock* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmDwarfCatchBlock* sgnode);
     ...
     public:
       ...
       */
       // SgAsmDwarfCatchBlock( SgAsmDwarfCatchBlockStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmDwarfCatchBlockStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmDwarfCatchBlock( const SgAsmDwarfCatchBlockStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmDwarfCatchBlock* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmDwarfCatchBlock* isSgAsmDwarfCatchBlock ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmDwarfCatchBlock>;
...
// postdeclarations for SgAsmDwarfCatchBlock

/* #line 502 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfCatchBlock.h" */
...
/* #line 509 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfCatchBlock.h" */

#endif // ROSE_SgAsmDwarfCatchBlock_H
