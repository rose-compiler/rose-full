...
#ifndef ROSE_SgAsmBinaryLsr_H
#define ROSE_SgAsmBinaryLsr_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmBinaryLsr

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmBinaryLsr.h" */
...
// Class Definition for SgAsmBinaryLsr
class ROSE_DLL_API SgAsmBinaryLsr  : public SgAsmBinaryExpression
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmBinaryLsr.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 42965 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmBinaryLsr* isSgAsmBinaryLsr(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmBinaryLsr* isSgAsmBinaryLsr( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmBinaryLsr * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmBinaryLsrStorageClass *); // 
          ...
          /// \private
          static SgAsmBinaryLsr * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmBinaryLsr * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmBinaryLsr::operator delete (pointer,sizeof(SgAsmBinaryLsr));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmBinaryLsr* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmBinaryLsr* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmBinaryLsr* sgnode);
     ...
     public:
       ...
       */
       // SgAsmBinaryLsr( SgAsmBinaryLsrStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmBinaryLsrStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmBinaryLsr( const SgAsmBinaryLsrStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmBinaryLsr* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmBinaryLsr* isSgAsmBinaryLsr ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmBinaryLsr>;
...
// postdeclarations for SgAsmBinaryLsr

/* #line 501 "/workspace/generated/src/frontend/SageIII//SgAsmBinaryLsr.h" */
...
/* #line 508 "/workspace/generated/src/frontend/SageIII//SgAsmBinaryLsr.h" */

#endif // ROSE_SgAsmBinaryLsr_H
