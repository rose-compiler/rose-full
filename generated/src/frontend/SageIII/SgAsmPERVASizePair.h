...
#ifndef ROSE_SgAsmPERVASizePair_H
#define ROSE_SgAsmPERVASizePair_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmPERVASizePair

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmPERVASizePair.h" */
/* #line 2578 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// Class Definition for SgAsmPERVASizePair
class ROSE_DLL_API SgAsmPERVASizePair  : public SgAsmExecutableFileFormat
   {
     public:


/* #line 43 "/workspace/generated/src/frontend/SageIII//SgAsmPERVASizePair.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 2607 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmPERVASizePair;
          enum { static_variant = V_SgAsmPERVASizePair };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmPERVASizePair* isSgAsmPERVASizePair(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmPERVASizePair* isSgAsmPERVASizePair( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmPERVASizePair * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmPERVASizePairStorageClass *); // 
          ...
          /// \private
          static SgAsmPERVASizePair * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmPERVASizePair * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmPERVASizePair::operator delete (pointer,sizeof(SgAsmPERVASizePair));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmPERVASizePair* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmPERVASizePair* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmPERVASizePair* sgnode);
     ...
     public:
       ...
       */
       // SgAsmPERVASizePair( SgAsmPERVASizePairStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmPERVASizePairStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmPERVASizePair( const SgAsmPERVASizePairStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmPERVASizePair* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmPERVASizePair* isSgAsmPERVASizePair ( SgNode* s );
...
// End of memberFunctionString
    ...
    protected:
// Start of memberFunctionString
Rose::BinaryAnalysis::RelativeVirtualAddress p_e_rva;
          
// End of memberFunctionString
// Start of memberFunctionString
Rose::BinaryAnalysis::Address p_e_size;
          
// End of memberFunctionString
// Start of memberFunctionString
SgAsmGenericSection* p_section;
          
// End of memberFunctionString

    friend struct Rose::Traits::generated::describe_node_t<SgAsmPERVASizePair>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmPERVASizePair, Rose::BinaryAnalysis::RelativeVirtualAddress,&SgAsmPERVASizePair::p_e_rva>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmPERVASizePair, Rose::BinaryAnalysis::Address,&SgAsmPERVASizePair::p_e_size>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmPERVASizePair, SgAsmGenericSection*,&SgAsmPERVASizePair::p_section>;
...
// postdeclarations for SgAsmPERVASizePair

/* #line 594 "/workspace/generated/src/frontend/SageIII//SgAsmPERVASizePair.h" */
...
/* #line 601 "/workspace/generated/src/frontend/SageIII//SgAsmPERVASizePair.h" */

#endif // ROSE_SgAsmPERVASizePair_H
