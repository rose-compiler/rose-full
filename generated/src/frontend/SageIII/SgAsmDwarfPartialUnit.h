...
#ifndef ROSE_SgAsmDwarfPartialUnit_H
#define ROSE_SgAsmDwarfPartialUnit_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmDwarfPartialUnit

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfPartialUnit.h" */
...
// Class Definition for SgAsmDwarfPartialUnit
class ROSE_DLL_API SgAsmDwarfPartialUnit  : public SgAsmDwarfConstruct
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfPartialUnit.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 25982 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmDwarfPartialUnit;
          enum { static_variant = V_SgAsmDwarfPartialUnit };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmDwarfPartialUnit* isSgAsmDwarfPartialUnit(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmDwarfPartialUnit* isSgAsmDwarfPartialUnit( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmDwarfPartialUnit * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmDwarfPartialUnitStorageClass *); // 
          ...
          /// \private
          static SgAsmDwarfPartialUnit * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmDwarfPartialUnit * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmDwarfPartialUnit::operator delete (pointer,sizeof(SgAsmDwarfPartialUnit));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmDwarfPartialUnit* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmDwarfPartialUnit* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmDwarfPartialUnit* sgnode);
     ...
     public:
       ...
       */
       // SgAsmDwarfPartialUnit( SgAsmDwarfPartialUnitStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmDwarfPartialUnitStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmDwarfPartialUnit( const SgAsmDwarfPartialUnitStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmDwarfPartialUnit* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmDwarfPartialUnit* isSgAsmDwarfPartialUnit ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmDwarfPartialUnit>;
...
// postdeclarations for SgAsmDwarfPartialUnit

/* #line 502 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfPartialUnit.h" */
...
/* #line 509 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfPartialUnit.h" */

#endif // ROSE_SgAsmDwarfPartialUnit_H
