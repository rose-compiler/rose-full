...
#ifndef ROSE_SgAsmElfSectionTable_H
#define ROSE_SgAsmElfSectionTable_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmElfSectionTable

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmElfSectionTable.h" */
/* #line 20968 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// Class Definition for SgAsmElfSectionTable
class ROSE_DLL_API SgAsmElfSectionTable  : public SgAsmGenericSection
   {
     public:


/* #line 42 "/workspace/generated/src/frontend/SageIII//SgAsmElfSectionTable.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 20982 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmElfSectionTable;
          enum { static_variant = V_SgAsmElfSectionTable };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmElfSectionTable* isSgAsmElfSectionTable(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmElfSectionTable* isSgAsmElfSectionTable( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmElfSectionTable * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmElfSectionTableStorageClass *); // 
          ...
          /// \private
          static SgAsmElfSectionTable * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmElfSectionTable * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmElfSectionTable::operator delete (pointer,sizeof(SgAsmElfSectionTable));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmElfSectionTable* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmElfSectionTable* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmElfSectionTable* sgnode);
     ...
     public:
       ...
       */
       // SgAsmElfSectionTable( SgAsmElfSectionTableStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmElfSectionTableStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmElfSectionTable( const SgAsmElfSectionTableStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmElfSectionTable* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmElfSectionTable* isSgAsmElfSectionTable ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmElfSectionTable>;
...
// postdeclarations for SgAsmElfSectionTable

/* #line 541 "/workspace/generated/src/frontend/SageIII//SgAsmElfSectionTable.h" */
...
/* #line 548 "/workspace/generated/src/frontend/SageIII//SgAsmElfSectionTable.h" */

#endif // ROSE_SgAsmElfSectionTable_H
