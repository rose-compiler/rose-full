...
#ifndef ROSE_SgAsmScalarType_H
#define ROSE_SgAsmScalarType_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmScalarType

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmScalarType.h" */
/* #line 17868 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// Class Definition for SgAsmScalarType
class ROSE_DLL_API SgAsmScalarType  : public SgAsmType
   {
     public:


/* #line 42 "/workspace/generated/src/frontend/SageIII//SgAsmScalarType.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 17902 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmScalarType;
          enum { static_variant = V_SgAsmScalarType };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmScalarType* isSgAsmScalarType(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmScalarType* isSgAsmScalarType( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmScalarType * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmScalarTypeStorageClass *); // 
          ...
          /// \private
          static SgAsmScalarType * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmScalarType * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmScalarType::operator delete (pointer,sizeof(SgAsmScalarType));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmScalarType* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmScalarType* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmScalarType* sgnode);
     ...
     public:
       ...
       */
       // SgAsmScalarType( SgAsmScalarTypeStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmScalarTypeStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmScalarType( const SgAsmScalarTypeStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmScalarType* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmScalarType* isSgAsmScalarType ( SgNode* s );

          typedef SgAsmType base_node_type;
...
// End of memberFunctionString
    ...
    protected:
// Start of memberFunctionString
Rose::BinaryAnalysis::ByteOrder::Endianness p_minorOrder;
          
// End of memberFunctionString
// Start of memberFunctionString
Rose::BinaryAnalysis::ByteOrder::Endianness p_majorOrder;
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmScalarType>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmScalarType, Rose::BinaryAnalysis::ByteOrder::Endianness,&SgAsmScalarType::p_minorOrder>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmScalarType, Rose::BinaryAnalysis::ByteOrder::Endianness,&SgAsmScalarType::p_majorOrder>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmScalarType, size_t,&SgAsmScalarType::p_majorNBytes>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmScalarType, size_t,&SgAsmScalarType::p_nBits>;
...
// postdeclarations for SgAsmScalarType

/* #line 570 "/workspace/generated/src/frontend/SageIII//SgAsmScalarType.h" */
...
/* #line 577 "/workspace/generated/src/frontend/SageIII//SgAsmScalarType.h" */

#endif // ROSE_SgAsmScalarType_H
