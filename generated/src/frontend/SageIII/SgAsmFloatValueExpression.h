...
#ifndef ROSE_SgAsmFloatValueExpression_H
#define ROSE_SgAsmFloatValueExpression_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmFloatValueExpression

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmFloatValueExpression.h" */
...
// Class Definition for SgAsmFloatValueExpression
class ROSE_DLL_API SgAsmFloatValueExpression  : public SgAsmConstantExpression
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmFloatValueExpression.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 17564 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmFloatValueExpression;
      ...
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmFloatValueExpression* isSgAsmFloatValueExpression(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmFloatValueExpression* isSgAsmFloatValueExpression( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmFloatValueExpression * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmFloatValueExpressionStorageClass *); // 
          ...
          /// \private
          static SgAsmFloatValueExpression * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmFloatValueExpression * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmFloatValueExpression::operator delete (pointer,sizeof(SgAsmFloatValueExpression));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmFloatValueExpression* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmFloatValueExpression* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmFloatValueExpression* sgnode);
     ...
     public:
       ...
       */
       // SgAsmFloatValueExpression( SgAsmFloatValueExpressionStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmFloatValueExpressionStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmFloatValueExpression( const SgAsmFloatValueExpressionStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmFloatValueExpression* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmFloatValueExpression* isSgAsmFloatValueExpression ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmFloatValueExpression>;
...
// postdeclarations for SgAsmFloatValueExpression

/* #line 549 "/workspace/generated/src/frontend/SageIII//SgAsmFloatValueExpression.h" */
...
/* #line 556 "/workspace/generated/src/frontend/SageIII//SgAsmFloatValueExpression.h" */

#endif // ROSE_SgAsmFloatValueExpression_H
