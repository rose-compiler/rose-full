...
#ifndef ROSE_SgAsmMemoryReferenceExpression_H
#define ROSE_SgAsmMemoryReferenceExpression_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmMemoryReferenceExpression

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmMemoryReferenceExpression.h" */
...
class ROSE_DLL_API SgAsmMemoryReferenceExpression  : public SgAsmExpression
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmMemoryReferenceExpression.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 7432 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmMemoryReferenceExpression* isSgAsmMemoryReferenceExpression(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmMemoryReferenceExpression* isSgAsmMemoryReferenceExpression( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmMemoryReferenceExpression * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmMemoryReferenceExpressionStorageClass *); // 
          ...
          /// \private
          static SgAsmMemoryReferenceExpression * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmMemoryReferenceExpression * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmMemoryReferenceExpression::operator delete (pointer,sizeof(SgAsmMemoryReferenceExpression));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmMemoryReferenceExpression* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmMemoryReferenceExpression* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmMemoryReferenceExpression* sgnode);
     ...
     public:
       ...
       */
       // SgAsmMemoryReferenceExpression( SgAsmMemoryReferenceExpressionStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmMemoryReferenceExpressionStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmMemoryReferenceExpression( const SgAsmMemoryReferenceExpressionStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmMemoryReferenceExpression* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmMemoryReferenceExpression* isSgAsmMemoryReferenceExpression ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmMemoryReferenceExpression>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmMemoryReferenceExpression, SgAsmExpression*,&SgAsmMemoryReferenceExpression::p_address>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmMemoryReferenceExpression, SgAsmExpression*,&SgAsmMemoryReferenceExpression::p_segment>;
...
// postdeclarations for SgAsmMemoryReferenceExpression

/* #line 539 "/workspace/generated/src/frontend/SageIII//SgAsmMemoryReferenceExpression.h" */
...
/* #line 546 "/workspace/generated/src/frontend/SageIII//SgAsmMemoryReferenceExpression.h" */

#endif // ROSE_SgAsmMemoryReferenceExpression_H
