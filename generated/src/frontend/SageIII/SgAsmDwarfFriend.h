...
#ifndef ROSE_SgAsmDwarfFriend_H
#define ROSE_SgAsmDwarfFriend_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmDwarfFriend

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfFriend.h" */
...
// Class Definition for SgAsmDwarfFriend
class ROSE_DLL_API SgAsmDwarfFriend  : public SgAsmDwarfConstruct
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfFriend.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 27383 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmDwarfFriend;
          enum { static_variant = V_SgAsmDwarfFriend };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmDwarfFriend* isSgAsmDwarfFriend(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmDwarfFriend* isSgAsmDwarfFriend( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmDwarfFriend * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmDwarfFriendStorageClass *); // 
          ...
          /// \private
          static SgAsmDwarfFriend * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmDwarfFriend * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmDwarfFriend::operator delete (pointer,sizeof(SgAsmDwarfFriend));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmDwarfFriend* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmDwarfFriend* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmDwarfFriend* sgnode);
     ...
     public:
       ...
       */
       // SgAsmDwarfFriend( SgAsmDwarfFriendStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmDwarfFriendStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmDwarfFriend( const SgAsmDwarfFriendStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmDwarfFriend* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmDwarfFriend* isSgAsmDwarfFriend ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmDwarfFriend>;
...
// postdeclarations for SgAsmDwarfFriend

/* #line 502 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfFriend.h" */
...
/* #line 509 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfFriend.h" */

#endif // ROSE_SgAsmDwarfFriend_H
