...
#ifndef ROSE_SgAsmDwarfConstruct_H
#define ROSE_SgAsmDwarfConstruct_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmDwarfConstruct

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfConstruct.h" */
...
// Class Definition for SgAsmDwarfConstruct
class ROSE_DLL_API SgAsmDwarfConstruct  : public SgAsmDwarfInformation
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfConstruct.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 29068 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
private:
    ...
    void serialize(S &s, const unsigned /*version*/) {
        ...
        s & BOOST_SERIALIZATION_NVP(p_decl_file_id);
        s & BOOST_SERIALIZATION_NVP(p_decl_line);
        s & BOOST_SERIALIZATION_NVP(p_decl_column);
...
public:
    int const& get_decl_line() const;
    void set_decl_line(int const&);

public:
    int const& get_decl_column() const;
    void set_decl_column(int const&);
public:
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmDwarfConstruct;
          enum { static_variant = V_SgAsmDwarfConstruct };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmDwarfConstruct* isSgAsmDwarfConstruct(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmDwarfConstruct* isSgAsmDwarfConstruct( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmDwarfConstruct * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmDwarfConstructStorageClass *); // 
          ...
          /// \private
          static SgAsmDwarfConstruct * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmDwarfConstruct * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmDwarfConstruct::operator delete (pointer,sizeof(SgAsmDwarfConstruct));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmDwarfConstruct* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmDwarfConstruct* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmDwarfConstruct* sgnode);
     ...
     public:
       ...
       */
       // SgAsmDwarfConstruct( SgAsmDwarfConstructStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmDwarfConstructStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmDwarfConstruct( const SgAsmDwarfConstructStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmDwarfConstruct* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmDwarfConstruct* isSgAsmDwarfConstruct ( SgNode* s );

          typedef SgAsmDwarfInformation base_node_type;
...
// End of memberFunctionString
// Start of memberFunctionString
SgAsmDwarfLine* p_source_position;
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmDwarfConstruct>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmDwarfConstruct, int,&SgAsmDwarfConstruct::p_nesting_level>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmDwarfConstruct, uint64_t,&SgAsmDwarfConstruct::p_offset>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmDwarfConstruct, uint64_t,&SgAsmDwarfConstruct::p_overall_offset>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmDwarfConstruct, std::string,&SgAsmDwarfConstruct::p_name>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmDwarfConstruct, SgAsmDwarfLine*,&SgAsmDwarfConstruct::p_source_position>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmDwarfConstruct, int,&SgAsmDwarfConstruct::p_decl_file_id>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmDwarfConstruct, int,&SgAsmDwarfConstruct::p_decl_line>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmDwarfConstruct, int,&SgAsmDwarfConstruct::p_decl_column>;
...
// postdeclarations for SgAsmDwarfConstruct

/* #line 605 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfConstruct.h" */
...
/* #line 612 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfConstruct.h" */

#endif // ROSE_SgAsmDwarfConstruct_H
