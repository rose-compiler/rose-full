...
#ifndef ROSE_SgAsmDwarfInformation_H
#define ROSE_SgAsmDwarfInformation_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmDwarfInformation

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfInformation.h" */
...
// Class Definition for SgAsmDwarfInformation
class ROSE_DLL_API SgAsmDwarfInformation  : public SgAsmExecutableFileFormat
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfInformation.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 29201 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmDwarfInformation;
          enum { static_variant = V_SgAsmDwarfInformation };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmDwarfInformation* isSgAsmDwarfInformation(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmDwarfInformation* isSgAsmDwarfInformation( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmDwarfInformation * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmDwarfInformationStorageClass *); // 
          ...
          /// \private
          static SgAsmDwarfInformation * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmDwarfInformation * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmDwarfInformation::operator delete (pointer,sizeof(SgAsmDwarfInformation));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmDwarfInformation* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmDwarfInformation* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmDwarfInformation* sgnode);
     ...
     public:
       ...
       */
       // SgAsmDwarfInformation( SgAsmDwarfInformationStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmDwarfInformationStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmDwarfInformation( const SgAsmDwarfInformationStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmDwarfInformation* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmDwarfInformation* isSgAsmDwarfInformation ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmDwarfInformation>;
...
// postdeclarations for SgAsmDwarfInformation

/* #line 496 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfInformation.h" */
...
/* #line 503 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfInformation.h" */

#endif // ROSE_SgAsmDwarfInformation_H
