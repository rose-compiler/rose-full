...
#ifndef ROSE_SgAsmCilGenericParamTable_H
#define ROSE_SgAsmCilGenericParamTable_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmCilGenericParamTable

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmCilGenericParamTable.h" */
...
// Class Definition for SgAsmCilGenericParamTable
class ROSE_DLL_API SgAsmCilGenericParamTable  : public SgAsmCilMetadata
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmCilGenericParamTable.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 37762 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmCilGenericParamTable;
          enum { static_variant = V_SgAsmCilGenericParamTable };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmCilGenericParamTable* isSgAsmCilGenericParamTable(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmCilGenericParamTable* isSgAsmCilGenericParamTable( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmCilGenericParamTable * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmCilGenericParamTableStorageClass *); // 
          ...
          /// \private
          static SgAsmCilGenericParamTable * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmCilGenericParamTable * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmCilGenericParamTable::operator delete (pointer,sizeof(SgAsmCilGenericParamTable));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmCilGenericParamTable* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmCilGenericParamTable* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmCilGenericParamTable* sgnode);
     ...
     public:
       ...
       */
       // SgAsmCilGenericParamTable( SgAsmCilGenericParamTableStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmCilGenericParamTableStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmCilGenericParamTable( const SgAsmCilGenericParamTableStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmCilGenericParamTable* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmCilGenericParamTable* isSgAsmCilGenericParamTable ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmCilGenericParamTable>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilGenericParamTable, std::vector<SgAsmCilGenericParam*>,&SgAsmCilGenericParamTable::p_elements>;
...
// postdeclarations for SgAsmCilGenericParamTable

/* #line 508 "/workspace/generated/src/frontend/SageIII//SgAsmCilGenericParamTable.h" */
...
/* #line 515 "/workspace/generated/src/frontend/SageIII//SgAsmCilGenericParamTable.h" */

#endif // ROSE_SgAsmCilGenericParamTable_H
