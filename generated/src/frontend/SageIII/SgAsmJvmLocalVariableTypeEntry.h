...
#ifndef ROSE_SgAsmJvmLocalVariableTypeEntry_H
#define ROSE_SgAsmJvmLocalVariableTypeEntry_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmJvmLocalVariableTypeEntry

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmJvmLocalVariableTypeEntry.h" */
...
// Class Definition for SgAsmJvmLocalVariableTypeEntry
class ROSE_DLL_API SgAsmJvmLocalVariableTypeEntry  : public SgAsmJvmNode
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmJvmLocalVariableTypeEntry.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 11603 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmJvmLocalVariableTypeEntry;
          enum { static_variant = V_SgAsmJvmLocalVariableTypeEntry };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmJvmLocalVariableTypeEntry* isSgAsmJvmLocalVariableTypeEntry(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmJvmLocalVariableTypeEntry* isSgAsmJvmLocalVariableTypeEntry( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmJvmLocalVariableTypeEntry * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmJvmLocalVariableTypeEntryStorageClass *); // 
          ...
          /// \private
          static SgAsmJvmLocalVariableTypeEntry * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmJvmLocalVariableTypeEntry * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmJvmLocalVariableTypeEntry::operator delete (pointer,sizeof(SgAsmJvmLocalVariableTypeEntry));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmJvmLocalVariableTypeEntry* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmJvmLocalVariableTypeEntry* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmJvmLocalVariableTypeEntry* sgnode);
     ...
     public:
       ...
       */
       // SgAsmJvmLocalVariableTypeEntry( SgAsmJvmLocalVariableTypeEntryStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmJvmLocalVariableTypeEntryStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmJvmLocalVariableTypeEntry( const SgAsmJvmLocalVariableTypeEntryStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmJvmLocalVariableTypeEntry* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmJvmLocalVariableTypeEntry* isSgAsmJvmLocalVariableTypeEntry ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmJvmLocalVariableTypeEntry>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmJvmLocalVariableTypeEntry, uint16_t,&SgAsmJvmLocalVariableTypeEntry::p_start_pc>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmJvmLocalVariableTypeEntry, uint16_t,&SgAsmJvmLocalVariableTypeEntry::p_length>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmJvmLocalVariableTypeEntry, uint16_t,&SgAsmJvmLocalVariableTypeEntry::p_name_index>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmJvmLocalVariableTypeEntry, uint16_t,&SgAsmJvmLocalVariableTypeEntry::p_signature_index>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmJvmLocalVariableTypeEntry, uint16_t,&SgAsmJvmLocalVariableTypeEntry::p_index>;
...
// postdeclarations for SgAsmJvmLocalVariableTypeEntry

/* #line 602 "/workspace/generated/src/frontend/SageIII//SgAsmJvmLocalVariableTypeEntry.h" */
...
/* #line 609 "/workspace/generated/src/frontend/SageIII//SgAsmJvmLocalVariableTypeEntry.h" */

#endif // ROSE_SgAsmJvmLocalVariableTypeEntry_H
