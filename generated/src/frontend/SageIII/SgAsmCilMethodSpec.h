...
#ifndef ROSE_SgAsmCilMethodSpec_H
#define ROSE_SgAsmCilMethodSpec_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmCilMethodSpec

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmCilMethodSpec.h" */
...
// Class Definition for SgAsmCilMethodSpec
class ROSE_DLL_API SgAsmCilMethodSpec  : public SgAsmCilMetadata
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmCilMethodSpec.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 34806 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmCilMethodSpec;
          enum { static_variant = V_SgAsmCilMethodSpec };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmCilMethodSpec* isSgAsmCilMethodSpec(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmCilMethodSpec* isSgAsmCilMethodSpec( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmCilMethodSpec * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmCilMethodSpecStorageClass *); // 
          ...
          /// \private
          static SgAsmCilMethodSpec * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmCilMethodSpec * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmCilMethodSpec::operator delete (pointer,sizeof(SgAsmCilMethodSpec));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmCilMethodSpec* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmCilMethodSpec* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmCilMethodSpec* sgnode);
     ...
     public:
       ...
       */
       // SgAsmCilMethodSpec( SgAsmCilMethodSpecStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmCilMethodSpecStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmCilMethodSpec( const SgAsmCilMethodSpecStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmCilMethodSpec* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmCilMethodSpec* isSgAsmCilMethodSpec ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmCilMethodSpec>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilMethodSpec, uint32_t,&SgAsmCilMethodSpec::p_Method>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilMethodSpec, uint32_t,&SgAsmCilMethodSpec::p_Instantiation>;
...
// postdeclarations for SgAsmCilMethodSpec

/* #line 536 "/workspace/generated/src/frontend/SageIII//SgAsmCilMethodSpec.h" */
...
/* #line 543 "/workspace/generated/src/frontend/SageIII//SgAsmCilMethodSpec.h" */

#endif // ROSE_SgAsmCilMethodSpec_H
