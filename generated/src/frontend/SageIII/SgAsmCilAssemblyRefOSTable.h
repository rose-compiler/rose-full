...
#ifndef ROSE_SgAsmCilAssemblyRefOSTable_H
#define ROSE_SgAsmCilAssemblyRefOSTable_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmCilAssemblyRefOSTable

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmCilAssemblyRefOSTable.h" */
...
// Class Definition for SgAsmCilAssemblyRefOSTable
class ROSE_DLL_API SgAsmCilAssemblyRefOSTable  : public SgAsmCilMetadata
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmCilAssemblyRefOSTable.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 40923 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmCilAssemblyRefOSTable;
          enum { static_variant = V_SgAsmCilAssemblyRefOSTable };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmCilAssemblyRefOSTable* isSgAsmCilAssemblyRefOSTable(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmCilAssemblyRefOSTable* isSgAsmCilAssemblyRefOSTable( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmCilAssemblyRefOSTable * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmCilAssemblyRefOSTableStorageClass *); // 
          ...
          /// \private
          static SgAsmCilAssemblyRefOSTable * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmCilAssemblyRefOSTable * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmCilAssemblyRefOSTable::operator delete (pointer,sizeof(SgAsmCilAssemblyRefOSTable));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmCilAssemblyRefOSTable* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmCilAssemblyRefOSTable* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmCilAssemblyRefOSTable* sgnode);
     ...
     public:
       ...
       */
       // SgAsmCilAssemblyRefOSTable( SgAsmCilAssemblyRefOSTableStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmCilAssemblyRefOSTableStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmCilAssemblyRefOSTable( const SgAsmCilAssemblyRefOSTableStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmCilAssemblyRefOSTable* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmCilAssemblyRefOSTable* isSgAsmCilAssemblyRefOSTable ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmCilAssemblyRefOSTable>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilAssemblyRefOSTable, std::vector<SgAsmCilAssemblyRefOS*>,&SgAsmCilAssemblyRefOSTable::p_elements>;
...
// postdeclarations for SgAsmCilAssemblyRefOSTable

/* #line 508 "/workspace/generated/src/frontend/SageIII//SgAsmCilAssemblyRefOSTable.h" */
...
/* #line 515 "/workspace/generated/src/frontend/SageIII//SgAsmCilAssemblyRefOSTable.h" */

#endif // ROSE_SgAsmCilAssemblyRefOSTable_H
