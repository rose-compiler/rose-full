...
#ifndef ROSE_SgAsmCilParamTable_H
#define ROSE_SgAsmCilParamTable_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmCilParamTable

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmCilParamTable.h" */
...
// Class Definition for SgAsmCilParamTable
class ROSE_DLL_API SgAsmCilParamTable  : public SgAsmCilMetadata
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmCilParamTable.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 34043 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmCilParamTable;
          enum { static_variant = V_SgAsmCilParamTable };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmCilParamTable* isSgAsmCilParamTable(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmCilParamTable* isSgAsmCilParamTable( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmCilParamTable * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmCilParamTableStorageClass *); // 
          ...
          /// \private
          static SgAsmCilParamTable * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmCilParamTable * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmCilParamTable::operator delete (pointer,sizeof(SgAsmCilParamTable));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmCilParamTable* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmCilParamTable* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmCilParamTable* sgnode);
     ...
     public:
       ...
       */
       // SgAsmCilParamTable( SgAsmCilParamTableStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmCilParamTableStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmCilParamTable( const SgAsmCilParamTableStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmCilParamTable* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmCilParamTable* isSgAsmCilParamTable ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmCilParamTable>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilParamTable, std::vector<SgAsmCilParam*>,&SgAsmCilParamTable::p_elements>;
...
// postdeclarations for SgAsmCilParamTable

/* #line 508 "/workspace/generated/src/frontend/SageIII//SgAsmCilParamTable.h" */
...
/* #line 515 "/workspace/generated/src/frontend/SageIII//SgAsmCilParamTable.h" */

#endif // ROSE_SgAsmCilParamTable_H
