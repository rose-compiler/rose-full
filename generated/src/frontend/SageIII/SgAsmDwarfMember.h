...
#ifndef ROSE_SgAsmDwarfMember_H
#define ROSE_SgAsmDwarfMember_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmDwarfMember

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfMember.h" */
...
// Class Definition for SgAsmDwarfMember
class ROSE_DLL_API SgAsmDwarfMember  : public SgAsmDwarfConstruct
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfMember.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 26420 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
private:
    ...
    void serialize(S &s, const unsigned /*version*/) {
        ...
        s & BOOST_SERIALIZATION_NVP(p_data_bit_offset);
...
public:
    uint64_t const& get_data_bit_offset() const;
    void set_data_bit_offset(uint64_t const&);
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmDwarfMember;
          enum { static_variant = V_SgAsmDwarfMember };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmDwarfMember* isSgAsmDwarfMember(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmDwarfMember* isSgAsmDwarfMember( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmDwarfMember * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmDwarfMemberStorageClass *); // 
          ...
          /// \private
          static SgAsmDwarfMember * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmDwarfMember * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmDwarfMember::operator delete (pointer,sizeof(SgAsmDwarfMember));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmDwarfMember* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmDwarfMember* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmDwarfMember* sgnode);
     ...
     public:
       ...
       */
       // SgAsmDwarfMember( SgAsmDwarfMemberStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmDwarfMemberStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmDwarfMember( const SgAsmDwarfMemberStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmDwarfMember* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmDwarfMember* isSgAsmDwarfMember ( SgNode* s );
...
// End of memberFunctionString
    ...
    protected:
// Start of memberFunctionString
uint64_t p_data_bit_offset;
          
// End of memberFunctionString

    friend struct Rose::Traits::generated::describe_node_t<SgAsmDwarfMember>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmDwarfMember, uint64_t,&SgAsmDwarfMember::p_data_bit_offset>;
...
// postdeclarations for SgAsmDwarfMember

/* #line 514 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfMember.h" */
...
/* #line 521 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfMember.h" */

#endif // ROSE_SgAsmDwarfMember_H
