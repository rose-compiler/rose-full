...
#ifndef ROSE_SgAsmCilEvent_H
#define ROSE_SgAsmCilEvent_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmCilEvent

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmCilEvent.h" */
...
// Class Definition for SgAsmCilEvent
class ROSE_DLL_API SgAsmCilEvent  : public SgAsmCilMetadata
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmCilEvent.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 39581 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmCilEvent;
          enum { static_variant = V_SgAsmCilEvent };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmCilEvent* isSgAsmCilEvent(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmCilEvent* isSgAsmCilEvent( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmCilEvent * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmCilEventStorageClass *); // 
          ...
          /// \private
          static SgAsmCilEvent * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmCilEvent * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmCilEvent::operator delete (pointer,sizeof(SgAsmCilEvent));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmCilEvent* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmCilEvent* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmCilEvent* sgnode);
     ...
     public:
       ...
       */
       // SgAsmCilEvent( SgAsmCilEventStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmCilEventStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmCilEvent( const SgAsmCilEventStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmCilEvent* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmCilEvent* isSgAsmCilEvent ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmCilEvent>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilEvent, uint16_t,&SgAsmCilEvent::p_EventFlags>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilEvent, uint32_t,&SgAsmCilEvent::p_Name>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilEvent, uint32_t,&SgAsmCilEvent::p_EventType>;
...
// postdeclarations for SgAsmCilEvent

/* #line 553 "/workspace/generated/src/frontend/SageIII//SgAsmCilEvent.h" */
...
/* #line 560 "/workspace/generated/src/frontend/SageIII//SgAsmCilEvent.h" */

#endif // ROSE_SgAsmCilEvent_H
