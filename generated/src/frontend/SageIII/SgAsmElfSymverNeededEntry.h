...
#ifndef ROSE_SgAsmElfSymverNeededEntry_H
#define ROSE_SgAsmElfSymverNeededEntry_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmElfSymverNeededEntry

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmElfSymverNeededEntry.h" */
/* #line 18500 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// Class Definition for SgAsmElfSymverNeededEntry
class ROSE_DLL_API SgAsmElfSymverNeededEntry  : public SgAsmExecutableFileFormat
   {
     public:


/* #line 47 "/workspace/generated/src/frontend/SageIII//SgAsmElfSymverNeededEntry.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 18533 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmElfSymverNeededEntry;
          enum { static_variant = V_SgAsmElfSymverNeededEntry };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmElfSymverNeededEntry* isSgAsmElfSymverNeededEntry(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmElfSymverNeededEntry* isSgAsmElfSymverNeededEntry( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmElfSymverNeededEntry * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmElfSymverNeededEntryStorageClass *); // 
          ...
          /// \private
          static SgAsmElfSymverNeededEntry * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmElfSymverNeededEntry * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmElfSymverNeededEntry::operator delete (pointer,sizeof(SgAsmElfSymverNeededEntry));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmElfSymverNeededEntry* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmElfSymverNeededEntry* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmElfSymverNeededEntry* sgnode);
     ...
     public:
       ...
       */
       // SgAsmElfSymverNeededEntry( SgAsmElfSymverNeededEntryStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmElfSymverNeededEntryStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmElfSymverNeededEntry( const SgAsmElfSymverNeededEntryStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmElfSymverNeededEntry* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmElfSymverNeededEntry* isSgAsmElfSymverNeededEntry ( SgNode* s );
...
// End of memberFunctionString
// Start of memberFunctionString
SgAsmGenericString* p_fileName;
          
// End of memberFunctionString
// Start of memberFunctionString
SgAsmElfSymverNeededAuxList* p_entries;
          
// End of memberFunctionString

    friend struct Rose::Traits::generated::describe_node_t<SgAsmElfSymverNeededEntry>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmElfSymverNeededEntry, size_t,&SgAsmElfSymverNeededEntry::p_version>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmElfSymverNeededEntry, SgAsmGenericString*,&SgAsmElfSymverNeededEntry::p_fileName>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmElfSymverNeededEntry, SgAsmElfSymverNeededAuxList*,&SgAsmElfSymverNeededEntry::p_entries>;
...
// postdeclarations for SgAsmElfSymverNeededEntry

/* #line 604 "/workspace/generated/src/frontend/SageIII//SgAsmElfSymverNeededEntry.h" */
...
/* #line 611 "/workspace/generated/src/frontend/SageIII//SgAsmElfSymverNeededEntry.h" */

#endif // ROSE_SgAsmElfSymverNeededEntry_H
