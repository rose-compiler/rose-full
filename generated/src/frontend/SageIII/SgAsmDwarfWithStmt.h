...
#ifndef ROSE_SgAsmDwarfWithStmt_H
#define ROSE_SgAsmDwarfWithStmt_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmDwarfWithStmt

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfWithStmt.h" */
...
// Class Definition for SgAsmDwarfWithStmt
class ROSE_DLL_API SgAsmDwarfWithStmt  : public SgAsmDwarfConstruct
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfWithStmt.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 24198 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmDwarfWithStmt;
          enum { static_variant = V_SgAsmDwarfWithStmt };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmDwarfWithStmt* isSgAsmDwarfWithStmt(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmDwarfWithStmt* isSgAsmDwarfWithStmt( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmDwarfWithStmt * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmDwarfWithStmtStorageClass *); // 
          ...
          /// \private
          static SgAsmDwarfWithStmt * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmDwarfWithStmt * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmDwarfWithStmt::operator delete (pointer,sizeof(SgAsmDwarfWithStmt));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmDwarfWithStmt* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmDwarfWithStmt* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmDwarfWithStmt* sgnode);
     ...
     public:
       ...
       */
       // SgAsmDwarfWithStmt( SgAsmDwarfWithStmtStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmDwarfWithStmtStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmDwarfWithStmt( const SgAsmDwarfWithStmtStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmDwarfWithStmt* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmDwarfWithStmt* isSgAsmDwarfWithStmt ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmDwarfWithStmt>;
...
// postdeclarations for SgAsmDwarfWithStmt

/* #line 502 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfWithStmt.h" */
...
/* #line 509 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfWithStmt.h" */

#endif // ROSE_SgAsmDwarfWithStmt_H
