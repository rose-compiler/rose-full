...
#ifndef ROSE_SgAsmGenericString_H
#define ROSE_SgAsmGenericString_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmGenericString

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmGenericString.h" */
/* #line 43526 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// Class Definition for SgAsmGenericString
class ROSE_DLL_API SgAsmGenericString  : public SgAsmExecutableFileFormat
   {
     public:


/* #line 42 "/workspace/generated/src/frontend/SageIII//SgAsmGenericString.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 43536 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmGenericString;
          enum { static_variant = V_SgAsmGenericString };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmGenericString* isSgAsmGenericString(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmGenericString* isSgAsmGenericString( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmGenericString * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmGenericStringStorageClass *); // 
          ...
          /// \private
          static SgAsmGenericString * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmGenericString * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmGenericString::operator delete (pointer,sizeof(SgAsmGenericString));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmGenericString* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmGenericString* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmGenericString* sgnode);
     ...
     public:
       ...
       */
       // SgAsmGenericString( SgAsmGenericStringStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmGenericStringStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmGenericString( const SgAsmGenericStringStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmGenericString* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmGenericString* isSgAsmGenericString ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmGenericString>;
...
// postdeclarations for SgAsmGenericString

/* #line 519 "/workspace/generated/src/frontend/SageIII//SgAsmGenericString.h" */
...
/* #line 526 "/workspace/generated/src/frontend/SageIII//SgAsmGenericString.h" */

#endif // ROSE_SgAsmGenericString_H
