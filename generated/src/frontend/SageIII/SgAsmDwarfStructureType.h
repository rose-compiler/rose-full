...
#ifndef ROSE_SgAsmDwarfStructureType_H
#define ROSE_SgAsmDwarfStructureType_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmDwarfStructureType

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfStructureType.h" */
/* #line 25487 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// Class Definition for SgAsmDwarfStructureType
class ROSE_DLL_API SgAsmDwarfStructureType  : public SgAsmDwarfConstruct
   {
     public:


/* #line 44 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfStructureType.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 25504 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmDwarfStructureType;
          enum { static_variant = V_SgAsmDwarfStructureType };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmDwarfStructureType* isSgAsmDwarfStructureType(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmDwarfStructureType* isSgAsmDwarfStructureType( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmDwarfStructureType * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmDwarfStructureTypeStorageClass *); // 
          ...
          /// \private
          static SgAsmDwarfStructureType * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmDwarfStructureType * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmDwarfStructureType::operator delete (pointer,sizeof(SgAsmDwarfStructureType));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmDwarfStructureType* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmDwarfStructureType* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmDwarfStructureType* sgnode);
     ...
     public:
       ...
       */
       // SgAsmDwarfStructureType( SgAsmDwarfStructureTypeStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmDwarfStructureTypeStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmDwarfStructureType( const SgAsmDwarfStructureTypeStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmDwarfStructureType* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmDwarfStructureType* isSgAsmDwarfStructureType ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmDwarfStructureType>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmDwarfStructureType, SgAsmDwarfConstructList*,&SgAsmDwarfStructureType::p_body>;
...
// postdeclarations for SgAsmDwarfStructureType

/* #line 520 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfStructureType.h" */
...
/* #line 527 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfStructureType.h" */

#endif // ROSE_SgAsmDwarfStructureType_H
