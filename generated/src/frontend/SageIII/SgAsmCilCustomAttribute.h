...
#ifndef ROSE_SgAsmCilCustomAttribute_H
#define ROSE_SgAsmCilCustomAttribute_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmCilCustomAttribute

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmCilCustomAttribute.h" */
...
// Class Definition for SgAsmCilCustomAttribute
class ROSE_DLL_API SgAsmCilCustomAttribute  : public SgAsmCilMetadata
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmCilCustomAttribute.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 40162 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmCilCustomAttribute;
          enum { static_variant = V_SgAsmCilCustomAttribute };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmCilCustomAttribute* isSgAsmCilCustomAttribute(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmCilCustomAttribute* isSgAsmCilCustomAttribute( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmCilCustomAttribute * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmCilCustomAttributeStorageClass *); // 
          ...
          /// \private
          static SgAsmCilCustomAttribute * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmCilCustomAttribute * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmCilCustomAttribute::operator delete (pointer,sizeof(SgAsmCilCustomAttribute));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmCilCustomAttribute* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmCilCustomAttribute* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmCilCustomAttribute* sgnode);
     ...
     public:
       ...
       */
       // SgAsmCilCustomAttribute( SgAsmCilCustomAttributeStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmCilCustomAttributeStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmCilCustomAttribute( const SgAsmCilCustomAttributeStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmCilCustomAttribute* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmCilCustomAttribute* isSgAsmCilCustomAttribute ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmCilCustomAttribute>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilCustomAttribute, uint32_t,&SgAsmCilCustomAttribute::p_Parent>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilCustomAttribute, uint32_t,&SgAsmCilCustomAttribute::p_Type>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilCustomAttribute, uint32_t,&SgAsmCilCustomAttribute::p_Value>;
...
// postdeclarations for SgAsmCilCustomAttribute

/* #line 554 "/workspace/generated/src/frontend/SageIII//SgAsmCilCustomAttribute.h" */
...
/* #line 561 "/workspace/generated/src/frontend/SageIII//SgAsmCilCustomAttribute.h" */

#endif // ROSE_SgAsmCilCustomAttribute_H
