...
#ifndef ROSE_SgAsmDwarfCondition_H
#define ROSE_SgAsmDwarfCondition_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmDwarfCondition

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfCondition.h" */
...
// Class Definition for SgAsmDwarfCondition
class ROSE_DLL_API SgAsmDwarfCondition  : public SgAsmDwarfConstruct
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfCondition.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 28073 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmDwarfCondition;
          enum { static_variant = V_SgAsmDwarfCondition };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmDwarfCondition* isSgAsmDwarfCondition(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmDwarfCondition* isSgAsmDwarfCondition( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmDwarfCondition * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmDwarfConditionStorageClass *); // 
          ...
          /// \private
          static SgAsmDwarfCondition * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmDwarfCondition * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmDwarfCondition::operator delete (pointer,sizeof(SgAsmDwarfCondition));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmDwarfCondition* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmDwarfCondition* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmDwarfCondition* sgnode);
     ...
     public:
       ...
       */
       // SgAsmDwarfCondition( SgAsmDwarfConditionStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmDwarfConditionStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmDwarfCondition( const SgAsmDwarfConditionStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmDwarfCondition* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmDwarfCondition* isSgAsmDwarfCondition ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmDwarfCondition>;
...
// postdeclarations for SgAsmDwarfCondition

/* #line 502 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfCondition.h" */
...
/* #line 509 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfCondition.h" */

#endif // ROSE_SgAsmDwarfCondition_H
