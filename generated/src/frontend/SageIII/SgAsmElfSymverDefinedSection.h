...
#ifndef ROSE_SgAsmElfSymverDefinedSection_H
#define ROSE_SgAsmElfSymverDefinedSection_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmElfSymverDefinedSection

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmElfSymverDefinedSection.h" */
/* #line 19073 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// Class Definition for SgAsmElfSymverDefinedSection
class ROSE_DLL_API SgAsmElfSymverDefinedSection  : public SgAsmElfSection
   {
     public:


/* #line 46 "/workspace/generated/src/frontend/SageIII//SgAsmElfSymverDefinedSection.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 19097 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmElfSymverDefinedSection;
          enum { static_variant = V_SgAsmElfSymverDefinedSection };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmElfSymverDefinedSection* isSgAsmElfSymverDefinedSection(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmElfSymverDefinedSection* isSgAsmElfSymverDefinedSection( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmElfSymverDefinedSection * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmElfSymverDefinedSectionStorageClass *); // 
          ...
          /// \private
          static SgAsmElfSymverDefinedSection * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmElfSymverDefinedSection * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmElfSymverDefinedSection::operator delete (pointer,sizeof(SgAsmElfSymverDefinedSection));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmElfSymverDefinedSection* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmElfSymverDefinedSection* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmElfSymverDefinedSection* sgnode);
     ...
     public:
       ...
       */
       // SgAsmElfSymverDefinedSection( SgAsmElfSymverDefinedSectionStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmElfSymverDefinedSectionStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmElfSymverDefinedSection( const SgAsmElfSymverDefinedSectionStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmElfSymverDefinedSection* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmElfSymverDefinedSection* isSgAsmElfSymverDefinedSection ( SgNode* s );

          typedef SgAsmElfSection base_node_type;
...
// End of memberFunctionString
    ...
    protected:
// Start of memberFunctionString
SgAsmElfSymverDefinedEntryList* p_entries;
          
// End of memberFunctionString

    friend struct Rose::Traits::generated::describe_node_t<SgAsmElfSymverDefinedSection>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmElfSymverDefinedSection, SgAsmElfSymverDefinedEntryList*,&SgAsmElfSymverDefinedSection::p_entries>;
...
// postdeclarations for SgAsmElfSymverDefinedSection

/* #line 615 "/workspace/generated/src/frontend/SageIII//SgAsmElfSymverDefinedSection.h" */
...
/* #line 622 "/workspace/generated/src/frontend/SageIII//SgAsmElfSymverDefinedSection.h" */

#endif // ROSE_SgAsmElfSymverDefinedSection_H
