...
#ifndef ROSE_SgAsmNEEntryPoint_H
#define ROSE_SgAsmNEEntryPoint_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmNEEntryPoint

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmNEEntryPoint.h" */
...
// Class Definition for SgAsmNEEntryPoint
class ROSE_DLL_API SgAsmNEEntryPoint  : public SgAsmExecutableFileFormat
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmNEEntryPoint.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 7233 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmNEEntryPoint;
          enum { static_variant = V_SgAsmNEEntryPoint };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmNEEntryPoint* isSgAsmNEEntryPoint(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmNEEntryPoint* isSgAsmNEEntryPoint( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmNEEntryPoint * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmNEEntryPointStorageClass *); // 
          ...
          /// \private
          static SgAsmNEEntryPoint * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmNEEntryPoint * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmNEEntryPoint::operator delete (pointer,sizeof(SgAsmNEEntryPoint));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmNEEntryPoint* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmNEEntryPoint* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmNEEntryPoint* sgnode);
     ...
     public:
       ...
       */
       // SgAsmNEEntryPoint( SgAsmNEEntryPointStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmNEEntryPointStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmNEEntryPoint( const SgAsmNEEntryPointStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmNEEntryPoint* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmNEEntryPoint* isSgAsmNEEntryPoint ( SgNode* s );
...
// End of memberFunctionString
    ...
    protected:
// Start of memberFunctionString
SgAsmNEEntryPoint::NEEntryFlags p_flags;
...
// End of memberFunctionString
// Start of memberFunctionString
unsigned p_sectionIndex;
          
// End of memberFunctionString
// Start of memberFunctionString
unsigned p_sectionOffset;
          
// End of memberFunctionString

    friend struct Rose::Traits::generated::describe_node_t<SgAsmNEEntryPoint>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmNEEntryPoint, SgAsmNEEntryPoint::NEEntryFlags,&SgAsmNEEntryPoint::p_flags>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmNEEntryPoint, unsigned,&SgAsmNEEntryPoint::p_int3f>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmNEEntryPoint, unsigned,&SgAsmNEEntryPoint::p_sectionIndex>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmNEEntryPoint, unsigned,&SgAsmNEEntryPoint::p_sectionOffset>;
...
// postdeclarations for SgAsmNEEntryPoint

/* #line 568 "/workspace/generated/src/frontend/SageIII//SgAsmNEEntryPoint.h" */
...
/* #line 575 "/workspace/generated/src/frontend/SageIII//SgAsmNEEntryPoint.h" */

#endif // ROSE_SgAsmNEEntryPoint_H
