...
#ifndef ROSE_SgAsmJvmSynthetic_H
#define ROSE_SgAsmJvmSynthetic_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmJvmSynthetic

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmJvmSynthetic.h" */
...
// Class Definition for SgAsmJvmSynthetic
class ROSE_DLL_API SgAsmJvmSynthetic  : public SgAsmJvmAttribute
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmJvmSynthetic.h" */

          virtual SgNode* copy ( SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 9345 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmJvmSynthetic;
          enum { static_variant = V_SgAsmJvmSynthetic };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmJvmSynthetic* isSgAsmJvmSynthetic(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmJvmSynthetic* isSgAsmJvmSynthetic( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmJvmSynthetic * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmJvmSyntheticStorageClass *); // 
          ...
          /// \private
          static SgAsmJvmSynthetic * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmJvmSynthetic * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmJvmSynthetic::operator delete (pointer,sizeof(SgAsmJvmSynthetic));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmJvmSynthetic* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmJvmSynthetic* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmJvmSynthetic* sgnode);
     ...
     public:
       ...
       */
       // SgAsmJvmSynthetic( SgAsmJvmSyntheticStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmJvmSyntheticStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmJvmSynthetic( const SgAsmJvmSyntheticStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmJvmSynthetic* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 670 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmJvmSynthetic* isSgAsmJvmSynthetic ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmJvmSynthetic>;
...
// postdeclarations for SgAsmJvmSynthetic

/* #line 503 "/workspace/generated/src/frontend/SageIII//SgAsmJvmSynthetic.h" */
...
/* #line 510 "/workspace/generated/src/frontend/SageIII//SgAsmJvmSynthetic.h" */

#endif // ROSE_SgAsmJvmSynthetic_H
