...
#ifndef ROSE_SgAsmBinaryPreupdate_H
#define ROSE_SgAsmBinaryPreupdate_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmBinaryPreupdate

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmBinaryPreupdate.h" */
...
// Class Definition for SgAsmBinaryPreupdate
class ROSE_DLL_API SgAsmBinaryPreupdate  : public SgAsmBinaryExpression
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmBinaryPreupdate.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 42665 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmBinaryPreupdate;
          enum { static_variant = V_SgAsmBinaryPreupdate };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmBinaryPreupdate* isSgAsmBinaryPreupdate(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmBinaryPreupdate* isSgAsmBinaryPreupdate( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmBinaryPreupdate * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmBinaryPreupdateStorageClass *); // 
          ...
          /// \private
          static SgAsmBinaryPreupdate * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmBinaryPreupdate * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmBinaryPreupdate::operator delete (pointer,sizeof(SgAsmBinaryPreupdate));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmBinaryPreupdate* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmBinaryPreupdate* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmBinaryPreupdate* sgnode);
     ...
     public:
       ...
       */
       // SgAsmBinaryPreupdate( SgAsmBinaryPreupdateStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmBinaryPreupdateStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmBinaryPreupdate( const SgAsmBinaryPreupdateStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmBinaryPreupdate* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmBinaryPreupdate* isSgAsmBinaryPreupdate ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmBinaryPreupdate>;
...
// postdeclarations for SgAsmBinaryPreupdate

/* #line 501 "/workspace/generated/src/frontend/SageIII//SgAsmBinaryPreupdate.h" */
...
/* #line 508 "/workspace/generated/src/frontend/SageIII//SgAsmBinaryPreupdate.h" */

#endif // ROSE_SgAsmBinaryPreupdate_H
