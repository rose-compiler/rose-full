...
#ifndef ROSE_SgAsmCilGenericParamConstraint_H
#define ROSE_SgAsmCilGenericParamConstraint_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmCilGenericParamConstraint

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmCilGenericParamConstraint.h" */
...
// Class Definition for SgAsmCilGenericParamConstraint
class ROSE_DLL_API SgAsmCilGenericParamConstraint  : public SgAsmCilMetadata
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmCilGenericParamConstraint.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 38028 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmCilGenericParamConstraint;
          enum { static_variant = V_SgAsmCilGenericParamConstraint };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmCilGenericParamConstraint* isSgAsmCilGenericParamConstraint(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmCilGenericParamConstraint* isSgAsmCilGenericParamConstraint( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmCilGenericParamConstraint * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmCilGenericParamConstraintStorageClass *); // 
          ...
          /// \private
          static SgAsmCilGenericParamConstraint * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmCilGenericParamConstraint * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmCilGenericParamConstraint::operator delete (pointer,sizeof(SgAsmCilGenericParamConstraint));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmCilGenericParamConstraint* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmCilGenericParamConstraint* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmCilGenericParamConstraint* sgnode);
     ...
     public:
       ...
       */
       // SgAsmCilGenericParamConstraint( SgAsmCilGenericParamConstraintStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmCilGenericParamConstraintStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmCilGenericParamConstraint( const SgAsmCilGenericParamConstraintStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmCilGenericParamConstraint* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmCilGenericParamConstraint* isSgAsmCilGenericParamConstraint ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmCilGenericParamConstraint>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilGenericParamConstraint, uint32_t,&SgAsmCilGenericParamConstraint::p_Owner>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilGenericParamConstraint, uint32_t,&SgAsmCilGenericParamConstraint::p_Constraint>;
...
// postdeclarations for SgAsmCilGenericParamConstraint

/* #line 536 "/workspace/generated/src/frontend/SageIII//SgAsmCilGenericParamConstraint.h" */
...
/* #line 543 "/workspace/generated/src/frontend/SageIII//SgAsmCilGenericParamConstraint.h" */

#endif // ROSE_SgAsmCilGenericParamConstraint_H
