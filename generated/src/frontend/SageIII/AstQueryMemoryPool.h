...
case V_SgAsmJvmSynthetic: {
  SgAsmJvmSynthetic::traverseMemoryPoolNodes(astQuery);
  break;
}
...
case V_SgAsmJvmSourceFile: {
  SgAsmJvmSourceFile::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAsmJvmSignature: {
  SgAsmJvmSignature::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAsmJvmNestMembers: {
  SgAsmJvmNestMembers::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAsmJvmNestHost: {
  SgAsmJvmNestHost::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAsmJvmModuleMainClass: {
  SgAsmJvmModuleMainClass::traverseMemoryPoolNodes(astQuery);
  break;
}
...
case V_SgAsmJvmLineNumberEntry: {
  SgAsmJvmLineNumberEntry::traverseMemoryPoolNodes(astQuery);
  break;
}
...
case V_SgAsmJvmInnerClassesEntry: {
  SgAsmJvmInnerClassesEntry::traverseMemoryPoolNodes(astQuery);
  break;
}
...
case V_SgAsmJvmExceptions: {
  SgAsmJvmExceptions::traverseMemoryPoolNodes(astQuery);
  break;
}
...
case V_SgAsmJvmDeprecated: {
  SgAsmJvmDeprecated::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAsmJvmConstantValue: {
  SgAsmJvmConstantValue::traverseMemoryPoolNodes(astQuery);
  break;
}
