...
case V_SgJvmComposite: {
  SgJvmComposite::traverseMemoryPoolNodes(astQuery);
  break;
}
...
case V_SgTypeFloat16: {
  SgTypeFloat16::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgTypeFp16: {
  SgTypeFp16::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgTypeBFloat16: {
  SgTypeBFloat16::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgTypeFloat32x: {
  SgTypeFloat32x::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgTypeFloat64x: {
  SgTypeFloat64x::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgTypeFloat32: {
  SgTypeFloat32::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgTypeFloat64: {
  SgTypeFloat64::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgTypeFixed: {
...
case V_SgAdaDerivedType: {
  SgAdaDerivedType::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAdaModularType: {
  SgAdaModularType::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAdaDiscriminatedType: {
  SgAdaDiscriminatedType::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAdaFormalType: {
  SgAdaFormalType::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAdaDiscreteType: {
  SgAdaDiscreteType::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAdaSubroutineType: {
  SgAdaSubroutineType::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgRangeType: {
  SgRangeType::traverseMemoryPoolNodes(astQuery);
  break;
}
...
case V_SgAdaProtectedType: {
  SgAdaProtectedType::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgScopedType: {
  SgScopedType::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgClassType: {
...
case V_SgSignedIntegralType: {
  SgSignedIntegralType::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgUnsignedIntegralType: {
  SgUnsignedIntegralType::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgIntegralType: {
  SgIntegralType::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgFloatingPointType: {
  SgFloatingPointType::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgType: {
...
case V_SgAdaParameterList: {
  SgAdaParameterList::traverseMemoryPoolNodes(astQuery);
  break;
}
...
case V_SgAdaDelayStmt: {
  SgAdaDelayStmt::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAdaSelectStmt: {
  SgAdaSelectStmt::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAdaSelectAlternativeStmt: {
  SgAdaSelectAlternativeStmt::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAdaTerminateStmt: {
  SgAdaTerminateStmt::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAdaUnscopedBlock: {
  SgAdaUnscopedBlock::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAdaVariantWhenStmt: {
  SgAdaVariantWhenStmt::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgSpawnStmt: {
...
case V_SgFortranContinueStmt: {
  SgFortranContinueStmt::traverseMemoryPoolNodes(astQuery);
  break;
}
...
case V_SgTemplateVariableInstantiation: {
  SgTemplateVariableInstantiation::traverseMemoryPoolNodes(astQuery);
  break;
}
...
case V_SgJovialLabelDeclaration: {
  SgJovialLabelDeclaration::traverseMemoryPoolNodes(astQuery);
  break;
}
...
case V_SgAdaProtectedBody: {
  SgAdaProtectedBody::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAdaProtectedSpec: {
  SgAdaProtectedSpec::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAdaGenericDefn: {
  SgAdaGenericDefn::traverseMemoryPoolNodes(astQuery);
  break;
}
...
case V_SgAdaFunctionRenamingDecl: {
  SgAdaFunctionRenamingDecl::traverseMemoryPoolNodes(astQuery);
  break;
}
...
case V_SgAdaProtectedSpecDecl: {
  SgAdaProtectedSpecDecl::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAdaProtectedTypeDecl: {
  SgAdaProtectedTypeDecl::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAdaProtectedBodyDecl: {
  SgAdaProtectedBodyDecl::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAdaRepresentationClause: {
  SgAdaRepresentationClause::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAdaEnumRepresentationClause: {
  SgAdaEnumRepresentationClause::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAdaAttributeClause: {
  SgAdaAttributeClause::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAdaComponentClause: {
  SgAdaComponentClause::traverseMemoryPoolNodes(astQuery);
  break;
}
...
case V_SgAdaGenericDecl: {
  SgAdaGenericDecl::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAdaGenericInstanceDecl: {
  SgAdaGenericInstanceDecl::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAdaFormalTypeDecl: {
  SgAdaFormalTypeDecl::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAdaFormalPackageDecl: {
  SgAdaFormalPackageDecl::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAdaDiscriminatedTypeDecl: {
  SgAdaDiscriminatedTypeDecl::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAdaVariantDecl: {
  SgAdaVariantDecl::traverseMemoryPoolNodes(astQuery);
  break;
}
...
case V_SgAdaAncestorInitializer: {
  SgAdaAncestorInitializer::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAdaAttributeExp: {
  SgAdaAttributeExp::traverseMemoryPoolNodes(astQuery);
  break;
}
...
case V_SgAdaOthersExp: {
  SgAdaOthersExp::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAdaProtectedRefExp: {
  SgAdaProtectedRefExp::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAdaRenamingRefExp: {
  SgAdaRenamingRefExp::traverseMemoryPoolNodes(astQuery);
  break;
}
...
case V_SgAdaUnitRefExp: {
  SgAdaUnitRefExp::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAddOp: {
...
case V_SgBFloat16Val: {
  SgBFloat16Val::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgFloat16Val: {
  SgFloat16Val::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgFloat32Val: {
  SgFloat32Val::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgFloat64Val: {
  SgFloat64Val::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgFloatVal: {
...
case V_SgJovialPresetPositionExp: {
  SgJovialPresetPositionExp::traverseMemoryPoolNodes(astQuery);
  break;
}
...
case V_SgSignedCharVal: {
  SgSignedCharVal::traverseMemoryPoolNodes(astQuery);
  break;
}
...
case V_SgScopedRefExp: {
  SgScopedRefExp::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgTypeRefExp: {
  SgTypeRefExp::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgReferenceExp: {
  SgReferenceExp::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgExpression: {
...
case V_SgAdaInheritedFunctionSymbol: {
  SgAdaInheritedFunctionSymbol::traverseMemoryPoolNodes(astQuery);
  break;
}
...
case V_SgTypeSymbol: {
  SgTypeSymbol::traverseMemoryPoolNodes(astQuery);
  break;
}
...
case V_SgAdaProtectedSymbol: {
  SgAdaProtectedSymbol::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAdaGenericSymbol: {
  SgAdaGenericSymbol::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAdaGenericInstanceSymbol: {
  SgAdaGenericInstanceSymbol::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAdaFormalPackageSymbol: {
  SgAdaFormalPackageSymbol::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAdaRenamingSymbol: {
  SgAdaRenamingSymbol::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgSymbol: {
...
case V_SgAsmVoidType: {
  SgAsmVoidType::traverseMemoryPoolNodes(astQuery);
  break;
}
...
case V_SgAsmUserInstruction: {
  SgAsmUserInstruction::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAsmUnaryUnsignedExtend: {
  SgAsmUnaryUnsignedExtend::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAsmUnaryTruncate: {
  SgAsmUnaryTruncate::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAsmUnarySignedExtend: {
  SgAsmUnarySignedExtend::traverseMemoryPoolNodes(astQuery);
  break;
}
...
case V_SgAsmStackExpression: {
  SgAsmStackExpression::traverseMemoryPoolNodes(astQuery);
  break;
}
...
case V_SgAsmPointerType: {
  SgAsmPointerType::traverseMemoryPoolNodes(astQuery);
  break;
}
...
case V_SgAsmNullInstruction: {
  SgAsmNullInstruction::traverseMemoryPoolNodes(astQuery);
  break;
}
...
case V_SgAsmJvmStackMapVerificationType: {
  SgAsmJvmStackMapVerificationType::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAsmJvmStackMapTable: {
  SgAsmJvmStackMapTable::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAsmJvmStackMapFrame: {
  SgAsmJvmStackMapFrame::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAsmJvmRuntimeVisibleAnnotations: {
  SgAsmJvmRuntimeVisibleAnnotations::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAsmJvmRuntimeVisibilityParamAnnotations: {
  SgAsmJvmRuntimeVisibilityParamAnnotations::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAsmJvmRuntimeParameterAnnotation: {
  SgAsmJvmRuntimeParameterAnnotation::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAsmJvmRuntimeInvisibleAnnotations: {
  SgAsmJvmRuntimeInvisibleAnnotations::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAsmJvmRuntimeAnnotationValue: {
  SgAsmJvmRuntimeAnnotationValue::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAsmJvmRuntimeAnnotationPair: {
  SgAsmJvmRuntimeAnnotationPair::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAsmJvmRuntimeAnnotation: {
  SgAsmJvmRuntimeAnnotation::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAsmJvmModule: {
  SgAsmJvmModule::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAsmJvmMethodTable: {
  SgAsmJvmMethodTable::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAsmJvmMethodParameters: {
  SgAsmJvmMethodParameters::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAsmJvmMethodParametersEntry: {
  SgAsmJvmMethodParametersEntry::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAsmJvmMethod: {
  SgAsmJvmMethod::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAsmJvmLocalVariableTypeTable: {
  SgAsmJvmLocalVariableTypeTable::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAsmJvmLocalVariableTypeEntry: {
  SgAsmJvmLocalVariableTypeEntry::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAsmJvmLocalVariableTable: {
  SgAsmJvmLocalVariableTable::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAsmJvmLocalVariableEntry: {
  SgAsmJvmLocalVariableEntry::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAsmJvmLineNumberTable: {
  SgAsmJvmLineNumberTable::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAsmJvmInstruction: {
  SgAsmJvmInstruction::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAsmJvmInnerClasses: {
  SgAsmJvmInnerClasses::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAsmJvmIndexTableAttr: {
  SgAsmJvmIndexTableAttr::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAsmJvmIndexedAttr: {
  SgAsmJvmIndexedAttr::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAsmJvmFileHeader: {
  SgAsmJvmFileHeader::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAsmJvmFieldTable: {
  SgAsmJvmFieldTable::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAsmJvmField: {
  SgAsmJvmField::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAsmJvmExceptionTable: {
  SgAsmJvmExceptionTable::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAsmJvmExceptionHandler: {
  SgAsmJvmExceptionHandler::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAsmJvmEnclosingMethod: {
  SgAsmJvmEnclosingMethod::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAsmJvmConstantPool: {
  SgAsmJvmConstantPool::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAsmJvmConstantPoolEntry: {
  SgAsmJvmConstantPoolEntry::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAsmJvmCodeAttribute: {
  SgAsmJvmCodeAttribute::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAsmJvmClass: {
  SgAsmJvmClass::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAsmJvmBootstrapMethods: {
  SgAsmJvmBootstrapMethods::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAsmJvmBootstrapMethod: {
  SgAsmJvmBootstrapMethod::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAsmJvmAttributeTable: {
  SgAsmJvmAttributeTable::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAsmJvmAnnotationDefault: {
  SgAsmJvmAnnotationDefault::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAsmJvmAttribute: {
  SgAsmJvmAttribute::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAsmJvmNode: {
  SgAsmJvmNode::traverseMemoryPoolNodes(astQuery);
  break;
}
...
case V_SgAsmInstructionList: {
  SgAsmInstructionList::traverseMemoryPoolNodes(astQuery);
  break;
}
...
case V_SgAsmCliHeader: {
  SgAsmCliHeader::traverseMemoryPoolNodes(astQuery);
  break;
}
...
case V_SgAsmCilUint8Heap: {
  SgAsmCilUint8Heap::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAsmCilUint32Heap: {
  SgAsmCilUint32Heap::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAsmCilTypeSpecTable: {
  SgAsmCilTypeSpecTable::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAsmCilTypeSpec: {
  SgAsmCilTypeSpec::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAsmCilTypeRefTable: {
  SgAsmCilTypeRefTable::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAsmCilTypeRef: {
  SgAsmCilTypeRef::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAsmCilTypeDefTable: {
  SgAsmCilTypeDefTable::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAsmCilTypeDef: {
  SgAsmCilTypeDef::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAsmCilStandAloneSigTable: {
  SgAsmCilStandAloneSigTable::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAsmCilStandAloneSig: {
  SgAsmCilStandAloneSig::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAsmCilPropertyTable: {
  SgAsmCilPropertyTable::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAsmCilPropertyMapTable: {
  SgAsmCilPropertyMapTable::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAsmCilPropertyMap: {
  SgAsmCilPropertyMap::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAsmCilProperty: {
  SgAsmCilProperty::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAsmCilParamTable: {
  SgAsmCilParamTable::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAsmCilParam: {
  SgAsmCilParam::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAsmCilNestedClassTable: {
  SgAsmCilNestedClassTable::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAsmCilNestedClass: {
  SgAsmCilNestedClass::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAsmCilModuleTable: {
  SgAsmCilModuleTable::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAsmCilModuleRefTable: {
  SgAsmCilModuleRefTable::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAsmCilModuleRef: {
  SgAsmCilModuleRef::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAsmCilModule: {
  SgAsmCilModule::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAsmCilMethodSpecTable: {
  SgAsmCilMethodSpecTable::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAsmCilMethodSpec: {
  SgAsmCilMethodSpec::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAsmCilMethodSemanticsTable: {
  SgAsmCilMethodSemanticsTable::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAsmCilMethodSemantics: {
  SgAsmCilMethodSemantics::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAsmCilMethodImplTable: {
  SgAsmCilMethodImplTable::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAsmCilMethodImpl: {
  SgAsmCilMethodImpl::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAsmCilMethodDefTable: {
  SgAsmCilMethodDefTable::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAsmCilMethodDef: {
  SgAsmCilMethodDef::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAsmCilMethodData: {
  SgAsmCilMethodData::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAsmCilMetadataRoot: {
  SgAsmCilMetadataRoot::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAsmCilMetadataHeap: {
  SgAsmCilMetadataHeap::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAsmCilMemberRefTable: {
  SgAsmCilMemberRefTable::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAsmCilMemberRef: {
  SgAsmCilMemberRef::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAsmCilManifestResourceTable: {
  SgAsmCilManifestResourceTable::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAsmCilManifestResource: {
  SgAsmCilManifestResource::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAsmCilInterfaceImplTable: {
  SgAsmCilInterfaceImplTable::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAsmCilInterfaceImpl: {
  SgAsmCilInterfaceImpl::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAsmCilInstruction: {
  SgAsmCilInstruction::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAsmCilImplMapTable: {
  SgAsmCilImplMapTable::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAsmCilImplMap: {
  SgAsmCilImplMap::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAsmCilGenericParamTable: {
  SgAsmCilGenericParamTable::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAsmCilGenericParam: {
  SgAsmCilGenericParam::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAsmCilGenericParamConstraintTable: {
  SgAsmCilGenericParamConstraintTable::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAsmCilGenericParamConstraint: {
  SgAsmCilGenericParamConstraint::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAsmCilFileTable: {
  SgAsmCilFileTable::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAsmCilFile: {
  SgAsmCilFile::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAsmCilFieldTable: {
  SgAsmCilFieldTable::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAsmCilFieldRVATable: {
  SgAsmCilFieldRVATable::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAsmCilFieldRVA: {
  SgAsmCilFieldRVA::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAsmCilFieldMarshalTable: {
  SgAsmCilFieldMarshalTable::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAsmCilFieldMarshal: {
  SgAsmCilFieldMarshal::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAsmCilFieldLayoutTable: {
  SgAsmCilFieldLayoutTable::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAsmCilFieldLayout: {
  SgAsmCilFieldLayout::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAsmCilField: {
  SgAsmCilField::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAsmCilExportedTypeTable: {
  SgAsmCilExportedTypeTable::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAsmCilExportedType: {
  SgAsmCilExportedType::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAsmCilExceptionData: {
  SgAsmCilExceptionData::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAsmCilEventTable: {
  SgAsmCilEventTable::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAsmCilEventMapTable: {
  SgAsmCilEventMapTable::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAsmCilEventMap: {
  SgAsmCilEventMap::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAsmCilEvent: {
  SgAsmCilEvent::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAsmCilErrorHeap: {
  SgAsmCilErrorHeap::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAsmCilDeclSecurityTable: {
  SgAsmCilDeclSecurityTable::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAsmCilDeclSecurity: {
  SgAsmCilDeclSecurity::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAsmCilDataStream: {
  SgAsmCilDataStream::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAsmCilCustomAttributeTable: {
  SgAsmCilCustomAttributeTable::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAsmCilCustomAttribute: {
  SgAsmCilCustomAttribute::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAsmCilConstantTable: {
  SgAsmCilConstantTable::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAsmCilConstant: {
  SgAsmCilConstant::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAsmCilClassLayoutTable: {
  SgAsmCilClassLayoutTable::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAsmCilClassLayout: {
  SgAsmCilClassLayout::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAsmCilAssemblyTable: {
  SgAsmCilAssemblyTable::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAsmCilAssemblyRefTable: {
  SgAsmCilAssemblyRefTable::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAsmCilAssemblyRefProcessorTable: {
  SgAsmCilAssemblyRefProcessorTable::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAsmCilAssemblyRefProcessor: {
  SgAsmCilAssemblyRefProcessor::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAsmCilAssemblyRefOSTable: {
  SgAsmCilAssemblyRefOSTable::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAsmCilAssemblyRefOS: {
  SgAsmCilAssemblyRefOS::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAsmCilAssemblyRef: {
  SgAsmCilAssemblyRef::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAsmCilAssemblyProcessorTable: {
  SgAsmCilAssemblyProcessorTable::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAsmCilAssemblyProcessor: {
  SgAsmCilAssemblyProcessor::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAsmCilAssemblyOSTable: {
  SgAsmCilAssemblyOSTable::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAsmCilAssemblyOS: {
  SgAsmCilAssemblyOS::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAsmCilAssembly: {
  SgAsmCilAssembly::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAsmCilMetadata: {
  SgAsmCilMetadata::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAsmCilNode: {
  SgAsmCilNode::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAsmByteOrder: {
  SgAsmByteOrder::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAsmBlock: {
...
case V_SgAsmBinaryPreupdate: {
  SgAsmBinaryPreupdate::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAsmBinaryPostupdate: {
  SgAsmBinaryPostupdate::traverseMemoryPoolNodes(astQuery);
  break;
}
...
case V_SgAsmBinaryMsl: {
  SgAsmBinaryMsl::traverseMemoryPoolNodes(astQuery);
  break;
}
...
case V_SgAsmBinaryConcat: {
  SgAsmBinaryConcat::traverseMemoryPoolNodes(astQuery);
  break;
}
...
case V_SgAsmAarch32Coprocessor: {
  SgAsmAarch32Coprocessor::traverseMemoryPoolNodes(astQuery);
  break;
}
...
case V_SgAdaIndexConstraint: {
  SgAdaIndexConstraint::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAdaDigitsConstraint: {
  SgAdaDigitsConstraint::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAdaDeltaConstraint: {
  SgAdaDeltaConstraint::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAdaDiscriminantConstraint: {
  SgAdaDiscriminantConstraint::traverseMemoryPoolNodes(astQuery);
  break;
}
case V_SgAdaNullConstraint: {
  SgAdaNullConstraint::traverseMemoryPoolNodes(astQuery);
  break;
}
