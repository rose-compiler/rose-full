...
#ifndef ROSE_SgAsmJvmRuntimeInvisibleAnnotations_H
#define ROSE_SgAsmJvmRuntimeInvisibleAnnotations_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmJvmRuntimeInvisibleAnnotations

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmJvmRuntimeInvisibleAnnotations.h" */
/* #line 10130 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// Class Definition for SgAsmJvmRuntimeInvisibleAnnotations
class ROSE_DLL_API SgAsmJvmRuntimeInvisibleAnnotations  : public SgAsmJvmAttribute
   {
     public:


/* #line 42 "/workspace/generated/src/frontend/SageIII//SgAsmJvmRuntimeInvisibleAnnotations.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 10151 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmJvmRuntimeInvisibleAnnotations;
          enum { static_variant = V_SgAsmJvmRuntimeInvisibleAnnotations };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmJvmRuntimeInvisibleAnnotations* isSgAsmJvmRuntimeInvisibleAnnotations(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmJvmRuntimeInvisibleAnnotations* isSgAsmJvmRuntimeInvisibleAnnotations( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmJvmRuntimeInvisibleAnnotations * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmJvmRuntimeInvisibleAnnotationsStorageClass *); // 
          ...
          /// \private
          static SgAsmJvmRuntimeInvisibleAnnotations * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmJvmRuntimeInvisibleAnnotations * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmJvmRuntimeInvisibleAnnotations::operator delete (pointer,sizeof(SgAsmJvmRuntimeInvisibleAnnotations));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmJvmRuntimeInvisibleAnnotations* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmJvmRuntimeInvisibleAnnotations* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmJvmRuntimeInvisibleAnnotations* sgnode);
     ...
     public:
       ...
       */
       // SgAsmJvmRuntimeInvisibleAnnotations( SgAsmJvmRuntimeInvisibleAnnotationsStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmJvmRuntimeInvisibleAnnotationsStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmJvmRuntimeInvisibleAnnotations( const SgAsmJvmRuntimeInvisibleAnnotationsStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmJvmRuntimeInvisibleAnnotations* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmJvmRuntimeInvisibleAnnotations* isSgAsmJvmRuntimeInvisibleAnnotations ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmJvmRuntimeInvisibleAnnotations>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmJvmRuntimeInvisibleAnnotations, std::vector<SgAsmJvmRuntimeAnnotation*>,&SgAsmJvmRuntimeInvisibleAnnotations::p_annotations>;
...
// postdeclarations for SgAsmJvmRuntimeInvisibleAnnotations

/* #line 530 "/workspace/generated/src/frontend/SageIII//SgAsmJvmRuntimeInvisibleAnnotations.h" */
...
/* #line 537 "/workspace/generated/src/frontend/SageIII//SgAsmJvmRuntimeInvisibleAnnotations.h" */

#endif // ROSE_SgAsmJvmRuntimeInvisibleAnnotations_H
