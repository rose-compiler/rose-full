...
#ifndef ROSE_SgAsmPowerpcInstruction_H
#define ROSE_SgAsmPowerpcInstruction_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmPowerpcInstruction

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmPowerpcInstruction.h" */
/* #line 1881 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
class ROSE_DLL_API SgAsmPowerpcInstruction  : public SgAsmInstruction
   {
     public:


/* #line 42 "/workspace/generated/src/frontend/SageIII//SgAsmPowerpcInstruction.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 1897 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmPowerpcInstruction;
          enum { static_variant = V_SgAsmPowerpcInstruction };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmPowerpcInstruction* isSgAsmPowerpcInstruction(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmPowerpcInstruction* isSgAsmPowerpcInstruction( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmPowerpcInstruction * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmPowerpcInstructionStorageClass *); // 
          ...
          /// \private
          static SgAsmPowerpcInstruction * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmPowerpcInstruction * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmPowerpcInstruction::operator delete (pointer,sizeof(SgAsmPowerpcInstruction));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmPowerpcInstruction* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmPowerpcInstruction* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmPowerpcInstruction* sgnode);
     ...
     public:
       ...
       */
       // SgAsmPowerpcInstruction( SgAsmPowerpcInstructionStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmPowerpcInstructionStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmPowerpcInstruction( const SgAsmPowerpcInstructionStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmPowerpcInstruction* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmPowerpcInstruction* isSgAsmPowerpcInstruction ( SgNode* s );
...
// End of memberFunctionString
    ...
    protected:
// Start of memberFunctionString
Rose::BinaryAnalysis::PowerpcInstructionKind p_kind;
          
// End of memberFunctionString

    friend struct Rose::Traits::generated::describe_node_t<SgAsmPowerpcInstruction>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmPowerpcInstruction, Rose::BinaryAnalysis::PowerpcInstructionKind,&SgAsmPowerpcInstruction::p_kind>;
...
// postdeclarations for SgAsmPowerpcInstruction

/* #line 539 "/workspace/generated/src/frontend/SageIII//SgAsmPowerpcInstruction.h" */
...
/* #line 546 "/workspace/generated/src/frontend/SageIII//SgAsmPowerpcInstruction.h" */

#endif // ROSE_SgAsmPowerpcInstruction_H
