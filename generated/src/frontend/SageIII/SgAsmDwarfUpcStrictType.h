...
#ifndef ROSE_SgAsmDwarfUpcStrictType_H
#define ROSE_SgAsmDwarfUpcStrictType_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmDwarfUpcStrictType

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfUpcStrictType.h" */
...
// Class Definition for SgAsmDwarfUpcStrictType
class ROSE_DLL_API SgAsmDwarfUpcStrictType  : public SgAsmDwarfConstruct
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfUpcStrictType.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 24516 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmDwarfUpcStrictType;
          enum { static_variant = V_SgAsmDwarfUpcStrictType };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmDwarfUpcStrictType* isSgAsmDwarfUpcStrictType(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmDwarfUpcStrictType* isSgAsmDwarfUpcStrictType( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmDwarfUpcStrictType * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmDwarfUpcStrictTypeStorageClass *); // 
          ...
          /// \private
          static SgAsmDwarfUpcStrictType * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmDwarfUpcStrictType * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmDwarfUpcStrictType::operator delete (pointer,sizeof(SgAsmDwarfUpcStrictType));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmDwarfUpcStrictType* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmDwarfUpcStrictType* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmDwarfUpcStrictType* sgnode);
     ...
     public:
       ...
       */
       // SgAsmDwarfUpcStrictType( SgAsmDwarfUpcStrictTypeStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmDwarfUpcStrictTypeStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmDwarfUpcStrictType( const SgAsmDwarfUpcStrictTypeStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmDwarfUpcStrictType* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmDwarfUpcStrictType* isSgAsmDwarfUpcStrictType ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmDwarfUpcStrictType>;
...
// postdeclarations for SgAsmDwarfUpcStrictType

/* #line 502 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfUpcStrictType.h" */
...
/* #line 509 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfUpcStrictType.h" */

#endif // ROSE_SgAsmDwarfUpcStrictType_H
