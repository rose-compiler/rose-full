...
#ifndef ROSE_SgAsmCilMethodImpl_H
#define ROSE_SgAsmCilMethodImpl_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmCilMethodImpl

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmCilMethodImpl.h" */
...
// Class Definition for SgAsmCilMethodImpl
class ROSE_DLL_API SgAsmCilMethodImpl  : public SgAsmCilMetadata
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmCilMethodImpl.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 35149 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmCilMethodImpl;
          enum { static_variant = V_SgAsmCilMethodImpl };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmCilMethodImpl* isSgAsmCilMethodImpl(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmCilMethodImpl* isSgAsmCilMethodImpl( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmCilMethodImpl * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmCilMethodImplStorageClass *); // 
          ...
          /// \private
          static SgAsmCilMethodImpl * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmCilMethodImpl * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmCilMethodImpl::operator delete (pointer,sizeof(SgAsmCilMethodImpl));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmCilMethodImpl* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmCilMethodImpl* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmCilMethodImpl* sgnode);
     ...
     public:
       ...
       */
       // SgAsmCilMethodImpl( SgAsmCilMethodImplStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmCilMethodImplStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmCilMethodImpl( const SgAsmCilMethodImplStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmCilMethodImpl* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmCilMethodImpl* isSgAsmCilMethodImpl ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmCilMethodImpl>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilMethodImpl, uint32_t,&SgAsmCilMethodImpl::p_Class>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilMethodImpl, uint32_t,&SgAsmCilMethodImpl::p_MethodBody>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilMethodImpl, uint32_t,&SgAsmCilMethodImpl::p_MethodDeclaration>;
...
// postdeclarations for SgAsmCilMethodImpl

/* #line 554 "/workspace/generated/src/frontend/SageIII//SgAsmCilMethodImpl.h" */
...
/* #line 561 "/workspace/generated/src/frontend/SageIII//SgAsmCilMethodImpl.h" */

#endif // ROSE_SgAsmCilMethodImpl_H
