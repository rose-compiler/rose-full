...
#ifndef ROSE_SgAsmRegisterNames_H
#define ROSE_SgAsmRegisterNames_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmRegisterNames

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmRegisterNames.h" */
/* #line 1785 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// Class Definition for SgAsmRegisterNames
class ROSE_DLL_API SgAsmRegisterNames  : public SgAsmExpression
   {
     public:


/* #line 42 "/workspace/generated/src/frontend/SageIII//SgAsmRegisterNames.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 1807 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmRegisterNames;
          enum { static_variant = V_SgAsmRegisterNames };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmRegisterNames* isSgAsmRegisterNames(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmRegisterNames* isSgAsmRegisterNames( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmRegisterNames * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmRegisterNamesStorageClass *); // 
          ...
          /// \private
          static SgAsmRegisterNames * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmRegisterNames * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmRegisterNames::operator delete (pointer,sizeof(SgAsmRegisterNames));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmRegisterNames* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmRegisterNames* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmRegisterNames* sgnode);
     ...
     public:
       ...
       */
       // SgAsmRegisterNames( SgAsmRegisterNamesStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmRegisterNamesStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmRegisterNames( const SgAsmRegisterNamesStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmRegisterNames* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmRegisterNames* isSgAsmRegisterNames ( SgNode* s );
...
// End of memberFunctionString
    ...
    protected:
// Start of memberFunctionString
SgAsmRegisterReferenceExpressionPtrList p_registers;
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmRegisterNames>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmRegisterNames, SgAsmRegisterReferenceExpressionPtrList,&SgAsmRegisterNames::p_registers>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmRegisterNames, unsigned,&SgAsmRegisterNames::p_mask>;
...
// postdeclarations for SgAsmRegisterNames

/* #line 537 "/workspace/generated/src/frontend/SageIII//SgAsmRegisterNames.h" */
...
/* #line 544 "/workspace/generated/src/frontend/SageIII//SgAsmRegisterNames.h" */

#endif // ROSE_SgAsmRegisterNames_H
