...
#ifndef ROSE_SgAsmJvmLocalVariableEntry_H
#define ROSE_SgAsmJvmLocalVariableEntry_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmJvmLocalVariableEntry

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmJvmLocalVariableEntry.h" */
...
// Class Definition for SgAsmJvmLocalVariableEntry
class ROSE_DLL_API SgAsmJvmLocalVariableEntry  : public SgAsmJvmNode
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmJvmLocalVariableEntry.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 11859 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmJvmLocalVariableEntry;
          enum { static_variant = V_SgAsmJvmLocalVariableEntry };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmJvmLocalVariableEntry* isSgAsmJvmLocalVariableEntry(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmJvmLocalVariableEntry* isSgAsmJvmLocalVariableEntry( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmJvmLocalVariableEntry * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmJvmLocalVariableEntryStorageClass *); // 
          ...
          /// \private
          static SgAsmJvmLocalVariableEntry * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmJvmLocalVariableEntry * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmJvmLocalVariableEntry::operator delete (pointer,sizeof(SgAsmJvmLocalVariableEntry));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmJvmLocalVariableEntry* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmJvmLocalVariableEntry* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmJvmLocalVariableEntry* sgnode);
     ...
     public:
       ...
       */
       // SgAsmJvmLocalVariableEntry( SgAsmJvmLocalVariableEntryStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmJvmLocalVariableEntryStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmJvmLocalVariableEntry( const SgAsmJvmLocalVariableEntryStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmJvmLocalVariableEntry* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmJvmLocalVariableEntry* isSgAsmJvmLocalVariableEntry ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmJvmLocalVariableEntry>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmJvmLocalVariableEntry, uint16_t,&SgAsmJvmLocalVariableEntry::p_start_pc>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmJvmLocalVariableEntry, uint16_t,&SgAsmJvmLocalVariableEntry::p_length>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmJvmLocalVariableEntry, uint16_t,&SgAsmJvmLocalVariableEntry::p_name_index>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmJvmLocalVariableEntry, uint16_t,&SgAsmJvmLocalVariableEntry::p_descriptor_index>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmJvmLocalVariableEntry, uint16_t,&SgAsmJvmLocalVariableEntry::p_index>;
...
// postdeclarations for SgAsmJvmLocalVariableEntry

/* #line 602 "/workspace/generated/src/frontend/SageIII//SgAsmJvmLocalVariableEntry.h" */
...
/* #line 609 "/workspace/generated/src/frontend/SageIII//SgAsmJvmLocalVariableEntry.h" */

#endif // ROSE_SgAsmJvmLocalVariableEntry_H
