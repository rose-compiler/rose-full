...
#ifndef ROSE_SgAsmGenericDLLList_H
#define ROSE_SgAsmGenericDLLList_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmGenericDLLList

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmGenericDLLList.h" */
/* #line 16767 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// Class Definition for SgAsmGenericDLLList
class ROSE_DLL_API SgAsmGenericDLLList  : public SgAsmExecutableFileFormat
   {
     public:


/* #line 42 "/workspace/generated/src/frontend/SageIII//SgAsmGenericDLLList.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 16786 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmGenericDLLList;
          enum { static_variant = V_SgAsmGenericDLLList };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmGenericDLLList* isSgAsmGenericDLLList(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmGenericDLLList* isSgAsmGenericDLLList( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmGenericDLLList * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmGenericDLLListStorageClass *); // 
          ...
          /// \private
          static SgAsmGenericDLLList * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmGenericDLLList * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmGenericDLLList::operator delete (pointer,sizeof(SgAsmGenericDLLList));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmGenericDLLList* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmGenericDLLList* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmGenericDLLList* sgnode);
     ...
     public:
       ...
       */
       // SgAsmGenericDLLList( SgAsmGenericDLLListStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmGenericDLLListStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmGenericDLLList( const SgAsmGenericDLLListStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmGenericDLLList* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmGenericDLLList* isSgAsmGenericDLLList ( SgNode* s );
...
// End of memberFunctionString
    ...
    protected:
// Start of memberFunctionString
SgAsmGenericDLLPtrList p_dlls;
          
// End of memberFunctionString

    friend struct Rose::Traits::generated::describe_node_t<SgAsmGenericDLLList>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmGenericDLLList, SgAsmGenericDLLPtrList,&SgAsmGenericDLLList::p_dlls>;
...
// postdeclarations for SgAsmGenericDLLList

/* #line 516 "/workspace/generated/src/frontend/SageIII//SgAsmGenericDLLList.h" */
...
/* #line 523 "/workspace/generated/src/frontend/SageIII//SgAsmGenericDLLList.h" */

#endif // ROSE_SgAsmGenericDLLList_H
