...
#ifndef ROSE_SgAsmCilAssemblyProcessor_H
#define ROSE_SgAsmCilAssemblyProcessor_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmCilAssemblyProcessor

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmCilAssemblyProcessor.h" */
...
// Class Definition for SgAsmCilAssemblyProcessor
class ROSE_DLL_API SgAsmCilAssemblyProcessor  : public SgAsmCilMetadata
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmCilAssemblyProcessor.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 41397 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmCilAssemblyProcessor;
          enum { static_variant = V_SgAsmCilAssemblyProcessor };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmCilAssemblyProcessor* isSgAsmCilAssemblyProcessor(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmCilAssemblyProcessor* isSgAsmCilAssemblyProcessor( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmCilAssemblyProcessor * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmCilAssemblyProcessorStorageClass *); // 
          ...
          /// \private
          static SgAsmCilAssemblyProcessor * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmCilAssemblyProcessor * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmCilAssemblyProcessor::operator delete (pointer,sizeof(SgAsmCilAssemblyProcessor));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmCilAssemblyProcessor* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmCilAssemblyProcessor* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmCilAssemblyProcessor* sgnode);
     ...
     public:
       ...
       */
       // SgAsmCilAssemblyProcessor( SgAsmCilAssemblyProcessorStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmCilAssemblyProcessorStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmCilAssemblyProcessor( const SgAsmCilAssemblyProcessorStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmCilAssemblyProcessor* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmCilAssemblyProcessor* isSgAsmCilAssemblyProcessor ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmCilAssemblyProcessor>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilAssemblyProcessor, uint32_t,&SgAsmCilAssemblyProcessor::p_Processor>;
...
// postdeclarations for SgAsmCilAssemblyProcessor

/* #line 516 "/workspace/generated/src/frontend/SageIII//SgAsmCilAssemblyProcessor.h" */
...
/* #line 523 "/workspace/generated/src/frontend/SageIII//SgAsmCilAssemblyProcessor.h" */

#endif // ROSE_SgAsmCilAssemblyProcessor_H
