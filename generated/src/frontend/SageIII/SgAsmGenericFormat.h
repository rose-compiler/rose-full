...
#ifndef ROSE_SgAsmGenericFormat_H
#define ROSE_SgAsmGenericFormat_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmGenericFormat

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmGenericFormat.h" */
/* #line 15892 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// Class Definition for SgAsmGenericFormat
class ROSE_DLL_API SgAsmGenericFormat  : public SgAsmExecutableFileFormat
   {
     public:


/* #line 42 "/workspace/generated/src/frontend/SageIII//SgAsmGenericFormat.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 15950 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmGenericFormat;
          enum { static_variant = V_SgAsmGenericFormat };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmGenericFormat* isSgAsmGenericFormat(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmGenericFormat* isSgAsmGenericFormat( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmGenericFormat * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmGenericFormatStorageClass *); // 
          ...
          /// \private
          static SgAsmGenericFormat * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmGenericFormat * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmGenericFormat::operator delete (pointer,sizeof(SgAsmGenericFormat));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmGenericFormat* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmGenericFormat* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmGenericFormat* sgnode);
     ...
     public:
       ...
       */
       // SgAsmGenericFormat( SgAsmGenericFormatStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmGenericFormatStorageClass;
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmGenericFormat* isSgAsmGenericFormat ( SgNode* s );
...
// End of memberFunctionString
    ...
    protected:
// Start of memberFunctionString
SgAsmGenericFormat::ExecFamily p_family;
          
// End of memberFunctionString
// Start of memberFunctionString
SgAsmGenericFormat::ExecPurpose p_purpose;
          
// End of memberFunctionString
// Start of memberFunctionString
Rose::BinaryAnalysis::ByteOrder::Endianness p_sex;
...
// End of memberFunctionString
// Start of memberFunctionString
bool p_isCurrentVersion;
          
// End of memberFunctionString
// Start of memberFunctionString
SgAsmGenericFormat::ExecABI p_abi;
          
// End of memberFunctionString
// Start of memberFunctionString
unsigned p_abiVersion;
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmGenericFormat>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmGenericFormat, SgAsmGenericFormat::ExecFamily,&SgAsmGenericFormat::p_family>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmGenericFormat, SgAsmGenericFormat::ExecPurpose,&SgAsmGenericFormat::p_purpose>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmGenericFormat, Rose::BinaryAnalysis::ByteOrder::Endianness,&SgAsmGenericFormat::p_sex>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmGenericFormat, unsigned,&SgAsmGenericFormat::p_version>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmGenericFormat, bool,&SgAsmGenericFormat::p_isCurrentVersion>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmGenericFormat, SgAsmGenericFormat::ExecABI,&SgAsmGenericFormat::p_abi>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmGenericFormat, unsigned,&SgAsmGenericFormat::p_abiVersion>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmGenericFormat, size_t,&SgAsmGenericFormat::p_wordSize>;
...
// postdeclarations for SgAsmGenericFormat

/* #line 636 "/workspace/generated/src/frontend/SageIII//SgAsmGenericFormat.h" */
...
/* #line 643 "/workspace/generated/src/frontend/SageIII//SgAsmGenericFormat.h" */

#endif // ROSE_SgAsmGenericFormat_H
