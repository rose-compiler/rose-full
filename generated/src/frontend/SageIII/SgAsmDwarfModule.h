...
#ifndef ROSE_SgAsmDwarfModule_H
#define ROSE_SgAsmDwarfModule_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmDwarfModule

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfModule.h" */
...
// Class Definition for SgAsmDwarfModule
class ROSE_DLL_API SgAsmDwarfModule  : public SgAsmDwarfConstruct
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfModule.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 26355 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmDwarfModule;
          enum { static_variant = V_SgAsmDwarfModule };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmDwarfModule* isSgAsmDwarfModule(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmDwarfModule* isSgAsmDwarfModule( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmDwarfModule * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmDwarfModuleStorageClass *); // 
          ...
          /// \private
          static SgAsmDwarfModule * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmDwarfModule * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmDwarfModule::operator delete (pointer,sizeof(SgAsmDwarfModule));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmDwarfModule* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmDwarfModule* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmDwarfModule* sgnode);
     ...
     public:
       ...
       */
       // SgAsmDwarfModule( SgAsmDwarfModuleStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmDwarfModuleStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmDwarfModule( const SgAsmDwarfModuleStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmDwarfModule* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmDwarfModule* isSgAsmDwarfModule ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmDwarfModule>;
...
// postdeclarations for SgAsmDwarfModule

/* #line 502 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfModule.h" */
...
/* #line 509 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfModule.h" */

#endif // ROSE_SgAsmDwarfModule_H
