...
#ifndef ROSE_SgAsmCilGenericParam_H
#define ROSE_SgAsmCilGenericParam_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmCilGenericParam

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmCilGenericParam.h" */
...
// Class Definition for SgAsmCilGenericParam
class ROSE_DLL_API SgAsmCilGenericParam  : public SgAsmCilMetadata
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmCilGenericParam.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 37846 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmCilGenericParam;
          enum { static_variant = V_SgAsmCilGenericParam };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmCilGenericParam* isSgAsmCilGenericParam(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmCilGenericParam* isSgAsmCilGenericParam( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmCilGenericParam * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmCilGenericParamStorageClass *); // 
          ...
          /// \private
          static SgAsmCilGenericParam * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmCilGenericParam * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmCilGenericParam::operator delete (pointer,sizeof(SgAsmCilGenericParam));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmCilGenericParam* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmCilGenericParam* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmCilGenericParam* sgnode);
     ...
     public:
       ...
       */
       // SgAsmCilGenericParam( SgAsmCilGenericParamStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmCilGenericParamStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmCilGenericParam( const SgAsmCilGenericParamStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmCilGenericParam* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmCilGenericParam* isSgAsmCilGenericParam ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmCilGenericParam>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilGenericParam, uint16_t,&SgAsmCilGenericParam::p_Number>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilGenericParam, uint16_t,&SgAsmCilGenericParam::p_Flags>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilGenericParam, uint32_t,&SgAsmCilGenericParam::p_Owner>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilGenericParam, uint32_t,&SgAsmCilGenericParam::p_Name>;
...
// postdeclarations for SgAsmCilGenericParam

/* #line 570 "/workspace/generated/src/frontend/SageIII//SgAsmCilGenericParam.h" */
...
/* #line 577 "/workspace/generated/src/frontend/SageIII//SgAsmCilGenericParam.h" */

#endif // ROSE_SgAsmCilGenericParam_H
