...
#ifndef ROSE_SgAsmInstructionList_H
#define ROSE_SgAsmInstructionList_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmInstructionList

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmInstructionList.h" */
/* #line 15435 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// Class Definition for SgAsmInstructionList
class ROSE_DLL_API SgAsmInstructionList  : public SgAsmNode
   {
     public:


/* #line 42 "/workspace/generated/src/frontend/SageIII//SgAsmInstructionList.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 15451 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmInstructionList;
          enum { static_variant = V_SgAsmInstructionList };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmInstructionList* isSgAsmInstructionList(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmInstructionList* isSgAsmInstructionList( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmInstructionList * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmInstructionListStorageClass *); // 
          ...
          /// \private
          static SgAsmInstructionList * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmInstructionList * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmInstructionList::operator delete (pointer,sizeof(SgAsmInstructionList));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmInstructionList* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmInstructionList* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmInstructionList* sgnode);
     ...
     public:
       ...
       */
       // SgAsmInstructionList( SgAsmInstructionListStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmInstructionListStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmInstructionList( const SgAsmInstructionListStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmInstructionList* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmInstructionList* isSgAsmInstructionList ( SgNode* s );
...
// End of memberFunctionString
    ...
    protected:
// Start of memberFunctionString
SgAsmInstructionPtrList p_instructions;
          
// End of memberFunctionString

    friend struct Rose::Traits::generated::describe_node_t<SgAsmInstructionList>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmInstructionList, SgAsmInstructionPtrList,&SgAsmInstructionList::p_instructions>;
...
// postdeclarations for SgAsmInstructionList

/* #line 520 "/workspace/generated/src/frontend/SageIII//SgAsmInstructionList.h" */
...
/* #line 527 "/workspace/generated/src/frontend/SageIII//SgAsmInstructionList.h" */

#endif // ROSE_SgAsmInstructionList_H
