...
#ifndef ROSE_SgAsmBinaryExpression_H
#define ROSE_SgAsmBinaryExpression_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmBinaryExpression

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmBinaryExpression.h" */
...
// Class Definition for SgAsmBinaryExpression
class ROSE_DLL_API SgAsmBinaryExpression  : public SgAsmExpression
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmBinaryExpression.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 43356 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmBinaryExpression* isSgAsmBinaryExpression(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmBinaryExpression* isSgAsmBinaryExpression( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmBinaryExpression * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmBinaryExpressionStorageClass *); // 
          ...
          /// \private
          static SgAsmBinaryExpression * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmBinaryExpression * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmBinaryExpression::operator delete (pointer,sizeof(SgAsmBinaryExpression));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmBinaryExpression* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmBinaryExpression* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmBinaryExpression* sgnode);
     ...
     public:
       ...
       */
       // SgAsmBinaryExpression( SgAsmBinaryExpressionStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmBinaryExpressionStorageClass;
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmBinaryExpression* isSgAsmBinaryExpression ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmBinaryExpression>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmBinaryExpression, SgAsmExpression*,&SgAsmBinaryExpression::p_lhs>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmBinaryExpression, SgAsmExpression*,&SgAsmBinaryExpression::p_rhs>;
...
// postdeclarations for SgAsmBinaryExpression

/* #line 531 "/workspace/generated/src/frontend/SageIII//SgAsmBinaryExpression.h" */
...
/* #line 538 "/workspace/generated/src/frontend/SageIII//SgAsmBinaryExpression.h" */

#endif // ROSE_SgAsmBinaryExpression_H
