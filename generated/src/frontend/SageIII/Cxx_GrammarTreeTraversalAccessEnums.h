...
{
SgJvmComposite_genericFileList, SgJvmComposite_interpretations};
...
{
SgAdaProtectedType_type_kind, SgAdaProtectedType_builtin_type, SgAdaProtectedType_declaration};
enum E_SgAdaFormalType 
{
SgAdaFormalType_type_kind, SgAdaFormalType_builtin_type, SgAdaFormalType_declaration};
enum E_SgAdaDiscriminatedType 
{
SgAdaDiscriminatedType_type_kind, SgAdaDiscriminatedType_builtin_type, SgAdaDiscriminatedType_declaration};
enum E_SgScopedType 
{
SgScopedType_type_kind, SgScopedType_builtin_type, SgScopedType_declaration};
enum E_SgNamedType 
{
...
{
SgPartialFunctionModifierType_type_kind, SgPartialFunctionModifierType_return_type, SgPartialFunctionModifierType_builtin_type};
enum E_SgPartialFunctionType 
{
SgPartialFunctionType_type_kind, SgPartialFunctionType_return_type};
enum E_SgMemberFunctionType 
{
SgMemberFunctionType_type_kind, SgMemberFunctionType_return_type};
enum E_SgFunctionType 
{
SgFunctionType_type_kind, SgFunctionType_return_type};
enum E_SgArrayType 
{
...
{
SgAdaAccessType_type_kind, SgAdaAccessType_base_type};
enum E_SgAdaSubtype 
{
SgAdaSubtype_type_kind, SgAdaSubtype_base_type, SgAdaSubtype_constraint};
enum E_SgAdaDiscreteType 
{
SgAdaDiscreteType_type_kind, SgAdaDiscreteType_builtin_type};
enum E_SgAdaDerivedType 
{
SgAdaDerivedType_type_kind, SgAdaDerivedType_base_type};
enum E_SgAdaSubroutineType 
{
SgAdaSubroutineType_type_kind, SgAdaSubroutineType_parameterList, SgAdaSubroutineType_return_type};
enum E_SgTypeInt 
{
...
enum E_SgSignedIntegralType 
{
SgSignedIntegralType_type_kind};
...
enum E_SgUnsignedIntegralType 
{
SgUnsignedIntegralType_type_kind};
enum E_SgTypeChar 
{
...
{
SgAdaModularType_type_kind, SgAdaModularType_modexpr};
enum E_SgTypeBool 
{
SgTypeBool_type_kind, SgTypeBool_builtin_type};
enum E_SgIntegralType 
{
SgIntegralType_type_kind};
enum E_SgTypeFloat 
{
...
enum E_SgTypeFloat16 
{
SgTypeFloat16_type_kind, SgTypeFloat16_builtin_type};
enum E_SgTypeBFloat16 
{
SgTypeBFloat16_type_kind, SgTypeBFloat16_builtin_type};
enum E_SgTypeFp16 
{
SgTypeFp16_type_kind, SgTypeFp16_builtin_type};
enum E_SgTypeFloat32x 
{
SgTypeFloat32x_type_kind, SgTypeFloat32x_builtin_type};
enum E_SgTypeFloat64x 
{
SgTypeFloat64x_type_kind, SgTypeFloat64x_builtin_type};
enum E_SgTypeFloat32 
{
SgTypeFloat32_type_kind, SgTypeFloat32_builtin_type};
enum E_SgTypeFloat64 
{
SgTypeFloat64_type_kind, SgTypeFloat64_builtin_type};
enum E_SgFloatingPointType 
{
SgFloatingPointType_type_kind};
enum E_SgType 
{
SgType_type_kind};
...
{
SgAdaRangeConstraint_range};
enum E_SgAdaIndexConstraint 
{
SgAdaIndexConstraint_indexRanges};
enum E_SgAdaDigitsConstraint 
{
SgAdaDigitsConstraint_digits, SgAdaDigitsConstraint_subConstraint};
enum E_SgAdaDeltaConstraint 
{
SgAdaDeltaConstraint_delta, SgAdaDeltaConstraint_subConstraint};
enum E_SgAdaDiscriminantConstraint 
{
SgAdaDiscriminantConstraint_discriminants};
enum E_SgGlobal 
{
...
{
SgAdaProtectedBody_statements};
enum E_SgAdaProtectedSpec 
{
SgAdaProtectedSpec_declarations};
enum E_SgAdaGenericDefn 
{
SgAdaGenericDefn_declarations};
...
enum E_SgTemplateVariableInstantiation 
{
SgTemplateVariableInstantiation_baseTypeDefiningDeclaration, SgTemplateVariableInstantiation_variables};
...
{
SgAdaEntryDecl_parameterList, SgAdaEntryDecl_decoratorList, SgAdaEntryDecl_definition, SgAdaEntryDecl_entryIndex, SgAdaEntryDecl_entryBarrier};
enum E_SgAdaFunctionRenamingDecl 
{
SgAdaFunctionRenamingDecl_parameterList, SgAdaFunctionRenamingDecl_decoratorList, SgAdaFunctionRenamingDecl_definition, SgAdaFunctionRenamingDecl_renamed_function};
...
{
SgAdaProtectedSpecDecl_definition};
enum E_SgAdaProtectedBodyDecl 
{
SgAdaProtectedBodyDecl_definition};
enum E_SgAdaProtectedTypeDecl 
{
SgAdaProtectedTypeDecl_definition};
enum E_SgAdaRepresentationClause 
{
SgAdaRepresentationClause_alignment, SgAdaRepresentationClause_components};
enum E_SgAdaComponentClause 
{
SgAdaComponentClause_component, SgAdaComponentClause_offset, SgAdaComponentClause_range};
enum E_SgAdaAttributeClause 
{
SgAdaAttributeClause_attribute, SgAdaAttributeClause_size};
enum E_SgAdaEnumRepresentationClause 
{
SgAdaEnumRepresentationClause_components};
enum E_SgAdaGenericDecl 
{
SgAdaGenericDecl_definition, SgAdaGenericDecl_declaration};
enum E_SgAdaFormalTypeDecl 
{
SgAdaFormalTypeDecl_discriminants};
enum E_SgAdaDiscriminatedTypeDecl 
{
SgAdaDiscriminatedTypeDecl_discriminants, SgAdaDiscriminatedTypeDecl_discriminatedDecl};
enum E_SgAdaGenericInstanceDecl 
{
SgAdaGenericInstanceDecl_instantiatedScope, SgAdaGenericInstanceDecl_actual_parameters};
enum E_SgAdaParameterList 
{
SgAdaParameterList_parameters};
enum E_SgAdaVariantDecl 
{
SgAdaVariantDecl_discriminant, SgAdaVariantDecl_variants};
...
{
SgProcessControlStatement_code, SgProcessControlStatement_quiet};
...
{
SgAdaSelectStmt_select_path, SgAdaSelectStmt_or_path, SgAdaSelectStmt_else_path, SgAdaSelectStmt_abort_path};
enum E_SgAdaSelectAlternativeStmt 
{
SgAdaSelectAlternativeStmt_body, SgAdaSelectAlternativeStmt_guard, SgAdaSelectAlternativeStmt_next};
enum E_SgAdaUnscopedBlock 
{
SgAdaUnscopedBlock_statements};
enum E_SgAdaVariantWhenStmt 
{
SgAdaVariantWhenStmt_choices, SgAdaVariantWhenStmt_components};
...
{
SgAdaAncestorInitializer_ancestor};
...
enum E_SgScopedRefExp 
{
SgScopedRefExp_lhs, SgScopedRefExp_rhs};
...
{
SgAdaAttributeExp_object, SgAdaAttributeExp_args};
enum E_SgJovialTablePresetExp 
{
SgJovialTablePresetExp_preset_list};
enum E_SgJovialPresetPositionExp 
{
SgJovialPresetPositionExp_indices, SgJovialPresetPositionExp_value};
...
{
SgAdaInheritedFunctionSymbol_declaration};
...
{
SgAsmElfSymverNeededEntry_fileName, SgAsmElfSymverNeededEntry_entries};
...
{
SgAsmGenericFile_dwarfInfo, SgAsmGenericFile_headers, SgAsmGenericFile_holes};
enum E_SgAsmGenericHeaderList 
{
SgAsmGenericHeaderList_headers};
enum E_SgAsmCliHeader 
{
SgAsmCliHeader_metadataRoot};
enum E_SgAsmCoffSymbolTable 
{
SgAsmCoffSymbolTable_symbols};
enum E_SgAsmElfDynamicSection 
{
SgAsmElfDynamicSection_sectionEntry, SgAsmElfDynamicSection_segmentEntry, SgAsmElfDynamicSection_entries};
enum E_SgAsmElfEHFrameSection 
{
SgAsmElfEHFrameSection_sectionEntry, SgAsmElfEHFrameSection_segmentEntry, SgAsmElfEHFrameSection_ci_entries};
enum E_SgAsmElfNoteSection 
{
SgAsmElfNoteSection_sectionEntry, SgAsmElfNoteSection_segmentEntry, SgAsmElfNoteSection_entries};
enum E_SgAsmElfRelocSection 
{
SgAsmElfRelocSection_sectionEntry, SgAsmElfRelocSection_segmentEntry, SgAsmElfRelocSection_entries};
enum E_SgAsmElfStringSection 
{
SgAsmElfStringSection_sectionEntry, SgAsmElfStringSection_segmentEntry};
enum E_SgAsmElfSymbolSection 
{
SgAsmElfSymbolSection_sectionEntry, SgAsmElfSymbolSection_segmentEntry, SgAsmElfSymbolSection_symbols};
enum E_SgAsmElfSymverDefinedSection 
{
SgAsmElfSymverDefinedSection_sectionEntry, SgAsmElfSymverDefinedSection_segmentEntry, SgAsmElfSymverDefinedSection_entries};
enum E_SgAsmElfSymverNeededSection 
{
SgAsmElfSymverNeededSection_sectionEntry, SgAsmElfSymverNeededSection_segmentEntry, SgAsmElfSymverNeededSection_entries};
enum E_SgAsmElfSymverSection 
{
SgAsmElfSymverSection_sectionEntry, SgAsmElfSymverSection_segmentEntry, SgAsmElfSymverSection_entries};
enum E_SgAsmElfSection 
{
SgAsmElfSection_sectionEntry, SgAsmElfSection_segmentEntry};
enum E_SgAsmDOSFileHeader 
{
SgAsmDOSFileHeader_executableFormat, SgAsmDOSFileHeader_dlls, SgAsmDOSFileHeader_sections};
enum E_SgAsmElfFileHeader 
{
SgAsmElfFileHeader_executableFormat, SgAsmElfFileHeader_dlls, SgAsmElfFileHeader_sections};
enum E_SgAsmJvmFileHeader 
{
SgAsmJvmFileHeader_executableFormat, SgAsmJvmFileHeader_dlls, SgAsmJvmFileHeader_sections};
enum E_SgAsmLEFileHeader 
{
SgAsmLEFileHeader_executableFormat, SgAsmLEFileHeader_dlls, SgAsmLEFileHeader_sections, SgAsmLEFileHeader_dos2Header, SgAsmLEFileHeader_pageTable, SgAsmLEFileHeader_residentNameTable, SgAsmLEFileHeader_nonresidentNameTable, SgAsmLEFileHeader_entryTable, SgAsmLEFileHeader_relocationTable};
enum E_SgAsmNEFileHeader 
{
SgAsmNEFileHeader_executableFormat, SgAsmNEFileHeader_dlls, SgAsmNEFileHeader_sections, SgAsmNEFileHeader_dos2Header, SgAsmNEFileHeader_residentNameTable, SgAsmNEFileHeader_nonresidentNameTable, SgAsmNEFileHeader_moduleTable, SgAsmNEFileHeader_entryTable};
enum E_SgAsmPEFileHeader 
{
SgAsmPEFileHeader_executableFormat, SgAsmPEFileHeader_dlls, SgAsmPEFileHeader_sections, SgAsmPEFileHeader_rvaSizePairs};
enum E_SgAsmGenericHeader 
{
SgAsmGenericHeader_executableFormat, SgAsmGenericHeader_dlls, SgAsmGenericHeader_sections};
enum E_SgAsmJvmAttributeTable 
{
SgAsmJvmAttributeTable_attributes};
enum E_SgAsmJvmFieldTable 
{
SgAsmJvmFieldTable_fields};
enum E_SgAsmJvmMethodTable 
{
SgAsmJvmMethodTable_methods};
...
{
SgAsmLESection_sectionTableEntry};
...
{
SgAsmNESection_sectionTableEntry, SgAsmNESection_relocationTable};
enum E_SgAsmPEExportSection 
{
SgAsmPEExportSection_section_entry, SgAsmPEExportSection_exportDirectory, SgAsmPEExportSection_exports};
enum E_SgAsmPEImportSection 
{
SgAsmPEImportSection_section_entry, SgAsmPEImportSection_importDirectories};
...
{
SgAsmPEImportDirectory_dllName, SgAsmPEImportDirectory_imports};
...
{
SgAsmBinaryConcat_lhs, SgAsmBinaryConcat_rhs};
...
{
SgAsmBinaryMsl_lhs, SgAsmBinaryMsl_rhs};
enum E_SgAsmBinaryMultiply 
{
SgAsmBinaryMultiply_lhs, SgAsmBinaryMultiply_rhs};
enum E_SgAsmBinaryPostupdate 
{
SgAsmBinaryPostupdate_lhs, SgAsmBinaryPostupdate_rhs};
enum E_SgAsmBinaryPreupdate 
{
SgAsmBinaryPreupdate_lhs, SgAsmBinaryPreupdate_rhs};
...
{
SgAsmUnarySignedExtend_operand};
enum E_SgAsmUnaryTruncate 
{
SgAsmUnaryTruncate_operand};
enum E_SgAsmUnaryUnsignedExtend 
{
SgAsmUnaryUnsignedExtend_operand};
enum E_SgAsmUnaryExpression 
{
SgAsmUnaryExpression_operand};
enum E_SgAsmFloatValueExpression 
{
SgAsmFloatValueExpression_unfoldedExpression};
enum E_SgAsmIntegerValueExpression 
{
SgAsmIntegerValueExpression_unfoldedExpression};
enum E_SgAsmConstantExpression 
{
SgAsmConstantExpression_unfoldedExpression};
enum E_SgAsmValueExpression 
{
SgAsmValueExpression_unfoldedExpression};
enum E_SgAsmGenericFileList 
{
SgAsmGenericFileList_files};
enum E_SgAsmInterpretation 
{
SgAsmInterpretation_globalBlock};
enum E_SgAsmInterpretationList 
{
SgAsmInterpretationList_interpretations};
enum E_SgAsmJvmRuntimeInvisibleAnnotations 
{
SgAsmJvmRuntimeInvisibleAnnotations_annotations};
enum E_SgAsmJvmRuntimeVisibilityParamAnnotations 
{
SgAsmJvmRuntimeVisibilityParamAnnotations_parameter_annotations};
enum E_SgAsmJvmRuntimeVisibleAnnotations 
{
SgAsmJvmRuntimeVisibleAnnotations_annotations};
enum E_SgAsmJvmField 
{
SgAsmJvmField_attribute_table};
enum E_SgAsmJvmMethod 
{
SgAsmJvmMethod_attribute_table};
enum E_SgAsmJvmRuntimeAnnotation 
{
SgAsmJvmRuntimeAnnotation_element_value_pairs};
enum E_SgAsmJvmRuntimeAnnotationValue 
{
SgAsmJvmRuntimeAnnotationValue_values};
enum E_SgAsmJvmRuntimeParameterAnnotation 
{
SgAsmJvmRuntimeParameterAnnotation_annotations};
...
{
SgAsmCilInstruction_operandList, SgAsmCilInstruction_semantics};
enum E_SgAsmJvmInstruction 
{
SgAsmJvmInstruction_operandList, SgAsmJvmInstruction_semantics};
...
{
SgAsmNullInstruction_operandList, SgAsmNullInstruction_semantics};
enum E_SgAsmPowerpcInstruction 
{
SgAsmPowerpcInstruction_operandList, SgAsmPowerpcInstruction_semantics};
enum E_SgAsmUserInstruction 
{
SgAsmUserInstruction_operandList, SgAsmUserInstruction_semantics};
...
enum E_SgAsmPointerType 
{
SgAsmPointerType_subtype};
