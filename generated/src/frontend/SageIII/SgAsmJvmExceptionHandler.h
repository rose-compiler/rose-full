...
#ifndef ROSE_SgAsmJvmExceptionHandler_H
#define ROSE_SgAsmJvmExceptionHandler_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmJvmExceptionHandler

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmJvmExceptionHandler.h" */
...
// Class Definition for SgAsmJvmExceptionHandler
class ROSE_DLL_API SgAsmJvmExceptionHandler  : public SgAsmJvmNode
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmJvmExceptionHandler.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 13235 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmJvmExceptionHandler;
          enum { static_variant = V_SgAsmJvmExceptionHandler };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmJvmExceptionHandler* isSgAsmJvmExceptionHandler(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmJvmExceptionHandler* isSgAsmJvmExceptionHandler( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmJvmExceptionHandler * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmJvmExceptionHandlerStorageClass *); // 
          ...
          /// \private
          static SgAsmJvmExceptionHandler * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmJvmExceptionHandler * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmJvmExceptionHandler::operator delete (pointer,sizeof(SgAsmJvmExceptionHandler));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmJvmExceptionHandler* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmJvmExceptionHandler* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmJvmExceptionHandler* sgnode);
     ...
     public:
       ...
       */
       // SgAsmJvmExceptionHandler( SgAsmJvmExceptionHandlerStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmJvmExceptionHandlerStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmJvmExceptionHandler( const SgAsmJvmExceptionHandlerStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmJvmExceptionHandler* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmJvmExceptionHandler* isSgAsmJvmExceptionHandler ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmJvmExceptionHandler>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmJvmExceptionHandler, uint16_t,&SgAsmJvmExceptionHandler::p_start_pc>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmJvmExceptionHandler, uint16_t,&SgAsmJvmExceptionHandler::p_end_pc>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmJvmExceptionHandler, uint16_t,&SgAsmJvmExceptionHandler::p_handler_pc>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmJvmExceptionHandler, uint16_t,&SgAsmJvmExceptionHandler::p_catch_type>;
...
// postdeclarations for SgAsmJvmExceptionHandler

/* #line 581 "/workspace/generated/src/frontend/SageIII//SgAsmJvmExceptionHandler.h" */
...
/* #line 588 "/workspace/generated/src/frontend/SageIII//SgAsmJvmExceptionHandler.h" */

#endif // ROSE_SgAsmJvmExceptionHandler_H
