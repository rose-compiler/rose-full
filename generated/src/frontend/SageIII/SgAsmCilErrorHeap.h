...
#ifndef ROSE_SgAsmCilErrorHeap_H
#define ROSE_SgAsmCilErrorHeap_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmCilErrorHeap

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmCilErrorHeap.h" */
...
// Class Definition for SgAsmCilErrorHeap
class ROSE_DLL_API SgAsmCilErrorHeap  : public SgAsmCilDataStream
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmCilErrorHeap.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 39674 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmCilErrorHeap;
          enum { static_variant = V_SgAsmCilErrorHeap };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmCilErrorHeap* isSgAsmCilErrorHeap(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmCilErrorHeap* isSgAsmCilErrorHeap( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmCilErrorHeap * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmCilErrorHeapStorageClass *); // 
          ...
          /// \private
          static SgAsmCilErrorHeap * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmCilErrorHeap * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmCilErrorHeap::operator delete (pointer,sizeof(SgAsmCilErrorHeap));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmCilErrorHeap* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmCilErrorHeap* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmCilErrorHeap* sgnode);
     ...
     public:
       ...
       */
       // SgAsmCilErrorHeap( SgAsmCilErrorHeapStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmCilErrorHeapStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmCilErrorHeap( const SgAsmCilErrorHeapStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmCilErrorHeap* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmCilErrorHeap* isSgAsmCilErrorHeap ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmCilErrorHeap>;
...
// postdeclarations for SgAsmCilErrorHeap

/* #line 506 "/workspace/generated/src/frontend/SageIII//SgAsmCilErrorHeap.h" */
...
/* #line 513 "/workspace/generated/src/frontend/SageIII//SgAsmCilErrorHeap.h" */

#endif // ROSE_SgAsmCilErrorHeap_H
