...
#ifndef ROSE_SgAsmDwarfNamespace_H
#define ROSE_SgAsmDwarfNamespace_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmDwarfNamespace

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfNamespace.h" */
/* #line 26096 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// Class Definition for SgAsmDwarfNamespace
class ROSE_DLL_API SgAsmDwarfNamespace  : public SgAsmDwarfConstruct
   {
     public:


/* #line 44 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfNamespace.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 26113 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmDwarfNamespace;
          enum { static_variant = V_SgAsmDwarfNamespace };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmDwarfNamespace* isSgAsmDwarfNamespace(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmDwarfNamespace* isSgAsmDwarfNamespace( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmDwarfNamespace * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmDwarfNamespaceStorageClass *); // 
          ...
          /// \private
          static SgAsmDwarfNamespace * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmDwarfNamespace * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmDwarfNamespace::operator delete (pointer,sizeof(SgAsmDwarfNamespace));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmDwarfNamespace* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmDwarfNamespace* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmDwarfNamespace* sgnode);
     ...
     public:
       ...
       */
       // SgAsmDwarfNamespace( SgAsmDwarfNamespaceStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmDwarfNamespaceStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmDwarfNamespace( const SgAsmDwarfNamespaceStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmDwarfNamespace* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmDwarfNamespace* isSgAsmDwarfNamespace ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmDwarfNamespace>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmDwarfNamespace, SgAsmDwarfConstructList*,&SgAsmDwarfNamespace::p_body>;
...
// postdeclarations for SgAsmDwarfNamespace

/* #line 520 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfNamespace.h" */
...
/* #line 527 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfNamespace.h" */

#endif // ROSE_SgAsmDwarfNamespace_H
