...
#ifndef ROSE_SgAsmNEStringTable_H
#define ROSE_SgAsmNEStringTable_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmNEStringTable

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmNEStringTable.h" */
/* #line 5570 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// Class Definition for SgAsmNEStringTable
class ROSE_DLL_API SgAsmNEStringTable  : public SgAsmGenericSection
   {
     public:


/* #line 42 "/workspace/generated/src/frontend/SageIII//SgAsmNEStringTable.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 5579 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmNEStringTable;
          enum { static_variant = V_SgAsmNEStringTable };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmNEStringTable* isSgAsmNEStringTable(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmNEStringTable* isSgAsmNEStringTable( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmNEStringTable * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmNEStringTableStorageClass *); // 
          ...
          /// \private
          static SgAsmNEStringTable * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmNEStringTable * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmNEStringTable::operator delete (pointer,sizeof(SgAsmNEStringTable));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmNEStringTable* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmNEStringTable* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmNEStringTable* sgnode);
     ...
     public:
       ...
       */
       // SgAsmNEStringTable( SgAsmNEStringTableStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmNEStringTableStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmNEStringTable( const SgAsmNEStringTableStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmNEStringTable* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmNEStringTable* isSgAsmNEStringTable ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmNEStringTable>;
...
// postdeclarations for SgAsmNEStringTable

/* #line 503 "/workspace/generated/src/frontend/SageIII//SgAsmNEStringTable.h" */
...
/* #line 510 "/workspace/generated/src/frontend/SageIII//SgAsmNEStringTable.h" */

#endif // ROSE_SgAsmNEStringTable_H
