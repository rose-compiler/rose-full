...
#ifndef ROSE_SgAsmCilInterfaceImplTable_H
#define ROSE_SgAsmCilInterfaceImplTable_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmCilInterfaceImplTable

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmCilInterfaceImplTable.h" */
...
// Class Definition for SgAsmCilInterfaceImplTable
class ROSE_DLL_API SgAsmCilInterfaceImplTable  : public SgAsmCilMetadata
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmCilInterfaceImplTable.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 37323 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmCilInterfaceImplTable;
          enum { static_variant = V_SgAsmCilInterfaceImplTable };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmCilInterfaceImplTable* isSgAsmCilInterfaceImplTable(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmCilInterfaceImplTable* isSgAsmCilInterfaceImplTable( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmCilInterfaceImplTable * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmCilInterfaceImplTableStorageClass *); // 
          ...
          /// \private
          static SgAsmCilInterfaceImplTable * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmCilInterfaceImplTable * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmCilInterfaceImplTable::operator delete (pointer,sizeof(SgAsmCilInterfaceImplTable));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmCilInterfaceImplTable* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmCilInterfaceImplTable* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmCilInterfaceImplTable* sgnode);
     ...
     public:
       ...
       */
       // SgAsmCilInterfaceImplTable( SgAsmCilInterfaceImplTableStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmCilInterfaceImplTableStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmCilInterfaceImplTable( const SgAsmCilInterfaceImplTableStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmCilInterfaceImplTable* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmCilInterfaceImplTable* isSgAsmCilInterfaceImplTable ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmCilInterfaceImplTable>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilInterfaceImplTable, std::vector<SgAsmCilInterfaceImpl*>,&SgAsmCilInterfaceImplTable::p_elements>;
...
// postdeclarations for SgAsmCilInterfaceImplTable

/* #line 508 "/workspace/generated/src/frontend/SageIII//SgAsmCilInterfaceImplTable.h" */
...
/* #line 515 "/workspace/generated/src/frontend/SageIII//SgAsmCilInterfaceImplTable.h" */

#endif // ROSE_SgAsmCilInterfaceImplTable_H
