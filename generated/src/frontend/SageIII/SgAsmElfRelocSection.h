...
#ifndef ROSE_SgAsmElfRelocSection_H
#define ROSE_SgAsmElfRelocSection_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmElfRelocSection

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmElfRelocSection.h" */
/* #line 21455 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// Class Definition for SgAsmElfRelocSection
class ROSE_DLL_API SgAsmElfRelocSection  : public SgAsmElfSection
   {
     public:


/* #line 46 "/workspace/generated/src/frontend/SageIII//SgAsmElfRelocSection.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 21487 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmElfRelocSection;
          enum { static_variant = V_SgAsmElfRelocSection };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmElfRelocSection* isSgAsmElfRelocSection(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmElfRelocSection* isSgAsmElfRelocSection( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmElfRelocSection * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmElfRelocSectionStorageClass *); // 
          ...
          /// \private
          static SgAsmElfRelocSection * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmElfRelocSection * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmElfRelocSection::operator delete (pointer,sizeof(SgAsmElfRelocSection));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmElfRelocSection* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmElfRelocSection* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmElfRelocSection* sgnode);
     ...
     public:
       ...
       */
       // SgAsmElfRelocSection( SgAsmElfRelocSectionStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmElfRelocSectionStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmElfRelocSection( const SgAsmElfRelocSectionStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmElfRelocSection* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmElfRelocSection* isSgAsmElfRelocSection ( SgNode* s );
...
// End of memberFunctionString
// Start of memberFunctionString
SgAsmElfSection* p_targetSection;
          
// End of memberFunctionString
// Start of memberFunctionString
SgAsmElfRelocEntryList* p_entries;
          
// End of memberFunctionString

    friend struct Rose::Traits::generated::describe_node_t<SgAsmElfRelocSection>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmElfRelocSection, bool,&SgAsmElfRelocSection::p_usesAddend>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmElfRelocSection, SgAsmElfSection*,&SgAsmElfRelocSection::p_targetSection>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmElfRelocSection, SgAsmElfRelocEntryList*,&SgAsmElfRelocSection::p_entries>;
...
// postdeclarations for SgAsmElfRelocSection

/* #line 580 "/workspace/generated/src/frontend/SageIII//SgAsmElfRelocSection.h" */
...
/* #line 587 "/workspace/generated/src/frontend/SageIII//SgAsmElfRelocSection.h" */

#endif // ROSE_SgAsmElfRelocSection_H
