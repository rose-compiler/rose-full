...
#ifndef ROSE_SgAsmStackExpression_H
#define ROSE_SgAsmStackExpression_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmStackExpression

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmStackExpression.h" */
...
// Class Definition for SgAsmStackExpression
class ROSE_DLL_API SgAsmStackExpression  : public SgAsmExpression
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmStackExpression.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 1536 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmStackExpression;
          enum { static_variant = V_SgAsmStackExpression };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmStackExpression* isSgAsmStackExpression(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmStackExpression* isSgAsmStackExpression( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmStackExpression * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmStackExpressionStorageClass *); // 
          ...
          /// \private
          static SgAsmStackExpression * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmStackExpression * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmStackExpression::operator delete (pointer,sizeof(SgAsmStackExpression));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmStackExpression* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmStackExpression* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmStackExpression* sgnode);
     ...
     public:
       ...
       */
       // SgAsmStackExpression( SgAsmStackExpressionStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmStackExpressionStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmStackExpression( const SgAsmStackExpressionStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmStackExpression* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmStackExpression* isSgAsmStackExpression ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmStackExpression>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmStackExpression, int,&SgAsmStackExpression::p_stackPosition>;
...
// postdeclarations for SgAsmStackExpression

/* #line 523 "/workspace/generated/src/frontend/SageIII//SgAsmStackExpression.h" */
...
/* #line 530 "/workspace/generated/src/frontend/SageIII//SgAsmStackExpression.h" */

#endif // ROSE_SgAsmStackExpression_H
