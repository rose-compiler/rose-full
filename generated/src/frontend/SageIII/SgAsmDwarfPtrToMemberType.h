...
#ifndef ROSE_SgAsmDwarfPtrToMemberType_H
#define ROSE_SgAsmDwarfPtrToMemberType_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmDwarfPtrToMemberType

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfPtrToMemberType.h" */
...
// Class Definition for SgAsmDwarfPtrToMemberType
class ROSE_DLL_API SgAsmDwarfPtrToMemberType  : public SgAsmDwarfConstruct
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfPtrToMemberType.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 25864 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmDwarfPtrToMemberType;
          enum { static_variant = V_SgAsmDwarfPtrToMemberType };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmDwarfPtrToMemberType* isSgAsmDwarfPtrToMemberType(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmDwarfPtrToMemberType* isSgAsmDwarfPtrToMemberType( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmDwarfPtrToMemberType * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmDwarfPtrToMemberTypeStorageClass *); // 
          ...
          /// \private
          static SgAsmDwarfPtrToMemberType * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmDwarfPtrToMemberType * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmDwarfPtrToMemberType::operator delete (pointer,sizeof(SgAsmDwarfPtrToMemberType));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmDwarfPtrToMemberType* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmDwarfPtrToMemberType* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmDwarfPtrToMemberType* sgnode);
     ...
     public:
       ...
       */
       // SgAsmDwarfPtrToMemberType( SgAsmDwarfPtrToMemberTypeStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmDwarfPtrToMemberTypeStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmDwarfPtrToMemberType( const SgAsmDwarfPtrToMemberTypeStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmDwarfPtrToMemberType* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmDwarfPtrToMemberType* isSgAsmDwarfPtrToMemberType ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmDwarfPtrToMemberType>;
...
// postdeclarations for SgAsmDwarfPtrToMemberType

/* #line 502 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfPtrToMemberType.h" */
...
/* #line 509 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfPtrToMemberType.h" */

#endif // ROSE_SgAsmDwarfPtrToMemberType_H
