...
#ifndef ROSE_SgAsmJvmLocalVariableTable_H
#define ROSE_SgAsmJvmLocalVariableTable_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmJvmLocalVariableTable

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmJvmLocalVariableTable.h" */
/* #line 11728 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// Class Definition for SgAsmJvmLocalVariableTable
class ROSE_DLL_API SgAsmJvmLocalVariableTable  : public SgAsmJvmAttribute
   {
     public:


/* #line 42 "/workspace/generated/src/frontend/SageIII//SgAsmJvmLocalVariableTable.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 11748 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmJvmLocalVariableTable;
          enum { static_variant = V_SgAsmJvmLocalVariableTable };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmJvmLocalVariableTable* isSgAsmJvmLocalVariableTable(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmJvmLocalVariableTable* isSgAsmJvmLocalVariableTable( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmJvmLocalVariableTable * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmJvmLocalVariableTableStorageClass *); // 
          ...
          /// \private
          static SgAsmJvmLocalVariableTable * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmJvmLocalVariableTable * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmJvmLocalVariableTable::operator delete (pointer,sizeof(SgAsmJvmLocalVariableTable));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmJvmLocalVariableTable* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmJvmLocalVariableTable* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmJvmLocalVariableTable* sgnode);
     ...
     public:
       ...
       */
       // SgAsmJvmLocalVariableTable( SgAsmJvmLocalVariableTableStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmJvmLocalVariableTableStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmJvmLocalVariableTable( const SgAsmJvmLocalVariableTableStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmJvmLocalVariableTable* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmJvmLocalVariableTable* isSgAsmJvmLocalVariableTable ( SgNode* s );
...
// End of memberFunctionString
    ...
    protected:
// Start of memberFunctionString
SgAsmJvmLocalVariableEntryPtrList p_local_variable_table;
          
// End of memberFunctionString

    friend struct Rose::Traits::generated::describe_node_t<SgAsmJvmLocalVariableTable>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmJvmLocalVariableTable, SgAsmJvmLocalVariableEntryPtrList,&SgAsmJvmLocalVariableTable::p_local_variable_table>;
...
// postdeclarations for SgAsmJvmLocalVariableTable

/* #line 531 "/workspace/generated/src/frontend/SageIII//SgAsmJvmLocalVariableTable.h" */
...
/* #line 538 "/workspace/generated/src/frontend/SageIII//SgAsmJvmLocalVariableTable.h" */

#endif // ROSE_SgAsmJvmLocalVariableTable_H
