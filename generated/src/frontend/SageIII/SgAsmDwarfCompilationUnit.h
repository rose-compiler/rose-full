...
#ifndef ROSE_SgAsmDwarfCompilationUnit_H
#define ROSE_SgAsmDwarfCompilationUnit_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmDwarfCompilationUnit

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfCompilationUnit.h" */
/* #line 28198 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// Class Definition for SgAsmDwarfCompilationUnit
class ROSE_DLL_API SgAsmDwarfCompilationUnit  : public SgAsmDwarfConstruct
   {
     public:


/* #line 46 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfCompilationUnit.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 28289 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
private:
    ...
    void serialize(S &s, const unsigned /*version*/) {
        ...
        s & BOOST_SERIALIZATION_NVP(p_type_signature);
        s & BOOST_SERIALIZATION_NVP(p_comp_dir);
...
public:
    std::string const& get_type_signature() const;
    void set_type_signature(std::string const&);
 // DQ (11/21/2025): Added support for Dwarf 4.
public:
    std::string const& get_comp_dir() const;
    void set_comp_dir(std::string const&);
 // DQ (11/21/2025): Added support for Dwarf 4.
public:
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmDwarfCompilationUnit;
          enum { static_variant = V_SgAsmDwarfCompilationUnit };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmDwarfCompilationUnit* isSgAsmDwarfCompilationUnit(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmDwarfCompilationUnit* isSgAsmDwarfCompilationUnit( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmDwarfCompilationUnit * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmDwarfCompilationUnitStorageClass *); // 
          ...
          /// \private
          static SgAsmDwarfCompilationUnit * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmDwarfCompilationUnit * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmDwarfCompilationUnit::operator delete (pointer,sizeof(SgAsmDwarfCompilationUnit));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmDwarfCompilationUnit* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmDwarfCompilationUnit* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmDwarfCompilationUnit* sgnode);
     ...
     public:
       ...
       */
       // SgAsmDwarfCompilationUnit( SgAsmDwarfCompilationUnitStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmDwarfCompilationUnitStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmDwarfCompilationUnit( const SgAsmDwarfCompilationUnitStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmDwarfCompilationUnit* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
// End of memberFunctionString
// Start of memberFunctionString
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */

     // the generated cast function
     // friend ROSE_DLL_API SgAsmDwarfCompilationUnit* isSgAsmDwarfCompilationUnit ( SgNode* s );

          typedef SgAsmDwarfConstruct base_node_type;
...
// End of memberFunctionString
// Start of memberFunctionString
uint64_t p_abbrev_offset;
          
// End of memberFunctionString
// Start of memberFunctionString
uint64_t p_address_size;
          
// End of memberFunctionString
// Start of memberFunctionString
uint64_t p_offset_length;
          
// End of memberFunctionString
// Start of memberFunctionString
std::string p_type_signature;
          
// End of memberFunctionString
// Start of memberFunctionString
std::string p_comp_dir;
          
// End of memberFunctionString
// Start of memberFunctionString
SgAsmDwarfLineList* p_line_info;
          
// End of memberFunctionString
// Start of memberFunctionString
SgAsmDwarfConstructList* p_language_constructs;
          
// End of memberFunctionString
// Start of memberFunctionString
SgAsmDwarfMacroList* p_macro_info;
          
// End of memberFunctionString

    friend struct Rose::Traits::generated::describe_node_t<SgAsmDwarfCompilationUnit>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmDwarfCompilationUnit, std::string,&SgAsmDwarfCompilationUnit::p_producer>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmDwarfCompilationUnit, std::string,&SgAsmDwarfCompilationUnit::p_language>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmDwarfCompilationUnit, uint64_t,&SgAsmDwarfCompilationUnit::p_low_pc>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmDwarfCompilationUnit, uint64_t,&SgAsmDwarfCompilationUnit::p_hi_pc>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmDwarfCompilationUnit, int,&SgAsmDwarfCompilationUnit::p_version_stamp>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmDwarfCompilationUnit, uint64_t,&SgAsmDwarfCompilationUnit::p_abbrev_offset>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmDwarfCompilationUnit, uint64_t,&SgAsmDwarfCompilationUnit::p_address_size>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmDwarfCompilationUnit, uint64_t,&SgAsmDwarfCompilationUnit::p_offset_length>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmDwarfCompilationUnit, std::string,&SgAsmDwarfCompilationUnit::p_type_signature>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmDwarfCompilationUnit, std::string,&SgAsmDwarfCompilationUnit::p_comp_dir>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmDwarfCompilationUnit, SgAsmDwarfLineList*,&SgAsmDwarfCompilationUnit::p_line_info>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmDwarfCompilationUnit, SgAsmDwarfConstructList*,&SgAsmDwarfCompilationUnit::p_language_constructs>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmDwarfCompilationUnit, SgAsmDwarfMacroList*,&SgAsmDwarfCompilationUnit::p_macro_info>;
...
// postdeclarations for SgAsmDwarfCompilationUnit

/* #line 654 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfCompilationUnit.h" */
...
/* #line 661 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfCompilationUnit.h" */

#endif // ROSE_SgAsmDwarfCompilationUnit_H
