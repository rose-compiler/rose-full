...
#ifndef ROSE_SgAsmDwarfEntryPoint_H
#define ROSE_SgAsmDwarfEntryPoint_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmDwarfEntryPoint

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfEntryPoint.h" */
...
// Class Definition for SgAsmDwarfEntryPoint
class ROSE_DLL_API SgAsmDwarfEntryPoint  : public SgAsmDwarfConstruct
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfEntryPoint.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 27767 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmDwarfEntryPoint;
          enum { static_variant = V_SgAsmDwarfEntryPoint };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmDwarfEntryPoint* isSgAsmDwarfEntryPoint(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmDwarfEntryPoint* isSgAsmDwarfEntryPoint( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmDwarfEntryPoint * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmDwarfEntryPointStorageClass *); // 
          ...
          /// \private
          static SgAsmDwarfEntryPoint * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmDwarfEntryPoint * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmDwarfEntryPoint::operator delete (pointer,sizeof(SgAsmDwarfEntryPoint));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmDwarfEntryPoint* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmDwarfEntryPoint* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmDwarfEntryPoint* sgnode);
     ...
     public:
       ...
       */
       // SgAsmDwarfEntryPoint( SgAsmDwarfEntryPointStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmDwarfEntryPointStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmDwarfEntryPoint( const SgAsmDwarfEntryPointStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmDwarfEntryPoint* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmDwarfEntryPoint* isSgAsmDwarfEntryPoint ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmDwarfEntryPoint>;
...
// postdeclarations for SgAsmDwarfEntryPoint

/* #line 502 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfEntryPoint.h" */
...
/* #line 509 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfEntryPoint.h" */

#endif // ROSE_SgAsmDwarfEntryPoint_H
