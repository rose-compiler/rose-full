...
#ifndef ROSE_SgAsmCilAssemblyTable_H
#define ROSE_SgAsmCilAssemblyTable_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmCilAssemblyTable

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmCilAssemblyTable.h" */
...
// Class Definition for SgAsmCilAssemblyTable
class ROSE_DLL_API SgAsmCilAssemblyTable  : public SgAsmCilMetadata
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmCilAssemblyTable.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 40632 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmCilAssemblyTable;
          enum { static_variant = V_SgAsmCilAssemblyTable };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmCilAssemblyTable* isSgAsmCilAssemblyTable(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmCilAssemblyTable* isSgAsmCilAssemblyTable( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmCilAssemblyTable * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmCilAssemblyTableStorageClass *); // 
          ...
          /// \private
          static SgAsmCilAssemblyTable * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmCilAssemblyTable * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmCilAssemblyTable::operator delete (pointer,sizeof(SgAsmCilAssemblyTable));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmCilAssemblyTable* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmCilAssemblyTable* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmCilAssemblyTable* sgnode);
     ...
     public:
       ...
       */
       // SgAsmCilAssemblyTable( SgAsmCilAssemblyTableStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmCilAssemblyTableStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmCilAssemblyTable( const SgAsmCilAssemblyTableStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmCilAssemblyTable* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmCilAssemblyTable* isSgAsmCilAssemblyTable ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmCilAssemblyTable>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilAssemblyTable, std::vector<SgAsmCilAssembly*>,&SgAsmCilAssemblyTable::p_elements>;
...
// postdeclarations for SgAsmCilAssemblyTable

/* #line 508 "/workspace/generated/src/frontend/SageIII//SgAsmCilAssemblyTable.h" */
...
/* #line 515 "/workspace/generated/src/frontend/SageIII//SgAsmCilAssemblyTable.h" */

#endif // ROSE_SgAsmCilAssemblyTable_H
