...
#ifndef ROSE_SgAsmBinaryConcat_H
#define ROSE_SgAsmBinaryConcat_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmBinaryConcat

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmBinaryConcat.h" */
...
// Class Definition for SgAsmBinaryConcat
class ROSE_DLL_API SgAsmBinaryConcat  : public SgAsmBinaryExpression
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmBinaryConcat.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 43142 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmBinaryConcat;
          enum { static_variant = V_SgAsmBinaryConcat };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmBinaryConcat* isSgAsmBinaryConcat(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmBinaryConcat* isSgAsmBinaryConcat( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmBinaryConcat * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmBinaryConcatStorageClass *); // 
          ...
          /// \private
          static SgAsmBinaryConcat * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmBinaryConcat * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmBinaryConcat::operator delete (pointer,sizeof(SgAsmBinaryConcat));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmBinaryConcat* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmBinaryConcat* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmBinaryConcat* sgnode);
     ...
     public:
       ...
       */
       // SgAsmBinaryConcat( SgAsmBinaryConcatStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmBinaryConcatStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmBinaryConcat( const SgAsmBinaryConcatStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmBinaryConcat* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmBinaryConcat* isSgAsmBinaryConcat ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmBinaryConcat>;
...
// postdeclarations for SgAsmBinaryConcat

/* #line 501 "/workspace/generated/src/frontend/SageIII//SgAsmBinaryConcat.h" */
...
/* #line 508 "/workspace/generated/src/frontend/SageIII//SgAsmBinaryConcat.h" */

#endif // ROSE_SgAsmBinaryConcat_H
