...
#ifndef ROSE_SgAsmJvmIndexedAttr_H
#define ROSE_SgAsmJvmIndexedAttr_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmJvmIndexedAttr

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmJvmIndexedAttr.h" */
/* #line 12462 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// Class Definition for SgAsmJvmIndexedAttr
class ROSE_DLL_API SgAsmJvmIndexedAttr  : public SgAsmJvmAttribute
   {
     public:


/* #line 42 "/workspace/generated/src/frontend/SageIII//SgAsmJvmIndexedAttr.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 12510 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmJvmIndexedAttr;
          enum { static_variant = V_SgAsmJvmIndexedAttr };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmJvmIndexedAttr* isSgAsmJvmIndexedAttr(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmJvmIndexedAttr* isSgAsmJvmIndexedAttr( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmJvmIndexedAttr * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmJvmIndexedAttrStorageClass *); // 
          ...
          /// \private
          static SgAsmJvmIndexedAttr * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmJvmIndexedAttr * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmJvmIndexedAttr::operator delete (pointer,sizeof(SgAsmJvmIndexedAttr));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmJvmIndexedAttr* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmJvmIndexedAttr* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmJvmIndexedAttr* sgnode);
     ...
     public:
       ...
       */
       // SgAsmJvmIndexedAttr( SgAsmJvmIndexedAttrStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmJvmIndexedAttrStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmJvmIndexedAttr( const SgAsmJvmIndexedAttrStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmJvmIndexedAttr* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmJvmIndexedAttr* isSgAsmJvmIndexedAttr ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmJvmIndexedAttr>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmJvmIndexedAttr, unsigned,&SgAsmJvmIndexedAttr::p_attribute_type>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmJvmIndexedAttr, uint16_t,&SgAsmJvmIndexedAttr::p_index>;
...
// postdeclarations for SgAsmJvmIndexedAttr

/* #line 568 "/workspace/generated/src/frontend/SageIII//SgAsmJvmIndexedAttr.h" */
...
/* #line 575 "/workspace/generated/src/frontend/SageIII//SgAsmJvmIndexedAttr.h" */

#endif // ROSE_SgAsmJvmIndexedAttr_H
