...
#ifndef ROSE_SgAsmDwarfFileType_H
#define ROSE_SgAsmDwarfFileType_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmDwarfFileType

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfFileType.h" */
...
// Class Definition for SgAsmDwarfFileType
class ROSE_DLL_API SgAsmDwarfFileType  : public SgAsmDwarfConstruct
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfFileType.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 27560 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmDwarfFileType;
          enum { static_variant = V_SgAsmDwarfFileType };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmDwarfFileType* isSgAsmDwarfFileType(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmDwarfFileType* isSgAsmDwarfFileType( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmDwarfFileType * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmDwarfFileTypeStorageClass *); // 
          ...
          /// \private
          static SgAsmDwarfFileType * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmDwarfFileType * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmDwarfFileType::operator delete (pointer,sizeof(SgAsmDwarfFileType));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmDwarfFileType* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmDwarfFileType* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmDwarfFileType* sgnode);
     ...
     public:
       ...
       */
       // SgAsmDwarfFileType( SgAsmDwarfFileTypeStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmDwarfFileTypeStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmDwarfFileType( const SgAsmDwarfFileTypeStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmDwarfFileType* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmDwarfFileType* isSgAsmDwarfFileType ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmDwarfFileType>;
...
// postdeclarations for SgAsmDwarfFileType

/* #line 502 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfFileType.h" */
...
/* #line 509 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfFileType.h" */

#endif // ROSE_SgAsmDwarfFileType_H
