...
#ifndef ROSE_SgAsmDwarfLexicalBlock_H
#define ROSE_SgAsmDwarfLexicalBlock_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmDwarfLexicalBlock

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfLexicalBlock.h" */
/* #line 26810 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// Class Definition for SgAsmDwarfLexicalBlock
class ROSE_DLL_API SgAsmDwarfLexicalBlock  : public SgAsmDwarfConstruct
   {
     public:


/* #line 44 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfLexicalBlock.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 26827 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmDwarfLexicalBlock;
          enum { static_variant = V_SgAsmDwarfLexicalBlock };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmDwarfLexicalBlock* isSgAsmDwarfLexicalBlock(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmDwarfLexicalBlock* isSgAsmDwarfLexicalBlock( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmDwarfLexicalBlock * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmDwarfLexicalBlockStorageClass *); // 
          ...
          /// \private
          static SgAsmDwarfLexicalBlock * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmDwarfLexicalBlock * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmDwarfLexicalBlock::operator delete (pointer,sizeof(SgAsmDwarfLexicalBlock));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmDwarfLexicalBlock* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmDwarfLexicalBlock* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmDwarfLexicalBlock* sgnode);
     ...
     public:
       ...
       */
       // SgAsmDwarfLexicalBlock( SgAsmDwarfLexicalBlockStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmDwarfLexicalBlockStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmDwarfLexicalBlock( const SgAsmDwarfLexicalBlockStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmDwarfLexicalBlock* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmDwarfLexicalBlock* isSgAsmDwarfLexicalBlock ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmDwarfLexicalBlock>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmDwarfLexicalBlock, SgAsmDwarfConstructList*,&SgAsmDwarfLexicalBlock::p_body>;
...
// postdeclarations for SgAsmDwarfLexicalBlock

/* #line 520 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfLexicalBlock.h" */
...
/* #line 527 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfLexicalBlock.h" */

#endif // ROSE_SgAsmDwarfLexicalBlock_H
