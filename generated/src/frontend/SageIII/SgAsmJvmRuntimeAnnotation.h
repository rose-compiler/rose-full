...
#ifndef ROSE_SgAsmJvmRuntimeAnnotation_H
#define ROSE_SgAsmJvmRuntimeAnnotation_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmJvmRuntimeAnnotation

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmJvmRuntimeAnnotation.h" */
...
// Class Definition for SgAsmJvmRuntimeAnnotation
class ROSE_DLL_API SgAsmJvmRuntimeAnnotation  : public SgAsmJvmNode
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmJvmRuntimeAnnotation.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 10612 "/workspace/src/ROSETTA/src/binaryInstruction.C" */


    //----------------------- Boost serialization for SgAsmJvmRuntimeAnnotation -----------------------
...
private:
    ...
    void serialize(S &s, const unsigned /*version*/) {
        debugSerializationBegin("SgAsmJvmRuntimeAnnotation");
        s & BOOST_SERIALIZATION_BASE_OBJECT_NVP(SgAsmJvmNode);
        s & BOOST_SERIALIZATION_NVP(p_type_index);
        s & BOOST_SERIALIZATION_NVP(p_element_value_pairs);
        debugSerializationEnd("SgAsmJvmRuntimeAnnotation");
    }
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmJvmRuntimeAnnotation;
          enum { static_variant = V_SgAsmJvmRuntimeAnnotation };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmJvmRuntimeAnnotation* isSgAsmJvmRuntimeAnnotation(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmJvmRuntimeAnnotation* isSgAsmJvmRuntimeAnnotation( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmJvmRuntimeAnnotation * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmJvmRuntimeAnnotationStorageClass *); // 
          ...
          /// \private
          static SgAsmJvmRuntimeAnnotation * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmJvmRuntimeAnnotation * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmJvmRuntimeAnnotation::operator delete (pointer,sizeof(SgAsmJvmRuntimeAnnotation));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmJvmRuntimeAnnotation* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmJvmRuntimeAnnotation* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmJvmRuntimeAnnotation* sgnode);
     ...
     public:
       ...
       */
       // SgAsmJvmRuntimeAnnotation( SgAsmJvmRuntimeAnnotationStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmJvmRuntimeAnnotationStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmJvmRuntimeAnnotation( const SgAsmJvmRuntimeAnnotationStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmJvmRuntimeAnnotation* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmJvmRuntimeAnnotation* isSgAsmJvmRuntimeAnnotation ( SgNode* s );
...
// End of memberFunctionString
    ...
    protected:
// Start of memberFunctionString
uint16_t p_type_index;
          
// End of memberFunctionString
// Start of memberFunctionString
std::vector<SgAsmJvmRuntimeAnnotationPair*> p_element_value_pairs;
          
// End of memberFunctionString

    friend struct Rose::Traits::generated::describe_node_t<SgAsmJvmRuntimeAnnotation>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmJvmRuntimeAnnotation, uint16_t,&SgAsmJvmRuntimeAnnotation::p_type_index>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmJvmRuntimeAnnotation, std::vector<SgAsmJvmRuntimeAnnotationPair*>,&SgAsmJvmRuntimeAnnotation::p_element_value_pairs>;
...
// postdeclarations for SgAsmJvmRuntimeAnnotation

/* #line 560 "/workspace/generated/src/frontend/SageIII//SgAsmJvmRuntimeAnnotation.h" */
...
/* #line 567 "/workspace/generated/src/frontend/SageIII//SgAsmJvmRuntimeAnnotation.h" */

#endif // ROSE_SgAsmJvmRuntimeAnnotation_H
