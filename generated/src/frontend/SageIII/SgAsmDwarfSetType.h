...
#ifndef ROSE_SgAsmDwarfSetType_H
#define ROSE_SgAsmDwarfSetType_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmDwarfSetType

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfSetType.h" */
...
// Class Definition for SgAsmDwarfSetType
class ROSE_DLL_API SgAsmDwarfSetType  : public SgAsmDwarfConstruct
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfSetType.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 25687 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmDwarfSetType;
          enum { static_variant = V_SgAsmDwarfSetType };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmDwarfSetType* isSgAsmDwarfSetType(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmDwarfSetType* isSgAsmDwarfSetType( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmDwarfSetType * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmDwarfSetTypeStorageClass *); // 
          ...
          /// \private
          static SgAsmDwarfSetType * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmDwarfSetType * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmDwarfSetType::operator delete (pointer,sizeof(SgAsmDwarfSetType));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmDwarfSetType* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmDwarfSetType* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmDwarfSetType* sgnode);
     ...
     public:
       ...
       */
       // SgAsmDwarfSetType( SgAsmDwarfSetTypeStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmDwarfSetTypeStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmDwarfSetType( const SgAsmDwarfSetTypeStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmDwarfSetType* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmDwarfSetType* isSgAsmDwarfSetType ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmDwarfSetType>;
...
// postdeclarations for SgAsmDwarfSetType

/* #line 502 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfSetType.h" */
...
/* #line 509 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfSetType.h" */

#endif // ROSE_SgAsmDwarfSetType_H
