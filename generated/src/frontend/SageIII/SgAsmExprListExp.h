...
#ifndef ROSE_SgAsmExprListExp_H
#define ROSE_SgAsmExprListExp_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmExprListExp

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmExprListExp.h" */
/* #line 18112 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// Class Definition for SgAsmExprListExp
class ROSE_DLL_API SgAsmExprListExp  : public SgAsmExpression
   {
     public:


/* #line 42 "/workspace/generated/src/frontend/SageIII//SgAsmExprListExp.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 18128 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmExprListExp;
          enum { static_variant = V_SgAsmExprListExp };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmExprListExp* isSgAsmExprListExp(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmExprListExp* isSgAsmExprListExp( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmExprListExp * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmExprListExpStorageClass *); // 
          ...
          /// \private
          static SgAsmExprListExp * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmExprListExp * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmExprListExp::operator delete (pointer,sizeof(SgAsmExprListExp));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmExprListExp* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmExprListExp* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmExprListExp* sgnode);
     ...
     public:
       ...
       */
       // SgAsmExprListExp( SgAsmExprListExpStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmExprListExpStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmExprListExp( const SgAsmExprListExpStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmExprListExp* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmExprListExp* isSgAsmExprListExp ( SgNode* s );
...
// End of memberFunctionString
    ...
    protected:
// Start of memberFunctionString
SgAsmExpressionPtrList p_expressions;
          
// End of memberFunctionString

    friend struct Rose::Traits::generated::describe_node_t<SgAsmExprListExp>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmExprListExp, SgAsmExpressionPtrList,&SgAsmExprListExp::p_expressions>;
...
// postdeclarations for SgAsmExprListExp

/* #line 519 "/workspace/generated/src/frontend/SageIII//SgAsmExprListExp.h" */
...
/* #line 526 "/workspace/generated/src/frontend/SageIII//SgAsmExprListExp.h" */

#endif // ROSE_SgAsmExprListExp_H
