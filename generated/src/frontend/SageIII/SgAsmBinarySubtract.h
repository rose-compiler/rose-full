...
#ifndef ROSE_SgAsmBinarySubtract_H
#define ROSE_SgAsmBinarySubtract_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmBinarySubtract

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmBinarySubtract.h" */
...
// Class Definition for SgAsmBinarySubtract
class ROSE_DLL_API SgAsmBinarySubtract  : public SgAsmBinaryExpression
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmBinarySubtract.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 42544 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmBinarySubtract* isSgAsmBinarySubtract(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmBinarySubtract* isSgAsmBinarySubtract( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmBinarySubtract * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmBinarySubtractStorageClass *); // 
          ...
          /// \private
          static SgAsmBinarySubtract * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmBinarySubtract * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmBinarySubtract::operator delete (pointer,sizeof(SgAsmBinarySubtract));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmBinarySubtract* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmBinarySubtract* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmBinarySubtract* sgnode);
     ...
     public:
       ...
       */
       // SgAsmBinarySubtract( SgAsmBinarySubtractStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmBinarySubtractStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmBinarySubtract( const SgAsmBinarySubtractStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmBinarySubtract* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmBinarySubtract* isSgAsmBinarySubtract ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmBinarySubtract>;
...
// postdeclarations for SgAsmBinarySubtract

/* #line 501 "/workspace/generated/src/frontend/SageIII//SgAsmBinarySubtract.h" */
...
/* #line 508 "/workspace/generated/src/frontend/SageIII//SgAsmBinarySubtract.h" */

#endif // ROSE_SgAsmBinarySubtract_H
