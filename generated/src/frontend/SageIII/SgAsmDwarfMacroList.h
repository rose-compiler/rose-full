...
#ifndef ROSE_SgAsmDwarfMacroList_H
#define ROSE_SgAsmDwarfMacroList_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmDwarfMacroList

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfMacroList.h" */
/* #line 26481 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// Class Definition for SgAsmDwarfMacroList
class ROSE_DLL_API SgAsmDwarfMacroList  : public SgAsmDwarfInformation
   {
     public:


/* #line 42 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfMacroList.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 26496 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmDwarfMacroList;
          enum { static_variant = V_SgAsmDwarfMacroList };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmDwarfMacroList* isSgAsmDwarfMacroList(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmDwarfMacroList* isSgAsmDwarfMacroList( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmDwarfMacroList * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmDwarfMacroListStorageClass *); // 
          ...
          /// \private
          static SgAsmDwarfMacroList * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmDwarfMacroList * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmDwarfMacroList::operator delete (pointer,sizeof(SgAsmDwarfMacroList));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmDwarfMacroList* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmDwarfMacroList* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmDwarfMacroList* sgnode);
     ...
     public:
       ...
       */
       // SgAsmDwarfMacroList( SgAsmDwarfMacroListStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmDwarfMacroListStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmDwarfMacroList( const SgAsmDwarfMacroListStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmDwarfMacroList* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmDwarfMacroList* isSgAsmDwarfMacroList ( SgNode* s );
...
// End of memberFunctionString
    ...
    protected:
// Start of memberFunctionString
SgAsmDwarfMacroPtrList p_macro_list;
          
// End of memberFunctionString

    friend struct Rose::Traits::generated::describe_node_t<SgAsmDwarfMacroList>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmDwarfMacroList, SgAsmDwarfMacroPtrList,&SgAsmDwarfMacroList::p_macro_list>;
...
// postdeclarations for SgAsmDwarfMacroList

/* #line 511 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfMacroList.h" */
...
/* #line 518 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfMacroList.h" */

#endif // ROSE_SgAsmDwarfMacroList_H
