...
#ifndef ROSE_SgAsmBinaryMultiply_H
#define ROSE_SgAsmBinaryMultiply_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmBinaryMultiply

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmBinaryMultiply.h" */
...
class ROSE_DLL_API SgAsmBinaryMultiply  : public SgAsmBinaryExpression
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmBinaryMultiply.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 42786 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmBinaryMultiply* isSgAsmBinaryMultiply(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmBinaryMultiply* isSgAsmBinaryMultiply( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmBinaryMultiply * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmBinaryMultiplyStorageClass *); // 
          ...
          /// \private
          static SgAsmBinaryMultiply * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmBinaryMultiply * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmBinaryMultiply::operator delete (pointer,sizeof(SgAsmBinaryMultiply));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmBinaryMultiply* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmBinaryMultiply* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmBinaryMultiply* sgnode);
     ...
     public:
       ...
       */
       // SgAsmBinaryMultiply( SgAsmBinaryMultiplyStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmBinaryMultiplyStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmBinaryMultiply( const SgAsmBinaryMultiplyStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmBinaryMultiply* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmBinaryMultiply* isSgAsmBinaryMultiply ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmBinaryMultiply>;
...
// postdeclarations for SgAsmBinaryMultiply

/* #line 501 "/workspace/generated/src/frontend/SageIII//SgAsmBinaryMultiply.h" */
...
/* #line 508 "/workspace/generated/src/frontend/SageIII//SgAsmBinaryMultiply.h" */

#endif // ROSE_SgAsmBinaryMultiply_H
