...
#ifndef ROSE_SgAsmDwarfAccessDeclaration_H
#define ROSE_SgAsmDwarfAccessDeclaration_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmDwarfAccessDeclaration

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfAccessDeclaration.h" */
...
// Class Definition for SgAsmDwarfAccessDeclaration
class ROSE_DLL_API SgAsmDwarfAccessDeclaration  : public SgAsmDwarfConstruct
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfAccessDeclaration.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 28884 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmDwarfAccessDeclaration;
          enum { static_variant = V_SgAsmDwarfAccessDeclaration };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmDwarfAccessDeclaration* isSgAsmDwarfAccessDeclaration(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmDwarfAccessDeclaration* isSgAsmDwarfAccessDeclaration( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmDwarfAccessDeclaration * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmDwarfAccessDeclarationStorageClass *); // 
          ...
          /// \private
          static SgAsmDwarfAccessDeclaration * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmDwarfAccessDeclaration * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmDwarfAccessDeclaration::operator delete (pointer,sizeof(SgAsmDwarfAccessDeclaration));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmDwarfAccessDeclaration* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmDwarfAccessDeclaration* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmDwarfAccessDeclaration* sgnode);
     ...
     public:
       ...
       */
       // SgAsmDwarfAccessDeclaration( SgAsmDwarfAccessDeclarationStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmDwarfAccessDeclarationStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmDwarfAccessDeclaration( const SgAsmDwarfAccessDeclarationStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmDwarfAccessDeclaration* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmDwarfAccessDeclaration* isSgAsmDwarfAccessDeclaration ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmDwarfAccessDeclaration>;
...
// postdeclarations for SgAsmDwarfAccessDeclaration

/* #line 502 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfAccessDeclaration.h" */
...
/* #line 509 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfAccessDeclaration.h" */

#endif // ROSE_SgAsmDwarfAccessDeclaration_H
