...
#ifndef ROSE_SgAsmDwarfVolatileType_H
#define ROSE_SgAsmDwarfVolatileType_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmDwarfVolatileType

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfVolatileType.h" */
...
// Class Definition for SgAsmDwarfVolatileType
class ROSE_DLL_API SgAsmDwarfVolatileType  : public SgAsmDwarfConstruct
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfVolatileType.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 24257 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmDwarfVolatileType;
          enum { static_variant = V_SgAsmDwarfVolatileType };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmDwarfVolatileType* isSgAsmDwarfVolatileType(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmDwarfVolatileType* isSgAsmDwarfVolatileType( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmDwarfVolatileType * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmDwarfVolatileTypeStorageClass *); // 
          ...
          /// \private
          static SgAsmDwarfVolatileType * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmDwarfVolatileType * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmDwarfVolatileType::operator delete (pointer,sizeof(SgAsmDwarfVolatileType));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmDwarfVolatileType* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmDwarfVolatileType* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmDwarfVolatileType* sgnode);
     ...
     public:
       ...
       */
       // SgAsmDwarfVolatileType( SgAsmDwarfVolatileTypeStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmDwarfVolatileTypeStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmDwarfVolatileType( const SgAsmDwarfVolatileTypeStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmDwarfVolatileType* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmDwarfVolatileType* isSgAsmDwarfVolatileType ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmDwarfVolatileType>;
...
// postdeclarations for SgAsmDwarfVolatileType

/* #line 502 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfVolatileType.h" */
...
/* #line 509 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfVolatileType.h" */

#endif // ROSE_SgAsmDwarfVolatileType_H
