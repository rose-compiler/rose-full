...
#ifndef ROSE_SgAsmSynthesizedFieldDeclaration_H
#define ROSE_SgAsmSynthesizedFieldDeclaration_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmSynthesizedFieldDeclaration

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmSynthesizedFieldDeclaration.h" */
/* #line 1025 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// Class Definition for SgAsmSynthesizedFieldDeclaration
class ROSE_DLL_API SgAsmSynthesizedFieldDeclaration  : public SgAsmSynthesizedDeclaration
   {
     public:


/* #line 42 "/workspace/generated/src/frontend/SageIII//SgAsmSynthesizedFieldDeclaration.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 1046 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmSynthesizedFieldDeclaration;
          enum { static_variant = V_SgAsmSynthesizedFieldDeclaration };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmSynthesizedFieldDeclaration* isSgAsmSynthesizedFieldDeclaration(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmSynthesizedFieldDeclaration* isSgAsmSynthesizedFieldDeclaration( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmSynthesizedFieldDeclaration * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmSynthesizedFieldDeclarationStorageClass *); // 
          ...
          /// \private
          static SgAsmSynthesizedFieldDeclaration * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmSynthesizedFieldDeclaration * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmSynthesizedFieldDeclaration::operator delete (pointer,sizeof(SgAsmSynthesizedFieldDeclaration));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmSynthesizedFieldDeclaration* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmSynthesizedFieldDeclaration* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmSynthesizedFieldDeclaration* sgnode);
     ...
     public:
       ...
       */
       // SgAsmSynthesizedFieldDeclaration( SgAsmSynthesizedFieldDeclarationStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmSynthesizedFieldDeclarationStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmSynthesizedFieldDeclaration( const SgAsmSynthesizedFieldDeclarationStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmSynthesizedFieldDeclaration* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmSynthesizedFieldDeclaration* isSgAsmSynthesizedFieldDeclaration ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmSynthesizedFieldDeclaration>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmSynthesizedFieldDeclaration, std::string,&SgAsmSynthesizedFieldDeclaration::p_name>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmSynthesizedFieldDeclaration, uint64_t,&SgAsmSynthesizedFieldDeclaration::p_offset>;
...
// postdeclarations for SgAsmSynthesizedFieldDeclaration

/* #line 535 "/workspace/generated/src/frontend/SageIII//SgAsmSynthesizedFieldDeclaration.h" */
...
/* #line 542 "/workspace/generated/src/frontend/SageIII//SgAsmSynthesizedFieldDeclaration.h" */

#endif // ROSE_SgAsmSynthesizedFieldDeclaration_H
