...
#ifndef ROSE_SgAsmCilTypeDef_H
#define ROSE_SgAsmCilTypeDef_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmCilTypeDef

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmCilTypeDef.h" */
...
// Class Definition for SgAsmCilTypeDef
class ROSE_DLL_API SgAsmCilTypeDef  : public SgAsmCilMetadata
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmCilTypeDef.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 33376 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmCilTypeDef;
          enum { static_variant = V_SgAsmCilTypeDef };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmCilTypeDef* isSgAsmCilTypeDef(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmCilTypeDef* isSgAsmCilTypeDef( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmCilTypeDef * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmCilTypeDefStorageClass *); // 
          ...
          /// \private
          static SgAsmCilTypeDef * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmCilTypeDef * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmCilTypeDef::operator delete (pointer,sizeof(SgAsmCilTypeDef));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmCilTypeDef* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmCilTypeDef* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmCilTypeDef* sgnode);
     ...
     public:
       ...
       */
       // SgAsmCilTypeDef( SgAsmCilTypeDefStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmCilTypeDefStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmCilTypeDef( const SgAsmCilTypeDefStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmCilTypeDef* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmCilTypeDef* isSgAsmCilTypeDef ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmCilTypeDef>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilTypeDef, uint32_t,&SgAsmCilTypeDef::p_Flags>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilTypeDef, uint32_t,&SgAsmCilTypeDef::p_TypeName>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilTypeDef, uint32_t,&SgAsmCilTypeDef::p_TypeNamespace>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilTypeDef, uint32_t,&SgAsmCilTypeDef::p_Extends>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilTypeDef, uint32_t,&SgAsmCilTypeDef::p_FieldList>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilTypeDef, uint32_t,&SgAsmCilTypeDef::p_MethodList>;
...
// postdeclarations for SgAsmCilTypeDef

/* #line 660 "/workspace/generated/src/frontend/SageIII//SgAsmCilTypeDef.h" */
...
/* #line 667 "/workspace/generated/src/frontend/SageIII//SgAsmCilTypeDef.h" */

#endif // ROSE_SgAsmCilTypeDef_H
