...
#ifndef ROSE_SgAsmDwarfEnumerationType_H
#define ROSE_SgAsmDwarfEnumerationType_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmDwarfEnumerationType

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfEnumerationType.h" */
/* #line 27674 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// Class Definition for SgAsmDwarfEnumerationType
class ROSE_DLL_API SgAsmDwarfEnumerationType  : public SgAsmDwarfConstruct
   {
     public:


/* #line 44 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfEnumerationType.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 27697 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
private:
    ...
    void serialize(S &s, const unsigned /*version*/) {
        ...
        s & BOOST_SERIALIZATION_NVP(p_is_enum_class);
...
public:
    bool const& get_is_enum_class() const;
    void set_is_enum_class(bool const&);
public:
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmDwarfEnumerationType;
          enum { static_variant = V_SgAsmDwarfEnumerationType };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmDwarfEnumerationType* isSgAsmDwarfEnumerationType(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmDwarfEnumerationType* isSgAsmDwarfEnumerationType( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmDwarfEnumerationType * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmDwarfEnumerationTypeStorageClass *); // 
          ...
          /// \private
          static SgAsmDwarfEnumerationType * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmDwarfEnumerationType * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmDwarfEnumerationType::operator delete (pointer,sizeof(SgAsmDwarfEnumerationType));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmDwarfEnumerationType* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmDwarfEnumerationType* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmDwarfEnumerationType* sgnode);
     ...
     public:
       ...
       */
       // SgAsmDwarfEnumerationType( SgAsmDwarfEnumerationTypeStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmDwarfEnumerationTypeStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmDwarfEnumerationType( const SgAsmDwarfEnumerationTypeStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmDwarfEnumerationType* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmDwarfEnumerationType* isSgAsmDwarfEnumerationType ( SgNode* s );
...
// End of memberFunctionString
// Start of memberFunctionString
bool p_is_enum_class;
          
// End of memberFunctionString

    friend struct Rose::Traits::generated::describe_node_t<SgAsmDwarfEnumerationType>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmDwarfEnumerationType, SgAsmDwarfConstructList*,&SgAsmDwarfEnumerationType::p_body>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmDwarfEnumerationType, bool,&SgAsmDwarfEnumerationType::p_is_enum_class>;
...
// postdeclarations for SgAsmDwarfEnumerationType

/* #line 531 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfEnumerationType.h" */
...
/* #line 538 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfEnumerationType.h" */

#endif // ROSE_SgAsmDwarfEnumerationType_H
