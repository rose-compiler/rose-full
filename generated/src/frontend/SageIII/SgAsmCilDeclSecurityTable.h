...
#ifndef ROSE_SgAsmCilDeclSecurityTable_H
#define ROSE_SgAsmCilDeclSecurityTable_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmCilDeclSecurityTable

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmCilDeclSecurityTable.h" */
...
// Class Definition for SgAsmCilDeclSecurityTable
class ROSE_DLL_API SgAsmCilDeclSecurityTable  : public SgAsmCilMetadata
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmCilDeclSecurityTable.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 39744 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmCilDeclSecurityTable;
          enum { static_variant = V_SgAsmCilDeclSecurityTable };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmCilDeclSecurityTable* isSgAsmCilDeclSecurityTable(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmCilDeclSecurityTable* isSgAsmCilDeclSecurityTable( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmCilDeclSecurityTable * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmCilDeclSecurityTableStorageClass *); // 
          ...
          /// \private
          static SgAsmCilDeclSecurityTable * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmCilDeclSecurityTable * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmCilDeclSecurityTable::operator delete (pointer,sizeof(SgAsmCilDeclSecurityTable));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmCilDeclSecurityTable* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmCilDeclSecurityTable* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmCilDeclSecurityTable* sgnode);
     ...
     public:
       ...
       */
       // SgAsmCilDeclSecurityTable( SgAsmCilDeclSecurityTableStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmCilDeclSecurityTableStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmCilDeclSecurityTable( const SgAsmCilDeclSecurityTableStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmCilDeclSecurityTable* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmCilDeclSecurityTable* isSgAsmCilDeclSecurityTable ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmCilDeclSecurityTable>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilDeclSecurityTable, std::vector<SgAsmCilDeclSecurity*>,&SgAsmCilDeclSecurityTable::p_elements>;
...
// postdeclarations for SgAsmCilDeclSecurityTable

/* #line 508 "/workspace/generated/src/frontend/SageIII//SgAsmCilDeclSecurityTable.h" */
...
/* #line 515 "/workspace/generated/src/frontend/SageIII//SgAsmCilDeclSecurityTable.h" */

#endif // ROSE_SgAsmCilDeclSecurityTable_H
