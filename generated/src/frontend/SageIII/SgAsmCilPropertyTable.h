...
#ifndef ROSE_SgAsmCilPropertyTable_H
#define ROSE_SgAsmCilPropertyTable_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmCilPropertyTable

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmCilPropertyTable.h" */
...
// Class Definition for SgAsmCilPropertyTable
class ROSE_DLL_API SgAsmCilPropertyTable  : public SgAsmCilMetadata
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmCilPropertyTable.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 33706 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmCilPropertyTable;
          enum { static_variant = V_SgAsmCilPropertyTable };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmCilPropertyTable* isSgAsmCilPropertyTable(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmCilPropertyTable* isSgAsmCilPropertyTable( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmCilPropertyTable * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmCilPropertyTableStorageClass *); // 
          ...
          /// \private
          static SgAsmCilPropertyTable * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmCilPropertyTable * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmCilPropertyTable::operator delete (pointer,sizeof(SgAsmCilPropertyTable));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmCilPropertyTable* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmCilPropertyTable* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmCilPropertyTable* sgnode);
     ...
     public:
       ...
       */
       // SgAsmCilPropertyTable( SgAsmCilPropertyTableStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmCilPropertyTableStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmCilPropertyTable( const SgAsmCilPropertyTableStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmCilPropertyTable* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmCilPropertyTable* isSgAsmCilPropertyTable ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmCilPropertyTable>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilPropertyTable, std::vector<SgAsmCilProperty*>,&SgAsmCilPropertyTable::p_elements>;
...
// postdeclarations for SgAsmCilPropertyTable

/* #line 508 "/workspace/generated/src/frontend/SageIII//SgAsmCilPropertyTable.h" */
...
/* #line 515 "/workspace/generated/src/frontend/SageIII//SgAsmCilPropertyTable.h" */

#endif // ROSE_SgAsmCilPropertyTable_H
