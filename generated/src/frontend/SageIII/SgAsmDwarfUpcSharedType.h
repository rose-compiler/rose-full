...
#ifndef ROSE_SgAsmDwarfUpcSharedType_H
#define ROSE_SgAsmDwarfUpcSharedType_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmDwarfUpcSharedType

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfUpcSharedType.h" */
...
// Class Definition for SgAsmDwarfUpcSharedType
class ROSE_DLL_API SgAsmDwarfUpcSharedType  : public SgAsmDwarfConstruct
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfUpcSharedType.h" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmDwarfUpcSharedType;
          enum { static_variant = V_SgAsmDwarfUpcSharedType };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmDwarfUpcSharedType* isSgAsmDwarfUpcSharedType(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmDwarfUpcSharedType* isSgAsmDwarfUpcSharedType( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmDwarfUpcSharedType * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmDwarfUpcSharedTypeStorageClass *); // 
          ...
          /// \private
          static SgAsmDwarfUpcSharedType * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmDwarfUpcSharedType * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmDwarfUpcSharedType::operator delete (pointer,sizeof(SgAsmDwarfUpcSharedType));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmDwarfUpcSharedType* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmDwarfUpcSharedType* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmDwarfUpcSharedType* sgnode);
     ...
     public:
       ...
       */
       // SgAsmDwarfUpcSharedType( SgAsmDwarfUpcSharedTypeStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmDwarfUpcSharedTypeStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmDwarfUpcSharedType( const SgAsmDwarfUpcSharedTypeStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmDwarfUpcSharedType* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmDwarfUpcSharedType* isSgAsmDwarfUpcSharedType ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmDwarfUpcSharedType>;
...
// postdeclarations for SgAsmDwarfUpcSharedType

/* #line 502 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfUpcSharedType.h" */
...
/* #line 509 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfUpcSharedType.h" */

#endif // ROSE_SgAsmDwarfUpcSharedType_H
