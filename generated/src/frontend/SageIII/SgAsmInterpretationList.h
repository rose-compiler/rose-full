...
#ifndef ROSE_SgAsmInterpretationList_H
#define ROSE_SgAsmInterpretationList_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmInterpretationList

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmInterpretationList.h" */
/* #line 14892 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// Class Definition for SgAsmInterpretationList
class ROSE_DLL_API SgAsmInterpretationList  : public SgAsmNode
   {
     public:


/* #line 42 "/workspace/generated/src/frontend/SageIII//SgAsmInterpretationList.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 14907 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmInterpretationList;
          enum { static_variant = V_SgAsmInterpretationList };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmInterpretationList* isSgAsmInterpretationList(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmInterpretationList* isSgAsmInterpretationList( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmInterpretationList * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmInterpretationListStorageClass *); // 
          ...
          /// \private
          static SgAsmInterpretationList * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmInterpretationList * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmInterpretationList::operator delete (pointer,sizeof(SgAsmInterpretationList));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmInterpretationList* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmInterpretationList* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmInterpretationList* sgnode);
     ...
     public:
       ...
       */
       // SgAsmInterpretationList( SgAsmInterpretationListStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmInterpretationListStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmInterpretationList( const SgAsmInterpretationListStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmInterpretationList* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmInterpretationList* isSgAsmInterpretationList ( SgNode* s );
...
// End of memberFunctionString
    ...
    protected:
// Start of memberFunctionString
SgAsmInterpretationPtrList p_interpretations;
          
// End of memberFunctionString

    friend struct Rose::Traits::generated::describe_node_t<SgAsmInterpretationList>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmInterpretationList, SgAsmInterpretationPtrList,&SgAsmInterpretationList::p_interpretations>;
...
// postdeclarations for SgAsmInterpretationList

/* #line 519 "/workspace/generated/src/frontend/SageIII//SgAsmInterpretationList.h" */
...
/* #line 526 "/workspace/generated/src/frontend/SageIII//SgAsmInterpretationList.h" */

#endif // ROSE_SgAsmInterpretationList_H
