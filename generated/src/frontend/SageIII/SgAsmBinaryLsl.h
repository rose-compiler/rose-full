...
#ifndef ROSE_SgAsmBinaryLsl_H
#define ROSE_SgAsmBinaryLsl_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmBinaryLsl

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmBinaryLsl.h" */
...
// Class Definition for SgAsmBinaryLsl
class ROSE_DLL_API SgAsmBinaryLsl  : public SgAsmBinaryExpression
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmBinaryLsl.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 43024 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmBinaryLsl* isSgAsmBinaryLsl(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmBinaryLsl* isSgAsmBinaryLsl( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmBinaryLsl * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmBinaryLslStorageClass *); // 
          ...
          /// \private
          static SgAsmBinaryLsl * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmBinaryLsl * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmBinaryLsl::operator delete (pointer,sizeof(SgAsmBinaryLsl));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmBinaryLsl* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmBinaryLsl* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmBinaryLsl* sgnode);
     ...
     public:
       ...
       */
       // SgAsmBinaryLsl( SgAsmBinaryLslStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmBinaryLslStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmBinaryLsl( const SgAsmBinaryLslStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmBinaryLsl* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmBinaryLsl* isSgAsmBinaryLsl ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmBinaryLsl>;
...
// postdeclarations for SgAsmBinaryLsl

/* #line 501 "/workspace/generated/src/frontend/SageIII//SgAsmBinaryLsl.h" */
...
/* #line 508 "/workspace/generated/src/frontend/SageIII//SgAsmBinaryLsl.h" */

#endif // ROSE_SgAsmBinaryLsl_H
