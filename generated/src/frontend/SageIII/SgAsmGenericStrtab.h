...
#ifndef ROSE_SgAsmGenericStrtab_H
#define ROSE_SgAsmGenericStrtab_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmGenericStrtab

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmGenericStrtab.h" */
/* #line 31505 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// Class Definition for SgAsmGenericStrtab
class ROSE_DLL_API SgAsmGenericStrtab  : public SgAsmExecutableFileFormat
   {
     public:


/* #line 43 "/workspace/generated/src/frontend/SageIII//SgAsmGenericStrtab.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 31546 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmGenericStrtab;
          enum { static_variant = V_SgAsmGenericStrtab };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmGenericStrtab* isSgAsmGenericStrtab(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmGenericStrtab* isSgAsmGenericStrtab( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmGenericStrtab * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmGenericStrtabStorageClass *); // 
          ...
          /// \private
          static SgAsmGenericStrtab * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmGenericStrtab * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmGenericStrtab::operator delete (pointer,sizeof(SgAsmGenericStrtab));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmGenericStrtab* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmGenericStrtab* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmGenericStrtab* sgnode);
     ...
     public:
       ...
       */
       // SgAsmGenericStrtab( SgAsmGenericStrtabStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmGenericStrtabStorageClass;
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmGenericStrtab* isSgAsmGenericStrtab ( SgNode* s );
...
// End of memberFunctionString
// Start of memberFunctionString
SgAsmGenericStrtab::referenced_t p_storageList;
          
// End of memberFunctionString
// Start of memberFunctionString
Rose::BinaryAnalysis::AddressIntervalSet p_freeList;
          
// End of memberFunctionString
// Start of memberFunctionString
SgAsmStringStorage* p_dontFree;
          
// End of memberFunctionString
// Start of memberFunctionString
size_t p_numberFreed;
          
// End of memberFunctionString

    friend struct Rose::Traits::generated::describe_node_t<SgAsmGenericStrtab>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmGenericStrtab, SgAsmGenericSection*,&SgAsmGenericStrtab::p_container>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmGenericStrtab, SgAsmGenericStrtab::referenced_t,&SgAsmGenericStrtab::p_storageList>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmGenericStrtab, Rose::BinaryAnalysis::AddressIntervalSet,&SgAsmGenericStrtab::p_freeList>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmGenericStrtab, SgAsmStringStorage*,&SgAsmGenericStrtab::p_dontFree>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmGenericStrtab, size_t,&SgAsmGenericStrtab::p_numberFreed>;
...
// postdeclarations for SgAsmGenericStrtab

/* #line 649 "/workspace/generated/src/frontend/SageIII//SgAsmGenericStrtab.h" */
...
/* #line 656 "/workspace/generated/src/frontend/SageIII//SgAsmGenericStrtab.h" */

#endif // ROSE_SgAsmGenericStrtab_H
