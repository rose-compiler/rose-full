...
#ifndef ROSE_SgAsmCilPropertyMap_H
#define ROSE_SgAsmCilPropertyMap_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmCilPropertyMap

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmCilPropertyMap.h" */
...
// Class Definition for SgAsmCilPropertyMap
class ROSE_DLL_API SgAsmCilPropertyMap  : public SgAsmCilMetadata
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmCilPropertyMap.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 33844 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmCilPropertyMap;
          enum { static_variant = V_SgAsmCilPropertyMap };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmCilPropertyMap* isSgAsmCilPropertyMap(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmCilPropertyMap* isSgAsmCilPropertyMap( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmCilPropertyMap * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmCilPropertyMapStorageClass *); // 
          ...
          /// \private
          static SgAsmCilPropertyMap * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmCilPropertyMap * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmCilPropertyMap::operator delete (pointer,sizeof(SgAsmCilPropertyMap));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmCilPropertyMap* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmCilPropertyMap* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmCilPropertyMap* sgnode);
     ...
     public:
       ...
       */
       // SgAsmCilPropertyMap( SgAsmCilPropertyMapStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmCilPropertyMapStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmCilPropertyMap( const SgAsmCilPropertyMapStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmCilPropertyMap* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmCilPropertyMap* isSgAsmCilPropertyMap ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmCilPropertyMap>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilPropertyMap, uint32_t,&SgAsmCilPropertyMap::p_Parent>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilPropertyMap, uint32_t,&SgAsmCilPropertyMap::p_PropertyList>;
...
// postdeclarations for SgAsmCilPropertyMap

/* #line 536 "/workspace/generated/src/frontend/SageIII//SgAsmCilPropertyMap.h" */
...
/* #line 543 "/workspace/generated/src/frontend/SageIII//SgAsmCilPropertyMap.h" */

#endif // ROSE_SgAsmCilPropertyMap_H
