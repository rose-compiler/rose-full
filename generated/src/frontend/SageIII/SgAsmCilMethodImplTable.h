...
#ifndef ROSE_SgAsmCilMethodImplTable_H
#define ROSE_SgAsmCilMethodImplTable_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmCilMethodImplTable

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmCilMethodImplTable.h" */
...
// Class Definition for SgAsmCilMethodImplTable
class ROSE_DLL_API SgAsmCilMethodImplTable  : public SgAsmCilMetadata
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmCilMethodImplTable.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 35071 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmCilMethodImplTable;
          enum { static_variant = V_SgAsmCilMethodImplTable };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmCilMethodImplTable* isSgAsmCilMethodImplTable(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmCilMethodImplTable* isSgAsmCilMethodImplTable( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmCilMethodImplTable * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmCilMethodImplTableStorageClass *); // 
          ...
          /// \private
          static SgAsmCilMethodImplTable * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmCilMethodImplTable * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmCilMethodImplTable::operator delete (pointer,sizeof(SgAsmCilMethodImplTable));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmCilMethodImplTable* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmCilMethodImplTable* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmCilMethodImplTable* sgnode);
     ...
     public:
       ...
       */
       // SgAsmCilMethodImplTable( SgAsmCilMethodImplTableStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmCilMethodImplTableStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmCilMethodImplTable( const SgAsmCilMethodImplTableStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmCilMethodImplTable* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmCilMethodImplTable* isSgAsmCilMethodImplTable ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmCilMethodImplTable>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilMethodImplTable, std::vector<SgAsmCilMethodImpl*>,&SgAsmCilMethodImplTable::p_elements>;
...
// postdeclarations for SgAsmCilMethodImplTable

/* #line 508 "/workspace/generated/src/frontend/SageIII//SgAsmCilMethodImplTable.h" */
...
/* #line 515 "/workspace/generated/src/frontend/SageIII//SgAsmCilMethodImplTable.h" */

#endif // ROSE_SgAsmCilMethodImplTable_H
