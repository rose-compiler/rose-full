...
#ifndef ROSE_SgAsmElfEHFrameEntryFDList_H
#define ROSE_SgAsmElfEHFrameEntryFDList_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmElfEHFrameEntryFDList

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmElfEHFrameEntryFDList.h" */
/* #line 22896 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// Class Definition for SgAsmElfEHFrameEntryFDList
class ROSE_DLL_API SgAsmElfEHFrameEntryFDList  : public SgAsmExecutableFileFormat
   {
     public:


/* #line 42 "/workspace/generated/src/frontend/SageIII//SgAsmElfEHFrameEntryFDList.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 22915 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmElfEHFrameEntryFDList;
          enum { static_variant = V_SgAsmElfEHFrameEntryFDList };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmElfEHFrameEntryFDList* isSgAsmElfEHFrameEntryFDList(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmElfEHFrameEntryFDList* isSgAsmElfEHFrameEntryFDList( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmElfEHFrameEntryFDList * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmElfEHFrameEntryFDListStorageClass *); // 
          ...
          /// \private
          static SgAsmElfEHFrameEntryFDList * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmElfEHFrameEntryFDList * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmElfEHFrameEntryFDList::operator delete (pointer,sizeof(SgAsmElfEHFrameEntryFDList));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmElfEHFrameEntryFDList* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmElfEHFrameEntryFDList* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmElfEHFrameEntryFDList* sgnode);
     ...
     public:
       ...
       */
       // SgAsmElfEHFrameEntryFDList( SgAsmElfEHFrameEntryFDListStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmElfEHFrameEntryFDListStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmElfEHFrameEntryFDList( const SgAsmElfEHFrameEntryFDListStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmElfEHFrameEntryFDList* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmElfEHFrameEntryFDList* isSgAsmElfEHFrameEntryFDList ( SgNode* s );
...
// End of memberFunctionString
    ...
    protected:
// Start of memberFunctionString
SgAsmElfEHFrameEntryFDPtrList p_entries;
          
// End of memberFunctionString

    friend struct Rose::Traits::generated::describe_node_t<SgAsmElfEHFrameEntryFDList>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmElfEHFrameEntryFDList, SgAsmElfEHFrameEntryFDPtrList,&SgAsmElfEHFrameEntryFDList::p_entries>;
...
// postdeclarations for SgAsmElfEHFrameEntryFDList

/* #line 516 "/workspace/generated/src/frontend/SageIII//SgAsmElfEHFrameEntryFDList.h" */
...
/* #line 523 "/workspace/generated/src/frontend/SageIII//SgAsmElfEHFrameEntryFDList.h" */

#endif // ROSE_SgAsmElfEHFrameEntryFDList_H
