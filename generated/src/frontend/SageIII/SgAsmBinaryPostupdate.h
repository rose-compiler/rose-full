...
#ifndef ROSE_SgAsmBinaryPostupdate_H
#define ROSE_SgAsmBinaryPostupdate_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmBinaryPostupdate

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmBinaryPostupdate.h" */
...
// Class Definition for SgAsmBinaryPostupdate
class ROSE_DLL_API SgAsmBinaryPostupdate  : public SgAsmBinaryExpression
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmBinaryPostupdate.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 42727 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmBinaryPostupdate;
          enum { static_variant = V_SgAsmBinaryPostupdate };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmBinaryPostupdate* isSgAsmBinaryPostupdate(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmBinaryPostupdate* isSgAsmBinaryPostupdate( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmBinaryPostupdate * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmBinaryPostupdateStorageClass *); // 
          ...
          /// \private
          static SgAsmBinaryPostupdate * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmBinaryPostupdate * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmBinaryPostupdate::operator delete (pointer,sizeof(SgAsmBinaryPostupdate));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmBinaryPostupdate* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmBinaryPostupdate* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmBinaryPostupdate* sgnode);
     ...
     public:
       ...
       */
       // SgAsmBinaryPostupdate( SgAsmBinaryPostupdateStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmBinaryPostupdateStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmBinaryPostupdate( const SgAsmBinaryPostupdateStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmBinaryPostupdate* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmBinaryPostupdate* isSgAsmBinaryPostupdate ( SgNode* s );

          typedef SgAsmBinaryExpression base_node_type;
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmBinaryPostupdate>;
...
// postdeclarations for SgAsmBinaryPostupdate

/* #line 501 "/workspace/generated/src/frontend/SageIII//SgAsmBinaryPostupdate.h" */
...
/* #line 508 "/workspace/generated/src/frontend/SageIII//SgAsmBinaryPostupdate.h" */

#endif // ROSE_SgAsmBinaryPostupdate_H
