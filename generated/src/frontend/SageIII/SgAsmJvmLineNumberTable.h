...
#ifndef ROSE_SgAsmJvmLineNumberTable_H
#define ROSE_SgAsmJvmLineNumberTable_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmJvmLineNumberTable

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmJvmLineNumberTable.h" */
/* #line 11984 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// Class Definition for SgAsmJvmLineNumberTable
class ROSE_DLL_API SgAsmJvmLineNumberTable  : public SgAsmJvmAttribute
   {
     public:


/* #line 42 "/workspace/generated/src/frontend/SageIII//SgAsmJvmLineNumberTable.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 12004 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmJvmLineNumberTable;
          enum { static_variant = V_SgAsmJvmLineNumberTable };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmJvmLineNumberTable* isSgAsmJvmLineNumberTable(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmJvmLineNumberTable* isSgAsmJvmLineNumberTable( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmJvmLineNumberTable * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmJvmLineNumberTableStorageClass *); // 
          ...
          /// \private
          static SgAsmJvmLineNumberTable * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmJvmLineNumberTable * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmJvmLineNumberTable::operator delete (pointer,sizeof(SgAsmJvmLineNumberTable));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmJvmLineNumberTable* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmJvmLineNumberTable* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmJvmLineNumberTable* sgnode);
     ...
     public:
       ...
       */
       // SgAsmJvmLineNumberTable( SgAsmJvmLineNumberTableStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmJvmLineNumberTableStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmJvmLineNumberTable( const SgAsmJvmLineNumberTableStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmJvmLineNumberTable* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmJvmLineNumberTable* isSgAsmJvmLineNumberTable ( SgNode* s );
...
// End of memberFunctionString
    ...
    protected:
// Start of memberFunctionString
std::vector<SgAsmJvmLineNumberTable::Entry*> p_line_number_table;
          
// End of memberFunctionString

    friend struct Rose::Traits::generated::describe_node_t<SgAsmJvmLineNumberTable>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmJvmLineNumberTable, std::vector<SgAsmJvmLineNumberTable::Entry*>,&SgAsmJvmLineNumberTable::p_line_number_table>;
...
// postdeclarations for SgAsmJvmLineNumberTable

/* #line 553 "/workspace/generated/src/frontend/SageIII//SgAsmJvmLineNumberTable.h" */
...
/* #line 560 "/workspace/generated/src/frontend/SageIII//SgAsmJvmLineNumberTable.h" */

#endif // ROSE_SgAsmJvmLineNumberTable_H
