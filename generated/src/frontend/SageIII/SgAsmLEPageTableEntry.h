...
#ifndef ROSE_SgAsmLEPageTableEntry_H
#define ROSE_SgAsmLEPageTableEntry_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmLEPageTableEntry

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmLEPageTableEntry.h" */
/* #line 8105 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// Class Definition for SgAsmLEPageTableEntry
class ROSE_DLL_API SgAsmLEPageTableEntry  : public SgAsmExecutableFileFormat
   {
     public:


/* #line 42 "/workspace/generated/src/frontend/SageIII//SgAsmLEPageTableEntry.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 8126 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmLEPageTableEntry;
          enum { static_variant = V_SgAsmLEPageTableEntry };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmLEPageTableEntry* isSgAsmLEPageTableEntry(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmLEPageTableEntry* isSgAsmLEPageTableEntry( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmLEPageTableEntry * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmLEPageTableEntryStorageClass *); // 
          ...
          /// \private
          static SgAsmLEPageTableEntry * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmLEPageTableEntry * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmLEPageTableEntry::operator delete (pointer,sizeof(SgAsmLEPageTableEntry));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmLEPageTableEntry* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmLEPageTableEntry* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmLEPageTableEntry* sgnode);
     ...
     public:
       ...
       */
       // SgAsmLEPageTableEntry( SgAsmLEPageTableEntryStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmLEPageTableEntryStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmLEPageTableEntry( const SgAsmLEPageTableEntryStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmLEPageTableEntry* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmLEPageTableEntry* isSgAsmLEPageTableEntry ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmLEPageTableEntry>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmLEPageTableEntry, unsigned,&SgAsmLEPageTableEntry::p_pageno>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmLEPageTableEntry, unsigned,&SgAsmLEPageTableEntry::p_flags>;
...
// postdeclarations for SgAsmLEPageTableEntry

/* #line 562 "/workspace/generated/src/frontend/SageIII//SgAsmLEPageTableEntry.h" */
...
/* #line 569 "/workspace/generated/src/frontend/SageIII//SgAsmLEPageTableEntry.h" */

#endif // ROSE_SgAsmLEPageTableEntry_H
