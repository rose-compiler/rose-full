...
#ifndef ROSE_SgAsmDwarfUnknownConstruct_H
#define ROSE_SgAsmDwarfUnknownConstruct_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmDwarfUnknownConstruct

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfUnknownConstruct.h" */
...
// Class Definition for SgAsmDwarfUnknownConstruct
class ROSE_DLL_API SgAsmDwarfUnknownConstruct  : public SgAsmDwarfConstruct
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfUnknownConstruct.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 24811 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmDwarfUnknownConstruct;
          enum { static_variant = V_SgAsmDwarfUnknownConstruct };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmDwarfUnknownConstruct* isSgAsmDwarfUnknownConstruct(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmDwarfUnknownConstruct* isSgAsmDwarfUnknownConstruct( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmDwarfUnknownConstruct * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmDwarfUnknownConstructStorageClass *); // 
          ...
          /// \private
          static SgAsmDwarfUnknownConstruct * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmDwarfUnknownConstruct * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmDwarfUnknownConstruct::operator delete (pointer,sizeof(SgAsmDwarfUnknownConstruct));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmDwarfUnknownConstruct* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmDwarfUnknownConstruct* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmDwarfUnknownConstruct* sgnode);
     ...
     public:
       ...
       */
       // SgAsmDwarfUnknownConstruct( SgAsmDwarfUnknownConstructStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmDwarfUnknownConstructStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmDwarfUnknownConstruct( const SgAsmDwarfUnknownConstructStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmDwarfUnknownConstruct* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmDwarfUnknownConstruct* isSgAsmDwarfUnknownConstruct ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmDwarfUnknownConstruct>;
...
// postdeclarations for SgAsmDwarfUnknownConstruct

/* #line 502 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfUnknownConstruct.h" */
...
/* #line 509 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfUnknownConstruct.h" */

#endif // ROSE_SgAsmDwarfUnknownConstruct_H
