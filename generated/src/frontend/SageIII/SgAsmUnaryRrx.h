...
#ifndef ROSE_SgAsmUnaryRrx_H
#define ROSE_SgAsmUnaryRrx_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmUnaryRrx

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmUnaryRrx.h" */
/* #line 756 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
class ROSE_DLL_API SgAsmUnaryRrx  : public SgAsmUnaryExpression
   {
     public:


/* #line 42 "/workspace/generated/src/frontend/SageIII//SgAsmUnaryRrx.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 765 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmUnaryRrx* isSgAsmUnaryRrx(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmUnaryRrx* isSgAsmUnaryRrx( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmUnaryRrx * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmUnaryRrxStorageClass *); // 
          ...
          /// \private
          static SgAsmUnaryRrx * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmUnaryRrx * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmUnaryRrx::operator delete (pointer,sizeof(SgAsmUnaryRrx));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmUnaryRrx* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmUnaryRrx* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmUnaryRrx* sgnode);
     ...
     public:
       ...
       */
       // SgAsmUnaryRrx( SgAsmUnaryRrxStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmUnaryRrxStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmUnaryRrx( const SgAsmUnaryRrxStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmUnaryRrx* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmUnaryRrx* isSgAsmUnaryRrx ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmUnaryRrx>;
...
// postdeclarations for SgAsmUnaryRrx

/* #line 504 "/workspace/generated/src/frontend/SageIII//SgAsmUnaryRrx.h" */
...
/* #line 511 "/workspace/generated/src/frontend/SageIII//SgAsmUnaryRrx.h" */

#endif // ROSE_SgAsmUnaryRrx_H
