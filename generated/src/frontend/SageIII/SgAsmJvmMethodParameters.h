...
#ifndef ROSE_SgAsmJvmMethodParameters_H
#define ROSE_SgAsmJvmMethodParameters_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmJvmMethodParameters

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmJvmMethodParameters.h" */
/* #line 11111 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// Class Definition for SgAsmJvmMethodParameters
class ROSE_DLL_API SgAsmJvmMethodParameters  : public SgAsmJvmAttribute
   {
     public:


/* #line 42 "/workspace/generated/src/frontend/SageIII//SgAsmJvmMethodParameters.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 11131 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmJvmMethodParameters;
          enum { static_variant = V_SgAsmJvmMethodParameters };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmJvmMethodParameters* isSgAsmJvmMethodParameters(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmJvmMethodParameters* isSgAsmJvmMethodParameters( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmJvmMethodParameters * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmJvmMethodParametersStorageClass *); // 
          ...
          /// \private
          static SgAsmJvmMethodParameters * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmJvmMethodParameters * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmJvmMethodParameters::operator delete (pointer,sizeof(SgAsmJvmMethodParameters));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmJvmMethodParameters* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmJvmMethodParameters* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmJvmMethodParameters* sgnode);
     ...
     public:
       ...
       */
       // SgAsmJvmMethodParameters( SgAsmJvmMethodParametersStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmJvmMethodParametersStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmJvmMethodParameters( const SgAsmJvmMethodParametersStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmJvmMethodParameters* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmJvmMethodParameters* isSgAsmJvmMethodParameters ( SgNode* s );
...
// End of memberFunctionString
    ...
    protected:
// Start of memberFunctionString
SgAsmJvmMethodParametersEntryPtrList p_parameters;
          
// End of memberFunctionString

    friend struct Rose::Traits::generated::describe_node_t<SgAsmJvmMethodParameters>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmJvmMethodParameters, SgAsmJvmMethodParametersEntryPtrList,&SgAsmJvmMethodParameters::p_parameters>;
...
// postdeclarations for SgAsmJvmMethodParameters

/* #line 531 "/workspace/generated/src/frontend/SageIII//SgAsmJvmMethodParameters.h" */
...
/* #line 538 "/workspace/generated/src/frontend/SageIII//SgAsmJvmMethodParameters.h" */

#endif // ROSE_SgAsmJvmMethodParameters_H
