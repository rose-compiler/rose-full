...
#ifndef ROSE_SgAsmJvmStackMapTable_H
#define ROSE_SgAsmJvmStackMapTable_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmJvmStackMapTable

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmJvmStackMapTable.h" */
/* #line 9531 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// Class Definition for SgAsmJvmStackMapTable
class ROSE_DLL_API SgAsmJvmStackMapTable  : public SgAsmJvmAttribute
   {
     public:


/* #line 42 "/workspace/generated/src/frontend/SageIII//SgAsmJvmStackMapTable.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 9550 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmJvmStackMapTable;
          enum { static_variant = V_SgAsmJvmStackMapTable };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmJvmStackMapTable* isSgAsmJvmStackMapTable(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmJvmStackMapTable* isSgAsmJvmStackMapTable( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmJvmStackMapTable * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmJvmStackMapTableStorageClass *); // 
          ...
          /// \private
          static SgAsmJvmStackMapTable * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmJvmStackMapTable * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmJvmStackMapTable::operator delete (pointer,sizeof(SgAsmJvmStackMapTable));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmJvmStackMapTable* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmJvmStackMapTable* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmJvmStackMapTable* sgnode);
     ...
     public:
       ...
       */
       // SgAsmJvmStackMapTable( SgAsmJvmStackMapTableStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmJvmStackMapTableStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmJvmStackMapTable( const SgAsmJvmStackMapTableStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmJvmStackMapTable* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmJvmStackMapTable* isSgAsmJvmStackMapTable ( SgNode* s );
...
// End of memberFunctionString
    ...
    protected:
// Start of memberFunctionString
SgAsmJvmStackMapFramePtrList p_entries;
          
// End of memberFunctionString

    friend struct Rose::Traits::generated::describe_node_t<SgAsmJvmStackMapTable>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmJvmStackMapTable, SgAsmJvmStackMapFramePtrList,&SgAsmJvmStackMapTable::p_entries>;
...
// postdeclarations for SgAsmJvmStackMapTable

/* #line 535 "/workspace/generated/src/frontend/SageIII//SgAsmJvmStackMapTable.h" */
...
/* #line 542 "/workspace/generated/src/frontend/SageIII//SgAsmJvmStackMapTable.h" */

#endif // ROSE_SgAsmJvmStackMapTable_H
