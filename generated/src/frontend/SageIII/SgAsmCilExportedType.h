...
#ifndef ROSE_SgAsmCilExportedType_H
#define ROSE_SgAsmCilExportedType_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmCilExportedType

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmCilExportedType.h" */
...
// Class Definition for SgAsmCilExportedType
class ROSE_DLL_API SgAsmCilExportedType  : public SgAsmCilMetadata
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmCilExportedType.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 39064 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmCilExportedType;
          enum { static_variant = V_SgAsmCilExportedType };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmCilExportedType* isSgAsmCilExportedType(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmCilExportedType* isSgAsmCilExportedType( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmCilExportedType * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmCilExportedTypeStorageClass *); // 
          ...
          /// \private
          static SgAsmCilExportedType * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmCilExportedType * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmCilExportedType::operator delete (pointer,sizeof(SgAsmCilExportedType));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmCilExportedType* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmCilExportedType* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmCilExportedType* sgnode);
     ...
     public:
       ...
       */
       // SgAsmCilExportedType( SgAsmCilExportedTypeStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmCilExportedTypeStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmCilExportedType( const SgAsmCilExportedTypeStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmCilExportedType* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmCilExportedType* isSgAsmCilExportedType ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmCilExportedType>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilExportedType, uint32_t,&SgAsmCilExportedType::p_EventFlags>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilExportedType, uint32_t,&SgAsmCilExportedType::p_TypeDefIdName>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilExportedType, uint32_t,&SgAsmCilExportedType::p_TypeName>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilExportedType, uint32_t,&SgAsmCilExportedType::p_TypeNamespace>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilExportedType, uint32_t,&SgAsmCilExportedType::p_Implementation>;
...
// postdeclarations for SgAsmCilExportedType

/* #line 588 "/workspace/generated/src/frontend/SageIII//SgAsmCilExportedType.h" */
...
/* #line 595 "/workspace/generated/src/frontend/SageIII//SgAsmCilExportedType.h" */

#endif // ROSE_SgAsmCilExportedType_H
