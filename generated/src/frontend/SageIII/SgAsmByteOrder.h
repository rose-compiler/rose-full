...
#ifndef ROSE_SgAsmByteOrder_H
#define ROSE_SgAsmByteOrder_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmByteOrder

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmByteOrder.h" */
/* #line 42061 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// Class Definition for SgAsmByteOrder
class ROSE_DLL_API SgAsmByteOrder  : public SgAsmExpression
   {
     public:


/* #line 42 "/workspace/generated/src/frontend/SageIII//SgAsmByteOrder.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 42071 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmByteOrder;
          enum { static_variant = V_SgAsmByteOrder };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmByteOrder* isSgAsmByteOrder(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmByteOrder* isSgAsmByteOrder( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmByteOrder * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmByteOrderStorageClass *); // 
          ...
          /// \private
          static SgAsmByteOrder * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmByteOrder * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmByteOrder::operator delete (pointer,sizeof(SgAsmByteOrder));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmByteOrder* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmByteOrder* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmByteOrder* sgnode);
     ...
     public:
       ...
       */
       // SgAsmByteOrder( SgAsmByteOrderStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmByteOrderStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmByteOrder( const SgAsmByteOrderStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmByteOrder* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmByteOrder* isSgAsmByteOrder ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmByteOrder>;
...
// postdeclarations for SgAsmByteOrder

/* #line 516 "/workspace/generated/src/frontend/SageIII//SgAsmByteOrder.h" */
...
/* #line 523 "/workspace/generated/src/frontend/SageIII//SgAsmByteOrder.h" */

#endif // ROSE_SgAsmByteOrder_H
