...
#ifndef ROSE_SgAsmCilModuleRefTable_H
#define ROSE_SgAsmCilModuleRefTable_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmCilModuleRefTable

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmCilModuleRefTable.h" */
...
// Class Definition for SgAsmCilModuleRefTable
class ROSE_DLL_API SgAsmCilModuleRefTable  : public SgAsmCilMetadata
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmCilModuleRefTable.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 34445 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmCilModuleRefTable;
          enum { static_variant = V_SgAsmCilModuleRefTable };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmCilModuleRefTable* isSgAsmCilModuleRefTable(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmCilModuleRefTable* isSgAsmCilModuleRefTable( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmCilModuleRefTable * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmCilModuleRefTableStorageClass *); // 
          ...
          /// \private
          static SgAsmCilModuleRefTable * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmCilModuleRefTable * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmCilModuleRefTable::operator delete (pointer,sizeof(SgAsmCilModuleRefTable));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmCilModuleRefTable* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmCilModuleRefTable* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmCilModuleRefTable* sgnode);
     ...
     public:
       ...
       */
       // SgAsmCilModuleRefTable( SgAsmCilModuleRefTableStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmCilModuleRefTableStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmCilModuleRefTable( const SgAsmCilModuleRefTableStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmCilModuleRefTable* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmCilModuleRefTable* isSgAsmCilModuleRefTable ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmCilModuleRefTable>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilModuleRefTable, std::vector<SgAsmCilModuleRef*>,&SgAsmCilModuleRefTable::p_elements>;
...
// postdeclarations for SgAsmCilModuleRefTable

/* #line 508 "/workspace/generated/src/frontend/SageIII//SgAsmCilModuleRefTable.h" */
...
/* #line 515 "/workspace/generated/src/frontend/SageIII//SgAsmCilModuleRefTable.h" */

#endif // ROSE_SgAsmCilModuleRefTable_H
