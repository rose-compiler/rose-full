...
#ifndef ROSE_SgAsmDwarfClassTemplate_H
#define ROSE_SgAsmDwarfClassTemplate_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmDwarfClassTemplate

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfClassTemplate.h" */
...
// Class Definition for SgAsmDwarfClassTemplate
class ROSE_DLL_API SgAsmDwarfClassTemplate  : public SgAsmDwarfConstruct
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfClassTemplate.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 28629 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmDwarfClassTemplate;
          enum { static_variant = V_SgAsmDwarfClassTemplate };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmDwarfClassTemplate* isSgAsmDwarfClassTemplate(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmDwarfClassTemplate* isSgAsmDwarfClassTemplate( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmDwarfClassTemplate * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmDwarfClassTemplateStorageClass *); // 
          ...
          /// \private
          static SgAsmDwarfClassTemplate * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmDwarfClassTemplate * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmDwarfClassTemplate::operator delete (pointer,sizeof(SgAsmDwarfClassTemplate));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmDwarfClassTemplate* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmDwarfClassTemplate* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmDwarfClassTemplate* sgnode);
     ...
     public:
       ...
       */
       // SgAsmDwarfClassTemplate( SgAsmDwarfClassTemplateStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmDwarfClassTemplateStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmDwarfClassTemplate( const SgAsmDwarfClassTemplateStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmDwarfClassTemplate* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmDwarfClassTemplate* isSgAsmDwarfClassTemplate ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmDwarfClassTemplate>;
...
// postdeclarations for SgAsmDwarfClassTemplate

/* #line 502 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfClassTemplate.h" */
...
/* #line 509 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfClassTemplate.h" */

#endif // ROSE_SgAsmDwarfClassTemplate_H
