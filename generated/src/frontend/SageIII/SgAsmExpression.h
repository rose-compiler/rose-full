...
#ifndef ROSE_SgAsmExpression_H
#define ROSE_SgAsmExpression_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmExpression

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmExpression.h" */
...
// Class Definition for SgAsmExpression
class ROSE_DLL_API SgAsmExpression  : public SgAsmNode
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmExpression.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 45662 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmExpression* isSgAsmExpression(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmExpression* isSgAsmExpression( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmExpression * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmExpressionStorageClass *); // 
          ...
          /// \private
          static SgAsmExpression * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmExpression * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmExpression::operator delete (pointer,sizeof(SgAsmExpression));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmExpression* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmExpression* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmExpression* sgnode);
     ...
     public:
       ...
       */
       // SgAsmExpression( SgAsmExpressionStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmExpressionStorageClass;
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmExpression* isSgAsmExpression ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmExpression>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmExpression, SgAsmType*,&SgAsmExpression::p_type>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmExpression, std::string,&SgAsmExpression::p_comment>;
...
// postdeclarations for SgAsmExpression

/* #line 557 "/workspace/generated/src/frontend/SageIII//SgAsmExpression.h" */
...
/* #line 564 "/workspace/generated/src/frontend/SageIII//SgAsmExpression.h" */

#endif // ROSE_SgAsmExpression_H
