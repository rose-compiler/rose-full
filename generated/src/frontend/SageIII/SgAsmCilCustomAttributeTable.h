...
#ifndef ROSE_SgAsmCilCustomAttributeTable_H
#define ROSE_SgAsmCilCustomAttributeTable_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmCilCustomAttributeTable

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmCilCustomAttributeTable.h" */
...
// Class Definition for SgAsmCilCustomAttributeTable
class ROSE_DLL_API SgAsmCilCustomAttributeTable  : public SgAsmCilMetadata
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmCilCustomAttributeTable.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 40084 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmCilCustomAttributeTable;
          enum { static_variant = V_SgAsmCilCustomAttributeTable };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmCilCustomAttributeTable* isSgAsmCilCustomAttributeTable(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmCilCustomAttributeTable* isSgAsmCilCustomAttributeTable( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmCilCustomAttributeTable * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmCilCustomAttributeTableStorageClass *); // 
          ...
          /// \private
          static SgAsmCilCustomAttributeTable * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmCilCustomAttributeTable * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmCilCustomAttributeTable::operator delete (pointer,sizeof(SgAsmCilCustomAttributeTable));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmCilCustomAttributeTable* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmCilCustomAttributeTable* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmCilCustomAttributeTable* sgnode);
     ...
     public:
       ...
       */
       // SgAsmCilCustomAttributeTable( SgAsmCilCustomAttributeTableStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmCilCustomAttributeTableStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmCilCustomAttributeTable( const SgAsmCilCustomAttributeTableStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmCilCustomAttributeTable* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmCilCustomAttributeTable* isSgAsmCilCustomAttributeTable ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmCilCustomAttributeTable>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilCustomAttributeTable, std::vector<SgAsmCilCustomAttribute*>,&SgAsmCilCustomAttributeTable::p_elements>;
...
// postdeclarations for SgAsmCilCustomAttributeTable

/* #line 508 "/workspace/generated/src/frontend/SageIII//SgAsmCilCustomAttributeTable.h" */
...
/* #line 515 "/workspace/generated/src/frontend/SageIII//SgAsmCilCustomAttributeTable.h" */

#endif // ROSE_SgAsmCilCustomAttributeTable_H
