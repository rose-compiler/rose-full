...
#ifndef ROSE_SgAsmDwarfEnumerator_H
#define ROSE_SgAsmDwarfEnumerator_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmDwarfEnumerator

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfEnumerator.h" */
...
// Class Definition for SgAsmDwarfEnumerator
class ROSE_DLL_API SgAsmDwarfEnumerator  : public SgAsmDwarfConstruct
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfEnumerator.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 27619 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmDwarfEnumerator;
          enum { static_variant = V_SgAsmDwarfEnumerator };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmDwarfEnumerator* isSgAsmDwarfEnumerator(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmDwarfEnumerator* isSgAsmDwarfEnumerator( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmDwarfEnumerator * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmDwarfEnumeratorStorageClass *); // 
          ...
          /// \private
          static SgAsmDwarfEnumerator * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmDwarfEnumerator * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmDwarfEnumerator::operator delete (pointer,sizeof(SgAsmDwarfEnumerator));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmDwarfEnumerator* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmDwarfEnumerator* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmDwarfEnumerator* sgnode);
     ...
     public:
       ...
       */
       // SgAsmDwarfEnumerator( SgAsmDwarfEnumeratorStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmDwarfEnumeratorStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmDwarfEnumerator( const SgAsmDwarfEnumeratorStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmDwarfEnumerator* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmDwarfEnumerator* isSgAsmDwarfEnumerator ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmDwarfEnumerator>;
...
// postdeclarations for SgAsmDwarfEnumerator

/* #line 502 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfEnumerator.h" */
...
/* #line 509 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfEnumerator.h" */

#endif // ROSE_SgAsmDwarfEnumerator_H
