...
#ifndef ROSE_SgAsmJvmConstantValue_H
#define ROSE_SgAsmJvmConstantValue_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmJvmConstantValue

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmJvmConstantValue.h" */
...
// Class Definition for SgAsmJvmConstantValue
class ROSE_DLL_API SgAsmJvmConstantValue  : public SgAsmJvmAttribute
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmJvmConstantValue.h" */

          virtual SgNode* copy ( SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 12829 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmJvmConstantValue;
          enum { static_variant = V_SgAsmJvmConstantValue };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmJvmConstantValue* isSgAsmJvmConstantValue(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmJvmConstantValue* isSgAsmJvmConstantValue( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmJvmConstantValue * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmJvmConstantValueStorageClass *); // 
          ...
          /// \private
          static SgAsmJvmConstantValue * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmJvmConstantValue * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmJvmConstantValue::operator delete (pointer,sizeof(SgAsmJvmConstantValue));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmJvmConstantValue* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmJvmConstantValue* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmJvmConstantValue* sgnode);
     ...
     public:
       ...
       */
       // SgAsmJvmConstantValue( SgAsmJvmConstantValueStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmJvmConstantValueStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmJvmConstantValue( const SgAsmJvmConstantValueStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmJvmConstantValue* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 670 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmJvmConstantValue* isSgAsmJvmConstantValue ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmJvmConstantValue>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmJvmConstantValue, uint16_t,&SgAsmJvmConstantValue::p_constantvalue_index>;
...
// postdeclarations for SgAsmJvmConstantValue

/* #line 526 "/workspace/generated/src/frontend/SageIII//SgAsmJvmConstantValue.h" */
...
/* #line 533 "/workspace/generated/src/frontend/SageIII//SgAsmJvmConstantValue.h" */

#endif // ROSE_SgAsmJvmConstantValue_H
