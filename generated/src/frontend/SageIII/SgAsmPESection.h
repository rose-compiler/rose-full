...
#ifndef ROSE_SgAsmPESection_H
#define ROSE_SgAsmPESection_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmPESection

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmPESection.h" */
/* #line 4794 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// Class Definition for SgAsmPESection
class ROSE_DLL_API SgAsmPESection  : public SgAsmGenericSection
   {
     public:


/* #line 44 "/workspace/generated/src/frontend/SageIII//SgAsmPESection.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 4812 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmPESection;
          enum { static_variant = V_SgAsmPESection };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmPESection* isSgAsmPESection(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmPESection* isSgAsmPESection( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmPESection * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmPESectionStorageClass *); // 
          ...
          /// \private
          static SgAsmPESection * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmPESection * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmPESection::operator delete (pointer,sizeof(SgAsmPESection));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmPESection* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmPESection* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmPESection* sgnode);
     ...
     public:
       ...
       */
       // SgAsmPESection( SgAsmPESectionStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmPESectionStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmPESection( const SgAsmPESectionStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmPESection* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmPESection* isSgAsmPESection ( SgNode* s );
...
// End of memberFunctionString
    ...
    protected:
// Start of memberFunctionString
SgAsmPESectionTableEntry* p_section_entry;
          
// End of memberFunctionString

    friend struct Rose::Traits::generated::describe_node_t<SgAsmPESection>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmPESection, SgAsmPESectionTableEntry*,&SgAsmPESection::p_section_entry>;
...
// postdeclarations for SgAsmPESection

/* #line 535 "/workspace/generated/src/frontend/SageIII//SgAsmPESection.h" */
...
/* #line 542 "/workspace/generated/src/frontend/SageIII//SgAsmPESection.h" */

#endif // ROSE_SgAsmPESection_H
