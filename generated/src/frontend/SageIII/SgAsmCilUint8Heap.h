...
#ifndef ROSE_SgAsmCilUint8Heap_H
#define ROSE_SgAsmCilUint8Heap_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmCilUint8Heap

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmCilUint8Heap.h" */
...
// Class Definition for SgAsmCilUint8Heap
class ROSE_DLL_API SgAsmCilUint8Heap  : public SgAsmCilDataStream
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmCilUint8Heap.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 32810 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmCilUint8Heap;
          enum { static_variant = V_SgAsmCilUint8Heap };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmCilUint8Heap* isSgAsmCilUint8Heap(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmCilUint8Heap* isSgAsmCilUint8Heap( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmCilUint8Heap * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmCilUint8HeapStorageClass *); // 
          ...
          /// \private
          static SgAsmCilUint8Heap * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmCilUint8Heap * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmCilUint8Heap::operator delete (pointer,sizeof(SgAsmCilUint8Heap));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmCilUint8Heap* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmCilUint8Heap* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmCilUint8Heap* sgnode);
     ...
     public:
       ...
       */
       // SgAsmCilUint8Heap( SgAsmCilUint8HeapStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmCilUint8HeapStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmCilUint8Heap( const SgAsmCilUint8HeapStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmCilUint8Heap* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmCilUint8Heap* isSgAsmCilUint8Heap ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmCilUint8Heap>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilUint8Heap, std::vector<uint8_t>,&SgAsmCilUint8Heap::p_Stream>;
...
// postdeclarations for SgAsmCilUint8Heap

/* #line 517 "/workspace/generated/src/frontend/SageIII//SgAsmCilUint8Heap.h" */
...
/* #line 524 "/workspace/generated/src/frontend/SageIII//SgAsmCilUint8Heap.h" */

#endif // ROSE_SgAsmCilUint8Heap_H
