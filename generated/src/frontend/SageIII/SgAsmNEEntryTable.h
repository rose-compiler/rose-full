...
#ifndef ROSE_SgAsmNEEntryTable_H
#define ROSE_SgAsmNEEntryTable_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmNEEntryTable

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmNEEntryTable.h" */
/* #line 7120 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// Class Definition for SgAsmNEEntryTable
class ROSE_DLL_API SgAsmNEEntryTable  : public SgAsmGenericSection
   {
     public:


/* #line 42 "/workspace/generated/src/frontend/SageIII//SgAsmNEEntryTable.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 7141 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmNEEntryTable;
          enum { static_variant = V_SgAsmNEEntryTable };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmNEEntryTable* isSgAsmNEEntryTable(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmNEEntryTable* isSgAsmNEEntryTable( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmNEEntryTable * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmNEEntryTableStorageClass *); // 
          ...
          /// \private
          static SgAsmNEEntryTable * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmNEEntryTable * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmNEEntryTable::operator delete (pointer,sizeof(SgAsmNEEntryTable));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmNEEntryTable* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmNEEntryTable* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmNEEntryTable* sgnode);
     ...
     public:
       ...
       */
       // SgAsmNEEntryTable( SgAsmNEEntryTableStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmNEEntryTableStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmNEEntryTable( const SgAsmNEEntryTableStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmNEEntryTable* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmNEEntryTable* isSgAsmNEEntryTable ( SgNode* s );
...
// End of memberFunctionString
    ...
    protected:
// Start of memberFunctionString
SgSizeTList p_bundle_sizes;
          
// End of memberFunctionString
// Start of memberFunctionString
SgAsmNEEntryPointPtrList p_entries;
          
// End of memberFunctionString

    friend struct Rose::Traits::generated::describe_node_t<SgAsmNEEntryTable>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmNEEntryTable, SgSizeTList,&SgAsmNEEntryTable::p_bundle_sizes>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmNEEntryTable, SgAsmNEEntryPointPtrList,&SgAsmNEEntryTable::p_entries>;
...
// postdeclarations for SgAsmNEEntryTable

/* #line 527 "/workspace/generated/src/frontend/SageIII//SgAsmNEEntryTable.h" */
...
/* #line 534 "/workspace/generated/src/frontend/SageIII//SgAsmNEEntryTable.h" */

#endif // ROSE_SgAsmNEEntryTable_H
