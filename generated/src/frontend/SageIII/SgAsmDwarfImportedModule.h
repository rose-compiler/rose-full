...
#ifndef ROSE_SgAsmDwarfImportedModule_H
#define ROSE_SgAsmDwarfImportedModule_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmDwarfImportedModule

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfImportedModule.h" */
...
// Class Definition for SgAsmDwarfImportedModule
class ROSE_DLL_API SgAsmDwarfImportedModule  : public SgAsmDwarfConstruct
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfImportedModule.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 27206 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmDwarfImportedModule;
          enum { static_variant = V_SgAsmDwarfImportedModule };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmDwarfImportedModule* isSgAsmDwarfImportedModule(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmDwarfImportedModule* isSgAsmDwarfImportedModule( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmDwarfImportedModule * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmDwarfImportedModuleStorageClass *); // 
          ...
          /// \private
          static SgAsmDwarfImportedModule * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmDwarfImportedModule * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmDwarfImportedModule::operator delete (pointer,sizeof(SgAsmDwarfImportedModule));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmDwarfImportedModule* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmDwarfImportedModule* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmDwarfImportedModule* sgnode);
     ...
     public:
       ...
       */
       // SgAsmDwarfImportedModule( SgAsmDwarfImportedModuleStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmDwarfImportedModuleStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmDwarfImportedModule( const SgAsmDwarfImportedModuleStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmDwarfImportedModule* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmDwarfImportedModule* isSgAsmDwarfImportedModule ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmDwarfImportedModule>;
...
// postdeclarations for SgAsmDwarfImportedModule

/* #line 502 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfImportedModule.h" */
...
/* #line 509 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfImportedModule.h" */

#endif // ROSE_SgAsmDwarfImportedModule_H
