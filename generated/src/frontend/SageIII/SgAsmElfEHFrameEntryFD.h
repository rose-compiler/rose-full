...
#ifndef ROSE_SgAsmElfEHFrameEntryFD_H
#define ROSE_SgAsmElfEHFrameEntryFD_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmElfEHFrameEntryFD

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmElfEHFrameEntryFD.h" */
/* #line 22974 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// Class Definition for SgAsmElfEHFrameEntryFD
class ROSE_DLL_API SgAsmElfEHFrameEntryFD  : public SgAsmExecutableFileFormat
   {
     public:


/* #line 44 "/workspace/generated/src/frontend/SageIII//SgAsmElfEHFrameEntryFD.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 23010 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmElfEHFrameEntryFD;
          enum { static_variant = V_SgAsmElfEHFrameEntryFD };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmElfEHFrameEntryFD* isSgAsmElfEHFrameEntryFD(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmElfEHFrameEntryFD* isSgAsmElfEHFrameEntryFD( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmElfEHFrameEntryFD * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmElfEHFrameEntryFDStorageClass *); // 
          ...
          /// \private
          static SgAsmElfEHFrameEntryFD * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmElfEHFrameEntryFD * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmElfEHFrameEntryFD::operator delete (pointer,sizeof(SgAsmElfEHFrameEntryFD));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmElfEHFrameEntryFD* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmElfEHFrameEntryFD* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmElfEHFrameEntryFD* sgnode);
     ...
     public:
       ...
       */
       // SgAsmElfEHFrameEntryFD( SgAsmElfEHFrameEntryFDStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmElfEHFrameEntryFDStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmElfEHFrameEntryFD( const SgAsmElfEHFrameEntryFDStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmElfEHFrameEntryFD* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmElfEHFrameEntryFD* isSgAsmElfEHFrameEntryFD ( SgNode* s );
...
// End of memberFunctionString
    ...
    protected:
// Start of memberFunctionString
Rose::BinaryAnalysis::RelativeVirtualAddress p_begin_rva;
...
// End of memberFunctionString
// Start of memberFunctionString
SgUnsignedCharList p_augmentation_data;
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmElfEHFrameEntryFD>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmElfEHFrameEntryFD, Rose::BinaryAnalysis::RelativeVirtualAddress,&SgAsmElfEHFrameEntryFD::p_begin_rva>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmElfEHFrameEntryFD, Rose::BinaryAnalysis::Address,&SgAsmElfEHFrameEntryFD::p_size>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmElfEHFrameEntryFD, SgUnsignedCharList,&SgAsmElfEHFrameEntryFD::p_augmentation_data>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmElfEHFrameEntryFD, SgUnsignedCharList,&SgAsmElfEHFrameEntryFD::p_instructions>;
...
// postdeclarations for SgAsmElfEHFrameEntryFD

/* #line 584 "/workspace/generated/src/frontend/SageIII//SgAsmElfEHFrameEntryFD.h" */
...
/* #line 591 "/workspace/generated/src/frontend/SageIII//SgAsmElfEHFrameEntryFD.h" */

#endif // ROSE_SgAsmElfEHFrameEntryFD_H
