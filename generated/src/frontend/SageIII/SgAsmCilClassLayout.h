...
#ifndef ROSE_SgAsmCilClassLayout_H
#define ROSE_SgAsmCilClassLayout_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmCilClassLayout

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmCilClassLayout.h" */
...
// Class Definition for SgAsmCilClassLayout
class ROSE_DLL_API SgAsmCilClassLayout  : public SgAsmCilMetadata
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmCilClassLayout.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 40534 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmCilClassLayout;
          enum { static_variant = V_SgAsmCilClassLayout };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmCilClassLayout* isSgAsmCilClassLayout(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmCilClassLayout* isSgAsmCilClassLayout( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmCilClassLayout * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmCilClassLayoutStorageClass *); // 
          ...
          /// \private
          static SgAsmCilClassLayout * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmCilClassLayout * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmCilClassLayout::operator delete (pointer,sizeof(SgAsmCilClassLayout));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmCilClassLayout* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmCilClassLayout* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmCilClassLayout* sgnode);
     ...
     public:
       ...
       */
       // SgAsmCilClassLayout( SgAsmCilClassLayoutStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmCilClassLayoutStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmCilClassLayout( const SgAsmCilClassLayoutStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmCilClassLayout* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmCilClassLayout* isSgAsmCilClassLayout ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmCilClassLayout>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilClassLayout, uint16_t,&SgAsmCilClassLayout::p_PackingSize>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilClassLayout, uint32_t,&SgAsmCilClassLayout::p_ClassSize>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilClassLayout, uint32_t,&SgAsmCilClassLayout::p_Parent>;
...
// postdeclarations for SgAsmCilClassLayout

/* #line 552 "/workspace/generated/src/frontend/SageIII//SgAsmCilClassLayout.h" */
...
/* #line 559 "/workspace/generated/src/frontend/SageIII//SgAsmCilClassLayout.h" */

#endif // ROSE_SgAsmCilClassLayout_H
