/* #line 1 "/workspace/generated/src/ROSETTA/Grammar/grammarStaticDataManagingClassHeader.macro" */
...
class ROSE_DLL_API AstSpecificDataManagingClass 
  {
    private:
     SgProject* rootOfAst;
     int astIndex;
     unsigned long listOfAccumulatedPoolSizes [ 1088 + 1 ];
    ...
    std::map<std::string, uint64_t>  SgNode_shortMangledNameCache;
    std::unordered_map<SgNode*,std::string>  SgNode_globalQualifiedNameMapForNames;
    std::unordered_map<SgNode*,std::string>  SgNode_globalQualifiedNameMapForTypes;
    std::unordered_map<SgNode*,std::string>  SgNode_globalQualifiedNameMapForTemplateHeaders;
    std::unordered_map<SgNode*,std::string>  SgNode_globalTypeNameMap;
    std::map<SgNode*,std::unordered_map<SgNode*,std::string> >  SgNode_globalQualifiedNameMapForMapsOfTypes;
    SgUnorderedNodeSet  SgSymbolTable_aliasSymbolCausalNodeSet;
    bool  SgSymbolTable_force_search_of_base_classes;
    bool  SgSymbolTable_name_qualification_mode;
    ...
    bool  SgFile_header_file_unparsing_optimization;
    ...
    SgStatement*  SgUnparse_Info_previouslyUnparsedStatement;
    bool  SgUnparse_Info_previousStatementUnparsedFromTokenStream;
    ...
    SgAdaDiscreteType*  SgAdaDiscreteType_builtin_type;
    ...
    SgTypeFloat16*  SgTypeFloat16_builtin_type;
    SgTypeBFloat16*  SgTypeBFloat16_builtin_type;
    SgTypeFp16*  SgTypeFp16_builtin_type;
    SgTypeFloat32x*  SgTypeFloat32x_builtin_type;
    SgTypeFloat64x*  SgTypeFloat64x_builtin_type;
    SgTypeFloat32*  SgTypeFloat32_builtin_type;
    SgTypeFloat64*  SgTypeFloat64_builtin_type;

/* #line 16 "/workspace/generated/src/ROSETTA/Grammar/grammarStaticDataManagingClassHeader.macro" */
    public:
    ...
    std::map<std::string, uint64_t>  get_SgNode_shortMangledNameCache() const;
    std::unordered_map<SgNode*,std::string>  get_SgNode_globalQualifiedNameMapForNames() const;
    std::unordered_map<SgNode*,std::string>  get_SgNode_globalQualifiedNameMapForTypes() const;
    std::unordered_map<SgNode*,std::string>  get_SgNode_globalQualifiedNameMapForTemplateHeaders() const;
    std::unordered_map<SgNode*,std::string>  get_SgNode_globalTypeNameMap() const;
    std::map<SgNode*,std::unordered_map<SgNode*,std::string> >  get_SgNode_globalQualifiedNameMapForMapsOfTypes() const;
    SgUnorderedNodeSet  get_SgSymbolTable_aliasSymbolCausalNodeSet() const;
    bool  get_SgSymbolTable_force_search_of_base_classes() const;
    bool  get_SgSymbolTable_name_qualification_mode() const;
    ...
    bool  get_SgFile_header_file_unparsing_optimization() const;
    ...
    SgStatement*  get_SgUnparse_Info_previouslyUnparsedStatement() const;
    bool  get_SgUnparse_Info_previousStatementUnparsedFromTokenStream() const;
    ...
    SgAdaDiscreteType*  get_SgAdaDiscreteType_builtin_type() const;
    ...
    SgTypeFloat16*  get_SgTypeFloat16_builtin_type() const;
    SgTypeBFloat16*  get_SgTypeBFloat16_builtin_type() const;
    SgTypeFp16*  get_SgTypeFp16_builtin_type() const;
    SgTypeFloat32x*  get_SgTypeFloat32x_builtin_type() const;
    SgTypeFloat64x*  get_SgTypeFloat64x_builtin_type() const;
    SgTypeFloat32*  get_SgTypeFloat32_builtin_type() const;
    SgTypeFloat64*  get_SgTypeFloat64_builtin_type() const;

/* #line 26 "/workspace/generated/src/ROSETTA/Grammar/grammarStaticDataManagingClassHeader.macro" */
