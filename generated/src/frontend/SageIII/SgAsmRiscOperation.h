...
#ifndef ROSE_SgAsmRiscOperation_H
#define ROSE_SgAsmRiscOperation_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmRiscOperation

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmRiscOperation.h" */
/* #line 1606 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// Class Definition for SgAsmRiscOperation
class ROSE_DLL_API SgAsmRiscOperation  : public SgAsmExpression
   {
     public:


/* #line 44 "/workspace/generated/src/frontend/SageIII//SgAsmRiscOperation.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 1637 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmRiscOperation;
          enum { static_variant = V_SgAsmRiscOperation };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmRiscOperation* isSgAsmRiscOperation(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmRiscOperation* isSgAsmRiscOperation( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmRiscOperation * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmRiscOperationStorageClass *); // 
          ...
          /// \private
          static SgAsmRiscOperation * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmRiscOperation * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmRiscOperation::operator delete (pointer,sizeof(SgAsmRiscOperation));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmRiscOperation* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmRiscOperation* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmRiscOperation* sgnode);
     ...
     public:
       ...
       */
       // SgAsmRiscOperation( SgAsmRiscOperationStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmRiscOperationStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmRiscOperation( const SgAsmRiscOperationStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmRiscOperation* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmRiscOperation* isSgAsmRiscOperation ( SgNode* s );
...
// End of memberFunctionString
    ...
    protected:
// Start of memberFunctionString
SgAsmRiscOperation::RiscOperator p_riscOperator;
          
// End of memberFunctionString
// Start of memberFunctionString
SgAsmExprListExp* p_operands;
          
// End of memberFunctionString

    friend struct Rose::Traits::generated::describe_node_t<SgAsmRiscOperation>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmRiscOperation, SgAsmRiscOperation::RiscOperator,&SgAsmRiscOperation::p_riscOperator>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmRiscOperation, SgAsmExprListExp*,&SgAsmRiscOperation::p_operands>;
...
// postdeclarations for SgAsmRiscOperation

/* #line 613 "/workspace/generated/src/frontend/SageIII//SgAsmRiscOperation.h" */
...
/* #line 620 "/workspace/generated/src/frontend/SageIII//SgAsmRiscOperation.h" */

#endif // ROSE_SgAsmRiscOperation_H
