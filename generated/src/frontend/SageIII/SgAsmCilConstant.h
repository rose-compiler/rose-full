...
#ifndef ROSE_SgAsmCilConstant_H
#define ROSE_SgAsmCilConstant_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmCilConstant

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmCilConstant.h" */
...
// Class Definition for SgAsmCilConstant
class ROSE_DLL_API SgAsmCilConstant  : public SgAsmCilMetadata
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmCilConstant.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 40346 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmCilConstant;
          enum { static_variant = V_SgAsmCilConstant };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmCilConstant* isSgAsmCilConstant(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmCilConstant* isSgAsmCilConstant( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmCilConstant * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmCilConstantStorageClass *); // 
          ...
          /// \private
          static SgAsmCilConstant * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmCilConstant * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmCilConstant::operator delete (pointer,sizeof(SgAsmCilConstant));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmCilConstant* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmCilConstant* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmCilConstant* sgnode);
     ...
     public:
       ...
       */
       // SgAsmCilConstant( SgAsmCilConstantStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmCilConstantStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmCilConstant( const SgAsmCilConstantStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmCilConstant* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmCilConstant* isSgAsmCilConstant ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmCilConstant>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilConstant, uint8_t,&SgAsmCilConstant::p_Type>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilConstant, uint8_t,&SgAsmCilConstant::p_Padding>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilConstant, uint32_t,&SgAsmCilConstant::p_Parent>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilConstant, uint32_t,&SgAsmCilConstant::p_Value>;
...
// postdeclarations for SgAsmCilConstant

/* #line 570 "/workspace/generated/src/frontend/SageIII//SgAsmCilConstant.h" */
...
/* #line 577 "/workspace/generated/src/frontend/SageIII//SgAsmCilConstant.h" */

#endif // ROSE_SgAsmCilConstant_H
