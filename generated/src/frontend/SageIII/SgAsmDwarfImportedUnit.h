...
#ifndef ROSE_SgAsmDwarfImportedUnit_H
#define ROSE_SgAsmDwarfImportedUnit_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmDwarfImportedUnit

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfImportedUnit.h" */
...
// Class Definition for SgAsmDwarfImportedUnit
class ROSE_DLL_API SgAsmDwarfImportedUnit  : public SgAsmDwarfConstruct
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfImportedUnit.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 27147 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmDwarfImportedUnit;
          enum { static_variant = V_SgAsmDwarfImportedUnit };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmDwarfImportedUnit* isSgAsmDwarfImportedUnit(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmDwarfImportedUnit* isSgAsmDwarfImportedUnit( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmDwarfImportedUnit * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmDwarfImportedUnitStorageClass *); // 
          ...
          /// \private
          static SgAsmDwarfImportedUnit * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmDwarfImportedUnit * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmDwarfImportedUnit::operator delete (pointer,sizeof(SgAsmDwarfImportedUnit));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmDwarfImportedUnit* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmDwarfImportedUnit* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmDwarfImportedUnit* sgnode);
     ...
     public:
       ...
       */
       // SgAsmDwarfImportedUnit( SgAsmDwarfImportedUnitStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmDwarfImportedUnitStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmDwarfImportedUnit( const SgAsmDwarfImportedUnitStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmDwarfImportedUnit* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmDwarfImportedUnit* isSgAsmDwarfImportedUnit ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmDwarfImportedUnit>;
...
// postdeclarations for SgAsmDwarfImportedUnit

/* #line 502 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfImportedUnit.h" */
...
/* #line 509 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfImportedUnit.h" */

#endif // ROSE_SgAsmDwarfImportedUnit_H
