...
#ifndef ROSE_SgAsmCilMethodDefTable_H
#define ROSE_SgAsmCilMethodDefTable_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmCilMethodDefTable

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmCilMethodDefTable.h" */
...
// Class Definition for SgAsmCilMethodDefTable
class ROSE_DLL_API SgAsmCilMethodDefTable  : public SgAsmCilMetadata
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmCilMethodDefTable.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 35249 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmCilMethodDefTable;
          enum { static_variant = V_SgAsmCilMethodDefTable };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmCilMethodDefTable* isSgAsmCilMethodDefTable(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmCilMethodDefTable* isSgAsmCilMethodDefTable( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmCilMethodDefTable * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmCilMethodDefTableStorageClass *); // 
          ...
          /// \private
          static SgAsmCilMethodDefTable * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmCilMethodDefTable * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmCilMethodDefTable::operator delete (pointer,sizeof(SgAsmCilMethodDefTable));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmCilMethodDefTable* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmCilMethodDefTable* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmCilMethodDefTable* sgnode);
     ...
     public:
       ...
       */
       // SgAsmCilMethodDefTable( SgAsmCilMethodDefTableStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmCilMethodDefTableStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmCilMethodDefTable( const SgAsmCilMethodDefTableStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmCilMethodDefTable* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmCilMethodDefTable* isSgAsmCilMethodDefTable ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmCilMethodDefTable>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilMethodDefTable, std::vector<SgAsmCilMethodDef*>,&SgAsmCilMethodDefTable::p_elements>;
...
// postdeclarations for SgAsmCilMethodDefTable

/* #line 508 "/workspace/generated/src/frontend/SageIII//SgAsmCilMethodDefTable.h" */
...
/* #line 515 "/workspace/generated/src/frontend/SageIII//SgAsmCilMethodDefTable.h" */

#endif // ROSE_SgAsmCilMethodDefTable_H
