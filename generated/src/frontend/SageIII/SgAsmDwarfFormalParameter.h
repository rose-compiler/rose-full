...
#ifndef ROSE_SgAsmDwarfFormalParameter_H
#define ROSE_SgAsmDwarfFormalParameter_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmDwarfFormalParameter

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfFormalParameter.h" */
...
// Class Definition for SgAsmDwarfFormalParameter
class ROSE_DLL_API SgAsmDwarfFormalParameter  : public SgAsmDwarfConstruct
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfFormalParameter.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 27501 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmDwarfFormalParameter;
          enum { static_variant = V_SgAsmDwarfFormalParameter };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmDwarfFormalParameter* isSgAsmDwarfFormalParameter(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmDwarfFormalParameter* isSgAsmDwarfFormalParameter( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmDwarfFormalParameter * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmDwarfFormalParameterStorageClass *); // 
          ...
          /// \private
          static SgAsmDwarfFormalParameter * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmDwarfFormalParameter * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmDwarfFormalParameter::operator delete (pointer,sizeof(SgAsmDwarfFormalParameter));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmDwarfFormalParameter* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmDwarfFormalParameter* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmDwarfFormalParameter* sgnode);
     ...
     public:
       ...
       */
       // SgAsmDwarfFormalParameter( SgAsmDwarfFormalParameterStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmDwarfFormalParameterStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmDwarfFormalParameter( const SgAsmDwarfFormalParameterStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmDwarfFormalParameter* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmDwarfFormalParameter* isSgAsmDwarfFormalParameter ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmDwarfFormalParameter>;
...
// postdeclarations for SgAsmDwarfFormalParameter

/* #line 502 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfFormalParameter.h" */
...
/* #line 509 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfFormalParameter.h" */

#endif // ROSE_SgAsmDwarfFormalParameter_H
