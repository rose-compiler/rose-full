...
#ifndef ROSE_SgAsmValueExpression_H
#define ROSE_SgAsmValueExpression_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmValueExpression

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmValueExpression.h" */
...
class ROSE_DLL_API SgAsmValueExpression  : public SgAsmExpression
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmValueExpression.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 30624 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmValueExpression* isSgAsmValueExpression(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmValueExpression* isSgAsmValueExpression( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmValueExpression * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmValueExpressionStorageClass *); // 
          ...
          /// \private
          static SgAsmValueExpression * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmValueExpression * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmValueExpression::operator delete (pointer,sizeof(SgAsmValueExpression));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmValueExpression* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmValueExpression* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmValueExpression* sgnode);
     ...
     public:
       ...
       */
       // SgAsmValueExpression( SgAsmValueExpressionStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmValueExpressionStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmValueExpression( const SgAsmValueExpressionStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmValueExpression* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmValueExpression* isSgAsmValueExpression ( SgNode* s );
...
// End of memberFunctionString
    ...
    protected:
// Start of memberFunctionString
SgAsmValueExpression* p_unfoldedExpression;
          
// End of memberFunctionString
// Start of memberFunctionString
unsigned short p_bitOffset;
          
// End of memberFunctionString
// Start of memberFunctionString
unsigned short p_bitSize;
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmValueExpression>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmValueExpression, SgAsmValueExpression*,&SgAsmValueExpression::p_unfoldedExpression>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmValueExpression, unsigned short,&SgAsmValueExpression::p_bitOffset>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmValueExpression, unsigned short,&SgAsmValueExpression::p_bitSize>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmValueExpression, SgSymbol*,&SgAsmValueExpression::p_symbol>;
...
// postdeclarations for SgAsmValueExpression

/* #line 579 "/workspace/generated/src/frontend/SageIII//SgAsmValueExpression.h" */
...
/* #line 586 "/workspace/generated/src/frontend/SageIII//SgAsmValueExpression.h" */

#endif // ROSE_SgAsmValueExpression_H
