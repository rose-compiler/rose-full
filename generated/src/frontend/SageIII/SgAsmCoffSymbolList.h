...
#ifndef ROSE_SgAsmCoffSymbolList_H
#define ROSE_SgAsmCoffSymbolList_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmCoffSymbolList

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmCoffSymbolList.h" */
/* #line 30901 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// Class Definition for SgAsmCoffSymbolList
class ROSE_DLL_API SgAsmCoffSymbolList  : public SgAsmExecutableFileFormat
   {
     public:


/* #line 42 "/workspace/generated/src/frontend/SageIII//SgAsmCoffSymbolList.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 30917 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmCoffSymbolList;
          enum { static_variant = V_SgAsmCoffSymbolList };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmCoffSymbolList* isSgAsmCoffSymbolList(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmCoffSymbolList* isSgAsmCoffSymbolList( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmCoffSymbolList * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmCoffSymbolListStorageClass *); // 
          ...
          /// \private
          static SgAsmCoffSymbolList * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmCoffSymbolList * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmCoffSymbolList::operator delete (pointer,sizeof(SgAsmCoffSymbolList));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmCoffSymbolList* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmCoffSymbolList* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmCoffSymbolList* sgnode);
     ...
     public:
       ...
       */
       // SgAsmCoffSymbolList( SgAsmCoffSymbolListStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmCoffSymbolListStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmCoffSymbolList( const SgAsmCoffSymbolListStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmCoffSymbolList* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmCoffSymbolList* isSgAsmCoffSymbolList ( SgNode* s );
...
// End of memberFunctionString
    ...
    protected:
// Start of memberFunctionString
SgAsmCoffSymbolPtrList p_symbols;
          
// End of memberFunctionString

    friend struct Rose::Traits::generated::describe_node_t<SgAsmCoffSymbolList>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCoffSymbolList, SgAsmCoffSymbolPtrList,&SgAsmCoffSymbolList::p_symbols>;
...
// postdeclarations for SgAsmCoffSymbolList

/* #line 516 "/workspace/generated/src/frontend/SageIII//SgAsmCoffSymbolList.h" */
...
/* #line 523 "/workspace/generated/src/frontend/SageIII//SgAsmCoffSymbolList.h" */

#endif // ROSE_SgAsmCoffSymbolList_H
