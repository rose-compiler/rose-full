...
#ifndef ROSE_SgAsmCilFieldMarshal_H
#define ROSE_SgAsmCilFieldMarshal_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmCilFieldMarshal

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmCilFieldMarshal.h" */
...
// Class Definition for SgAsmCilFieldMarshal
class ROSE_DLL_API SgAsmCilFieldMarshal  : public SgAsmCilMetadata
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmCilFieldMarshal.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 38590 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmCilFieldMarshal;
          enum { static_variant = V_SgAsmCilFieldMarshal };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmCilFieldMarshal* isSgAsmCilFieldMarshal(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmCilFieldMarshal* isSgAsmCilFieldMarshal( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmCilFieldMarshal * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmCilFieldMarshalStorageClass *); // 
          ...
          /// \private
          static SgAsmCilFieldMarshal * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmCilFieldMarshal * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmCilFieldMarshal::operator delete (pointer,sizeof(SgAsmCilFieldMarshal));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmCilFieldMarshal* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmCilFieldMarshal* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmCilFieldMarshal* sgnode);
     ...
     public:
       ...
       */
       // SgAsmCilFieldMarshal( SgAsmCilFieldMarshalStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmCilFieldMarshalStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmCilFieldMarshal( const SgAsmCilFieldMarshalStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmCilFieldMarshal* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmCilFieldMarshal* isSgAsmCilFieldMarshal ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmCilFieldMarshal>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilFieldMarshal, uint32_t,&SgAsmCilFieldMarshal::p_Parent>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilFieldMarshal, uint32_t,&SgAsmCilFieldMarshal::p_NativeType>;
...
// postdeclarations for SgAsmCilFieldMarshal

/* #line 536 "/workspace/generated/src/frontend/SageIII//SgAsmCilFieldMarshal.h" */
...
/* #line 543 "/workspace/generated/src/frontend/SageIII//SgAsmCilFieldMarshal.h" */

#endif // ROSE_SgAsmCilFieldMarshal_H
