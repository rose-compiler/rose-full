...
#ifndef ROSE_SgAsmCilMetadata_H
#define ROSE_SgAsmCilMetadata_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmCilMetadata

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmCilMetadata.h" */
...
// Class Definition for SgAsmCilMetadata
class ROSE_DLL_API SgAsmCilMetadata  : public SgAsmCilNode
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmCilMetadata.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 41941 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmCilMetadata;
          enum { static_variant = V_SgAsmCilMetadata };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmCilMetadata* isSgAsmCilMetadata(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmCilMetadata* isSgAsmCilMetadata( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmCilMetadata * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmCilMetadataStorageClass *); // 
          ...
          /// \private
          static SgAsmCilMetadata * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmCilMetadata * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmCilMetadata::operator delete (pointer,sizeof(SgAsmCilMetadata));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmCilMetadata* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmCilMetadata* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmCilMetadata* sgnode);
     ...
     public:
       ...
       */
       // SgAsmCilMetadata( SgAsmCilMetadataStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmCilMetadataStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmCilMetadata( const SgAsmCilMetadataStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmCilMetadata* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmCilMetadata* isSgAsmCilMetadata ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmCilMetadata>;
...
// postdeclarations for SgAsmCilMetadata

/* #line 496 "/workspace/generated/src/frontend/SageIII//SgAsmCilMetadata.h" */
...
/* #line 503 "/workspace/generated/src/frontend/SageIII//SgAsmCilMetadata.h" */

#endif // ROSE_SgAsmCilMetadata_H
