...
#ifndef ROSE_SgAsmDwarfClassType_H
#define ROSE_SgAsmDwarfClassType_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmDwarfClassType

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfClassType.h" */
/* #line 28547 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// Class Definition for SgAsmDwarfClassType
class ROSE_DLL_API SgAsmDwarfClassType  : public SgAsmDwarfConstruct
   {
     public:


/* #line 44 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfClassType.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 28564 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmDwarfClassType;
          enum { static_variant = V_SgAsmDwarfClassType };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmDwarfClassType* isSgAsmDwarfClassType(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmDwarfClassType* isSgAsmDwarfClassType( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmDwarfClassType * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmDwarfClassTypeStorageClass *); // 
          ...
          /// \private
          static SgAsmDwarfClassType * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmDwarfClassType * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmDwarfClassType::operator delete (pointer,sizeof(SgAsmDwarfClassType));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmDwarfClassType* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmDwarfClassType* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmDwarfClassType* sgnode);
     ...
     public:
       ...
       */
       // SgAsmDwarfClassType( SgAsmDwarfClassTypeStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmDwarfClassTypeStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmDwarfClassType( const SgAsmDwarfClassTypeStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmDwarfClassType* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmDwarfClassType* isSgAsmDwarfClassType ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmDwarfClassType>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmDwarfClassType, SgAsmDwarfConstructList*,&SgAsmDwarfClassType::p_body>;
...
// postdeclarations for SgAsmDwarfClassType

/* #line 520 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfClassType.h" */
...
/* #line 527 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfClassType.h" */

#endif // ROSE_SgAsmDwarfClassType_H
