...
#ifndef ROSE_SgAsmDwarfConstructList_H
#define ROSE_SgAsmDwarfConstructList_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmDwarfConstructList

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfConstructList.h" */
/* #line 27940 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// Class Definition for SgAsmDwarfConstructList
class ROSE_DLL_API SgAsmDwarfConstructList  : public SgAsmDwarfInformation
   {
     public:


/* #line 42 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfConstructList.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 27955 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmDwarfConstructList;
          enum { static_variant = V_SgAsmDwarfConstructList };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmDwarfConstructList* isSgAsmDwarfConstructList(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmDwarfConstructList* isSgAsmDwarfConstructList( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmDwarfConstructList * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmDwarfConstructListStorageClass *); // 
          ...
          /// \private
          static SgAsmDwarfConstructList * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmDwarfConstructList * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmDwarfConstructList::operator delete (pointer,sizeof(SgAsmDwarfConstructList));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmDwarfConstructList* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmDwarfConstructList* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmDwarfConstructList* sgnode);
     ...
     public:
       ...
       */
       // SgAsmDwarfConstructList( SgAsmDwarfConstructListStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmDwarfConstructListStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmDwarfConstructList( const SgAsmDwarfConstructListStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmDwarfConstructList* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmDwarfConstructList* isSgAsmDwarfConstructList ( SgNode* s );
...
// End of memberFunctionString
    ...
    protected:
// Start of memberFunctionString
SgAsmDwarfConstructPtrList p_list;
          
// End of memberFunctionString

    friend struct Rose::Traits::generated::describe_node_t<SgAsmDwarfConstructList>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmDwarfConstructList, SgAsmDwarfConstructPtrList,&SgAsmDwarfConstructList::p_list>;
...
// postdeclarations for SgAsmDwarfConstructList

/* #line 512 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfConstructList.h" */
...
/* #line 519 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfConstructList.h" */

#endif // ROSE_SgAsmDwarfConstructList_H
