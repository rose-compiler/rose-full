...
#ifndef ROSE_SgAsmJvmLineNumberEntry_H
#define ROSE_SgAsmJvmLineNumberEntry_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmJvmLineNumberEntry

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmJvmLineNumberEntry.h" */
...
// Class Definition for SgAsmJvmLineNumberEntry
class ROSE_DLL_API SgAsmJvmLineNumberEntry  : public SgAsmJvmNode
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmJvmLineNumberEntry.h" */

          virtual SgNode* copy ( SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 11413 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmJvmLineNumberEntry;
          enum { static_variant = V_SgAsmJvmLineNumberEntry };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmJvmLineNumberEntry* isSgAsmJvmLineNumberEntry(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmJvmLineNumberEntry* isSgAsmJvmLineNumberEntry( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmJvmLineNumberEntry * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmJvmLineNumberEntryStorageClass *); // 
          ...
          /// \private
          static SgAsmJvmLineNumberEntry * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmJvmLineNumberEntry * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmJvmLineNumberEntry::operator delete (pointer,sizeof(SgAsmJvmLineNumberEntry));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmJvmLineNumberEntry* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmJvmLineNumberEntry* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmJvmLineNumberEntry* sgnode);
     ...
     public:
       ...
       */
       // SgAsmJvmLineNumberEntry( SgAsmJvmLineNumberEntryStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmJvmLineNumberEntryStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmJvmLineNumberEntry( const SgAsmJvmLineNumberEntryStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmJvmLineNumberEntry* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 670 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmJvmLineNumberEntry* isSgAsmJvmLineNumberEntry ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmJvmLineNumberEntry>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmJvmLineNumberEntry, uint16_t,&SgAsmJvmLineNumberEntry::p_start_pc>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmJvmLineNumberEntry, uint16_t,&SgAsmJvmLineNumberEntry::p_line_number>;
...
// postdeclarations for SgAsmJvmLineNumberEntry

/* #line 543 "/workspace/generated/src/frontend/SageIII//SgAsmJvmLineNumberEntry.h" */
...
/* #line 550 "/workspace/generated/src/frontend/SageIII//SgAsmJvmLineNumberEntry.h" */

#endif // ROSE_SgAsmJvmLineNumberEntry_H
