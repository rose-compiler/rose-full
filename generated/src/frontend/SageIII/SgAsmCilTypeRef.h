...
#ifndef ROSE_SgAsmCilTypeRef_H
#define ROSE_SgAsmCilTypeRef_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmCilTypeRef

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmCilTypeRef.h" */
...
// Class Definition for SgAsmCilTypeRef
class ROSE_DLL_API SgAsmCilTypeRef  : public SgAsmCilMetadata
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmCilTypeRef.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 33180 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmCilTypeRef;
          enum { static_variant = V_SgAsmCilTypeRef };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmCilTypeRef* isSgAsmCilTypeRef(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmCilTypeRef* isSgAsmCilTypeRef( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmCilTypeRef * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmCilTypeRefStorageClass *); // 
          ...
          /// \private
          static SgAsmCilTypeRef * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmCilTypeRef * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmCilTypeRef::operator delete (pointer,sizeof(SgAsmCilTypeRef));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmCilTypeRef* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmCilTypeRef* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmCilTypeRef* sgnode);
     ...
     public:
       ...
       */
       // SgAsmCilTypeRef( SgAsmCilTypeRefStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmCilTypeRefStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmCilTypeRef( const SgAsmCilTypeRefStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmCilTypeRef* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmCilTypeRef* isSgAsmCilTypeRef ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmCilTypeRef>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilTypeRef, uint16_t,&SgAsmCilTypeRef::p_ResolutionScope>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilTypeRef, uint32_t,&SgAsmCilTypeRef::p_TypeName>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilTypeRef, uint32_t,&SgAsmCilTypeRef::p_TypeNamespace>;
...
// postdeclarations for SgAsmCilTypeRef

/* #line 554 "/workspace/generated/src/frontend/SageIII//SgAsmCilTypeRef.h" */
...
/* #line 561 "/workspace/generated/src/frontend/SageIII//SgAsmCilTypeRef.h" */

#endif // ROSE_SgAsmCilTypeRef_H
