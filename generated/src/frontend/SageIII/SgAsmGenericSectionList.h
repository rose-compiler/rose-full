...
#ifndef ROSE_SgAsmGenericSectionList_H
#define ROSE_SgAsmGenericSectionList_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmGenericSectionList

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmGenericSectionList.h" */
/* #line 15736 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// Class Definition for SgAsmGenericSectionList
class ROSE_DLL_API SgAsmGenericSectionList  : public SgAsmExecutableFileFormat
   {
     public:


/* #line 42 "/workspace/generated/src/frontend/SageIII//SgAsmGenericSectionList.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 15755 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmGenericSectionList;
          enum { static_variant = V_SgAsmGenericSectionList };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmGenericSectionList* isSgAsmGenericSectionList(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmGenericSectionList* isSgAsmGenericSectionList( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmGenericSectionList * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmGenericSectionListStorageClass *); // 
          ...
          /// \private
          static SgAsmGenericSectionList * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmGenericSectionList * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmGenericSectionList::operator delete (pointer,sizeof(SgAsmGenericSectionList));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmGenericSectionList* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmGenericSectionList* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmGenericSectionList* sgnode);
     ...
     public:
       ...
       */
       // SgAsmGenericSectionList( SgAsmGenericSectionListStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmGenericSectionListStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmGenericSectionList( const SgAsmGenericSectionListStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmGenericSectionList* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmGenericSectionList* isSgAsmGenericSectionList ( SgNode* s );
...
// End of memberFunctionString
    ...
    protected:
// Start of memberFunctionString
SgAsmGenericSectionPtrList p_sections;
          
// End of memberFunctionString

    friend struct Rose::Traits::generated::describe_node_t<SgAsmGenericSectionList>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmGenericSectionList, SgAsmGenericSectionPtrList,&SgAsmGenericSectionList::p_sections>;
...
// postdeclarations for SgAsmGenericSectionList

/* #line 516 "/workspace/generated/src/frontend/SageIII//SgAsmGenericSectionList.h" */
...
/* #line 523 "/workspace/generated/src/frontend/SageIII//SgAsmGenericSectionList.h" */

#endif // ROSE_SgAsmGenericSectionList_H
