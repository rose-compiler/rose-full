...
#ifndef ROSE_SgAsmJvmInstruction_H
#define ROSE_SgAsmJvmInstruction_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmJvmInstruction

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmJvmInstruction.h" */
/* #line 12100 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// Class Definition for SgAsmJvmInstruction
class ROSE_DLL_API SgAsmJvmInstruction  : public SgAsmInstruction
   {
     public:


/* #line 42 "/workspace/generated/src/frontend/SageIII//SgAsmJvmInstruction.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 12116 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmJvmInstruction;
          enum { static_variant = V_SgAsmJvmInstruction };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmJvmInstruction* isSgAsmJvmInstruction(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmJvmInstruction* isSgAsmJvmInstruction( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmJvmInstruction * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmJvmInstructionStorageClass *); // 
          ...
          /// \private
          static SgAsmJvmInstruction * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmJvmInstruction * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmJvmInstruction::operator delete (pointer,sizeof(SgAsmJvmInstruction));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmJvmInstruction* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmJvmInstruction* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmJvmInstruction* sgnode);
     ...
     public:
       ...
       */
       // SgAsmJvmInstruction( SgAsmJvmInstructionStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmJvmInstructionStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmJvmInstruction( const SgAsmJvmInstructionStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmJvmInstruction* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmJvmInstruction* isSgAsmJvmInstruction ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmJvmInstruction>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmJvmInstruction, Rose::BinaryAnalysis::JvmInstructionKind,&SgAsmJvmInstruction::p_kind>;
...
// postdeclarations for SgAsmJvmInstruction

/* #line 526 "/workspace/generated/src/frontend/SageIII//SgAsmJvmInstruction.h" */
...
/* #line 533 "/workspace/generated/src/frontend/SageIII//SgAsmJvmInstruction.h" */

#endif // ROSE_SgAsmJvmInstruction_H
