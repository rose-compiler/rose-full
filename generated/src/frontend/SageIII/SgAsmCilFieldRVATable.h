...
#ifndef ROSE_SgAsmCilFieldRVATable_H
#define ROSE_SgAsmCilFieldRVATable_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmCilFieldRVATable

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmCilFieldRVATable.h" */
...
// Class Definition for SgAsmCilFieldRVATable
class ROSE_DLL_API SgAsmCilFieldRVATable  : public SgAsmCilMetadata
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmCilFieldRVATable.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 38359 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmCilFieldRVATable;
          enum { static_variant = V_SgAsmCilFieldRVATable };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmCilFieldRVATable* isSgAsmCilFieldRVATable(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmCilFieldRVATable* isSgAsmCilFieldRVATable( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmCilFieldRVATable * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmCilFieldRVATableStorageClass *); // 
          ...
          /// \private
          static SgAsmCilFieldRVATable * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmCilFieldRVATable * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmCilFieldRVATable::operator delete (pointer,sizeof(SgAsmCilFieldRVATable));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmCilFieldRVATable* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmCilFieldRVATable* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmCilFieldRVATable* sgnode);
     ...
     public:
       ...
       */
       // SgAsmCilFieldRVATable( SgAsmCilFieldRVATableStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmCilFieldRVATableStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmCilFieldRVATable( const SgAsmCilFieldRVATableStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmCilFieldRVATable* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmCilFieldRVATable* isSgAsmCilFieldRVATable ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmCilFieldRVATable>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilFieldRVATable, std::vector<SgAsmCilFieldRVA*>,&SgAsmCilFieldRVATable::p_elements>;
...
// postdeclarations for SgAsmCilFieldRVATable

/* #line 508 "/workspace/generated/src/frontend/SageIII//SgAsmCilFieldRVATable.h" */
...
/* #line 515 "/workspace/generated/src/frontend/SageIII//SgAsmCilFieldRVATable.h" */

#endif // ROSE_SgAsmCilFieldRVATable_H
