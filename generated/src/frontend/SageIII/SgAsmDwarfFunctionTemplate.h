...
#ifndef ROSE_SgAsmDwarfFunctionTemplate_H
#define ROSE_SgAsmDwarfFunctionTemplate_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmDwarfFunctionTemplate

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfFunctionTemplate.h" */
...
// Class Definition for SgAsmDwarfFunctionTemplate
class ROSE_DLL_API SgAsmDwarfFunctionTemplate  : public SgAsmDwarfConstruct
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfFunctionTemplate.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 27324 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmDwarfFunctionTemplate;
          enum { static_variant = V_SgAsmDwarfFunctionTemplate };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmDwarfFunctionTemplate* isSgAsmDwarfFunctionTemplate(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmDwarfFunctionTemplate* isSgAsmDwarfFunctionTemplate( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmDwarfFunctionTemplate * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmDwarfFunctionTemplateStorageClass *); // 
          ...
          /// \private
          static SgAsmDwarfFunctionTemplate * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmDwarfFunctionTemplate * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmDwarfFunctionTemplate::operator delete (pointer,sizeof(SgAsmDwarfFunctionTemplate));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmDwarfFunctionTemplate* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmDwarfFunctionTemplate* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmDwarfFunctionTemplate* sgnode);
     ...
     public:
       ...
       */
       // SgAsmDwarfFunctionTemplate( SgAsmDwarfFunctionTemplateStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmDwarfFunctionTemplateStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmDwarfFunctionTemplate( const SgAsmDwarfFunctionTemplateStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmDwarfFunctionTemplate* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmDwarfFunctionTemplate* isSgAsmDwarfFunctionTemplate ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmDwarfFunctionTemplate>;
...
// postdeclarations for SgAsmDwarfFunctionTemplate

/* #line 502 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfFunctionTemplate.h" */
...
/* #line 509 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfFunctionTemplate.h" */

#endif // ROSE_SgAsmDwarfFunctionTemplate_H
