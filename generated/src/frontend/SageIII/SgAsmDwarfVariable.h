...
#ifndef ROSE_SgAsmDwarfVariable_H
#define ROSE_SgAsmDwarfVariable_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmDwarfVariable

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfVariable.h" */
...
// Class Definition for SgAsmDwarfVariable
class ROSE_DLL_API SgAsmDwarfVariable  : public SgAsmDwarfConstruct
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfVariable.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 24446 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmDwarfVariable;
          enum { static_variant = V_SgAsmDwarfVariable };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmDwarfVariable* isSgAsmDwarfVariable(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmDwarfVariable* isSgAsmDwarfVariable( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmDwarfVariable * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmDwarfVariableStorageClass *); // 
          ...
          /// \private
          static SgAsmDwarfVariable * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmDwarfVariable * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmDwarfVariable::operator delete (pointer,sizeof(SgAsmDwarfVariable));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmDwarfVariable* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmDwarfVariable* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmDwarfVariable* sgnode);
     ...
     public:
       ...
       */
       // SgAsmDwarfVariable( SgAsmDwarfVariableStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmDwarfVariableStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmDwarfVariable( const SgAsmDwarfVariableStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmDwarfVariable* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmDwarfVariable* isSgAsmDwarfVariable ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmDwarfVariable>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmDwarfVariable, std::string,&SgAsmDwarfVariable::p_linkage_name>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmDwarfVariable, bool,&SgAsmDwarfVariable::p_is_const_expr>;
...
// postdeclarations for SgAsmDwarfVariable

/* #line 525 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfVariable.h" */
...
/* #line 532 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfVariable.h" */

#endif // ROSE_SgAsmDwarfVariable_H
