...
#ifndef ROSE_SgAsmCilMethodSemanticsTable_H
#define ROSE_SgAsmCilMethodSemanticsTable_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmCilMethodSemanticsTable

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmCilMethodSemanticsTable.h" */
...
// Class Definition for SgAsmCilMethodSemanticsTable
class ROSE_DLL_API SgAsmCilMethodSemanticsTable  : public SgAsmCilMetadata
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmCilMethodSemanticsTable.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 34894 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmCilMethodSemanticsTable;
          enum { static_variant = V_SgAsmCilMethodSemanticsTable };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmCilMethodSemanticsTable* isSgAsmCilMethodSemanticsTable(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmCilMethodSemanticsTable* isSgAsmCilMethodSemanticsTable( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmCilMethodSemanticsTable * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmCilMethodSemanticsTableStorageClass *); // 
          ...
          /// \private
          static SgAsmCilMethodSemanticsTable * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmCilMethodSemanticsTable * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmCilMethodSemanticsTable::operator delete (pointer,sizeof(SgAsmCilMethodSemanticsTable));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmCilMethodSemanticsTable* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmCilMethodSemanticsTable* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmCilMethodSemanticsTable* sgnode);
     ...
     public:
       ...
       */
       // SgAsmCilMethodSemanticsTable( SgAsmCilMethodSemanticsTableStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmCilMethodSemanticsTableStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmCilMethodSemanticsTable( const SgAsmCilMethodSemanticsTableStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmCilMethodSemanticsTable* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmCilMethodSemanticsTable* isSgAsmCilMethodSemanticsTable ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmCilMethodSemanticsTable>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilMethodSemanticsTable, std::vector<SgAsmCilMethodSemantics*>,&SgAsmCilMethodSemanticsTable::p_elements>;
...
// postdeclarations for SgAsmCilMethodSemanticsTable

/* #line 508 "/workspace/generated/src/frontend/SageIII//SgAsmCilMethodSemanticsTable.h" */
...
/* #line 515 "/workspace/generated/src/frontend/SageIII//SgAsmCilMethodSemanticsTable.h" */

#endif // ROSE_SgAsmCilMethodSemanticsTable_H
