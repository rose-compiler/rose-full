...
#ifndef ROSE_SgAsmCilClassLayoutTable_H
#define ROSE_SgAsmCilClassLayoutTable_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmCilClassLayoutTable

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmCilClassLayoutTable.h" */
...
// Class Definition for SgAsmCilClassLayoutTable
class ROSE_DLL_API SgAsmCilClassLayoutTable  : public SgAsmCilMetadata
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmCilClassLayoutTable.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 40456 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmCilClassLayoutTable;
          enum { static_variant = V_SgAsmCilClassLayoutTable };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmCilClassLayoutTable* isSgAsmCilClassLayoutTable(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmCilClassLayoutTable* isSgAsmCilClassLayoutTable( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmCilClassLayoutTable * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmCilClassLayoutTableStorageClass *); // 
          ...
          /// \private
          static SgAsmCilClassLayoutTable * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmCilClassLayoutTable * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmCilClassLayoutTable::operator delete (pointer,sizeof(SgAsmCilClassLayoutTable));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmCilClassLayoutTable* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmCilClassLayoutTable* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmCilClassLayoutTable* sgnode);
     ...
     public:
       ...
       */
       // SgAsmCilClassLayoutTable( SgAsmCilClassLayoutTableStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmCilClassLayoutTableStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmCilClassLayoutTable( const SgAsmCilClassLayoutTableStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmCilClassLayoutTable* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmCilClassLayoutTable* isSgAsmCilClassLayoutTable ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmCilClassLayoutTable>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilClassLayoutTable, std::vector<SgAsmCilClassLayout*>,&SgAsmCilClassLayoutTable::p_elements>;
...
// postdeclarations for SgAsmCilClassLayoutTable

/* #line 508 "/workspace/generated/src/frontend/SageIII//SgAsmCilClassLayoutTable.h" */
...
/* #line 515 "/workspace/generated/src/frontend/SageIII//SgAsmCilClassLayoutTable.h" */

#endif // ROSE_SgAsmCilClassLayoutTable_H
