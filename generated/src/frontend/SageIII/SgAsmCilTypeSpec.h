...
#ifndef ROSE_SgAsmCilTypeSpec_H
#define ROSE_SgAsmCilTypeSpec_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmCilTypeSpec

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmCilTypeSpec.h" */
...
// Class Definition for SgAsmCilTypeSpec
class ROSE_DLL_API SgAsmCilTypeSpec  : public SgAsmCilMetadata
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmCilTypeSpec.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 33026 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmCilTypeSpec;
          enum { static_variant = V_SgAsmCilTypeSpec };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmCilTypeSpec* isSgAsmCilTypeSpec(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmCilTypeSpec* isSgAsmCilTypeSpec( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmCilTypeSpec * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmCilTypeSpecStorageClass *); // 
          ...
          /// \private
          static SgAsmCilTypeSpec * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmCilTypeSpec * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmCilTypeSpec::operator delete (pointer,sizeof(SgAsmCilTypeSpec));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmCilTypeSpec* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmCilTypeSpec* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmCilTypeSpec* sgnode);
     ...
     public:
       ...
       */
       // SgAsmCilTypeSpec( SgAsmCilTypeSpecStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmCilTypeSpecStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmCilTypeSpec( const SgAsmCilTypeSpecStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmCilTypeSpec* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmCilTypeSpec* isSgAsmCilTypeSpec ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmCilTypeSpec>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilTypeSpec, uint32_t,&SgAsmCilTypeSpec::p_Signature>;
...
// postdeclarations for SgAsmCilTypeSpec

/* #line 518 "/workspace/generated/src/frontend/SageIII//SgAsmCilTypeSpec.h" */
...
/* #line 525 "/workspace/generated/src/frontend/SageIII//SgAsmCilTypeSpec.h" */

#endif // ROSE_SgAsmCilTypeSpec_H
