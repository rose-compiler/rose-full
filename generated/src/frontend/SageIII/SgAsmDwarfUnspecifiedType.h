...
#ifndef ROSE_SgAsmDwarfUnspecifiedType_H
#define ROSE_SgAsmDwarfUnspecifiedType_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmDwarfUnspecifiedType

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfUnspecifiedType.h" */
...
// Class Definition for SgAsmDwarfUnspecifiedType
class ROSE_DLL_API SgAsmDwarfUnspecifiedType  : public SgAsmDwarfConstruct
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfUnspecifiedType.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 24693 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmDwarfUnspecifiedType;
          enum { static_variant = V_SgAsmDwarfUnspecifiedType };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmDwarfUnspecifiedType* isSgAsmDwarfUnspecifiedType(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmDwarfUnspecifiedType* isSgAsmDwarfUnspecifiedType( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmDwarfUnspecifiedType * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmDwarfUnspecifiedTypeStorageClass *); // 
          ...
          /// \private
          static SgAsmDwarfUnspecifiedType * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmDwarfUnspecifiedType * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmDwarfUnspecifiedType::operator delete (pointer,sizeof(SgAsmDwarfUnspecifiedType));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmDwarfUnspecifiedType* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmDwarfUnspecifiedType* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmDwarfUnspecifiedType* sgnode);
     ...
     public:
       ...
       */
       // SgAsmDwarfUnspecifiedType( SgAsmDwarfUnspecifiedTypeStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmDwarfUnspecifiedTypeStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmDwarfUnspecifiedType( const SgAsmDwarfUnspecifiedTypeStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmDwarfUnspecifiedType* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmDwarfUnspecifiedType* isSgAsmDwarfUnspecifiedType ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmDwarfUnspecifiedType>;
...
// postdeclarations for SgAsmDwarfUnspecifiedType

/* #line 502 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfUnspecifiedType.h" */
...
/* #line 509 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfUnspecifiedType.h" */

#endif // ROSE_SgAsmDwarfUnspecifiedType_H
