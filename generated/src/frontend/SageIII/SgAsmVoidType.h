...
#ifndef ROSE_SgAsmVoidType_H
#define ROSE_SgAsmVoidType_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmVoidType

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmVoidType.h" */
...
// Class Definition for SgAsmVoidType
class ROSE_DLL_API SgAsmVoidType  : public SgAsmType
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmVoidType.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 341 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmVoidType;
          enum { static_variant = V_SgAsmVoidType };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmVoidType* isSgAsmVoidType(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmVoidType* isSgAsmVoidType( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmVoidType * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmVoidTypeStorageClass *); // 
          ...
          /// \private
          static SgAsmVoidType * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmVoidType * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmVoidType::operator delete (pointer,sizeof(SgAsmVoidType));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmVoidType* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmVoidType* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmVoidType* sgnode);
     ...
     public:
       ...
       */
       // SgAsmVoidType( SgAsmVoidTypeStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmVoidTypeStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmVoidType( const SgAsmVoidTypeStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmVoidType* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmVoidType* isSgAsmVoidType ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmVoidType>;
...
// postdeclarations for SgAsmVoidType

/* #line 500 "/workspace/generated/src/frontend/SageIII//SgAsmVoidType.h" */
...
/* #line 507 "/workspace/generated/src/frontend/SageIII//SgAsmVoidType.h" */

#endif // ROSE_SgAsmVoidType_H
