...
#ifndef ROSE_SgAsmDwarfRestrictType_H
#define ROSE_SgAsmDwarfRestrictType_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmDwarfRestrictType

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfRestrictType.h" */
...
// Class Definition for SgAsmDwarfRestrictType
class ROSE_DLL_API SgAsmDwarfRestrictType  : public SgAsmDwarfConstruct
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfRestrictType.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 25746 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmDwarfRestrictType;
          enum { static_variant = V_SgAsmDwarfRestrictType };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmDwarfRestrictType* isSgAsmDwarfRestrictType(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmDwarfRestrictType* isSgAsmDwarfRestrictType( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmDwarfRestrictType * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmDwarfRestrictTypeStorageClass *); // 
          ...
          /// \private
          static SgAsmDwarfRestrictType * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmDwarfRestrictType * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmDwarfRestrictType::operator delete (pointer,sizeof(SgAsmDwarfRestrictType));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmDwarfRestrictType* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmDwarfRestrictType* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmDwarfRestrictType* sgnode);
     ...
     public:
       ...
       */
       // SgAsmDwarfRestrictType( SgAsmDwarfRestrictTypeStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmDwarfRestrictTypeStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmDwarfRestrictType( const SgAsmDwarfRestrictTypeStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmDwarfRestrictType* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmDwarfRestrictType* isSgAsmDwarfRestrictType ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmDwarfRestrictType>;
...
// postdeclarations for SgAsmDwarfRestrictType

/* #line 502 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfRestrictType.h" */
...
/* #line 509 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfRestrictType.h" */

#endif // ROSE_SgAsmDwarfRestrictType_H
