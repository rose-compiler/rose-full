...
#ifndef ROSE_SgAsmLENameTable_H
#define ROSE_SgAsmLENameTable_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmLENameTable

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmLENameTable.h" */
/* #line 8225 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// Class Definition for SgAsmLENameTable
class ROSE_DLL_API SgAsmLENameTable  : public SgAsmGenericSection
   {
     public:


/* #line 42 "/workspace/generated/src/frontend/SageIII//SgAsmLENameTable.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 8246 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmLENameTable;
          enum { static_variant = V_SgAsmLENameTable };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmLENameTable* isSgAsmLENameTable(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmLENameTable* isSgAsmLENameTable( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmLENameTable * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmLENameTableStorageClass *); // 
          ...
          /// \private
          static SgAsmLENameTable * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmLENameTable * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmLENameTable::operator delete (pointer,sizeof(SgAsmLENameTable));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmLENameTable* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmLENameTable* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmLENameTable* sgnode);
     ...
     public:
       ...
       */
       // SgAsmLENameTable( SgAsmLENameTableStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmLENameTableStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmLENameTable( const SgAsmLENameTableStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmLENameTable* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmLENameTable* isSgAsmLENameTable ( SgNode* s );
...
// End of memberFunctionString
// Start of memberFunctionString
SgUnsignedList p_ordinals;
          
// End of memberFunctionString

    friend struct Rose::Traits::generated::describe_node_t<SgAsmLENameTable>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmLENameTable, SgStringList,&SgAsmLENameTable::p_names>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmLENameTable, SgUnsignedList,&SgAsmLENameTable::p_ordinals>;
...
// postdeclarations for SgAsmLENameTable

/* #line 529 "/workspace/generated/src/frontend/SageIII//SgAsmLENameTable.h" */
...
/* #line 536 "/workspace/generated/src/frontend/SageIII//SgAsmLENameTable.h" */

#endif // ROSE_SgAsmLENameTable_H
