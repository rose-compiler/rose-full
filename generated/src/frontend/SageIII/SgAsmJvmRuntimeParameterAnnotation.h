...
#ifndef ROSE_SgAsmJvmRuntimeParameterAnnotation_H
#define ROSE_SgAsmJvmRuntimeParameterAnnotation_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmJvmRuntimeParameterAnnotation

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmJvmRuntimeParameterAnnotation.h" */
...
// Class Definition for SgAsmJvmRuntimeParameterAnnotation
class ROSE_DLL_API SgAsmJvmRuntimeParameterAnnotation  : public SgAsmJvmNode
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmJvmRuntimeParameterAnnotation.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 10055 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmJvmRuntimeParameterAnnotation;
          enum { static_variant = V_SgAsmJvmRuntimeParameterAnnotation };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmJvmRuntimeParameterAnnotation* isSgAsmJvmRuntimeParameterAnnotation(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmJvmRuntimeParameterAnnotation* isSgAsmJvmRuntimeParameterAnnotation( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmJvmRuntimeParameterAnnotation * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmJvmRuntimeParameterAnnotationStorageClass *); // 
          ...
          /// \private
          static SgAsmJvmRuntimeParameterAnnotation * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmJvmRuntimeParameterAnnotation * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmJvmRuntimeParameterAnnotation::operator delete (pointer,sizeof(SgAsmJvmRuntimeParameterAnnotation));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmJvmRuntimeParameterAnnotation* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmJvmRuntimeParameterAnnotation* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmJvmRuntimeParameterAnnotation* sgnode);
     ...
     public:
       ...
       */
       // SgAsmJvmRuntimeParameterAnnotation( SgAsmJvmRuntimeParameterAnnotationStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmJvmRuntimeParameterAnnotationStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmJvmRuntimeParameterAnnotation( const SgAsmJvmRuntimeParameterAnnotationStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmJvmRuntimeParameterAnnotation* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmJvmRuntimeParameterAnnotation* isSgAsmJvmRuntimeParameterAnnotation ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmJvmRuntimeParameterAnnotation>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmJvmRuntimeParameterAnnotation, std::vector<SgAsmJvmRuntimeAnnotation*>,&SgAsmJvmRuntimeParameterAnnotation::p_annotations>;
...
// postdeclarations for SgAsmJvmRuntimeParameterAnnotation

/* #line 528 "/workspace/generated/src/frontend/SageIII//SgAsmJvmRuntimeParameterAnnotation.h" */
...
/* #line 535 "/workspace/generated/src/frontend/SageIII//SgAsmJvmRuntimeParameterAnnotation.h" */

#endif // ROSE_SgAsmJvmRuntimeParameterAnnotation_H
