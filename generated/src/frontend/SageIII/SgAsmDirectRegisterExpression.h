...
#ifndef ROSE_SgAsmDirectRegisterExpression_H
#define ROSE_SgAsmDirectRegisterExpression_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmDirectRegisterExpression

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmDirectRegisterExpression.h" */
...
// Class Definition for SgAsmDirectRegisterExpression
class ROSE_DLL_API SgAsmDirectRegisterExpression  : public SgAsmRegisterReferenceExpression
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmDirectRegisterExpression.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 30254 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmDirectRegisterExpression;
      ...
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmDirectRegisterExpression* isSgAsmDirectRegisterExpression(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmDirectRegisterExpression* isSgAsmDirectRegisterExpression( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmDirectRegisterExpression * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmDirectRegisterExpressionStorageClass *); // 
          ...
          /// \private
          static SgAsmDirectRegisterExpression * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmDirectRegisterExpression * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmDirectRegisterExpression::operator delete (pointer,sizeof(SgAsmDirectRegisterExpression));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmDirectRegisterExpression* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmDirectRegisterExpression* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmDirectRegisterExpression* sgnode);
     ...
     public:
       ...
       */
       // SgAsmDirectRegisterExpression( SgAsmDirectRegisterExpressionStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmDirectRegisterExpressionStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmDirectRegisterExpression( const SgAsmDirectRegisterExpressionStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmDirectRegisterExpression* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmDirectRegisterExpression* isSgAsmDirectRegisterExpression ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmDirectRegisterExpression>;
...
// postdeclarations for SgAsmDirectRegisterExpression

/* #line 500 "/workspace/generated/src/frontend/SageIII//SgAsmDirectRegisterExpression.h" */
...
/* #line 507 "/workspace/generated/src/frontend/SageIII//SgAsmDirectRegisterExpression.h" */

#endif // ROSE_SgAsmDirectRegisterExpression_H
