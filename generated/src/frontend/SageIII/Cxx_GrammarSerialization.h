...
BOOST_CLASS_EXPORT_KEY(SgAsmJvmRuntimeVisibleAnnotations);
BOOST_CLASS_EXPORT_KEY(SgAsmJvmRuntimeVisibilityParamAnnotations);
BOOST_CLASS_EXPORT_KEY(SgAsmJvmRuntimeParameterAnnotation);
BOOST_CLASS_EXPORT_KEY(SgAsmJvmRuntimeInvisibleAnnotations);
BOOST_CLASS_EXPORT_KEY(SgAsmJvmRuntimeAnnotationValue);
BOOST_CLASS_EXPORT_KEY(SgAsmJvmRuntimeAnnotationPair);
BOOST_CLASS_EXPORT_KEY(SgAsmJvmRuntimeAnnotation);
BOOST_CLASS_EXPORT_KEY(SgAsmJvmModule);
...
BOOST_CLASS_EXPORT_KEY(SgAsmJvmIndexTableAttr);
BOOST_CLASS_EXPORT_KEY(SgAsmJvmIndexedAttr);
...
BOOST_CLASS_EXPORT_KEY(SgAsmJvmAnnotationDefault);
...
void roseAstSerializationRegistration(Archive &archive) {
    ...
    archive.template register_type<SgAsmJvmRuntimeVisibleAnnotations>();
    archive.template register_type<SgAsmJvmRuntimeVisibilityParamAnnotations>();
    archive.template register_type<SgAsmJvmRuntimeParameterAnnotation>();
    archive.template register_type<SgAsmJvmRuntimeInvisibleAnnotations>();
    archive.template register_type<SgAsmJvmRuntimeAnnotationValue>();
    archive.template register_type<SgAsmJvmRuntimeAnnotationPair>();
    archive.template register_type<SgAsmJvmRuntimeAnnotation>();
    archive.template register_type<SgAsmJvmModule>();
    ...
    archive.template register_type<SgAsmJvmIndexTableAttr>();
    archive.template register_type<SgAsmJvmIndexedAttr>();
    ...
    archive.template register_type<SgAsmJvmAnnotationDefault>();
