...
#ifndef ROSE_SgAsmUnaryPlus_H
#define ROSE_SgAsmUnaryPlus_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmUnaryPlus

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmUnaryPlus.h" */
...
// Class Definition for SgAsmUnaryPlus
class ROSE_DLL_API SgAsmUnaryPlus  : public SgAsmUnaryExpression
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmUnaryPlus.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 823 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmUnaryPlus* isSgAsmUnaryPlus(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmUnaryPlus* isSgAsmUnaryPlus( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmUnaryPlus * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmUnaryPlusStorageClass *); // 
          ...
          /// \private
          static SgAsmUnaryPlus * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmUnaryPlus * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmUnaryPlus::operator delete (pointer,sizeof(SgAsmUnaryPlus));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmUnaryPlus* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmUnaryPlus* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmUnaryPlus* sgnode);
     ...
     public:
       ...
       */
       // SgAsmUnaryPlus( SgAsmUnaryPlusStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmUnaryPlusStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmUnaryPlus( const SgAsmUnaryPlusStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmUnaryPlus* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmUnaryPlus* isSgAsmUnaryPlus ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmUnaryPlus>;
...
// postdeclarations for SgAsmUnaryPlus

/* #line 500 "/workspace/generated/src/frontend/SageIII//SgAsmUnaryPlus.h" */
...
/* #line 507 "/workspace/generated/src/frontend/SageIII//SgAsmUnaryPlus.h" */

#endif // ROSE_SgAsmUnaryPlus_H
