...
#ifndef ROSE_SgAsmJvmModuleMainClass_H
#define ROSE_SgAsmJvmModuleMainClass_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmJvmModuleMainClass

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmJvmModuleMainClass.h" */
...
// Class Definition for SgAsmJvmModuleMainClass
class ROSE_DLL_API SgAsmJvmModuleMainClass  : public SgAsmJvmAttribute
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmJvmModuleMainClass.h" */

          virtual SgNode* copy ( SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 10264 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmJvmModuleMainClass;
          enum { static_variant = V_SgAsmJvmModuleMainClass };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmJvmModuleMainClass* isSgAsmJvmModuleMainClass(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmJvmModuleMainClass* isSgAsmJvmModuleMainClass( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmJvmModuleMainClass * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmJvmModuleMainClassStorageClass *); // 
          ...
          /// \private
          static SgAsmJvmModuleMainClass * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmJvmModuleMainClass * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmJvmModuleMainClass::operator delete (pointer,sizeof(SgAsmJvmModuleMainClass));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmJvmModuleMainClass* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmJvmModuleMainClass* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmJvmModuleMainClass* sgnode);
     ...
     public:
       ...
       */
       // SgAsmJvmModuleMainClass( SgAsmJvmModuleMainClassStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmJvmModuleMainClassStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmJvmModuleMainClass( const SgAsmJvmModuleMainClassStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmJvmModuleMainClass* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 670 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmJvmModuleMainClass* isSgAsmJvmModuleMainClass ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmJvmModuleMainClass>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmJvmModuleMainClass, uint16_t,&SgAsmJvmModuleMainClass::p_main_class_index>;
...
// postdeclarations for SgAsmJvmModuleMainClass

/* #line 526 "/workspace/generated/src/frontend/SageIII//SgAsmJvmModuleMainClass.h" */
...
/* #line 533 "/workspace/generated/src/frontend/SageIII//SgAsmJvmModuleMainClass.h" */

#endif // ROSE_SgAsmJvmModuleMainClass_H
