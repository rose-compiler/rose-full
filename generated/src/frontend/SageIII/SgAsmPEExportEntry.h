...
#ifndef ROSE_SgAsmPEExportEntry_H
#define ROSE_SgAsmPEExportEntry_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmPEExportEntry

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmPEExportEntry.h" */
/* #line 4966 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// Class Definition for SgAsmPEExportEntry
class ROSE_DLL_API SgAsmPEExportEntry  : public SgAsmExecutableFileFormat
   {
     public:


/* #line 43 "/workspace/generated/src/frontend/SageIII//SgAsmPEExportEntry.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 5001 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmPEExportEntry;
          enum { static_variant = V_SgAsmPEExportEntry };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmPEExportEntry* isSgAsmPEExportEntry(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmPEExportEntry* isSgAsmPEExportEntry( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmPEExportEntry * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmPEExportEntryStorageClass *); // 
          ...
          /// \private
          static SgAsmPEExportEntry * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmPEExportEntry * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmPEExportEntry::operator delete (pointer,sizeof(SgAsmPEExportEntry));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmPEExportEntry* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmPEExportEntry* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmPEExportEntry* sgnode);
     ...
     public:
       ...
       */
       // SgAsmPEExportEntry( SgAsmPEExportEntryStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmPEExportEntryStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmPEExportEntry( const SgAsmPEExportEntryStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmPEExportEntry* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmPEExportEntry* isSgAsmPEExportEntry ( SgNode* s );
...
// End of memberFunctionString
// Start of memberFunctionString
Rose::BinaryAnalysis::RelativeVirtualAddress p_exportRva;
          
// End of memberFunctionString
// Start of memberFunctionString
SgAsmGenericString* p_forwarder;
          
// End of memberFunctionString

    friend struct Rose::Traits::generated::describe_node_t<SgAsmPEExportEntry>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmPEExportEntry, SgAsmGenericString*,&SgAsmPEExportEntry::p_name>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmPEExportEntry, unsigned,&SgAsmPEExportEntry::p_ordinal>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmPEExportEntry, Rose::BinaryAnalysis::RelativeVirtualAddress,&SgAsmPEExportEntry::p_exportRva>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmPEExportEntry, SgAsmGenericString*,&SgAsmPEExportEntry::p_forwarder>;
...
// postdeclarations for SgAsmPEExportEntry

/* #line 588 "/workspace/generated/src/frontend/SageIII//SgAsmPEExportEntry.h" */
...
/* #line 595 "/workspace/generated/src/frontend/SageIII//SgAsmPEExportEntry.h" */

#endif // ROSE_SgAsmPEExportEntry_H
