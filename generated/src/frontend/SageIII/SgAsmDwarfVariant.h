...
#ifndef ROSE_SgAsmDwarfVariant_H
#define ROSE_SgAsmDwarfVariant_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmDwarfVariant

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfVariant.h" */
...
// Class Definition for SgAsmDwarfVariant
class ROSE_DLL_API SgAsmDwarfVariant  : public SgAsmDwarfConstruct
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfVariant.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 24375 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmDwarfVariant;
          enum { static_variant = V_SgAsmDwarfVariant };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmDwarfVariant* isSgAsmDwarfVariant(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmDwarfVariant* isSgAsmDwarfVariant( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmDwarfVariant * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmDwarfVariantStorageClass *); // 
          ...
          /// \private
          static SgAsmDwarfVariant * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmDwarfVariant * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmDwarfVariant::operator delete (pointer,sizeof(SgAsmDwarfVariant));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmDwarfVariant* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmDwarfVariant* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmDwarfVariant* sgnode);
     ...
     public:
       ...
       */
       // SgAsmDwarfVariant( SgAsmDwarfVariantStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmDwarfVariantStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmDwarfVariant( const SgAsmDwarfVariantStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmDwarfVariant* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmDwarfVariant* isSgAsmDwarfVariant ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmDwarfVariant>;
...
// postdeclarations for SgAsmDwarfVariant

/* #line 502 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfVariant.h" */
...
/* #line 509 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfVariant.h" */

#endif // ROSE_SgAsmDwarfVariant_H
