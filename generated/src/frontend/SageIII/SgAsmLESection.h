...
#ifndef ROSE_SgAsmLESection_H
#define ROSE_SgAsmLESection_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmLESection

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmLESection.h" */
/* #line 7879 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// Class Definition for SgAsmLESection
class ROSE_DLL_API SgAsmLESection  : public SgAsmGenericSection
   {
     public:


/* #line 44 "/workspace/generated/src/frontend/SageIII//SgAsmLESection.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 7896 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmLESection;
          enum { static_variant = V_SgAsmLESection };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmLESection* isSgAsmLESection(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmLESection* isSgAsmLESection( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmLESection * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmLESectionStorageClass *); // 
          ...
          /// \private
          static SgAsmLESection * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmLESection * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmLESection::operator delete (pointer,sizeof(SgAsmLESection));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmLESection* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmLESection* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmLESection* sgnode);
     ...
     public:
       ...
       */
       // SgAsmLESection( SgAsmLESectionStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmLESectionStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmLESection( const SgAsmLESectionStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmLESection* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmLESection* isSgAsmLESection ( SgNode* s );
...
// End of memberFunctionString
    ...
    protected:
// Start of memberFunctionString
SgAsmLESectionTableEntry* p_sectionTableEntry;
          
// End of memberFunctionString

    friend struct Rose::Traits::generated::describe_node_t<SgAsmLESection>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmLESection, SgAsmLESectionTableEntry*,&SgAsmLESection::p_sectionTableEntry>;
...
// postdeclarations for SgAsmLESection

/* #line 522 "/workspace/generated/src/frontend/SageIII//SgAsmLESection.h" */
...
/* #line 529 "/workspace/generated/src/frontend/SageIII//SgAsmLESection.h" */

#endif // ROSE_SgAsmLESection_H
