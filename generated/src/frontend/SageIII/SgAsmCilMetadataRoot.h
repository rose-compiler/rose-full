...
#ifndef ROSE_SgAsmCilMetadataRoot_H
#define ROSE_SgAsmCilMetadataRoot_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmCilMetadataRoot

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmCilMetadataRoot.h" */
...
// Class Definition for SgAsmCilMetadataRoot
class ROSE_DLL_API SgAsmCilMetadataRoot  : public SgAsmCilNode
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmCilMetadataRoot.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 35835 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmCilMetadataRoot;
          enum { static_variant = V_SgAsmCilMetadataRoot };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmCilMetadataRoot* isSgAsmCilMetadataRoot(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmCilMetadataRoot* isSgAsmCilMetadataRoot( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmCilMetadataRoot * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmCilMetadataRootStorageClass *); // 
          ...
          /// \private
          static SgAsmCilMetadataRoot * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmCilMetadataRoot * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmCilMetadataRoot::operator delete (pointer,sizeof(SgAsmCilMetadataRoot));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmCilMetadataRoot* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmCilMetadataRoot* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmCilMetadataRoot* sgnode);
     ...
     public:
       ...
       */
       // SgAsmCilMetadataRoot( SgAsmCilMetadataRootStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmCilMetadataRootStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmCilMetadataRoot( const SgAsmCilMetadataRootStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmCilMetadataRoot* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmCilMetadataRoot* isSgAsmCilMetadataRoot ( SgNode* s );

          typedef SgAsmCilNode base_node_type;
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmCilMetadataRoot>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilMetadataRoot, uint32_t,&SgAsmCilMetadataRoot::p_Signature>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilMetadataRoot, uint16_t,&SgAsmCilMetadataRoot::p_MajorVersion>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilMetadataRoot, uint16_t,&SgAsmCilMetadataRoot::p_MinorVersion>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilMetadataRoot, uint32_t,&SgAsmCilMetadataRoot::p_Reserved0>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilMetadataRoot, uint32_t,&SgAsmCilMetadataRoot::p_Length>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilMetadataRoot, std::string,&SgAsmCilMetadataRoot::p_Version>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilMetadataRoot, uint32_t,&SgAsmCilMetadataRoot::p_VersionPadding>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilMetadataRoot, uint16_t,&SgAsmCilMetadataRoot::p_Flags>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilMetadataRoot, uint16_t,&SgAsmCilMetadataRoot::p_NumberOfStreams>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilMetadataRoot, std::vector<SgAsmCilDataStream*>,&SgAsmCilMetadataRoot::p_Streams>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilMetadataRoot, bool,&SgAsmCilMetadataRoot::p_ErrorFree>;
...
// postdeclarations for SgAsmCilMetadataRoot

/* #line 705 "/workspace/generated/src/frontend/SageIII//SgAsmCilMetadataRoot.h" */
...
/* #line 712 "/workspace/generated/src/frontend/SageIII//SgAsmCilMetadataRoot.h" */

#endif // ROSE_SgAsmCilMetadataRoot_H
