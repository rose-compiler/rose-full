...
#ifndef ROSE_SgAsmElfSymverDefinedAux_H
#define ROSE_SgAsmElfSymverDefinedAux_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmElfSymverDefinedAux

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmElfSymverDefinedAux.h" */
/* #line 19599 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// Class Definition for SgAsmElfSymverDefinedAux
class ROSE_DLL_API SgAsmElfSymverDefinedAux  : public SgAsmExecutableFileFormat
   {
     public:


/* #line 46 "/workspace/generated/src/frontend/SageIII//SgAsmElfSymverDefinedAux.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 19619 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmElfSymverDefinedAux;
          enum { static_variant = V_SgAsmElfSymverDefinedAux };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmElfSymverDefinedAux* isSgAsmElfSymverDefinedAux(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmElfSymverDefinedAux* isSgAsmElfSymverDefinedAux( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmElfSymverDefinedAux * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmElfSymverDefinedAuxStorageClass *); // 
          ...
          /// \private
          static SgAsmElfSymverDefinedAux * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmElfSymverDefinedAux * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmElfSymverDefinedAux::operator delete (pointer,sizeof(SgAsmElfSymverDefinedAux));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmElfSymverDefinedAux* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmElfSymverDefinedAux* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmElfSymverDefinedAux* sgnode);
     ...
     public:
       ...
       */
       // SgAsmElfSymverDefinedAux( SgAsmElfSymverDefinedAuxStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmElfSymverDefinedAuxStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmElfSymverDefinedAux( const SgAsmElfSymverDefinedAuxStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmElfSymverDefinedAux* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmElfSymverDefinedAux* isSgAsmElfSymverDefinedAux ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmElfSymverDefinedAux>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmElfSymverDefinedAux, SgAsmGenericString*,&SgAsmElfSymverDefinedAux::p_name>;
...
// postdeclarations for SgAsmElfSymverDefinedAux

/* #line 564 "/workspace/generated/src/frontend/SageIII//SgAsmElfSymverDefinedAux.h" */
...
/* #line 571 "/workspace/generated/src/frontend/SageIII//SgAsmElfSymverDefinedAux.h" */

#endif // ROSE_SgAsmElfSymverDefinedAux_H
