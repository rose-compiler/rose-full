...
#ifndef ROSE_SgAsmStoredString_H
#define ROSE_SgAsmStoredString_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmStoredString

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmStoredString.h" */
/* #line 1319 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// Class Definition for SgAsmStoredString
class ROSE_DLL_API SgAsmStoredString  : public SgAsmGenericString
   {
     public:


/* #line 42 "/workspace/generated/src/frontend/SageIII//SgAsmStoredString.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 1335 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmStoredString;
          enum { static_variant = V_SgAsmStoredString };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmStoredString* isSgAsmStoredString(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmStoredString* isSgAsmStoredString( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmStoredString * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmStoredStringStorageClass *); // 
          ...
          /// \private
          static SgAsmStoredString * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmStoredString * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmStoredString::operator delete (pointer,sizeof(SgAsmStoredString));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmStoredString* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmStoredString* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmStoredString* sgnode);
     ...
     public:
       ...
       */
       // SgAsmStoredString( SgAsmStoredStringStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmStoredStringStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmStoredString( const SgAsmStoredStringStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmStoredString* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmStoredString* isSgAsmStoredString ( SgNode* s );

          typedef SgAsmGenericString base_node_type;
...
// End of memberFunctionString
    ...
    protected:
// Start of memberFunctionString
SgAsmStringStorage* p_storage;
          
// End of memberFunctionString

    friend struct Rose::Traits::generated::describe_node_t<SgAsmStoredString>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmStoredString, SgAsmStringStorage*,&SgAsmStoredString::p_storage>;
...
// postdeclarations for SgAsmStoredString

/* #line 549 "/workspace/generated/src/frontend/SageIII//SgAsmStoredString.h" */
...
/* #line 556 "/workspace/generated/src/frontend/SageIII//SgAsmStoredString.h" */

#endif // ROSE_SgAsmStoredString_H
