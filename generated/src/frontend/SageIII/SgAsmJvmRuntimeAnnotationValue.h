...
#ifndef ROSE_SgAsmJvmRuntimeAnnotationValue_H
#define ROSE_SgAsmJvmRuntimeAnnotationValue_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmJvmRuntimeAnnotationValue

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmJvmRuntimeAnnotationValue.h" */
/* #line 10224 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// Class Definition for SgAsmJvmRuntimeAnnotationValue
class ROSE_DLL_API SgAsmJvmRuntimeAnnotationValue  : public SgAsmJvmNode
   {
     public:


/* #line 45 "/workspace/generated/src/frontend/SageIII//SgAsmJvmRuntimeAnnotationValue.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 10306 "/workspace/src/ROSETTA/src/binaryInstruction.C" */


    //----------------------- Boost serialization for SgAsmJvmRuntimeAnnotationValue -----------------------
...
private:
    ...
    void serialize(S &s, const unsigned /*version*/) {
        debugSerializationBegin("SgAsmJvmRuntimeAnnotationValue");
        s & BOOST_SERIALIZATION_BASE_OBJECT_NVP(SgAsmJvmNode);
        s & BOOST_SERIALIZATION_NVP(p_tag);
        s & BOOST_SERIALIZATION_NVP(p_const_value_index);
        s & BOOST_SERIALIZATION_NVP(p_type_name_index);
        s & BOOST_SERIALIZATION_NVP(p_const_name_index);
        s & BOOST_SERIALIZATION_NVP(p_class_info_index);
        s & BOOST_SERIALIZATION_NVP(p_is_annotation_value);
        s & BOOST_SERIALIZATION_NVP(p_annotation_value);
        s & BOOST_SERIALIZATION_NVP(p_values);
        debugSerializationEnd("SgAsmJvmRuntimeAnnotationValue");
    }
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmJvmRuntimeAnnotationValue;
          enum { static_variant = V_SgAsmJvmRuntimeAnnotationValue };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmJvmRuntimeAnnotationValue* isSgAsmJvmRuntimeAnnotationValue(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmJvmRuntimeAnnotationValue* isSgAsmJvmRuntimeAnnotationValue( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmJvmRuntimeAnnotationValue * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmJvmRuntimeAnnotationValueStorageClass *); // 
          ...
          /// \private
          static SgAsmJvmRuntimeAnnotationValue * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmJvmRuntimeAnnotationValue * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmJvmRuntimeAnnotationValue::operator delete (pointer,sizeof(SgAsmJvmRuntimeAnnotationValue));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmJvmRuntimeAnnotationValue* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmJvmRuntimeAnnotationValue* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmJvmRuntimeAnnotationValue* sgnode);
     ...
     public:
       ...
       */
       // SgAsmJvmRuntimeAnnotationValue( SgAsmJvmRuntimeAnnotationValueStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmJvmRuntimeAnnotationValueStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmJvmRuntimeAnnotationValue( const SgAsmJvmRuntimeAnnotationValueStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmJvmRuntimeAnnotationValue* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmJvmRuntimeAnnotationValue* isSgAsmJvmRuntimeAnnotationValue ( SgNode* s );
...
// End of memberFunctionString
// Start of memberFunctionString
uint16_t p_const_value_index;
          
// End of memberFunctionString
// Start of memberFunctionString
uint16_t p_type_name_index;
          
// End of memberFunctionString
// Start of memberFunctionString
uint16_t p_const_name_index;
          
// End of memberFunctionString
// Start of memberFunctionString
uint16_t p_class_info_index;
          
// End of memberFunctionString
// Start of memberFunctionString
bool p_is_annotation_value;
          
// End of memberFunctionString
// Start of memberFunctionString
SgAsmJvmRuntimeAnnotation* p_annotation_value;
          
// End of memberFunctionString
// Start of memberFunctionString
std::vector<SgAsmJvmRuntimeAnnotationValue*> p_values;
          
// End of memberFunctionString

    friend struct Rose::Traits::generated::describe_node_t<SgAsmJvmRuntimeAnnotationValue>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmJvmRuntimeAnnotationValue, uint8_t,&SgAsmJvmRuntimeAnnotationValue::p_tag>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmJvmRuntimeAnnotationValue, uint16_t,&SgAsmJvmRuntimeAnnotationValue::p_const_value_index>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmJvmRuntimeAnnotationValue, uint16_t,&SgAsmJvmRuntimeAnnotationValue::p_type_name_index>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmJvmRuntimeAnnotationValue, uint16_t,&SgAsmJvmRuntimeAnnotationValue::p_const_name_index>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmJvmRuntimeAnnotationValue, uint16_t,&SgAsmJvmRuntimeAnnotationValue::p_class_info_index>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmJvmRuntimeAnnotationValue, bool,&SgAsmJvmRuntimeAnnotationValue::p_is_annotation_value>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmJvmRuntimeAnnotationValue, SgAsmJvmRuntimeAnnotation*,&SgAsmJvmRuntimeAnnotationValue::p_annotation_value>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmJvmRuntimeAnnotationValue, std::vector<SgAsmJvmRuntimeAnnotationValue*>,&SgAsmJvmRuntimeAnnotationValue::p_values>;
...
// postdeclarations for SgAsmJvmRuntimeAnnotationValue

/* #line 681 "/workspace/generated/src/frontend/SageIII//SgAsmJvmRuntimeAnnotationValue.h" */
...
/* #line 688 "/workspace/generated/src/frontend/SageIII//SgAsmJvmRuntimeAnnotationValue.h" */

#endif // ROSE_SgAsmJvmRuntimeAnnotationValue_H
