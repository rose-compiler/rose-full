...
#ifndef ROSE_SgAsmDwarfCompilationUnitList_H
#define ROSE_SgAsmDwarfCompilationUnitList_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmDwarfCompilationUnitList

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfCompilationUnitList.h" */
/* #line 28128 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// Class Definition for SgAsmDwarfCompilationUnitList
class ROSE_DLL_API SgAsmDwarfCompilationUnitList  : public SgAsmDwarfInformation
   {
     public:


/* #line 42 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfCompilationUnitList.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 28143 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmDwarfCompilationUnitList;
          enum { static_variant = V_SgAsmDwarfCompilationUnitList };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmDwarfCompilationUnitList* isSgAsmDwarfCompilationUnitList(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmDwarfCompilationUnitList* isSgAsmDwarfCompilationUnitList( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmDwarfCompilationUnitList * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmDwarfCompilationUnitListStorageClass *); // 
          ...
          /// \private
          static SgAsmDwarfCompilationUnitList * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmDwarfCompilationUnitList * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmDwarfCompilationUnitList::operator delete (pointer,sizeof(SgAsmDwarfCompilationUnitList));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmDwarfCompilationUnitList* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmDwarfCompilationUnitList* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmDwarfCompilationUnitList* sgnode);
     ...
     public:
       ...
       */
       // SgAsmDwarfCompilationUnitList( SgAsmDwarfCompilationUnitListStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmDwarfCompilationUnitListStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmDwarfCompilationUnitList( const SgAsmDwarfCompilationUnitListStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmDwarfCompilationUnitList* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmDwarfCompilationUnitList* isSgAsmDwarfCompilationUnitList ( SgNode* s );
...
// End of memberFunctionString
    ...
    protected:
// Start of memberFunctionString
SgAsmDwarfCompilationUnitPtrList p_cu_list;
          
// End of memberFunctionString

    friend struct Rose::Traits::generated::describe_node_t<SgAsmDwarfCompilationUnitList>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmDwarfCompilationUnitList, SgAsmDwarfCompilationUnitPtrList,&SgAsmDwarfCompilationUnitList::p_cu_list>;
...
// postdeclarations for SgAsmDwarfCompilationUnitList

/* #line 512 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfCompilationUnitList.h" */
...
/* #line 519 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfCompilationUnitList.h" */

#endif // ROSE_SgAsmDwarfCompilationUnitList_H
