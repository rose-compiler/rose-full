...
#ifndef ROSE_SgAsmIntegerType_H
#define ROSE_SgAsmIntegerType_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmIntegerType

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmIntegerType.h" */
/* #line 15345 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// Class Definition for SgAsmIntegerType
class ROSE_DLL_API SgAsmIntegerType  : public SgAsmScalarType
   {
     public:


/* #line 42 "/workspace/generated/src/frontend/SageIII//SgAsmIntegerType.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 15361 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmIntegerType;
          enum { static_variant = V_SgAsmIntegerType };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmIntegerType* isSgAsmIntegerType(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmIntegerType* isSgAsmIntegerType( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmIntegerType * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmIntegerTypeStorageClass *); // 
          ...
          /// \private
          static SgAsmIntegerType * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmIntegerType * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmIntegerType::operator delete (pointer,sizeof(SgAsmIntegerType));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmIntegerType* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmIntegerType* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmIntegerType* sgnode);
     ...
     public:
       ...
       */
       // SgAsmIntegerType( SgAsmIntegerTypeStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmIntegerTypeStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmIntegerType( const SgAsmIntegerTypeStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmIntegerType* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmIntegerType* isSgAsmIntegerType ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmIntegerType>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmIntegerType, bool,&SgAsmIntegerType::p_isSigned>;
...
// postdeclarations for SgAsmIntegerType

/* #line 531 "/workspace/generated/src/frontend/SageIII//SgAsmIntegerType.h" */
...
/* #line 538 "/workspace/generated/src/frontend/SageIII//SgAsmIntegerType.h" */

#endif // ROSE_SgAsmIntegerType_H
