...
#ifndef ROSE_SgAsmCilNode_H
#define ROSE_SgAsmCilNode_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmCilNode

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmCilNode.h" */
...
// Class Definition for SgAsmCilNode
class ROSE_DLL_API SgAsmCilNode  : public SgAsmNode
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmCilNode.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 42012 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmCilNode;
          enum { static_variant = V_SgAsmCilNode };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmCilNode* isSgAsmCilNode(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmCilNode* isSgAsmCilNode( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmCilNode * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmCilNodeStorageClass *); // 
          ...
          /// \private
          static SgAsmCilNode * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmCilNode * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmCilNode::operator delete (pointer,sizeof(SgAsmCilNode));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmCilNode* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmCilNode* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmCilNode* sgnode);
     ...
     public:
       ...
       */
       // SgAsmCilNode( SgAsmCilNodeStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmCilNodeStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmCilNode( const SgAsmCilNodeStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmCilNode* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmCilNode* isSgAsmCilNode ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmCilNode>;
...
// postdeclarations for SgAsmCilNode

/* #line 496 "/workspace/generated/src/frontend/SageIII//SgAsmCilNode.h" */
...
/* #line 503 "/workspace/generated/src/frontend/SageIII//SgAsmCilNode.h" */

#endif // ROSE_SgAsmCilNode_H
