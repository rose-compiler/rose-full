...
#ifndef ROSE_SgAsmJvmCodeAttribute_H
#define ROSE_SgAsmJvmCodeAttribute_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmJvmCodeAttribute

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmJvmCodeAttribute.h" */
/* #line 14029 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// Class Definition for SgAsmJvmCodeAttribute
class ROSE_DLL_API SgAsmJvmCodeAttribute  : public SgAsmJvmAttribute
   {
     public:


/* #line 42 "/workspace/generated/src/frontend/SageIII//SgAsmJvmCodeAttribute.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 14085 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmJvmCodeAttribute;
          enum { static_variant = V_SgAsmJvmCodeAttribute };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmJvmCodeAttribute* isSgAsmJvmCodeAttribute(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmJvmCodeAttribute* isSgAsmJvmCodeAttribute( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmJvmCodeAttribute * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmJvmCodeAttributeStorageClass *); // 
          ...
          /// \private
          static SgAsmJvmCodeAttribute * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmJvmCodeAttribute * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmJvmCodeAttribute::operator delete (pointer,sizeof(SgAsmJvmCodeAttribute));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmJvmCodeAttribute* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmJvmCodeAttribute* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmJvmCodeAttribute* sgnode);
     ...
     public:
       ...
       */
       // SgAsmJvmCodeAttribute( SgAsmJvmCodeAttributeStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmJvmCodeAttributeStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmJvmCodeAttribute( const SgAsmJvmCodeAttributeStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmJvmCodeAttribute* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmJvmCodeAttribute* isSgAsmJvmCodeAttribute ( SgNode* s );
...
// End of memberFunctionString
// Start of memberFunctionString
Rose::BinaryAnalysis::Address p_code_offset;
          
// End of memberFunctionString

    friend struct Rose::Traits::generated::describe_node_t<SgAsmJvmCodeAttribute>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmJvmCodeAttribute, uint16_t,&SgAsmJvmCodeAttribute::p_max_stack>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmJvmCodeAttribute, uint16_t,&SgAsmJvmCodeAttribute::p_max_locals>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmJvmCodeAttribute, uint32_t,&SgAsmJvmCodeAttribute::p_code_length>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmJvmCodeAttribute, const char*,&SgAsmJvmCodeAttribute::p_code>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmJvmCodeAttribute, SgAsmJvmExceptionTable*,&SgAsmJvmCodeAttribute::p_exception_table>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmJvmCodeAttribute, SgAsmJvmAttributeTable*,&SgAsmJvmCodeAttribute::p_attribute_table>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmJvmCodeAttribute, Rose::BinaryAnalysis::Address,&SgAsmJvmCodeAttribute::p_code_offset>;
...
// postdeclarations for SgAsmJvmCodeAttribute

/* #line 635 "/workspace/generated/src/frontend/SageIII//SgAsmJvmCodeAttribute.h" */
...
/* #line 642 "/workspace/generated/src/frontend/SageIII//SgAsmJvmCodeAttribute.h" */

#endif // ROSE_SgAsmJvmCodeAttribute_H
