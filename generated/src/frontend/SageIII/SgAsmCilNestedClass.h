...
#ifndef ROSE_SgAsmCilNestedClass_H
#define ROSE_SgAsmCilNestedClass_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmCilNestedClass

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmCilNestedClass.h" */
...
// Class Definition for SgAsmCilNestedClass
class ROSE_DLL_API SgAsmCilNestedClass  : public SgAsmCilMetadata
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmCilNestedClass.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 34291 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmCilNestedClass;
          enum { static_variant = V_SgAsmCilNestedClass };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmCilNestedClass* isSgAsmCilNestedClass(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmCilNestedClass* isSgAsmCilNestedClass( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmCilNestedClass * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmCilNestedClassStorageClass *); // 
          ...
          /// \private
          static SgAsmCilNestedClass * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmCilNestedClass * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmCilNestedClass::operator delete (pointer,sizeof(SgAsmCilNestedClass));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmCilNestedClass* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmCilNestedClass* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmCilNestedClass* sgnode);
     ...
     public:
       ...
       */
       // SgAsmCilNestedClass( SgAsmCilNestedClassStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmCilNestedClassStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmCilNestedClass( const SgAsmCilNestedClassStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmCilNestedClass* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmCilNestedClass* isSgAsmCilNestedClass ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmCilNestedClass>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilNestedClass, uint32_t,&SgAsmCilNestedClass::p_NestedClass>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilNestedClass, uint32_t,&SgAsmCilNestedClass::p_EnclosingClass>;
...
// postdeclarations for SgAsmCilNestedClass

/* #line 536 "/workspace/generated/src/frontend/SageIII//SgAsmCilNestedClass.h" */
...
/* #line 543 "/workspace/generated/src/frontend/SageIII//SgAsmCilNestedClass.h" */

#endif // ROSE_SgAsmCilNestedClass_H
