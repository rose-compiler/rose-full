...
#ifndef ROSE_SgAsmCoffSymbol_H
#define ROSE_SgAsmCoffSymbol_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmCoffSymbol

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmCoffSymbol.h" */
/* #line 30976 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// Class Definition for SgAsmCoffSymbol
class ROSE_DLL_API SgAsmCoffSymbol  : public SgAsmGenericSymbol
   {
     public:


/* #line 44 "/workspace/generated/src/frontend/SageIII//SgAsmCoffSymbol.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 31030 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmCoffSymbol;
          enum { static_variant = V_SgAsmCoffSymbol };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmCoffSymbol* isSgAsmCoffSymbol(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmCoffSymbol* isSgAsmCoffSymbol( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmCoffSymbol * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmCoffSymbolStorageClass *); // 
          ...
          /// \private
          static SgAsmCoffSymbol * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmCoffSymbol * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmCoffSymbol::operator delete (pointer,sizeof(SgAsmCoffSymbol));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmCoffSymbol* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmCoffSymbol* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmCoffSymbol* sgnode);
     ...
     public:
       ...
       */
       // SgAsmCoffSymbol( SgAsmCoffSymbolStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmCoffSymbolStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmCoffSymbol( const SgAsmCoffSymbolStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmCoffSymbol* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmCoffSymbol* isSgAsmCoffSymbol ( SgNode* s );

          typedef SgAsmGenericSymbol base_node_type;
...
// End of memberFunctionString
    ...
    protected:
// Start of memberFunctionString
std::string p_st_name;
          
// End of memberFunctionString
// Start of memberFunctionString
Rose::BinaryAnalysis::Address p_st_name_offset;
          
// End of memberFunctionString
// Start of memberFunctionString
int p_st_section_num;
...
// End of memberFunctionString
// Start of memberFunctionString
unsigned p_st_storage_class;
          
// End of memberFunctionString
// Start of memberFunctionString
unsigned p_st_num_aux_entries;
          
// End of memberFunctionString
// Start of memberFunctionString
SgUnsignedCharList p_auxiliaryData;
          
// End of memberFunctionString

    friend struct Rose::Traits::generated::describe_node_t<SgAsmCoffSymbol>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCoffSymbol, std::string,&SgAsmCoffSymbol::p_st_name>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCoffSymbol, Rose::BinaryAnalysis::Address,&SgAsmCoffSymbol::p_st_name_offset>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCoffSymbol, int,&SgAsmCoffSymbol::p_st_section_num>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCoffSymbol, unsigned,&SgAsmCoffSymbol::p_st_type>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCoffSymbol, unsigned,&SgAsmCoffSymbol::p_st_storage_class>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCoffSymbol, unsigned,&SgAsmCoffSymbol::p_st_num_aux_entries>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCoffSymbol, SgUnsignedCharList,&SgAsmCoffSymbol::p_auxiliaryData>;
...
// postdeclarations for SgAsmCoffSymbol

/* #line 657 "/workspace/generated/src/frontend/SageIII//SgAsmCoffSymbol.h" */
...
/* #line 664 "/workspace/generated/src/frontend/SageIII//SgAsmCoffSymbol.h" */

#endif // ROSE_SgAsmCoffSymbol_H
