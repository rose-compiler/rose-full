...
#ifndef ROSE_SgAsmCilImplMapTable_H
#define ROSE_SgAsmCilImplMapTable_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmCilImplMapTable

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmCilImplMapTable.h" */
...
// Class Definition for SgAsmCilImplMapTable
class ROSE_DLL_API SgAsmCilImplMapTable  : public SgAsmCilMetadata
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmCilImplMapTable.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 37567 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmCilImplMapTable;
          enum { static_variant = V_SgAsmCilImplMapTable };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmCilImplMapTable* isSgAsmCilImplMapTable(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmCilImplMapTable* isSgAsmCilImplMapTable( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmCilImplMapTable * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmCilImplMapTableStorageClass *); // 
          ...
          /// \private
          static SgAsmCilImplMapTable * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmCilImplMapTable * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmCilImplMapTable::operator delete (pointer,sizeof(SgAsmCilImplMapTable));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmCilImplMapTable* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmCilImplMapTable* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmCilImplMapTable* sgnode);
     ...
     public:
       ...
       */
       // SgAsmCilImplMapTable( SgAsmCilImplMapTableStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmCilImplMapTableStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmCilImplMapTable( const SgAsmCilImplMapTableStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmCilImplMapTable* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmCilImplMapTable* isSgAsmCilImplMapTable ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmCilImplMapTable>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilImplMapTable, std::vector<SgAsmCilImplMap*>,&SgAsmCilImplMapTable::p_elements>;
...
// postdeclarations for SgAsmCilImplMapTable

/* #line 508 "/workspace/generated/src/frontend/SageIII//SgAsmCilImplMapTable.h" */
...
/* #line 515 "/workspace/generated/src/frontend/SageIII//SgAsmCilImplMapTable.h" */

#endif // ROSE_SgAsmCilImplMapTable_H
