...
#ifndef ROSE_SgAsmControlFlagsExpression_H
#define ROSE_SgAsmControlFlagsExpression_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmControlFlagsExpression

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmControlFlagsExpression.h" */
/* #line 30411 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// Class Definition for SgAsmControlFlagsExpression
class ROSE_DLL_API SgAsmControlFlagsExpression  : public SgAsmExpression
   {
     public:


/* #line 42 "/workspace/generated/src/frontend/SageIII//SgAsmControlFlagsExpression.h" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmControlFlagsExpression;
          enum { static_variant = V_SgAsmControlFlagsExpression };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmControlFlagsExpression* isSgAsmControlFlagsExpression(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmControlFlagsExpression* isSgAsmControlFlagsExpression( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmControlFlagsExpression * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmControlFlagsExpressionStorageClass *); // 
          ...
          /// \private
          static SgAsmControlFlagsExpression * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmControlFlagsExpression * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmControlFlagsExpression::operator delete (pointer,sizeof(SgAsmControlFlagsExpression));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmControlFlagsExpression* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmControlFlagsExpression* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmControlFlagsExpression* sgnode);
     ...
     public:
       ...
       */
       // SgAsmControlFlagsExpression( SgAsmControlFlagsExpressionStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmControlFlagsExpressionStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmControlFlagsExpression( const SgAsmControlFlagsExpressionStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmControlFlagsExpression* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmControlFlagsExpression* isSgAsmControlFlagsExpression ( SgNode* s );
...
// End of memberFunctionString
    ...
    protected:
// Start of memberFunctionString
unsigned long p_bitFlags;
          
// End of memberFunctionString

    friend struct Rose::Traits::generated::describe_node_t<SgAsmControlFlagsExpression>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmControlFlagsExpression, unsigned long,&SgAsmControlFlagsExpression::p_bitFlags>;
...
// postdeclarations for SgAsmControlFlagsExpression

/* #line 513 "/workspace/generated/src/frontend/SageIII//SgAsmControlFlagsExpression.h" */
...
/* #line 520 "/workspace/generated/src/frontend/SageIII//SgAsmControlFlagsExpression.h" */

#endif // ROSE_SgAsmControlFlagsExpression_H
