...
#ifndef ROSE_SgAsmCilFileTable_H
#define ROSE_SgAsmCilFileTable_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmCilFileTable

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmCilFileTable.h" */
...
// Class Definition for SgAsmCilFileTable
class ROSE_DLL_API SgAsmCilFileTable  : public SgAsmCilMetadata
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmCilFileTable.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 38116 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmCilFileTable;
          enum { static_variant = V_SgAsmCilFileTable };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmCilFileTable* isSgAsmCilFileTable(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmCilFileTable* isSgAsmCilFileTable( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmCilFileTable * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmCilFileTableStorageClass *); // 
          ...
          /// \private
          static SgAsmCilFileTable * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmCilFileTable * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmCilFileTable::operator delete (pointer,sizeof(SgAsmCilFileTable));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmCilFileTable* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmCilFileTable* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmCilFileTable* sgnode);
     ...
     public:
       ...
       */
       // SgAsmCilFileTable( SgAsmCilFileTableStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmCilFileTableStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmCilFileTable( const SgAsmCilFileTableStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmCilFileTable* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmCilFileTable* isSgAsmCilFileTable ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmCilFileTable>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilFileTable, std::vector<SgAsmCilFile*>,&SgAsmCilFileTable::p_elements>;
...
// postdeclarations for SgAsmCilFileTable

/* #line 508 "/workspace/generated/src/frontend/SageIII//SgAsmCilFileTable.h" */
...
/* #line 515 "/workspace/generated/src/frontend/SageIII//SgAsmCilFileTable.h" */

#endif // ROSE_SgAsmCilFileTable_H
