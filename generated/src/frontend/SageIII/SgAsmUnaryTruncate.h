...
#ifndef ROSE_SgAsmUnaryTruncate_H
#define ROSE_SgAsmUnaryTruncate_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmUnaryTruncate

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmUnaryTruncate.h" */
...
// Class Definition for SgAsmUnaryTruncate
class ROSE_DLL_API SgAsmUnaryTruncate  : public SgAsmUnaryExpression
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmUnaryTruncate.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 641 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmUnaryTruncate;
          enum { static_variant = V_SgAsmUnaryTruncate };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmUnaryTruncate* isSgAsmUnaryTruncate(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmUnaryTruncate* isSgAsmUnaryTruncate( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmUnaryTruncate * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmUnaryTruncateStorageClass *); // 
          ...
          /// \private
          static SgAsmUnaryTruncate * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmUnaryTruncate * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmUnaryTruncate::operator delete (pointer,sizeof(SgAsmUnaryTruncate));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmUnaryTruncate* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmUnaryTruncate* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmUnaryTruncate* sgnode);
     ...
     public:
       ...
       */
       // SgAsmUnaryTruncate( SgAsmUnaryTruncateStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmUnaryTruncateStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmUnaryTruncate( const SgAsmUnaryTruncateStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmUnaryTruncate* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmUnaryTruncate* isSgAsmUnaryTruncate ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmUnaryTruncate>;
...
// postdeclarations for SgAsmUnaryTruncate

/* #line 500 "/workspace/generated/src/frontend/SageIII//SgAsmUnaryTruncate.h" */
...
/* #line 507 "/workspace/generated/src/frontend/SageIII//SgAsmUnaryTruncate.h" */

#endif // ROSE_SgAsmUnaryTruncate_H
