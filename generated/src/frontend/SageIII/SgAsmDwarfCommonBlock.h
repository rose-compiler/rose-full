...
#ifndef ROSE_SgAsmDwarfCommonBlock_H
#define ROSE_SgAsmDwarfCommonBlock_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmDwarfCommonBlock

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfCommonBlock.h" */
/* #line 28469 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// Class Definition for SgAsmDwarfCommonBlock
class ROSE_DLL_API SgAsmDwarfCommonBlock  : public SgAsmDwarfConstruct
   {
     public:


/* #line 44 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfCommonBlock.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 28486 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmDwarfCommonBlock;
          enum { static_variant = V_SgAsmDwarfCommonBlock };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmDwarfCommonBlock* isSgAsmDwarfCommonBlock(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmDwarfCommonBlock* isSgAsmDwarfCommonBlock( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmDwarfCommonBlock * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmDwarfCommonBlockStorageClass *); // 
          ...
          /// \private
          static SgAsmDwarfCommonBlock * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmDwarfCommonBlock * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmDwarfCommonBlock::operator delete (pointer,sizeof(SgAsmDwarfCommonBlock));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmDwarfCommonBlock* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmDwarfCommonBlock* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmDwarfCommonBlock* sgnode);
     ...
     public:
       ...
       */
       // SgAsmDwarfCommonBlock( SgAsmDwarfCommonBlockStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmDwarfCommonBlockStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmDwarfCommonBlock( const SgAsmDwarfCommonBlockStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmDwarfCommonBlock* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmDwarfCommonBlock* isSgAsmDwarfCommonBlock ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmDwarfCommonBlock>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmDwarfCommonBlock, SgAsmDwarfConstructList*,&SgAsmDwarfCommonBlock::p_body>;
...
// postdeclarations for SgAsmDwarfCommonBlock

/* #line 520 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfCommonBlock.h" */
...
/* #line 527 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfCommonBlock.h" */

#endif // ROSE_SgAsmDwarfCommonBlock_H
