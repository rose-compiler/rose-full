...
#ifndef ROSE_SgAsmCilInterfaceImpl_H
#define ROSE_SgAsmCilInterfaceImpl_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmCilInterfaceImpl

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmCilInterfaceImpl.h" */
...
// Class Definition for SgAsmCilInterfaceImpl
class ROSE_DLL_API SgAsmCilInterfaceImpl  : public SgAsmCilMetadata
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmCilInterfaceImpl.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 37395 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmCilInterfaceImpl;
          enum { static_variant = V_SgAsmCilInterfaceImpl };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmCilInterfaceImpl* isSgAsmCilInterfaceImpl(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmCilInterfaceImpl* isSgAsmCilInterfaceImpl( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmCilInterfaceImpl * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmCilInterfaceImplStorageClass *); // 
          ...
          /// \private
          static SgAsmCilInterfaceImpl * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmCilInterfaceImpl * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmCilInterfaceImpl::operator delete (pointer,sizeof(SgAsmCilInterfaceImpl));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmCilInterfaceImpl* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmCilInterfaceImpl* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmCilInterfaceImpl* sgnode);
     ...
     public:
       ...
       */
       // SgAsmCilInterfaceImpl( SgAsmCilInterfaceImplStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmCilInterfaceImplStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmCilInterfaceImpl( const SgAsmCilInterfaceImplStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmCilInterfaceImpl* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmCilInterfaceImpl* isSgAsmCilInterfaceImpl ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmCilInterfaceImpl>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilInterfaceImpl, uint32_t,&SgAsmCilInterfaceImpl::p_Class>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilInterfaceImpl, uint32_t,&SgAsmCilInterfaceImpl::p_Interface>;
...
// postdeclarations for SgAsmCilInterfaceImpl

/* #line 536 "/workspace/generated/src/frontend/SageIII//SgAsmCilInterfaceImpl.h" */
...
/* #line 543 "/workspace/generated/src/frontend/SageIII//SgAsmCilInterfaceImpl.h" */

#endif // ROSE_SgAsmCilInterfaceImpl_H
