...
#ifndef ROSE_SgAsmJvmRuntimeAnnotationPair_H
#define ROSE_SgAsmJvmRuntimeAnnotationPair_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmJvmRuntimeAnnotationPair

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmJvmRuntimeAnnotationPair.h" */
...
// Class Definition for SgAsmJvmRuntimeAnnotationPair
class ROSE_DLL_API SgAsmJvmRuntimeAnnotationPair  : public SgAsmJvmNode
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmJvmRuntimeAnnotationPair.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 10505 "/workspace/src/ROSETTA/src/binaryInstruction.C" */


    //----------------------- Boost serialization for SgAsmJvmRuntimeAnnotationPair -----------------------
...
private:
    ...
    void serialize(S &s, const unsigned /*version*/) {
        debugSerializationBegin("SgAsmJvmRuntimeAnnotationPair");
        s & BOOST_SERIALIZATION_BASE_OBJECT_NVP(SgAsmJvmNode);
        s & BOOST_SERIALIZATION_NVP(p_element_name_index);
        s & BOOST_SERIALIZATION_NVP(p_value);
        debugSerializationEnd("SgAsmJvmRuntimeAnnotationPair");
    }
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmJvmRuntimeAnnotationPair;
          enum { static_variant = V_SgAsmJvmRuntimeAnnotationPair };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmJvmRuntimeAnnotationPair* isSgAsmJvmRuntimeAnnotationPair(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmJvmRuntimeAnnotationPair* isSgAsmJvmRuntimeAnnotationPair( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmJvmRuntimeAnnotationPair * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmJvmRuntimeAnnotationPairStorageClass *); // 
          ...
          /// \private
          static SgAsmJvmRuntimeAnnotationPair * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmJvmRuntimeAnnotationPair * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmJvmRuntimeAnnotationPair::operator delete (pointer,sizeof(SgAsmJvmRuntimeAnnotationPair));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmJvmRuntimeAnnotationPair* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmJvmRuntimeAnnotationPair* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmJvmRuntimeAnnotationPair* sgnode);
     ...
     public:
       ...
       */
       // SgAsmJvmRuntimeAnnotationPair( SgAsmJvmRuntimeAnnotationPairStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmJvmRuntimeAnnotationPairStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmJvmRuntimeAnnotationPair( const SgAsmJvmRuntimeAnnotationPairStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmJvmRuntimeAnnotationPair* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmJvmRuntimeAnnotationPair* isSgAsmJvmRuntimeAnnotationPair ( SgNode* s );
...
// End of memberFunctionString
    ...
    protected:
// Start of memberFunctionString
uint16_t p_element_name_index;
          
// End of memberFunctionString
// Start of memberFunctionString
SgAsmJvmRuntimeAnnotationValue* p_value;
          
// End of memberFunctionString

    friend struct Rose::Traits::generated::describe_node_t<SgAsmJvmRuntimeAnnotationPair>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmJvmRuntimeAnnotationPair, uint16_t,&SgAsmJvmRuntimeAnnotationPair::p_element_name_index>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmJvmRuntimeAnnotationPair, SgAsmJvmRuntimeAnnotationValue*,&SgAsmJvmRuntimeAnnotationPair::p_value>;
...
// postdeclarations for SgAsmJvmRuntimeAnnotationPair

/* #line 546 "/workspace/generated/src/frontend/SageIII//SgAsmJvmRuntimeAnnotationPair.h" */
...
/* #line 553 "/workspace/generated/src/frontend/SageIII//SgAsmJvmRuntimeAnnotationPair.h" */

#endif // ROSE_SgAsmJvmRuntimeAnnotationPair_H
