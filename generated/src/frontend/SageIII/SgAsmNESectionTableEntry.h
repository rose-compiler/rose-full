...
#ifndef ROSE_SgAsmNESectionTableEntry_H
#define ROSE_SgAsmNESectionTableEntry_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmNESectionTableEntry

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmNESectionTableEntry.h" */
/* #line 5745 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// Class Definition for SgAsmNESectionTableEntry
class ROSE_DLL_API SgAsmNESectionTableEntry  : public SgAsmExecutableFileFormat
   {
     public:


/* #line 42 "/workspace/generated/src/frontend/SageIII//SgAsmNESectionTableEntry.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 5778 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmNESectionTableEntry;
          enum { static_variant = V_SgAsmNESectionTableEntry };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmNESectionTableEntry* isSgAsmNESectionTableEntry(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmNESectionTableEntry* isSgAsmNESectionTableEntry( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmNESectionTableEntry * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmNESectionTableEntryStorageClass *); // 
          ...
          /// \private
          static SgAsmNESectionTableEntry * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmNESectionTableEntry * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmNESectionTableEntry::operator delete (pointer,sizeof(SgAsmNESectionTableEntry));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmNESectionTableEntry* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmNESectionTableEntry* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmNESectionTableEntry* sgnode);
     ...
     public:
       ...
       */
       // SgAsmNESectionTableEntry( SgAsmNESectionTableEntryStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmNESectionTableEntryStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmNESectionTableEntry( const SgAsmNESectionTableEntryStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmNESectionTableEntry* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmNESectionTableEntry* isSgAsmNESectionTableEntry ( SgNode* s );
...
// End of memberFunctionString
// Start of memberFunctionString
Rose::BinaryAnalysis::Address p_physicalSize;
          
// End of memberFunctionString
// Start of memberFunctionString
Rose::BinaryAnalysis::Address p_virtualSize;
          
// End of memberFunctionString

    friend struct Rose::Traits::generated::describe_node_t<SgAsmNESectionTableEntry>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmNESectionTableEntry, unsigned,&SgAsmNESectionTableEntry::p_flags>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmNESectionTableEntry, unsigned,&SgAsmNESectionTableEntry::p_sector>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmNESectionTableEntry, Rose::BinaryAnalysis::Address,&SgAsmNESectionTableEntry::p_physicalSize>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmNESectionTableEntry, Rose::BinaryAnalysis::Address,&SgAsmNESectionTableEntry::p_virtualSize>;
...
// postdeclarations for SgAsmNESectionTableEntry

/* #line 606 "/workspace/generated/src/frontend/SageIII//SgAsmNESectionTableEntry.h" */
...
/* #line 613 "/workspace/generated/src/frontend/SageIII//SgAsmNESectionTableEntry.h" */

#endif // ROSE_SgAsmNESectionTableEntry_H
