...
#ifndef ROSE_SgAsmElfSegmentTable_H
#define ROSE_SgAsmElfSegmentTable_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmElfSegmentTable

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmElfSegmentTable.h" */
/* #line 20429 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// Class Definition for SgAsmElfSegmentTable
class ROSE_DLL_API SgAsmElfSegmentTable  : public SgAsmGenericSection
   {
     public:


/* #line 42 "/workspace/generated/src/frontend/SageIII//SgAsmElfSegmentTable.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 20444 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmElfSegmentTable;
          enum { static_variant = V_SgAsmElfSegmentTable };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmElfSegmentTable* isSgAsmElfSegmentTable(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmElfSegmentTable* isSgAsmElfSegmentTable( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmElfSegmentTable * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmElfSegmentTableStorageClass *); // 
          ...
          /// \private
          static SgAsmElfSegmentTable * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmElfSegmentTable * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmElfSegmentTable::operator delete (pointer,sizeof(SgAsmElfSegmentTable));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmElfSegmentTable* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmElfSegmentTable* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmElfSegmentTable* sgnode);
     ...
     public:
       ...
       */
       // SgAsmElfSegmentTable( SgAsmElfSegmentTableStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmElfSegmentTableStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmElfSegmentTable( const SgAsmElfSegmentTableStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmElfSegmentTable* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmElfSegmentTable* isSgAsmElfSegmentTable ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmElfSegmentTable>;
...
// postdeclarations for SgAsmElfSegmentTable

/* #line 543 "/workspace/generated/src/frontend/SageIII//SgAsmElfSegmentTable.h" */
...
/* #line 550 "/workspace/generated/src/frontend/SageIII//SgAsmElfSegmentTable.h" */

#endif // ROSE_SgAsmElfSegmentTable_H
