...
#ifndef ROSE_SgAsmDwarfTemplateTypeParameter_H
#define ROSE_SgAsmDwarfTemplateTypeParameter_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmDwarfTemplateTypeParameter

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfTemplateTypeParameter.h" */
...
// Class Definition for SgAsmDwarfTemplateTypeParameter
class ROSE_DLL_API SgAsmDwarfTemplateTypeParameter  : public SgAsmDwarfConstruct
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfTemplateTypeParameter.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 25184 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmDwarfTemplateTypeParameter;
          enum { static_variant = V_SgAsmDwarfTemplateTypeParameter };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmDwarfTemplateTypeParameter* isSgAsmDwarfTemplateTypeParameter(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmDwarfTemplateTypeParameter* isSgAsmDwarfTemplateTypeParameter( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmDwarfTemplateTypeParameter * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmDwarfTemplateTypeParameterStorageClass *); // 
          ...
          /// \private
          static SgAsmDwarfTemplateTypeParameter * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmDwarfTemplateTypeParameter * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmDwarfTemplateTypeParameter::operator delete (pointer,sizeof(SgAsmDwarfTemplateTypeParameter));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmDwarfTemplateTypeParameter* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmDwarfTemplateTypeParameter* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmDwarfTemplateTypeParameter* sgnode);
     ...
     public:
       ...
       */
       // SgAsmDwarfTemplateTypeParameter( SgAsmDwarfTemplateTypeParameterStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmDwarfTemplateTypeParameterStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmDwarfTemplateTypeParameter( const SgAsmDwarfTemplateTypeParameterStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmDwarfTemplateTypeParameter* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmDwarfTemplateTypeParameter* isSgAsmDwarfTemplateTypeParameter ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmDwarfTemplateTypeParameter>;
...
// postdeclarations for SgAsmDwarfTemplateTypeParameter

/* #line 502 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfTemplateTypeParameter.h" */
...
/* #line 509 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfTemplateTypeParameter.h" */

#endif // ROSE_SgAsmDwarfTemplateTypeParameter_H
