...
#ifndef ROSE_SgAsmJvmAttribute_H
#define ROSE_SgAsmJvmAttribute_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmJvmAttribute

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmJvmAttribute.h" */
...
// Class Definition for SgAsmJvmAttribute
class ROSE_DLL_API SgAsmJvmAttribute  : public SgAsmJvmNode
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmJvmAttribute.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 14721 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmJvmAttribute;
          enum { static_variant = V_SgAsmJvmAttribute };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmJvmAttribute* isSgAsmJvmAttribute(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmJvmAttribute* isSgAsmJvmAttribute( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmJvmAttribute * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmJvmAttributeStorageClass *); // 
          ...
          /// \private
          static SgAsmJvmAttribute * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmJvmAttribute * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmJvmAttribute::operator delete (pointer,sizeof(SgAsmJvmAttribute));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmJvmAttribute* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmJvmAttribute* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmJvmAttribute* sgnode);
     ...
     public:
       ...
       */
       // SgAsmJvmAttribute( SgAsmJvmAttributeStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmJvmAttributeStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmJvmAttribute( const SgAsmJvmAttributeStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmJvmAttribute* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmJvmAttribute* isSgAsmJvmAttribute ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmJvmAttribute>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmJvmAttribute, uint16_t,&SgAsmJvmAttribute::p_attribute_name_index>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmJvmAttribute, uint32_t,&SgAsmJvmAttribute::p_attribute_length>;
...
// postdeclarations for SgAsmJvmAttribute

/* #line 542 "/workspace/generated/src/frontend/SageIII//SgAsmJvmAttribute.h" */
...
/* #line 549 "/workspace/generated/src/frontend/SageIII//SgAsmJvmAttribute.h" */

#endif // ROSE_SgAsmJvmAttribute_H
