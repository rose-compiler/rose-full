...
#ifndef ROSE_SgAsmCilTypeDefTable_H
#define ROSE_SgAsmCilTypeDefTable_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmCilTypeDefTable

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmCilTypeDefTable.h" */
...
// Class Definition for SgAsmCilTypeDefTable
class ROSE_DLL_API SgAsmCilTypeDefTable  : public SgAsmCilMetadata
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmCilTypeDefTable.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 33280 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmCilTypeDefTable;
          enum { static_variant = V_SgAsmCilTypeDefTable };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmCilTypeDefTable* isSgAsmCilTypeDefTable(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmCilTypeDefTable* isSgAsmCilTypeDefTable( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmCilTypeDefTable * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmCilTypeDefTableStorageClass *); // 
          ...
          /// \private
          static SgAsmCilTypeDefTable * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmCilTypeDefTable * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmCilTypeDefTable::operator delete (pointer,sizeof(SgAsmCilTypeDefTable));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmCilTypeDefTable* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmCilTypeDefTable* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmCilTypeDefTable* sgnode);
     ...
     public:
       ...
       */
       // SgAsmCilTypeDefTable( SgAsmCilTypeDefTableStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmCilTypeDefTableStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmCilTypeDefTable( const SgAsmCilTypeDefTableStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmCilTypeDefTable* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmCilTypeDefTable* isSgAsmCilTypeDefTable ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmCilTypeDefTable>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilTypeDefTable, std::vector<SgAsmCilTypeDef*>,&SgAsmCilTypeDefTable::p_elements>;
...
// postdeclarations for SgAsmCilTypeDefTable

/* #line 508 "/workspace/generated/src/frontend/SageIII//SgAsmCilTypeDefTable.h" */
...
/* #line 515 "/workspace/generated/src/frontend/SageIII//SgAsmCilTypeDefTable.h" */

#endif // ROSE_SgAsmCilTypeDefTable_H
