...
#ifndef ROSE_SgAsmElfSymverNeededAux_H
#define ROSE_SgAsmElfSymverNeededAux_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmElfSymverNeededAux

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmElfSymverNeededAux.h" */
/* #line 18741 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// Class Definition for SgAsmElfSymverNeededAux
class ROSE_DLL_API SgAsmElfSymverNeededAux  : public SgAsmExecutableFileFormat
   {
     public:


/* #line 46 "/workspace/generated/src/frontend/SageIII//SgAsmElfSymverNeededAux.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 18779 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmElfSymverNeededAux;
          enum { static_variant = V_SgAsmElfSymverNeededAux };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmElfSymverNeededAux* isSgAsmElfSymverNeededAux(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmElfSymverNeededAux* isSgAsmElfSymverNeededAux( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmElfSymverNeededAux * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmElfSymverNeededAuxStorageClass *); // 
          ...
          /// \private
          static SgAsmElfSymverNeededAux * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmElfSymverNeededAux * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmElfSymverNeededAux::operator delete (pointer,sizeof(SgAsmElfSymverNeededAux));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmElfSymverNeededAux* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmElfSymverNeededAux* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmElfSymverNeededAux* sgnode);
     ...
     public:
       ...
       */
       // SgAsmElfSymverNeededAux( SgAsmElfSymverNeededAuxStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmElfSymverNeededAuxStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmElfSymverNeededAux( const SgAsmElfSymverNeededAuxStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmElfSymverNeededAux* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmElfSymverNeededAux* isSgAsmElfSymverNeededAux ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmElfSymverNeededAux>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmElfSymverNeededAux, uint32_t,&SgAsmElfSymverNeededAux::p_hash>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmElfSymverNeededAux, int,&SgAsmElfSymverNeededAux::p_flags>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmElfSymverNeededAux, size_t,&SgAsmElfSymverNeededAux::p_other>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmElfSymverNeededAux, SgAsmGenericString*,&SgAsmElfSymverNeededAux::p_name>;
...
// postdeclarations for SgAsmElfSymverNeededAux

/* #line 619 "/workspace/generated/src/frontend/SageIII//SgAsmElfSymverNeededAux.h" */
...
/* #line 626 "/workspace/generated/src/frontend/SageIII//SgAsmElfSymverNeededAux.h" */

#endif // ROSE_SgAsmElfSymverNeededAux_H
