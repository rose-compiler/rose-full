...
#ifndef ROSE_SgAsmDwarfConstant_H
#define ROSE_SgAsmDwarfConstant_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmDwarfConstant

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfConstant.h" */
...
// Class Definition for SgAsmDwarfConstant
class ROSE_DLL_API SgAsmDwarfConstant  : public SgAsmDwarfConstruct
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfConstant.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 28014 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmDwarfConstant;
          enum { static_variant = V_SgAsmDwarfConstant };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmDwarfConstant* isSgAsmDwarfConstant(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmDwarfConstant* isSgAsmDwarfConstant( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmDwarfConstant * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmDwarfConstantStorageClass *); // 
          ...
          /// \private
          static SgAsmDwarfConstant * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmDwarfConstant * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmDwarfConstant::operator delete (pointer,sizeof(SgAsmDwarfConstant));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmDwarfConstant* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmDwarfConstant* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmDwarfConstant* sgnode);
     ...
     public:
       ...
       */
       // SgAsmDwarfConstant( SgAsmDwarfConstantStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmDwarfConstantStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmDwarfConstant( const SgAsmDwarfConstantStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmDwarfConstant* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmDwarfConstant* isSgAsmDwarfConstant ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmDwarfConstant>;
...
// postdeclarations for SgAsmDwarfConstant

/* #line 502 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfConstant.h" */
...
/* #line 509 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfConstant.h" */

#endif // ROSE_SgAsmDwarfConstant_H
