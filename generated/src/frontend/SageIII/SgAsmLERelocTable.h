...
#ifndef ROSE_SgAsmLERelocTable_H
#define ROSE_SgAsmLERelocTable_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmLERelocTable

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmLERelocTable.h" */
/* #line 7959 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// Class Definition for SgAsmLERelocTable
class ROSE_DLL_API SgAsmLERelocTable  : public SgAsmGenericSection
   {
     public:


/* #line 42 "/workspace/generated/src/frontend/SageIII//SgAsmLERelocTable.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 7974 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmLERelocTable;
          enum { static_variant = V_SgAsmLERelocTable };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmLERelocTable* isSgAsmLERelocTable(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmLERelocTable* isSgAsmLERelocTable( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmLERelocTable * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmLERelocTableStorageClass *); // 
          ...
          /// \private
          static SgAsmLERelocTable * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmLERelocTable * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmLERelocTable::operator delete (pointer,sizeof(SgAsmLERelocTable));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmLERelocTable* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmLERelocTable* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmLERelocTable* sgnode);
     ...
     public:
       ...
       */
       // SgAsmLERelocTable( SgAsmLERelocTableStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmLERelocTableStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmLERelocTable( const SgAsmLERelocTableStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmLERelocTable* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmLERelocTable* isSgAsmLERelocTable ( SgNode* s );
...
// End of memberFunctionString
    ...
    protected:
// Start of memberFunctionString
SgAsmLERelocEntryPtrList p_entries;
          
// End of memberFunctionString

    friend struct Rose::Traits::generated::describe_node_t<SgAsmLERelocTable>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmLERelocTable, SgAsmLERelocEntryPtrList,&SgAsmLERelocTable::p_entries>;
...
// postdeclarations for SgAsmLERelocTable

/* #line 514 "/workspace/generated/src/frontend/SageIII//SgAsmLERelocTable.h" */
...
/* #line 521 "/workspace/generated/src/frontend/SageIII//SgAsmLERelocTable.h" */

#endif // ROSE_SgAsmLERelocTable_H
