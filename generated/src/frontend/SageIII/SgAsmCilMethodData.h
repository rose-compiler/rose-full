...
#ifndef ROSE_SgAsmCilMethodData_H
#define ROSE_SgAsmCilMethodData_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmCilMethodData

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmCilMethodData.h" */
/* #line 34782 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// Class Definition for SgAsmCilMethodData
class ROSE_DLL_API SgAsmCilMethodData  : public SgAsmCilNode
   {
     public:


/* #line 42 "/workspace/generated/src/frontend/SageIII//SgAsmCilMethodData.h" */

          virtual SgNode* copy ( SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 34813 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmCilMethodData;
          enum { static_variant = V_SgAsmCilMethodData };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmCilMethodData* isSgAsmCilMethodData(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmCilMethodData* isSgAsmCilMethodData( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmCilMethodData * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmCilMethodDataStorageClass *); // 
          ...
          /// \private
          static SgAsmCilMethodData * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmCilMethodData * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmCilMethodData::operator delete (pointer,sizeof(SgAsmCilMethodData));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmCilMethodData* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmCilMethodData* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmCilMethodData* sgnode);
     ...
     public:
       ...
       */
       // SgAsmCilMethodData( SgAsmCilMethodDataStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmCilMethodDataStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmCilMethodData( const SgAsmCilMethodDataStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmCilMethodData* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 670 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmCilMethodData* isSgAsmCilMethodData ( SgNode* s );
...
// End of memberFunctionString
// Start of memberFunctionString
std::uint32_t p_dataSize;
          
// End of memberFunctionString
// Start of memberFunctionString
std::vector<SgAsmCilExceptionData*> p_clauses;
          
// End of memberFunctionString

    friend struct Rose::Traits::generated::describe_node_t<SgAsmCilMethodData>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilMethodData, uint64_t,&SgAsmCilMethodData::p_kind>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilMethodData, std::uint32_t,&SgAsmCilMethodData::p_dataSize>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilMethodData, std::vector<SgAsmCilExceptionData*>,&SgAsmCilMethodData::p_clauses>;
...
// postdeclarations for SgAsmCilMethodData

/* #line 564 "/workspace/generated/src/frontend/SageIII//SgAsmCilMethodData.h" */
...
/* #line 571 "/workspace/generated/src/frontend/SageIII//SgAsmCilMethodData.h" */

#endif // ROSE_SgAsmCilMethodData_H
