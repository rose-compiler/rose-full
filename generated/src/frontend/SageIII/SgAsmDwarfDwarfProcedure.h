...
#ifndef ROSE_SgAsmDwarfDwarfProcedure_H
#define ROSE_SgAsmDwarfDwarfProcedure_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmDwarfDwarfProcedure

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfDwarfProcedure.h" */
...
// Class Definition for SgAsmDwarfDwarfProcedure
class ROSE_DLL_API SgAsmDwarfDwarfProcedure  : public SgAsmDwarfConstruct
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfDwarfProcedure.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 27826 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmDwarfDwarfProcedure;
          enum { static_variant = V_SgAsmDwarfDwarfProcedure };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmDwarfDwarfProcedure* isSgAsmDwarfDwarfProcedure(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmDwarfDwarfProcedure* isSgAsmDwarfDwarfProcedure( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmDwarfDwarfProcedure * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmDwarfDwarfProcedureStorageClass *); // 
          ...
          /// \private
          static SgAsmDwarfDwarfProcedure * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmDwarfDwarfProcedure * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmDwarfDwarfProcedure::operator delete (pointer,sizeof(SgAsmDwarfDwarfProcedure));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmDwarfDwarfProcedure* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmDwarfDwarfProcedure* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmDwarfDwarfProcedure* sgnode);
     ...
     public:
       ...
       */
       // SgAsmDwarfDwarfProcedure( SgAsmDwarfDwarfProcedureStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmDwarfDwarfProcedureStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmDwarfDwarfProcedure( const SgAsmDwarfDwarfProcedureStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmDwarfDwarfProcedure* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmDwarfDwarfProcedure* isSgAsmDwarfDwarfProcedure ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmDwarfDwarfProcedure>;
...
// postdeclarations for SgAsmDwarfDwarfProcedure

/* #line 502 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfDwarfProcedure.h" */
...
/* #line 509 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfDwarfProcedure.h" */

#endif // ROSE_SgAsmDwarfDwarfProcedure_H
