...
#ifndef ROSE_SgAsmCilAssembly_H
#define ROSE_SgAsmCilAssembly_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmCilAssembly

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmCilAssembly.h" */
...
// Class Definition for SgAsmCilAssembly
class ROSE_DLL_API SgAsmCilAssembly  : public SgAsmCilMetadata
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmCilAssembly.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 41693 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmCilAssembly;
          enum { static_variant = V_SgAsmCilAssembly };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmCilAssembly* isSgAsmCilAssembly(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmCilAssembly* isSgAsmCilAssembly( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmCilAssembly * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmCilAssemblyStorageClass *); // 
          ...
          /// \private
          static SgAsmCilAssembly * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmCilAssembly * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmCilAssembly::operator delete (pointer,sizeof(SgAsmCilAssembly));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmCilAssembly* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmCilAssembly* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmCilAssembly* sgnode);
     ...
     public:
       ...
       */
       // SgAsmCilAssembly( SgAsmCilAssemblyStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmCilAssemblyStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmCilAssembly( const SgAsmCilAssemblyStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmCilAssembly* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmCilAssembly* isSgAsmCilAssembly ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmCilAssembly>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilAssembly, uint32_t,&SgAsmCilAssembly::p_HashAlgId>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilAssembly, uint16_t,&SgAsmCilAssembly::p_MajorVersion>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilAssembly, uint16_t,&SgAsmCilAssembly::p_MinorVersion>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilAssembly, uint16_t,&SgAsmCilAssembly::p_BuildNumber>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilAssembly, uint16_t,&SgAsmCilAssembly::p_RevisionNumber>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilAssembly, uint32_t,&SgAsmCilAssembly::p_Flags>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilAssembly, uint32_t,&SgAsmCilAssembly::p_PublicKey>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilAssembly, uint32_t,&SgAsmCilAssembly::p_Name>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilAssembly, uint32_t,&SgAsmCilAssembly::p_Culture>;
...
// postdeclarations for SgAsmCilAssembly

/* #line 656 "/workspace/generated/src/frontend/SageIII//SgAsmCilAssembly.h" */
...
/* #line 663 "/workspace/generated/src/frontend/SageIII//SgAsmCilAssembly.h" */

#endif // ROSE_SgAsmCilAssembly_H
