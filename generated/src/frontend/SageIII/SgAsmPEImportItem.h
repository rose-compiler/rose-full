...
#ifndef ROSE_SgAsmPEImportItem_H
#define ROSE_SgAsmPEImportItem_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmPEImportItem

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmPEImportItem.h" */
/* #line 3068 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// Class Definition for SgAsmPEImportItem
class ROSE_DLL_API SgAsmPEImportItem  : public SgAsmExecutableFileFormat
   {
     public:


/* #line 47 "/workspace/generated/src/frontend/SageIII//SgAsmPEImportItem.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 3137 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmPEImportItem;
          enum { static_variant = V_SgAsmPEImportItem };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmPEImportItem* isSgAsmPEImportItem(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmPEImportItem* isSgAsmPEImportItem( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmPEImportItem * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmPEImportItemStorageClass *); // 
          ...
          /// \private
          static SgAsmPEImportItem * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmPEImportItem * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmPEImportItem::operator delete (pointer,sizeof(SgAsmPEImportItem));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmPEImportItem* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmPEImportItem* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmPEImportItem* sgnode);
     ...
     public:
       ...
       */
       // SgAsmPEImportItem( SgAsmPEImportItemStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmPEImportItemStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmPEImportItem( const SgAsmPEImportItemStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmPEImportItem* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmPEImportItem* isSgAsmPEImportItem ( SgNode* s );
...
// End of memberFunctionString
// Start of memberFunctionString
Rose::BinaryAnalysis::RelativeVirtualAddress p_hintname_rva;
          
// End of memberFunctionString
// Start of memberFunctionString
size_t p_hintname_nalloc;
          
// End of memberFunctionString
// Start of memberFunctionString
Rose::BinaryAnalysis::RelativeVirtualAddress p_bound_rva;
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmPEImportItem>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmPEImportItem, bool,&SgAsmPEImportItem::p_by_ordinal>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmPEImportItem, unsigned,&SgAsmPEImportItem::p_ordinal>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmPEImportItem, unsigned,&SgAsmPEImportItem::p_hint>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmPEImportItem, SgAsmGenericString*,&SgAsmPEImportItem::p_name>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmPEImportItem, Rose::BinaryAnalysis::RelativeVirtualAddress,&SgAsmPEImportItem::p_hintname_rva>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmPEImportItem, size_t,&SgAsmPEImportItem::p_hintname_nalloc>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmPEImportItem, Rose::BinaryAnalysis::RelativeVirtualAddress,&SgAsmPEImportItem::p_bound_rva>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmPEImportItem, bool,&SgAsmPEImportItem::p_iat_written>;
...
// postdeclarations for SgAsmPEImportItem

/* #line 672 "/workspace/generated/src/frontend/SageIII//SgAsmPEImportItem.h" */
...
/* #line 679 "/workspace/generated/src/frontend/SageIII//SgAsmPEImportItem.h" */

#endif // ROSE_SgAsmPEImportItem_H
