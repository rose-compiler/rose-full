...
#ifndef ROSE_SgAsmPEImportSection_H
#define ROSE_SgAsmPEImportSection_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmPEImportSection

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmPEImportSection.h" */
/* #line 2731 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// Class Definition for SgAsmPEImportSection
class ROSE_DLL_API SgAsmPEImportSection  : public SgAsmPESection
   {
     public:


/* #line 47 "/workspace/generated/src/frontend/SageIII//SgAsmPEImportSection.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 2893 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmPEImportSection;
          enum { static_variant = V_SgAsmPEImportSection };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmPEImportSection* isSgAsmPEImportSection(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmPEImportSection* isSgAsmPEImportSection( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmPEImportSection * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmPEImportSectionStorageClass *); // 
          ...
          /// \private
          static SgAsmPEImportSection * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmPEImportSection * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmPEImportSection::operator delete (pointer,sizeof(SgAsmPEImportSection));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmPEImportSection* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmPEImportSection* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmPEImportSection* sgnode);
     ...
     public:
       ...
       */
       // SgAsmPEImportSection( SgAsmPEImportSectionStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmPEImportSectionStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmPEImportSection( const SgAsmPEImportSectionStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmPEImportSection* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmPEImportSection* isSgAsmPEImportSection ( SgNode* s );
...
// End of memberFunctionString
    ...
    protected:
// Start of memberFunctionString
SgAsmPEImportDirectoryList* p_importDirectories;
          
// End of memberFunctionString

    friend struct Rose::Traits::generated::describe_node_t<SgAsmPEImportSection>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmPEImportSection, SgAsmPEImportDirectoryList*,&SgAsmPEImportSection::p_importDirectories>;
...
// postdeclarations for SgAsmPEImportSection

/* #line 559 "/workspace/generated/src/frontend/SageIII//SgAsmPEImportSection.h" */
...
/* #line 566 "/workspace/generated/src/frontend/SageIII//SgAsmPEImportSection.h" */

#endif // ROSE_SgAsmPEImportSection_H
