...
#ifndef ROSE_SgAsmCilFieldLayout_H
#define ROSE_SgAsmCilFieldLayout_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmCilFieldLayout

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmCilFieldLayout.h" */
...
// Class Definition for SgAsmCilFieldLayout
class ROSE_DLL_API SgAsmCilFieldLayout  : public SgAsmCilMetadata
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmCilFieldLayout.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 38750 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmCilFieldLayout;
          enum { static_variant = V_SgAsmCilFieldLayout };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmCilFieldLayout* isSgAsmCilFieldLayout(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmCilFieldLayout* isSgAsmCilFieldLayout( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmCilFieldLayout * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmCilFieldLayoutStorageClass *); // 
          ...
          /// \private
          static SgAsmCilFieldLayout * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmCilFieldLayout * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmCilFieldLayout::operator delete (pointer,sizeof(SgAsmCilFieldLayout));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmCilFieldLayout* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmCilFieldLayout* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmCilFieldLayout* sgnode);
     ...
     public:
       ...
       */
       // SgAsmCilFieldLayout( SgAsmCilFieldLayoutStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmCilFieldLayoutStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmCilFieldLayout( const SgAsmCilFieldLayoutStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmCilFieldLayout* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmCilFieldLayout* isSgAsmCilFieldLayout ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmCilFieldLayout>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilFieldLayout, uint32_t,&SgAsmCilFieldLayout::p_Offset>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilFieldLayout, uint32_t,&SgAsmCilFieldLayout::p_Field>;
...
// postdeclarations for SgAsmCilFieldLayout

/* #line 535 "/workspace/generated/src/frontend/SageIII//SgAsmCilFieldLayout.h" */
...
/* #line 542 "/workspace/generated/src/frontend/SageIII//SgAsmCilFieldLayout.h" */

#endif // ROSE_SgAsmCilFieldLayout_H
