...
#ifndef ROSE_SgAsmElfSectionTableEntry_H
#define ROSE_SgAsmElfSectionTableEntry_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmElfSectionTableEntry

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmElfSectionTableEntry.h" */
/* #line 21072 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// Class Definition for SgAsmElfSectionTableEntry
class ROSE_DLL_API SgAsmElfSectionTableEntry  : public SgAsmExecutableFileFormat
   {
     public:


/* #line 44 "/workspace/generated/src/frontend/SageIII//SgAsmElfSectionTableEntry.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 21150 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmElfSectionTableEntry;
          enum { static_variant = V_SgAsmElfSectionTableEntry };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmElfSectionTableEntry* isSgAsmElfSectionTableEntry(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmElfSectionTableEntry* isSgAsmElfSectionTableEntry( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmElfSectionTableEntry * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmElfSectionTableEntryStorageClass *); // 
          ...
          /// \private
          static SgAsmElfSectionTableEntry * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmElfSectionTableEntry * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmElfSectionTableEntry::operator delete (pointer,sizeof(SgAsmElfSectionTableEntry));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmElfSectionTableEntry* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmElfSectionTableEntry* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmElfSectionTableEntry* sgnode);
     ...
     public:
       ...
       */
       // SgAsmElfSectionTableEntry( SgAsmElfSectionTableEntryStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmElfSectionTableEntryStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmElfSectionTableEntry( const SgAsmElfSectionTableEntryStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmElfSectionTableEntry* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmElfSectionTableEntry* isSgAsmElfSectionTableEntry ( SgNode* s );
...
// End of memberFunctionString
// Start of memberFunctionString
SgAsmElfSectionTableEntry::SectionType p_sh_type;
          
// End of memberFunctionString
// Start of memberFunctionString
unsigned long p_sh_link;
          
// End of memberFunctionString
// Start of memberFunctionString
unsigned long p_sh_info;
...
// End of memberFunctionString
// Start of memberFunctionString
Rose::BinaryAnalysis::Address p_sh_addr;
          
// End of memberFunctionString
// Start of memberFunctionString
Rose::BinaryAnalysis::Address p_sh_offset;
          
// End of memberFunctionString
// Start of memberFunctionString
Rose::BinaryAnalysis::Address p_sh_size;
          
// End of memberFunctionString
// Start of memberFunctionString
Rose::BinaryAnalysis::Address p_sh_addralign;
          
// End of memberFunctionString
// Start of memberFunctionString
Rose::BinaryAnalysis::Address p_sh_entsize;
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmElfSectionTableEntry>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmElfSectionTableEntry, unsigned,&SgAsmElfSectionTableEntry::p_sh_name>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmElfSectionTableEntry, SgAsmElfSectionTableEntry::SectionType,&SgAsmElfSectionTableEntry::p_sh_type>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmElfSectionTableEntry, unsigned long,&SgAsmElfSectionTableEntry::p_sh_link>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmElfSectionTableEntry, unsigned long,&SgAsmElfSectionTableEntry::p_sh_info>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmElfSectionTableEntry, uint64_t,&SgAsmElfSectionTableEntry::p_sh_flags>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmElfSectionTableEntry, Rose::BinaryAnalysis::Address,&SgAsmElfSectionTableEntry::p_sh_addr>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmElfSectionTableEntry, Rose::BinaryAnalysis::Address,&SgAsmElfSectionTableEntry::p_sh_offset>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmElfSectionTableEntry, Rose::BinaryAnalysis::Address,&SgAsmElfSectionTableEntry::p_sh_size>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmElfSectionTableEntry, Rose::BinaryAnalysis::Address,&SgAsmElfSectionTableEntry::p_sh_addralign>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmElfSectionTableEntry, Rose::BinaryAnalysis::Address,&SgAsmElfSectionTableEntry::p_sh_entsize>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmElfSectionTableEntry, SgUnsignedCharList,&SgAsmElfSectionTableEntry::p_extra>;
...
// postdeclarations for SgAsmElfSectionTableEntry

/* #line 824 "/workspace/generated/src/frontend/SageIII//SgAsmElfSectionTableEntry.h" */
...
/* #line 831 "/workspace/generated/src/frontend/SageIII//SgAsmElfSectionTableEntry.h" */

#endif // ROSE_SgAsmElfSectionTableEntry_H
