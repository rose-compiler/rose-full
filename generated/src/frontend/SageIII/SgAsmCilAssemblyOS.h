...
#ifndef ROSE_SgAsmCilAssemblyOS_H
#define ROSE_SgAsmCilAssemblyOS_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmCilAssemblyOS

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmCilAssemblyOS.h" */
...
// Class Definition for SgAsmCilAssemblyOS
class ROSE_DLL_API SgAsmCilAssemblyOS  : public SgAsmCilMetadata
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmCilAssemblyOS.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 41549 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmCilAssemblyOS;
          enum { static_variant = V_SgAsmCilAssemblyOS };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmCilAssemblyOS* isSgAsmCilAssemblyOS(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmCilAssemblyOS* isSgAsmCilAssemblyOS( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmCilAssemblyOS * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmCilAssemblyOSStorageClass *); // 
          ...
          /// \private
          static SgAsmCilAssemblyOS * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmCilAssemblyOS * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmCilAssemblyOS::operator delete (pointer,sizeof(SgAsmCilAssemblyOS));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmCilAssemblyOS* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmCilAssemblyOS* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmCilAssemblyOS* sgnode);
     ...
     public:
       ...
       */
       // SgAsmCilAssemblyOS( SgAsmCilAssemblyOSStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmCilAssemblyOSStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmCilAssemblyOS( const SgAsmCilAssemblyOSStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmCilAssemblyOS* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmCilAssemblyOS* isSgAsmCilAssemblyOS ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmCilAssemblyOS>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilAssemblyOS, uint32_t,&SgAsmCilAssemblyOS::p_OSPlatformID>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilAssemblyOS, uint32_t,&SgAsmCilAssemblyOS::p_OSMajorVersion>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilAssemblyOS, uint32_t,&SgAsmCilAssemblyOS::p_OSMinorVersion>;
...
// postdeclarations for SgAsmCilAssemblyOS

/* #line 550 "/workspace/generated/src/frontend/SageIII//SgAsmCilAssemblyOS.h" */
...
/* #line 557 "/workspace/generated/src/frontend/SageIII//SgAsmCilAssemblyOS.h" */

#endif // ROSE_SgAsmCilAssemblyOS_H
