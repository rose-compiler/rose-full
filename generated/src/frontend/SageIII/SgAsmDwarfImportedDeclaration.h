...
#ifndef ROSE_SgAsmDwarfImportedDeclaration_H
#define ROSE_SgAsmDwarfImportedDeclaration_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmDwarfImportedDeclaration

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfImportedDeclaration.h" */
...
// Class Definition for SgAsmDwarfImportedDeclaration
class ROSE_DLL_API SgAsmDwarfImportedDeclaration  : public SgAsmDwarfConstruct
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfImportedDeclaration.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 27265 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmDwarfImportedDeclaration;
          enum { static_variant = V_SgAsmDwarfImportedDeclaration };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmDwarfImportedDeclaration* isSgAsmDwarfImportedDeclaration(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmDwarfImportedDeclaration* isSgAsmDwarfImportedDeclaration( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmDwarfImportedDeclaration * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmDwarfImportedDeclarationStorageClass *); // 
          ...
          /// \private
          static SgAsmDwarfImportedDeclaration * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmDwarfImportedDeclaration * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmDwarfImportedDeclaration::operator delete (pointer,sizeof(SgAsmDwarfImportedDeclaration));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmDwarfImportedDeclaration* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmDwarfImportedDeclaration* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmDwarfImportedDeclaration* sgnode);
     ...
     public:
       ...
       */
       // SgAsmDwarfImportedDeclaration( SgAsmDwarfImportedDeclarationStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmDwarfImportedDeclarationStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmDwarfImportedDeclaration( const SgAsmDwarfImportedDeclarationStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmDwarfImportedDeclaration* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmDwarfImportedDeclaration* isSgAsmDwarfImportedDeclaration ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmDwarfImportedDeclaration>;
...
// postdeclarations for SgAsmDwarfImportedDeclaration

/* #line 502 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfImportedDeclaration.h" */
...
/* #line 509 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfImportedDeclaration.h" */

#endif // ROSE_SgAsmDwarfImportedDeclaration_H
