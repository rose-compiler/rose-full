...
#ifndef ROSE_SgAsmSynthesizedDataStructureDeclaration_H
#define ROSE_SgAsmSynthesizedDataStructureDeclaration_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmSynthesizedDataStructureDeclaration

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmSynthesizedDataStructureDeclaration.h" */
/* #line 1118 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// Class Definition for SgAsmSynthesizedDataStructureDeclaration
class ROSE_DLL_API SgAsmSynthesizedDataStructureDeclaration  : public SgAsmSynthesizedDeclaration
   {
     public:


/* #line 42 "/workspace/generated/src/frontend/SageIII//SgAsmSynthesizedDataStructureDeclaration.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 1137 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmSynthesizedDataStructureDeclaration;
          enum { static_variant = V_SgAsmSynthesizedDataStructureDeclaration };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmSynthesizedDataStructureDeclaration* isSgAsmSynthesizedDataStructureDeclaration(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmSynthesizedDataStructureDeclaration* isSgAsmSynthesizedDataStructureDeclaration( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmSynthesizedDataStructureDeclaration * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmSynthesizedDataStructureDeclarationStorageClass *); // 
          ...
          /// \private
          static SgAsmSynthesizedDataStructureDeclaration * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmSynthesizedDataStructureDeclaration * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmSynthesizedDataStructureDeclaration::operator delete (pointer,sizeof(SgAsmSynthesizedDataStructureDeclaration));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmSynthesizedDataStructureDeclaration* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmSynthesizedDataStructureDeclaration* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmSynthesizedDataStructureDeclaration* sgnode);
     ...
     public:
       ...
       */
       // SgAsmSynthesizedDataStructureDeclaration( SgAsmSynthesizedDataStructureDeclarationStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmSynthesizedDataStructureDeclarationStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmSynthesizedDataStructureDeclaration( const SgAsmSynthesizedDataStructureDeclarationStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmSynthesizedDataStructureDeclaration* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmSynthesizedDataStructureDeclaration* isSgAsmSynthesizedDataStructureDeclaration ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmSynthesizedDataStructureDeclaration>;
...
// postdeclarations for SgAsmSynthesizedDataStructureDeclaration

/* #line 517 "/workspace/generated/src/frontend/SageIII//SgAsmSynthesizedDataStructureDeclaration.h" */
...
/* #line 524 "/workspace/generated/src/frontend/SageIII//SgAsmSynthesizedDataStructureDeclaration.h" */

#endif // ROSE_SgAsmSynthesizedDataStructureDeclaration_H
