...
#ifndef ROSE_SgAsmType_H
#define ROSE_SgAsmType_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmType

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmType.h" */
...
// Class Definition for SgAsmType
class ROSE_DLL_API SgAsmType  : public SgAsmNode
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmType.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 18017 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmType* isSgAsmType(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmType* isSgAsmType( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmType * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmTypeStorageClass *); // 
          ...
          /// \private
          static SgAsmType * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmType * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmType::operator delete (pointer,sizeof(SgAsmType));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmType* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmType* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmType* sgnode);
     ...
     public:
       ...
       */
       // SgAsmType( SgAsmTypeStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmTypeStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmType( const SgAsmTypeStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmType* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmType* isSgAsmType ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmType>;
...
// postdeclarations for SgAsmType

/* #line 542 "/workspace/generated/src/frontend/SageIII//SgAsmType.h" */
...
/* #line 549 "/workspace/generated/src/frontend/SageIII//SgAsmType.h" */

#endif // ROSE_SgAsmType_H
