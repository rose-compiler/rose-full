...
#ifndef ROSE_SgAsmCilDataStream_H
#define ROSE_SgAsmCilDataStream_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmCilDataStream

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmCilDataStream.h" */
...
// Class Definition for SgAsmCilDataStream
class ROSE_DLL_API SgAsmCilDataStream  : public SgAsmCilNode
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmCilDataStream.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 39955 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmCilDataStream;
          enum { static_variant = V_SgAsmCilDataStream };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmCilDataStream* isSgAsmCilDataStream(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmCilDataStream* isSgAsmCilDataStream( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmCilDataStream * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmCilDataStreamStorageClass *); // 
          ...
          /// \private
          static SgAsmCilDataStream * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmCilDataStream * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmCilDataStream::operator delete (pointer,sizeof(SgAsmCilDataStream));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmCilDataStream* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmCilDataStream* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmCilDataStream* sgnode);
     ...
     public:
       ...
       */
       // SgAsmCilDataStream( SgAsmCilDataStreamStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmCilDataStreamStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmCilDataStream( const SgAsmCilDataStreamStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmCilDataStream* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmCilDataStream* isSgAsmCilDataStream ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmCilDataStream>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilDataStream, uint32_t,&SgAsmCilDataStream::p_Offset>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilDataStream, uint32_t,&SgAsmCilDataStream::p_Size>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilDataStream, std::string,&SgAsmCilDataStream::p_Name>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilDataStream, uint32_t,&SgAsmCilDataStream::p_NamePadding>;
...
// postdeclarations for SgAsmCilDataStream

/* #line 589 "/workspace/generated/src/frontend/SageIII//SgAsmCilDataStream.h" */
...
/* #line 596 "/workspace/generated/src/frontend/SageIII//SgAsmCilDataStream.h" */

#endif // ROSE_SgAsmCilDataStream_H
