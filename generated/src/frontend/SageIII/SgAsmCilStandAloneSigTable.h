...
#ifndef ROSE_SgAsmCilStandAloneSigTable_H
#define ROSE_SgAsmCilStandAloneSigTable_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmCilStandAloneSigTable

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmCilStandAloneSigTable.h" */
...
// Class Definition for SgAsmCilStandAloneSigTable
class ROSE_DLL_API SgAsmCilStandAloneSigTable  : public SgAsmCilMetadata
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmCilStandAloneSigTable.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 33564 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmCilStandAloneSigTable;
          enum { static_variant = V_SgAsmCilStandAloneSigTable };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmCilStandAloneSigTable* isSgAsmCilStandAloneSigTable(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmCilStandAloneSigTable* isSgAsmCilStandAloneSigTable( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmCilStandAloneSigTable * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmCilStandAloneSigTableStorageClass *); // 
          ...
          /// \private
          static SgAsmCilStandAloneSigTable * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmCilStandAloneSigTable * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmCilStandAloneSigTable::operator delete (pointer,sizeof(SgAsmCilStandAloneSigTable));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmCilStandAloneSigTable* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmCilStandAloneSigTable* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmCilStandAloneSigTable* sgnode);
     ...
     public:
       ...
       */
       // SgAsmCilStandAloneSigTable( SgAsmCilStandAloneSigTableStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmCilStandAloneSigTableStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmCilStandAloneSigTable( const SgAsmCilStandAloneSigTableStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmCilStandAloneSigTable* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmCilStandAloneSigTable* isSgAsmCilStandAloneSigTable ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmCilStandAloneSigTable>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilStandAloneSigTable, std::vector<SgAsmCilStandAloneSig*>,&SgAsmCilStandAloneSigTable::p_elements>;
...
// postdeclarations for SgAsmCilStandAloneSigTable

/* #line 508 "/workspace/generated/src/frontend/SageIII//SgAsmCilStandAloneSigTable.h" */
...
/* #line 515 "/workspace/generated/src/frontend/SageIII//SgAsmCilStandAloneSigTable.h" */

#endif // ROSE_SgAsmCilStandAloneSigTable_H
