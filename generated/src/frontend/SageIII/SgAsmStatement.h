...
#ifndef ROSE_SgAsmStatement_H
#define ROSE_SgAsmStatement_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmStatement

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmStatement.h" */
/* #line 45434 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// Class Definition for SgAsmStatement
class ROSE_DLL_API SgAsmStatement  : public SgAsmNode
   {
     public:


/* #line 42 "/workspace/generated/src/frontend/SageIII//SgAsmStatement.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 45459 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
     ...
     public:
          ...
          /// \private
          static SgAsmStatement * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmStatementStorageClass *); // 
          ...
          /// \private
          static SgAsmStatement * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmStatement * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmStatement::operator delete (pointer,sizeof(SgAsmStatement));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmStatement* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmStatement* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmStatement* sgnode);
     ...
     public:
       ...
       */
       // SgAsmStatement( SgAsmStatementStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmStatementStorageClass;
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmStatement* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmStatement* isSgAsmStatement ( SgNode* s );
...
// End of memberFunctionString
    ...
    protected:
// Start of memberFunctionString
Rose::BinaryAnalysis::Address p_address;
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmStatement>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmStatement, Rose::BinaryAnalysis::Address,&SgAsmStatement::p_address>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmStatement, std::string,&SgAsmStatement::p_comment>;
...
// postdeclarations for SgAsmStatement

/* #line 536 "/workspace/generated/src/frontend/SageIII//SgAsmStatement.h" */
...
/* #line 543 "/workspace/generated/src/frontend/SageIII//SgAsmStatement.h" */

#endif // ROSE_SgAsmStatement_H
