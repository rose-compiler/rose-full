...
#ifndef ROSE_SgAsmJvmClass_H
#define ROSE_SgAsmJvmClass_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmJvmClass

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmJvmClass.h" */
...
// Class Definition for SgAsmJvmClass
class ROSE_DLL_API SgAsmJvmClass  : public SgAsmJvmNode
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmJvmClass.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 14234 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmJvmClass;
          enum { static_variant = V_SgAsmJvmClass };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmJvmClass* isSgAsmJvmClass(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmJvmClass* isSgAsmJvmClass( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmJvmClass * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmJvmClassStorageClass *); // 
          ...
          /// \private
          static SgAsmJvmClass * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmJvmClass * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmJvmClass::operator delete (pointer,sizeof(SgAsmJvmClass));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmJvmClass* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmJvmClass* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmJvmClass* sgnode);
     ...
     public:
       ...
       */
       // SgAsmJvmClass( SgAsmJvmClassStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmJvmClassStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmJvmClass( const SgAsmJvmClassStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmJvmClass* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmJvmClass* isSgAsmJvmClass ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmJvmClass>;
...
// postdeclarations for SgAsmJvmClass

/* #line 496 "/workspace/generated/src/frontend/SageIII//SgAsmJvmClass.h" */
...
/* #line 503 "/workspace/generated/src/frontend/SageIII//SgAsmJvmClass.h" */

#endif // ROSE_SgAsmJvmClass_H
