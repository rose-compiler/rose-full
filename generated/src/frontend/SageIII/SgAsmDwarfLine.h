...
#ifndef ROSE_SgAsmDwarfLine_H
#define ROSE_SgAsmDwarfLine_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmDwarfLine

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfLine.h" */
...
// Class Definition for SgAsmDwarfLine
class ROSE_DLL_API SgAsmDwarfLine  : public SgAsmDwarfInformation
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfLine.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 26733 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmDwarfLine;
          enum { static_variant = V_SgAsmDwarfLine };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmDwarfLine* isSgAsmDwarfLine(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmDwarfLine* isSgAsmDwarfLine( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmDwarfLine * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmDwarfLineStorageClass *); // 
          ...
          /// \private
          static SgAsmDwarfLine * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmDwarfLine * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmDwarfLine::operator delete (pointer,sizeof(SgAsmDwarfLine));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmDwarfLine* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmDwarfLine* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmDwarfLine* sgnode);
     ...
     public:
       ...
       */
       // SgAsmDwarfLine( SgAsmDwarfLineStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmDwarfLineStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmDwarfLine( const SgAsmDwarfLineStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmDwarfLine* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmDwarfLine* isSgAsmDwarfLine ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmDwarfLine>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmDwarfLine, uint64_t,&SgAsmDwarfLine::p_address>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmDwarfLine, int,&SgAsmDwarfLine::p_file_id>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmDwarfLine, int,&SgAsmDwarfLine::p_line>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmDwarfLine, int,&SgAsmDwarfLine::p_column>;
...
// postdeclarations for SgAsmDwarfLine

/* #line 548 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfLine.h" */
...
/* #line 555 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfLine.h" */

#endif // ROSE_SgAsmDwarfLine_H
