...
public:
    ...
    virtual void visit(SgAsmJvmIndexedAttr*);
...
public:
    ...
    void visit(SgTypeFloat16*);
    void visit(SgTypeFp16*);
    void visit(SgTypeBFloat16*);
    void visit(SgTypeFloat32x*);
    void visit(SgTypeFloat64x*);
    void visit(SgTypeFloat32*);
    void visit(SgTypeFloat64*);
    ...
    void visit(SgSignedIntegralType*);
    void visit(SgUnsignedIntegralType*);
    void visit(SgIntegralType*);
    void visit(SgFloatingPointType*);
    void visit(SgType*);
    ...
    void visit(SgBFloat16Val*);
    void visit(SgFloat16Val*);
    void visit(SgFloat32Val*);
    void visit(SgFloat64Val*);
    ...
    void visit(SgAsmJvmRuntimeVisibleAnnotations*);
    void visit(SgAsmJvmRuntimeVisibilityParamAnnotations*);
    void visit(SgAsmJvmRuntimeParameterAnnotation*);
    void visit(SgAsmJvmRuntimeInvisibleAnnotations*);
    void visit(SgAsmJvmRuntimeAnnotationValue*);
    void visit(SgAsmJvmRuntimeAnnotationPair*);
    void visit(SgAsmJvmRuntimeAnnotation*);
    void visit(SgAsmJvmModule*);
    ...
    void visit(SgAsmJvmIndexTableAttr*);
    void visit(SgAsmJvmIndexedAttr*);
    ...
    void visit(SgAsmJvmAnnotationDefault*);
...
public:
    ...
    virtual void visit(SgTypeFloat16 *x) {
        _strategy->visit(x);
    }

    virtual void visit(SgTypeFp16 *x) {
        _strategy->visit(x);
    }

    virtual void visit(SgTypeBFloat16 *x) {
        _strategy->visit(x);
    }

    virtual void visit(SgTypeFloat32x *x) {
        _strategy->visit(x);
    }

    virtual void visit(SgTypeFloat64x *x) {
        _strategy->visit(x);
    }

    virtual void visit(SgTypeFloat32 *x) {
        _strategy->visit(x);
    }

    virtual void visit(SgTypeFloat64 *x) {
        _strategy->visit(x);
    }
    ...
    virtual void visit(SgSignedIntegralType *x) {
        _strategy->visit(x);
    }

    virtual void visit(SgUnsignedIntegralType *x) {
        _strategy->visit(x);
    }

    virtual void visit(SgIntegralType *x) {
        _strategy->visit(x);
    }

    virtual void visit(SgFloatingPointType *x) {
        _strategy->visit(x);
    }
    ...
    virtual void visit(SgBFloat16Val *x) {
        _strategy->visit(x);
    }

    virtual void visit(SgFloat16Val *x) {
        _strategy->visit(x);
    }

    virtual void visit(SgFloat32Val *x) {
        _strategy->visit(x);
    }

    virtual void visit(SgFloat64Val *x) {
        _strategy->visit(x);
    }
    ...
    virtual void visit(SgAsmJvmRuntimeVisibleAnnotations *x) {
        _strategy->visit(x);
    }

    virtual void visit(SgAsmJvmRuntimeVisibilityParamAnnotations *x) {
        _strategy->visit(x);
    }

    virtual void visit(SgAsmJvmRuntimeParameterAnnotation *x) {
        _strategy->visit(x);
    }

    virtual void visit(SgAsmJvmRuntimeInvisibleAnnotations *x) {
        _strategy->visit(x);
    }

    virtual void visit(SgAsmJvmRuntimeAnnotationValue *x) {
        _strategy->visit(x);
    }

    virtual void visit(SgAsmJvmRuntimeAnnotationPair *x) {
        _strategy->visit(x);
    }

    virtual void visit(SgAsmJvmRuntimeAnnotation *x) {
        _strategy->visit(x);
    }

    virtual void visit(SgAsmJvmModule *x) {
        _strategy->visit(x);
    }
    ...
    virtual void visit(SgAsmJvmIndexTableAttr *x) {
        _strategy->visit(x);
    }

    virtual void visit(SgAsmJvmIndexedAttr *x) {
        _strategy->visit(x);
    }
    ...
    virtual void visit(SgAsmJvmAnnotationDefault *x) {
        _strategy->visit(x);
    }
