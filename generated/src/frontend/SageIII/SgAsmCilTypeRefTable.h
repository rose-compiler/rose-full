...
#ifndef ROSE_SgAsmCilTypeRefTable_H
#define ROSE_SgAsmCilTypeRefTable_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmCilTypeRefTable

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmCilTypeRefTable.h" */
...
// Class Definition for SgAsmCilTypeRefTable
class ROSE_DLL_API SgAsmCilTypeRefTable  : public SgAsmCilMetadata
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmCilTypeRefTable.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 33102 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmCilTypeRefTable;
          enum { static_variant = V_SgAsmCilTypeRefTable };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmCilTypeRefTable* isSgAsmCilTypeRefTable(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmCilTypeRefTable* isSgAsmCilTypeRefTable( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmCilTypeRefTable * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmCilTypeRefTableStorageClass *); // 
          ...
          /// \private
          static SgAsmCilTypeRefTable * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmCilTypeRefTable * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmCilTypeRefTable::operator delete (pointer,sizeof(SgAsmCilTypeRefTable));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmCilTypeRefTable* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmCilTypeRefTable* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmCilTypeRefTable* sgnode);
     ...
     public:
       ...
       */
       // SgAsmCilTypeRefTable( SgAsmCilTypeRefTableStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmCilTypeRefTableStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmCilTypeRefTable( const SgAsmCilTypeRefTableStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmCilTypeRefTable* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmCilTypeRefTable* isSgAsmCilTypeRefTable ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmCilTypeRefTable>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilTypeRefTable, std::vector<SgAsmCilTypeRef*>,&SgAsmCilTypeRefTable::p_elements>;
...
// postdeclarations for SgAsmCilTypeRefTable

/* #line 508 "/workspace/generated/src/frontend/SageIII//SgAsmCilTypeRefTable.h" */
...
/* #line 515 "/workspace/generated/src/frontend/SageIII//SgAsmCilTypeRefTable.h" */

#endif // ROSE_SgAsmCilTypeRefTable_H
