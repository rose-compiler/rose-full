...
#ifndef ROSE_SgAsmElfEHFrameEntryCIList_H
#define ROSE_SgAsmElfEHFrameEntryCIList_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmElfEHFrameEntryCIList

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmElfEHFrameEntryCIList.h" */
/* #line 23117 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// Class Definition for SgAsmElfEHFrameEntryCIList
class ROSE_DLL_API SgAsmElfEHFrameEntryCIList  : public SgAsmExecutableFileFormat
   {
     public:


/* #line 42 "/workspace/generated/src/frontend/SageIII//SgAsmElfEHFrameEntryCIList.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 23136 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmElfEHFrameEntryCIList;
          enum { static_variant = V_SgAsmElfEHFrameEntryCIList };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmElfEHFrameEntryCIList* isSgAsmElfEHFrameEntryCIList(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmElfEHFrameEntryCIList* isSgAsmElfEHFrameEntryCIList( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmElfEHFrameEntryCIList * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmElfEHFrameEntryCIListStorageClass *); // 
          ...
          /// \private
          static SgAsmElfEHFrameEntryCIList * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmElfEHFrameEntryCIList * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmElfEHFrameEntryCIList::operator delete (pointer,sizeof(SgAsmElfEHFrameEntryCIList));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmElfEHFrameEntryCIList* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmElfEHFrameEntryCIList* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmElfEHFrameEntryCIList* sgnode);
     ...
     public:
       ...
       */
       // SgAsmElfEHFrameEntryCIList( SgAsmElfEHFrameEntryCIListStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmElfEHFrameEntryCIListStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmElfEHFrameEntryCIList( const SgAsmElfEHFrameEntryCIListStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmElfEHFrameEntryCIList* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmElfEHFrameEntryCIList* isSgAsmElfEHFrameEntryCIList ( SgNode* s );
...
// End of memberFunctionString
    ...
    protected:
// Start of memberFunctionString
SgAsmElfEHFrameEntryCIPtrList p_entries;
          
// End of memberFunctionString

    friend struct Rose::Traits::generated::describe_node_t<SgAsmElfEHFrameEntryCIList>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmElfEHFrameEntryCIList, SgAsmElfEHFrameEntryCIPtrList,&SgAsmElfEHFrameEntryCIList::p_entries>;
...
// postdeclarations for SgAsmElfEHFrameEntryCIList

/* #line 516 "/workspace/generated/src/frontend/SageIII//SgAsmElfEHFrameEntryCIList.h" */
...
/* #line 523 "/workspace/generated/src/frontend/SageIII//SgAsmElfEHFrameEntryCIList.h" */

#endif // ROSE_SgAsmElfEHFrameEntryCIList_H
