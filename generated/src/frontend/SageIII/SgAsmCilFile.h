...
#ifndef ROSE_SgAsmCilFile_H
#define ROSE_SgAsmCilFile_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmCilFile

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmCilFile.h" */
...
// Class Definition for SgAsmCilFile
class ROSE_DLL_API SgAsmCilFile  : public SgAsmCilMetadata
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmCilFile.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 38194 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmCilFile;
          enum { static_variant = V_SgAsmCilFile };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmCilFile* isSgAsmCilFile(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmCilFile* isSgAsmCilFile( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmCilFile * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmCilFileStorageClass *); // 
          ...
          /// \private
          static SgAsmCilFile * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmCilFile * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmCilFile::operator delete (pointer,sizeof(SgAsmCilFile));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmCilFile* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmCilFile* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmCilFile* sgnode);
     ...
     public:
       ...
       */
       // SgAsmCilFile( SgAsmCilFileStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmCilFileStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmCilFile( const SgAsmCilFileStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmCilFile* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmCilFile* isSgAsmCilFile ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmCilFile>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilFile, uint32_t,&SgAsmCilFile::p_Flags>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilFile, uint32_t,&SgAsmCilFile::p_Name>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilFile, uint32_t,&SgAsmCilFile::p_HashValue>;
...
// postdeclarations for SgAsmCilFile

/* #line 553 "/workspace/generated/src/frontend/SageIII//SgAsmCilFile.h" */
...
/* #line 560 "/workspace/generated/src/frontend/SageIII//SgAsmCilFile.h" */

#endif // ROSE_SgAsmCilFile_H
