...
#ifndef ROSE_SgAsmJvmNestHost_H
#define ROSE_SgAsmJvmNestHost_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmJvmNestHost

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmJvmNestHost.h" */
...
// Class Definition for SgAsmJvmNestHost
class ROSE_DLL_API SgAsmJvmNestHost  : public SgAsmJvmAttribute
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmJvmNestHost.h" */

          virtual SgNode* copy ( SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 10174 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmJvmNestHost;
          enum { static_variant = V_SgAsmJvmNestHost };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmJvmNestHost* isSgAsmJvmNestHost(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmJvmNestHost* isSgAsmJvmNestHost( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmJvmNestHost * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmJvmNestHostStorageClass *); // 
          ...
          /// \private
          static SgAsmJvmNestHost * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmJvmNestHost * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmJvmNestHost::operator delete (pointer,sizeof(SgAsmJvmNestHost));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmJvmNestHost* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmJvmNestHost* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmJvmNestHost* sgnode);
     ...
     public:
       ...
       */
       // SgAsmJvmNestHost( SgAsmJvmNestHostStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmJvmNestHostStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmJvmNestHost( const SgAsmJvmNestHostStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmJvmNestHost* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 670 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmJvmNestHost* isSgAsmJvmNestHost ( SgNode* s );
...
// End of memberFunctionString
    ...
    protected:
// Start of memberFunctionString
uint16_t p_host_class_index;
          
// End of memberFunctionString

    friend struct Rose::Traits::generated::describe_node_t<SgAsmJvmNestHost>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmJvmNestHost, uint16_t,&SgAsmJvmNestHost::p_host_class_index>;
...
// postdeclarations for SgAsmJvmNestHost

/* #line 529 "/workspace/generated/src/frontend/SageIII//SgAsmJvmNestHost.h" */
...
/* #line 536 "/workspace/generated/src/frontend/SageIII//SgAsmJvmNestHost.h" */

#endif // ROSE_SgAsmJvmNestHost_H
