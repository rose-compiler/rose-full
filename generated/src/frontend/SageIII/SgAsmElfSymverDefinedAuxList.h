...
#ifndef ROSE_SgAsmElfSymverDefinedAuxList_H
#define ROSE_SgAsmElfSymverDefinedAuxList_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmElfSymverDefinedAuxList

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmElfSymverDefinedAuxList.h" */
/* #line 19521 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// Class Definition for SgAsmElfSymverDefinedAuxList
class ROSE_DLL_API SgAsmElfSymverDefinedAuxList  : public SgAsmExecutableFileFormat
   {
     public:


/* #line 42 "/workspace/generated/src/frontend/SageIII//SgAsmElfSymverDefinedAuxList.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 19540 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmElfSymverDefinedAuxList;
          enum { static_variant = V_SgAsmElfSymverDefinedAuxList };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmElfSymverDefinedAuxList* isSgAsmElfSymverDefinedAuxList(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmElfSymverDefinedAuxList* isSgAsmElfSymverDefinedAuxList( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmElfSymverDefinedAuxList * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmElfSymverDefinedAuxListStorageClass *); // 
          ...
          /// \private
          static SgAsmElfSymverDefinedAuxList * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmElfSymverDefinedAuxList * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmElfSymverDefinedAuxList::operator delete (pointer,sizeof(SgAsmElfSymverDefinedAuxList));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmElfSymverDefinedAuxList* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmElfSymverDefinedAuxList* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmElfSymverDefinedAuxList* sgnode);
     ...
     public:
       ...
       */
       // SgAsmElfSymverDefinedAuxList( SgAsmElfSymverDefinedAuxListStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmElfSymverDefinedAuxListStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmElfSymverDefinedAuxList( const SgAsmElfSymverDefinedAuxListStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmElfSymverDefinedAuxList* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmElfSymverDefinedAuxList* isSgAsmElfSymverDefinedAuxList ( SgNode* s );
...
// End of memberFunctionString
    ...
    protected:
// Start of memberFunctionString
SgAsmElfSymverDefinedAuxPtrList p_entries;
          
// End of memberFunctionString

    friend struct Rose::Traits::generated::describe_node_t<SgAsmElfSymverDefinedAuxList>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmElfSymverDefinedAuxList, SgAsmElfSymverDefinedAuxPtrList,&SgAsmElfSymverDefinedAuxList::p_entries>;
...
// postdeclarations for SgAsmElfSymverDefinedAuxList

/* #line 516 "/workspace/generated/src/frontend/SageIII//SgAsmElfSymverDefinedAuxList.h" */
...
/* #line 523 "/workspace/generated/src/frontend/SageIII//SgAsmElfSymverDefinedAuxList.h" */

#endif // ROSE_SgAsmElfSymverDefinedAuxList_H
