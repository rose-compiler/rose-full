...
#ifndef ROSE_SgAsmCilGenericParamConstraintTable_H
#define ROSE_SgAsmCilGenericParamConstraintTable_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmCilGenericParamConstraintTable

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmCilGenericParamConstraintTable.h" */
...
// Class Definition for SgAsmCilGenericParamConstraintTable
class ROSE_DLL_API SgAsmCilGenericParamConstraintTable  : public SgAsmCilMetadata
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmCilGenericParamConstraintTable.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 37956 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmCilGenericParamConstraintTable;
          enum { static_variant = V_SgAsmCilGenericParamConstraintTable };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmCilGenericParamConstraintTable* isSgAsmCilGenericParamConstraintTable(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmCilGenericParamConstraintTable* isSgAsmCilGenericParamConstraintTable( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmCilGenericParamConstraintTable * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmCilGenericParamConstraintTableStorageClass *); // 
          ...
          /// \private
          static SgAsmCilGenericParamConstraintTable * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmCilGenericParamConstraintTable * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmCilGenericParamConstraintTable::operator delete (pointer,sizeof(SgAsmCilGenericParamConstraintTable));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmCilGenericParamConstraintTable* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmCilGenericParamConstraintTable* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmCilGenericParamConstraintTable* sgnode);
     ...
     public:
       ...
       */
       // SgAsmCilGenericParamConstraintTable( SgAsmCilGenericParamConstraintTableStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmCilGenericParamConstraintTableStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmCilGenericParamConstraintTable( const SgAsmCilGenericParamConstraintTableStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmCilGenericParamConstraintTable* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmCilGenericParamConstraintTable* isSgAsmCilGenericParamConstraintTable ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmCilGenericParamConstraintTable>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilGenericParamConstraintTable, std::vector<SgAsmCilGenericParamConstraint*>,&SgAsmCilGenericParamConstraintTable::p_elements>;
...
// postdeclarations for SgAsmCilGenericParamConstraintTable

/* #line 508 "/workspace/generated/src/frontend/SageIII//SgAsmCilGenericParamConstraintTable.h" */
...
/* #line 515 "/workspace/generated/src/frontend/SageIII//SgAsmCilGenericParamConstraintTable.h" */

#endif // ROSE_SgAsmCilGenericParamConstraintTable_H
