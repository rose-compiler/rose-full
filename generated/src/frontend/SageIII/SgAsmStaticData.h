...
#ifndef ROSE_SgAsmStaticData_H
#define ROSE_SgAsmStaticData_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmStaticData

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmStaticData.h" */
/* #line 1427 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// Class Definition for SgAsmStaticData
class ROSE_DLL_API SgAsmStaticData  : public SgAsmStatement
   {
     public:


/* #line 42 "/workspace/generated/src/frontend/SageIII//SgAsmStaticData.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 1449 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmStaticData;
          enum { static_variant = V_SgAsmStaticData };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmStaticData* isSgAsmStaticData(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmStaticData* isSgAsmStaticData( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmStaticData * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmStaticDataStorageClass *); // 
          ...
          /// \private
          static SgAsmStaticData * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmStaticData * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmStaticData::operator delete (pointer,sizeof(SgAsmStaticData));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmStaticData* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmStaticData* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmStaticData* sgnode);
     ...
     public:
       ...
       */
       // SgAsmStaticData( SgAsmStaticDataStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmStaticDataStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmStaticData( const SgAsmStaticDataStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmStaticData* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmStaticData* isSgAsmStaticData ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmStaticData>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmStaticData, SgUnsignedCharList,&SgAsmStaticData::p_rawBytes>;
...
// postdeclarations for SgAsmStaticData

/* #line 533 "/workspace/generated/src/frontend/SageIII//SgAsmStaticData.h" */
...
/* #line 540 "/workspace/generated/src/frontend/SageIII//SgAsmStaticData.h" */

#endif // ROSE_SgAsmStaticData_H
