...
#ifndef ROSE_SgAsmGenericFileList_H
#define ROSE_SgAsmGenericFileList_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmGenericFileList

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmGenericFileList.h" */
/* #line 16087 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// Class Definition for SgAsmGenericFileList
class ROSE_DLL_API SgAsmGenericFileList  : public SgAsmNode
   {
     public:


/* #line 42 "/workspace/generated/src/frontend/SageIII//SgAsmGenericFileList.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 16106 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmGenericFileList;
          enum { static_variant = V_SgAsmGenericFileList };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmGenericFileList* isSgAsmGenericFileList(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmGenericFileList* isSgAsmGenericFileList( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmGenericFileList * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmGenericFileListStorageClass *); // 
          ...
          /// \private
          static SgAsmGenericFileList * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmGenericFileList * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmGenericFileList::operator delete (pointer,sizeof(SgAsmGenericFileList));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmGenericFileList* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmGenericFileList* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmGenericFileList* sgnode);
     ...
     public:
       ...
       */
       // SgAsmGenericFileList( SgAsmGenericFileListStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmGenericFileListStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmGenericFileList( const SgAsmGenericFileListStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmGenericFileList* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmGenericFileList* isSgAsmGenericFileList ( SgNode* s );
...
// End of memberFunctionString
    ...
    protected:
// Start of memberFunctionString
SgAsmGenericFilePtrList p_files;
          
// End of memberFunctionString

    friend struct Rose::Traits::generated::describe_node_t<SgAsmGenericFileList>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmGenericFileList, SgAsmGenericFilePtrList,&SgAsmGenericFileList::p_files>;
...
// postdeclarations for SgAsmGenericFileList

/* #line 516 "/workspace/generated/src/frontend/SageIII//SgAsmGenericFileList.h" */
...
/* #line 523 "/workspace/generated/src/frontend/SageIII//SgAsmGenericFileList.h" */

#endif // ROSE_SgAsmGenericFileList_H
