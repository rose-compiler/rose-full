...
#ifndef ROSE_SgAsmDwarfReferenceType_H
#define ROSE_SgAsmDwarfReferenceType_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmDwarfReferenceType

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfReferenceType.h" */
...
// Class Definition for SgAsmDwarfReferenceType
class ROSE_DLL_API SgAsmDwarfReferenceType  : public SgAsmDwarfConstruct
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfReferenceType.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 25805 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmDwarfReferenceType;
          enum { static_variant = V_SgAsmDwarfReferenceType };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmDwarfReferenceType* isSgAsmDwarfReferenceType(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmDwarfReferenceType* isSgAsmDwarfReferenceType( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmDwarfReferenceType * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmDwarfReferenceTypeStorageClass *); // 
          ...
          /// \private
          static SgAsmDwarfReferenceType * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmDwarfReferenceType * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmDwarfReferenceType::operator delete (pointer,sizeof(SgAsmDwarfReferenceType));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmDwarfReferenceType* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmDwarfReferenceType* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmDwarfReferenceType* sgnode);
     ...
     public:
       ...
       */
       // SgAsmDwarfReferenceType( SgAsmDwarfReferenceTypeStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmDwarfReferenceTypeStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmDwarfReferenceType( const SgAsmDwarfReferenceTypeStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmDwarfReferenceType* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmDwarfReferenceType* isSgAsmDwarfReferenceType ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmDwarfReferenceType>;
...
// postdeclarations for SgAsmDwarfReferenceType

/* #line 502 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfReferenceType.h" */
...
/* #line 509 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfReferenceType.h" */

#endif // ROSE_SgAsmDwarfReferenceType_H
