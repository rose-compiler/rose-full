...
#ifndef ROSE_SgAsmElfEHFrameSection_H
#define ROSE_SgAsmElfEHFrameSection_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmElfEHFrameSection

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmElfEHFrameSection.h" */
/* #line 22784 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// Class Definition for SgAsmElfEHFrameSection
class ROSE_DLL_API SgAsmElfEHFrameSection  : public SgAsmElfSection
   {
     public:


/* #line 46 "/workspace/generated/src/frontend/SageIII//SgAsmElfEHFrameSection.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 22804 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmElfEHFrameSection;
          enum { static_variant = V_SgAsmElfEHFrameSection };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmElfEHFrameSection* isSgAsmElfEHFrameSection(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmElfEHFrameSection* isSgAsmElfEHFrameSection( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmElfEHFrameSection * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmElfEHFrameSectionStorageClass *); // 
          ...
          /// \private
          static SgAsmElfEHFrameSection * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmElfEHFrameSection * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmElfEHFrameSection::operator delete (pointer,sizeof(SgAsmElfEHFrameSection));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmElfEHFrameSection* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmElfEHFrameSection* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmElfEHFrameSection* sgnode);
     ...
     public:
       ...
       */
       // SgAsmElfEHFrameSection( SgAsmElfEHFrameSectionStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmElfEHFrameSectionStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmElfEHFrameSection( const SgAsmElfEHFrameSectionStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmElfEHFrameSection* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmElfEHFrameSection* isSgAsmElfEHFrameSection ( SgNode* s );
...
// End of memberFunctionString
    ...
    protected:
// Start of memberFunctionString
SgAsmElfEHFrameEntryCIList* p_ci_entries;
          
// End of memberFunctionString

    friend struct Rose::Traits::generated::describe_node_t<SgAsmElfEHFrameSection>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmElfEHFrameSection, SgAsmElfEHFrameEntryCIList*,&SgAsmElfEHFrameSection::p_ci_entries>;
...
// postdeclarations for SgAsmElfEHFrameSection

/* #line 553 "/workspace/generated/src/frontend/SageIII//SgAsmElfEHFrameSection.h" */
...
/* #line 560 "/workspace/generated/src/frontend/SageIII//SgAsmElfEHFrameSection.h" */

#endif // ROSE_SgAsmElfEHFrameSection_H
