...
#ifndef ROSE_SgAsmCilMemberRefTable_H
#define ROSE_SgAsmCilMemberRefTable_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmCilMemberRefTable

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmCilMemberRefTable.h" */
...
// Class Definition for SgAsmCilMemberRefTable
class ROSE_DLL_API SgAsmCilMemberRefTable  : public SgAsmCilMetadata
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmCilMemberRefTable.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 36951 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmCilMemberRefTable;
          enum { static_variant = V_SgAsmCilMemberRefTable };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmCilMemberRefTable* isSgAsmCilMemberRefTable(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmCilMemberRefTable* isSgAsmCilMemberRefTable( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmCilMemberRefTable * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmCilMemberRefTableStorageClass *); // 
          ...
          /// \private
          static SgAsmCilMemberRefTable * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmCilMemberRefTable * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmCilMemberRefTable::operator delete (pointer,sizeof(SgAsmCilMemberRefTable));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmCilMemberRefTable* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmCilMemberRefTable* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmCilMemberRefTable* sgnode);
     ...
     public:
       ...
       */
       // SgAsmCilMemberRefTable( SgAsmCilMemberRefTableStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmCilMemberRefTableStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmCilMemberRefTable( const SgAsmCilMemberRefTableStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmCilMemberRefTable* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmCilMemberRefTable* isSgAsmCilMemberRefTable ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmCilMemberRefTable>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilMemberRefTable, std::vector<SgAsmCilMemberRef*>,&SgAsmCilMemberRefTable::p_elements>;
...
// postdeclarations for SgAsmCilMemberRefTable

/* #line 508 "/workspace/generated/src/frontend/SageIII//SgAsmCilMemberRefTable.h" */
...
/* #line 515 "/workspace/generated/src/frontend/SageIII//SgAsmCilMemberRefTable.h" */

#endif // ROSE_SgAsmCilMemberRefTable_H
