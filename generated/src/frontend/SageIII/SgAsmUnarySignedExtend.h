...
#ifndef ROSE_SgAsmUnarySignedExtend_H
#define ROSE_SgAsmUnarySignedExtend_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmUnarySignedExtend

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmUnarySignedExtend.h" */
...
// Class Definition for SgAsmUnarySignedExtend
class ROSE_DLL_API SgAsmUnarySignedExtend  : public SgAsmUnaryExpression
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmUnarySignedExtend.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 703 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmUnarySignedExtend;
          enum { static_variant = V_SgAsmUnarySignedExtend };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmUnarySignedExtend* isSgAsmUnarySignedExtend(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmUnarySignedExtend* isSgAsmUnarySignedExtend( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmUnarySignedExtend * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmUnarySignedExtendStorageClass *); // 
          ...
          /// \private
          static SgAsmUnarySignedExtend * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmUnarySignedExtend * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmUnarySignedExtend::operator delete (pointer,sizeof(SgAsmUnarySignedExtend));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmUnarySignedExtend* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmUnarySignedExtend* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmUnarySignedExtend* sgnode);
     ...
     public:
       ...
       */
       // SgAsmUnarySignedExtend( SgAsmUnarySignedExtendStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmUnarySignedExtendStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmUnarySignedExtend( const SgAsmUnarySignedExtendStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmUnarySignedExtend* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmUnarySignedExtend* isSgAsmUnarySignedExtend ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmUnarySignedExtend>;
...
// postdeclarations for SgAsmUnarySignedExtend

/* #line 500 "/workspace/generated/src/frontend/SageIII//SgAsmUnarySignedExtend.h" */
...
/* #line 507 "/workspace/generated/src/frontend/SageIII//SgAsmUnarySignedExtend.h" */

#endif // ROSE_SgAsmUnarySignedExtend_H
