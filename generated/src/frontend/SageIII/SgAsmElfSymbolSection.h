...
#ifndef ROSE_SgAsmElfSymbolSection_H
#define ROSE_SgAsmElfSymbolSection_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmElfSymbolSection

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmElfSymbolSection.h" */
/* #line 19722 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// Class Definition for SgAsmElfSymbolSection
class ROSE_DLL_API SgAsmElfSymbolSection  : public SgAsmElfSection
   {
     public:


/* #line 46 "/workspace/generated/src/frontend/SageIII//SgAsmElfSymbolSection.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 19748 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmElfSymbolSection;
          enum { static_variant = V_SgAsmElfSymbolSection };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmElfSymbolSection* isSgAsmElfSymbolSection(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmElfSymbolSection* isSgAsmElfSymbolSection( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmElfSymbolSection * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmElfSymbolSectionStorageClass *); // 
          ...
          /// \private
          static SgAsmElfSymbolSection * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmElfSymbolSection * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmElfSymbolSection::operator delete (pointer,sizeof(SgAsmElfSymbolSection));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmElfSymbolSection* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmElfSymbolSection* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmElfSymbolSection* sgnode);
     ...
     public:
       ...
       */
       // SgAsmElfSymbolSection( SgAsmElfSymbolSectionStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmElfSymbolSectionStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmElfSymbolSection( const SgAsmElfSymbolSectionStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmElfSymbolSection* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmElfSymbolSection* isSgAsmElfSymbolSection ( SgNode* s );
...
// End of memberFunctionString
// Start of memberFunctionString
SgAsmElfSymbolList* p_symbols;
          
// End of memberFunctionString

    friend struct Rose::Traits::generated::describe_node_t<SgAsmElfSymbolSection>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmElfSymbolSection, bool,&SgAsmElfSymbolSection::p_isDynamic>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmElfSymbolSection, SgAsmElfSymbolList*,&SgAsmElfSymbolSection::p_symbols>;
...
// postdeclarations for SgAsmElfSymbolSection

/* #line 589 "/workspace/generated/src/frontend/SageIII//SgAsmElfSymbolSection.h" */
...
/* #line 596 "/workspace/generated/src/frontend/SageIII//SgAsmElfSymbolSection.h" */

#endif // ROSE_SgAsmElfSymbolSection_H
