...
#ifndef ROSE_SgAsmGenericSymbolList_H
#define ROSE_SgAsmGenericSymbolList_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmGenericSymbolList

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmGenericSymbolList.h" */
/* #line 15658 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// Class Definition for SgAsmGenericSymbolList
class ROSE_DLL_API SgAsmGenericSymbolList  : public SgAsmExecutableFileFormat
   {
     public:


/* #line 42 "/workspace/generated/src/frontend/SageIII//SgAsmGenericSymbolList.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 15677 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmGenericSymbolList;
          enum { static_variant = V_SgAsmGenericSymbolList };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmGenericSymbolList* isSgAsmGenericSymbolList(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmGenericSymbolList* isSgAsmGenericSymbolList( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmGenericSymbolList * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmGenericSymbolListStorageClass *); // 
          ...
          /// \private
          static SgAsmGenericSymbolList * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmGenericSymbolList * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmGenericSymbolList::operator delete (pointer,sizeof(SgAsmGenericSymbolList));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmGenericSymbolList* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmGenericSymbolList* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmGenericSymbolList* sgnode);
     ...
     public:
       ...
       */
       // SgAsmGenericSymbolList( SgAsmGenericSymbolListStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmGenericSymbolListStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmGenericSymbolList( const SgAsmGenericSymbolListStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmGenericSymbolList* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmGenericSymbolList* isSgAsmGenericSymbolList ( SgNode* s );
...
// End of memberFunctionString
    ...
    protected:
// Start of memberFunctionString
SgAsmGenericSymbolPtrList p_symbols;
          
// End of memberFunctionString

    friend struct Rose::Traits::generated::describe_node_t<SgAsmGenericSymbolList>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmGenericSymbolList, SgAsmGenericSymbolPtrList,&SgAsmGenericSymbolList::p_symbols>;
...
// postdeclarations for SgAsmGenericSymbolList

/* #line 516 "/workspace/generated/src/frontend/SageIII//SgAsmGenericSymbolList.h" */
...
/* #line 523 "/workspace/generated/src/frontend/SageIII//SgAsmGenericSymbolList.h" */

#endif // ROSE_SgAsmGenericSymbolList_H
