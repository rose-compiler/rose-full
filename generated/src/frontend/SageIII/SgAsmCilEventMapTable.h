...
#ifndef ROSE_SgAsmCilEventMapTable_H
#define ROSE_SgAsmCilEventMapTable_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmCilEventMapTable

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmCilEventMapTable.h" */
...
// Class Definition for SgAsmCilEventMapTable
class ROSE_DLL_API SgAsmCilEventMapTable  : public SgAsmCilMetadata
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmCilEventMapTable.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 39409 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmCilEventMapTable;
          enum { static_variant = V_SgAsmCilEventMapTable };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmCilEventMapTable* isSgAsmCilEventMapTable(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmCilEventMapTable* isSgAsmCilEventMapTable( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmCilEventMapTable * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmCilEventMapTableStorageClass *); // 
          ...
          /// \private
          static SgAsmCilEventMapTable * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmCilEventMapTable * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmCilEventMapTable::operator delete (pointer,sizeof(SgAsmCilEventMapTable));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmCilEventMapTable* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmCilEventMapTable* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmCilEventMapTable* sgnode);
     ...
     public:
       ...
       */
       // SgAsmCilEventMapTable( SgAsmCilEventMapTableStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmCilEventMapTableStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmCilEventMapTable( const SgAsmCilEventMapTableStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmCilEventMapTable* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmCilEventMapTable* isSgAsmCilEventMapTable ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmCilEventMapTable>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilEventMapTable, std::vector<SgAsmCilEventMap*>,&SgAsmCilEventMapTable::p_elements>;
...
// postdeclarations for SgAsmCilEventMapTable

/* #line 508 "/workspace/generated/src/frontend/SageIII//SgAsmCilEventMapTable.h" */
...
/* #line 515 "/workspace/generated/src/frontend/SageIII//SgAsmCilEventMapTable.h" */

#endif // ROSE_SgAsmCilEventMapTable_H
