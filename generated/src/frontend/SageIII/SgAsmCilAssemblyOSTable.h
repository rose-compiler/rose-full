...
#ifndef ROSE_SgAsmCilAssemblyOSTable_H
#define ROSE_SgAsmCilAssemblyOSTable_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmCilAssemblyOSTable

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmCilAssemblyOSTable.h" */
...
// Class Definition for SgAsmCilAssemblyOSTable
class ROSE_DLL_API SgAsmCilAssemblyOSTable  : public SgAsmCilMetadata
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmCilAssemblyOSTable.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 41471 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmCilAssemblyOSTable;
          enum { static_variant = V_SgAsmCilAssemblyOSTable };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmCilAssemblyOSTable* isSgAsmCilAssemblyOSTable(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmCilAssemblyOSTable* isSgAsmCilAssemblyOSTable( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmCilAssemblyOSTable * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmCilAssemblyOSTableStorageClass *); // 
          ...
          /// \private
          static SgAsmCilAssemblyOSTable * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmCilAssemblyOSTable * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmCilAssemblyOSTable::operator delete (pointer,sizeof(SgAsmCilAssemblyOSTable));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmCilAssemblyOSTable* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmCilAssemblyOSTable* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmCilAssemblyOSTable* sgnode);
     ...
     public:
       ...
       */
       // SgAsmCilAssemblyOSTable( SgAsmCilAssemblyOSTableStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmCilAssemblyOSTableStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmCilAssemblyOSTable( const SgAsmCilAssemblyOSTableStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmCilAssemblyOSTable* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmCilAssemblyOSTable* isSgAsmCilAssemblyOSTable ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmCilAssemblyOSTable>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilAssemblyOSTable, std::vector<SgAsmCilAssemblyOS*>,&SgAsmCilAssemblyOSTable::p_elements>;
...
// postdeclarations for SgAsmCilAssemblyOSTable

/* #line 508 "/workspace/generated/src/frontend/SageIII//SgAsmCilAssemblyOSTable.h" */
...
/* #line 515 "/workspace/generated/src/frontend/SageIII//SgAsmCilAssemblyOSTable.h" */

#endif // ROSE_SgAsmCilAssemblyOSTable_H
