...
#ifndef ROSE_SgAsmIndirectRegisterExpression_H
#define ROSE_SgAsmIndirectRegisterExpression_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmIndirectRegisterExpression

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmIndirectRegisterExpression.h" */
...
// Class Definition for SgAsmIndirectRegisterExpression
class ROSE_DLL_API SgAsmIndirectRegisterExpression  : public SgAsmRegisterReferenceExpression
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmIndirectRegisterExpression.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 15557 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmIndirectRegisterExpression* isSgAsmIndirectRegisterExpression(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmIndirectRegisterExpression* isSgAsmIndirectRegisterExpression( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmIndirectRegisterExpression * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmIndirectRegisterExpressionStorageClass *); // 
          ...
          /// \private
          static SgAsmIndirectRegisterExpression * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmIndirectRegisterExpression * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmIndirectRegisterExpression::operator delete (pointer,sizeof(SgAsmIndirectRegisterExpression));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmIndirectRegisterExpression* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmIndirectRegisterExpression* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmIndirectRegisterExpression* sgnode);
     ...
     public:
       ...
       */
       // SgAsmIndirectRegisterExpression( SgAsmIndirectRegisterExpressionStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmIndirectRegisterExpressionStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmIndirectRegisterExpression( const SgAsmIndirectRegisterExpressionStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmIndirectRegisterExpression* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmIndirectRegisterExpression* isSgAsmIndirectRegisterExpression ( SgNode* s );

          typedef SgAsmRegisterReferenceExpression base_node_type;
...
// End of memberFunctionString
    ...
    protected:
// Start of memberFunctionString
Rose::BinaryAnalysis::RegisterDescriptor p_stride;
          
// End of memberFunctionString
// Start of memberFunctionString
Rose::BinaryAnalysis::RegisterDescriptor p_offset;
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmIndirectRegisterExpression>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmIndirectRegisterExpression, Rose::BinaryAnalysis::RegisterDescriptor,&SgAsmIndirectRegisterExpression::p_stride>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmIndirectRegisterExpression, Rose::BinaryAnalysis::RegisterDescriptor,&SgAsmIndirectRegisterExpression::p_offset>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmIndirectRegisterExpression, size_t,&SgAsmIndirectRegisterExpression::p_index>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmIndirectRegisterExpression, size_t,&SgAsmIndirectRegisterExpression::p_modulus>;
...
// postdeclarations for SgAsmIndirectRegisterExpression

/* #line 572 "/workspace/generated/src/frontend/SageIII//SgAsmIndirectRegisterExpression.h" */
...
/* #line 579 "/workspace/generated/src/frontend/SageIII//SgAsmIndirectRegisterExpression.h" */

#endif // ROSE_SgAsmIndirectRegisterExpression_H
