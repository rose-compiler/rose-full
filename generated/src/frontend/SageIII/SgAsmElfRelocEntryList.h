...
#ifndef ROSE_SgAsmElfRelocEntryList_H
#define ROSE_SgAsmElfRelocEntryList_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmElfRelocEntryList

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmElfRelocEntryList.h" */
/* #line 21594 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// Class Definition for SgAsmElfRelocEntryList
class ROSE_DLL_API SgAsmElfRelocEntryList  : public SgAsmExecutableFileFormat
   {
     public:


/* #line 42 "/workspace/generated/src/frontend/SageIII//SgAsmElfRelocEntryList.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 21613 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmElfRelocEntryList;
          enum { static_variant = V_SgAsmElfRelocEntryList };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmElfRelocEntryList* isSgAsmElfRelocEntryList(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmElfRelocEntryList* isSgAsmElfRelocEntryList( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmElfRelocEntryList * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmElfRelocEntryListStorageClass *); // 
          ...
          /// \private
          static SgAsmElfRelocEntryList * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmElfRelocEntryList * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmElfRelocEntryList::operator delete (pointer,sizeof(SgAsmElfRelocEntryList));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmElfRelocEntryList* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmElfRelocEntryList* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmElfRelocEntryList* sgnode);
     ...
     public:
       ...
       */
       // SgAsmElfRelocEntryList( SgAsmElfRelocEntryListStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmElfRelocEntryListStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmElfRelocEntryList( const SgAsmElfRelocEntryListStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmElfRelocEntryList* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmElfRelocEntryList* isSgAsmElfRelocEntryList ( SgNode* s );
...
// End of memberFunctionString
    ...
    protected:
// Start of memberFunctionString
SgAsmElfRelocEntryPtrList p_entries;
          
// End of memberFunctionString

    friend struct Rose::Traits::generated::describe_node_t<SgAsmElfRelocEntryList>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmElfRelocEntryList, SgAsmElfRelocEntryPtrList,&SgAsmElfRelocEntryList::p_entries>;
...
// postdeclarations for SgAsmElfRelocEntryList

/* #line 516 "/workspace/generated/src/frontend/SageIII//SgAsmElfRelocEntryList.h" */
...
/* #line 523 "/workspace/generated/src/frontend/SageIII//SgAsmElfRelocEntryList.h" */

#endif // ROSE_SgAsmElfRelocEntryList_H
