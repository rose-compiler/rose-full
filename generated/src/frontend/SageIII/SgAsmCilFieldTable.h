...
#ifndef ROSE_SgAsmCilFieldTable_H
#define ROSE_SgAsmCilFieldTable_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmCilFieldTable

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmCilFieldTable.h" */
...
// Class Definition for SgAsmCilFieldTable
class ROSE_DLL_API SgAsmCilFieldTable  : public SgAsmCilMetadata
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmCilFieldTable.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 38293 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmCilFieldTable;
          enum { static_variant = V_SgAsmCilFieldTable };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmCilFieldTable* isSgAsmCilFieldTable(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmCilFieldTable* isSgAsmCilFieldTable( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmCilFieldTable * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmCilFieldTableStorageClass *); // 
          ...
          /// \private
          static SgAsmCilFieldTable * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmCilFieldTable * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmCilFieldTable::operator delete (pointer,sizeof(SgAsmCilFieldTable));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmCilFieldTable* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmCilFieldTable* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmCilFieldTable* sgnode);
     ...
     public:
       ...
       */
       // SgAsmCilFieldTable( SgAsmCilFieldTableStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmCilFieldTableStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmCilFieldTable( const SgAsmCilFieldTableStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmCilFieldTable* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmCilFieldTable* isSgAsmCilFieldTable ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmCilFieldTable>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilFieldTable, std::vector<SgAsmCilField*>,&SgAsmCilFieldTable::p_elements>;
...
// postdeclarations for SgAsmCilFieldTable

/* #line 508 "/workspace/generated/src/frontend/SageIII//SgAsmCilFieldTable.h" */
...
/* #line 515 "/workspace/generated/src/frontend/SageIII//SgAsmCilFieldTable.h" */

#endif // ROSE_SgAsmCilFieldTable_H
