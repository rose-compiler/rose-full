...
#ifndef ROSE_SgAsmBinaryRor_H
#define ROSE_SgAsmBinaryRor_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmBinaryRor

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmBinaryRor.h" */
...
// Class Definition for SgAsmBinaryRor
class ROSE_DLL_API SgAsmBinaryRor  : public SgAsmBinaryExpression
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmBinaryRor.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 42603 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmBinaryRor* isSgAsmBinaryRor(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmBinaryRor* isSgAsmBinaryRor( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmBinaryRor * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmBinaryRorStorageClass *); // 
          ...
          /// \private
          static SgAsmBinaryRor * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmBinaryRor * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmBinaryRor::operator delete (pointer,sizeof(SgAsmBinaryRor));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmBinaryRor* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmBinaryRor* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmBinaryRor* sgnode);
     ...
     public:
       ...
       */
       // SgAsmBinaryRor( SgAsmBinaryRorStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmBinaryRorStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmBinaryRor( const SgAsmBinaryRorStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmBinaryRor* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmBinaryRor* isSgAsmBinaryRor ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmBinaryRor>;
...
// postdeclarations for SgAsmBinaryRor

/* #line 501 "/workspace/generated/src/frontend/SageIII//SgAsmBinaryRor.h" */
...
/* #line 508 "/workspace/generated/src/frontend/SageIII//SgAsmBinaryRor.h" */

#endif // ROSE_SgAsmBinaryRor_H
