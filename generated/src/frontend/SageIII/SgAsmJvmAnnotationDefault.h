...
#ifndef ROSE_SgAsmJvmAnnotationDefault_H
#define ROSE_SgAsmJvmAnnotationDefault_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmJvmAnnotationDefault

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmJvmAnnotationDefault.h" */
...
// Class Definition for SgAsmJvmAnnotationDefault
class ROSE_DLL_API SgAsmJvmAnnotationDefault  : public SgAsmJvmAttribute
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmJvmAnnotationDefault.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 14601 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmJvmAnnotationDefault;
          enum { static_variant = V_SgAsmJvmAnnotationDefault };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmJvmAnnotationDefault* isSgAsmJvmAnnotationDefault(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmJvmAnnotationDefault* isSgAsmJvmAnnotationDefault( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmJvmAnnotationDefault * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmJvmAnnotationDefaultStorageClass *); // 
          ...
          /// \private
          static SgAsmJvmAnnotationDefault * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmJvmAnnotationDefault * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmJvmAnnotationDefault::operator delete (pointer,sizeof(SgAsmJvmAnnotationDefault));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmJvmAnnotationDefault* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmJvmAnnotationDefault* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmJvmAnnotationDefault* sgnode);
     ...
     public:
       ...
       */
       // SgAsmJvmAnnotationDefault( SgAsmJvmAnnotationDefaultStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmJvmAnnotationDefaultStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmJvmAnnotationDefault( const SgAsmJvmAnnotationDefaultStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmJvmAnnotationDefault* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmJvmAnnotationDefault* isSgAsmJvmAnnotationDefault ( SgNode* s );
...
// End of memberFunctionString
    ...
    protected:
// Start of memberFunctionString
SgAsmJvmRuntimeAnnotationValue* p_default_value;
          
// End of memberFunctionString

    friend struct Rose::Traits::generated::describe_node_t<SgAsmJvmAnnotationDefault>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmJvmAnnotationDefault, SgAsmJvmRuntimeAnnotationValue*,&SgAsmJvmAnnotationDefault::p_default_value>;
...
// postdeclarations for SgAsmJvmAnnotationDefault

/* #line 528 "/workspace/generated/src/frontend/SageIII//SgAsmJvmAnnotationDefault.h" */
...
/* #line 535 "/workspace/generated/src/frontend/SageIII//SgAsmJvmAnnotationDefault.h" */

#endif // ROSE_SgAsmJvmAnnotationDefault_H
