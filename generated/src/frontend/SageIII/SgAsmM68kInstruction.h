...
#ifndef ROSE_SgAsmM68kInstruction_H
#define ROSE_SgAsmM68kInstruction_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmM68kInstruction

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmM68kInstruction.h" */
/* #line 7512 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// Class Definition for SgAsmM68kInstruction
class ROSE_DLL_API SgAsmM68kInstruction  : public SgAsmInstruction
   {
     public:


/* #line 42 "/workspace/generated/src/frontend/SageIII//SgAsmM68kInstruction.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 7533 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmM68kInstruction;
          enum { static_variant = V_SgAsmM68kInstruction };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmM68kInstruction* isSgAsmM68kInstruction(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmM68kInstruction* isSgAsmM68kInstruction( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmM68kInstruction * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmM68kInstructionStorageClass *); // 
          ...
          /// \private
          static SgAsmM68kInstruction * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmM68kInstruction * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmM68kInstruction::operator delete (pointer,sizeof(SgAsmM68kInstruction));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmM68kInstruction* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmM68kInstruction* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmM68kInstruction* sgnode);
     ...
     public:
       ...
       */
       // SgAsmM68kInstruction( SgAsmM68kInstructionStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmM68kInstructionStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmM68kInstruction( const SgAsmM68kInstructionStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmM68kInstruction* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmM68kInstruction* isSgAsmM68kInstruction ( SgNode* s );
...
// End of memberFunctionString
    ...
    protected:
// Start of memberFunctionString
Rose::BinaryAnalysis::M68kInstructionKind p_kind;
          
// End of memberFunctionString
// Start of memberFunctionString
Rose::BinaryAnalysis::M68kDataFormat p_dataFormat;
          
// End of memberFunctionString

    friend struct Rose::Traits::generated::describe_node_t<SgAsmM68kInstruction>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmM68kInstruction, Rose::BinaryAnalysis::M68kInstructionKind,&SgAsmM68kInstruction::p_kind>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmM68kInstruction, Rose::BinaryAnalysis::M68kDataFormat,&SgAsmM68kInstruction::p_dataFormat>;
...
// postdeclarations for SgAsmM68kInstruction

/* #line 542 "/workspace/generated/src/frontend/SageIII//SgAsmM68kInstruction.h" */
...
/* #line 549 "/workspace/generated/src/frontend/SageIII//SgAsmM68kInstruction.h" */

#endif // ROSE_SgAsmM68kInstruction_H
