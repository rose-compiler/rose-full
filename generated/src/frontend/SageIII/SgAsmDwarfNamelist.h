...
#ifndef ROSE_SgAsmDwarfNamelist_H
#define ROSE_SgAsmDwarfNamelist_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmDwarfNamelist

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfNamelist.h" */
...
// Class Definition for SgAsmDwarfNamelist
class ROSE_DLL_API SgAsmDwarfNamelist  : public SgAsmDwarfConstruct
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfNamelist.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 26237 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmDwarfNamelist;
          enum { static_variant = V_SgAsmDwarfNamelist };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmDwarfNamelist* isSgAsmDwarfNamelist(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmDwarfNamelist* isSgAsmDwarfNamelist( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmDwarfNamelist * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmDwarfNamelistStorageClass *); // 
          ...
          /// \private
          static SgAsmDwarfNamelist * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmDwarfNamelist * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmDwarfNamelist::operator delete (pointer,sizeof(SgAsmDwarfNamelist));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmDwarfNamelist* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmDwarfNamelist* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmDwarfNamelist* sgnode);
     ...
     public:
       ...
       */
       // SgAsmDwarfNamelist( SgAsmDwarfNamelistStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmDwarfNamelistStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmDwarfNamelist( const SgAsmDwarfNamelistStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmDwarfNamelist* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmDwarfNamelist* isSgAsmDwarfNamelist ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmDwarfNamelist>;
...
// postdeclarations for SgAsmDwarfNamelist

/* #line 502 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfNamelist.h" */
...
/* #line 509 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfNamelist.h" */

#endif // ROSE_SgAsmDwarfNamelist_H
