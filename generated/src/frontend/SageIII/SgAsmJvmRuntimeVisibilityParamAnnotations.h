...
#ifndef ROSE_SgAsmJvmRuntimeVisibilityParamAnnotations_H
#define ROSE_SgAsmJvmRuntimeVisibilityParamAnnotations_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmJvmRuntimeVisibilityParamAnnotations

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmJvmRuntimeVisibilityParamAnnotations.h" */
/* #line 9921 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// Class Definition for SgAsmJvmRuntimeVisibilityParamAnnotations
class ROSE_DLL_API SgAsmJvmRuntimeVisibilityParamAnnotations  : public SgAsmJvmAttribute
   {
     public:


/* #line 42 "/workspace/generated/src/frontend/SageIII//SgAsmJvmRuntimeVisibilityParamAnnotations.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 9954 "/workspace/src/ROSETTA/src/binaryInstruction.C" */


    //----------------------- Boost serialization for SgAsmJvmRuntimeVisibilityParamAnnotations -----------------------
...
private:
    ...
    void serialize(S &s, const unsigned /*version*/) {
        debugSerializationBegin("SgAsmJvmRuntimeVisibilityParamAnnotations");
        s & BOOST_SERIALIZATION_BASE_OBJECT_NVP(SgAsmJvmAttribute);
        s & BOOST_SERIALIZATION_NVP(p_parameter_annotations);
        s & BOOST_SERIALIZATION_NVP(p_isVisible);
        debugSerializationEnd("SgAsmJvmRuntimeVisibilityParamAnnotations");
    }
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmJvmRuntimeVisibilityParamAnnotations;
          enum { static_variant = V_SgAsmJvmRuntimeVisibilityParamAnnotations };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmJvmRuntimeVisibilityParamAnnotations* isSgAsmJvmRuntimeVisibilityParamAnnotations(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmJvmRuntimeVisibilityParamAnnotations* isSgAsmJvmRuntimeVisibilityParamAnnotations( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmJvmRuntimeVisibilityParamAnnotations * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmJvmRuntimeVisibilityParamAnnotationsStorageClass *); // 
          ...
          /// \private
          static SgAsmJvmRuntimeVisibilityParamAnnotations * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmJvmRuntimeVisibilityParamAnnotations * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmJvmRuntimeVisibilityParamAnnotations::operator delete (pointer,sizeof(SgAsmJvmRuntimeVisibilityParamAnnotations));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmJvmRuntimeVisibilityParamAnnotations* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmJvmRuntimeVisibilityParamAnnotations* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmJvmRuntimeVisibilityParamAnnotations* sgnode);
     ...
     public:
       ...
       */
       // SgAsmJvmRuntimeVisibilityParamAnnotations( SgAsmJvmRuntimeVisibilityParamAnnotationsStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmJvmRuntimeVisibilityParamAnnotationsStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmJvmRuntimeVisibilityParamAnnotations( const SgAsmJvmRuntimeVisibilityParamAnnotationsStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmJvmRuntimeVisibilityParamAnnotations* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmJvmRuntimeVisibilityParamAnnotations* isSgAsmJvmRuntimeVisibilityParamAnnotations ( SgNode* s );

          typedef SgAsmJvmAttribute base_node_type;
...
// End of memberFunctionString
    ...
    protected:
// Start of memberFunctionString
std::vector<SgAsmJvmRuntimeParameterAnnotation*> p_parameter_annotations;
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmJvmRuntimeVisibilityParamAnnotations>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmJvmRuntimeVisibilityParamAnnotations, std::vector<SgAsmJvmRuntimeParameterAnnotation*>,&SgAsmJvmRuntimeVisibilityParamAnnotations::p_parameter_annotations>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmJvmRuntimeVisibilityParamAnnotations, bool,&SgAsmJvmRuntimeVisibilityParamAnnotations::p_isVisible>;
...
// postdeclarations for SgAsmJvmRuntimeVisibilityParamAnnotations

/* #line 550 "/workspace/generated/src/frontend/SageIII//SgAsmJvmRuntimeVisibilityParamAnnotations.h" */
...
/* #line 557 "/workspace/generated/src/frontend/SageIII//SgAsmJvmRuntimeVisibilityParamAnnotations.h" */

#endif // ROSE_SgAsmJvmRuntimeVisibilityParamAnnotations_H
