...
#ifndef ROSE_SgAsmConstantExpression_H
#define ROSE_SgAsmConstantExpression_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmConstantExpression

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmConstantExpression.h" */
/* #line 30496 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// Class Definition for SgAsmConstantExpression
class ROSE_DLL_API SgAsmConstantExpression  : public SgAsmValueExpression
   {
     public:


/* #line 42 "/workspace/generated/src/frontend/SageIII//SgAsmConstantExpression.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 30515 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmConstantExpression;
      ...
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmConstantExpression* isSgAsmConstantExpression(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmConstantExpression* isSgAsmConstantExpression( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmConstantExpression * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmConstantExpressionStorageClass *); // 
          ...
          /// \private
          static SgAsmConstantExpression * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmConstantExpression * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmConstantExpression::operator delete (pointer,sizeof(SgAsmConstantExpression));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmConstantExpression* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmConstantExpression* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmConstantExpression* sgnode);
     ...
     public:
       ...
       */
       // SgAsmConstantExpression( SgAsmConstantExpressionStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmConstantExpressionStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmConstantExpression( const SgAsmConstantExpressionStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmConstantExpression* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmConstantExpression* isSgAsmConstantExpression ( SgNode* s );

          typedef SgAsmValueExpression base_node_type;
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmConstantExpression>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmConstantExpression, Sawyer::Container::BitVector,&SgAsmConstantExpression::p_bitVector>;
...
// postdeclarations for SgAsmConstantExpression

/* #line 518 "/workspace/generated/src/frontend/SageIII//SgAsmConstantExpression.h" */
...
/* #line 525 "/workspace/generated/src/frontend/SageIII//SgAsmConstantExpression.h" */

#endif // ROSE_SgAsmConstantExpression_H
