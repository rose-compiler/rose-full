...
#ifndef ROSE_SgAsmUserInstruction_H
#define ROSE_SgAsmUserInstruction_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmUserInstruction

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmUserInstruction.h" */
...
// Class Definition for SgAsmUserInstruction
class ROSE_DLL_API SgAsmUserInstruction  : public SgAsmInstruction
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmUserInstruction.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 502 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmUserInstruction;
          enum { static_variant = V_SgAsmUserInstruction };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmUserInstruction* isSgAsmUserInstruction(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmUserInstruction* isSgAsmUserInstruction( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmUserInstruction * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmUserInstructionStorageClass *); // 
          ...
          /// \private
          static SgAsmUserInstruction * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmUserInstruction * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmUserInstruction::operator delete (pointer,sizeof(SgAsmUserInstruction));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmUserInstruction* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmUserInstruction* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmUserInstruction* sgnode);
     ...
     public:
       ...
       */
       // SgAsmUserInstruction( SgAsmUserInstructionStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmUserInstructionStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmUserInstruction( const SgAsmUserInstructionStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmUserInstruction* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmUserInstruction* isSgAsmUserInstruction ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmUserInstruction>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmUserInstruction, unsigned,&SgAsmUserInstruction::p_kind>;
...
// postdeclarations for SgAsmUserInstruction

/* #line 521 "/workspace/generated/src/frontend/SageIII//SgAsmUserInstruction.h" */
...
/* #line 528 "/workspace/generated/src/frontend/SageIII//SgAsmUserInstruction.h" */

#endif // ROSE_SgAsmUserInstruction_H
