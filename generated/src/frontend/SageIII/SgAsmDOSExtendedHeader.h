...
#ifndef ROSE_SgAsmDOSExtendedHeader_H
#define ROSE_SgAsmDOSExtendedHeader_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmDOSExtendedHeader

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmDOSExtendedHeader.h" */
/* #line 29998 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// Class Definition for SgAsmDOSExtendedHeader
class ROSE_DLL_API SgAsmDOSExtendedHeader  : public SgAsmGenericSection
   {
     public:


/* #line 42 "/workspace/generated/src/frontend/SageIII//SgAsmDOSExtendedHeader.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 30064 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmDOSExtendedHeader;
          enum { static_variant = V_SgAsmDOSExtendedHeader };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmDOSExtendedHeader* isSgAsmDOSExtendedHeader(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmDOSExtendedHeader* isSgAsmDOSExtendedHeader( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmDOSExtendedHeader * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmDOSExtendedHeaderStorageClass *); // 
          ...
          /// \private
          static SgAsmDOSExtendedHeader * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmDOSExtendedHeader * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmDOSExtendedHeader::operator delete (pointer,sizeof(SgAsmDOSExtendedHeader));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmDOSExtendedHeader* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmDOSExtendedHeader* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmDOSExtendedHeader* sgnode);
     ...
     public:
       ...
       */
       // SgAsmDOSExtendedHeader( SgAsmDOSExtendedHeaderStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmDOSExtendedHeaderStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmDOSExtendedHeader( const SgAsmDOSExtendedHeaderStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmDOSExtendedHeader* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmDOSExtendedHeader* isSgAsmDOSExtendedHeader ( SgNode* s );
...
// End of memberFunctionString
// Start of memberFunctionString
Rose::BinaryAnalysis::Address p_e_lfanew;
          
// End of memberFunctionString

    friend struct Rose::Traits::generated::describe_node_t<SgAsmDOSExtendedHeader>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmDOSExtendedHeader, unsigned,&SgAsmDOSExtendedHeader::p_e_res1>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmDOSExtendedHeader, unsigned,&SgAsmDOSExtendedHeader::p_e_oemid>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmDOSExtendedHeader, unsigned,&SgAsmDOSExtendedHeader::p_e_oeminfo>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmDOSExtendedHeader, unsigned,&SgAsmDOSExtendedHeader::p_e_res2>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmDOSExtendedHeader, unsigned,&SgAsmDOSExtendedHeader::p_e_res3>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmDOSExtendedHeader, unsigned,&SgAsmDOSExtendedHeader::p_e_res4>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmDOSExtendedHeader, unsigned,&SgAsmDOSExtendedHeader::p_e_res5>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmDOSExtendedHeader, unsigned,&SgAsmDOSExtendedHeader::p_e_res6>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmDOSExtendedHeader, Rose::BinaryAnalysis::Address,&SgAsmDOSExtendedHeader::p_e_lfanew>;
...
// postdeclarations for SgAsmDOSExtendedHeader

/* #line 690 "/workspace/generated/src/frontend/SageIII//SgAsmDOSExtendedHeader.h" */
...
/* #line 697 "/workspace/generated/src/frontend/SageIII//SgAsmDOSExtendedHeader.h" */

#endif // ROSE_SgAsmDOSExtendedHeader_H
