...
#ifndef ROSE_SgAsmDwarfSubrangeType_H
#define ROSE_SgAsmDwarfSubrangeType_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmDwarfSubrangeType

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfSubrangeType.h" */
...
// Class Definition for SgAsmDwarfSubrangeType
class ROSE_DLL_API SgAsmDwarfSubrangeType  : public SgAsmDwarfConstruct
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfSubrangeType.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 25321 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmDwarfSubrangeType;
          enum { static_variant = V_SgAsmDwarfSubrangeType };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmDwarfSubrangeType* isSgAsmDwarfSubrangeType(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmDwarfSubrangeType* isSgAsmDwarfSubrangeType( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmDwarfSubrangeType * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmDwarfSubrangeTypeStorageClass *); // 
          ...
          /// \private
          static SgAsmDwarfSubrangeType * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmDwarfSubrangeType * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmDwarfSubrangeType::operator delete (pointer,sizeof(SgAsmDwarfSubrangeType));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmDwarfSubrangeType* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmDwarfSubrangeType* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmDwarfSubrangeType* sgnode);
     ...
     public:
       ...
       */
       // SgAsmDwarfSubrangeType( SgAsmDwarfSubrangeTypeStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmDwarfSubrangeTypeStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmDwarfSubrangeType( const SgAsmDwarfSubrangeTypeStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmDwarfSubrangeType* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmDwarfSubrangeType* isSgAsmDwarfSubrangeType ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmDwarfSubrangeType>;
...
// postdeclarations for SgAsmDwarfSubrangeType

/* #line 502 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfSubrangeType.h" */
...
/* #line 509 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfSubrangeType.h" */

#endif // ROSE_SgAsmDwarfSubrangeType_H
