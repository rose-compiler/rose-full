...
#ifndef ROSE_SgAsmJvmRuntimeVisibleParameterAnnotations_H
#define ROSE_SgAsmJvmRuntimeVisibleParameterAnnotations_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmJvmRuntimeVisibleParameterAnnotations

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmJvmRuntimeVisibleParameterAnnotations.h" */
/* #line 10064 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// Class Definition for SgAsmJvmRuntimeVisibleParameterAnnotations
class ROSE_DLL_API SgAsmJvmRuntimeVisibleParameterAnnotations  : public SgAsmJvmAttribute
   {
     public:


/* #line 42 "/workspace/generated/src/frontend/SageIII//SgAsmJvmRuntimeVisibleParameterAnnotations.h" */

          virtual SgNode* copy ( SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 10085 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmJvmRuntimeVisibleParameterAnnotations;
          enum { static_variant = V_SgAsmJvmRuntimeVisibleParameterAnnotations };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmJvmRuntimeVisibleParameterAnnotations* isSgAsmJvmRuntimeVisibleParameterAnnotations(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmJvmRuntimeVisibleParameterAnnotations* isSgAsmJvmRuntimeVisibleParameterAnnotations( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmJvmRuntimeVisibleParameterAnnotations * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmJvmRuntimeVisibleParameterAnnotationsStorageClass *); // 
          ...
          /// \private
          static SgAsmJvmRuntimeVisibleParameterAnnotations * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmJvmRuntimeVisibleParameterAnnotations * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmJvmRuntimeVisibleParameterAnnotations::operator delete (pointer,sizeof(SgAsmJvmRuntimeVisibleParameterAnnotations));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmJvmRuntimeVisibleParameterAnnotations* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmJvmRuntimeVisibleParameterAnnotations* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmJvmRuntimeVisibleParameterAnnotations* sgnode);
     ...
     public:
       ...
       */
       // SgAsmJvmRuntimeVisibleParameterAnnotations( SgAsmJvmRuntimeVisibleParameterAnnotationsStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmJvmRuntimeVisibleParameterAnnotationsStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmJvmRuntimeVisibleParameterAnnotations( const SgAsmJvmRuntimeVisibleParameterAnnotationsStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmJvmRuntimeVisibleParameterAnnotations* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 670 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmJvmRuntimeVisibleParameterAnnotations* isSgAsmJvmRuntimeVisibleParameterAnnotations ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmJvmRuntimeVisibleParameterAnnotations>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmJvmRuntimeVisibleParameterAnnotations, std::vector<SgAsmJvmRuntimeParameterAnnotation*>,&SgAsmJvmRuntimeVisibleParameterAnnotations::p_parameter_annotations>;
...
// postdeclarations for SgAsmJvmRuntimeVisibleParameterAnnotations

/* #line 532 "/workspace/generated/src/frontend/SageIII//SgAsmJvmRuntimeVisibleParameterAnnotations.h" */
...
/* #line 539 "/workspace/generated/src/frontend/SageIII//SgAsmJvmRuntimeVisibleParameterAnnotations.h" */

#endif // ROSE_SgAsmJvmRuntimeVisibleParameterAnnotations_H
