...
#ifndef ROSE_SgAsmJvmMethodTable_H
#define ROSE_SgAsmJvmMethodTable_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmJvmMethodTable

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmJvmMethodTable.h" */
...
// Class Definition for SgAsmJvmMethodTable
class ROSE_DLL_API SgAsmJvmMethodTable  : public SgAsmGenericSection
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmJvmMethodTable.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 11036 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmJvmMethodTable;
          enum { static_variant = V_SgAsmJvmMethodTable };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmJvmMethodTable* isSgAsmJvmMethodTable(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmJvmMethodTable* isSgAsmJvmMethodTable( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmJvmMethodTable * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmJvmMethodTableStorageClass *); // 
          ...
          /// \private
          static SgAsmJvmMethodTable * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmJvmMethodTable * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmJvmMethodTable::operator delete (pointer,sizeof(SgAsmJvmMethodTable));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmJvmMethodTable* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmJvmMethodTable* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmJvmMethodTable* sgnode);
     ...
     public:
       ...
       */
       // SgAsmJvmMethodTable( SgAsmJvmMethodTableStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmJvmMethodTableStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmJvmMethodTable( const SgAsmJvmMethodTableStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmJvmMethodTable* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmJvmMethodTable* isSgAsmJvmMethodTable ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmJvmMethodTable>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmJvmMethodTable, SgAsmJvmMethodPtrList,&SgAsmJvmMethodTable::p_methods>;
...
// postdeclarations for SgAsmJvmMethodTable

/* #line 528 "/workspace/generated/src/frontend/SageIII//SgAsmJvmMethodTable.h" */
...
/* #line 535 "/workspace/generated/src/frontend/SageIII//SgAsmJvmMethodTable.h" */

#endif // ROSE_SgAsmJvmMethodTable_H
