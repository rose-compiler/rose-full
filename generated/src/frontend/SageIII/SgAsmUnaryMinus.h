...
#ifndef ROSE_SgAsmUnaryMinus_H
#define ROSE_SgAsmUnaryMinus_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmUnaryMinus

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmUnaryMinus.h" */
...
// Class Definition for SgAsmUnaryMinus
class ROSE_DLL_API SgAsmUnaryMinus  : public SgAsmUnaryExpression
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmUnaryMinus.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 881 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmUnaryMinus* isSgAsmUnaryMinus(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmUnaryMinus* isSgAsmUnaryMinus( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmUnaryMinus * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmUnaryMinusStorageClass *); // 
          ...
          /// \private
          static SgAsmUnaryMinus * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmUnaryMinus * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmUnaryMinus::operator delete (pointer,sizeof(SgAsmUnaryMinus));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmUnaryMinus* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmUnaryMinus* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmUnaryMinus* sgnode);
     ...
     public:
       ...
       */
       // SgAsmUnaryMinus( SgAsmUnaryMinusStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmUnaryMinusStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmUnaryMinus( const SgAsmUnaryMinusStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmUnaryMinus* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmUnaryMinus* isSgAsmUnaryMinus ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmUnaryMinus>;
...
// postdeclarations for SgAsmUnaryMinus

/* #line 500 "/workspace/generated/src/frontend/SageIII//SgAsmUnaryMinus.h" */
...
/* #line 507 "/workspace/generated/src/frontend/SageIII//SgAsmUnaryMinus.h" */

#endif // ROSE_SgAsmUnaryMinus_H
