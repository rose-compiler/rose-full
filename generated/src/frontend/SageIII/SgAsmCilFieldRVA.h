...
#ifndef ROSE_SgAsmCilFieldRVA_H
#define ROSE_SgAsmCilFieldRVA_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmCilFieldRVA

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmCilFieldRVA.h" */
...
// Class Definition for SgAsmCilFieldRVA
class ROSE_DLL_API SgAsmCilFieldRVA  : public SgAsmCilMetadata
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmCilFieldRVA.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 38431 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmCilFieldRVA;
          enum { static_variant = V_SgAsmCilFieldRVA };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmCilFieldRVA* isSgAsmCilFieldRVA(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmCilFieldRVA* isSgAsmCilFieldRVA( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmCilFieldRVA * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmCilFieldRVAStorageClass *); // 
          ...
          /// \private
          static SgAsmCilFieldRVA * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmCilFieldRVA * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmCilFieldRVA::operator delete (pointer,sizeof(SgAsmCilFieldRVA));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmCilFieldRVA* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmCilFieldRVA* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmCilFieldRVA* sgnode);
     ...
     public:
       ...
       */
       // SgAsmCilFieldRVA( SgAsmCilFieldRVAStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmCilFieldRVAStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmCilFieldRVA( const SgAsmCilFieldRVAStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmCilFieldRVA* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmCilFieldRVA* isSgAsmCilFieldRVA ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmCilFieldRVA>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilFieldRVA, uint32_t,&SgAsmCilFieldRVA::p_RVA>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilFieldRVA, uint32_t,&SgAsmCilFieldRVA::p_Field>;
...
// postdeclarations for SgAsmCilFieldRVA

/* #line 535 "/workspace/generated/src/frontend/SageIII//SgAsmCilFieldRVA.h" */
...
/* #line 542 "/workspace/generated/src/frontend/SageIII//SgAsmCilFieldRVA.h" */

#endif // ROSE_SgAsmCilFieldRVA_H
