...
#ifndef ROSE_SgAsmJvmMethod_H
#define ROSE_SgAsmJvmMethod_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmJvmMethod

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmJvmMethod.h" */
/* #line 11310 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// Class Definition for SgAsmJvmMethod
class ROSE_DLL_API SgAsmJvmMethod  : public SgAsmJvmNode
   {
     public:


/* #line 45 "/workspace/generated/src/frontend/SageIII//SgAsmJvmMethod.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 11356 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmJvmMethod;
          enum { static_variant = V_SgAsmJvmMethod };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmJvmMethod* isSgAsmJvmMethod(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmJvmMethod* isSgAsmJvmMethod( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmJvmMethod * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmJvmMethodStorageClass *); // 
          ...
          /// \private
          static SgAsmJvmMethod * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmJvmMethod * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmJvmMethod::operator delete (pointer,sizeof(SgAsmJvmMethod));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmJvmMethod* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmJvmMethod* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmJvmMethod* sgnode);
     ...
     public:
       ...
       */
       // SgAsmJvmMethod( SgAsmJvmMethodStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmJvmMethodStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmJvmMethod( const SgAsmJvmMethodStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmJvmMethod* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmJvmMethod* isSgAsmJvmMethod ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmJvmMethod>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmJvmMethod, uint16_t,&SgAsmJvmMethod::p_access_flags>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmJvmMethod, uint16_t,&SgAsmJvmMethod::p_name_index>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmJvmMethod, uint16_t,&SgAsmJvmMethod::p_descriptor_index>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmJvmMethod, SgAsmJvmAttributeTable*,&SgAsmJvmMethod::p_attribute_table>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmJvmMethod, SgAsmInstructionList*,&SgAsmJvmMethod::p_instruction_list>;
...
// postdeclarations for SgAsmJvmMethod

/* #line 600 "/workspace/generated/src/frontend/SageIII//SgAsmJvmMethod.h" */
...
/* #line 607 "/workspace/generated/src/frontend/SageIII//SgAsmJvmMethod.h" */

#endif // ROSE_SgAsmJvmMethod_H
