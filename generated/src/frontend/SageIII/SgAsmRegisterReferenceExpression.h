...
#ifndef ROSE_SgAsmRegisterReferenceExpression_H
#define ROSE_SgAsmRegisterReferenceExpression_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmRegisterReferenceExpression

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmRegisterReferenceExpression.h" */
...
class ROSE_DLL_API SgAsmRegisterReferenceExpression  : public SgAsmExpression
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmRegisterReferenceExpression.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 30338 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmRegisterReferenceExpression* isSgAsmRegisterReferenceExpression(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmRegisterReferenceExpression* isSgAsmRegisterReferenceExpression( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmRegisterReferenceExpression * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmRegisterReferenceExpressionStorageClass *); // 
          ...
          /// \private
          static SgAsmRegisterReferenceExpression * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmRegisterReferenceExpression * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmRegisterReferenceExpression::operator delete (pointer,sizeof(SgAsmRegisterReferenceExpression));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmRegisterReferenceExpression* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmRegisterReferenceExpression* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmRegisterReferenceExpression* sgnode);
     ...
     public:
       ...
       */
       // SgAsmRegisterReferenceExpression( SgAsmRegisterReferenceExpressionStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmRegisterReferenceExpressionStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmRegisterReferenceExpression( const SgAsmRegisterReferenceExpressionStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmRegisterReferenceExpression* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmRegisterReferenceExpression* isSgAsmRegisterReferenceExpression ( SgNode* s );

          typedef SgAsmExpression base_node_type;
...
// End of memberFunctionString
    ...
    protected:
// Start of memberFunctionString
Rose::BinaryAnalysis::RegisterDescriptor p_descriptor;
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmRegisterReferenceExpression>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmRegisterReferenceExpression, Rose::BinaryAnalysis::RegisterDescriptor,&SgAsmRegisterReferenceExpression::p_descriptor>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmRegisterReferenceExpression, int,&SgAsmRegisterReferenceExpression::p_adjustment>;
...
// postdeclarations for SgAsmRegisterReferenceExpression

/* #line 532 "/workspace/generated/src/frontend/SageIII//SgAsmRegisterReferenceExpression.h" */
...
/* #line 539 "/workspace/generated/src/frontend/SageIII//SgAsmRegisterReferenceExpression.h" */

#endif // ROSE_SgAsmRegisterReferenceExpression_H
