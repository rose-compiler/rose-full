...
#ifndef ROSE_SgAsmBasicString_H
#define ROSE_SgAsmBasicString_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmBasicString

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmBasicString.h" */
/* #line 43428 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// Class Definition for SgAsmBasicString
class ROSE_DLL_API SgAsmBasicString  : public SgAsmGenericString
   {
     public:


/* #line 42 "/workspace/generated/src/frontend/SageIII//SgAsmBasicString.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 43447 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmBasicString;
          enum { static_variant = V_SgAsmBasicString };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmBasicString* isSgAsmBasicString(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmBasicString* isSgAsmBasicString( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmBasicString * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmBasicStringStorageClass *); // 
          ...
          /// \private
          static SgAsmBasicString * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmBasicString * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmBasicString::operator delete (pointer,sizeof(SgAsmBasicString));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmBasicString* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmBasicString* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmBasicString* sgnode);
     ...
     public:
       ...
       */
       // SgAsmBasicString( SgAsmBasicStringStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmBasicStringStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmBasicString( const SgAsmBasicStringStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmBasicString* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmBasicString* isSgAsmBasicString ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmBasicString>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmBasicString, std::string,&SgAsmBasicString::p_string>;
...
// postdeclarations for SgAsmBasicString

/* #line 522 "/workspace/generated/src/frontend/SageIII//SgAsmBasicString.h" */
...
/* #line 529 "/workspace/generated/src/frontend/SageIII//SgAsmBasicString.h" */

#endif // ROSE_SgAsmBasicString_H
