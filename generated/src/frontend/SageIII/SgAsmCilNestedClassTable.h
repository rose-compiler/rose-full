...
#ifndef ROSE_SgAsmCilNestedClassTable_H
#define ROSE_SgAsmCilNestedClassTable_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmCilNestedClassTable

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmCilNestedClassTable.h" */
...
// Class Definition for SgAsmCilNestedClassTable
class ROSE_DLL_API SgAsmCilNestedClassTable  : public SgAsmCilMetadata
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmCilNestedClassTable.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 34219 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmCilNestedClassTable;
          enum { static_variant = V_SgAsmCilNestedClassTable };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmCilNestedClassTable* isSgAsmCilNestedClassTable(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmCilNestedClassTable* isSgAsmCilNestedClassTable( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmCilNestedClassTable * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmCilNestedClassTableStorageClass *); // 
          ...
          /// \private
          static SgAsmCilNestedClassTable * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmCilNestedClassTable * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmCilNestedClassTable::operator delete (pointer,sizeof(SgAsmCilNestedClassTable));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmCilNestedClassTable* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmCilNestedClassTable* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmCilNestedClassTable* sgnode);
     ...
     public:
       ...
       */
       // SgAsmCilNestedClassTable( SgAsmCilNestedClassTableStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmCilNestedClassTableStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmCilNestedClassTable( const SgAsmCilNestedClassTableStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmCilNestedClassTable* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmCilNestedClassTable* isSgAsmCilNestedClassTable ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmCilNestedClassTable>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilNestedClassTable, std::vector<SgAsmCilNestedClass*>,&SgAsmCilNestedClassTable::p_elements>;
...
// postdeclarations for SgAsmCilNestedClassTable

/* #line 508 "/workspace/generated/src/frontend/SageIII//SgAsmCilNestedClassTable.h" */
...
/* #line 515 "/workspace/generated/src/frontend/SageIII//SgAsmCilNestedClassTable.h" */

#endif // ROSE_SgAsmCilNestedClassTable_H
