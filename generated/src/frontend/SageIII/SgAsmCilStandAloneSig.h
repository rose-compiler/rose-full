...
#ifndef ROSE_SgAsmCilStandAloneSig_H
#define ROSE_SgAsmCilStandAloneSig_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmCilStandAloneSig

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmCilStandAloneSig.h" */
...
// Class Definition for SgAsmCilStandAloneSig
class ROSE_DLL_API SgAsmCilStandAloneSig  : public SgAsmCilMetadata
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmCilStandAloneSig.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 33630 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmCilStandAloneSig;
          enum { static_variant = V_SgAsmCilStandAloneSig };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmCilStandAloneSig* isSgAsmCilStandAloneSig(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmCilStandAloneSig* isSgAsmCilStandAloneSig( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmCilStandAloneSig * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmCilStandAloneSigStorageClass *); // 
          ...
          /// \private
          static SgAsmCilStandAloneSig * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmCilStandAloneSig * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmCilStandAloneSig::operator delete (pointer,sizeof(SgAsmCilStandAloneSig));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmCilStandAloneSig* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmCilStandAloneSig* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmCilStandAloneSig* sgnode);
     ...
     public:
       ...
       */
       // SgAsmCilStandAloneSig( SgAsmCilStandAloneSigStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmCilStandAloneSigStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmCilStandAloneSig( const SgAsmCilStandAloneSigStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmCilStandAloneSig* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmCilStandAloneSig* isSgAsmCilStandAloneSig ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmCilStandAloneSig>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilStandAloneSig, uint32_t,&SgAsmCilStandAloneSig::p_Signature>;
...
// postdeclarations for SgAsmCilStandAloneSig

/* #line 518 "/workspace/generated/src/frontend/SageIII//SgAsmCilStandAloneSig.h" */
...
/* #line 525 "/workspace/generated/src/frontend/SageIII//SgAsmCilStandAloneSig.h" */

#endif // ROSE_SgAsmCilStandAloneSig_H
