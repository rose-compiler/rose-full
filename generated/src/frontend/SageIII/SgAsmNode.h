...
#ifndef ROSE_SgAsmNode_H
#define ROSE_SgAsmNode_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmNode

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmNode.h" */
/* #line 45783 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// Class Definition for SgAsmNode
class ROSE_DLL_API SgAsmNode  : public SgNode
   {
     public:


/* #line 43 "/workspace/generated/src/frontend/SageIII//SgAsmNode.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 45794 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
     ...
     public:
          ...
          /// \private
          static SgAsmNode * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmNodeStorageClass *); // 
          ...
          /// \private
          static SgAsmNode * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmNode * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmNode::operator delete (pointer,sizeof(SgAsmNode));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmNode* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmNode* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmNode* sgnode);
     ...
     public:
       ...
       */
       // SgAsmNode( SgAsmNodeStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmNodeStorageClass;
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmNode* isSgAsmNode ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmNode>;
...
// postdeclarations for SgAsmNode

/* #line 519 "/workspace/generated/src/frontend/SageIII//SgAsmNode.h" */
...
/* #line 526 "/workspace/generated/src/frontend/SageIII//SgAsmNode.h" */

#endif // ROSE_SgAsmNode_H
