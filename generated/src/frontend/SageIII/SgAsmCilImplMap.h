...
#ifndef ROSE_SgAsmCilImplMap_H
#define ROSE_SgAsmCilImplMap_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmCilImplMap

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmCilImplMap.h" */
...
// Class Definition for SgAsmCilImplMap
class ROSE_DLL_API SgAsmCilImplMap  : public SgAsmCilMetadata
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmCilImplMap.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 37651 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmCilImplMap;
          enum { static_variant = V_SgAsmCilImplMap };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmCilImplMap* isSgAsmCilImplMap(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmCilImplMap* isSgAsmCilImplMap( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmCilImplMap * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmCilImplMapStorageClass *); // 
          ...
          /// \private
          static SgAsmCilImplMap * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmCilImplMap * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmCilImplMap::operator delete (pointer,sizeof(SgAsmCilImplMap));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmCilImplMap* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmCilImplMap* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmCilImplMap* sgnode);
     ...
     public:
       ...
       */
       // SgAsmCilImplMap( SgAsmCilImplMapStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmCilImplMapStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmCilImplMap( const SgAsmCilImplMapStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmCilImplMap* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmCilImplMap* isSgAsmCilImplMap ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmCilImplMap>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilImplMap, uint16_t,&SgAsmCilImplMap::p_MappingFlags>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilImplMap, uint32_t,&SgAsmCilImplMap::p_MemberForwarded>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilImplMap, uint32_t,&SgAsmCilImplMap::p_ImportName>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilImplMap, uint32_t,&SgAsmCilImplMap::p_ImportScope>;
...
// postdeclarations for SgAsmCilImplMap

/* #line 571 "/workspace/generated/src/frontend/SageIII//SgAsmCilImplMap.h" */
...
/* #line 578 "/workspace/generated/src/frontend/SageIII//SgAsmCilImplMap.h" */

#endif // ROSE_SgAsmCilImplMap_H
