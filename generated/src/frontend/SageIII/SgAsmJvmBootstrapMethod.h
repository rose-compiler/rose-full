...
#ifndef ROSE_SgAsmJvmBootstrapMethod_H
#define ROSE_SgAsmJvmBootstrapMethod_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmJvmBootstrapMethod

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmJvmBootstrapMethod.h" */
/* #line 14380 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// Class Definition for SgAsmJvmBootstrapMethod
class ROSE_DLL_API SgAsmJvmBootstrapMethod  : public SgAsmJvmNode
   {
     public:


/* #line 42 "/workspace/generated/src/frontend/SageIII//SgAsmJvmBootstrapMethod.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 14406 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmJvmBootstrapMethod;
          enum { static_variant = V_SgAsmJvmBootstrapMethod };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmJvmBootstrapMethod* isSgAsmJvmBootstrapMethod(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmJvmBootstrapMethod* isSgAsmJvmBootstrapMethod( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmJvmBootstrapMethod * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmJvmBootstrapMethodStorageClass *); // 
          ...
          /// \private
          static SgAsmJvmBootstrapMethod * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmJvmBootstrapMethod * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmJvmBootstrapMethod::operator delete (pointer,sizeof(SgAsmJvmBootstrapMethod));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmJvmBootstrapMethod* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmJvmBootstrapMethod* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmJvmBootstrapMethod* sgnode);
     ...
     public:
       ...
       */
       // SgAsmJvmBootstrapMethod( SgAsmJvmBootstrapMethodStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmJvmBootstrapMethodStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmJvmBootstrapMethod( const SgAsmJvmBootstrapMethodStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmJvmBootstrapMethod* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmJvmBootstrapMethod* isSgAsmJvmBootstrapMethod ( SgNode* s );
...
// End of memberFunctionString
    ...
    protected:
// Start of memberFunctionString
uint16_t p_bootstrap_method_ref;
          
// End of memberFunctionString
// Start of memberFunctionString
SgUnsigned16List p_bootstrap_arguments;
          
// End of memberFunctionString

    friend struct Rose::Traits::generated::describe_node_t<SgAsmJvmBootstrapMethod>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmJvmBootstrapMethod, uint16_t,&SgAsmJvmBootstrapMethod::p_bootstrap_method_ref>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmJvmBootstrapMethod, SgUnsigned16List,&SgAsmJvmBootstrapMethod::p_bootstrap_arguments>;
...
// postdeclarations for SgAsmJvmBootstrapMethod

/* #line 549 "/workspace/generated/src/frontend/SageIII//SgAsmJvmBootstrapMethod.h" */
...
/* #line 556 "/workspace/generated/src/frontend/SageIII//SgAsmJvmBootstrapMethod.h" */

#endif // ROSE_SgAsmJvmBootstrapMethod_H
