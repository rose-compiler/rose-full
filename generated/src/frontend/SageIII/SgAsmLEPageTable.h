...
#ifndef ROSE_SgAsmLEPageTable_H
#define ROSE_SgAsmLEPageTable_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmLEPageTable

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmLEPageTable.h" */
/* #line 8031 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// Class Definition for SgAsmLEPageTable
class ROSE_DLL_API SgAsmLEPageTable  : public SgAsmGenericSection
   {
     public:


/* #line 42 "/workspace/generated/src/frontend/SageIII//SgAsmLEPageTable.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 8046 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmLEPageTable;
          enum { static_variant = V_SgAsmLEPageTable };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmLEPageTable* isSgAsmLEPageTable(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmLEPageTable* isSgAsmLEPageTable( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmLEPageTable * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmLEPageTableStorageClass *); // 
          ...
          /// \private
          static SgAsmLEPageTable * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmLEPageTable * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmLEPageTable::operator delete (pointer,sizeof(SgAsmLEPageTable));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmLEPageTable* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmLEPageTable* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmLEPageTable* sgnode);
     ...
     public:
       ...
       */
       // SgAsmLEPageTable( SgAsmLEPageTableStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmLEPageTableStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmLEPageTable( const SgAsmLEPageTableStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmLEPageTable* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmLEPageTable* isSgAsmLEPageTable ( SgNode* s );
...
// End of memberFunctionString
    ...
    protected:
// Start of memberFunctionString
SgAsmLEPageTableEntryPtrList p_entries;
          
// End of memberFunctionString

    friend struct Rose::Traits::generated::describe_node_t<SgAsmLEPageTable>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmLEPageTable, SgAsmLEPageTableEntryPtrList,&SgAsmLEPageTable::p_entries>;
...
// postdeclarations for SgAsmLEPageTable

/* #line 516 "/workspace/generated/src/frontend/SageIII//SgAsmLEPageTable.h" */
...
/* #line 523 "/workspace/generated/src/frontend/SageIII//SgAsmLEPageTable.h" */

#endif // ROSE_SgAsmLEPageTable_H
