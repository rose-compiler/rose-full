...
#ifndef ROSE_SgAsmDwarfPointerType_H
#define ROSE_SgAsmDwarfPointerType_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmDwarfPointerType

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfPointerType.h" */
...
// Class Definition for SgAsmDwarfPointerType
class ROSE_DLL_API SgAsmDwarfPointerType  : public SgAsmDwarfConstruct
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfPointerType.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 25923 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmDwarfPointerType;
          enum { static_variant = V_SgAsmDwarfPointerType };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmDwarfPointerType* isSgAsmDwarfPointerType(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmDwarfPointerType* isSgAsmDwarfPointerType( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmDwarfPointerType * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmDwarfPointerTypeStorageClass *); // 
          ...
          /// \private
          static SgAsmDwarfPointerType * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmDwarfPointerType * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmDwarfPointerType::operator delete (pointer,sizeof(SgAsmDwarfPointerType));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmDwarfPointerType* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmDwarfPointerType* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmDwarfPointerType* sgnode);
     ...
     public:
       ...
       */
       // SgAsmDwarfPointerType( SgAsmDwarfPointerTypeStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmDwarfPointerTypeStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmDwarfPointerType( const SgAsmDwarfPointerTypeStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmDwarfPointerType* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmDwarfPointerType* isSgAsmDwarfPointerType ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmDwarfPointerType>;
...
// postdeclarations for SgAsmDwarfPointerType

/* #line 502 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfPointerType.h" */
...
/* #line 509 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfPointerType.h" */

#endif // ROSE_SgAsmDwarfPointerType_H
