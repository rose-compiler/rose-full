...
#ifndef ROSE_SgAsmJvmDeprecated_H
#define ROSE_SgAsmJvmDeprecated_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmJvmDeprecated

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmJvmDeprecated.h" */
...
// Class Definition for SgAsmJvmDeprecated
class ROSE_DLL_API SgAsmJvmDeprecated  : public SgAsmJvmAttribute
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmJvmDeprecated.h" */

          virtual SgNode* copy ( SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 12759 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmJvmDeprecated;
          enum { static_variant = V_SgAsmJvmDeprecated };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmJvmDeprecated* isSgAsmJvmDeprecated(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmJvmDeprecated* isSgAsmJvmDeprecated( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmJvmDeprecated * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmJvmDeprecatedStorageClass *); // 
          ...
          /// \private
          static SgAsmJvmDeprecated * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmJvmDeprecated * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmJvmDeprecated::operator delete (pointer,sizeof(SgAsmJvmDeprecated));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmJvmDeprecated* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmJvmDeprecated* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmJvmDeprecated* sgnode);
     ...
     public:
       ...
       */
       // SgAsmJvmDeprecated( SgAsmJvmDeprecatedStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmJvmDeprecatedStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmJvmDeprecated( const SgAsmJvmDeprecatedStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmJvmDeprecated* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 670 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmJvmDeprecated* isSgAsmJvmDeprecated ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmJvmDeprecated>;
...
// postdeclarations for SgAsmJvmDeprecated

/* #line 503 "/workspace/generated/src/frontend/SageIII//SgAsmJvmDeprecated.h" */
...
/* #line 510 "/workspace/generated/src/frontend/SageIII//SgAsmJvmDeprecated.h" */

#endif // ROSE_SgAsmJvmDeprecated_H
