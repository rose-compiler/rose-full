...
#ifndef ROSE_SgAsmCliHeader_H
#define ROSE_SgAsmCliHeader_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmCliHeader

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmCliHeader.h" */
/* #line 31713 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// Class Definition for SgAsmCliHeader
class ROSE_DLL_API SgAsmCliHeader  : public SgAsmGenericSection
   {
     public:


/* #line 44 "/workspace/generated/src/frontend/SageIII//SgAsmCliHeader.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 31805 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmCliHeader;
          enum { static_variant = V_SgAsmCliHeader };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmCliHeader* isSgAsmCliHeader(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmCliHeader* isSgAsmCliHeader( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmCliHeader * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmCliHeaderStorageClass *); // 
          ...
          /// \private
          static SgAsmCliHeader * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmCliHeader * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmCliHeader::operator delete (pointer,sizeof(SgAsmCliHeader));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmCliHeader* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmCliHeader* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmCliHeader* sgnode);
     ...
     public:
       ...
       */
       // SgAsmCliHeader( SgAsmCliHeaderStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmCliHeaderStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmCliHeader( const SgAsmCliHeaderStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmCliHeader* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmCliHeader* isSgAsmCliHeader ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmCliHeader>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCliHeader, uint32_t,&SgAsmCliHeader::p_cb>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCliHeader, uint16_t,&SgAsmCliHeader::p_majorRuntimeVersion>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCliHeader, uint16_t,&SgAsmCliHeader::p_minorRuntimeVersion>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCliHeader, uint64_t,&SgAsmCliHeader::p_metaData>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCliHeader, uint32_t,&SgAsmCliHeader::p_flags>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCliHeader, uint32_t,&SgAsmCliHeader::p_entryPointToken>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCliHeader, uint64_t,&SgAsmCliHeader::p_resources>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCliHeader, uint64_t,&SgAsmCliHeader::p_strongNameSignature>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCliHeader, uint64_t,&SgAsmCliHeader::p_codeManagerTable>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCliHeader, uint64_t,&SgAsmCliHeader::p_vTableFixups>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCliHeader, uint64_t,&SgAsmCliHeader::p_exportAddressTableJumps>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCliHeader, uint64_t,&SgAsmCliHeader::p_managedNativeHeader>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCliHeader, SgAsmCilMetadataRoot*,&SgAsmCliHeader::p_metadataRoot>;
...
// postdeclarations for SgAsmCliHeader

/* #line 730 "/workspace/generated/src/frontend/SageIII//SgAsmCliHeader.h" */
...
/* #line 737 "/workspace/generated/src/frontend/SageIII//SgAsmCliHeader.h" */

#endif // ROSE_SgAsmCliHeader_H
