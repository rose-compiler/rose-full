...
#ifndef ROSE_SgAsmElfSymverDefinedEntry_H
#define ROSE_SgAsmElfSymverDefinedEntry_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmElfSymverDefinedEntry

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmElfSymverDefinedEntry.h" */
/* #line 19329 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// Class Definition for SgAsmElfSymverDefinedEntry
class ROSE_DLL_API SgAsmElfSymverDefinedEntry  : public SgAsmExecutableFileFormat
   {
     public:


/* #line 46 "/workspace/generated/src/frontend/SageIII//SgAsmElfSymverDefinedEntry.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 19373 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmElfSymverDefinedEntry;
          enum { static_variant = V_SgAsmElfSymverDefinedEntry };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmElfSymverDefinedEntry* isSgAsmElfSymverDefinedEntry(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmElfSymverDefinedEntry* isSgAsmElfSymverDefinedEntry( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmElfSymverDefinedEntry * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmElfSymverDefinedEntryStorageClass *); // 
          ...
          /// \private
          static SgAsmElfSymverDefinedEntry * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmElfSymverDefinedEntry * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmElfSymverDefinedEntry::operator delete (pointer,sizeof(SgAsmElfSymverDefinedEntry));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmElfSymverDefinedEntry* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmElfSymverDefinedEntry* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmElfSymverDefinedEntry* sgnode);
     ...
     public:
       ...
       */
       // SgAsmElfSymverDefinedEntry( SgAsmElfSymverDefinedEntryStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmElfSymverDefinedEntryStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmElfSymverDefinedEntry( const SgAsmElfSymverDefinedEntryStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmElfSymverDefinedEntry* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmElfSymverDefinedEntry* isSgAsmElfSymverDefinedEntry ( SgNode* s );
...
// End of memberFunctionString
// Start of memberFunctionString
SgAsmElfSymverDefinedAuxList* p_entries;
          
// End of memberFunctionString

    friend struct Rose::Traits::generated::describe_node_t<SgAsmElfSymverDefinedEntry>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmElfSymverDefinedEntry, size_t,&SgAsmElfSymverDefinedEntry::p_version>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmElfSymverDefinedEntry, int,&SgAsmElfSymverDefinedEntry::p_flags>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmElfSymverDefinedEntry, size_t,&SgAsmElfSymverDefinedEntry::p_index>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmElfSymverDefinedEntry, uint32_t,&SgAsmElfSymverDefinedEntry::p_hash>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmElfSymverDefinedEntry, SgAsmElfSymverDefinedAuxList*,&SgAsmElfSymverDefinedEntry::p_entries>;
...
// postdeclarations for SgAsmElfSymverDefinedEntry

/* #line 633 "/workspace/generated/src/frontend/SageIII//SgAsmElfSymverDefinedEntry.h" */
...
/* #line 640 "/workspace/generated/src/frontend/SageIII//SgAsmElfSymverDefinedEntry.h" */

#endif // ROSE_SgAsmElfSymverDefinedEntry_H
