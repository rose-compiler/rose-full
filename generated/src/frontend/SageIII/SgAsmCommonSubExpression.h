...
#ifndef ROSE_SgAsmCommonSubExpression_H
#define ROSE_SgAsmCommonSubExpression_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmCommonSubExpression

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmCommonSubExpression.h" */
/* #line 30732 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// Class Definition for SgAsmCommonSubExpression
class ROSE_DLL_API SgAsmCommonSubExpression  : public SgAsmExpression
   {
     public:


/* #line 42 "/workspace/generated/src/frontend/SageIII//SgAsmCommonSubExpression.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 30747 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmCommonSubExpression;
          enum { static_variant = V_SgAsmCommonSubExpression };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmCommonSubExpression* isSgAsmCommonSubExpression(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmCommonSubExpression* isSgAsmCommonSubExpression( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmCommonSubExpression * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmCommonSubExpressionStorageClass *); // 
          ...
          /// \private
          static SgAsmCommonSubExpression * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmCommonSubExpression * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmCommonSubExpression::operator delete (pointer,sizeof(SgAsmCommonSubExpression));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmCommonSubExpression* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmCommonSubExpression* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmCommonSubExpression* sgnode);
     ...
     public:
       ...
       */
       // SgAsmCommonSubExpression( SgAsmCommonSubExpressionStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmCommonSubExpressionStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmCommonSubExpression( const SgAsmCommonSubExpressionStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmCommonSubExpression* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmCommonSubExpression* isSgAsmCommonSubExpression ( SgNode* s );
...
// End of memberFunctionString
    ...
    protected:
// Start of memberFunctionString
SgAsmExpression* p_subexpression;
          
// End of memberFunctionString

    friend struct Rose::Traits::generated::describe_node_t<SgAsmCommonSubExpression>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCommonSubExpression, SgAsmExpression*,&SgAsmCommonSubExpression::p_subexpression>;
...
// postdeclarations for SgAsmCommonSubExpression

/* #line 511 "/workspace/generated/src/frontend/SageIII//SgAsmCommonSubExpression.h" */
...
/* #line 518 "/workspace/generated/src/frontend/SageIII//SgAsmCommonSubExpression.h" */

#endif // ROSE_SgAsmCommonSubExpression_H
