...
#ifndef ROSE_SgAsmDwarfLabel_H
#define ROSE_SgAsmDwarfLabel_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmDwarfLabel

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfLabel.h" */
...
// Class Definition for SgAsmDwarfLabel
class ROSE_DLL_API SgAsmDwarfLabel  : public SgAsmDwarfConstruct
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfLabel.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 26892 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmDwarfLabel;
          enum { static_variant = V_SgAsmDwarfLabel };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmDwarfLabel* isSgAsmDwarfLabel(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmDwarfLabel* isSgAsmDwarfLabel( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmDwarfLabel * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmDwarfLabelStorageClass *); // 
          ...
          /// \private
          static SgAsmDwarfLabel * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmDwarfLabel * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmDwarfLabel::operator delete (pointer,sizeof(SgAsmDwarfLabel));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmDwarfLabel* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmDwarfLabel* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmDwarfLabel* sgnode);
     ...
     public:
       ...
       */
       // SgAsmDwarfLabel( SgAsmDwarfLabelStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmDwarfLabelStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmDwarfLabel( const SgAsmDwarfLabelStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmDwarfLabel* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmDwarfLabel* isSgAsmDwarfLabel ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmDwarfLabel>;
...
// postdeclarations for SgAsmDwarfLabel

/* #line 502 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfLabel.h" */
...
/* #line 509 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfLabel.h" */

#endif // ROSE_SgAsmDwarfLabel_H
