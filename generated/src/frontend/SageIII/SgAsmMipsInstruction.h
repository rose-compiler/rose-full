...
#ifndef ROSE_SgAsmMipsInstruction_H
#define ROSE_SgAsmMipsInstruction_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmMipsInstruction

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmMipsInstruction.h" */
/* #line 7330 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// Class Definition for SgAsmMipsInstruction
class ROSE_DLL_API SgAsmMipsInstruction  : public SgAsmInstruction
   {
     public:


/* #line 42 "/workspace/generated/src/frontend/SageIII//SgAsmMipsInstruction.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 7346 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmMipsInstruction;
          enum { static_variant = V_SgAsmMipsInstruction };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmMipsInstruction* isSgAsmMipsInstruction(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmMipsInstruction* isSgAsmMipsInstruction( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmMipsInstruction * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmMipsInstructionStorageClass *); // 
          ...
          /// \private
          static SgAsmMipsInstruction * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmMipsInstruction * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmMipsInstruction::operator delete (pointer,sizeof(SgAsmMipsInstruction));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmMipsInstruction* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmMipsInstruction* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmMipsInstruction* sgnode);
     ...
     public:
       ...
       */
       // SgAsmMipsInstruction( SgAsmMipsInstructionStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmMipsInstructionStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmMipsInstruction( const SgAsmMipsInstructionStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmMipsInstruction* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmMipsInstruction* isSgAsmMipsInstruction ( SgNode* s );
...
// End of memberFunctionString
    ...
    protected:
// Start of memberFunctionString
Rose::BinaryAnalysis::MipsInstructionKind p_kind;
          
// End of memberFunctionString

    friend struct Rose::Traits::generated::describe_node_t<SgAsmMipsInstruction>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmMipsInstruction, Rose::BinaryAnalysis::MipsInstructionKind,&SgAsmMipsInstruction::p_kind>;
...
// postdeclarations for SgAsmMipsInstruction

/* #line 526 "/workspace/generated/src/frontend/SageIII//SgAsmMipsInstruction.h" */
...
/* #line 533 "/workspace/generated/src/frontend/SageIII//SgAsmMipsInstruction.h" */

#endif // ROSE_SgAsmMipsInstruction_H
