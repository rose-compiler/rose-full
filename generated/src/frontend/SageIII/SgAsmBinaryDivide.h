...
#ifndef ROSE_SgAsmBinaryDivide_H
#define ROSE_SgAsmBinaryDivide_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmBinaryDivide

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmBinaryDivide.h" */
...
// Class Definition for SgAsmBinaryDivide
class ROSE_DLL_API SgAsmBinaryDivide  : public SgAsmBinaryExpression
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmBinaryDivide.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 43083 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmBinaryDivide* isSgAsmBinaryDivide(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmBinaryDivide* isSgAsmBinaryDivide( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmBinaryDivide * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmBinaryDivideStorageClass *); // 
          ...
          /// \private
          static SgAsmBinaryDivide * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmBinaryDivide * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmBinaryDivide::operator delete (pointer,sizeof(SgAsmBinaryDivide));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmBinaryDivide* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmBinaryDivide* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmBinaryDivide* sgnode);
     ...
     public:
       ...
       */
       // SgAsmBinaryDivide( SgAsmBinaryDivideStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmBinaryDivideStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmBinaryDivide( const SgAsmBinaryDivideStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmBinaryDivide* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmBinaryDivide* isSgAsmBinaryDivide ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmBinaryDivide>;
...
// postdeclarations for SgAsmBinaryDivide

/* #line 501 "/workspace/generated/src/frontend/SageIII//SgAsmBinaryDivide.h" */
...
/* #line 508 "/workspace/generated/src/frontend/SageIII//SgAsmBinaryDivide.h" */

#endif // ROSE_SgAsmBinaryDivide_H
