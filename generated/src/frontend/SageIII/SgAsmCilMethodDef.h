...
#ifndef ROSE_SgAsmCilMethodDef_H
#define ROSE_SgAsmCilMethodDef_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmCilMethodDef

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmCilMethodDef.h" */
...
// Class Definition for SgAsmCilMethodDef
class ROSE_DLL_API SgAsmCilMethodDef  : public SgAsmCilMetadata
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmCilMethodDef.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 35387 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmCilMethodDef;
          enum { static_variant = V_SgAsmCilMethodDef };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmCilMethodDef* isSgAsmCilMethodDef(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmCilMethodDef* isSgAsmCilMethodDef( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmCilMethodDef * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmCilMethodDefStorageClass *); // 
          ...
          /// \private
          static SgAsmCilMethodDef * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmCilMethodDef * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmCilMethodDef::operator delete (pointer,sizeof(SgAsmCilMethodDef));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmCilMethodDef* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmCilMethodDef* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmCilMethodDef* sgnode);
     ...
     public:
       ...
       */
       // SgAsmCilMethodDef( SgAsmCilMethodDefStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmCilMethodDefStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmCilMethodDef( const SgAsmCilMethodDefStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmCilMethodDef* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmCilMethodDef* isSgAsmCilMethodDef ( SgNode* s );

          typedef SgAsmCilMetadata base_node_type;
...
// End of memberFunctionString
// Start of memberFunctionString
uint32_t p_stackSize;
          
// End of memberFunctionString
// Start of memberFunctionString
bool p_hasMoreSections;
          
// End of memberFunctionString
// Start of memberFunctionString
uint32_t p_localVarSigTok;
          
// End of memberFunctionString
// Start of memberFunctionString
std::vector<SgAsmCilMethodData*> p_methodData;
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmCilMethodDef>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilMethodDef, uint32_t,&SgAsmCilMethodDef::p_RVA>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilMethodDef, uint16_t,&SgAsmCilMethodDef::p_ImplFlags>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilMethodDef, uint16_t,&SgAsmCilMethodDef::p_Flags>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilMethodDef, uint32_t,&SgAsmCilMethodDef::p_Name>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilMethodDef, uint32_t,&SgAsmCilMethodDef::p_Signature>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilMethodDef, uint32_t,&SgAsmCilMethodDef::p_ParamList>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilMethodDef, SgAsmBlock*,&SgAsmCilMethodDef::p_body>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilMethodDef, bool,&SgAsmCilMethodDef::p_initLocals>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilMethodDef, uint32_t,&SgAsmCilMethodDef::p_stackSize>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilMethodDef, bool,&SgAsmCilMethodDef::p_hasMoreSections>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilMethodDef, uint32_t,&SgAsmCilMethodDef::p_localVarSigTok>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilMethodDef, std::vector<SgAsmCilMethodData*>,&SgAsmCilMethodDef::p_methodData>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilMethodDef, int,&SgAsmCilMethodDef::p_bodyState>;
...
// postdeclarations for SgAsmCilMethodDef

/* #line 783 "/workspace/generated/src/frontend/SageIII//SgAsmCilMethodDef.h" */
...
/* #line 790 "/workspace/generated/src/frontend/SageIII//SgAsmCilMethodDef.h" */

#endif // ROSE_SgAsmCilMethodDef_H
