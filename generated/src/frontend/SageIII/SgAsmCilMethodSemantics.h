...
#ifndef ROSE_SgAsmCilMethodSemantics_H
#define ROSE_SgAsmCilMethodSemantics_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmCilMethodSemantics

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmCilMethodSemantics.h" */
...
// Class Definition for SgAsmCilMethodSemantics
class ROSE_DLL_API SgAsmCilMethodSemantics  : public SgAsmCilMetadata
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmCilMethodSemantics.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 34972 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmCilMethodSemantics;
          enum { static_variant = V_SgAsmCilMethodSemantics };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmCilMethodSemantics* isSgAsmCilMethodSemantics(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmCilMethodSemantics* isSgAsmCilMethodSemantics( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmCilMethodSemantics * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmCilMethodSemanticsStorageClass *); // 
          ...
          /// \private
          static SgAsmCilMethodSemantics * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmCilMethodSemantics * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmCilMethodSemantics::operator delete (pointer,sizeof(SgAsmCilMethodSemantics));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmCilMethodSemantics* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmCilMethodSemantics* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmCilMethodSemantics* sgnode);
     ...
     public:
       ...
       */
       // SgAsmCilMethodSemantics( SgAsmCilMethodSemanticsStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmCilMethodSemanticsStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmCilMethodSemantics( const SgAsmCilMethodSemanticsStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmCilMethodSemantics* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmCilMethodSemantics* isSgAsmCilMethodSemantics ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmCilMethodSemantics>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilMethodSemantics, uint16_t,&SgAsmCilMethodSemantics::p_Semantics>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilMethodSemantics, uint32_t,&SgAsmCilMethodSemantics::p_Method>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilMethodSemantics, uint32_t,&SgAsmCilMethodSemantics::p_Association>;
...
// postdeclarations for SgAsmCilMethodSemantics

/* #line 553 "/workspace/generated/src/frontend/SageIII//SgAsmCilMethodSemantics.h" */
...
/* #line 560 "/workspace/generated/src/frontend/SageIII//SgAsmCilMethodSemantics.h" */

#endif // ROSE_SgAsmCilMethodSemantics_H
