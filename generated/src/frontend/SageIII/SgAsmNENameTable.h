...
#ifndef ROSE_SgAsmNENameTable_H
#define ROSE_SgAsmNENameTable_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmNENameTable

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmNENameTable.h" */
/* #line 6358 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// Class Definition for SgAsmNENameTable
class ROSE_DLL_API SgAsmNENameTable  : public SgAsmGenericSection
   {
     public:


/* #line 42 "/workspace/generated/src/frontend/SageIII//SgAsmNENameTable.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 6379 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmNENameTable;
          enum { static_variant = V_SgAsmNENameTable };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmNENameTable* isSgAsmNENameTable(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmNENameTable* isSgAsmNENameTable( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmNENameTable * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmNENameTableStorageClass *); // 
          ...
          /// \private
          static SgAsmNENameTable * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmNENameTable * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmNENameTable::operator delete (pointer,sizeof(SgAsmNENameTable));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmNENameTable* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmNENameTable* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmNENameTable* sgnode);
     ...
     public:
       ...
       */
       // SgAsmNENameTable( SgAsmNENameTableStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmNENameTableStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmNENameTable( const SgAsmNENameTableStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmNENameTable* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmNENameTable* isSgAsmNENameTable ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmNENameTable>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmNENameTable, SgStringList,&SgAsmNENameTable::p_names>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmNENameTable, SgUnsignedList,&SgAsmNENameTable::p_ordinals>;
...
// postdeclarations for SgAsmNENameTable

/* #line 532 "/workspace/generated/src/frontend/SageIII//SgAsmNENameTable.h" */
...
/* #line 539 "/workspace/generated/src/frontend/SageIII//SgAsmNENameTable.h" */

#endif // ROSE_SgAsmNENameTable_H
