...
#ifndef ROSE_SgAsmNERelocEntry_H
#define ROSE_SgAsmNERelocEntry_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmNERelocEntry

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmNERelocEntry.h" */
/* #line 6072 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// Class Definition for SgAsmNERelocEntry
class ROSE_DLL_API SgAsmNERelocEntry  : public SgAsmExecutableFileFormat
   {
     public:


/* #line 42 "/workspace/generated/src/frontend/SageIII//SgAsmNERelocEntry.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 6135 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmNERelocEntry;
          enum { static_variant = V_SgAsmNERelocEntry };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmNERelocEntry* isSgAsmNERelocEntry(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmNERelocEntry* isSgAsmNERelocEntry( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmNERelocEntry * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmNERelocEntryStorageClass *); // 
          ...
          /// \private
          static SgAsmNERelocEntry * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmNERelocEntry * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmNERelocEntry::operator delete (pointer,sizeof(SgAsmNERelocEntry));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmNERelocEntry* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmNERelocEntry* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmNERelocEntry* sgnode);
     ...
     public:
       ...
       */
       // SgAsmNERelocEntry( SgAsmNERelocEntryStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmNERelocEntryStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmNERelocEntry( const SgAsmNERelocEntryStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmNERelocEntry* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmNERelocEntry* isSgAsmNERelocEntry ( SgNode* s );
...
// End of memberFunctionString
    ...
    protected:
// Start of memberFunctionString
SgAsmNERelocEntry::NERelocSrcType p_src_type;
          
// End of memberFunctionString
// Start of memberFunctionString
SgAsmNERelocEntry::NERelocModifiers p_modifier;
          
// End of memberFunctionString
// Start of memberFunctionString
SgAsmNERelocEntry::NERelocTgtType p_tgt_type;
          
// End of memberFunctionString
// Start of memberFunctionString
SgAsmNERelocEntry::NERelocFlags p_flags;
          
// End of memberFunctionString
// Start of memberFunctionString
Rose::BinaryAnalysis::Address p_src_offset;
          
// End of memberFunctionString
// Start of memberFunctionString
SgAsmNERelocEntry::iref_type p_iref;
          
// End of memberFunctionString
// Start of memberFunctionString
SgAsmNERelocEntry::iord_type p_iord;
          
// End of memberFunctionString
// Start of memberFunctionString
SgAsmNERelocEntry::iname_type p_iname;
          
// End of memberFunctionString
// Start of memberFunctionString
SgAsmNERelocEntry::osfixup_type p_osfixup;
          
// End of memberFunctionString

    friend struct Rose::Traits::generated::describe_node_t<SgAsmNERelocEntry>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmNERelocEntry, SgAsmNERelocEntry::NERelocSrcType,&SgAsmNERelocEntry::p_src_type>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmNERelocEntry, SgAsmNERelocEntry::NERelocModifiers,&SgAsmNERelocEntry::p_modifier>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmNERelocEntry, SgAsmNERelocEntry::NERelocTgtType,&SgAsmNERelocEntry::p_tgt_type>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmNERelocEntry, SgAsmNERelocEntry::NERelocFlags,&SgAsmNERelocEntry::p_flags>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmNERelocEntry, Rose::BinaryAnalysis::Address,&SgAsmNERelocEntry::p_src_offset>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmNERelocEntry, SgAsmNERelocEntry::iref_type,&SgAsmNERelocEntry::p_iref>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmNERelocEntry, SgAsmNERelocEntry::iord_type,&SgAsmNERelocEntry::p_iord>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmNERelocEntry, SgAsmNERelocEntry::iname_type,&SgAsmNERelocEntry::p_iname>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmNERelocEntry, SgAsmNERelocEntry::osfixup_type,&SgAsmNERelocEntry::p_osfixup>;
...
// postdeclarations for SgAsmNERelocEntry

/* #line 728 "/workspace/generated/src/frontend/SageIII//SgAsmNERelocEntry.h" */
...
/* #line 735 "/workspace/generated/src/frontend/SageIII//SgAsmNERelocEntry.h" */

#endif // ROSE_SgAsmNERelocEntry_H
