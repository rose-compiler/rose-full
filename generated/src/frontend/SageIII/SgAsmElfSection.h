...
#ifndef ROSE_SgAsmElfSection_H
#define ROSE_SgAsmElfSection_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmElfSection

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmElfSection.h" */
/* #line 23645 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// Class Definition for SgAsmElfSection
class ROSE_DLL_API SgAsmElfSection  : public SgAsmGenericSection
   {
     public:


/* #line 47 "/workspace/generated/src/frontend/SageIII//SgAsmElfSection.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 23678 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmElfSection;
          enum { static_variant = V_SgAsmElfSection };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmElfSection* isSgAsmElfSection(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmElfSection* isSgAsmElfSection( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmElfSection * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmElfSectionStorageClass *); // 
          ...
          /// \private
          static SgAsmElfSection * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmElfSection * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmElfSection::operator delete (pointer,sizeof(SgAsmElfSection));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmElfSection* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmElfSection* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmElfSection* sgnode);
     ...
     public:
       ...
       */
       // SgAsmElfSection( SgAsmElfSectionStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmElfSectionStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmElfSection( const SgAsmElfSectionStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmElfSection* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmElfSection* isSgAsmElfSection ( SgNode* s );
...
// End of memberFunctionString
    ...
    protected:
// Start of memberFunctionString
SgAsmElfSection* p_linkedSection;
          
// End of memberFunctionString
// Start of memberFunctionString
SgAsmElfSectionTableEntry* p_sectionEntry;
          
// End of memberFunctionString
// Start of memberFunctionString
SgAsmElfSegmentTableEntry* p_segmentEntry;
          
// End of memberFunctionString

    friend struct Rose::Traits::generated::describe_node_t<SgAsmElfSection>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmElfSection, SgAsmElfSection*,&SgAsmElfSection::p_linkedSection>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmElfSection, SgAsmElfSectionTableEntry*,&SgAsmElfSection::p_sectionEntry>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmElfSection, SgAsmElfSegmentTableEntry*,&SgAsmElfSection::p_segmentEntry>;
...
// postdeclarations for SgAsmElfSection

/* #line 648 "/workspace/generated/src/frontend/SageIII//SgAsmElfSection.h" */
...
/* #line 655 "/workspace/generated/src/frontend/SageIII//SgAsmElfSection.h" */

#endif // ROSE_SgAsmElfSection_H
