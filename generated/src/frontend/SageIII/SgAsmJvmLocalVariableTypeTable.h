...
#ifndef ROSE_SgAsmJvmLocalVariableTypeTable_H
#define ROSE_SgAsmJvmLocalVariableTypeTable_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmJvmLocalVariableTypeTable

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmJvmLocalVariableTypeTable.h" */
/* #line 11472 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// Class Definition for SgAsmJvmLocalVariableTypeTable
class ROSE_DLL_API SgAsmJvmLocalVariableTypeTable  : public SgAsmJvmAttribute
   {
     public:


/* #line 42 "/workspace/generated/src/frontend/SageIII//SgAsmJvmLocalVariableTypeTable.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 11492 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmJvmLocalVariableTypeTable;
          enum { static_variant = V_SgAsmJvmLocalVariableTypeTable };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmJvmLocalVariableTypeTable* isSgAsmJvmLocalVariableTypeTable(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmJvmLocalVariableTypeTable* isSgAsmJvmLocalVariableTypeTable( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmJvmLocalVariableTypeTable * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmJvmLocalVariableTypeTableStorageClass *); // 
          ...
          /// \private
          static SgAsmJvmLocalVariableTypeTable * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmJvmLocalVariableTypeTable * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmJvmLocalVariableTypeTable::operator delete (pointer,sizeof(SgAsmJvmLocalVariableTypeTable));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmJvmLocalVariableTypeTable* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmJvmLocalVariableTypeTable* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmJvmLocalVariableTypeTable* sgnode);
     ...
     public:
       ...
       */
       // SgAsmJvmLocalVariableTypeTable( SgAsmJvmLocalVariableTypeTableStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmJvmLocalVariableTypeTableStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmJvmLocalVariableTypeTable( const SgAsmJvmLocalVariableTypeTableStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmJvmLocalVariableTypeTable* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmJvmLocalVariableTypeTable* isSgAsmJvmLocalVariableTypeTable ( SgNode* s );
...
// End of memberFunctionString
    ...
    protected:
// Start of memberFunctionString
SgAsmJvmLocalVariableTypeEntryPtrList p_local_variable_type_table;
          
// End of memberFunctionString

    friend struct Rose::Traits::generated::describe_node_t<SgAsmJvmLocalVariableTypeTable>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmJvmLocalVariableTypeTable, SgAsmJvmLocalVariableTypeEntryPtrList,&SgAsmJvmLocalVariableTypeTable::p_local_variable_type_table>;
...
// postdeclarations for SgAsmJvmLocalVariableTypeTable

/* #line 531 "/workspace/generated/src/frontend/SageIII//SgAsmJvmLocalVariableTypeTable.h" */
...
/* #line 538 "/workspace/generated/src/frontend/SageIII//SgAsmJvmLocalVariableTypeTable.h" */

#endif // ROSE_SgAsmJvmLocalVariableTypeTable_H
