...
#ifndef ROSE_SgAsmCilManifestResource_H
#define ROSE_SgAsmCilManifestResource_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmCilManifestResource

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmCilManifestResource.h" */
...
// Class Definition for SgAsmCilManifestResource
class ROSE_DLL_API SgAsmCilManifestResource  : public SgAsmCilMetadata
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmCilManifestResource.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 37213 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmCilManifestResource;
          enum { static_variant = V_SgAsmCilManifestResource };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmCilManifestResource* isSgAsmCilManifestResource(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmCilManifestResource* isSgAsmCilManifestResource( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmCilManifestResource * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmCilManifestResourceStorageClass *); // 
          ...
          /// \private
          static SgAsmCilManifestResource * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmCilManifestResource * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmCilManifestResource::operator delete (pointer,sizeof(SgAsmCilManifestResource));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmCilManifestResource* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmCilManifestResource* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmCilManifestResource* sgnode);
     ...
     public:
       ...
       */
       // SgAsmCilManifestResource( SgAsmCilManifestResourceStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmCilManifestResourceStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmCilManifestResource( const SgAsmCilManifestResourceStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmCilManifestResource* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmCilManifestResource* isSgAsmCilManifestResource ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmCilManifestResource>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilManifestResource, uint32_t,&SgAsmCilManifestResource::p_Offset>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilManifestResource, uint32_t,&SgAsmCilManifestResource::p_Flags>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilManifestResource, uint32_t,&SgAsmCilManifestResource::p_Name>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilManifestResource, uint32_t,&SgAsmCilManifestResource::p_Implementation>;
...
// postdeclarations for SgAsmCilManifestResource

/* #line 570 "/workspace/generated/src/frontend/SageIII//SgAsmCilManifestResource.h" */
...
/* #line 577 "/workspace/generated/src/frontend/SageIII//SgAsmCilManifestResource.h" */

#endif // ROSE_SgAsmCilManifestResource_H
