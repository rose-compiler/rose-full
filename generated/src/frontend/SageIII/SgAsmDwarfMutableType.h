...
#ifndef ROSE_SgAsmDwarfMutableType_H
#define ROSE_SgAsmDwarfMutableType_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmDwarfMutableType

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfMutableType.h" */
...
// Class Definition for SgAsmDwarfMutableType
class ROSE_DLL_API SgAsmDwarfMutableType  : public SgAsmDwarfConstruct
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfMutableType.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 26296 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmDwarfMutableType;
          enum { static_variant = V_SgAsmDwarfMutableType };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmDwarfMutableType* isSgAsmDwarfMutableType(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmDwarfMutableType* isSgAsmDwarfMutableType( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmDwarfMutableType * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmDwarfMutableTypeStorageClass *); // 
          ...
          /// \private
          static SgAsmDwarfMutableType * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmDwarfMutableType * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmDwarfMutableType::operator delete (pointer,sizeof(SgAsmDwarfMutableType));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmDwarfMutableType* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmDwarfMutableType* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmDwarfMutableType* sgnode);
     ...
     public:
       ...
       */
       // SgAsmDwarfMutableType( SgAsmDwarfMutableTypeStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmDwarfMutableTypeStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmDwarfMutableType( const SgAsmDwarfMutableTypeStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmDwarfMutableType* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmDwarfMutableType* isSgAsmDwarfMutableType ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmDwarfMutableType>;
...
// postdeclarations for SgAsmDwarfMutableType

/* #line 502 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfMutableType.h" */
...
/* #line 509 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfMutableType.h" */

#endif // ROSE_SgAsmDwarfMutableType_H
