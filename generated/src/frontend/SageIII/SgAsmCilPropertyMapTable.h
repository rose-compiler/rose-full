...
#ifndef ROSE_SgAsmCilPropertyMapTable_H
#define ROSE_SgAsmCilPropertyMapTable_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmCilPropertyMapTable

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmCilPropertyMapTable.h" */
...
// Class Definition for SgAsmCilPropertyMapTable
class ROSE_DLL_API SgAsmCilPropertyMapTable  : public SgAsmCilMetadata
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmCilPropertyMapTable.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 33772 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmCilPropertyMapTable;
          enum { static_variant = V_SgAsmCilPropertyMapTable };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmCilPropertyMapTable* isSgAsmCilPropertyMapTable(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmCilPropertyMapTable* isSgAsmCilPropertyMapTable( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmCilPropertyMapTable * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmCilPropertyMapTableStorageClass *); // 
          ...
          /// \private
          static SgAsmCilPropertyMapTable * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmCilPropertyMapTable * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmCilPropertyMapTable::operator delete (pointer,sizeof(SgAsmCilPropertyMapTable));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmCilPropertyMapTable* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmCilPropertyMapTable* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmCilPropertyMapTable* sgnode);
     ...
     public:
       ...
       */
       // SgAsmCilPropertyMapTable( SgAsmCilPropertyMapTableStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmCilPropertyMapTableStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmCilPropertyMapTable( const SgAsmCilPropertyMapTableStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmCilPropertyMapTable* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmCilPropertyMapTable* isSgAsmCilPropertyMapTable ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmCilPropertyMapTable>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilPropertyMapTable, std::vector<SgAsmCilPropertyMap*>,&SgAsmCilPropertyMapTable::p_elements>;
...
// postdeclarations for SgAsmCilPropertyMapTable

/* #line 508 "/workspace/generated/src/frontend/SageIII//SgAsmCilPropertyMapTable.h" */
...
/* #line 515 "/workspace/generated/src/frontend/SageIII//SgAsmCilPropertyMapTable.h" */

#endif // ROSE_SgAsmCilPropertyMapTable_H
