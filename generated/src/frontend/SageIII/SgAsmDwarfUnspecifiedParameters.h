...
#ifndef ROSE_SgAsmDwarfUnspecifiedParameters_H
#define ROSE_SgAsmDwarfUnspecifiedParameters_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmDwarfUnspecifiedParameters

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfUnspecifiedParameters.h" */
...
// Class Definition for SgAsmDwarfUnspecifiedParameters
class ROSE_DLL_API SgAsmDwarfUnspecifiedParameters  : public SgAsmDwarfConstruct
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfUnspecifiedParameters.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 24752 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmDwarfUnspecifiedParameters;
          enum { static_variant = V_SgAsmDwarfUnspecifiedParameters };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmDwarfUnspecifiedParameters* isSgAsmDwarfUnspecifiedParameters(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmDwarfUnspecifiedParameters* isSgAsmDwarfUnspecifiedParameters( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmDwarfUnspecifiedParameters * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmDwarfUnspecifiedParametersStorageClass *); // 
          ...
          /// \private
          static SgAsmDwarfUnspecifiedParameters * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmDwarfUnspecifiedParameters * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmDwarfUnspecifiedParameters::operator delete (pointer,sizeof(SgAsmDwarfUnspecifiedParameters));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmDwarfUnspecifiedParameters* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmDwarfUnspecifiedParameters* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmDwarfUnspecifiedParameters* sgnode);
     ...
     public:
       ...
       */
       // SgAsmDwarfUnspecifiedParameters( SgAsmDwarfUnspecifiedParametersStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmDwarfUnspecifiedParametersStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmDwarfUnspecifiedParameters( const SgAsmDwarfUnspecifiedParametersStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmDwarfUnspecifiedParameters* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmDwarfUnspecifiedParameters* isSgAsmDwarfUnspecifiedParameters ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmDwarfUnspecifiedParameters>;
...
// postdeclarations for SgAsmDwarfUnspecifiedParameters

/* #line 502 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfUnspecifiedParameters.h" */
...
/* #line 509 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfUnspecifiedParameters.h" */

#endif // ROSE_SgAsmDwarfUnspecifiedParameters_H
