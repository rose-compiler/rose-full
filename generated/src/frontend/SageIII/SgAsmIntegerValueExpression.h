...
#ifndef ROSE_SgAsmIntegerValueExpression_H
#define ROSE_SgAsmIntegerValueExpression_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmIntegerValueExpression

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmIntegerValueExpression.h" */
...
// Class Definition for SgAsmIntegerValueExpression
class ROSE_DLL_API SgAsmIntegerValueExpression  : public SgAsmConstantExpression
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmIntegerValueExpression.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 15200 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmIntegerValueExpression;
      ...
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmIntegerValueExpression* isSgAsmIntegerValueExpression(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmIntegerValueExpression* isSgAsmIntegerValueExpression( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmIntegerValueExpression * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmIntegerValueExpressionStorageClass *); // 
          ...
          /// \private
          static SgAsmIntegerValueExpression * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmIntegerValueExpression * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmIntegerValueExpression::operator delete (pointer,sizeof(SgAsmIntegerValueExpression));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmIntegerValueExpression* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmIntegerValueExpression* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmIntegerValueExpression* sgnode);
     ...
     public:
       ...
       */
       // SgAsmIntegerValueExpression( SgAsmIntegerValueExpressionStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmIntegerValueExpressionStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmIntegerValueExpression( const SgAsmIntegerValueExpressionStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmIntegerValueExpression* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmIntegerValueExpression* isSgAsmIntegerValueExpression ( SgNode* s );

          typedef SgAsmConstantExpression base_node_type;
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmIntegerValueExpression>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmIntegerValueExpression, SgNode*,&SgAsmIntegerValueExpression::p_baseNode>;
...
// postdeclarations for SgAsmIntegerValueExpression

/* #line 598 "/workspace/generated/src/frontend/SageIII//SgAsmIntegerValueExpression.h" */
...
/* #line 605 "/workspace/generated/src/frontend/SageIII//SgAsmIntegerValueExpression.h" */

#endif // ROSE_SgAsmIntegerValueExpression_H
