...
#ifndef ROSE_SgAsmDwarfSubprogram_H
#define ROSE_SgAsmDwarfSubprogram_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmDwarfSubprogram

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfSubprogram.h" */
/* #line 25376 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// Class Definition for SgAsmDwarfSubprogram
class ROSE_DLL_API SgAsmDwarfSubprogram  : public SgAsmDwarfConstruct
   {
     public:


/* #line 44 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfSubprogram.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 25411 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
private:
    ...
    void serialize(S &s, const unsigned /*version*/) {
        ...
        s & BOOST_SERIALIZATION_NVP(p_linkage_name);
        s & BOOST_SERIALIZATION_NVP(p_is_main_subprogram);
        s & BOOST_SERIALIZATION_NVP(p_is_const_expr);
...
public:
    std::string const& get_linkage_name() const;
    void set_linkage_name(std::string const&);
 // DQ (11/21/2025): Added support for Dwarf 4.
public:
    bool const& get_is_main_subprogram() const;
    void set_is_main_subprogram(bool const&);
 // DQ (11/21/2025): Added support for Dwarf 4.
public:
    bool const& get_is_const_expr() const;
    void set_is_const_expr(bool const&);
public:
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmDwarfSubprogram;
          enum { static_variant = V_SgAsmDwarfSubprogram };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmDwarfSubprogram* isSgAsmDwarfSubprogram(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmDwarfSubprogram* isSgAsmDwarfSubprogram( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmDwarfSubprogram * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmDwarfSubprogramStorageClass *); // 
          ...
          /// \private
          static SgAsmDwarfSubprogram * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmDwarfSubprogram * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmDwarfSubprogram::operator delete (pointer,sizeof(SgAsmDwarfSubprogram));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmDwarfSubprogram* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmDwarfSubprogram* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmDwarfSubprogram* sgnode);
     ...
     public:
       ...
       */
       // SgAsmDwarfSubprogram( SgAsmDwarfSubprogramStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmDwarfSubprogramStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmDwarfSubprogram( const SgAsmDwarfSubprogramStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmDwarfSubprogram* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmDwarfSubprogram* isSgAsmDwarfSubprogram ( SgNode* s );
...
// End of memberFunctionString
    ...
    protected:
// Start of memberFunctionString
SgAsmDwarfConstructList* p_body;
          
// End of memberFunctionString
// Start of memberFunctionString
std::string p_linkage_name;
          
// End of memberFunctionString
// Start of memberFunctionString
bool p_is_main_subprogram;
          
// End of memberFunctionString
// Start of memberFunctionString
bool p_is_const_expr;
          
// End of memberFunctionString

    friend struct Rose::Traits::generated::describe_node_t<SgAsmDwarfSubprogram>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmDwarfSubprogram, SgAsmDwarfConstructList*,&SgAsmDwarfSubprogram::p_body>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmDwarfSubprogram, std::string,&SgAsmDwarfSubprogram::p_linkage_name>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmDwarfSubprogram, bool,&SgAsmDwarfSubprogram::p_is_main_subprogram>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmDwarfSubprogram, bool,&SgAsmDwarfSubprogram::p_is_const_expr>;
...
// postdeclarations for SgAsmDwarfSubprogram

/* #line 553 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfSubprogram.h" */
...
/* #line 560 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfSubprogram.h" */

#endif // ROSE_SgAsmDwarfSubprogram_H
