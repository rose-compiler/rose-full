...
#ifndef ROSE_SgAsmCilProperty_H
#define ROSE_SgAsmCilProperty_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmCilProperty

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmCilProperty.h" */
...
// Class Definition for SgAsmCilProperty
class ROSE_DLL_API SgAsmCilProperty  : public SgAsmCilMetadata
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmCilProperty.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 33944 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmCilProperty;
          enum { static_variant = V_SgAsmCilProperty };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmCilProperty* isSgAsmCilProperty(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmCilProperty* isSgAsmCilProperty( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmCilProperty * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmCilPropertyStorageClass *); // 
          ...
          /// \private
          static SgAsmCilProperty * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmCilProperty * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmCilProperty::operator delete (pointer,sizeof(SgAsmCilProperty));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmCilProperty* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmCilProperty* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmCilProperty* sgnode);
     ...
     public:
       ...
       */
       // SgAsmCilProperty( SgAsmCilPropertyStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmCilPropertyStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmCilProperty( const SgAsmCilPropertyStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmCilProperty* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmCilProperty* isSgAsmCilProperty ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmCilProperty>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilProperty, uint16_t,&SgAsmCilProperty::p_Flags>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilProperty, uint32_t,&SgAsmCilProperty::p_Name>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilProperty, uint32_t,&SgAsmCilProperty::p_Type>;
...
// postdeclarations for SgAsmCilProperty

/* #line 553 "/workspace/generated/src/frontend/SageIII//SgAsmCilProperty.h" */
...
/* #line 560 "/workspace/generated/src/frontend/SageIII//SgAsmCilProperty.h" */

#endif // ROSE_SgAsmCilProperty_H
