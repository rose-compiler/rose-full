...
#ifndef ROSE_SgAsmAarch32Coprocessor_H
#define ROSE_SgAsmAarch32Coprocessor_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmAarch32Coprocessor

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmAarch32Coprocessor.h" */
...
// Class Definition for SgAsmAarch32Coprocessor
class ROSE_DLL_API SgAsmAarch32Coprocessor  : public SgAsmExpression
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmAarch32Coprocessor.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 45537 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmAarch32Coprocessor;
          enum { static_variant = V_SgAsmAarch32Coprocessor };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmAarch32Coprocessor* isSgAsmAarch32Coprocessor(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmAarch32Coprocessor* isSgAsmAarch32Coprocessor( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmAarch32Coprocessor * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmAarch32CoprocessorStorageClass *); // 
          ...
          /// \private
          static SgAsmAarch32Coprocessor * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmAarch32Coprocessor * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmAarch32Coprocessor::operator delete (pointer,sizeof(SgAsmAarch32Coprocessor));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmAarch32Coprocessor* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmAarch32Coprocessor* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmAarch32Coprocessor* sgnode);
     ...
     public:
       ...
       */
       // SgAsmAarch32Coprocessor( SgAsmAarch32CoprocessorStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmAarch32CoprocessorStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmAarch32Coprocessor( const SgAsmAarch32CoprocessorStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmAarch32Coprocessor* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmAarch32Coprocessor* isSgAsmAarch32Coprocessor ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmAarch32Coprocessor>;
...
// postdeclarations for SgAsmAarch32Coprocessor

/* #line 512 "/workspace/generated/src/frontend/SageIII//SgAsmAarch32Coprocessor.h" */
...
/* #line 519 "/workspace/generated/src/frontend/SageIII//SgAsmAarch32Coprocessor.h" */

#endif // ROSE_SgAsmAarch32Coprocessor_H
