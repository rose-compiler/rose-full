...
#ifndef ROSE_SgAsmElfStrtab_H
#define ROSE_SgAsmElfStrtab_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmElfStrtab

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmElfStrtab.h" */
/* #line 20211 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// Class Definition for SgAsmElfStrtab
class ROSE_DLL_API SgAsmElfStrtab  : public SgAsmGenericStrtab
   {
     public:


/* #line 42 "/workspace/generated/src/frontend/SageIII//SgAsmElfStrtab.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 20221 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmElfStrtab;
          enum { static_variant = V_SgAsmElfStrtab };
     ...
     public:
          ...
          /// \private
          static SgAsmElfStrtab * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmElfStrtabStorageClass *); // 
          ...
          /// \private
          static SgAsmElfStrtab * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmElfStrtab * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmElfStrtab::operator delete (pointer,sizeof(SgAsmElfStrtab));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmElfStrtab* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmElfStrtab* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmElfStrtab* sgnode);
     ...
     public:
       ...
       */
       // SgAsmElfStrtab( SgAsmElfStrtabStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmElfStrtabStorageClass;
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmElfStrtab* isSgAsmElfStrtab ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmElfStrtab>;
...
// postdeclarations for SgAsmElfStrtab

/* #line 556 "/workspace/generated/src/frontend/SageIII//SgAsmElfStrtab.h" */
...
/* #line 563 "/workspace/generated/src/frontend/SageIII//SgAsmElfStrtab.h" */

#endif // ROSE_SgAsmElfStrtab_H
