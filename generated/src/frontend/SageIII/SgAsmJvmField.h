...
#ifndef ROSE_SgAsmJvmField_H
#define ROSE_SgAsmJvmField_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmJvmField

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmJvmField.h" */
/* #line 12967 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// Class Definition for SgAsmJvmField
class ROSE_DLL_API SgAsmJvmField  : public SgAsmJvmNode
   {
     public:


/* #line 44 "/workspace/generated/src/frontend/SageIII//SgAsmJvmField.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 13005 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmJvmField;
          enum { static_variant = V_SgAsmJvmField };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmJvmField* isSgAsmJvmField(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmJvmField* isSgAsmJvmField( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmJvmField * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmJvmFieldStorageClass *); // 
          ...
          /// \private
          static SgAsmJvmField * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmJvmField * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmJvmField::operator delete (pointer,sizeof(SgAsmJvmField));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmJvmField* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmJvmField* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmJvmField* sgnode);
     ...
     public:
       ...
       */
       // SgAsmJvmField( SgAsmJvmFieldStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmJvmFieldStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmJvmField( const SgAsmJvmFieldStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmJvmField* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmJvmField* isSgAsmJvmField ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmJvmField>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmJvmField, uint16_t,&SgAsmJvmField::p_access_flags>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmJvmField, uint16_t,&SgAsmJvmField::p_name_index>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmJvmField, uint16_t,&SgAsmJvmField::p_descriptor_index>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmJvmField, SgAsmJvmAttributeTable*,&SgAsmJvmField::p_attribute_table>;
...
// postdeclarations for SgAsmJvmField

/* #line 582 "/workspace/generated/src/frontend/SageIII//SgAsmJvmField.h" */
...
/* #line 589 "/workspace/generated/src/frontend/SageIII//SgAsmJvmField.h" */

#endif // ROSE_SgAsmJvmField_H
