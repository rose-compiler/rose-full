...
#ifndef ROSE_SgAsmElfSymverEntryList_H
#define ROSE_SgAsmElfSymverEntryList_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmElfSymverEntryList

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmElfSymverEntryList.h" */
/* #line 18919 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// Class Definition for SgAsmElfSymverEntryList
class ROSE_DLL_API SgAsmElfSymverEntryList  : public SgAsmExecutableFileFormat
   {
     public:


/* #line 42 "/workspace/generated/src/frontend/SageIII//SgAsmElfSymverEntryList.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 18938 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmElfSymverEntryList;
          enum { static_variant = V_SgAsmElfSymverEntryList };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmElfSymverEntryList* isSgAsmElfSymverEntryList(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmElfSymverEntryList* isSgAsmElfSymverEntryList( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmElfSymverEntryList * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmElfSymverEntryListStorageClass *); // 
          ...
          /// \private
          static SgAsmElfSymverEntryList * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmElfSymverEntryList * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmElfSymverEntryList::operator delete (pointer,sizeof(SgAsmElfSymverEntryList));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmElfSymverEntryList* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmElfSymverEntryList* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmElfSymverEntryList* sgnode);
     ...
     public:
       ...
       */
       // SgAsmElfSymverEntryList( SgAsmElfSymverEntryListStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmElfSymverEntryListStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmElfSymverEntryList( const SgAsmElfSymverEntryListStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmElfSymverEntryList* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmElfSymverEntryList* isSgAsmElfSymverEntryList ( SgNode* s );
...
// End of memberFunctionString
    ...
    protected:
// Start of memberFunctionString
SgAsmElfSymverEntryPtrList p_entries;
          
// End of memberFunctionString

    friend struct Rose::Traits::generated::describe_node_t<SgAsmElfSymverEntryList>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmElfSymverEntryList, SgAsmElfSymverEntryPtrList,&SgAsmElfSymverEntryList::p_entries>;
...
// postdeclarations for SgAsmElfSymverEntryList

/* #line 516 "/workspace/generated/src/frontend/SageIII//SgAsmElfSymverEntryList.h" */
...
/* #line 523 "/workspace/generated/src/frontend/SageIII//SgAsmElfSymverEntryList.h" */

#endif // ROSE_SgAsmElfSymverEntryList_H
