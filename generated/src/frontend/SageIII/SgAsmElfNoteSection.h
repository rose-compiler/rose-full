...
#ifndef ROSE_SgAsmElfNoteSection_H
#define ROSE_SgAsmElfNoteSection_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmElfNoteSection

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmElfNoteSection.h" */
/* #line 21978 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// Class Definition for SgAsmElfNoteSection
class ROSE_DLL_API SgAsmElfNoteSection  : public SgAsmElfSection
   {
     public:


/* #line 44 "/workspace/generated/src/frontend/SageIII//SgAsmElfNoteSection.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 21995 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmElfNoteSection;
          enum { static_variant = V_SgAsmElfNoteSection };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmElfNoteSection* isSgAsmElfNoteSection(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmElfNoteSection* isSgAsmElfNoteSection( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmElfNoteSection * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmElfNoteSectionStorageClass *); // 
          ...
          /// \private
          static SgAsmElfNoteSection * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmElfNoteSection * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmElfNoteSection::operator delete (pointer,sizeof(SgAsmElfNoteSection));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmElfNoteSection* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmElfNoteSection* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmElfNoteSection* sgnode);
     ...
     public:
       ...
       */
       // SgAsmElfNoteSection( SgAsmElfNoteSectionStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmElfNoteSectionStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmElfNoteSection( const SgAsmElfNoteSectionStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmElfNoteSection* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmElfNoteSection* isSgAsmElfNoteSection ( SgNode* s );
...
// End of memberFunctionString
    ...
    protected:
// Start of memberFunctionString
SgAsmElfNoteEntryList* p_entries;
          
// End of memberFunctionString

    friend struct Rose::Traits::generated::describe_node_t<SgAsmElfNoteSection>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmElfNoteSection, SgAsmElfNoteEntryList*,&SgAsmElfNoteSection::p_entries>;
...
// postdeclarations for SgAsmElfNoteSection

/* #line 532 "/workspace/generated/src/frontend/SageIII//SgAsmElfNoteSection.h" */
...
/* #line 539 "/workspace/generated/src/frontend/SageIII//SgAsmElfNoteSection.h" */

#endif // ROSE_SgAsmElfNoteSection_H
