...
#ifndef ROSE_SgAsmJvmEnclosingMethod_H
#define ROSE_SgAsmJvmEnclosingMethod_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmJvmEnclosingMethod

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmJvmEnclosingMethod.h" */
...
// Class Definition for SgAsmJvmEnclosingMethod
class ROSE_DLL_API SgAsmJvmEnclosingMethod  : public SgAsmJvmAttribute
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmJvmEnclosingMethod.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 13366 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmJvmEnclosingMethod;
          enum { static_variant = V_SgAsmJvmEnclosingMethod };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmJvmEnclosingMethod* isSgAsmJvmEnclosingMethod(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmJvmEnclosingMethod* isSgAsmJvmEnclosingMethod( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmJvmEnclosingMethod * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmJvmEnclosingMethodStorageClass *); // 
          ...
          /// \private
          static SgAsmJvmEnclosingMethod * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmJvmEnclosingMethod * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmJvmEnclosingMethod::operator delete (pointer,sizeof(SgAsmJvmEnclosingMethod));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmJvmEnclosingMethod* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmJvmEnclosingMethod* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmJvmEnclosingMethod* sgnode);
     ...
     public:
       ...
       */
       // SgAsmJvmEnclosingMethod( SgAsmJvmEnclosingMethodStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmJvmEnclosingMethodStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmJvmEnclosingMethod( const SgAsmJvmEnclosingMethodStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmJvmEnclosingMethod* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmJvmEnclosingMethod* isSgAsmJvmEnclosingMethod ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmJvmEnclosingMethod>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmJvmEnclosingMethod, uint16_t,&SgAsmJvmEnclosingMethod::p_class_index>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmJvmEnclosingMethod, uint16_t,&SgAsmJvmEnclosingMethod::p_method_index>;
...
// postdeclarations for SgAsmJvmEnclosingMethod

/* #line 544 "/workspace/generated/src/frontend/SageIII//SgAsmJvmEnclosingMethod.h" */
...
/* #line 551 "/workspace/generated/src/frontend/SageIII//SgAsmJvmEnclosingMethod.h" */

#endif // ROSE_SgAsmJvmEnclosingMethod_H
