...
#ifndef ROSE_SgAsmCilModuleTable_H
#define ROSE_SgAsmCilModuleTable_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmCilModuleTable

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmCilModuleTable.h" */
...
// Class Definition for SgAsmCilModuleTable
class ROSE_DLL_API SgAsmCilModuleTable  : public SgAsmCilMetadata
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmCilModuleTable.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 34379 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmCilModuleTable;
          enum { static_variant = V_SgAsmCilModuleTable };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmCilModuleTable* isSgAsmCilModuleTable(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmCilModuleTable* isSgAsmCilModuleTable( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmCilModuleTable * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmCilModuleTableStorageClass *); // 
          ...
          /// \private
          static SgAsmCilModuleTable * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmCilModuleTable * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmCilModuleTable::operator delete (pointer,sizeof(SgAsmCilModuleTable));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmCilModuleTable* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmCilModuleTable* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmCilModuleTable* sgnode);
     ...
     public:
       ...
       */
       // SgAsmCilModuleTable( SgAsmCilModuleTableStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmCilModuleTableStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmCilModuleTable( const SgAsmCilModuleTableStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmCilModuleTable* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmCilModuleTable* isSgAsmCilModuleTable ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmCilModuleTable>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilModuleTable, std::vector<SgAsmCilModule*>,&SgAsmCilModuleTable::p_elements>;
...
// postdeclarations for SgAsmCilModuleTable

/* #line 508 "/workspace/generated/src/frontend/SageIII//SgAsmCilModuleTable.h" */
...
/* #line 515 "/workspace/generated/src/frontend/SageIII//SgAsmCilModuleTable.h" */

#endif // ROSE_SgAsmCilModuleTable_H
