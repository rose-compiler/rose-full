...
#ifndef ROSE_SgAsmGenericHeaderList_H
#define ROSE_SgAsmGenericHeaderList_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmGenericHeaderList

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmGenericHeaderList.h" */
/* #line 15814 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// Class Definition for SgAsmGenericHeaderList
class ROSE_DLL_API SgAsmGenericHeaderList  : public SgAsmExecutableFileFormat
   {
     public:


/* #line 42 "/workspace/generated/src/frontend/SageIII//SgAsmGenericHeaderList.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 15833 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmGenericHeaderList;
          enum { static_variant = V_SgAsmGenericHeaderList };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmGenericHeaderList* isSgAsmGenericHeaderList(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmGenericHeaderList* isSgAsmGenericHeaderList( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmGenericHeaderList * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmGenericHeaderListStorageClass *); // 
          ...
          /// \private
          static SgAsmGenericHeaderList * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmGenericHeaderList * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmGenericHeaderList::operator delete (pointer,sizeof(SgAsmGenericHeaderList));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmGenericHeaderList* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmGenericHeaderList* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmGenericHeaderList* sgnode);
     ...
     public:
       ...
       */
       // SgAsmGenericHeaderList( SgAsmGenericHeaderListStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmGenericHeaderListStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmGenericHeaderList( const SgAsmGenericHeaderListStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmGenericHeaderList* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmGenericHeaderList* isSgAsmGenericHeaderList ( SgNode* s );
...
// End of memberFunctionString
    ...
    protected:
// Start of memberFunctionString
SgAsmGenericHeaderPtrList p_headers;
          
// End of memberFunctionString

    friend struct Rose::Traits::generated::describe_node_t<SgAsmGenericHeaderList>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmGenericHeaderList, SgAsmGenericHeaderPtrList,&SgAsmGenericHeaderList::p_headers>;
...
// postdeclarations for SgAsmGenericHeaderList

/* #line 516 "/workspace/generated/src/frontend/SageIII//SgAsmGenericHeaderList.h" */
...
/* #line 523 "/workspace/generated/src/frontend/SageIII//SgAsmGenericHeaderList.h" */

#endif // ROSE_SgAsmGenericHeaderList_H
