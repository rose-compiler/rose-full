...
#ifndef ROSE_SgAsmPointerType_H
#define ROSE_SgAsmPointerType_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmPointerType

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmPointerType.h" */
...
// Class Definition for SgAsmPointerType
class ROSE_DLL_API SgAsmPointerType  : public SgAsmScalarType
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmPointerType.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 1990 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmPointerType;
          enum { static_variant = V_SgAsmPointerType };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmPointerType* isSgAsmPointerType(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmPointerType* isSgAsmPointerType( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmPointerType * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmPointerTypeStorageClass *); // 
          ...
          /// \private
          static SgAsmPointerType * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmPointerType * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmPointerType::operator delete (pointer,sizeof(SgAsmPointerType));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmPointerType* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmPointerType* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmPointerType* sgnode);
     ...
     public:
       ...
       */
       // SgAsmPointerType( SgAsmPointerTypeStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmPointerTypeStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmPointerType( const SgAsmPointerTypeStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmPointerType* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmPointerType* isSgAsmPointerType ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmPointerType>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmPointerType, SgAsmType *,&SgAsmPointerType::p_subtype>;
...
// postdeclarations for SgAsmPointerType

/* #line 515 "/workspace/generated/src/frontend/SageIII//SgAsmPointerType.h" */
...
/* #line 522 "/workspace/generated/src/frontend/SageIII//SgAsmPointerType.h" */

#endif // ROSE_SgAsmPointerType_H
