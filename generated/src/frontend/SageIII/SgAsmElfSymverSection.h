...
#ifndef ROSE_SgAsmElfSymverSection_H
#define ROSE_SgAsmElfSymverSection_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmElfSymverSection

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmElfSymverSection.h" */
/* #line 18190 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// Class Definition for SgAsmElfSymverSection
class ROSE_DLL_API SgAsmElfSymverSection  : public SgAsmElfSection
   {
     public:


/* #line 46 "/workspace/generated/src/frontend/SageIII//SgAsmElfSymverSection.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 18213 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmElfSymverSection;
          enum { static_variant = V_SgAsmElfSymverSection };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmElfSymverSection* isSgAsmElfSymverSection(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmElfSymverSection* isSgAsmElfSymverSection( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmElfSymverSection * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmElfSymverSectionStorageClass *); // 
          ...
          /// \private
          static SgAsmElfSymverSection * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmElfSymverSection * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmElfSymverSection::operator delete (pointer,sizeof(SgAsmElfSymverSection));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmElfSymverSection* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmElfSymverSection* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmElfSymverSection* sgnode);
     ...
     public:
       ...
       */
       // SgAsmElfSymverSection( SgAsmElfSymverSectionStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmElfSymverSectionStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmElfSymverSection( const SgAsmElfSymverSectionStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmElfSymverSection* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmElfSymverSection* isSgAsmElfSymverSection ( SgNode* s );
...
// End of memberFunctionString
    ...
    protected:
// Start of memberFunctionString
SgAsmElfSymverEntryList* p_entries;
          
// End of memberFunctionString

    friend struct Rose::Traits::generated::describe_node_t<SgAsmElfSymverSection>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmElfSymverSection, SgAsmElfSymverEntryList*,&SgAsmElfSymverSection::p_entries>;
...
// postdeclarations for SgAsmElfSymverSection

/* #line 548 "/workspace/generated/src/frontend/SageIII//SgAsmElfSymverSection.h" */
...
/* #line 555 "/workspace/generated/src/frontend/SageIII//SgAsmElfSymverSection.h" */

#endif // ROSE_SgAsmElfSymverSection_H
