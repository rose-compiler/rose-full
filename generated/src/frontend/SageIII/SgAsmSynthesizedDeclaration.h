...
#ifndef ROSE_SgAsmSynthesizedDeclaration_H
#define ROSE_SgAsmSynthesizedDeclaration_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmSynthesizedDeclaration

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmSynthesizedDeclaration.h" */
...
// Class Definition for SgAsmSynthesizedDeclaration
class ROSE_DLL_API SgAsmSynthesizedDeclaration  : public SgAsmStatement
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmSynthesizedDeclaration.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 17503 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmSynthesizedDeclaration;
      ...
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmSynthesizedDeclaration* isSgAsmSynthesizedDeclaration(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmSynthesizedDeclaration* isSgAsmSynthesizedDeclaration( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmSynthesizedDeclaration * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmSynthesizedDeclarationStorageClass *); // 
          ...
          /// \private
          static SgAsmSynthesizedDeclaration * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmSynthesizedDeclaration * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmSynthesizedDeclaration::operator delete (pointer,sizeof(SgAsmSynthesizedDeclaration));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmSynthesizedDeclaration* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmSynthesizedDeclaration* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmSynthesizedDeclaration* sgnode);
     ...
     public:
       ...
       */
       // SgAsmSynthesizedDeclaration( SgAsmSynthesizedDeclarationStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmSynthesizedDeclarationStorageClass;
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmSynthesizedDeclaration* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmSynthesizedDeclaration* isSgAsmSynthesizedDeclaration ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmSynthesizedDeclaration>;
...
// postdeclarations for SgAsmSynthesizedDeclaration

/* #line 500 "/workspace/generated/src/frontend/SageIII//SgAsmSynthesizedDeclaration.h" */
...
/* #line 507 "/workspace/generated/src/frontend/SageIII//SgAsmSynthesizedDeclaration.h" */

#endif // ROSE_SgAsmSynthesizedDeclaration_H
