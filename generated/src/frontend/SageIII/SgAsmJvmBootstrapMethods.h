...
#ifndef ROSE_SgAsmJvmBootstrapMethods_H
#define ROSE_SgAsmJvmBootstrapMethods_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmJvmBootstrapMethods

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmJvmBootstrapMethods.h" */
/* #line 14283 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// Class Definition for SgAsmJvmBootstrapMethods
class ROSE_DLL_API SgAsmJvmBootstrapMethods  : public SgAsmJvmAttribute
   {
     public:


/* #line 42 "/workspace/generated/src/frontend/SageIII//SgAsmJvmBootstrapMethods.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 14302 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmJvmBootstrapMethods;
          enum { static_variant = V_SgAsmJvmBootstrapMethods };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmJvmBootstrapMethods* isSgAsmJvmBootstrapMethods(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmJvmBootstrapMethods* isSgAsmJvmBootstrapMethods( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmJvmBootstrapMethods * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmJvmBootstrapMethodsStorageClass *); // 
          ...
          /// \private
          static SgAsmJvmBootstrapMethods * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmJvmBootstrapMethods * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmJvmBootstrapMethods::operator delete (pointer,sizeof(SgAsmJvmBootstrapMethods));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmJvmBootstrapMethods* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmJvmBootstrapMethods* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmJvmBootstrapMethods* sgnode);
     ...
     public:
       ...
       */
       // SgAsmJvmBootstrapMethods( SgAsmJvmBootstrapMethodsStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmJvmBootstrapMethodsStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmJvmBootstrapMethods( const SgAsmJvmBootstrapMethodsStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmJvmBootstrapMethods* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmJvmBootstrapMethods* isSgAsmJvmBootstrapMethods ( SgNode* s );
...
// End of memberFunctionString
    ...
    protected:
// Start of memberFunctionString
SgAsmJvmBootstrapMethodPtrList p_bootstrap_methods;
          
// End of memberFunctionString

    friend struct Rose::Traits::generated::describe_node_t<SgAsmJvmBootstrapMethods>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmJvmBootstrapMethods, SgAsmJvmBootstrapMethodPtrList,&SgAsmJvmBootstrapMethods::p_bootstrap_methods>;
...
// postdeclarations for SgAsmJvmBootstrapMethods

/* #line 535 "/workspace/generated/src/frontend/SageIII//SgAsmJvmBootstrapMethods.h" */
...
/* #line 542 "/workspace/generated/src/frontend/SageIII//SgAsmJvmBootstrapMethods.h" */

#endif // ROSE_SgAsmJvmBootstrapMethods_H
