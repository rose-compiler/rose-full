...
#ifndef ROSE_SgAsmNESectionTable_H
#define ROSE_SgAsmNESectionTable_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmNESectionTable

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmNESectionTable.h" */
/* #line 5631 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// Class Definition for SgAsmNESectionTable
class ROSE_DLL_API SgAsmNESectionTable  : public SgAsmGenericSection
   {
     public:


/* #line 42 "/workspace/generated/src/frontend/SageIII//SgAsmNESectionTable.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 5664 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmNESectionTable;
          enum { static_variant = V_SgAsmNESectionTable };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmNESectionTable* isSgAsmNESectionTable(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmNESectionTable* isSgAsmNESectionTable( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmNESectionTable * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmNESectionTableStorageClass *); // 
          ...
          /// \private
          static SgAsmNESectionTable * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmNESectionTable * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmNESectionTable::operator delete (pointer,sizeof(SgAsmNESectionTable));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmNESectionTable* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmNESectionTable* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmNESectionTable* sgnode);
     ...
     public:
       ...
       */
       // SgAsmNESectionTable( SgAsmNESectionTableStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmNESectionTableStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmNESectionTable( const SgAsmNESectionTableStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmNESectionTable* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmNESectionTable* isSgAsmNESectionTable ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmNESectionTable>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmNESectionTable, unsigned,&SgAsmNESectionTable::p_flags>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmNESectionTable, unsigned,&SgAsmNESectionTable::p_sector>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmNESectionTable, Rose::BinaryAnalysis::Address,&SgAsmNESectionTable::p_physicalSize>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmNESectionTable, Rose::BinaryAnalysis::Address,&SgAsmNESectionTable::p_virtualSize>;
...
// postdeclarations for SgAsmNESectionTable

/* #line 556 "/workspace/generated/src/frontend/SageIII//SgAsmNESectionTable.h" */
...
/* #line 563 "/workspace/generated/src/frontend/SageIII//SgAsmNESectionTable.h" */

#endif // ROSE_SgAsmNESectionTable_H
