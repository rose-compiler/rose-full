...
#ifndef ROSE_SgAsmJvmConstantPool_H
#define ROSE_SgAsmJvmConstantPool_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmJvmConstantPool

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmJvmConstantPool.h" */
...
// Class Definition for SgAsmJvmConstantPool
class ROSE_DLL_API SgAsmJvmConstantPool  : public SgAsmGenericSection
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmJvmConstantPool.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 13466 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmJvmConstantPool;
          enum { static_variant = V_SgAsmJvmConstantPool };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmJvmConstantPool* isSgAsmJvmConstantPool(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmJvmConstantPool* isSgAsmJvmConstantPool( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmJvmConstantPool * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmJvmConstantPoolStorageClass *); // 
          ...
          /// \private
          static SgAsmJvmConstantPool * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmJvmConstantPool * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmJvmConstantPool::operator delete (pointer,sizeof(SgAsmJvmConstantPool));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmJvmConstantPool* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmJvmConstantPool* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmJvmConstantPool* sgnode);
     ...
     public:
       ...
       */
       // SgAsmJvmConstantPool( SgAsmJvmConstantPoolStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmJvmConstantPoolStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmJvmConstantPool( const SgAsmJvmConstantPoolStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmJvmConstantPool* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmJvmConstantPool* isSgAsmJvmConstantPool ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmJvmConstantPool>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmJvmConstantPool, SgAsmJvmConstantPoolEntryPtrList,&SgAsmJvmConstantPool::p_entries>;
...
// postdeclarations for SgAsmJvmConstantPool

/* #line 545 "/workspace/generated/src/frontend/SageIII//SgAsmJvmConstantPool.h" */
...
/* #line 552 "/workspace/generated/src/frontend/SageIII//SgAsmJvmConstantPool.h" */

#endif // ROSE_SgAsmJvmConstantPool_H
