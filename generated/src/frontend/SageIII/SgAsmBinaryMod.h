...
#ifndef ROSE_SgAsmBinaryMod_H
#define ROSE_SgAsmBinaryMod_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmBinaryMod

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmBinaryMod.h" */
...
class ROSE_DLL_API SgAsmBinaryMod  : public SgAsmBinaryExpression
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmBinaryMod.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 42906 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmBinaryMod* isSgAsmBinaryMod(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmBinaryMod* isSgAsmBinaryMod( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmBinaryMod * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmBinaryModStorageClass *); // 
          ...
          /// \private
          static SgAsmBinaryMod * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmBinaryMod * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmBinaryMod::operator delete (pointer,sizeof(SgAsmBinaryMod));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmBinaryMod* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmBinaryMod* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmBinaryMod* sgnode);
     ...
     public:
       ...
       */
       // SgAsmBinaryMod( SgAsmBinaryModStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmBinaryModStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmBinaryMod( const SgAsmBinaryModStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmBinaryMod* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmBinaryMod* isSgAsmBinaryMod ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmBinaryMod>;
...
// postdeclarations for SgAsmBinaryMod

/* #line 501 "/workspace/generated/src/frontend/SageIII//SgAsmBinaryMod.h" */
...
/* #line 508 "/workspace/generated/src/frontend/SageIII//SgAsmBinaryMod.h" */

#endif // ROSE_SgAsmBinaryMod_H
