...
#ifndef ROSE_SgAsmElfSegmentTableEntryList_H
#define ROSE_SgAsmElfSegmentTableEntryList_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmElfSegmentTableEntryList

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmElfSegmentTableEntryList.h" */
/* #line 20536 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// Class Definition for SgAsmElfSegmentTableEntryList
class ROSE_DLL_API SgAsmElfSegmentTableEntryList  : public SgAsmExecutableFileFormat
   {
     public:


/* #line 42 "/workspace/generated/src/frontend/SageIII//SgAsmElfSegmentTableEntryList.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 20551 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmElfSegmentTableEntryList;
          enum { static_variant = V_SgAsmElfSegmentTableEntryList };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmElfSegmentTableEntryList* isSgAsmElfSegmentTableEntryList(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmElfSegmentTableEntryList* isSgAsmElfSegmentTableEntryList( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmElfSegmentTableEntryList * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmElfSegmentTableEntryListStorageClass *); // 
          ...
          /// \private
          static SgAsmElfSegmentTableEntryList * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmElfSegmentTableEntryList * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmElfSegmentTableEntryList::operator delete (pointer,sizeof(SgAsmElfSegmentTableEntryList));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmElfSegmentTableEntryList* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmElfSegmentTableEntryList* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmElfSegmentTableEntryList* sgnode);
     ...
     public:
       ...
       */
       // SgAsmElfSegmentTableEntryList( SgAsmElfSegmentTableEntryListStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmElfSegmentTableEntryListStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmElfSegmentTableEntryList( const SgAsmElfSegmentTableEntryListStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmElfSegmentTableEntryList* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmElfSegmentTableEntryList* isSgAsmElfSegmentTableEntryList ( SgNode* s );
...
// End of memberFunctionString
    ...
    protected:
// Start of memberFunctionString
SgAsmElfSegmentTableEntryPtrList p_entries;
          
// End of memberFunctionString

    friend struct Rose::Traits::generated::describe_node_t<SgAsmElfSegmentTableEntryList>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmElfSegmentTableEntryList, SgAsmElfSegmentTableEntryPtrList,&SgAsmElfSegmentTableEntryList::p_entries>;
...
// postdeclarations for SgAsmElfSegmentTableEntryList

/* #line 519 "/workspace/generated/src/frontend/SageIII//SgAsmElfSegmentTableEntryList.h" */
...
/* #line 526 "/workspace/generated/src/frontend/SageIII//SgAsmElfSegmentTableEntryList.h" */

#endif // ROSE_SgAsmElfSegmentTableEntryList_H
