...
#ifndef ROSE_SgAsmCilParam_H
#define ROSE_SgAsmCilParam_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmCilParam

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmCilParam.h" */
...
// Class Definition for SgAsmCilParam
class ROSE_DLL_API SgAsmCilParam  : public SgAsmCilMetadata
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmCilParam.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 34121 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmCilParam;
          enum { static_variant = V_SgAsmCilParam };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmCilParam* isSgAsmCilParam(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmCilParam* isSgAsmCilParam( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmCilParam * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmCilParamStorageClass *); // 
          ...
          /// \private
          static SgAsmCilParam * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmCilParam * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmCilParam::operator delete (pointer,sizeof(SgAsmCilParam));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmCilParam* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmCilParam* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmCilParam* sgnode);
     ...
     public:
       ...
       */
       // SgAsmCilParam( SgAsmCilParamStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmCilParamStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmCilParam( const SgAsmCilParamStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmCilParam* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmCilParam* isSgAsmCilParam ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmCilParam>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilParam, uint16_t,&SgAsmCilParam::p_Flags>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilParam, uint16_t,&SgAsmCilParam::p_Sequence>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilParam, uint32_t,&SgAsmCilParam::p_Name>;
...
// postdeclarations for SgAsmCilParam

/* #line 552 "/workspace/generated/src/frontend/SageIII//SgAsmCilParam.h" */
...
/* #line 559 "/workspace/generated/src/frontend/SageIII//SgAsmCilParam.h" */

#endif // ROSE_SgAsmCilParam_H
