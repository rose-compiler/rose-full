...
#ifndef ROSE_SgAsmCilAssemblyRefProcessorTable_H
#define ROSE_SgAsmCilAssemblyRefProcessorTable_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmCilAssemblyRefProcessorTable

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmCilAssemblyRefProcessorTable.h" */
...
// Class Definition for SgAsmCilAssemblyRefProcessorTable
class ROSE_DLL_API SgAsmCilAssemblyRefProcessorTable  : public SgAsmCilMetadata
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmCilAssemblyRefProcessorTable.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 40764 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmCilAssemblyRefProcessorTable;
          enum { static_variant = V_SgAsmCilAssemblyRefProcessorTable };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmCilAssemblyRefProcessorTable* isSgAsmCilAssemblyRefProcessorTable(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmCilAssemblyRefProcessorTable* isSgAsmCilAssemblyRefProcessorTable( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmCilAssemblyRefProcessorTable * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmCilAssemblyRefProcessorTableStorageClass *); // 
          ...
          /// \private
          static SgAsmCilAssemblyRefProcessorTable * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmCilAssemblyRefProcessorTable * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmCilAssemblyRefProcessorTable::operator delete (pointer,sizeof(SgAsmCilAssemblyRefProcessorTable));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmCilAssemblyRefProcessorTable* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmCilAssemblyRefProcessorTable* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmCilAssemblyRefProcessorTable* sgnode);
     ...
     public:
       ...
       */
       // SgAsmCilAssemblyRefProcessorTable( SgAsmCilAssemblyRefProcessorTableStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmCilAssemblyRefProcessorTableStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmCilAssemblyRefProcessorTable( const SgAsmCilAssemblyRefProcessorTableStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmCilAssemblyRefProcessorTable* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmCilAssemblyRefProcessorTable* isSgAsmCilAssemblyRefProcessorTable ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmCilAssemblyRefProcessorTable>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilAssemblyRefProcessorTable, std::vector<SgAsmCilAssemblyRefProcessor*>,&SgAsmCilAssemblyRefProcessorTable::p_elements>;
...
// postdeclarations for SgAsmCilAssemblyRefProcessorTable

/* #line 508 "/workspace/generated/src/frontend/SageIII//SgAsmCilAssemblyRefProcessorTable.h" */
...
/* #line 515 "/workspace/generated/src/frontend/SageIII//SgAsmCilAssemblyRefProcessorTable.h" */

#endif // ROSE_SgAsmCilAssemblyRefProcessorTable_H
