...
#ifndef ROSE_SgAsmDwarfUnionType_H
#define ROSE_SgAsmDwarfUnionType_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmDwarfUnionType

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfUnionType.h" */
/* #line 24866 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// Class Definition for SgAsmDwarfUnionType
class ROSE_DLL_API SgAsmDwarfUnionType  : public SgAsmDwarfConstruct
   {
     public:


/* #line 44 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfUnionType.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 24883 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmDwarfUnionType;
          enum { static_variant = V_SgAsmDwarfUnionType };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmDwarfUnionType* isSgAsmDwarfUnionType(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmDwarfUnionType* isSgAsmDwarfUnionType( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmDwarfUnionType * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmDwarfUnionTypeStorageClass *); // 
          ...
          /// \private
          static SgAsmDwarfUnionType * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmDwarfUnionType * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmDwarfUnionType::operator delete (pointer,sizeof(SgAsmDwarfUnionType));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmDwarfUnionType* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmDwarfUnionType* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmDwarfUnionType* sgnode);
     ...
     public:
       ...
       */
       // SgAsmDwarfUnionType( SgAsmDwarfUnionTypeStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmDwarfUnionTypeStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmDwarfUnionType( const SgAsmDwarfUnionTypeStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmDwarfUnionType* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmDwarfUnionType* isSgAsmDwarfUnionType ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmDwarfUnionType>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmDwarfUnionType, SgAsmDwarfConstructList*,&SgAsmDwarfUnionType::p_body>;
...
// postdeclarations for SgAsmDwarfUnionType

/* #line 520 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfUnionType.h" */
...
/* #line 527 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfUnionType.h" */

#endif // ROSE_SgAsmDwarfUnionType_H
