...
#ifndef ROSE_SgAsmDwarfNamelistItem_H
#define ROSE_SgAsmDwarfNamelistItem_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmDwarfNamelistItem

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfNamelistItem.h" */
...
// Class Definition for SgAsmDwarfNamelistItem
class ROSE_DLL_API SgAsmDwarfNamelistItem  : public SgAsmDwarfConstruct
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfNamelistItem.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 26178 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmDwarfNamelistItem;
          enum { static_variant = V_SgAsmDwarfNamelistItem };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmDwarfNamelistItem* isSgAsmDwarfNamelistItem(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmDwarfNamelistItem* isSgAsmDwarfNamelistItem( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmDwarfNamelistItem * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmDwarfNamelistItemStorageClass *); // 
          ...
          /// \private
          static SgAsmDwarfNamelistItem * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmDwarfNamelistItem * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmDwarfNamelistItem::operator delete (pointer,sizeof(SgAsmDwarfNamelistItem));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmDwarfNamelistItem* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmDwarfNamelistItem* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmDwarfNamelistItem* sgnode);
     ...
     public:
       ...
       */
       // SgAsmDwarfNamelistItem( SgAsmDwarfNamelistItemStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmDwarfNamelistItemStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmDwarfNamelistItem( const SgAsmDwarfNamelistItemStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmDwarfNamelistItem* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmDwarfNamelistItem* isSgAsmDwarfNamelistItem ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmDwarfNamelistItem>;
...
// postdeclarations for SgAsmDwarfNamelistItem

/* #line 502 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfNamelistItem.h" */
...
/* #line 509 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfNamelistItem.h" */

#endif // ROSE_SgAsmDwarfNamelistItem_H
