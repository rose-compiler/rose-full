...
#ifndef ROSE_SgAsmPEImportItemList_H
#define ROSE_SgAsmPEImportItemList_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmPEImportItemList

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmPEImportItemList.h" */
/* #line 2990 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// Class Definition for SgAsmPEImportItemList
class ROSE_DLL_API SgAsmPEImportItemList  : public SgAsmExecutableFileFormat
   {
     public:


/* #line 42 "/workspace/generated/src/frontend/SageIII//SgAsmPEImportItemList.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 3009 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmPEImportItemList;
          enum { static_variant = V_SgAsmPEImportItemList };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmPEImportItemList* isSgAsmPEImportItemList(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmPEImportItemList* isSgAsmPEImportItemList( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmPEImportItemList * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmPEImportItemListStorageClass *); // 
          ...
          /// \private
          static SgAsmPEImportItemList * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmPEImportItemList * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmPEImportItemList::operator delete (pointer,sizeof(SgAsmPEImportItemList));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmPEImportItemList* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmPEImportItemList* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmPEImportItemList* sgnode);
     ...
     public:
       ...
       */
       // SgAsmPEImportItemList( SgAsmPEImportItemListStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmPEImportItemListStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmPEImportItemList( const SgAsmPEImportItemListStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmPEImportItemList* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmPEImportItemList* isSgAsmPEImportItemList ( SgNode* s );
...
// End of memberFunctionString
    ...
    protected:
// Start of memberFunctionString
SgAsmPEImportItemPtrList p_vector;
          
// End of memberFunctionString

    friend struct Rose::Traits::generated::describe_node_t<SgAsmPEImportItemList>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmPEImportItemList, SgAsmPEImportItemPtrList,&SgAsmPEImportItemList::p_vector>;
...
// postdeclarations for SgAsmPEImportItemList

/* #line 516 "/workspace/generated/src/frontend/SageIII//SgAsmPEImportItemList.h" */
...
/* #line 523 "/workspace/generated/src/frontend/SageIII//SgAsmPEImportItemList.h" */

#endif // ROSE_SgAsmPEImportItemList_H
