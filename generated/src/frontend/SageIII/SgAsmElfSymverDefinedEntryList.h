...
#ifndef ROSE_SgAsmElfSymverDefinedEntryList_H
#define ROSE_SgAsmElfSymverDefinedEntryList_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmElfSymverDefinedEntryList

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmElfSymverDefinedEntryList.h" */
/* #line 19251 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// Class Definition for SgAsmElfSymverDefinedEntryList
class ROSE_DLL_API SgAsmElfSymverDefinedEntryList  : public SgAsmExecutableFileFormat
   {
     public:


/* #line 42 "/workspace/generated/src/frontend/SageIII//SgAsmElfSymverDefinedEntryList.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 19270 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmElfSymverDefinedEntryList;
          enum { static_variant = V_SgAsmElfSymverDefinedEntryList };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmElfSymverDefinedEntryList* isSgAsmElfSymverDefinedEntryList(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmElfSymverDefinedEntryList* isSgAsmElfSymverDefinedEntryList( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmElfSymverDefinedEntryList * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmElfSymverDefinedEntryListStorageClass *); // 
          ...
          /// \private
          static SgAsmElfSymverDefinedEntryList * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmElfSymverDefinedEntryList * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmElfSymverDefinedEntryList::operator delete (pointer,sizeof(SgAsmElfSymverDefinedEntryList));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmElfSymverDefinedEntryList* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmElfSymverDefinedEntryList* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmElfSymverDefinedEntryList* sgnode);
     ...
     public:
       ...
       */
       // SgAsmElfSymverDefinedEntryList( SgAsmElfSymverDefinedEntryListStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmElfSymverDefinedEntryListStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmElfSymverDefinedEntryList( const SgAsmElfSymverDefinedEntryListStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmElfSymverDefinedEntryList* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmElfSymverDefinedEntryList* isSgAsmElfSymverDefinedEntryList ( SgNode* s );
...
// End of memberFunctionString
    ...
    protected:
// Start of memberFunctionString
SgAsmElfSymverDefinedEntryPtrList p_entries;
          
// End of memberFunctionString

    friend struct Rose::Traits::generated::describe_node_t<SgAsmElfSymverDefinedEntryList>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmElfSymverDefinedEntryList, SgAsmElfSymverDefinedEntryPtrList,&SgAsmElfSymverDefinedEntryList::p_entries>;
...
// postdeclarations for SgAsmElfSymverDefinedEntryList

/* #line 516 "/workspace/generated/src/frontend/SageIII//SgAsmElfSymverDefinedEntryList.h" */
...
/* #line 523 "/workspace/generated/src/frontend/SageIII//SgAsmElfSymverDefinedEntryList.h" */

#endif // ROSE_SgAsmElfSymverDefinedEntryList_H
