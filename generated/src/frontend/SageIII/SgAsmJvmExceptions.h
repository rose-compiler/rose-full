...
#ifndef ROSE_SgAsmJvmExceptions_H
#define ROSE_SgAsmJvmExceptions_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmJvmExceptions

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmJvmExceptions.h" */
/* #line 12409 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// Class Definition for SgAsmJvmExceptions
class ROSE_DLL_API SgAsmJvmExceptions  : public SgAsmJvmAttribute
   {
     public:


/* #line 42 "/workspace/generated/src/frontend/SageIII//SgAsmJvmExceptions.h" */

          virtual SgNode* copy ( SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 12429 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmJvmExceptions;
          enum { static_variant = V_SgAsmJvmExceptions };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmJvmExceptions* isSgAsmJvmExceptions(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmJvmExceptions* isSgAsmJvmExceptions( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmJvmExceptions * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmJvmExceptionsStorageClass *); // 
          ...
          /// \private
          static SgAsmJvmExceptions * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmJvmExceptions * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmJvmExceptions::operator delete (pointer,sizeof(SgAsmJvmExceptions));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmJvmExceptions* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmJvmExceptions* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmJvmExceptions* sgnode);
     ...
     public:
       ...
       */
       // SgAsmJvmExceptions( SgAsmJvmExceptionsStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmJvmExceptionsStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmJvmExceptions( const SgAsmJvmExceptionsStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmJvmExceptions* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 670 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmJvmExceptions* isSgAsmJvmExceptions ( SgNode* s );
...
// End of memberFunctionString
    ...
    protected:
// Start of memberFunctionString
SgUnsigned16List p_exception_index_table;
          
// End of memberFunctionString

    friend struct Rose::Traits::generated::describe_node_t<SgAsmJvmExceptions>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmJvmExceptions, SgUnsigned16List,&SgAsmJvmExceptions::p_exception_index_table>;
...
// postdeclarations for SgAsmJvmExceptions

/* #line 532 "/workspace/generated/src/frontend/SageIII//SgAsmJvmExceptions.h" */
...
/* #line 539 "/workspace/generated/src/frontend/SageIII//SgAsmJvmExceptions.h" */

#endif // ROSE_SgAsmJvmExceptions_H
