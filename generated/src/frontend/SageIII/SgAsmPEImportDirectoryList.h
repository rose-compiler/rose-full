...
#ifndef ROSE_SgAsmPEImportDirectoryList_H
#define ROSE_SgAsmPEImportDirectoryList_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmPEImportDirectoryList

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmPEImportDirectoryList.h" */
/* #line 3305 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// Class Definition for SgAsmPEImportDirectoryList
class ROSE_DLL_API SgAsmPEImportDirectoryList  : public SgAsmExecutableFileFormat
   {
     public:


/* #line 42 "/workspace/generated/src/frontend/SageIII//SgAsmPEImportDirectoryList.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 3324 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmPEImportDirectoryList;
          enum { static_variant = V_SgAsmPEImportDirectoryList };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmPEImportDirectoryList* isSgAsmPEImportDirectoryList(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmPEImportDirectoryList* isSgAsmPEImportDirectoryList( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmPEImportDirectoryList * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmPEImportDirectoryListStorageClass *); // 
          ...
          /// \private
          static SgAsmPEImportDirectoryList * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmPEImportDirectoryList * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmPEImportDirectoryList::operator delete (pointer,sizeof(SgAsmPEImportDirectoryList));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmPEImportDirectoryList* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmPEImportDirectoryList* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmPEImportDirectoryList* sgnode);
     ...
     public:
       ...
       */
       // SgAsmPEImportDirectoryList( SgAsmPEImportDirectoryListStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmPEImportDirectoryListStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmPEImportDirectoryList( const SgAsmPEImportDirectoryListStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmPEImportDirectoryList* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmPEImportDirectoryList* isSgAsmPEImportDirectoryList ( SgNode* s );
...
// End of memberFunctionString
    ...
    protected:
// Start of memberFunctionString
SgAsmPEImportDirectoryPtrList p_vector;
          
// End of memberFunctionString

    friend struct Rose::Traits::generated::describe_node_t<SgAsmPEImportDirectoryList>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmPEImportDirectoryList, SgAsmPEImportDirectoryPtrList,&SgAsmPEImportDirectoryList::p_vector>;
...
// postdeclarations for SgAsmPEImportDirectoryList

/* #line 518 "/workspace/generated/src/frontend/SageIII//SgAsmPEImportDirectoryList.h" */
...
/* #line 525 "/workspace/generated/src/frontend/SageIII//SgAsmPEImportDirectoryList.h" */

#endif // ROSE_SgAsmPEImportDirectoryList_H
