...
#ifndef ROSE_SgAsmElfSymbol_H
#define ROSE_SgAsmElfSymbol_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmElfSymbol

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmElfSymbol.h" */
/* #line 19947 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// Class Definition for SgAsmElfSymbol
class ROSE_DLL_API SgAsmElfSymbol  : public SgAsmGenericSymbol
   {
     public:


/* #line 44 "/workspace/generated/src/frontend/SageIII//SgAsmElfSymbol.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 19992 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmElfSymbol;
          enum { static_variant = V_SgAsmElfSymbol };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmElfSymbol* isSgAsmElfSymbol(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmElfSymbol* isSgAsmElfSymbol( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmElfSymbol * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmElfSymbolStorageClass *); // 
          ...
          /// \private
          static SgAsmElfSymbol * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmElfSymbol * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmElfSymbol::operator delete (pointer,sizeof(SgAsmElfSymbol));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmElfSymbol* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmElfSymbol* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmElfSymbol* sgnode);
     ...
     public:
       ...
       */
       // SgAsmElfSymbol( SgAsmElfSymbolStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmElfSymbolStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmElfSymbol( const SgAsmElfSymbolStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmElfSymbol* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmElfSymbol* isSgAsmElfSymbol ( SgNode* s );
...
// End of memberFunctionString
    ...
    protected:
// Start of memberFunctionString
unsigned char p_st_info;
          
// End of memberFunctionString
// Start of memberFunctionString
unsigned char p_st_res1;
...
// End of memberFunctionString
// Start of memberFunctionString
Rose::BinaryAnalysis::Address p_st_size;
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmElfSymbol>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmElfSymbol, unsigned char,&SgAsmElfSymbol::p_st_info>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmElfSymbol, unsigned char,&SgAsmElfSymbol::p_st_res1>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmElfSymbol, unsigned,&SgAsmElfSymbol::p_st_shndx>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmElfSymbol, Rose::BinaryAnalysis::Address,&SgAsmElfSymbol::p_st_size>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmElfSymbol, SgUnsignedCharList,&SgAsmElfSymbol::p_extra>;
...
// postdeclarations for SgAsmElfSymbol

/* #line 702 "/workspace/generated/src/frontend/SageIII//SgAsmElfSymbol.h" */
...
/* #line 709 "/workspace/generated/src/frontend/SageIII//SgAsmElfSymbol.h" */

#endif // ROSE_SgAsmElfSymbol_H
