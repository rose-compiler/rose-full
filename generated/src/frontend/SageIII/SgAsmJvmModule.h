...
#ifndef ROSE_SgAsmJvmModule_H
#define ROSE_SgAsmJvmModule_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmJvmModule

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmJvmModule.h" */
/* #line 10713 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// Class Definition for SgAsmJvmModule
class ROSE_DLL_API SgAsmJvmModule  : public SgAsmJvmAttribute
   {
     public:


/* #line 42 "/workspace/generated/src/frontend/SageIII//SgAsmJvmModule.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 10776 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmJvmModule;
          enum { static_variant = V_SgAsmJvmModule };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmJvmModule* isSgAsmJvmModule(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmJvmModule* isSgAsmJvmModule( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmJvmModule * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmJvmModuleStorageClass *); // 
          ...
          /// \private
          static SgAsmJvmModule * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmJvmModule * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmJvmModule::operator delete (pointer,sizeof(SgAsmJvmModule));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmJvmModule* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmJvmModule* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmJvmModule* sgnode);
     ...
     public:
       ...
       */
       // SgAsmJvmModule( SgAsmJvmModuleStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmJvmModuleStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmJvmModule( const SgAsmJvmModuleStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmJvmModule* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmJvmModule* isSgAsmJvmModule ( SgNode* s );
...
// End of memberFunctionString
    ...
    protected:
// Start of memberFunctionString
uint16_t p_module_name_index;
          
// End of memberFunctionString
// Start of memberFunctionString
uint16_t p_module_flags;
          
// End of memberFunctionString
// Start of memberFunctionString
uint16_t p_module_version_index;
          
// End of memberFunctionString
// Start of memberFunctionString
std::vector<SgAsmJvmModule::Requires*> p_requires;
          
// End of memberFunctionString
// Start of memberFunctionString
std::vector<SgAsmJvmModule::Exports*> p_exports;
          
// End of memberFunctionString
// Start of memberFunctionString
std::vector<SgAsmJvmModule::Opens*> p_opens;
          
// End of memberFunctionString
// Start of memberFunctionString
std::vector<uint16_t> p_uses_index;
          
// End of memberFunctionString
// Start of memberFunctionString
std::vector<SgAsmJvmModule::Provides*> p_provides;
          
// End of memberFunctionString

    friend struct Rose::Traits::generated::describe_node_t<SgAsmJvmModule>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmJvmModule, uint16_t,&SgAsmJvmModule::p_module_name_index>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmJvmModule, uint16_t,&SgAsmJvmModule::p_module_flags>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmJvmModule, uint16_t,&SgAsmJvmModule::p_module_version_index>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmJvmModule, std::vector<SgAsmJvmModule::Requires*>,&SgAsmJvmModule::p_requires>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmJvmModule, std::vector<SgAsmJvmModule::Exports*>,&SgAsmJvmModule::p_exports>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmJvmModule, std::vector<SgAsmJvmModule::Opens*>,&SgAsmJvmModule::p_opens>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmJvmModule, std::vector<uint16_t>,&SgAsmJvmModule::p_uses_index>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmJvmModule, std::vector<SgAsmJvmModule::Provides*>,&SgAsmJvmModule::p_provides>;
...
// postdeclarations for SgAsmJvmModule

/* #line 744 "/workspace/generated/src/frontend/SageIII//SgAsmJvmModule.h" */
...
/* #line 751 "/workspace/generated/src/frontend/SageIII//SgAsmJvmModule.h" */

#endif // ROSE_SgAsmJvmModule_H
