...
#ifndef ROSE_SgAsmNERelocTable_H
#define ROSE_SgAsmNERelocTable_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmNERelocTable

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmNERelocTable.h" */
...
// Class Definition for SgAsmNERelocTable
class ROSE_DLL_API SgAsmNERelocTable  : public SgAsmGenericSection
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmNERelocTable.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 6014 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmNERelocTable;
          enum { static_variant = V_SgAsmNERelocTable };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmNERelocTable* isSgAsmNERelocTable(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmNERelocTable* isSgAsmNERelocTable( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmNERelocTable * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmNERelocTableStorageClass *); // 
          ...
          /// \private
          static SgAsmNERelocTable * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmNERelocTable * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmNERelocTable::operator delete (pointer,sizeof(SgAsmNERelocTable));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmNERelocTable* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmNERelocTable* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmNERelocTable* sgnode);
     ...
     public:
       ...
       */
       // SgAsmNERelocTable( SgAsmNERelocTableStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmNERelocTableStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmNERelocTable( const SgAsmNERelocTableStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmNERelocTable* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmNERelocTable* isSgAsmNERelocTable ( SgNode* s );
...
// End of memberFunctionString
    ...
    protected:
// Start of memberFunctionString
SgAsmNERelocEntryPtrList p_entries;
          
// End of memberFunctionString

    friend struct Rose::Traits::generated::describe_node_t<SgAsmNERelocTable>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmNERelocTable, SgAsmNERelocEntryPtrList,&SgAsmNERelocTable::p_entries>;
...
// postdeclarations for SgAsmNERelocTable

/* #line 511 "/workspace/generated/src/frontend/SageIII//SgAsmNERelocTable.h" */
...
/* #line 518 "/workspace/generated/src/frontend/SageIII//SgAsmNERelocTable.h" */

#endif // ROSE_SgAsmNERelocTable_H
