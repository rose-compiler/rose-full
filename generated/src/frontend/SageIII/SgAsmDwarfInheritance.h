...
#ifndef ROSE_SgAsmDwarfInheritance_H
#define ROSE_SgAsmDwarfInheritance_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmDwarfInheritance

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfInheritance.h" */
...
// Class Definition for SgAsmDwarfInheritance
class ROSE_DLL_API SgAsmDwarfInheritance  : public SgAsmDwarfConstruct
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfInheritance.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 27088 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmDwarfInheritance;
          enum { static_variant = V_SgAsmDwarfInheritance };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmDwarfInheritance* isSgAsmDwarfInheritance(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmDwarfInheritance* isSgAsmDwarfInheritance( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmDwarfInheritance * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmDwarfInheritanceStorageClass *); // 
          ...
          /// \private
          static SgAsmDwarfInheritance * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmDwarfInheritance * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmDwarfInheritance::operator delete (pointer,sizeof(SgAsmDwarfInheritance));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmDwarfInheritance* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmDwarfInheritance* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmDwarfInheritance* sgnode);
     ...
     public:
       ...
       */
       // SgAsmDwarfInheritance( SgAsmDwarfInheritanceStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmDwarfInheritanceStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmDwarfInheritance( const SgAsmDwarfInheritanceStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmDwarfInheritance* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmDwarfInheritance* isSgAsmDwarfInheritance ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmDwarfInheritance>;
...
// postdeclarations for SgAsmDwarfInheritance

/* #line 502 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfInheritance.h" */
...
/* #line 509 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfInheritance.h" */

#endif // ROSE_SgAsmDwarfInheritance_H
