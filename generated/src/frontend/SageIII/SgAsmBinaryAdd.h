...
#ifndef ROSE_SgAsmBinaryAdd_H
#define ROSE_SgAsmBinaryAdd_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmBinaryAdd

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmBinaryAdd.h" */
...
// Class Definition for SgAsmBinaryAdd
class ROSE_DLL_API SgAsmBinaryAdd  : public SgAsmBinaryExpression
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmBinaryAdd.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 43260 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmBinaryAdd* isSgAsmBinaryAdd(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmBinaryAdd* isSgAsmBinaryAdd( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmBinaryAdd * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmBinaryAddStorageClass *); // 
          ...
          /// \private
          static SgAsmBinaryAdd * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmBinaryAdd * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmBinaryAdd::operator delete (pointer,sizeof(SgAsmBinaryAdd));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmBinaryAdd* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmBinaryAdd* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmBinaryAdd* sgnode);
     ...
     public:
       ...
       */
       // SgAsmBinaryAdd( SgAsmBinaryAddStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmBinaryAddStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmBinaryAdd( const SgAsmBinaryAddStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmBinaryAdd* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmBinaryAdd* isSgAsmBinaryAdd ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmBinaryAdd>;
...
// postdeclarations for SgAsmBinaryAdd

/* #line 501 "/workspace/generated/src/frontend/SageIII//SgAsmBinaryAdd.h" */
...
/* #line 508 "/workspace/generated/src/frontend/SageIII//SgAsmBinaryAdd.h" */

#endif // ROSE_SgAsmBinaryAdd_H
