...
#ifndef ROSE_SgAsmJvmNestMembers_H
#define ROSE_SgAsmJvmNestMembers_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmJvmNestMembers

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmJvmNestMembers.h" */
...
// Class Definition for SgAsmJvmNestMembers
class ROSE_DLL_API SgAsmJvmNestMembers  : public SgAsmJvmAttribute
   {
     public:


/* #line 42 "/workspace/generated/src/frontend/SageIII//SgAsmJvmNestMembers.h" */

          virtual SgNode* copy ( SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 10084 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmJvmNestMembers;
          enum { static_variant = V_SgAsmJvmNestMembers };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmJvmNestMembers* isSgAsmJvmNestMembers(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmJvmNestMembers* isSgAsmJvmNestMembers( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmJvmNestMembers * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmJvmNestMembersStorageClass *); // 
          ...
          /// \private
          static SgAsmJvmNestMembers * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmJvmNestMembers * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmJvmNestMembers::operator delete (pointer,sizeof(SgAsmJvmNestMembers));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmJvmNestMembers* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmJvmNestMembers* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmJvmNestMembers* sgnode);
     ...
     public:
       ...
       */
       // SgAsmJvmNestMembers( SgAsmJvmNestMembersStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmJvmNestMembersStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmJvmNestMembers( const SgAsmJvmNestMembersStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmJvmNestMembers* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 670 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmJvmNestMembers* isSgAsmJvmNestMembers ( SgNode* s );
...
// End of memberFunctionString
    ...
    protected:
// Start of memberFunctionString
SgUnsigned16List p_classes;
          
// End of memberFunctionString

    friend struct Rose::Traits::generated::describe_node_t<SgAsmJvmNestMembers>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmJvmNestMembers, SgUnsigned16List,&SgAsmJvmNestMembers::p_classes>;
...
// postdeclarations for SgAsmJvmNestMembers

/* #line 533 "/workspace/generated/src/frontend/SageIII//SgAsmJvmNestMembers.h" */
...
/* #line 540 "/workspace/generated/src/frontend/SageIII//SgAsmJvmNestMembers.h" */

#endif // ROSE_SgAsmJvmNestMembers_H
