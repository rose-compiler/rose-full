...
#ifndef ROSE_SgAsmCoffStrtab_H
#define ROSE_SgAsmCoffStrtab_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmCoffStrtab

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmCoffStrtab.h" */
/* #line 31420 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// Class Definition for SgAsmCoffStrtab
class ROSE_DLL_API SgAsmCoffStrtab  : public SgAsmGenericStrtab
   {
     public:


/* #line 42 "/workspace/generated/src/frontend/SageIII//SgAsmCoffStrtab.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 31430 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmCoffStrtab;
          enum { static_variant = V_SgAsmCoffStrtab };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmCoffStrtab* isSgAsmCoffStrtab(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmCoffStrtab* isSgAsmCoffStrtab( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmCoffStrtab * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmCoffStrtabStorageClass *); // 
          ...
          /// \private
          static SgAsmCoffStrtab * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmCoffStrtab * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmCoffStrtab::operator delete (pointer,sizeof(SgAsmCoffStrtab));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmCoffStrtab* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmCoffStrtab* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmCoffStrtab* sgnode);
     ...
     public:
       ...
       */
       // SgAsmCoffStrtab( SgAsmCoffStrtabStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmCoffStrtabStorageClass;
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmCoffStrtab* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmCoffStrtab* isSgAsmCoffStrtab ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmCoffStrtab>;
...
// postdeclarations for SgAsmCoffStrtab

/* #line 512 "/workspace/generated/src/frontend/SageIII//SgAsmCoffStrtab.h" */
...
/* #line 519 "/workspace/generated/src/frontend/SageIII//SgAsmCoffStrtab.h" */

#endif // ROSE_SgAsmCoffStrtab_H
