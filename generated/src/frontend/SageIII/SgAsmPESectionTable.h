...
#ifndef ROSE_SgAsmPESectionTable_H
#define ROSE_SgAsmPESectionTable_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmPESectionTable

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmPESectionTable.h" */
...
// Class Definition for SgAsmPESectionTable
class ROSE_DLL_API SgAsmPESectionTable  : public SgAsmGenericSection
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmPESectionTable.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 2139 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmPESectionTable;
          enum { static_variant = V_SgAsmPESectionTable };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmPESectionTable* isSgAsmPESectionTable(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmPESectionTable* isSgAsmPESectionTable( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmPESectionTable * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmPESectionTableStorageClass *); // 
          ...
          /// \private
          static SgAsmPESectionTable * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmPESectionTable * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmPESectionTable::operator delete (pointer,sizeof(SgAsmPESectionTable));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmPESectionTable* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmPESectionTable* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmPESectionTable* sgnode);
     ...
     public:
       ...
       */
       // SgAsmPESectionTable( SgAsmPESectionTableStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmPESectionTableStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmPESectionTable( const SgAsmPESectionTableStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmPESectionTable* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmPESectionTable* isSgAsmPESectionTable ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmPESectionTable>;
...
// postdeclarations for SgAsmPESectionTable

/* #line 513 "/workspace/generated/src/frontend/SageIII//SgAsmPESectionTable.h" */
...
/* #line 520 "/workspace/generated/src/frontend/SageIII//SgAsmPESectionTable.h" */

#endif // ROSE_SgAsmPESectionTable_H
