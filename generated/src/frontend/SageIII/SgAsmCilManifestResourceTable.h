...
#ifndef ROSE_SgAsmCilManifestResourceTable_H
#define ROSE_SgAsmCilManifestResourceTable_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmCilManifestResourceTable

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmCilManifestResourceTable.h" */
...
// Class Definition for SgAsmCilManifestResourceTable
class ROSE_DLL_API SgAsmCilManifestResourceTable  : public SgAsmCilMetadata
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmCilManifestResourceTable.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 37129 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmCilManifestResourceTable;
          enum { static_variant = V_SgAsmCilManifestResourceTable };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmCilManifestResourceTable* isSgAsmCilManifestResourceTable(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmCilManifestResourceTable* isSgAsmCilManifestResourceTable( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmCilManifestResourceTable * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmCilManifestResourceTableStorageClass *); // 
          ...
          /// \private
          static SgAsmCilManifestResourceTable * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmCilManifestResourceTable * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmCilManifestResourceTable::operator delete (pointer,sizeof(SgAsmCilManifestResourceTable));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmCilManifestResourceTable* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmCilManifestResourceTable* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmCilManifestResourceTable* sgnode);
     ...
     public:
       ...
       */
       // SgAsmCilManifestResourceTable( SgAsmCilManifestResourceTableStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmCilManifestResourceTableStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmCilManifestResourceTable( const SgAsmCilManifestResourceTableStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmCilManifestResourceTable* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmCilManifestResourceTable* isSgAsmCilManifestResourceTable ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmCilManifestResourceTable>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilManifestResourceTable, std::vector<SgAsmCilManifestResource*>,&SgAsmCilManifestResourceTable::p_elements>;
...
// postdeclarations for SgAsmCilManifestResourceTable

/* #line 508 "/workspace/generated/src/frontend/SageIII//SgAsmCilManifestResourceTable.h" */
...
/* #line 515 "/workspace/generated/src/frontend/SageIII//SgAsmCilManifestResourceTable.h" */

#endif // ROSE_SgAsmCilManifestResourceTable_H
