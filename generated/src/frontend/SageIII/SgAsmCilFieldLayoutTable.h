...
#ifndef ROSE_SgAsmCilFieldLayoutTable_H
#define ROSE_SgAsmCilFieldLayoutTable_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmCilFieldLayoutTable

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmCilFieldLayoutTable.h" */
...
// Class Definition for SgAsmCilFieldLayoutTable
class ROSE_DLL_API SgAsmCilFieldLayoutTable  : public SgAsmCilMetadata
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmCilFieldLayoutTable.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 38678 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmCilFieldLayoutTable;
          enum { static_variant = V_SgAsmCilFieldLayoutTable };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmCilFieldLayoutTable* isSgAsmCilFieldLayoutTable(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmCilFieldLayoutTable* isSgAsmCilFieldLayoutTable( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmCilFieldLayoutTable * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmCilFieldLayoutTableStorageClass *); // 
          ...
          /// \private
          static SgAsmCilFieldLayoutTable * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmCilFieldLayoutTable * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmCilFieldLayoutTable::operator delete (pointer,sizeof(SgAsmCilFieldLayoutTable));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmCilFieldLayoutTable* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmCilFieldLayoutTable* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmCilFieldLayoutTable* sgnode);
     ...
     public:
       ...
       */
       // SgAsmCilFieldLayoutTable( SgAsmCilFieldLayoutTableStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmCilFieldLayoutTableStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmCilFieldLayoutTable( const SgAsmCilFieldLayoutTableStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmCilFieldLayoutTable* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmCilFieldLayoutTable* isSgAsmCilFieldLayoutTable ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmCilFieldLayoutTable>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilFieldLayoutTable, std::vector<SgAsmCilFieldLayout*>,&SgAsmCilFieldLayoutTable::p_elements>;
...
// postdeclarations for SgAsmCilFieldLayoutTable

/* #line 508 "/workspace/generated/src/frontend/SageIII//SgAsmCilFieldLayoutTable.h" */
...
/* #line 515 "/workspace/generated/src/frontend/SageIII//SgAsmCilFieldLayoutTable.h" */

#endif // ROSE_SgAsmCilFieldLayoutTable_H
