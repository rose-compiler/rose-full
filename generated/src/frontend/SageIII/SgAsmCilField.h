...
#ifndef ROSE_SgAsmCilField_H
#define ROSE_SgAsmCilField_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmCilField

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmCilField.h" */
...
// Class Definition for SgAsmCilField
class ROSE_DLL_API SgAsmCilField  : public SgAsmCilMetadata
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmCilField.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 38849 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmCilField;
          enum { static_variant = V_SgAsmCilField };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmCilField* isSgAsmCilField(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmCilField* isSgAsmCilField( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmCilField * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmCilFieldStorageClass *); // 
          ...
          /// \private
          static SgAsmCilField * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmCilField * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmCilField::operator delete (pointer,sizeof(SgAsmCilField));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmCilField* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmCilField* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmCilField* sgnode);
     ...
     public:
       ...
       */
       // SgAsmCilField( SgAsmCilFieldStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmCilFieldStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmCilField( const SgAsmCilFieldStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmCilField* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmCilField* isSgAsmCilField ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmCilField>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilField, uint16_t,&SgAsmCilField::p_Flags>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilField, uint32_t,&SgAsmCilField::p_Name>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilField, uint32_t,&SgAsmCilField::p_Signature>;
...
// postdeclarations for SgAsmCilField

/* #line 579 "/workspace/generated/src/frontend/SageIII//SgAsmCilField.h" */
...
/* #line 586 "/workspace/generated/src/frontend/SageIII//SgAsmCilField.h" */

#endif // ROSE_SgAsmCilField_H
