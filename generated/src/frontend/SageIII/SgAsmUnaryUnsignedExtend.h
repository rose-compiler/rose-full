...
#ifndef ROSE_SgAsmUnaryUnsignedExtend_H
#define ROSE_SgAsmUnaryUnsignedExtend_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmUnaryUnsignedExtend

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmUnaryUnsignedExtend.h" */
...
// Class Definition for SgAsmUnaryUnsignedExtend
class ROSE_DLL_API SgAsmUnaryUnsignedExtend  : public SgAsmUnaryExpression
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmUnaryUnsignedExtend.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 579 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmUnaryUnsignedExtend;
          enum { static_variant = V_SgAsmUnaryUnsignedExtend };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmUnaryUnsignedExtend* isSgAsmUnaryUnsignedExtend(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmUnaryUnsignedExtend* isSgAsmUnaryUnsignedExtend( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmUnaryUnsignedExtend * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmUnaryUnsignedExtendStorageClass *); // 
          ...
          /// \private
          static SgAsmUnaryUnsignedExtend * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmUnaryUnsignedExtend * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmUnaryUnsignedExtend::operator delete (pointer,sizeof(SgAsmUnaryUnsignedExtend));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmUnaryUnsignedExtend* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmUnaryUnsignedExtend* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmUnaryUnsignedExtend* sgnode);
     ...
     public:
       ...
       */
       // SgAsmUnaryUnsignedExtend( SgAsmUnaryUnsignedExtendStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmUnaryUnsignedExtendStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmUnaryUnsignedExtend( const SgAsmUnaryUnsignedExtendStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmUnaryUnsignedExtend* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmUnaryUnsignedExtend* isSgAsmUnaryUnsignedExtend ( SgNode* s );

          typedef SgAsmUnaryExpression base_node_type;
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmUnaryUnsignedExtend>;
...
// postdeclarations for SgAsmUnaryUnsignedExtend

/* #line 500 "/workspace/generated/src/frontend/SageIII//SgAsmUnaryUnsignedExtend.h" */
...
/* #line 507 "/workspace/generated/src/frontend/SageIII//SgAsmUnaryUnsignedExtend.h" */

#endif // ROSE_SgAsmUnaryUnsignedExtend_H
