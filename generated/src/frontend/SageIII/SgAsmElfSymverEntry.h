...
#ifndef ROSE_SgAsmElfSymverEntry_H
#define ROSE_SgAsmElfSymverEntry_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmElfSymverEntry

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmElfSymverEntry.h" */
...
// Class Definition for SgAsmElfSymverEntry
class ROSE_DLL_API SgAsmElfSymverEntry  : public SgAsmExecutableFileFormat
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmElfSymverEntry.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 19008 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmElfSymverEntry;
          enum { static_variant = V_SgAsmElfSymverEntry };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmElfSymverEntry* isSgAsmElfSymverEntry(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmElfSymverEntry* isSgAsmElfSymverEntry( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmElfSymverEntry * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmElfSymverEntryStorageClass *); // 
          ...
          /// \private
          static SgAsmElfSymverEntry * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmElfSymverEntry * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmElfSymverEntry::operator delete (pointer,sizeof(SgAsmElfSymverEntry));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmElfSymverEntry* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmElfSymverEntry* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmElfSymverEntry* sgnode);
     ...
     public:
       ...
       */
       // SgAsmElfSymverEntry( SgAsmElfSymverEntryStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmElfSymverEntryStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmElfSymverEntry( const SgAsmElfSymverEntryStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmElfSymverEntry* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmElfSymverEntry* isSgAsmElfSymverEntry ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmElfSymverEntry>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmElfSymverEntry, size_t,&SgAsmElfSymverEntry::p_value>;
...
// postdeclarations for SgAsmElfSymverEntry

/* #line 518 "/workspace/generated/src/frontend/SageIII//SgAsmElfSymverEntry.h" */
...
/* #line 525 "/workspace/generated/src/frontend/SageIII//SgAsmElfSymverEntry.h" */

#endif // ROSE_SgAsmElfSymverEntry_H
