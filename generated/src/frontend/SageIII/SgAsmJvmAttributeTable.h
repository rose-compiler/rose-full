...
#ifndef ROSE_SgAsmJvmAttributeTable_H
#define ROSE_SgAsmJvmAttributeTable_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmJvmAttributeTable

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmJvmAttributeTable.h" */
...
// Class Definition for SgAsmJvmAttributeTable
class ROSE_DLL_API SgAsmJvmAttributeTable  : public SgAsmGenericSection
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmJvmAttributeTable.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 14507 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmJvmAttributeTable;
          enum { static_variant = V_SgAsmJvmAttributeTable };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmJvmAttributeTable* isSgAsmJvmAttributeTable(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmJvmAttributeTable* isSgAsmJvmAttributeTable( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmJvmAttributeTable * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmJvmAttributeTableStorageClass *); // 
          ...
          /// \private
          static SgAsmJvmAttributeTable * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmJvmAttributeTable * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmJvmAttributeTable::operator delete (pointer,sizeof(SgAsmJvmAttributeTable));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmJvmAttributeTable* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmJvmAttributeTable* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmJvmAttributeTable* sgnode);
     ...
     public:
       ...
       */
       // SgAsmJvmAttributeTable( SgAsmJvmAttributeTableStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmJvmAttributeTableStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmJvmAttributeTable( const SgAsmJvmAttributeTableStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmJvmAttributeTable* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmJvmAttributeTable* isSgAsmJvmAttributeTable ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmJvmAttributeTable>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmJvmAttributeTable, SgAsmJvmAttributePtrList,&SgAsmJvmAttributeTable::p_attributes>;
...
// postdeclarations for SgAsmJvmAttributeTable

/* #line 530 "/workspace/generated/src/frontend/SageIII//SgAsmJvmAttributeTable.h" */
...
/* #line 537 "/workspace/generated/src/frontend/SageIII//SgAsmJvmAttributeTable.h" */

#endif // ROSE_SgAsmJvmAttributeTable_H
