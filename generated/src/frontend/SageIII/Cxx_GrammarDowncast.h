#ifndef ROSE_Cxx_GrammarDowncast_H
#define ROSE_Cxx_GrammarDowncast_H
// #line 2834 "/workspace/src/ROSETTA/src/grammar.C"
#include <RoseFirst.h>
#include <rosedll.h>
ROSE_DLL_API SgJovialBitVal* isSgJovialBitVal(SgNode* node);
ROSE_DLL_API const SgJovialBitVal* isSgJovialBitVal(const SgNode* node);
...
ROSE_DLL_API SgStructureModifier* isSgStructureModifier(SgNode* node);
ROSE_DLL_API const SgStructureModifier* isSgStructureModifier(const SgNode* node);
...
ROSE_DLL_API SgJvmComposite* isSgJvmComposite(SgNode* node);
ROSE_DLL_API const SgJvmComposite* isSgJvmComposite(const SgNode* node);
...
ROSE_DLL_API SgIncludeFile* isSgIncludeFile(SgNode* node);
ROSE_DLL_API const SgIncludeFile* isSgIncludeFile(const SgNode* node);
...
ROSE_DLL_API SgNonrealBaseClass* isSgNonrealBaseClass(SgNode* node);
ROSE_DLL_API const SgNonrealBaseClass* isSgNonrealBaseClass(const SgNode* node);
...
ROSE_DLL_API SgHeaderFileReport* isSgHeaderFileReport(SgNode* node);
ROSE_DLL_API const SgHeaderFileReport* isSgHeaderFileReport(const SgNode* node);
...
ROSE_DLL_API SgTypeFloat80* isSgTypeFloat80(SgNode* node);
ROSE_DLL_API const SgTypeFloat80* isSgTypeFloat80(const SgNode* node);
ROSE_DLL_API SgTypeFloat128* isSgTypeFloat128(SgNode* node);
ROSE_DLL_API const SgTypeFloat128* isSgTypeFloat128(const SgNode* node);
...
ROSE_DLL_API SgTypeFloat16* isSgTypeFloat16(SgNode* node);
ROSE_DLL_API const SgTypeFloat16* isSgTypeFloat16(const SgNode* node);
ROSE_DLL_API SgTypeFp16* isSgTypeFp16(SgNode* node);
ROSE_DLL_API const SgTypeFp16* isSgTypeFp16(const SgNode* node);
ROSE_DLL_API SgTypeBFloat16* isSgTypeBFloat16(SgNode* node);
ROSE_DLL_API const SgTypeBFloat16* isSgTypeBFloat16(const SgNode* node);
ROSE_DLL_API SgTypeFloat32x* isSgTypeFloat32x(SgNode* node);
ROSE_DLL_API const SgTypeFloat32x* isSgTypeFloat32x(const SgNode* node);
ROSE_DLL_API SgTypeFloat64x* isSgTypeFloat64x(SgNode* node);
ROSE_DLL_API const SgTypeFloat64x* isSgTypeFloat64x(const SgNode* node);
ROSE_DLL_API SgTypeFloat32* isSgTypeFloat32(SgNode* node);
ROSE_DLL_API const SgTypeFloat32* isSgTypeFloat32(const SgNode* node);
ROSE_DLL_API SgTypeFloat64* isSgTypeFloat64(SgNode* node);
ROSE_DLL_API const SgTypeFloat64* isSgTypeFloat64(const SgNode* node);
ROSE_DLL_API SgTypeFixed* isSgTypeFixed(SgNode* node);
ROSE_DLL_API const SgTypeFixed* isSgTypeFixed(const SgNode* node);
ROSE_DLL_API SgTypeMatrix* isSgTypeMatrix(SgNode* node);
ROSE_DLL_API const SgTypeMatrix* isSgTypeMatrix(const SgNode* node);
ROSE_DLL_API SgTypeTuple* isSgTypeTuple(SgNode* node);
ROSE_DLL_API const SgTypeTuple* isSgTypeTuple(const SgNode* node);
ROSE_DLL_API SgTypeNullptr* isSgTypeNullptr(SgNode* node);
ROSE_DLL_API const SgTypeNullptr* isSgTypeNullptr(const SgNode* node);
...
ROSE_DLL_API SgRvalueReferenceType* isSgRvalueReferenceType(SgNode* node);
ROSE_DLL_API const SgRvalueReferenceType* isSgRvalueReferenceType(const SgNode* node);
ROSE_DLL_API SgDeclType* isSgDeclType(SgNode* node);
ROSE_DLL_API const SgDeclType* isSgDeclType(const SgNode* node);
ROSE_DLL_API SgTypeOfType* isSgTypeOfType(SgNode* node);
ROSE_DLL_API const SgTypeOfType* isSgTypeOfType(const SgNode* node);
...
ROSE_DLL_API SgJovialTableType* isSgJovialTableType(SgNode* node);
ROSE_DLL_API const SgJovialTableType* isSgJovialTableType(const SgNode* node);
...
ROSE_DLL_API SgNonrealType* isSgNonrealType(SgNode* node);
ROSE_DLL_API const SgNonrealType* isSgNonrealType(const SgNode* node);
ROSE_DLL_API SgAutoType* isSgAutoType(SgNode* node);
ROSE_DLL_API const SgAutoType* isSgAutoType(const SgNode* node);
...
ROSE_DLL_API SgAdaAccessType* isSgAdaAccessType(SgNode* node);
ROSE_DLL_API const SgAdaAccessType* isSgAdaAccessType(const SgNode* node);
ROSE_DLL_API SgAdaSubtype* isSgAdaSubtype(SgNode* node);
ROSE_DLL_API const SgAdaSubtype* isSgAdaSubtype(const SgNode* node);
ROSE_DLL_API SgAdaDerivedType* isSgAdaDerivedType(SgNode* node);
ROSE_DLL_API const SgAdaDerivedType* isSgAdaDerivedType(const SgNode* node);
ROSE_DLL_API SgAdaModularType* isSgAdaModularType(SgNode* node);
ROSE_DLL_API const SgAdaModularType* isSgAdaModularType(const SgNode* node);
ROSE_DLL_API SgAdaDiscriminatedType* isSgAdaDiscriminatedType(SgNode* node);
ROSE_DLL_API const SgAdaDiscriminatedType* isSgAdaDiscriminatedType(const SgNode* node);
ROSE_DLL_API SgAdaFormalType* isSgAdaFormalType(SgNode* node);
ROSE_DLL_API const SgAdaFormalType* isSgAdaFormalType(const SgNode* node);
ROSE_DLL_API SgAdaDiscreteType* isSgAdaDiscreteType(SgNode* node);
ROSE_DLL_API const SgAdaDiscreteType* isSgAdaDiscreteType(const SgNode* node);
ROSE_DLL_API SgAdaSubroutineType* isSgAdaSubroutineType(SgNode* node);
ROSE_DLL_API const SgAdaSubroutineType* isSgAdaSubroutineType(const SgNode* node);
ROSE_DLL_API SgRangeType* isSgRangeType(SgNode* node);
ROSE_DLL_API const SgRangeType* isSgRangeType(const SgNode* node);
ROSE_DLL_API SgJovialBitType* isSgJovialBitType(SgNode* node);
ROSE_DLL_API const SgJovialBitType* isSgJovialBitType(const SgNode* node);
...
ROSE_DLL_API SgAdaTaskType* isSgAdaTaskType(SgNode* node);
ROSE_DLL_API const SgAdaTaskType* isSgAdaTaskType(const SgNode* node);
ROSE_DLL_API SgAdaProtectedType* isSgAdaProtectedType(SgNode* node);
ROSE_DLL_API const SgAdaProtectedType* isSgAdaProtectedType(const SgNode* node);
ROSE_DLL_API SgScopedType* isSgScopedType(SgNode* node);
ROSE_DLL_API const SgScopedType* isSgScopedType(const SgNode* node);
...
ROSE_DLL_API SgTypeChar16* isSgTypeChar16(SgNode* node);
ROSE_DLL_API const SgTypeChar16* isSgTypeChar16(const SgNode* node);
ROSE_DLL_API SgTypeChar32* isSgTypeChar32(SgNode* node);
ROSE_DLL_API const SgTypeChar32* isSgTypeChar32(const SgNode* node);
ROSE_DLL_API SgSignedIntegralType* isSgSignedIntegralType(SgNode* node);
ROSE_DLL_API const SgSignedIntegralType* isSgSignedIntegralType(const SgNode* node);
ROSE_DLL_API SgUnsignedIntegralType* isSgUnsignedIntegralType(SgNode* node);
ROSE_DLL_API const SgUnsignedIntegralType* isSgUnsignedIntegralType(const SgNode* node);
ROSE_DLL_API SgIntegralType* isSgIntegralType(SgNode* node);
ROSE_DLL_API const SgIntegralType* isSgIntegralType(const SgNode* node);
ROSE_DLL_API SgFloatingPointType* isSgFloatingPointType(SgNode* node);
ROSE_DLL_API const SgFloatingPointType* isSgFloatingPointType(const SgNode* node);
...
ROSE_DLL_API SgRangeBasedForStatement* isSgRangeBasedForStatement(SgNode* node);
ROSE_DLL_API const SgRangeBasedForStatement* isSgRangeBasedForStatement(const SgNode* node);
...
ROSE_DLL_API SgAdaParameterList* isSgAdaParameterList(SgNode* node);
ROSE_DLL_API const SgAdaParameterList* isSgAdaParameterList(const SgNode* node);
...
ROSE_DLL_API SgFunctionParameterScope* isSgFunctionParameterScope(SgNode* node);
ROSE_DLL_API const SgFunctionParameterScope* isSgFunctionParameterScope(const SgNode* node);
ROSE_DLL_API SgDeclarationScope* isSgDeclarationScope(SgNode* node);
ROSE_DLL_API const SgDeclarationScope* isSgDeclarationScope(const SgNode* node);
...
ROSE_DLL_API SgAdaExitStmt* isSgAdaExitStmt(SgNode* node);
ROSE_DLL_API const SgAdaExitStmt* isSgAdaExitStmt(const SgNode* node);
ROSE_DLL_API SgAdaLoopStmt* isSgAdaLoopStmt(SgNode* node);
ROSE_DLL_API const SgAdaLoopStmt* isSgAdaLoopStmt(const SgNode* node);
ROSE_DLL_API SgAdaDelayStmt* isSgAdaDelayStmt(SgNode* node);
ROSE_DLL_API const SgAdaDelayStmt* isSgAdaDelayStmt(const SgNode* node);
ROSE_DLL_API SgAdaSelectStmt* isSgAdaSelectStmt(SgNode* node);
ROSE_DLL_API const SgAdaSelectStmt* isSgAdaSelectStmt(const SgNode* node);
ROSE_DLL_API SgAdaSelectAlternativeStmt* isSgAdaSelectAlternativeStmt(SgNode* node);
ROSE_DLL_API const SgAdaSelectAlternativeStmt* isSgAdaSelectAlternativeStmt(const SgNode* node);
ROSE_DLL_API SgAdaTerminateStmt* isSgAdaTerminateStmt(SgNode* node);
ROSE_DLL_API const SgAdaTerminateStmt* isSgAdaTerminateStmt(const SgNode* node);
ROSE_DLL_API SgAdaUnscopedBlock* isSgAdaUnscopedBlock(SgNode* node);
ROSE_DLL_API const SgAdaUnscopedBlock* isSgAdaUnscopedBlock(const SgNode* node);
ROSE_DLL_API SgAdaVariantWhenStmt* isSgAdaVariantWhenStmt(SgNode* node);
ROSE_DLL_API const SgAdaVariantWhenStmt* isSgAdaVariantWhenStmt(const SgNode* node);
ROSE_DLL_API SgSpawnStmt* isSgSpawnStmt(SgNode* node);
ROSE_DLL_API const SgSpawnStmt* isSgSpawnStmt(const SgNode* node);
ROSE_DLL_API SgFortranContinueStmt* isSgFortranContinueStmt(SgNode* node);
ROSE_DLL_API const SgFortranContinueStmt* isSgFortranContinueStmt(const SgNode* node);
ROSE_DLL_API SgTemplateTypedefDeclaration* isSgTemplateTypedefDeclaration(SgNode* node);
ROSE_DLL_API const SgTemplateTypedefDeclaration* isSgTemplateTypedefDeclaration(const SgNode* node);
ROSE_DLL_API SgTemplateInstantiationTypedefDeclaration* isSgTemplateInstantiationTypedefDeclaration(SgNode* node);
ROSE_DLL_API const SgTemplateInstantiationTypedefDeclaration* isSgTemplateInstantiationTypedefDeclaration(const SgNode* node);
...
ROSE_DLL_API SgTemplateVariableInstantiation* isSgTemplateVariableInstantiation(SgNode* node);
ROSE_DLL_API const SgTemplateVariableInstantiation* isSgTemplateVariableInstantiation(const SgNode* node);
...
ROSE_DLL_API SgNonrealDecl* isSgNonrealDecl(SgNode* node);
ROSE_DLL_API const SgNonrealDecl* isSgNonrealDecl(const SgNode* node);
...
ROSE_DLL_API SgProcessControlStatement* isSgProcessControlStatement(SgNode* node);
ROSE_DLL_API const SgProcessControlStatement* isSgProcessControlStatement(const SgNode* node);
...
ROSE_DLL_API SgSyncAllStatement* isSgSyncAllStatement(SgNode* node);
ROSE_DLL_API const SgSyncAllStatement* isSgSyncAllStatement(const SgNode* node);
ROSE_DLL_API SgSyncImagesStatement* isSgSyncImagesStatement(SgNode* node);
ROSE_DLL_API const SgSyncImagesStatement* isSgSyncImagesStatement(const SgNode* node);
ROSE_DLL_API SgSyncMemoryStatement* isSgSyncMemoryStatement(SgNode* node);
ROSE_DLL_API const SgSyncMemoryStatement* isSgSyncMemoryStatement(const SgNode* node);
ROSE_DLL_API SgSyncTeamStatement* isSgSyncTeamStatement(SgNode* node);
ROSE_DLL_API const SgSyncTeamStatement* isSgSyncTeamStatement(const SgNode* node);
ROSE_DLL_API SgLockStatement* isSgLockStatement(SgNode* node);
ROSE_DLL_API const SgLockStatement* isSgLockStatement(const SgNode* node);
ROSE_DLL_API SgUnlockStatement* isSgUnlockStatement(SgNode* node);
ROSE_DLL_API const SgUnlockStatement* isSgUnlockStatement(const SgNode* node);
ROSE_DLL_API SgImageControlStatement* isSgImageControlStatement(SgNode* node);
ROSE_DLL_API const SgImageControlStatement* isSgImageControlStatement(const SgNode* node);
ROSE_DLL_API SgJovialCompoolStatement* isSgJovialCompoolStatement(SgNode* node);
ROSE_DLL_API const SgJovialCompoolStatement* isSgJovialCompoolStatement(const SgNode* node);
ROSE_DLL_API SgJovialDefineDeclaration* isSgJovialDefineDeclaration(SgNode* node);
ROSE_DLL_API const SgJovialDefineDeclaration* isSgJovialDefineDeclaration(const SgNode* node);
ROSE_DLL_API SgJovialDirectiveStatement* isSgJovialDirectiveStatement(SgNode* node);
ROSE_DLL_API const SgJovialDirectiveStatement* isSgJovialDirectiveStatement(const SgNode* node);
ROSE_DLL_API SgJovialLabelDeclaration* isSgJovialLabelDeclaration(SgNode* node);
ROSE_DLL_API const SgJovialLabelDeclaration* isSgJovialLabelDeclaration(const SgNode* node);
ROSE_DLL_API SgJovialOverlayDeclaration* isSgJovialOverlayDeclaration(SgNode* node);
ROSE_DLL_API const SgJovialOverlayDeclaration* isSgJovialOverlayDeclaration(const SgNode* node);
ROSE_DLL_API SgJovialForThenStatement* isSgJovialForThenStatement(SgNode* node);
ROSE_DLL_API const SgJovialForThenStatement* isSgJovialForThenStatement(const SgNode* node);
ROSE_DLL_API SgMatlabForStatement* isSgMatlabForStatement(SgNode* node);
ROSE_DLL_API const SgMatlabForStatement* isSgMatlabForStatement(const SgNode* node);
...
ROSE_DLL_API SgOmpForSimdStatement* isSgOmpForSimdStatement(SgNode* node);
ROSE_DLL_API const SgOmpForSimdStatement* isSgOmpForSimdStatement(const SgNode* node);
...
ROSE_DLL_API SgAsyncStmt* isSgAsyncStmt(SgNode* node);
ROSE_DLL_API const SgAsyncStmt* isSgAsyncStmt(const SgNode* node);
ROSE_DLL_API SgFinishStmt* isSgFinishStmt(SgNode* node);
ROSE_DLL_API const SgFinishStmt* isSgFinishStmt(const SgNode* node);
ROSE_DLL_API SgAtStmt* isSgAtStmt(SgNode* node);
ROSE_DLL_API const SgAtStmt* isSgAtStmt(const SgNode* node);
ROSE_DLL_API SgAtomicStmt* isSgAtomicStmt(SgNode* node);
ROSE_DLL_API const SgAtomicStmt* isSgAtomicStmt(const SgNode* node);
ROSE_DLL_API SgWhenStmt* isSgWhenStmt(SgNode* node);
ROSE_DLL_API const SgWhenStmt* isSgWhenStmt(const SgNode* node);
...
ROSE_DLL_API SgJovialTableStatement* isSgJovialTableStatement(SgNode* node);
ROSE_DLL_API const SgJovialTableStatement* isSgJovialTableStatement(const SgNode* node);
...
ROSE_DLL_API SgStaticAssertionDeclaration* isSgStaticAssertionDeclaration(SgNode* node);
ROSE_DLL_API const SgStaticAssertionDeclaration* isSgStaticAssertionDeclaration(const SgNode* node);
...
ROSE_DLL_API SgAdaAcceptStmt* isSgAdaAcceptStmt(SgNode* node);
ROSE_DLL_API const SgAdaAcceptStmt* isSgAdaAcceptStmt(const SgNode* node);
ROSE_DLL_API SgAdaPackageBody* isSgAdaPackageBody(SgNode* node);
ROSE_DLL_API const SgAdaPackageBody* isSgAdaPackageBody(const SgNode* node);
ROSE_DLL_API SgAdaPackageSpec* isSgAdaPackageSpec(SgNode* node);
ROSE_DLL_API const SgAdaPackageSpec* isSgAdaPackageSpec(const SgNode* node);
ROSE_DLL_API SgAdaTaskBody* isSgAdaTaskBody(SgNode* node);
ROSE_DLL_API const SgAdaTaskBody* isSgAdaTaskBody(const SgNode* node);
ROSE_DLL_API SgAdaTaskSpec* isSgAdaTaskSpec(SgNode* node);
ROSE_DLL_API const SgAdaTaskSpec* isSgAdaTaskSpec(const SgNode* node);
ROSE_DLL_API SgAdaProtectedBody* isSgAdaProtectedBody(SgNode* node);
ROSE_DLL_API const SgAdaProtectedBody* isSgAdaProtectedBody(const SgNode* node);
ROSE_DLL_API SgAdaProtectedSpec* isSgAdaProtectedSpec(SgNode* node);
ROSE_DLL_API const SgAdaProtectedSpec* isSgAdaProtectedSpec(const SgNode* node);
ROSE_DLL_API SgAdaGenericDefn* isSgAdaGenericDefn(SgNode* node);
ROSE_DLL_API const SgAdaGenericDefn* isSgAdaGenericDefn(const SgNode* node);
...
ROSE_DLL_API SgAdaEntryDecl* isSgAdaEntryDecl(SgNode* node);
ROSE_DLL_API const SgAdaEntryDecl* isSgAdaEntryDecl(const SgNode* node);
ROSE_DLL_API SgAdaFunctionRenamingDecl* isSgAdaFunctionRenamingDecl(SgNode* node);
ROSE_DLL_API const SgAdaFunctionRenamingDecl* isSgAdaFunctionRenamingDecl(const SgNode* node);
...
ROSE_DLL_API SgOmpDeclareSimdStatement* isSgOmpDeclareSimdStatement(SgNode* node);
ROSE_DLL_API const SgOmpDeclareSimdStatement* isSgOmpDeclareSimdStatement(const SgNode* node);
...
ROSE_DLL_API SgMicrosoftAttributeDeclaration* isSgMicrosoftAttributeDeclaration(SgNode* node);
ROSE_DLL_API const SgMicrosoftAttributeDeclaration* isSgMicrosoftAttributeDeclaration(const SgNode* node);
ROSE_DLL_API SgEmptyDeclaration* isSgEmptyDeclaration(SgNode* node);
ROSE_DLL_API const SgEmptyDeclaration* isSgEmptyDeclaration(const SgNode* node);
ROSE_DLL_API SgAdaPackageSpecDecl* isSgAdaPackageSpecDecl(SgNode* node);
ROSE_DLL_API const SgAdaPackageSpecDecl* isSgAdaPackageSpecDecl(const SgNode* node);
ROSE_DLL_API SgAdaPackageBodyDecl* isSgAdaPackageBodyDecl(SgNode* node);
ROSE_DLL_API const SgAdaPackageBodyDecl* isSgAdaPackageBodyDecl(const SgNode* node);
ROSE_DLL_API SgAdaTaskSpecDecl* isSgAdaTaskSpecDecl(SgNode* node);
ROSE_DLL_API const SgAdaTaskSpecDecl* isSgAdaTaskSpecDecl(const SgNode* node);
ROSE_DLL_API SgAdaTaskTypeDecl* isSgAdaTaskTypeDecl(SgNode* node);
ROSE_DLL_API const SgAdaTaskTypeDecl* isSgAdaTaskTypeDecl(const SgNode* node);
ROSE_DLL_API SgAdaTaskBodyDecl* isSgAdaTaskBodyDecl(SgNode* node);
ROSE_DLL_API const SgAdaTaskBodyDecl* isSgAdaTaskBodyDecl(const SgNode* node);
ROSE_DLL_API SgAdaProtectedSpecDecl* isSgAdaProtectedSpecDecl(SgNode* node);
ROSE_DLL_API const SgAdaProtectedSpecDecl* isSgAdaProtectedSpecDecl(const SgNode* node);
ROSE_DLL_API SgAdaProtectedTypeDecl* isSgAdaProtectedTypeDecl(SgNode* node);
ROSE_DLL_API const SgAdaProtectedTypeDecl* isSgAdaProtectedTypeDecl(const SgNode* node);
ROSE_DLL_API SgAdaProtectedBodyDecl* isSgAdaProtectedBodyDecl(SgNode* node);
ROSE_DLL_API const SgAdaProtectedBodyDecl* isSgAdaProtectedBodyDecl(const SgNode* node);
ROSE_DLL_API SgAdaRepresentationClause* isSgAdaRepresentationClause(SgNode* node);
ROSE_DLL_API const SgAdaRepresentationClause* isSgAdaRepresentationClause(const SgNode* node);
ROSE_DLL_API SgAdaEnumRepresentationClause* isSgAdaEnumRepresentationClause(SgNode* node);
ROSE_DLL_API const SgAdaEnumRepresentationClause* isSgAdaEnumRepresentationClause(const SgNode* node);
ROSE_DLL_API SgAdaAttributeClause* isSgAdaAttributeClause(SgNode* node);
ROSE_DLL_API const SgAdaAttributeClause* isSgAdaAttributeClause(const SgNode* node);
ROSE_DLL_API SgAdaComponentClause* isSgAdaComponentClause(SgNode* node);
ROSE_DLL_API const SgAdaComponentClause* isSgAdaComponentClause(const SgNode* node);
ROSE_DLL_API SgAdaRenamingDecl* isSgAdaRenamingDecl(SgNode* node);
ROSE_DLL_API const SgAdaRenamingDecl* isSgAdaRenamingDecl(const SgNode* node);
ROSE_DLL_API SgAdaGenericDecl* isSgAdaGenericDecl(SgNode* node);
ROSE_DLL_API const SgAdaGenericDecl* isSgAdaGenericDecl(const SgNode* node);
ROSE_DLL_API SgAdaGenericInstanceDecl* isSgAdaGenericInstanceDecl(SgNode* node);
ROSE_DLL_API const SgAdaGenericInstanceDecl* isSgAdaGenericInstanceDecl(const SgNode* node);
ROSE_DLL_API SgAdaFormalTypeDecl* isSgAdaFormalTypeDecl(SgNode* node);
ROSE_DLL_API const SgAdaFormalTypeDecl* isSgAdaFormalTypeDecl(const SgNode* node);
ROSE_DLL_API SgAdaFormalPackageDecl* isSgAdaFormalPackageDecl(SgNode* node);
ROSE_DLL_API const SgAdaFormalPackageDecl* isSgAdaFormalPackageDecl(const SgNode* node);
ROSE_DLL_API SgAdaDiscriminatedTypeDecl* isSgAdaDiscriminatedTypeDecl(SgNode* node);
ROSE_DLL_API const SgAdaDiscriminatedTypeDecl* isSgAdaDiscriminatedTypeDecl(const SgNode* node);
ROSE_DLL_API SgAdaVariantDecl* isSgAdaVariantDecl(SgNode* node);
ROSE_DLL_API const SgAdaVariantDecl* isSgAdaVariantDecl(const SgNode* node);
...
ROSE_DLL_API SgAbsOp* isSgAbsOp(SgNode* node);
ROSE_DLL_API const SgAbsOp* isSgAbsOp(const SgNode* node);
...
ROSE_DLL_API SgAdaAncestorInitializer* isSgAdaAncestorInitializer(SgNode* node);
ROSE_DLL_API const SgAdaAncestorInitializer* isSgAdaAncestorInitializer(const SgNode* node);
ROSE_DLL_API SgAdaAttributeExp* isSgAdaAttributeExp(SgNode* node);
ROSE_DLL_API const SgAdaAttributeExp* isSgAdaAttributeExp(const SgNode* node);
ROSE_DLL_API SgAdaFloatVal* isSgAdaFloatVal(SgNode* node);
ROSE_DLL_API const SgAdaFloatVal* isSgAdaFloatVal(const SgNode* node);
ROSE_DLL_API SgAdaOthersExp* isSgAdaOthersExp(SgNode* node);
ROSE_DLL_API const SgAdaOthersExp* isSgAdaOthersExp(const SgNode* node);
ROSE_DLL_API SgAdaProtectedRefExp* isSgAdaProtectedRefExp(SgNode* node);
ROSE_DLL_API const SgAdaProtectedRefExp* isSgAdaProtectedRefExp(const SgNode* node);
ROSE_DLL_API SgAdaRenamingRefExp* isSgAdaRenamingRefExp(SgNode* node);
ROSE_DLL_API const SgAdaRenamingRefExp* isSgAdaRenamingRefExp(const SgNode* node);
ROSE_DLL_API SgAdaTaskRefExp* isSgAdaTaskRefExp(SgNode* node);
ROSE_DLL_API const SgAdaTaskRefExp* isSgAdaTaskRefExp(const SgNode* node);
ROSE_DLL_API SgAdaUnitRefExp* isSgAdaUnitRefExp(SgNode* node);
ROSE_DLL_API const SgAdaUnitRefExp* isSgAdaUnitRefExp(const SgNode* node);
...
ROSE_DLL_API SgAtExp* isSgAtExp(SgNode* node);
ROSE_DLL_API const SgAtExp* isSgAtExp(const SgNode* node);
ROSE_DLL_API SgAtOp* isSgAtOp(SgNode* node);
ROSE_DLL_API const SgAtOp* isSgAtOp(const SgNode* node);
ROSE_DLL_API SgAwaitExpression* isSgAwaitExpression(SgNode* node);
ROSE_DLL_API const SgAwaitExpression* isSgAwaitExpression(const SgNode* node);
...
ROSE_DLL_API SgBitEqvOp* isSgBitEqvOp(SgNode* node);
ROSE_DLL_API const SgBitEqvOp* isSgBitEqvOp(const SgNode* node);
...
ROSE_DLL_API SgBracedInitializer* isSgBracedInitializer(SgNode* node);
ROSE_DLL_API const SgBracedInitializer* isSgBracedInitializer(const SgNode* node);
...
ROSE_DLL_API SgChar16Val* isSgChar16Val(SgNode* node);
ROSE_DLL_API const SgChar16Val* isSgChar16Val(const SgNode* node);
ROSE_DLL_API SgChar32Val* isSgChar32Val(SgNode* node);
ROSE_DLL_API const SgChar32Val* isSgChar32Val(const SgNode* node);
ROSE_DLL_API SgCharVal* isSgCharVal(SgNode* node);
ROSE_DLL_API const SgCharVal* isSgCharVal(const SgNode* node);
ROSE_DLL_API SgChooseExpression* isSgChooseExpression(SgNode* node);
ROSE_DLL_API const SgChooseExpression* isSgChooseExpression(const SgNode* node);
...
ROSE_DLL_API SgDotDotExp* isSgDotDotExp(SgNode* node);
ROSE_DLL_API const SgDotDotExp* isSgDotDotExp(const SgNode* node);
...
ROSE_DLL_API SgElementwiseAddOp* isSgElementwiseAddOp(SgNode* node);
ROSE_DLL_API const SgElementwiseAddOp* isSgElementwiseAddOp(const SgNode* node);
ROSE_DLL_API SgElementwiseDivideOp* isSgElementwiseDivideOp(SgNode* node);
ROSE_DLL_API const SgElementwiseDivideOp* isSgElementwiseDivideOp(const SgNode* node);
ROSE_DLL_API SgElementwiseLeftDivideOp* isSgElementwiseLeftDivideOp(SgNode* node);
ROSE_DLL_API const SgElementwiseLeftDivideOp* isSgElementwiseLeftDivideOp(const SgNode* node);
ROSE_DLL_API SgElementwiseMultiplyOp* isSgElementwiseMultiplyOp(SgNode* node);
ROSE_DLL_API const SgElementwiseMultiplyOp* isSgElementwiseMultiplyOp(const SgNode* node);
ROSE_DLL_API SgElementwisePowerOp* isSgElementwisePowerOp(SgNode* node);
ROSE_DLL_API const SgElementwisePowerOp* isSgElementwisePowerOp(const SgNode* node);
ROSE_DLL_API SgElementwiseSubtractOp* isSgElementwiseSubtractOp(SgNode* node);
ROSE_DLL_API const SgElementwiseSubtractOp* isSgElementwiseSubtractOp(const SgNode* node);
...
ROSE_DLL_API SgFinishExp* isSgFinishExp(SgNode* node);
ROSE_DLL_API const SgFinishExp* isSgFinishExp(const SgNode* node);
ROSE_DLL_API SgFloat128Val* isSgFloat128Val(SgNode* node);
ROSE_DLL_API const SgFloat128Val* isSgFloat128Val(const SgNode* node);
ROSE_DLL_API SgFloat80Val* isSgFloat80Val(SgNode* node);
ROSE_DLL_API const SgFloat80Val* isSgFloat80Val(const SgNode* node);
ROSE_DLL_API SgBFloat16Val* isSgBFloat16Val(SgNode* node);
ROSE_DLL_API const SgBFloat16Val* isSgBFloat16Val(const SgNode* node);
ROSE_DLL_API SgFloat16Val* isSgFloat16Val(SgNode* node);
ROSE_DLL_API const SgFloat16Val* isSgFloat16Val(const SgNode* node);
ROSE_DLL_API SgFloat32Val* isSgFloat32Val(SgNode* node);
ROSE_DLL_API const SgFloat32Val* isSgFloat32Val(const SgNode* node);
ROSE_DLL_API SgFloat64Val* isSgFloat64Val(SgNode* node);
ROSE_DLL_API const SgFloat64Val* isSgFloat64Val(const SgNode* node);
ROSE_DLL_API SgFloatVal* isSgFloatVal(SgNode* node);
ROSE_DLL_API const SgFloatVal* isSgFloatVal(const SgNode* node);
ROSE_DLL_API SgFoldExpression* isSgFoldExpression(SgNode* node);
ROSE_DLL_API const SgFoldExpression* isSgFoldExpression(const SgNode* node);
ROSE_DLL_API SgFunctionParameterRefExp* isSgFunctionParameterRefExp(SgNode* node);
ROSE_DLL_API const SgFunctionParameterRefExp* isSgFunctionParameterRefExp(const SgNode* node);
...
ROSE_DLL_API SgHereExp* isSgHereExp(SgNode* node);
ROSE_DLL_API const SgHereExp* isSgHereExp(const SgNode* node);
...
ROSE_DLL_API SgJovialPresetPositionExp* isSgJovialPresetPositionExp(SgNode* node);
ROSE_DLL_API const SgJovialPresetPositionExp* isSgJovialPresetPositionExp(const SgNode* node);
ROSE_DLL_API SgJovialTablePresetExp* isSgJovialTablePresetExp(SgNode* node);
ROSE_DLL_API const SgJovialTablePresetExp* isSgJovialTablePresetExp(const SgNode* node);
...
ROSE_DLL_API SgLambdaExp* isSgLambdaExp(SgNode* node);
ROSE_DLL_API const SgLambdaExp* isSgLambdaExp(const SgNode* node);
...
ROSE_DLL_API SgLeftDivideOp* isSgLeftDivideOp(SgNode* node);
ROSE_DLL_API const SgLeftDivideOp* isSgLeftDivideOp(const SgNode* node);
...
ROSE_DLL_API SgMagicColonExp* isSgMagicColonExp(SgNode* node);
ROSE_DLL_API const SgMagicColonExp* isSgMagicColonExp(const SgNode* node);
ROSE_DLL_API SgMatrixExp* isSgMatrixExp(SgNode* node);
ROSE_DLL_API const SgMatrixExp* isSgMatrixExp(const SgNode* node);
ROSE_DLL_API SgMatrixTransposeOp* isSgMatrixTransposeOp(SgNode* node);
ROSE_DLL_API const SgMatrixTransposeOp* isSgMatrixTransposeOp(const SgNode* node);
...
ROSE_DLL_API SgNoexceptOp* isSgNoexceptOp(SgNode* node);
ROSE_DLL_API const SgNoexceptOp* isSgNoexceptOp(const SgNode* node);
...
ROSE_DLL_API SgNonrealRefExp* isSgNonrealRefExp(SgNode* node);
ROSE_DLL_API const SgNonrealRefExp* isSgNonrealRefExp(const SgNode* node);
...
ROSE_DLL_API SgNullptrValExp* isSgNullptrValExp(SgNode* node);
ROSE_DLL_API const SgNullptrValExp* isSgNullptrValExp(const SgNode* node);
...
ROSE_DLL_API SgPowerOp* isSgPowerOp(SgNode* node);
ROSE_DLL_API const SgPowerOp* isSgPowerOp(const SgNode* node);
...
ROSE_DLL_API SgRangeExp* isSgRangeExp(SgNode* node);
ROSE_DLL_API const SgRangeExp* isSgRangeExp(const SgNode* node);
...
ROSE_DLL_API SgRemOp* isSgRemOp(SgNode* node);
ROSE_DLL_API const SgRemOp* isSgRemOp(const SgNode* node);
ROSE_DLL_API SgReplicationOp* isSgReplicationOp(SgNode* node);
ROSE_DLL_API const SgReplicationOp* isSgReplicationOp(const SgNode* node);
...
ROSE_DLL_API SgSpaceshipOp* isSgSpaceshipOp(SgNode* node);
ROSE_DLL_API const SgSpaceshipOp* isSgSpaceshipOp(const SgNode* node);
...
ROSE_DLL_API SgTypeExpression* isSgTypeExpression(SgNode* node);
ROSE_DLL_API const SgTypeExpression* isSgTypeExpression(const SgNode* node);
...
ROSE_DLL_API SgSignedCharVal* isSgSignedCharVal(SgNode* node);
ROSE_DLL_API const SgSignedCharVal* isSgSignedCharVal(const SgNode* node);
...
ROSE_DLL_API SgVoidVal* isSgVoidVal(SgNode* node);
ROSE_DLL_API const SgVoidVal* isSgVoidVal(const SgNode* node);
...
ROSE_DLL_API SgElementwiseOp* isSgElementwiseOp(SgNode* node);
ROSE_DLL_API const SgElementwiseOp* isSgElementwiseOp(const SgNode* node);
...
ROSE_DLL_API SgScopedRefExp* isSgScopedRefExp(SgNode* node);
ROSE_DLL_API const SgScopedRefExp* isSgScopedRefExp(const SgNode* node);
ROSE_DLL_API SgTypeRefExp* isSgTypeRefExp(SgNode* node);
ROSE_DLL_API const SgTypeRefExp* isSgTypeRefExp(const SgNode* node);
ROSE_DLL_API SgReferenceExp* isSgReferenceExp(SgNode* node);
ROSE_DLL_API const SgReferenceExp* isSgReferenceExp(const SgNode* node);
...
ROSE_DLL_API SgTemplateTypedefSymbol* isSgTemplateTypedefSymbol(SgNode* node);
ROSE_DLL_API const SgTemplateTypedefSymbol* isSgTemplateTypedefSymbol(const SgNode* node);
...
ROSE_DLL_API SgAdaInheritedFunctionSymbol* isSgAdaInheritedFunctionSymbol(SgNode* node);
ROSE_DLL_API const SgAdaInheritedFunctionSymbol* isSgAdaInheritedFunctionSymbol(const SgNode* node);
...
ROSE_DLL_API SgTypeSymbol* isSgTypeSymbol(SgNode* node);
ROSE_DLL_API const SgTypeSymbol* isSgTypeSymbol(const SgNode* node);
...
ROSE_DLL_API SgNonrealSymbol* isSgNonrealSymbol(SgNode* node);
ROSE_DLL_API const SgNonrealSymbol* isSgNonrealSymbol(const SgNode* node);
ROSE_DLL_API SgAdaPackageSymbol* isSgAdaPackageSymbol(SgNode* node);
ROSE_DLL_API const SgAdaPackageSymbol* isSgAdaPackageSymbol(const SgNode* node);
ROSE_DLL_API SgAdaTaskSymbol* isSgAdaTaskSymbol(SgNode* node);
ROSE_DLL_API const SgAdaTaskSymbol* isSgAdaTaskSymbol(const SgNode* node);
ROSE_DLL_API SgAdaProtectedSymbol* isSgAdaProtectedSymbol(SgNode* node);
ROSE_DLL_API const SgAdaProtectedSymbol* isSgAdaProtectedSymbol(const SgNode* node);
ROSE_DLL_API SgAdaGenericSymbol* isSgAdaGenericSymbol(SgNode* node);
ROSE_DLL_API const SgAdaGenericSymbol* isSgAdaGenericSymbol(const SgNode* node);
ROSE_DLL_API SgAdaGenericInstanceSymbol* isSgAdaGenericInstanceSymbol(SgNode* node);
ROSE_DLL_API const SgAdaGenericInstanceSymbol* isSgAdaGenericInstanceSymbol(const SgNode* node);
ROSE_DLL_API SgAdaFormalPackageSymbol* isSgAdaFormalPackageSymbol(SgNode* node);
ROSE_DLL_API const SgAdaFormalPackageSymbol* isSgAdaFormalPackageSymbol(const SgNode* node);
ROSE_DLL_API SgAdaRenamingSymbol* isSgAdaRenamingSymbol(SgNode* node);
ROSE_DLL_API const SgAdaRenamingSymbol* isSgAdaRenamingSymbol(const SgNode* node);
...
ROSE_DLL_API SgAsmVoidType* isSgAsmVoidType(SgNode* node);
ROSE_DLL_API const SgAsmVoidType* isSgAsmVoidType(const SgNode* node);
ROSE_DLL_API SgAsmVectorType* isSgAsmVectorType(SgNode* node);
ROSE_DLL_API const SgAsmVectorType* isSgAsmVectorType(const SgNode* node);
ROSE_DLL_API SgAsmUserInstruction* isSgAsmUserInstruction(SgNode* node);
ROSE_DLL_API const SgAsmUserInstruction* isSgAsmUserInstruction(const SgNode* node);
ROSE_DLL_API SgAsmUnaryUnsignedExtend* isSgAsmUnaryUnsignedExtend(SgNode* node);
ROSE_DLL_API const SgAsmUnaryUnsignedExtend* isSgAsmUnaryUnsignedExtend(const SgNode* node);
ROSE_DLL_API SgAsmUnaryTruncate* isSgAsmUnaryTruncate(SgNode* node);
ROSE_DLL_API const SgAsmUnaryTruncate* isSgAsmUnaryTruncate(const SgNode* node);
ROSE_DLL_API SgAsmUnarySignedExtend* isSgAsmUnarySignedExtend(SgNode* node);
ROSE_DLL_API const SgAsmUnarySignedExtend* isSgAsmUnarySignedExtend(const SgNode* node);
...
ROSE_DLL_API SgAsmStackExpression* isSgAsmStackExpression(SgNode* node);
ROSE_DLL_API const SgAsmStackExpression* isSgAsmStackExpression(const SgNode* node);
ROSE_DLL_API SgAsmRiscOperation* isSgAsmRiscOperation(SgNode* node);
ROSE_DLL_API const SgAsmRiscOperation* isSgAsmRiscOperation(const SgNode* node);
ROSE_DLL_API SgAsmRegisterNames* isSgAsmRegisterNames(SgNode* node);
ROSE_DLL_API const SgAsmRegisterNames* isSgAsmRegisterNames(const SgNode* node);
...
ROSE_DLL_API SgAsmPointerType* isSgAsmPointerType(SgNode* node);
ROSE_DLL_API const SgAsmPointerType* isSgAsmPointerType(const SgNode* node);
...
ROSE_DLL_API SgAsmNullInstruction* isSgAsmNullInstruction(SgNode* node);
ROSE_DLL_API const SgAsmNullInstruction* isSgAsmNullInstruction(const SgNode* node);
...
ROSE_DLL_API SgAsmM68kInstruction* isSgAsmM68kInstruction(SgNode* node);
ROSE_DLL_API const SgAsmM68kInstruction* isSgAsmM68kInstruction(const SgNode* node);
...
ROSE_DLL_API SgAsmJvmStackMapVerificationType* isSgAsmJvmStackMapVerificationType(SgNode* node);
ROSE_DLL_API const SgAsmJvmStackMapVerificationType* isSgAsmJvmStackMapVerificationType(const SgNode* node);
ROSE_DLL_API SgAsmJvmStackMapTable* isSgAsmJvmStackMapTable(SgNode* node);
ROSE_DLL_API const SgAsmJvmStackMapTable* isSgAsmJvmStackMapTable(const SgNode* node);
ROSE_DLL_API SgAsmJvmStackMapFrame* isSgAsmJvmStackMapFrame(SgNode* node);
ROSE_DLL_API const SgAsmJvmStackMapFrame* isSgAsmJvmStackMapFrame(const SgNode* node);
ROSE_DLL_API SgAsmJvmRuntimeVisibleAnnotations* isSgAsmJvmRuntimeVisibleAnnotations(SgNode* node);
ROSE_DLL_API const SgAsmJvmRuntimeVisibleAnnotations* isSgAsmJvmRuntimeVisibleAnnotations(const SgNode* node);
ROSE_DLL_API SgAsmJvmRuntimeVisibilityParamAnnotations* isSgAsmJvmRuntimeVisibilityParamAnnotations(SgNode* node);
ROSE_DLL_API const SgAsmJvmRuntimeVisibilityParamAnnotations* isSgAsmJvmRuntimeVisibilityParamAnnotations(const SgNode* node);
ROSE_DLL_API SgAsmJvmRuntimeParameterAnnotation* isSgAsmJvmRuntimeParameterAnnotation(SgNode* node);
ROSE_DLL_API const SgAsmJvmRuntimeParameterAnnotation* isSgAsmJvmRuntimeParameterAnnotation(const SgNode* node);
ROSE_DLL_API SgAsmJvmRuntimeInvisibleAnnotations* isSgAsmJvmRuntimeInvisibleAnnotations(SgNode* node);
ROSE_DLL_API const SgAsmJvmRuntimeInvisibleAnnotations* isSgAsmJvmRuntimeInvisibleAnnotations(const SgNode* node);
ROSE_DLL_API SgAsmJvmRuntimeAnnotationValue* isSgAsmJvmRuntimeAnnotationValue(SgNode* node);
ROSE_DLL_API const SgAsmJvmRuntimeAnnotationValue* isSgAsmJvmRuntimeAnnotationValue(const SgNode* node);
ROSE_DLL_API SgAsmJvmRuntimeAnnotationPair* isSgAsmJvmRuntimeAnnotationPair(SgNode* node);
ROSE_DLL_API const SgAsmJvmRuntimeAnnotationPair* isSgAsmJvmRuntimeAnnotationPair(const SgNode* node);
ROSE_DLL_API SgAsmJvmRuntimeAnnotation* isSgAsmJvmRuntimeAnnotation(SgNode* node);
ROSE_DLL_API const SgAsmJvmRuntimeAnnotation* isSgAsmJvmRuntimeAnnotation(const SgNode* node);
ROSE_DLL_API SgAsmJvmModule* isSgAsmJvmModule(SgNode* node);
ROSE_DLL_API const SgAsmJvmModule* isSgAsmJvmModule(const SgNode* node);
ROSE_DLL_API SgAsmJvmMethodTable* isSgAsmJvmMethodTable(SgNode* node);
ROSE_DLL_API const SgAsmJvmMethodTable* isSgAsmJvmMethodTable(const SgNode* node);
ROSE_DLL_API SgAsmJvmMethodParameters* isSgAsmJvmMethodParameters(SgNode* node);
ROSE_DLL_API const SgAsmJvmMethodParameters* isSgAsmJvmMethodParameters(const SgNode* node);
ROSE_DLL_API SgAsmJvmMethodParametersEntry* isSgAsmJvmMethodParametersEntry(SgNode* node);
ROSE_DLL_API const SgAsmJvmMethodParametersEntry* isSgAsmJvmMethodParametersEntry(const SgNode* node);
ROSE_DLL_API SgAsmJvmMethod* isSgAsmJvmMethod(SgNode* node);
ROSE_DLL_API const SgAsmJvmMethod* isSgAsmJvmMethod(const SgNode* node);
ROSE_DLL_API SgAsmJvmLocalVariableTypeTable* isSgAsmJvmLocalVariableTypeTable(SgNode* node);
ROSE_DLL_API const SgAsmJvmLocalVariableTypeTable* isSgAsmJvmLocalVariableTypeTable(const SgNode* node);
ROSE_DLL_API SgAsmJvmLocalVariableTypeEntry* isSgAsmJvmLocalVariableTypeEntry(SgNode* node);
ROSE_DLL_API const SgAsmJvmLocalVariableTypeEntry* isSgAsmJvmLocalVariableTypeEntry(const SgNode* node);
ROSE_DLL_API SgAsmJvmLocalVariableTable* isSgAsmJvmLocalVariableTable(SgNode* node);
ROSE_DLL_API const SgAsmJvmLocalVariableTable* isSgAsmJvmLocalVariableTable(const SgNode* node);
ROSE_DLL_API SgAsmJvmLocalVariableEntry* isSgAsmJvmLocalVariableEntry(SgNode* node);
ROSE_DLL_API const SgAsmJvmLocalVariableEntry* isSgAsmJvmLocalVariableEntry(const SgNode* node);
ROSE_DLL_API SgAsmJvmLineNumberTable* isSgAsmJvmLineNumberTable(SgNode* node);
ROSE_DLL_API const SgAsmJvmLineNumberTable* isSgAsmJvmLineNumberTable(const SgNode* node);
ROSE_DLL_API SgAsmJvmInstruction* isSgAsmJvmInstruction(SgNode* node);
ROSE_DLL_API const SgAsmJvmInstruction* isSgAsmJvmInstruction(const SgNode* node);
ROSE_DLL_API SgAsmJvmInnerClasses* isSgAsmJvmInnerClasses(SgNode* node);
ROSE_DLL_API const SgAsmJvmInnerClasses* isSgAsmJvmInnerClasses(const SgNode* node);
ROSE_DLL_API SgAsmJvmIndexTableAttr* isSgAsmJvmIndexTableAttr(SgNode* node);
ROSE_DLL_API const SgAsmJvmIndexTableAttr* isSgAsmJvmIndexTableAttr(const SgNode* node);
ROSE_DLL_API SgAsmJvmIndexedAttr* isSgAsmJvmIndexedAttr(SgNode* node);
ROSE_DLL_API const SgAsmJvmIndexedAttr* isSgAsmJvmIndexedAttr(const SgNode* node);
ROSE_DLL_API SgAsmJvmFileHeader* isSgAsmJvmFileHeader(SgNode* node);
ROSE_DLL_API const SgAsmJvmFileHeader* isSgAsmJvmFileHeader(const SgNode* node);
ROSE_DLL_API SgAsmJvmFieldTable* isSgAsmJvmFieldTable(SgNode* node);
ROSE_DLL_API const SgAsmJvmFieldTable* isSgAsmJvmFieldTable(const SgNode* node);
ROSE_DLL_API SgAsmJvmField* isSgAsmJvmField(SgNode* node);
ROSE_DLL_API const SgAsmJvmField* isSgAsmJvmField(const SgNode* node);
ROSE_DLL_API SgAsmJvmExceptionTable* isSgAsmJvmExceptionTable(SgNode* node);
ROSE_DLL_API const SgAsmJvmExceptionTable* isSgAsmJvmExceptionTable(const SgNode* node);
ROSE_DLL_API SgAsmJvmExceptionHandler* isSgAsmJvmExceptionHandler(SgNode* node);
ROSE_DLL_API const SgAsmJvmExceptionHandler* isSgAsmJvmExceptionHandler(const SgNode* node);
ROSE_DLL_API SgAsmJvmEnclosingMethod* isSgAsmJvmEnclosingMethod(SgNode* node);
ROSE_DLL_API const SgAsmJvmEnclosingMethod* isSgAsmJvmEnclosingMethod(const SgNode* node);
ROSE_DLL_API SgAsmJvmConstantPool* isSgAsmJvmConstantPool(SgNode* node);
ROSE_DLL_API const SgAsmJvmConstantPool* isSgAsmJvmConstantPool(const SgNode* node);
ROSE_DLL_API SgAsmJvmConstantPoolEntry* isSgAsmJvmConstantPoolEntry(SgNode* node);
ROSE_DLL_API const SgAsmJvmConstantPoolEntry* isSgAsmJvmConstantPoolEntry(const SgNode* node);
ROSE_DLL_API SgAsmJvmCodeAttribute* isSgAsmJvmCodeAttribute(SgNode* node);
ROSE_DLL_API const SgAsmJvmCodeAttribute* isSgAsmJvmCodeAttribute(const SgNode* node);
ROSE_DLL_API SgAsmJvmClass* isSgAsmJvmClass(SgNode* node);
ROSE_DLL_API const SgAsmJvmClass* isSgAsmJvmClass(const SgNode* node);
ROSE_DLL_API SgAsmJvmBootstrapMethods* isSgAsmJvmBootstrapMethods(SgNode* node);
ROSE_DLL_API const SgAsmJvmBootstrapMethods* isSgAsmJvmBootstrapMethods(const SgNode* node);
ROSE_DLL_API SgAsmJvmBootstrapMethod* isSgAsmJvmBootstrapMethod(SgNode* node);
ROSE_DLL_API const SgAsmJvmBootstrapMethod* isSgAsmJvmBootstrapMethod(const SgNode* node);
ROSE_DLL_API SgAsmJvmAttributeTable* isSgAsmJvmAttributeTable(SgNode* node);
ROSE_DLL_API const SgAsmJvmAttributeTable* isSgAsmJvmAttributeTable(const SgNode* node);
ROSE_DLL_API SgAsmJvmAnnotationDefault* isSgAsmJvmAnnotationDefault(SgNode* node);
ROSE_DLL_API const SgAsmJvmAnnotationDefault* isSgAsmJvmAnnotationDefault(const SgNode* node);
ROSE_DLL_API SgAsmJvmAttribute* isSgAsmJvmAttribute(SgNode* node);
ROSE_DLL_API const SgAsmJvmAttribute* isSgAsmJvmAttribute(const SgNode* node);
ROSE_DLL_API SgAsmJvmNode* isSgAsmJvmNode(SgNode* node);
ROSE_DLL_API const SgAsmJvmNode* isSgAsmJvmNode(const SgNode* node);
...
ROSE_DLL_API SgAsmIntegerType* isSgAsmIntegerType(SgNode* node);
ROSE_DLL_API const SgAsmIntegerType* isSgAsmIntegerType(const SgNode* node);
ROSE_DLL_API SgAsmInstructionList* isSgAsmInstructionList(SgNode* node);
ROSE_DLL_API const SgAsmInstructionList* isSgAsmInstructionList(const SgNode* node);
ROSE_DLL_API SgAsmIndirectRegisterExpression* isSgAsmIndirectRegisterExpression(SgNode* node);
ROSE_DLL_API const SgAsmIndirectRegisterExpression* isSgAsmIndirectRegisterExpression(const SgNode* node);
...
ROSE_DLL_API SgAsmFloatValueExpression* isSgAsmFloatValueExpression(SgNode* node);
ROSE_DLL_API const SgAsmFloatValueExpression* isSgAsmFloatValueExpression(const SgNode* node);
ROSE_DLL_API SgAsmFloatType* isSgAsmFloatType(SgNode* node);
ROSE_DLL_API const SgAsmFloatType* isSgAsmFloatType(const SgNode* node);
ROSE_DLL_API SgAsmScalarType* isSgAsmScalarType(SgNode* node);
ROSE_DLL_API const SgAsmScalarType* isSgAsmScalarType(const SgNode* node);
...
ROSE_DLL_API SgAsmDirectRegisterExpression* isSgAsmDirectRegisterExpression(SgNode* node);
ROSE_DLL_API const SgAsmDirectRegisterExpression* isSgAsmDirectRegisterExpression(const SgNode* node);
...
ROSE_DLL_API SgAsmConstantExpression* isSgAsmConstantExpression(SgNode* node);
ROSE_DLL_API const SgAsmConstantExpression* isSgAsmConstantExpression(const SgNode* node);
...
ROSE_DLL_API SgAsmCliHeader* isSgAsmCliHeader(SgNode* node);
ROSE_DLL_API const SgAsmCliHeader* isSgAsmCliHeader(const SgNode* node);
...
ROSE_DLL_API SgAsmCilUint8Heap* isSgAsmCilUint8Heap(SgNode* node);
ROSE_DLL_API const SgAsmCilUint8Heap* isSgAsmCilUint8Heap(const SgNode* node);
ROSE_DLL_API SgAsmCilUint32Heap* isSgAsmCilUint32Heap(SgNode* node);
ROSE_DLL_API const SgAsmCilUint32Heap* isSgAsmCilUint32Heap(const SgNode* node);
ROSE_DLL_API SgAsmCilTypeSpecTable* isSgAsmCilTypeSpecTable(SgNode* node);
ROSE_DLL_API const SgAsmCilTypeSpecTable* isSgAsmCilTypeSpecTable(const SgNode* node);
ROSE_DLL_API SgAsmCilTypeSpec* isSgAsmCilTypeSpec(SgNode* node);
ROSE_DLL_API const SgAsmCilTypeSpec* isSgAsmCilTypeSpec(const SgNode* node);
ROSE_DLL_API SgAsmCilTypeRefTable* isSgAsmCilTypeRefTable(SgNode* node);
ROSE_DLL_API const SgAsmCilTypeRefTable* isSgAsmCilTypeRefTable(const SgNode* node);
ROSE_DLL_API SgAsmCilTypeRef* isSgAsmCilTypeRef(SgNode* node);
ROSE_DLL_API const SgAsmCilTypeRef* isSgAsmCilTypeRef(const SgNode* node);
ROSE_DLL_API SgAsmCilTypeDefTable* isSgAsmCilTypeDefTable(SgNode* node);
ROSE_DLL_API const SgAsmCilTypeDefTable* isSgAsmCilTypeDefTable(const SgNode* node);
ROSE_DLL_API SgAsmCilTypeDef* isSgAsmCilTypeDef(SgNode* node);
ROSE_DLL_API const SgAsmCilTypeDef* isSgAsmCilTypeDef(const SgNode* node);
ROSE_DLL_API SgAsmCilStandAloneSigTable* isSgAsmCilStandAloneSigTable(SgNode* node);
ROSE_DLL_API const SgAsmCilStandAloneSigTable* isSgAsmCilStandAloneSigTable(const SgNode* node);
ROSE_DLL_API SgAsmCilStandAloneSig* isSgAsmCilStandAloneSig(SgNode* node);
ROSE_DLL_API const SgAsmCilStandAloneSig* isSgAsmCilStandAloneSig(const SgNode* node);
ROSE_DLL_API SgAsmCilPropertyTable* isSgAsmCilPropertyTable(SgNode* node);
ROSE_DLL_API const SgAsmCilPropertyTable* isSgAsmCilPropertyTable(const SgNode* node);
ROSE_DLL_API SgAsmCilPropertyMapTable* isSgAsmCilPropertyMapTable(SgNode* node);
ROSE_DLL_API const SgAsmCilPropertyMapTable* isSgAsmCilPropertyMapTable(const SgNode* node);
ROSE_DLL_API SgAsmCilPropertyMap* isSgAsmCilPropertyMap(SgNode* node);
ROSE_DLL_API const SgAsmCilPropertyMap* isSgAsmCilPropertyMap(const SgNode* node);
ROSE_DLL_API SgAsmCilProperty* isSgAsmCilProperty(SgNode* node);
ROSE_DLL_API const SgAsmCilProperty* isSgAsmCilProperty(const SgNode* node);
ROSE_DLL_API SgAsmCilParamTable* isSgAsmCilParamTable(SgNode* node);
ROSE_DLL_API const SgAsmCilParamTable* isSgAsmCilParamTable(const SgNode* node);
ROSE_DLL_API SgAsmCilParam* isSgAsmCilParam(SgNode* node);
ROSE_DLL_API const SgAsmCilParam* isSgAsmCilParam(const SgNode* node);
ROSE_DLL_API SgAsmCilNestedClassTable* isSgAsmCilNestedClassTable(SgNode* node);
ROSE_DLL_API const SgAsmCilNestedClassTable* isSgAsmCilNestedClassTable(const SgNode* node);
ROSE_DLL_API SgAsmCilNestedClass* isSgAsmCilNestedClass(SgNode* node);
ROSE_DLL_API const SgAsmCilNestedClass* isSgAsmCilNestedClass(const SgNode* node);
ROSE_DLL_API SgAsmCilModuleTable* isSgAsmCilModuleTable(SgNode* node);
ROSE_DLL_API const SgAsmCilModuleTable* isSgAsmCilModuleTable(const SgNode* node);
ROSE_DLL_API SgAsmCilModuleRefTable* isSgAsmCilModuleRefTable(SgNode* node);
ROSE_DLL_API const SgAsmCilModuleRefTable* isSgAsmCilModuleRefTable(const SgNode* node);
ROSE_DLL_API SgAsmCilModuleRef* isSgAsmCilModuleRef(SgNode* node);
ROSE_DLL_API const SgAsmCilModuleRef* isSgAsmCilModuleRef(const SgNode* node);
ROSE_DLL_API SgAsmCilModule* isSgAsmCilModule(SgNode* node);
ROSE_DLL_API const SgAsmCilModule* isSgAsmCilModule(const SgNode* node);
ROSE_DLL_API SgAsmCilMethodSpecTable* isSgAsmCilMethodSpecTable(SgNode* node);
ROSE_DLL_API const SgAsmCilMethodSpecTable* isSgAsmCilMethodSpecTable(const SgNode* node);
ROSE_DLL_API SgAsmCilMethodSpec* isSgAsmCilMethodSpec(SgNode* node);
ROSE_DLL_API const SgAsmCilMethodSpec* isSgAsmCilMethodSpec(const SgNode* node);
ROSE_DLL_API SgAsmCilMethodSemanticsTable* isSgAsmCilMethodSemanticsTable(SgNode* node);
ROSE_DLL_API const SgAsmCilMethodSemanticsTable* isSgAsmCilMethodSemanticsTable(const SgNode* node);
ROSE_DLL_API SgAsmCilMethodSemantics* isSgAsmCilMethodSemantics(SgNode* node);
ROSE_DLL_API const SgAsmCilMethodSemantics* isSgAsmCilMethodSemantics(const SgNode* node);
ROSE_DLL_API SgAsmCilMethodImplTable* isSgAsmCilMethodImplTable(SgNode* node);
ROSE_DLL_API const SgAsmCilMethodImplTable* isSgAsmCilMethodImplTable(const SgNode* node);
ROSE_DLL_API SgAsmCilMethodImpl* isSgAsmCilMethodImpl(SgNode* node);
ROSE_DLL_API const SgAsmCilMethodImpl* isSgAsmCilMethodImpl(const SgNode* node);
ROSE_DLL_API SgAsmCilMethodDefTable* isSgAsmCilMethodDefTable(SgNode* node);
ROSE_DLL_API const SgAsmCilMethodDefTable* isSgAsmCilMethodDefTable(const SgNode* node);
ROSE_DLL_API SgAsmCilMethodDef* isSgAsmCilMethodDef(SgNode* node);
ROSE_DLL_API const SgAsmCilMethodDef* isSgAsmCilMethodDef(const SgNode* node);
ROSE_DLL_API SgAsmCilMethodData* isSgAsmCilMethodData(SgNode* node);
ROSE_DLL_API const SgAsmCilMethodData* isSgAsmCilMethodData(const SgNode* node);
ROSE_DLL_API SgAsmCilMetadataRoot* isSgAsmCilMetadataRoot(SgNode* node);
ROSE_DLL_API const SgAsmCilMetadataRoot* isSgAsmCilMetadataRoot(const SgNode* node);
ROSE_DLL_API SgAsmCilMetadataHeap* isSgAsmCilMetadataHeap(SgNode* node);
ROSE_DLL_API const SgAsmCilMetadataHeap* isSgAsmCilMetadataHeap(const SgNode* node);
ROSE_DLL_API SgAsmCilMemberRefTable* isSgAsmCilMemberRefTable(SgNode* node);
ROSE_DLL_API const SgAsmCilMemberRefTable* isSgAsmCilMemberRefTable(const SgNode* node);
ROSE_DLL_API SgAsmCilMemberRef* isSgAsmCilMemberRef(SgNode* node);
ROSE_DLL_API const SgAsmCilMemberRef* isSgAsmCilMemberRef(const SgNode* node);
ROSE_DLL_API SgAsmCilManifestResourceTable* isSgAsmCilManifestResourceTable(SgNode* node);
ROSE_DLL_API const SgAsmCilManifestResourceTable* isSgAsmCilManifestResourceTable(const SgNode* node);
ROSE_DLL_API SgAsmCilManifestResource* isSgAsmCilManifestResource(SgNode* node);
ROSE_DLL_API const SgAsmCilManifestResource* isSgAsmCilManifestResource(const SgNode* node);
ROSE_DLL_API SgAsmCilInterfaceImplTable* isSgAsmCilInterfaceImplTable(SgNode* node);
ROSE_DLL_API const SgAsmCilInterfaceImplTable* isSgAsmCilInterfaceImplTable(const SgNode* node);
ROSE_DLL_API SgAsmCilInterfaceImpl* isSgAsmCilInterfaceImpl(SgNode* node);
ROSE_DLL_API const SgAsmCilInterfaceImpl* isSgAsmCilInterfaceImpl(const SgNode* node);
ROSE_DLL_API SgAsmCilInstruction* isSgAsmCilInstruction(SgNode* node);
ROSE_DLL_API const SgAsmCilInstruction* isSgAsmCilInstruction(const SgNode* node);
ROSE_DLL_API SgAsmCilImplMapTable* isSgAsmCilImplMapTable(SgNode* node);
ROSE_DLL_API const SgAsmCilImplMapTable* isSgAsmCilImplMapTable(const SgNode* node);
ROSE_DLL_API SgAsmCilImplMap* isSgAsmCilImplMap(SgNode* node);
ROSE_DLL_API const SgAsmCilImplMap* isSgAsmCilImplMap(const SgNode* node);
ROSE_DLL_API SgAsmCilGenericParamTable* isSgAsmCilGenericParamTable(SgNode* node);
ROSE_DLL_API const SgAsmCilGenericParamTable* isSgAsmCilGenericParamTable(const SgNode* node);
ROSE_DLL_API SgAsmCilGenericParam* isSgAsmCilGenericParam(SgNode* node);
ROSE_DLL_API const SgAsmCilGenericParam* isSgAsmCilGenericParam(const SgNode* node);
ROSE_DLL_API SgAsmCilGenericParamConstraintTable* isSgAsmCilGenericParamConstraintTable(SgNode* node);
ROSE_DLL_API const SgAsmCilGenericParamConstraintTable* isSgAsmCilGenericParamConstraintTable(const SgNode* node);
ROSE_DLL_API SgAsmCilGenericParamConstraint* isSgAsmCilGenericParamConstraint(SgNode* node);
ROSE_DLL_API const SgAsmCilGenericParamConstraint* isSgAsmCilGenericParamConstraint(const SgNode* node);
ROSE_DLL_API SgAsmCilFileTable* isSgAsmCilFileTable(SgNode* node);
ROSE_DLL_API const SgAsmCilFileTable* isSgAsmCilFileTable(const SgNode* node);
ROSE_DLL_API SgAsmCilFile* isSgAsmCilFile(SgNode* node);
ROSE_DLL_API const SgAsmCilFile* isSgAsmCilFile(const SgNode* node);
ROSE_DLL_API SgAsmCilFieldTable* isSgAsmCilFieldTable(SgNode* node);
ROSE_DLL_API const SgAsmCilFieldTable* isSgAsmCilFieldTable(const SgNode* node);
ROSE_DLL_API SgAsmCilFieldRVATable* isSgAsmCilFieldRVATable(SgNode* node);
ROSE_DLL_API const SgAsmCilFieldRVATable* isSgAsmCilFieldRVATable(const SgNode* node);
ROSE_DLL_API SgAsmCilFieldRVA* isSgAsmCilFieldRVA(SgNode* node);
ROSE_DLL_API const SgAsmCilFieldRVA* isSgAsmCilFieldRVA(const SgNode* node);
ROSE_DLL_API SgAsmCilFieldMarshalTable* isSgAsmCilFieldMarshalTable(SgNode* node);
ROSE_DLL_API const SgAsmCilFieldMarshalTable* isSgAsmCilFieldMarshalTable(const SgNode* node);
ROSE_DLL_API SgAsmCilFieldMarshal* isSgAsmCilFieldMarshal(SgNode* node);
ROSE_DLL_API const SgAsmCilFieldMarshal* isSgAsmCilFieldMarshal(const SgNode* node);
ROSE_DLL_API SgAsmCilFieldLayoutTable* isSgAsmCilFieldLayoutTable(SgNode* node);
ROSE_DLL_API const SgAsmCilFieldLayoutTable* isSgAsmCilFieldLayoutTable(const SgNode* node);
ROSE_DLL_API SgAsmCilFieldLayout* isSgAsmCilFieldLayout(SgNode* node);
ROSE_DLL_API const SgAsmCilFieldLayout* isSgAsmCilFieldLayout(const SgNode* node);
ROSE_DLL_API SgAsmCilField* isSgAsmCilField(SgNode* node);
ROSE_DLL_API const SgAsmCilField* isSgAsmCilField(const SgNode* node);
ROSE_DLL_API SgAsmCilExportedTypeTable* isSgAsmCilExportedTypeTable(SgNode* node);
ROSE_DLL_API const SgAsmCilExportedTypeTable* isSgAsmCilExportedTypeTable(const SgNode* node);
ROSE_DLL_API SgAsmCilExportedType* isSgAsmCilExportedType(SgNode* node);
ROSE_DLL_API const SgAsmCilExportedType* isSgAsmCilExportedType(const SgNode* node);
ROSE_DLL_API SgAsmCilExceptionData* isSgAsmCilExceptionData(SgNode* node);
ROSE_DLL_API const SgAsmCilExceptionData* isSgAsmCilExceptionData(const SgNode* node);
ROSE_DLL_API SgAsmCilEventTable* isSgAsmCilEventTable(SgNode* node);
ROSE_DLL_API const SgAsmCilEventTable* isSgAsmCilEventTable(const SgNode* node);
ROSE_DLL_API SgAsmCilEventMapTable* isSgAsmCilEventMapTable(SgNode* node);
ROSE_DLL_API const SgAsmCilEventMapTable* isSgAsmCilEventMapTable(const SgNode* node);
ROSE_DLL_API SgAsmCilEventMap* isSgAsmCilEventMap(SgNode* node);
ROSE_DLL_API const SgAsmCilEventMap* isSgAsmCilEventMap(const SgNode* node);
ROSE_DLL_API SgAsmCilEvent* isSgAsmCilEvent(SgNode* node);
ROSE_DLL_API const SgAsmCilEvent* isSgAsmCilEvent(const SgNode* node);
ROSE_DLL_API SgAsmCilErrorHeap* isSgAsmCilErrorHeap(SgNode* node);
ROSE_DLL_API const SgAsmCilErrorHeap* isSgAsmCilErrorHeap(const SgNode* node);
ROSE_DLL_API SgAsmCilDeclSecurityTable* isSgAsmCilDeclSecurityTable(SgNode* node);
ROSE_DLL_API const SgAsmCilDeclSecurityTable* isSgAsmCilDeclSecurityTable(const SgNode* node);
ROSE_DLL_API SgAsmCilDeclSecurity* isSgAsmCilDeclSecurity(SgNode* node);
ROSE_DLL_API const SgAsmCilDeclSecurity* isSgAsmCilDeclSecurity(const SgNode* node);
ROSE_DLL_API SgAsmCilDataStream* isSgAsmCilDataStream(SgNode* node);
ROSE_DLL_API const SgAsmCilDataStream* isSgAsmCilDataStream(const SgNode* node);
ROSE_DLL_API SgAsmCilCustomAttributeTable* isSgAsmCilCustomAttributeTable(SgNode* node);
ROSE_DLL_API const SgAsmCilCustomAttributeTable* isSgAsmCilCustomAttributeTable(const SgNode* node);
ROSE_DLL_API SgAsmCilCustomAttribute* isSgAsmCilCustomAttribute(SgNode* node);
ROSE_DLL_API const SgAsmCilCustomAttribute* isSgAsmCilCustomAttribute(const SgNode* node);
ROSE_DLL_API SgAsmCilConstantTable* isSgAsmCilConstantTable(SgNode* node);
ROSE_DLL_API const SgAsmCilConstantTable* isSgAsmCilConstantTable(const SgNode* node);
ROSE_DLL_API SgAsmCilConstant* isSgAsmCilConstant(SgNode* node);
ROSE_DLL_API const SgAsmCilConstant* isSgAsmCilConstant(const SgNode* node);
ROSE_DLL_API SgAsmCilClassLayoutTable* isSgAsmCilClassLayoutTable(SgNode* node);
ROSE_DLL_API const SgAsmCilClassLayoutTable* isSgAsmCilClassLayoutTable(const SgNode* node);
ROSE_DLL_API SgAsmCilClassLayout* isSgAsmCilClassLayout(SgNode* node);
ROSE_DLL_API const SgAsmCilClassLayout* isSgAsmCilClassLayout(const SgNode* node);
ROSE_DLL_API SgAsmCilAssemblyTable* isSgAsmCilAssemblyTable(SgNode* node);
ROSE_DLL_API const SgAsmCilAssemblyTable* isSgAsmCilAssemblyTable(const SgNode* node);
ROSE_DLL_API SgAsmCilAssemblyRefTable* isSgAsmCilAssemblyRefTable(SgNode* node);
ROSE_DLL_API const SgAsmCilAssemblyRefTable* isSgAsmCilAssemblyRefTable(const SgNode* node);
ROSE_DLL_API SgAsmCilAssemblyRefProcessorTable* isSgAsmCilAssemblyRefProcessorTable(SgNode* node);
ROSE_DLL_API const SgAsmCilAssemblyRefProcessorTable* isSgAsmCilAssemblyRefProcessorTable(const SgNode* node);
ROSE_DLL_API SgAsmCilAssemblyRefProcessor* isSgAsmCilAssemblyRefProcessor(SgNode* node);
ROSE_DLL_API const SgAsmCilAssemblyRefProcessor* isSgAsmCilAssemblyRefProcessor(const SgNode* node);
ROSE_DLL_API SgAsmCilAssemblyRefOSTable* isSgAsmCilAssemblyRefOSTable(SgNode* node);
ROSE_DLL_API const SgAsmCilAssemblyRefOSTable* isSgAsmCilAssemblyRefOSTable(const SgNode* node);
ROSE_DLL_API SgAsmCilAssemblyRefOS* isSgAsmCilAssemblyRefOS(SgNode* node);
ROSE_DLL_API const SgAsmCilAssemblyRefOS* isSgAsmCilAssemblyRefOS(const SgNode* node);
ROSE_DLL_API SgAsmCilAssemblyRef* isSgAsmCilAssemblyRef(SgNode* node);
ROSE_DLL_API const SgAsmCilAssemblyRef* isSgAsmCilAssemblyRef(const SgNode* node);
ROSE_DLL_API SgAsmCilAssemblyProcessorTable* isSgAsmCilAssemblyProcessorTable(SgNode* node);
ROSE_DLL_API const SgAsmCilAssemblyProcessorTable* isSgAsmCilAssemblyProcessorTable(const SgNode* node);
ROSE_DLL_API SgAsmCilAssemblyProcessor* isSgAsmCilAssemblyProcessor(SgNode* node);
ROSE_DLL_API const SgAsmCilAssemblyProcessor* isSgAsmCilAssemblyProcessor(const SgNode* node);
ROSE_DLL_API SgAsmCilAssemblyOSTable* isSgAsmCilAssemblyOSTable(SgNode* node);
ROSE_DLL_API const SgAsmCilAssemblyOSTable* isSgAsmCilAssemblyOSTable(const SgNode* node);
ROSE_DLL_API SgAsmCilAssemblyOS* isSgAsmCilAssemblyOS(SgNode* node);
ROSE_DLL_API const SgAsmCilAssemblyOS* isSgAsmCilAssemblyOS(const SgNode* node);
ROSE_DLL_API SgAsmCilAssembly* isSgAsmCilAssembly(SgNode* node);
ROSE_DLL_API const SgAsmCilAssembly* isSgAsmCilAssembly(const SgNode* node);
ROSE_DLL_API SgAsmCilMetadata* isSgAsmCilMetadata(SgNode* node);
ROSE_DLL_API const SgAsmCilMetadata* isSgAsmCilMetadata(const SgNode* node);
ROSE_DLL_API SgAsmCilNode* isSgAsmCilNode(SgNode* node);
ROSE_DLL_API const SgAsmCilNode* isSgAsmCilNode(const SgNode* node);
ROSE_DLL_API SgAsmByteOrder* isSgAsmByteOrder(SgNode* node);
ROSE_DLL_API const SgAsmByteOrder* isSgAsmByteOrder(const SgNode* node);
...
ROSE_DLL_API SgAsmBinaryPreupdate* isSgAsmBinaryPreupdate(SgNode* node);
ROSE_DLL_API const SgAsmBinaryPreupdate* isSgAsmBinaryPreupdate(const SgNode* node);
ROSE_DLL_API SgAsmBinaryPostupdate* isSgAsmBinaryPostupdate(SgNode* node);
ROSE_DLL_API const SgAsmBinaryPostupdate* isSgAsmBinaryPostupdate(const SgNode* node);
...
ROSE_DLL_API SgAsmBinaryMsl* isSgAsmBinaryMsl(SgNode* node);
ROSE_DLL_API const SgAsmBinaryMsl* isSgAsmBinaryMsl(const SgNode* node);
...
ROSE_DLL_API SgAsmBinaryConcat* isSgAsmBinaryConcat(SgNode* node);
ROSE_DLL_API const SgAsmBinaryConcat* isSgAsmBinaryConcat(const SgNode* node);
...
ROSE_DLL_API SgAsmAarch32Coprocessor* isSgAsmAarch32Coprocessor(SgNode* node);
ROSE_DLL_API const SgAsmAarch32Coprocessor* isSgAsmAarch32Coprocessor(const SgNode* node);
...
ROSE_DLL_API SgLambdaCapture* isSgLambdaCapture(SgNode* node);
ROSE_DLL_API const SgLambdaCapture* isSgLambdaCapture(const SgNode* node);
ROSE_DLL_API SgLambdaCaptureList* isSgLambdaCaptureList(SgNode* node);
ROSE_DLL_API const SgLambdaCaptureList* isSgLambdaCaptureList(const SgNode* node);
...
ROSE_DLL_API SgOmpBeginClause* isSgOmpBeginClause(SgNode* node);
ROSE_DLL_API const SgOmpBeginClause* isSgOmpBeginClause(const SgNode* node);
ROSE_DLL_API SgOmpEndClause* isSgOmpEndClause(SgNode* node);
ROSE_DLL_API const SgOmpEndClause* isSgOmpEndClause(const SgNode* node);
...
ROSE_DLL_API SgOmpMergeableClause* isSgOmpMergeableClause(SgNode* node);
ROSE_DLL_API const SgOmpMergeableClause* isSgOmpMergeableClause(const SgNode* node);
...
ROSE_DLL_API SgOmpAtomicClause* isSgOmpAtomicClause(SgNode* node);
ROSE_DLL_API const SgOmpAtomicClause* isSgOmpAtomicClause(const SgNode* node);
ROSE_DLL_API SgOmpProcBindClause* isSgOmpProcBindClause(SgNode* node);
ROSE_DLL_API const SgOmpProcBindClause* isSgOmpProcBindClause(const SgNode* node);
ROSE_DLL_API SgOmpInbranchClause* isSgOmpInbranchClause(SgNode* node);
ROSE_DLL_API const SgOmpInbranchClause* isSgOmpInbranchClause(const SgNode* node);
ROSE_DLL_API SgOmpNotinbranchClause* isSgOmpNotinbranchClause(SgNode* node);
ROSE_DLL_API const SgOmpNotinbranchClause* isSgOmpNotinbranchClause(const SgNode* node);
...
ROSE_DLL_API SgOmpFinalClause* isSgOmpFinalClause(SgNode* node);
ROSE_DLL_API const SgOmpFinalClause* isSgOmpFinalClause(const SgNode* node);
ROSE_DLL_API SgOmpPriorityClause* isSgOmpPriorityClause(SgNode* node);
ROSE_DLL_API const SgOmpPriorityClause* isSgOmpPriorityClause(const SgNode* node);
...
ROSE_DLL_API SgOmpSimdlenClause* isSgOmpSimdlenClause(SgNode* node);
ROSE_DLL_API const SgOmpSimdlenClause* isSgOmpSimdlenClause(const SgNode* node);
...
ROSE_DLL_API SgOmpDependClause* isSgOmpDependClause(SgNode* node);
ROSE_DLL_API const SgOmpDependClause* isSgOmpDependClause(const SgNode* node);
...
ROSE_DLL_API SgAdaRangeConstraint* isSgAdaRangeConstraint(SgNode* node);
ROSE_DLL_API const SgAdaRangeConstraint* isSgAdaRangeConstraint(const SgNode* node);
ROSE_DLL_API SgAdaIndexConstraint* isSgAdaIndexConstraint(SgNode* node);
ROSE_DLL_API const SgAdaIndexConstraint* isSgAdaIndexConstraint(const SgNode* node);
ROSE_DLL_API SgAdaDigitsConstraint* isSgAdaDigitsConstraint(SgNode* node);
ROSE_DLL_API const SgAdaDigitsConstraint* isSgAdaDigitsConstraint(const SgNode* node);
ROSE_DLL_API SgAdaDeltaConstraint* isSgAdaDeltaConstraint(SgNode* node);
ROSE_DLL_API const SgAdaDeltaConstraint* isSgAdaDeltaConstraint(const SgNode* node);
ROSE_DLL_API SgAdaDiscriminantConstraint* isSgAdaDiscriminantConstraint(SgNode* node);
ROSE_DLL_API const SgAdaDiscriminantConstraint* isSgAdaDiscriminantConstraint(const SgNode* node);
ROSE_DLL_API SgAdaNullConstraint* isSgAdaNullConstraint(SgNode* node);
ROSE_DLL_API const SgAdaNullConstraint* isSgAdaNullConstraint(const SgNode* node);
ROSE_DLL_API SgAdaTypeConstraint* isSgAdaTypeConstraint(SgNode* node);
ROSE_DLL_API const SgAdaTypeConstraint* isSgAdaTypeConstraint(const SgNode* node);
...
extern const uint8_t rose_ClassHierarchyCastTable[1087][136];

#define IS_SgJovialBitVal_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgJovialBitVal::static_variant >> 3] & (1 << (SgJovialBitVal::static_variant & 7)))) ? ((SgJovialBitVal*) (node)) : NULL) : NULL)
...
#define IS_SgStructureModifier_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgStructureModifier::static_variant >> 3] & (1 << (SgStructureModifier::static_variant & 7)))) ? ((SgStructureModifier*) (node)) : NULL) : NULL)
...
#define IS_SgJvmComposite_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgJvmComposite::static_variant >> 3] & (1 << (SgJvmComposite::static_variant & 7)))) ? ((SgJvmComposite*) (node)) : NULL) : NULL)
...
#define IS_SgIncludeFile_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgIncludeFile::static_variant >> 3] & (1 << (SgIncludeFile::static_variant & 7)))) ? ((SgIncludeFile*) (node)) : NULL) : NULL)
...
#define IS_SgNonrealBaseClass_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgNonrealBaseClass::static_variant >> 3] & (1 << (SgNonrealBaseClass::static_variant & 7)))) ? ((SgNonrealBaseClass*) (node)) : NULL) : NULL)
...
#define IS_SgHeaderFileReport_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgHeaderFileReport::static_variant >> 3] & (1 << (SgHeaderFileReport::static_variant & 7)))) ? ((SgHeaderFileReport*) (node)) : NULL) : NULL)
...
#define IS_SgTypeFloat80_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgTypeFloat80::static_variant >> 3] & (1 << (SgTypeFloat80::static_variant & 7)))) ? ((SgTypeFloat80*) (node)) : NULL) : NULL)
#define IS_SgTypeFloat128_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgTypeFloat128::static_variant >> 3] & (1 << (SgTypeFloat128::static_variant & 7)))) ? ((SgTypeFloat128*) (node)) : NULL) : NULL)
...
#define IS_SgTypeFloat16_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgTypeFloat16::static_variant >> 3] & (1 << (SgTypeFloat16::static_variant & 7)))) ? ((SgTypeFloat16*) (node)) : NULL) : NULL)
#define IS_SgTypeFp16_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgTypeFp16::static_variant >> 3] & (1 << (SgTypeFp16::static_variant & 7)))) ? ((SgTypeFp16*) (node)) : NULL) : NULL)
#define IS_SgTypeBFloat16_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgTypeBFloat16::static_variant >> 3] & (1 << (SgTypeBFloat16::static_variant & 7)))) ? ((SgTypeBFloat16*) (node)) : NULL) : NULL)
#define IS_SgTypeFloat32x_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgTypeFloat32x::static_variant >> 3] & (1 << (SgTypeFloat32x::static_variant & 7)))) ? ((SgTypeFloat32x*) (node)) : NULL) : NULL)
#define IS_SgTypeFloat64x_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgTypeFloat64x::static_variant >> 3] & (1 << (SgTypeFloat64x::static_variant & 7)))) ? ((SgTypeFloat64x*) (node)) : NULL) : NULL)
#define IS_SgTypeFloat32_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgTypeFloat32::static_variant >> 3] & (1 << (SgTypeFloat32::static_variant & 7)))) ? ((SgTypeFloat32*) (node)) : NULL) : NULL)
#define IS_SgTypeFloat64_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgTypeFloat64::static_variant >> 3] & (1 << (SgTypeFloat64::static_variant & 7)))) ? ((SgTypeFloat64*) (node)) : NULL) : NULL)
#define IS_SgTypeFixed_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgTypeFixed::static_variant >> 3] & (1 << (SgTypeFixed::static_variant & 7)))) ? ((SgTypeFixed*) (node)) : NULL) : NULL)
...
#define IS_SgJovialTableType_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgJovialTableType::static_variant >> 3] & (1 << (SgJovialTableType::static_variant & 7)))) ? ((SgJovialTableType*) (node)) : NULL) : NULL)
...
#define IS_SgNonrealType_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgNonrealType::static_variant >> 3] & (1 << (SgNonrealType::static_variant & 7)))) ? ((SgNonrealType*) (node)) : NULL) : NULL)
#define IS_SgAutoType_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAutoType::static_variant >> 3] & (1 << (SgAutoType::static_variant & 7)))) ? ((SgAutoType*) (node)) : NULL) : NULL)
...
#define IS_SgAdaAccessType_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAdaAccessType::static_variant >> 3] & (1 << (SgAdaAccessType::static_variant & 7)))) ? ((SgAdaAccessType*) (node)) : NULL) : NULL)
#define IS_SgAdaSubtype_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAdaSubtype::static_variant >> 3] & (1 << (SgAdaSubtype::static_variant & 7)))) ? ((SgAdaSubtype*) (node)) : NULL) : NULL)
#define IS_SgAdaDerivedType_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAdaDerivedType::static_variant >> 3] & (1 << (SgAdaDerivedType::static_variant & 7)))) ? ((SgAdaDerivedType*) (node)) : NULL) : NULL)
#define IS_SgAdaModularType_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAdaModularType::static_variant >> 3] & (1 << (SgAdaModularType::static_variant & 7)))) ? ((SgAdaModularType*) (node)) : NULL) : NULL)
#define IS_SgAdaDiscriminatedType_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAdaDiscriminatedType::static_variant >> 3] & (1 << (SgAdaDiscriminatedType::static_variant & 7)))) ? ((SgAdaDiscriminatedType*) (node)) : NULL) : NULL)
#define IS_SgAdaFormalType_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAdaFormalType::static_variant >> 3] & (1 << (SgAdaFormalType::static_variant & 7)))) ? ((SgAdaFormalType*) (node)) : NULL) : NULL)
#define IS_SgAdaDiscreteType_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAdaDiscreteType::static_variant >> 3] & (1 << (SgAdaDiscreteType::static_variant & 7)))) ? ((SgAdaDiscreteType*) (node)) : NULL) : NULL)
#define IS_SgAdaSubroutineType_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAdaSubroutineType::static_variant >> 3] & (1 << (SgAdaSubroutineType::static_variant & 7)))) ? ((SgAdaSubroutineType*) (node)) : NULL) : NULL)
#define IS_SgRangeType_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgRangeType::static_variant >> 3] & (1 << (SgRangeType::static_variant & 7)))) ? ((SgRangeType*) (node)) : NULL) : NULL)
#define IS_SgJovialBitType_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgJovialBitType::static_variant >> 3] & (1 << (SgJovialBitType::static_variant & 7)))) ? ((SgJovialBitType*) (node)) : NULL) : NULL)
...
#define IS_SgAdaTaskType_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAdaTaskType::static_variant >> 3] & (1 << (SgAdaTaskType::static_variant & 7)))) ? ((SgAdaTaskType*) (node)) : NULL) : NULL)
#define IS_SgAdaProtectedType_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAdaProtectedType::static_variant >> 3] & (1 << (SgAdaProtectedType::static_variant & 7)))) ? ((SgAdaProtectedType*) (node)) : NULL) : NULL)
#define IS_SgScopedType_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgScopedType::static_variant >> 3] & (1 << (SgScopedType::static_variant & 7)))) ? ((SgScopedType*) (node)) : NULL) : NULL)
...
#define IS_SgTypeChar16_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgTypeChar16::static_variant >> 3] & (1 << (SgTypeChar16::static_variant & 7)))) ? ((SgTypeChar16*) (node)) : NULL) : NULL)
#define IS_SgTypeChar32_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgTypeChar32::static_variant >> 3] & (1 << (SgTypeChar32::static_variant & 7)))) ? ((SgTypeChar32*) (node)) : NULL) : NULL)
#define IS_SgSignedIntegralType_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgSignedIntegralType::static_variant >> 3] & (1 << (SgSignedIntegralType::static_variant & 7)))) ? ((SgSignedIntegralType*) (node)) : NULL) : NULL)
#define IS_SgUnsignedIntegralType_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgUnsignedIntegralType::static_variant >> 3] & (1 << (SgUnsignedIntegralType::static_variant & 7)))) ? ((SgUnsignedIntegralType*) (node)) : NULL) : NULL)
#define IS_SgIntegralType_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgIntegralType::static_variant >> 3] & (1 << (SgIntegralType::static_variant & 7)))) ? ((SgIntegralType*) (node)) : NULL) : NULL)
#define IS_SgFloatingPointType_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgFloatingPointType::static_variant >> 3] & (1 << (SgFloatingPointType::static_variant & 7)))) ? ((SgFloatingPointType*) (node)) : NULL) : NULL)
...
#define IS_SgRangeBasedForStatement_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgRangeBasedForStatement::static_variant >> 3] & (1 << (SgRangeBasedForStatement::static_variant & 7)))) ? ((SgRangeBasedForStatement*) (node)) : NULL) : NULL)
...
#define IS_SgAdaParameterList_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAdaParameterList::static_variant >> 3] & (1 << (SgAdaParameterList::static_variant & 7)))) ? ((SgAdaParameterList*) (node)) : NULL) : NULL)
...
#define IS_SgFunctionParameterScope_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgFunctionParameterScope::static_variant >> 3] & (1 << (SgFunctionParameterScope::static_variant & 7)))) ? ((SgFunctionParameterScope*) (node)) : NULL) : NULL)
#define IS_SgDeclarationScope_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgDeclarationScope::static_variant >> 3] & (1 << (SgDeclarationScope::static_variant & 7)))) ? ((SgDeclarationScope*) (node)) : NULL) : NULL)
...
#define IS_SgAdaExitStmt_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAdaExitStmt::static_variant >> 3] & (1 << (SgAdaExitStmt::static_variant & 7)))) ? ((SgAdaExitStmt*) (node)) : NULL) : NULL)
#define IS_SgAdaLoopStmt_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAdaLoopStmt::static_variant >> 3] & (1 << (SgAdaLoopStmt::static_variant & 7)))) ? ((SgAdaLoopStmt*) (node)) : NULL) : NULL)
#define IS_SgAdaDelayStmt_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAdaDelayStmt::static_variant >> 3] & (1 << (SgAdaDelayStmt::static_variant & 7)))) ? ((SgAdaDelayStmt*) (node)) : NULL) : NULL)
#define IS_SgAdaSelectStmt_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAdaSelectStmt::static_variant >> 3] & (1 << (SgAdaSelectStmt::static_variant & 7)))) ? ((SgAdaSelectStmt*) (node)) : NULL) : NULL)
#define IS_SgAdaSelectAlternativeStmt_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAdaSelectAlternativeStmt::static_variant >> 3] & (1 << (SgAdaSelectAlternativeStmt::static_variant & 7)))) ? ((SgAdaSelectAlternativeStmt*) (node)) : NULL) : NULL)
#define IS_SgAdaTerminateStmt_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAdaTerminateStmt::static_variant >> 3] & (1 << (SgAdaTerminateStmt::static_variant & 7)))) ? ((SgAdaTerminateStmt*) (node)) : NULL) : NULL)
#define IS_SgAdaUnscopedBlock_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAdaUnscopedBlock::static_variant >> 3] & (1 << (SgAdaUnscopedBlock::static_variant & 7)))) ? ((SgAdaUnscopedBlock*) (node)) : NULL) : NULL)
#define IS_SgAdaVariantWhenStmt_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAdaVariantWhenStmt::static_variant >> 3] & (1 << (SgAdaVariantWhenStmt::static_variant & 7)))) ? ((SgAdaVariantWhenStmt*) (node)) : NULL) : NULL)
...
#define IS_SgFortranContinueStmt_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgFortranContinueStmt::static_variant >> 3] & (1 << (SgFortranContinueStmt::static_variant & 7)))) ? ((SgFortranContinueStmt*) (node)) : NULL) : NULL)
...
#define IS_SgTemplateVariableInstantiation_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgTemplateVariableInstantiation::static_variant >> 3] & (1 << (SgTemplateVariableInstantiation::static_variant & 7)))) ? ((SgTemplateVariableInstantiation*) (node)) : NULL) : NULL)
...
#define IS_SgNonrealDecl_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgNonrealDecl::static_variant >> 3] & (1 << (SgNonrealDecl::static_variant & 7)))) ? ((SgNonrealDecl*) (node)) : NULL) : NULL)
...
#define IS_SgProcessControlStatement_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgProcessControlStatement::static_variant >> 3] & (1 << (SgProcessControlStatement::static_variant & 7)))) ? ((SgProcessControlStatement*) (node)) : NULL) : NULL)
...
#define IS_SgSyncAllStatement_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgSyncAllStatement::static_variant >> 3] & (1 << (SgSyncAllStatement::static_variant & 7)))) ? ((SgSyncAllStatement*) (node)) : NULL) : NULL)
#define IS_SgSyncImagesStatement_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgSyncImagesStatement::static_variant >> 3] & (1 << (SgSyncImagesStatement::static_variant & 7)))) ? ((SgSyncImagesStatement*) (node)) : NULL) : NULL)
#define IS_SgSyncMemoryStatement_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgSyncMemoryStatement::static_variant >> 3] & (1 << (SgSyncMemoryStatement::static_variant & 7)))) ? ((SgSyncMemoryStatement*) (node)) : NULL) : NULL)
#define IS_SgSyncTeamStatement_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgSyncTeamStatement::static_variant >> 3] & (1 << (SgSyncTeamStatement::static_variant & 7)))) ? ((SgSyncTeamStatement*) (node)) : NULL) : NULL)
#define IS_SgLockStatement_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgLockStatement::static_variant >> 3] & (1 << (SgLockStatement::static_variant & 7)))) ? ((SgLockStatement*) (node)) : NULL) : NULL)
#define IS_SgUnlockStatement_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgUnlockStatement::static_variant >> 3] & (1 << (SgUnlockStatement::static_variant & 7)))) ? ((SgUnlockStatement*) (node)) : NULL) : NULL)
#define IS_SgImageControlStatement_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgImageControlStatement::static_variant >> 3] & (1 << (SgImageControlStatement::static_variant & 7)))) ? ((SgImageControlStatement*) (node)) : NULL) : NULL)
#define IS_SgJovialCompoolStatement_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgJovialCompoolStatement::static_variant >> 3] & (1 << (SgJovialCompoolStatement::static_variant & 7)))) ? ((SgJovialCompoolStatement*) (node)) : NULL) : NULL)
#define IS_SgJovialDefineDeclaration_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgJovialDefineDeclaration::static_variant >> 3] & (1 << (SgJovialDefineDeclaration::static_variant & 7)))) ? ((SgJovialDefineDeclaration*) (node)) : NULL) : NULL)
#define IS_SgJovialDirectiveStatement_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgJovialDirectiveStatement::static_variant >> 3] & (1 << (SgJovialDirectiveStatement::static_variant & 7)))) ? ((SgJovialDirectiveStatement*) (node)) : NULL) : NULL)
#define IS_SgJovialLabelDeclaration_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgJovialLabelDeclaration::static_variant >> 3] & (1 << (SgJovialLabelDeclaration::static_variant & 7)))) ? ((SgJovialLabelDeclaration*) (node)) : NULL) : NULL)
#define IS_SgJovialOverlayDeclaration_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgJovialOverlayDeclaration::static_variant >> 3] & (1 << (SgJovialOverlayDeclaration::static_variant & 7)))) ? ((SgJovialOverlayDeclaration*) (node)) : NULL) : NULL)
#define IS_SgJovialForThenStatement_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgJovialForThenStatement::static_variant >> 3] & (1 << (SgJovialForThenStatement::static_variant & 7)))) ? ((SgJovialForThenStatement*) (node)) : NULL) : NULL)
...
#define IS_SgOmpForSimdStatement_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgOmpForSimdStatement::static_variant >> 3] & (1 << (SgOmpForSimdStatement::static_variant & 7)))) ? ((SgOmpForSimdStatement*) (node)) : NULL) : NULL)
...
#define IS_SgAtomicStmt_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAtomicStmt::static_variant >> 3] & (1 << (SgAtomicStmt::static_variant & 7)))) ? ((SgAtomicStmt*) (node)) : NULL) : NULL)
#define IS_SgWhenStmt_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgWhenStmt::static_variant >> 3] & (1 << (SgWhenStmt::static_variant & 7)))) ? ((SgWhenStmt*) (node)) : NULL) : NULL)
...
#define IS_SgJovialTableStatement_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgJovialTableStatement::static_variant >> 3] & (1 << (SgJovialTableStatement::static_variant & 7)))) ? ((SgJovialTableStatement*) (node)) : NULL) : NULL)
...
#define IS_SgAdaAcceptStmt_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAdaAcceptStmt::static_variant >> 3] & (1 << (SgAdaAcceptStmt::static_variant & 7)))) ? ((SgAdaAcceptStmt*) (node)) : NULL) : NULL)
#define IS_SgAdaPackageBody_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAdaPackageBody::static_variant >> 3] & (1 << (SgAdaPackageBody::static_variant & 7)))) ? ((SgAdaPackageBody*) (node)) : NULL) : NULL)
#define IS_SgAdaPackageSpec_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAdaPackageSpec::static_variant >> 3] & (1 << (SgAdaPackageSpec::static_variant & 7)))) ? ((SgAdaPackageSpec*) (node)) : NULL) : NULL)
#define IS_SgAdaTaskBody_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAdaTaskBody::static_variant >> 3] & (1 << (SgAdaTaskBody::static_variant & 7)))) ? ((SgAdaTaskBody*) (node)) : NULL) : NULL)
#define IS_SgAdaTaskSpec_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAdaTaskSpec::static_variant >> 3] & (1 << (SgAdaTaskSpec::static_variant & 7)))) ? ((SgAdaTaskSpec*) (node)) : NULL) : NULL)
#define IS_SgAdaProtectedBody_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAdaProtectedBody::static_variant >> 3] & (1 << (SgAdaProtectedBody::static_variant & 7)))) ? ((SgAdaProtectedBody*) (node)) : NULL) : NULL)
#define IS_SgAdaProtectedSpec_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAdaProtectedSpec::static_variant >> 3] & (1 << (SgAdaProtectedSpec::static_variant & 7)))) ? ((SgAdaProtectedSpec*) (node)) : NULL) : NULL)
#define IS_SgAdaGenericDefn_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAdaGenericDefn::static_variant >> 3] & (1 << (SgAdaGenericDefn::static_variant & 7)))) ? ((SgAdaGenericDefn*) (node)) : NULL) : NULL)
...
#define IS_SgAdaEntryDecl_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAdaEntryDecl::static_variant >> 3] & (1 << (SgAdaEntryDecl::static_variant & 7)))) ? ((SgAdaEntryDecl*) (node)) : NULL) : NULL)
#define IS_SgAdaFunctionRenamingDecl_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAdaFunctionRenamingDecl::static_variant >> 3] & (1 << (SgAdaFunctionRenamingDecl::static_variant & 7)))) ? ((SgAdaFunctionRenamingDecl*) (node)) : NULL) : NULL)
...
#define IS_SgOmpDeclareSimdStatement_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgOmpDeclareSimdStatement::static_variant >> 3] & (1 << (SgOmpDeclareSimdStatement::static_variant & 7)))) ? ((SgOmpDeclareSimdStatement*) (node)) : NULL) : NULL)
...
#define IS_SgEmptyDeclaration_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgEmptyDeclaration::static_variant >> 3] & (1 << (SgEmptyDeclaration::static_variant & 7)))) ? ((SgEmptyDeclaration*) (node)) : NULL) : NULL)
#define IS_SgAdaPackageSpecDecl_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAdaPackageSpecDecl::static_variant >> 3] & (1 << (SgAdaPackageSpecDecl::static_variant & 7)))) ? ((SgAdaPackageSpecDecl*) (node)) : NULL) : NULL)
#define IS_SgAdaPackageBodyDecl_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAdaPackageBodyDecl::static_variant >> 3] & (1 << (SgAdaPackageBodyDecl::static_variant & 7)))) ? ((SgAdaPackageBodyDecl*) (node)) : NULL) : NULL)
#define IS_SgAdaTaskSpecDecl_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAdaTaskSpecDecl::static_variant >> 3] & (1 << (SgAdaTaskSpecDecl::static_variant & 7)))) ? ((SgAdaTaskSpecDecl*) (node)) : NULL) : NULL)
#define IS_SgAdaTaskTypeDecl_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAdaTaskTypeDecl::static_variant >> 3] & (1 << (SgAdaTaskTypeDecl::static_variant & 7)))) ? ((SgAdaTaskTypeDecl*) (node)) : NULL) : NULL)
#define IS_SgAdaTaskBodyDecl_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAdaTaskBodyDecl::static_variant >> 3] & (1 << (SgAdaTaskBodyDecl::static_variant & 7)))) ? ((SgAdaTaskBodyDecl*) (node)) : NULL) : NULL)
#define IS_SgAdaProtectedSpecDecl_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAdaProtectedSpecDecl::static_variant >> 3] & (1 << (SgAdaProtectedSpecDecl::static_variant & 7)))) ? ((SgAdaProtectedSpecDecl*) (node)) : NULL) : NULL)
#define IS_SgAdaProtectedTypeDecl_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAdaProtectedTypeDecl::static_variant >> 3] & (1 << (SgAdaProtectedTypeDecl::static_variant & 7)))) ? ((SgAdaProtectedTypeDecl*) (node)) : NULL) : NULL)
#define IS_SgAdaProtectedBodyDecl_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAdaProtectedBodyDecl::static_variant >> 3] & (1 << (SgAdaProtectedBodyDecl::static_variant & 7)))) ? ((SgAdaProtectedBodyDecl*) (node)) : NULL) : NULL)
#define IS_SgAdaRepresentationClause_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAdaRepresentationClause::static_variant >> 3] & (1 << (SgAdaRepresentationClause::static_variant & 7)))) ? ((SgAdaRepresentationClause*) (node)) : NULL) : NULL)
#define IS_SgAdaEnumRepresentationClause_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAdaEnumRepresentationClause::static_variant >> 3] & (1 << (SgAdaEnumRepresentationClause::static_variant & 7)))) ? ((SgAdaEnumRepresentationClause*) (node)) : NULL) : NULL)
#define IS_SgAdaAttributeClause_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAdaAttributeClause::static_variant >> 3] & (1 << (SgAdaAttributeClause::static_variant & 7)))) ? ((SgAdaAttributeClause*) (node)) : NULL) : NULL)
#define IS_SgAdaComponentClause_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAdaComponentClause::static_variant >> 3] & (1 << (SgAdaComponentClause::static_variant & 7)))) ? ((SgAdaComponentClause*) (node)) : NULL) : NULL)
#define IS_SgAdaRenamingDecl_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAdaRenamingDecl::static_variant >> 3] & (1 << (SgAdaRenamingDecl::static_variant & 7)))) ? ((SgAdaRenamingDecl*) (node)) : NULL) : NULL)
#define IS_SgAdaGenericDecl_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAdaGenericDecl::static_variant >> 3] & (1 << (SgAdaGenericDecl::static_variant & 7)))) ? ((SgAdaGenericDecl*) (node)) : NULL) : NULL)
#define IS_SgAdaGenericInstanceDecl_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAdaGenericInstanceDecl::static_variant >> 3] & (1 << (SgAdaGenericInstanceDecl::static_variant & 7)))) ? ((SgAdaGenericInstanceDecl*) (node)) : NULL) : NULL)
#define IS_SgAdaFormalTypeDecl_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAdaFormalTypeDecl::static_variant >> 3] & (1 << (SgAdaFormalTypeDecl::static_variant & 7)))) ? ((SgAdaFormalTypeDecl*) (node)) : NULL) : NULL)
#define IS_SgAdaFormalPackageDecl_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAdaFormalPackageDecl::static_variant >> 3] & (1 << (SgAdaFormalPackageDecl::static_variant & 7)))) ? ((SgAdaFormalPackageDecl*) (node)) : NULL) : NULL)
#define IS_SgAdaDiscriminatedTypeDecl_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAdaDiscriminatedTypeDecl::static_variant >> 3] & (1 << (SgAdaDiscriminatedTypeDecl::static_variant & 7)))) ? ((SgAdaDiscriminatedTypeDecl*) (node)) : NULL) : NULL)
#define IS_SgAdaVariantDecl_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAdaVariantDecl::static_variant >> 3] & (1 << (SgAdaVariantDecl::static_variant & 7)))) ? ((SgAdaVariantDecl*) (node)) : NULL) : NULL)
...
#define IS_SgAbsOp_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAbsOp::static_variant >> 3] & (1 << (SgAbsOp::static_variant & 7)))) ? ((SgAbsOp*) (node)) : NULL) : NULL)
...
#define IS_SgAdaAncestorInitializer_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAdaAncestorInitializer::static_variant >> 3] & (1 << (SgAdaAncestorInitializer::static_variant & 7)))) ? ((SgAdaAncestorInitializer*) (node)) : NULL) : NULL)
#define IS_SgAdaAttributeExp_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAdaAttributeExp::static_variant >> 3] & (1 << (SgAdaAttributeExp::static_variant & 7)))) ? ((SgAdaAttributeExp*) (node)) : NULL) : NULL)
#define IS_SgAdaFloatVal_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAdaFloatVal::static_variant >> 3] & (1 << (SgAdaFloatVal::static_variant & 7)))) ? ((SgAdaFloatVal*) (node)) : NULL) : NULL)
#define IS_SgAdaOthersExp_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAdaOthersExp::static_variant >> 3] & (1 << (SgAdaOthersExp::static_variant & 7)))) ? ((SgAdaOthersExp*) (node)) : NULL) : NULL)
#define IS_SgAdaProtectedRefExp_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAdaProtectedRefExp::static_variant >> 3] & (1 << (SgAdaProtectedRefExp::static_variant & 7)))) ? ((SgAdaProtectedRefExp*) (node)) : NULL) : NULL)
#define IS_SgAdaRenamingRefExp_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAdaRenamingRefExp::static_variant >> 3] & (1 << (SgAdaRenamingRefExp::static_variant & 7)))) ? ((SgAdaRenamingRefExp*) (node)) : NULL) : NULL)
#define IS_SgAdaTaskRefExp_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAdaTaskRefExp::static_variant >> 3] & (1 << (SgAdaTaskRefExp::static_variant & 7)))) ? ((SgAdaTaskRefExp*) (node)) : NULL) : NULL)
#define IS_SgAdaUnitRefExp_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAdaUnitRefExp::static_variant >> 3] & (1 << (SgAdaUnitRefExp::static_variant & 7)))) ? ((SgAdaUnitRefExp*) (node)) : NULL) : NULL)
...
#define IS_SgAtExp_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAtExp::static_variant >> 3] & (1 << (SgAtExp::static_variant & 7)))) ? ((SgAtExp*) (node)) : NULL) : NULL)
#define IS_SgAtOp_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAtOp::static_variant >> 3] & (1 << (SgAtOp::static_variant & 7)))) ? ((SgAtOp*) (node)) : NULL) : NULL)
#define IS_SgAwaitExpression_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAwaitExpression::static_variant >> 3] & (1 << (SgAwaitExpression::static_variant & 7)))) ? ((SgAwaitExpression*) (node)) : NULL) : NULL)
...
#define IS_SgBitEqvOp_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgBitEqvOp::static_variant >> 3] & (1 << (SgBitEqvOp::static_variant & 7)))) ? ((SgBitEqvOp*) (node)) : NULL) : NULL)
...
#define IS_SgBracedInitializer_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgBracedInitializer::static_variant >> 3] & (1 << (SgBracedInitializer::static_variant & 7)))) ? ((SgBracedInitializer*) (node)) : NULL) : NULL)
...
#define IS_SgChar16Val_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgChar16Val::static_variant >> 3] & (1 << (SgChar16Val::static_variant & 7)))) ? ((SgChar16Val*) (node)) : NULL) : NULL)
#define IS_SgChar32Val_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgChar32Val::static_variant >> 3] & (1 << (SgChar32Val::static_variant & 7)))) ? ((SgChar32Val*) (node)) : NULL) : NULL)
...
#define IS_SgChooseExpression_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgChooseExpression::static_variant >> 3] & (1 << (SgChooseExpression::static_variant & 7)))) ? ((SgChooseExpression*) (node)) : NULL) : NULL)
...
#define IS_SgDotDotExp_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgDotDotExp::static_variant >> 3] & (1 << (SgDotDotExp::static_variant & 7)))) ? ((SgDotDotExp*) (node)) : NULL) : NULL)
...
#define IS_SgFinishExp_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgFinishExp::static_variant >> 3] & (1 << (SgFinishExp::static_variant & 7)))) ? ((SgFinishExp*) (node)) : NULL) : NULL)
#define IS_SgFloat128Val_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgFloat128Val::static_variant >> 3] & (1 << (SgFloat128Val::static_variant & 7)))) ? ((SgFloat128Val*) (node)) : NULL) : NULL)
#define IS_SgFloat80Val_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgFloat80Val::static_variant >> 3] & (1 << (SgFloat80Val::static_variant & 7)))) ? ((SgFloat80Val*) (node)) : NULL) : NULL)
#define IS_SgBFloat16Val_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgBFloat16Val::static_variant >> 3] & (1 << (SgBFloat16Val::static_variant & 7)))) ? ((SgBFloat16Val*) (node)) : NULL) : NULL)
#define IS_SgFloat16Val_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgFloat16Val::static_variant >> 3] & (1 << (SgFloat16Val::static_variant & 7)))) ? ((SgFloat16Val*) (node)) : NULL) : NULL)
#define IS_SgFloat32Val_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgFloat32Val::static_variant >> 3] & (1 << (SgFloat32Val::static_variant & 7)))) ? ((SgFloat32Val*) (node)) : NULL) : NULL)
#define IS_SgFloat64Val_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgFloat64Val::static_variant >> 3] & (1 << (SgFloat64Val::static_variant & 7)))) ? ((SgFloat64Val*) (node)) : NULL) : NULL)
...
#define IS_SgFoldExpression_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgFoldExpression::static_variant >> 3] & (1 << (SgFoldExpression::static_variant & 7)))) ? ((SgFoldExpression*) (node)) : NULL) : NULL)
...
#define IS_SgJovialPresetPositionExp_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgJovialPresetPositionExp::static_variant >> 3] & (1 << (SgJovialPresetPositionExp::static_variant & 7)))) ? ((SgJovialPresetPositionExp*) (node)) : NULL) : NULL)
#define IS_SgJovialTablePresetExp_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgJovialTablePresetExp::static_variant >> 3] & (1 << (SgJovialTablePresetExp::static_variant & 7)))) ? ((SgJovialTablePresetExp*) (node)) : NULL) : NULL)
...
#define IS_SgNonrealRefExp_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgNonrealRefExp::static_variant >> 3] & (1 << (SgNonrealRefExp::static_variant & 7)))) ? ((SgNonrealRefExp*) (node)) : NULL) : NULL)
...
#define IS_SgRemOp_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgRemOp::static_variant >> 3] & (1 << (SgRemOp::static_variant & 7)))) ? ((SgRemOp*) (node)) : NULL) : NULL)
#define IS_SgReplicationOp_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgReplicationOp::static_variant >> 3] & (1 << (SgReplicationOp::static_variant & 7)))) ? ((SgReplicationOp*) (node)) : NULL) : NULL)
...
#define IS_SgSpaceshipOp_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgSpaceshipOp::static_variant >> 3] & (1 << (SgSpaceshipOp::static_variant & 7)))) ? ((SgSpaceshipOp*) (node)) : NULL) : NULL)
...
#define IS_SgSignedCharVal_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgSignedCharVal::static_variant >> 3] & (1 << (SgSignedCharVal::static_variant & 7)))) ? ((SgSignedCharVal*) (node)) : NULL) : NULL)
...
#define IS_SgVoidVal_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgVoidVal::static_variant >> 3] & (1 << (SgVoidVal::static_variant & 7)))) ? ((SgVoidVal*) (node)) : NULL) : NULL)
...
#define IS_SgScopedRefExp_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgScopedRefExp::static_variant >> 3] & (1 << (SgScopedRefExp::static_variant & 7)))) ? ((SgScopedRefExp*) (node)) : NULL) : NULL)
#define IS_SgTypeRefExp_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgTypeRefExp::static_variant >> 3] & (1 << (SgTypeRefExp::static_variant & 7)))) ? ((SgTypeRefExp*) (node)) : NULL) : NULL)
#define IS_SgReferenceExp_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgReferenceExp::static_variant >> 3] & (1 << (SgReferenceExp::static_variant & 7)))) ? ((SgReferenceExp*) (node)) : NULL) : NULL)
...
#define IS_SgAdaInheritedFunctionSymbol_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAdaInheritedFunctionSymbol::static_variant >> 3] & (1 << (SgAdaInheritedFunctionSymbol::static_variant & 7)))) ? ((SgAdaInheritedFunctionSymbol*) (node)) : NULL) : NULL)
...
#define IS_SgTypeSymbol_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgTypeSymbol::static_variant >> 3] & (1 << (SgTypeSymbol::static_variant & 7)))) ? ((SgTypeSymbol*) (node)) : NULL) : NULL)
...
#define IS_SgNonrealSymbol_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgNonrealSymbol::static_variant >> 3] & (1 << (SgNonrealSymbol::static_variant & 7)))) ? ((SgNonrealSymbol*) (node)) : NULL) : NULL)
#define IS_SgAdaPackageSymbol_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAdaPackageSymbol::static_variant >> 3] & (1 << (SgAdaPackageSymbol::static_variant & 7)))) ? ((SgAdaPackageSymbol*) (node)) : NULL) : NULL)
#define IS_SgAdaTaskSymbol_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAdaTaskSymbol::static_variant >> 3] & (1 << (SgAdaTaskSymbol::static_variant & 7)))) ? ((SgAdaTaskSymbol*) (node)) : NULL) : NULL)
#define IS_SgAdaProtectedSymbol_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAdaProtectedSymbol::static_variant >> 3] & (1 << (SgAdaProtectedSymbol::static_variant & 7)))) ? ((SgAdaProtectedSymbol*) (node)) : NULL) : NULL)
#define IS_SgAdaGenericSymbol_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAdaGenericSymbol::static_variant >> 3] & (1 << (SgAdaGenericSymbol::static_variant & 7)))) ? ((SgAdaGenericSymbol*) (node)) : NULL) : NULL)
#define IS_SgAdaGenericInstanceSymbol_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAdaGenericInstanceSymbol::static_variant >> 3] & (1 << (SgAdaGenericInstanceSymbol::static_variant & 7)))) ? ((SgAdaGenericInstanceSymbol*) (node)) : NULL) : NULL)
#define IS_SgAdaFormalPackageSymbol_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAdaFormalPackageSymbol::static_variant >> 3] & (1 << (SgAdaFormalPackageSymbol::static_variant & 7)))) ? ((SgAdaFormalPackageSymbol*) (node)) : NULL) : NULL)
#define IS_SgAdaRenamingSymbol_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAdaRenamingSymbol::static_variant >> 3] & (1 << (SgAdaRenamingSymbol::static_variant & 7)))) ? ((SgAdaRenamingSymbol*) (node)) : NULL) : NULL)
...
#define IS_SgAsmVoidType_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAsmVoidType::static_variant >> 3] & (1 << (SgAsmVoidType::static_variant & 7)))) ? ((SgAsmVoidType*) (node)) : NULL) : NULL)
...
#define IS_SgAsmUserInstruction_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAsmUserInstruction::static_variant >> 3] & (1 << (SgAsmUserInstruction::static_variant & 7)))) ? ((SgAsmUserInstruction*) (node)) : NULL) : NULL)
#define IS_SgAsmUnaryUnsignedExtend_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAsmUnaryUnsignedExtend::static_variant >> 3] & (1 << (SgAsmUnaryUnsignedExtend::static_variant & 7)))) ? ((SgAsmUnaryUnsignedExtend*) (node)) : NULL) : NULL)
#define IS_SgAsmUnaryTruncate_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAsmUnaryTruncate::static_variant >> 3] & (1 << (SgAsmUnaryTruncate::static_variant & 7)))) ? ((SgAsmUnaryTruncate*) (node)) : NULL) : NULL)
#define IS_SgAsmUnarySignedExtend_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAsmUnarySignedExtend::static_variant >> 3] & (1 << (SgAsmUnarySignedExtend::static_variant & 7)))) ? ((SgAsmUnarySignedExtend*) (node)) : NULL) : NULL)
...
#define IS_SgAsmStackExpression_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAsmStackExpression::static_variant >> 3] & (1 << (SgAsmStackExpression::static_variant & 7)))) ? ((SgAsmStackExpression*) (node)) : NULL) : NULL)
...
#define IS_SgAsmPointerType_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAsmPointerType::static_variant >> 3] & (1 << (SgAsmPointerType::static_variant & 7)))) ? ((SgAsmPointerType*) (node)) : NULL) : NULL)
...
#define IS_SgAsmNullInstruction_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAsmNullInstruction::static_variant >> 3] & (1 << (SgAsmNullInstruction::static_variant & 7)))) ? ((SgAsmNullInstruction*) (node)) : NULL) : NULL)
...
#define IS_SgAsmJvmStackMapVerificationType_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAsmJvmStackMapVerificationType::static_variant >> 3] & (1 << (SgAsmJvmStackMapVerificationType::static_variant & 7)))) ? ((SgAsmJvmStackMapVerificationType*) (node)) : NULL) : NULL)
#define IS_SgAsmJvmStackMapTable_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAsmJvmStackMapTable::static_variant >> 3] & (1 << (SgAsmJvmStackMapTable::static_variant & 7)))) ? ((SgAsmJvmStackMapTable*) (node)) : NULL) : NULL)
#define IS_SgAsmJvmStackMapFrame_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAsmJvmStackMapFrame::static_variant >> 3] & (1 << (SgAsmJvmStackMapFrame::static_variant & 7)))) ? ((SgAsmJvmStackMapFrame*) (node)) : NULL) : NULL)
#define IS_SgAsmJvmRuntimeVisibleAnnotations_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAsmJvmRuntimeVisibleAnnotations::static_variant >> 3] & (1 << (SgAsmJvmRuntimeVisibleAnnotations::static_variant & 7)))) ? ((SgAsmJvmRuntimeVisibleAnnotations*) (node)) : NULL) : NULL)
#define IS_SgAsmJvmRuntimeVisibilityParamAnnotations_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAsmJvmRuntimeVisibilityParamAnnotations::static_variant >> 3] & (1 << (SgAsmJvmRuntimeVisibilityParamAnnotations::static_variant & 7)))) ? ((SgAsmJvmRuntimeVisibilityParamAnnotations*) (node)) : NULL) : NULL)
#define IS_SgAsmJvmRuntimeParameterAnnotation_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAsmJvmRuntimeParameterAnnotation::static_variant >> 3] & (1 << (SgAsmJvmRuntimeParameterAnnotation::static_variant & 7)))) ? ((SgAsmJvmRuntimeParameterAnnotation*) (node)) : NULL) : NULL)
#define IS_SgAsmJvmRuntimeInvisibleAnnotations_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAsmJvmRuntimeInvisibleAnnotations::static_variant >> 3] & (1 << (SgAsmJvmRuntimeInvisibleAnnotations::static_variant & 7)))) ? ((SgAsmJvmRuntimeInvisibleAnnotations*) (node)) : NULL) : NULL)
#define IS_SgAsmJvmRuntimeAnnotationValue_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAsmJvmRuntimeAnnotationValue::static_variant >> 3] & (1 << (SgAsmJvmRuntimeAnnotationValue::static_variant & 7)))) ? ((SgAsmJvmRuntimeAnnotationValue*) (node)) : NULL) : NULL)
#define IS_SgAsmJvmRuntimeAnnotationPair_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAsmJvmRuntimeAnnotationPair::static_variant >> 3] & (1 << (SgAsmJvmRuntimeAnnotationPair::static_variant & 7)))) ? ((SgAsmJvmRuntimeAnnotationPair*) (node)) : NULL) : NULL)
#define IS_SgAsmJvmRuntimeAnnotation_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAsmJvmRuntimeAnnotation::static_variant >> 3] & (1 << (SgAsmJvmRuntimeAnnotation::static_variant & 7)))) ? ((SgAsmJvmRuntimeAnnotation*) (node)) : NULL) : NULL)
#define IS_SgAsmJvmModule_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAsmJvmModule::static_variant >> 3] & (1 << (SgAsmJvmModule::static_variant & 7)))) ? ((SgAsmJvmModule*) (node)) : NULL) : NULL)
#define IS_SgAsmJvmMethodTable_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAsmJvmMethodTable::static_variant >> 3] & (1 << (SgAsmJvmMethodTable::static_variant & 7)))) ? ((SgAsmJvmMethodTable*) (node)) : NULL) : NULL)
#define IS_SgAsmJvmMethodParameters_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAsmJvmMethodParameters::static_variant >> 3] & (1 << (SgAsmJvmMethodParameters::static_variant & 7)))) ? ((SgAsmJvmMethodParameters*) (node)) : NULL) : NULL)
#define IS_SgAsmJvmMethodParametersEntry_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAsmJvmMethodParametersEntry::static_variant >> 3] & (1 << (SgAsmJvmMethodParametersEntry::static_variant & 7)))) ? ((SgAsmJvmMethodParametersEntry*) (node)) : NULL) : NULL)
#define IS_SgAsmJvmMethod_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAsmJvmMethod::static_variant >> 3] & (1 << (SgAsmJvmMethod::static_variant & 7)))) ? ((SgAsmJvmMethod*) (node)) : NULL) : NULL)
#define IS_SgAsmJvmLocalVariableTypeTable_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAsmJvmLocalVariableTypeTable::static_variant >> 3] & (1 << (SgAsmJvmLocalVariableTypeTable::static_variant & 7)))) ? ((SgAsmJvmLocalVariableTypeTable*) (node)) : NULL) : NULL)
#define IS_SgAsmJvmLocalVariableTypeEntry_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAsmJvmLocalVariableTypeEntry::static_variant >> 3] & (1 << (SgAsmJvmLocalVariableTypeEntry::static_variant & 7)))) ? ((SgAsmJvmLocalVariableTypeEntry*) (node)) : NULL) : NULL)
#define IS_SgAsmJvmLocalVariableTable_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAsmJvmLocalVariableTable::static_variant >> 3] & (1 << (SgAsmJvmLocalVariableTable::static_variant & 7)))) ? ((SgAsmJvmLocalVariableTable*) (node)) : NULL) : NULL)
#define IS_SgAsmJvmLocalVariableEntry_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAsmJvmLocalVariableEntry::static_variant >> 3] & (1 << (SgAsmJvmLocalVariableEntry::static_variant & 7)))) ? ((SgAsmJvmLocalVariableEntry*) (node)) : NULL) : NULL)
#define IS_SgAsmJvmLineNumberTable_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAsmJvmLineNumberTable::static_variant >> 3] & (1 << (SgAsmJvmLineNumberTable::static_variant & 7)))) ? ((SgAsmJvmLineNumberTable*) (node)) : NULL) : NULL)
#define IS_SgAsmJvmInstruction_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAsmJvmInstruction::static_variant >> 3] & (1 << (SgAsmJvmInstruction::static_variant & 7)))) ? ((SgAsmJvmInstruction*) (node)) : NULL) : NULL)
#define IS_SgAsmJvmInnerClasses_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAsmJvmInnerClasses::static_variant >> 3] & (1 << (SgAsmJvmInnerClasses::static_variant & 7)))) ? ((SgAsmJvmInnerClasses*) (node)) : NULL) : NULL)
#define IS_SgAsmJvmIndexTableAttr_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAsmJvmIndexTableAttr::static_variant >> 3] & (1 << (SgAsmJvmIndexTableAttr::static_variant & 7)))) ? ((SgAsmJvmIndexTableAttr*) (node)) : NULL) : NULL)
#define IS_SgAsmJvmIndexedAttr_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAsmJvmIndexedAttr::static_variant >> 3] & (1 << (SgAsmJvmIndexedAttr::static_variant & 7)))) ? ((SgAsmJvmIndexedAttr*) (node)) : NULL) : NULL)
#define IS_SgAsmJvmFileHeader_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAsmJvmFileHeader::static_variant >> 3] & (1 << (SgAsmJvmFileHeader::static_variant & 7)))) ? ((SgAsmJvmFileHeader*) (node)) : NULL) : NULL)
#define IS_SgAsmJvmFieldTable_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAsmJvmFieldTable::static_variant >> 3] & (1 << (SgAsmJvmFieldTable::static_variant & 7)))) ? ((SgAsmJvmFieldTable*) (node)) : NULL) : NULL)
#define IS_SgAsmJvmField_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAsmJvmField::static_variant >> 3] & (1 << (SgAsmJvmField::static_variant & 7)))) ? ((SgAsmJvmField*) (node)) : NULL) : NULL)
#define IS_SgAsmJvmExceptionTable_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAsmJvmExceptionTable::static_variant >> 3] & (1 << (SgAsmJvmExceptionTable::static_variant & 7)))) ? ((SgAsmJvmExceptionTable*) (node)) : NULL) : NULL)
#define IS_SgAsmJvmExceptionHandler_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAsmJvmExceptionHandler::static_variant >> 3] & (1 << (SgAsmJvmExceptionHandler::static_variant & 7)))) ? ((SgAsmJvmExceptionHandler*) (node)) : NULL) : NULL)
#define IS_SgAsmJvmEnclosingMethod_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAsmJvmEnclosingMethod::static_variant >> 3] & (1 << (SgAsmJvmEnclosingMethod::static_variant & 7)))) ? ((SgAsmJvmEnclosingMethod*) (node)) : NULL) : NULL)
#define IS_SgAsmJvmConstantPool_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAsmJvmConstantPool::static_variant >> 3] & (1 << (SgAsmJvmConstantPool::static_variant & 7)))) ? ((SgAsmJvmConstantPool*) (node)) : NULL) : NULL)
#define IS_SgAsmJvmConstantPoolEntry_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAsmJvmConstantPoolEntry::static_variant >> 3] & (1 << (SgAsmJvmConstantPoolEntry::static_variant & 7)))) ? ((SgAsmJvmConstantPoolEntry*) (node)) : NULL) : NULL)
#define IS_SgAsmJvmCodeAttribute_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAsmJvmCodeAttribute::static_variant >> 3] & (1 << (SgAsmJvmCodeAttribute::static_variant & 7)))) ? ((SgAsmJvmCodeAttribute*) (node)) : NULL) : NULL)
#define IS_SgAsmJvmClass_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAsmJvmClass::static_variant >> 3] & (1 << (SgAsmJvmClass::static_variant & 7)))) ? ((SgAsmJvmClass*) (node)) : NULL) : NULL)
#define IS_SgAsmJvmBootstrapMethods_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAsmJvmBootstrapMethods::static_variant >> 3] & (1 << (SgAsmJvmBootstrapMethods::static_variant & 7)))) ? ((SgAsmJvmBootstrapMethods*) (node)) : NULL) : NULL)
#define IS_SgAsmJvmBootstrapMethod_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAsmJvmBootstrapMethod::static_variant >> 3] & (1 << (SgAsmJvmBootstrapMethod::static_variant & 7)))) ? ((SgAsmJvmBootstrapMethod*) (node)) : NULL) : NULL)
#define IS_SgAsmJvmAttributeTable_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAsmJvmAttributeTable::static_variant >> 3] & (1 << (SgAsmJvmAttributeTable::static_variant & 7)))) ? ((SgAsmJvmAttributeTable*) (node)) : NULL) : NULL)
#define IS_SgAsmJvmAnnotationDefault_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAsmJvmAnnotationDefault::static_variant >> 3] & (1 << (SgAsmJvmAnnotationDefault::static_variant & 7)))) ? ((SgAsmJvmAnnotationDefault*) (node)) : NULL) : NULL)
#define IS_SgAsmJvmAttribute_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAsmJvmAttribute::static_variant >> 3] & (1 << (SgAsmJvmAttribute::static_variant & 7)))) ? ((SgAsmJvmAttribute*) (node)) : NULL) : NULL)
#define IS_SgAsmJvmNode_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAsmJvmNode::static_variant >> 3] & (1 << (SgAsmJvmNode::static_variant & 7)))) ? ((SgAsmJvmNode*) (node)) : NULL) : NULL)
...
#define IS_SgAsmInstructionList_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAsmInstructionList::static_variant >> 3] & (1 << (SgAsmInstructionList::static_variant & 7)))) ? ((SgAsmInstructionList*) (node)) : NULL) : NULL)
...
#define IS_SgAsmCliHeader_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAsmCliHeader::static_variant >> 3] & (1 << (SgAsmCliHeader::static_variant & 7)))) ? ((SgAsmCliHeader*) (node)) : NULL) : NULL)
...
#define IS_SgAsmCilUint8Heap_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAsmCilUint8Heap::static_variant >> 3] & (1 << (SgAsmCilUint8Heap::static_variant & 7)))) ? ((SgAsmCilUint8Heap*) (node)) : NULL) : NULL)
#define IS_SgAsmCilUint32Heap_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAsmCilUint32Heap::static_variant >> 3] & (1 << (SgAsmCilUint32Heap::static_variant & 7)))) ? ((SgAsmCilUint32Heap*) (node)) : NULL) : NULL)
#define IS_SgAsmCilTypeSpecTable_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAsmCilTypeSpecTable::static_variant >> 3] & (1 << (SgAsmCilTypeSpecTable::static_variant & 7)))) ? ((SgAsmCilTypeSpecTable*) (node)) : NULL) : NULL)
#define IS_SgAsmCilTypeSpec_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAsmCilTypeSpec::static_variant >> 3] & (1 << (SgAsmCilTypeSpec::static_variant & 7)))) ? ((SgAsmCilTypeSpec*) (node)) : NULL) : NULL)
#define IS_SgAsmCilTypeRefTable_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAsmCilTypeRefTable::static_variant >> 3] & (1 << (SgAsmCilTypeRefTable::static_variant & 7)))) ? ((SgAsmCilTypeRefTable*) (node)) : NULL) : NULL)
#define IS_SgAsmCilTypeRef_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAsmCilTypeRef::static_variant >> 3] & (1 << (SgAsmCilTypeRef::static_variant & 7)))) ? ((SgAsmCilTypeRef*) (node)) : NULL) : NULL)
#define IS_SgAsmCilTypeDefTable_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAsmCilTypeDefTable::static_variant >> 3] & (1 << (SgAsmCilTypeDefTable::static_variant & 7)))) ? ((SgAsmCilTypeDefTable*) (node)) : NULL) : NULL)
#define IS_SgAsmCilTypeDef_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAsmCilTypeDef::static_variant >> 3] & (1 << (SgAsmCilTypeDef::static_variant & 7)))) ? ((SgAsmCilTypeDef*) (node)) : NULL) : NULL)
#define IS_SgAsmCilStandAloneSigTable_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAsmCilStandAloneSigTable::static_variant >> 3] & (1 << (SgAsmCilStandAloneSigTable::static_variant & 7)))) ? ((SgAsmCilStandAloneSigTable*) (node)) : NULL) : NULL)
#define IS_SgAsmCilStandAloneSig_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAsmCilStandAloneSig::static_variant >> 3] & (1 << (SgAsmCilStandAloneSig::static_variant & 7)))) ? ((SgAsmCilStandAloneSig*) (node)) : NULL) : NULL)
#define IS_SgAsmCilPropertyTable_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAsmCilPropertyTable::static_variant >> 3] & (1 << (SgAsmCilPropertyTable::static_variant & 7)))) ? ((SgAsmCilPropertyTable*) (node)) : NULL) : NULL)
#define IS_SgAsmCilPropertyMapTable_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAsmCilPropertyMapTable::static_variant >> 3] & (1 << (SgAsmCilPropertyMapTable::static_variant & 7)))) ? ((SgAsmCilPropertyMapTable*) (node)) : NULL) : NULL)
#define IS_SgAsmCilPropertyMap_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAsmCilPropertyMap::static_variant >> 3] & (1 << (SgAsmCilPropertyMap::static_variant & 7)))) ? ((SgAsmCilPropertyMap*) (node)) : NULL) : NULL)
#define IS_SgAsmCilProperty_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAsmCilProperty::static_variant >> 3] & (1 << (SgAsmCilProperty::static_variant & 7)))) ? ((SgAsmCilProperty*) (node)) : NULL) : NULL)
#define IS_SgAsmCilParamTable_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAsmCilParamTable::static_variant >> 3] & (1 << (SgAsmCilParamTable::static_variant & 7)))) ? ((SgAsmCilParamTable*) (node)) : NULL) : NULL)
#define IS_SgAsmCilParam_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAsmCilParam::static_variant >> 3] & (1 << (SgAsmCilParam::static_variant & 7)))) ? ((SgAsmCilParam*) (node)) : NULL) : NULL)
#define IS_SgAsmCilNestedClassTable_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAsmCilNestedClassTable::static_variant >> 3] & (1 << (SgAsmCilNestedClassTable::static_variant & 7)))) ? ((SgAsmCilNestedClassTable*) (node)) : NULL) : NULL)
#define IS_SgAsmCilNestedClass_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAsmCilNestedClass::static_variant >> 3] & (1 << (SgAsmCilNestedClass::static_variant & 7)))) ? ((SgAsmCilNestedClass*) (node)) : NULL) : NULL)
#define IS_SgAsmCilModuleTable_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAsmCilModuleTable::static_variant >> 3] & (1 << (SgAsmCilModuleTable::static_variant & 7)))) ? ((SgAsmCilModuleTable*) (node)) : NULL) : NULL)
#define IS_SgAsmCilModuleRefTable_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAsmCilModuleRefTable::static_variant >> 3] & (1 << (SgAsmCilModuleRefTable::static_variant & 7)))) ? ((SgAsmCilModuleRefTable*) (node)) : NULL) : NULL)
#define IS_SgAsmCilModuleRef_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAsmCilModuleRef::static_variant >> 3] & (1 << (SgAsmCilModuleRef::static_variant & 7)))) ? ((SgAsmCilModuleRef*) (node)) : NULL) : NULL)
#define IS_SgAsmCilModule_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAsmCilModule::static_variant >> 3] & (1 << (SgAsmCilModule::static_variant & 7)))) ? ((SgAsmCilModule*) (node)) : NULL) : NULL)
#define IS_SgAsmCilMethodSpecTable_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAsmCilMethodSpecTable::static_variant >> 3] & (1 << (SgAsmCilMethodSpecTable::static_variant & 7)))) ? ((SgAsmCilMethodSpecTable*) (node)) : NULL) : NULL)
#define IS_SgAsmCilMethodSpec_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAsmCilMethodSpec::static_variant >> 3] & (1 << (SgAsmCilMethodSpec::static_variant & 7)))) ? ((SgAsmCilMethodSpec*) (node)) : NULL) : NULL)
#define IS_SgAsmCilMethodSemanticsTable_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAsmCilMethodSemanticsTable::static_variant >> 3] & (1 << (SgAsmCilMethodSemanticsTable::static_variant & 7)))) ? ((SgAsmCilMethodSemanticsTable*) (node)) : NULL) : NULL)
#define IS_SgAsmCilMethodSemantics_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAsmCilMethodSemantics::static_variant >> 3] & (1 << (SgAsmCilMethodSemantics::static_variant & 7)))) ? ((SgAsmCilMethodSemantics*) (node)) : NULL) : NULL)
#define IS_SgAsmCilMethodImplTable_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAsmCilMethodImplTable::static_variant >> 3] & (1 << (SgAsmCilMethodImplTable::static_variant & 7)))) ? ((SgAsmCilMethodImplTable*) (node)) : NULL) : NULL)
#define IS_SgAsmCilMethodImpl_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAsmCilMethodImpl::static_variant >> 3] & (1 << (SgAsmCilMethodImpl::static_variant & 7)))) ? ((SgAsmCilMethodImpl*) (node)) : NULL) : NULL)
#define IS_SgAsmCilMethodDefTable_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAsmCilMethodDefTable::static_variant >> 3] & (1 << (SgAsmCilMethodDefTable::static_variant & 7)))) ? ((SgAsmCilMethodDefTable*) (node)) : NULL) : NULL)
#define IS_SgAsmCilMethodDef_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAsmCilMethodDef::static_variant >> 3] & (1 << (SgAsmCilMethodDef::static_variant & 7)))) ? ((SgAsmCilMethodDef*) (node)) : NULL) : NULL)
#define IS_SgAsmCilMethodData_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAsmCilMethodData::static_variant >> 3] & (1 << (SgAsmCilMethodData::static_variant & 7)))) ? ((SgAsmCilMethodData*) (node)) : NULL) : NULL)
#define IS_SgAsmCilMetadataRoot_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAsmCilMetadataRoot::static_variant >> 3] & (1 << (SgAsmCilMetadataRoot::static_variant & 7)))) ? ((SgAsmCilMetadataRoot*) (node)) : NULL) : NULL)
#define IS_SgAsmCilMetadataHeap_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAsmCilMetadataHeap::static_variant >> 3] & (1 << (SgAsmCilMetadataHeap::static_variant & 7)))) ? ((SgAsmCilMetadataHeap*) (node)) : NULL) : NULL)
#define IS_SgAsmCilMemberRefTable_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAsmCilMemberRefTable::static_variant >> 3] & (1 << (SgAsmCilMemberRefTable::static_variant & 7)))) ? ((SgAsmCilMemberRefTable*) (node)) : NULL) : NULL)
#define IS_SgAsmCilMemberRef_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAsmCilMemberRef::static_variant >> 3] & (1 << (SgAsmCilMemberRef::static_variant & 7)))) ? ((SgAsmCilMemberRef*) (node)) : NULL) : NULL)
#define IS_SgAsmCilManifestResourceTable_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAsmCilManifestResourceTable::static_variant >> 3] & (1 << (SgAsmCilManifestResourceTable::static_variant & 7)))) ? ((SgAsmCilManifestResourceTable*) (node)) : NULL) : NULL)
#define IS_SgAsmCilManifestResource_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAsmCilManifestResource::static_variant >> 3] & (1 << (SgAsmCilManifestResource::static_variant & 7)))) ? ((SgAsmCilManifestResource*) (node)) : NULL) : NULL)
#define IS_SgAsmCilInterfaceImplTable_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAsmCilInterfaceImplTable::static_variant >> 3] & (1 << (SgAsmCilInterfaceImplTable::static_variant & 7)))) ? ((SgAsmCilInterfaceImplTable*) (node)) : NULL) : NULL)
#define IS_SgAsmCilInterfaceImpl_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAsmCilInterfaceImpl::static_variant >> 3] & (1 << (SgAsmCilInterfaceImpl::static_variant & 7)))) ? ((SgAsmCilInterfaceImpl*) (node)) : NULL) : NULL)
#define IS_SgAsmCilInstruction_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAsmCilInstruction::static_variant >> 3] & (1 << (SgAsmCilInstruction::static_variant & 7)))) ? ((SgAsmCilInstruction*) (node)) : NULL) : NULL)
#define IS_SgAsmCilImplMapTable_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAsmCilImplMapTable::static_variant >> 3] & (1 << (SgAsmCilImplMapTable::static_variant & 7)))) ? ((SgAsmCilImplMapTable*) (node)) : NULL) : NULL)
#define IS_SgAsmCilImplMap_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAsmCilImplMap::static_variant >> 3] & (1 << (SgAsmCilImplMap::static_variant & 7)))) ? ((SgAsmCilImplMap*) (node)) : NULL) : NULL)
#define IS_SgAsmCilGenericParamTable_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAsmCilGenericParamTable::static_variant >> 3] & (1 << (SgAsmCilGenericParamTable::static_variant & 7)))) ? ((SgAsmCilGenericParamTable*) (node)) : NULL) : NULL)
#define IS_SgAsmCilGenericParam_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAsmCilGenericParam::static_variant >> 3] & (1 << (SgAsmCilGenericParam::static_variant & 7)))) ? ((SgAsmCilGenericParam*) (node)) : NULL) : NULL)
#define IS_SgAsmCilGenericParamConstraintTable_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAsmCilGenericParamConstraintTable::static_variant >> 3] & (1 << (SgAsmCilGenericParamConstraintTable::static_variant & 7)))) ? ((SgAsmCilGenericParamConstraintTable*) (node)) : NULL) : NULL)
#define IS_SgAsmCilGenericParamConstraint_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAsmCilGenericParamConstraint::static_variant >> 3] & (1 << (SgAsmCilGenericParamConstraint::static_variant & 7)))) ? ((SgAsmCilGenericParamConstraint*) (node)) : NULL) : NULL)
#define IS_SgAsmCilFileTable_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAsmCilFileTable::static_variant >> 3] & (1 << (SgAsmCilFileTable::static_variant & 7)))) ? ((SgAsmCilFileTable*) (node)) : NULL) : NULL)
#define IS_SgAsmCilFile_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAsmCilFile::static_variant >> 3] & (1 << (SgAsmCilFile::static_variant & 7)))) ? ((SgAsmCilFile*) (node)) : NULL) : NULL)
#define IS_SgAsmCilFieldTable_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAsmCilFieldTable::static_variant >> 3] & (1 << (SgAsmCilFieldTable::static_variant & 7)))) ? ((SgAsmCilFieldTable*) (node)) : NULL) : NULL)
#define IS_SgAsmCilFieldRVATable_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAsmCilFieldRVATable::static_variant >> 3] & (1 << (SgAsmCilFieldRVATable::static_variant & 7)))) ? ((SgAsmCilFieldRVATable*) (node)) : NULL) : NULL)
#define IS_SgAsmCilFieldRVA_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAsmCilFieldRVA::static_variant >> 3] & (1 << (SgAsmCilFieldRVA::static_variant & 7)))) ? ((SgAsmCilFieldRVA*) (node)) : NULL) : NULL)
#define IS_SgAsmCilFieldMarshalTable_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAsmCilFieldMarshalTable::static_variant >> 3] & (1 << (SgAsmCilFieldMarshalTable::static_variant & 7)))) ? ((SgAsmCilFieldMarshalTable*) (node)) : NULL) : NULL)
#define IS_SgAsmCilFieldMarshal_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAsmCilFieldMarshal::static_variant >> 3] & (1 << (SgAsmCilFieldMarshal::static_variant & 7)))) ? ((SgAsmCilFieldMarshal*) (node)) : NULL) : NULL)
#define IS_SgAsmCilFieldLayoutTable_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAsmCilFieldLayoutTable::static_variant >> 3] & (1 << (SgAsmCilFieldLayoutTable::static_variant & 7)))) ? ((SgAsmCilFieldLayoutTable*) (node)) : NULL) : NULL)
#define IS_SgAsmCilFieldLayout_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAsmCilFieldLayout::static_variant >> 3] & (1 << (SgAsmCilFieldLayout::static_variant & 7)))) ? ((SgAsmCilFieldLayout*) (node)) : NULL) : NULL)
#define IS_SgAsmCilField_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAsmCilField::static_variant >> 3] & (1 << (SgAsmCilField::static_variant & 7)))) ? ((SgAsmCilField*) (node)) : NULL) : NULL)
#define IS_SgAsmCilExportedTypeTable_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAsmCilExportedTypeTable::static_variant >> 3] & (1 << (SgAsmCilExportedTypeTable::static_variant & 7)))) ? ((SgAsmCilExportedTypeTable*) (node)) : NULL) : NULL)
#define IS_SgAsmCilExportedType_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAsmCilExportedType::static_variant >> 3] & (1 << (SgAsmCilExportedType::static_variant & 7)))) ? ((SgAsmCilExportedType*) (node)) : NULL) : NULL)
#define IS_SgAsmCilExceptionData_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAsmCilExceptionData::static_variant >> 3] & (1 << (SgAsmCilExceptionData::static_variant & 7)))) ? ((SgAsmCilExceptionData*) (node)) : NULL) : NULL)
#define IS_SgAsmCilEventTable_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAsmCilEventTable::static_variant >> 3] & (1 << (SgAsmCilEventTable::static_variant & 7)))) ? ((SgAsmCilEventTable*) (node)) : NULL) : NULL)
#define IS_SgAsmCilEventMapTable_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAsmCilEventMapTable::static_variant >> 3] & (1 << (SgAsmCilEventMapTable::static_variant & 7)))) ? ((SgAsmCilEventMapTable*) (node)) : NULL) : NULL)
#define IS_SgAsmCilEventMap_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAsmCilEventMap::static_variant >> 3] & (1 << (SgAsmCilEventMap::static_variant & 7)))) ? ((SgAsmCilEventMap*) (node)) : NULL) : NULL)
#define IS_SgAsmCilEvent_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAsmCilEvent::static_variant >> 3] & (1 << (SgAsmCilEvent::static_variant & 7)))) ? ((SgAsmCilEvent*) (node)) : NULL) : NULL)
#define IS_SgAsmCilErrorHeap_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAsmCilErrorHeap::static_variant >> 3] & (1 << (SgAsmCilErrorHeap::static_variant & 7)))) ? ((SgAsmCilErrorHeap*) (node)) : NULL) : NULL)
#define IS_SgAsmCilDeclSecurityTable_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAsmCilDeclSecurityTable::static_variant >> 3] & (1 << (SgAsmCilDeclSecurityTable::static_variant & 7)))) ? ((SgAsmCilDeclSecurityTable*) (node)) : NULL) : NULL)
#define IS_SgAsmCilDeclSecurity_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAsmCilDeclSecurity::static_variant >> 3] & (1 << (SgAsmCilDeclSecurity::static_variant & 7)))) ? ((SgAsmCilDeclSecurity*) (node)) : NULL) : NULL)
#define IS_SgAsmCilDataStream_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAsmCilDataStream::static_variant >> 3] & (1 << (SgAsmCilDataStream::static_variant & 7)))) ? ((SgAsmCilDataStream*) (node)) : NULL) : NULL)
#define IS_SgAsmCilCustomAttributeTable_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAsmCilCustomAttributeTable::static_variant >> 3] & (1 << (SgAsmCilCustomAttributeTable::static_variant & 7)))) ? ((SgAsmCilCustomAttributeTable*) (node)) : NULL) : NULL)
#define IS_SgAsmCilCustomAttribute_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAsmCilCustomAttribute::static_variant >> 3] & (1 << (SgAsmCilCustomAttribute::static_variant & 7)))) ? ((SgAsmCilCustomAttribute*) (node)) : NULL) : NULL)
#define IS_SgAsmCilConstantTable_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAsmCilConstantTable::static_variant >> 3] & (1 << (SgAsmCilConstantTable::static_variant & 7)))) ? ((SgAsmCilConstantTable*) (node)) : NULL) : NULL)
#define IS_SgAsmCilConstant_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAsmCilConstant::static_variant >> 3] & (1 << (SgAsmCilConstant::static_variant & 7)))) ? ((SgAsmCilConstant*) (node)) : NULL) : NULL)
#define IS_SgAsmCilClassLayoutTable_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAsmCilClassLayoutTable::static_variant >> 3] & (1 << (SgAsmCilClassLayoutTable::static_variant & 7)))) ? ((SgAsmCilClassLayoutTable*) (node)) : NULL) : NULL)
#define IS_SgAsmCilClassLayout_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAsmCilClassLayout::static_variant >> 3] & (1 << (SgAsmCilClassLayout::static_variant & 7)))) ? ((SgAsmCilClassLayout*) (node)) : NULL) : NULL)
#define IS_SgAsmCilAssemblyTable_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAsmCilAssemblyTable::static_variant >> 3] & (1 << (SgAsmCilAssemblyTable::static_variant & 7)))) ? ((SgAsmCilAssemblyTable*) (node)) : NULL) : NULL)
#define IS_SgAsmCilAssemblyRefTable_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAsmCilAssemblyRefTable::static_variant >> 3] & (1 << (SgAsmCilAssemblyRefTable::static_variant & 7)))) ? ((SgAsmCilAssemblyRefTable*) (node)) : NULL) : NULL)
#define IS_SgAsmCilAssemblyRefProcessorTable_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAsmCilAssemblyRefProcessorTable::static_variant >> 3] & (1 << (SgAsmCilAssemblyRefProcessorTable::static_variant & 7)))) ? ((SgAsmCilAssemblyRefProcessorTable*) (node)) : NULL) : NULL)
#define IS_SgAsmCilAssemblyRefProcessor_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAsmCilAssemblyRefProcessor::static_variant >> 3] & (1 << (SgAsmCilAssemblyRefProcessor::static_variant & 7)))) ? ((SgAsmCilAssemblyRefProcessor*) (node)) : NULL) : NULL)
#define IS_SgAsmCilAssemblyRefOSTable_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAsmCilAssemblyRefOSTable::static_variant >> 3] & (1 << (SgAsmCilAssemblyRefOSTable::static_variant & 7)))) ? ((SgAsmCilAssemblyRefOSTable*) (node)) : NULL) : NULL)
#define IS_SgAsmCilAssemblyRefOS_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAsmCilAssemblyRefOS::static_variant >> 3] & (1 << (SgAsmCilAssemblyRefOS::static_variant & 7)))) ? ((SgAsmCilAssemblyRefOS*) (node)) : NULL) : NULL)
#define IS_SgAsmCilAssemblyRef_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAsmCilAssemblyRef::static_variant >> 3] & (1 << (SgAsmCilAssemblyRef::static_variant & 7)))) ? ((SgAsmCilAssemblyRef*) (node)) : NULL) : NULL)
#define IS_SgAsmCilAssemblyProcessorTable_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAsmCilAssemblyProcessorTable::static_variant >> 3] & (1 << (SgAsmCilAssemblyProcessorTable::static_variant & 7)))) ? ((SgAsmCilAssemblyProcessorTable*) (node)) : NULL) : NULL)
#define IS_SgAsmCilAssemblyProcessor_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAsmCilAssemblyProcessor::static_variant >> 3] & (1 << (SgAsmCilAssemblyProcessor::static_variant & 7)))) ? ((SgAsmCilAssemblyProcessor*) (node)) : NULL) : NULL)
#define IS_SgAsmCilAssemblyOSTable_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAsmCilAssemblyOSTable::static_variant >> 3] & (1 << (SgAsmCilAssemblyOSTable::static_variant & 7)))) ? ((SgAsmCilAssemblyOSTable*) (node)) : NULL) : NULL)
#define IS_SgAsmCilAssemblyOS_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAsmCilAssemblyOS::static_variant >> 3] & (1 << (SgAsmCilAssemblyOS::static_variant & 7)))) ? ((SgAsmCilAssemblyOS*) (node)) : NULL) : NULL)
#define IS_SgAsmCilAssembly_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAsmCilAssembly::static_variant >> 3] & (1 << (SgAsmCilAssembly::static_variant & 7)))) ? ((SgAsmCilAssembly*) (node)) : NULL) : NULL)
#define IS_SgAsmCilMetadata_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAsmCilMetadata::static_variant >> 3] & (1 << (SgAsmCilMetadata::static_variant & 7)))) ? ((SgAsmCilMetadata*) (node)) : NULL) : NULL)
#define IS_SgAsmCilNode_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAsmCilNode::static_variant >> 3] & (1 << (SgAsmCilNode::static_variant & 7)))) ? ((SgAsmCilNode*) (node)) : NULL) : NULL)
#define IS_SgAsmByteOrder_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAsmByteOrder::static_variant >> 3] & (1 << (SgAsmByteOrder::static_variant & 7)))) ? ((SgAsmByteOrder*) (node)) : NULL) : NULL)
...
#define IS_SgAsmBinaryPreupdate_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAsmBinaryPreupdate::static_variant >> 3] & (1 << (SgAsmBinaryPreupdate::static_variant & 7)))) ? ((SgAsmBinaryPreupdate*) (node)) : NULL) : NULL)
#define IS_SgAsmBinaryPostupdate_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAsmBinaryPostupdate::static_variant >> 3] & (1 << (SgAsmBinaryPostupdate::static_variant & 7)))) ? ((SgAsmBinaryPostupdate*) (node)) : NULL) : NULL)
...
#define IS_SgAsmBinaryMsl_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAsmBinaryMsl::static_variant >> 3] & (1 << (SgAsmBinaryMsl::static_variant & 7)))) ? ((SgAsmBinaryMsl*) (node)) : NULL) : NULL)
...
#define IS_SgAsmBinaryConcat_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAsmBinaryConcat::static_variant >> 3] & (1 << (SgAsmBinaryConcat::static_variant & 7)))) ? ((SgAsmBinaryConcat*) (node)) : NULL) : NULL)
...
#define IS_SgAsmAarch32Coprocessor_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAsmAarch32Coprocessor::static_variant >> 3] & (1 << (SgAsmAarch32Coprocessor::static_variant & 7)))) ? ((SgAsmAarch32Coprocessor*) (node)) : NULL) : NULL)
...
#define IS_SgOmpBeginClause_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgOmpBeginClause::static_variant >> 3] & (1 << (SgOmpBeginClause::static_variant & 7)))) ? ((SgOmpBeginClause*) (node)) : NULL) : NULL)
#define IS_SgOmpEndClause_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgOmpEndClause::static_variant >> 3] & (1 << (SgOmpEndClause::static_variant & 7)))) ? ((SgOmpEndClause*) (node)) : NULL) : NULL)
...
#define IS_SgOmpMergeableClause_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgOmpMergeableClause::static_variant >> 3] & (1 << (SgOmpMergeableClause::static_variant & 7)))) ? ((SgOmpMergeableClause*) (node)) : NULL) : NULL)
...
#define IS_SgOmpAtomicClause_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgOmpAtomicClause::static_variant >> 3] & (1 << (SgOmpAtomicClause::static_variant & 7)))) ? ((SgOmpAtomicClause*) (node)) : NULL) : NULL)
#define IS_SgOmpProcBindClause_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgOmpProcBindClause::static_variant >> 3] & (1 << (SgOmpProcBindClause::static_variant & 7)))) ? ((SgOmpProcBindClause*) (node)) : NULL) : NULL)
#define IS_SgOmpInbranchClause_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgOmpInbranchClause::static_variant >> 3] & (1 << (SgOmpInbranchClause::static_variant & 7)))) ? ((SgOmpInbranchClause*) (node)) : NULL) : NULL)
#define IS_SgOmpNotinbranchClause_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgOmpNotinbranchClause::static_variant >> 3] & (1 << (SgOmpNotinbranchClause::static_variant & 7)))) ? ((SgOmpNotinbranchClause*) (node)) : NULL) : NULL)
...
#define IS_SgOmpFinalClause_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgOmpFinalClause::static_variant >> 3] & (1 << (SgOmpFinalClause::static_variant & 7)))) ? ((SgOmpFinalClause*) (node)) : NULL) : NULL)
#define IS_SgOmpPriorityClause_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgOmpPriorityClause::static_variant >> 3] & (1 << (SgOmpPriorityClause::static_variant & 7)))) ? ((SgOmpPriorityClause*) (node)) : NULL) : NULL)
...
#define IS_SgOmpSimdlenClause_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgOmpSimdlenClause::static_variant >> 3] & (1 << (SgOmpSimdlenClause::static_variant & 7)))) ? ((SgOmpSimdlenClause*) (node)) : NULL) : NULL)
...
#define IS_SgOmpDependClause_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgOmpDependClause::static_variant >> 3] & (1 << (SgOmpDependClause::static_variant & 7)))) ? ((SgOmpDependClause*) (node)) : NULL) : NULL)
...
#define IS_SgAdaRangeConstraint_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAdaRangeConstraint::static_variant >> 3] & (1 << (SgAdaRangeConstraint::static_variant & 7)))) ? ((SgAdaRangeConstraint*) (node)) : NULL) : NULL)
#define IS_SgAdaIndexConstraint_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAdaIndexConstraint::static_variant >> 3] & (1 << (SgAdaIndexConstraint::static_variant & 7)))) ? ((SgAdaIndexConstraint*) (node)) : NULL) : NULL)
#define IS_SgAdaDigitsConstraint_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAdaDigitsConstraint::static_variant >> 3] & (1 << (SgAdaDigitsConstraint::static_variant & 7)))) ? ((SgAdaDigitsConstraint*) (node)) : NULL) : NULL)
#define IS_SgAdaDeltaConstraint_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAdaDeltaConstraint::static_variant >> 3] & (1 << (SgAdaDeltaConstraint::static_variant & 7)))) ? ((SgAdaDeltaConstraint*) (node)) : NULL) : NULL)
#define IS_SgAdaDiscriminantConstraint_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAdaDiscriminantConstraint::static_variant >> 3] & (1 << (SgAdaDiscriminantConstraint::static_variant & 7)))) ? ((SgAdaDiscriminantConstraint*) (node)) : NULL) : NULL)
#define IS_SgAdaNullConstraint_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAdaNullConstraint::static_variant >> 3] & (1 << (SgAdaNullConstraint::static_variant & 7)))) ? ((SgAdaNullConstraint*) (node)) : NULL) : NULL)
#define IS_SgAdaTypeConstraint_FAST_MACRO(node) ( (node) ? (( (rose_ClassHierarchyCastTable[(node)->variantT()][SgAdaTypeConstraint::static_variant >> 3] & (1 << (SgAdaTypeConstraint::static_variant & 7)))) ? ((SgAdaTypeConstraint*) (node)) : NULL) : NULL)
