...
#ifndef ROSE_SgAsmElfSymbolList_H
#define ROSE_SgAsmElfSymbolList_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmElfSymbolList

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmElfSymbolList.h" */
/* #line 19870 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// Class Definition for SgAsmElfSymbolList
class ROSE_DLL_API SgAsmElfSymbolList  : public SgAsmExecutableFileFormat
   {
     public:


/* #line 42 "/workspace/generated/src/frontend/SageIII//SgAsmElfSymbolList.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 19885 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmElfSymbolList;
          enum { static_variant = V_SgAsmElfSymbolList };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmElfSymbolList* isSgAsmElfSymbolList(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmElfSymbolList* isSgAsmElfSymbolList( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmElfSymbolList * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmElfSymbolListStorageClass *); // 
          ...
          /// \private
          static SgAsmElfSymbolList * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmElfSymbolList * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmElfSymbolList::operator delete (pointer,sizeof(SgAsmElfSymbolList));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmElfSymbolList* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmElfSymbolList* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmElfSymbolList* sgnode);
     ...
     public:
       ...
       */
       // SgAsmElfSymbolList( SgAsmElfSymbolListStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmElfSymbolListStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmElfSymbolList( const SgAsmElfSymbolListStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmElfSymbolList* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmElfSymbolList* isSgAsmElfSymbolList ( SgNode* s );
...
// End of memberFunctionString
    ...
    protected:
// Start of memberFunctionString
SgAsmElfSymbolPtrList p_symbols;
          
// End of memberFunctionString

    friend struct Rose::Traits::generated::describe_node_t<SgAsmElfSymbolList>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmElfSymbolList, SgAsmElfSymbolPtrList,&SgAsmElfSymbolList::p_symbols>;
...
// postdeclarations for SgAsmElfSymbolList

/* #line 519 "/workspace/generated/src/frontend/SageIII//SgAsmElfSymbolList.h" */
...
/* #line 526 "/workspace/generated/src/frontend/SageIII//SgAsmElfSymbolList.h" */

#endif // ROSE_SgAsmElfSymbolList_H
