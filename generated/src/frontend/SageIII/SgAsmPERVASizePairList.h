...
#ifndef ROSE_SgAsmPERVASizePairList_H
#define ROSE_SgAsmPERVASizePairList_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmPERVASizePairList

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmPERVASizePairList.h" */
/* #line 2499 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// Class Definition for SgAsmPERVASizePairList
class ROSE_DLL_API SgAsmPERVASizePairList  : public SgAsmExecutableFileFormat
   {
     public:


/* #line 42 "/workspace/generated/src/frontend/SageIII//SgAsmPERVASizePairList.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 2518 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmPERVASizePairList;
          enum { static_variant = V_SgAsmPERVASizePairList };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmPERVASizePairList* isSgAsmPERVASizePairList(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmPERVASizePairList* isSgAsmPERVASizePairList( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmPERVASizePairList * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmPERVASizePairListStorageClass *); // 
          ...
          /// \private
          static SgAsmPERVASizePairList * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmPERVASizePairList * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmPERVASizePairList::operator delete (pointer,sizeof(SgAsmPERVASizePairList));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmPERVASizePairList* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmPERVASizePairList* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmPERVASizePairList* sgnode);
     ...
     public:
       ...
       */
       // SgAsmPERVASizePairList( SgAsmPERVASizePairListStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmPERVASizePairListStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmPERVASizePairList( const SgAsmPERVASizePairListStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmPERVASizePairList* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmPERVASizePairList* isSgAsmPERVASizePairList ( SgNode* s );
...
// End of memberFunctionString
    ...
    protected:
// Start of memberFunctionString
SgAsmPERVASizePairPtrList p_pairs;
          
// End of memberFunctionString

    friend struct Rose::Traits::generated::describe_node_t<SgAsmPERVASizePairList>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmPERVASizePairList, SgAsmPERVASizePairPtrList,&SgAsmPERVASizePairList::p_pairs>;
...
// postdeclarations for SgAsmPERVASizePairList

/* #line 517 "/workspace/generated/src/frontend/SageIII//SgAsmPERVASizePairList.h" */
...
/* #line 524 "/workspace/generated/src/frontend/SageIII//SgAsmPERVASizePairList.h" */

#endif // ROSE_SgAsmPERVASizePairList_H
