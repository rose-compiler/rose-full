...
#ifndef ROSE_SgAsmJvmStackMapVerificationType_H
#define ROSE_SgAsmJvmStackMapVerificationType_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmJvmStackMapVerificationType

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmJvmStackMapVerificationType.h" */
...
// Class Definition for SgAsmJvmStackMapVerificationType
class ROSE_DLL_API SgAsmJvmStackMapVerificationType  : public SgAsmJvmNode
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmJvmStackMapVerificationType.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 9362 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmJvmStackMapVerificationType;
          enum { static_variant = V_SgAsmJvmStackMapVerificationType };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmJvmStackMapVerificationType* isSgAsmJvmStackMapVerificationType(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmJvmStackMapVerificationType* isSgAsmJvmStackMapVerificationType( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmJvmStackMapVerificationType * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmJvmStackMapVerificationTypeStorageClass *); // 
          ...
          /// \private
          static SgAsmJvmStackMapVerificationType * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmJvmStackMapVerificationType * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmJvmStackMapVerificationType::operator delete (pointer,sizeof(SgAsmJvmStackMapVerificationType));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmJvmStackMapVerificationType* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmJvmStackMapVerificationType* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmJvmStackMapVerificationType* sgnode);
     ...
     public:
       ...
       */
       // SgAsmJvmStackMapVerificationType( SgAsmJvmStackMapVerificationTypeStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmJvmStackMapVerificationTypeStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmJvmStackMapVerificationType( const SgAsmJvmStackMapVerificationTypeStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmJvmStackMapVerificationType* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmJvmStackMapVerificationType* isSgAsmJvmStackMapVerificationType ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmJvmStackMapVerificationType>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmJvmStackMapVerificationType, uint8_t,&SgAsmJvmStackMapVerificationType::p_tag>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmJvmStackMapVerificationType, uint16_t,&SgAsmJvmStackMapVerificationType::p_cpool_index>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmJvmStackMapVerificationType, uint16_t,&SgAsmJvmStackMapVerificationType::p_offset>;
...
// postdeclarations for SgAsmJvmStackMapVerificationType

/* #line 634 "/workspace/generated/src/frontend/SageIII//SgAsmJvmStackMapVerificationType.h" */
...
/* #line 641 "/workspace/generated/src/frontend/SageIII//SgAsmJvmStackMapVerificationType.h" */

#endif // ROSE_SgAsmJvmStackMapVerificationType_H
