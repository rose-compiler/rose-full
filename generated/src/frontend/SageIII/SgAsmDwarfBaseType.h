...
#ifndef ROSE_SgAsmDwarfBaseType_H
#define ROSE_SgAsmDwarfBaseType_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmDwarfBaseType

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfBaseType.h" */
...
// Class Definition for SgAsmDwarfBaseType
class ROSE_DLL_API SgAsmDwarfBaseType  : public SgAsmDwarfConstruct
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfBaseType.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 28747 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmDwarfBaseType;
          enum { static_variant = V_SgAsmDwarfBaseType };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmDwarfBaseType* isSgAsmDwarfBaseType(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmDwarfBaseType* isSgAsmDwarfBaseType( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmDwarfBaseType * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmDwarfBaseTypeStorageClass *); // 
          ...
          /// \private
          static SgAsmDwarfBaseType * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmDwarfBaseType * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmDwarfBaseType::operator delete (pointer,sizeof(SgAsmDwarfBaseType));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmDwarfBaseType* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmDwarfBaseType* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmDwarfBaseType* sgnode);
     ...
     public:
       ...
       */
       // SgAsmDwarfBaseType( SgAsmDwarfBaseTypeStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmDwarfBaseTypeStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmDwarfBaseType( const SgAsmDwarfBaseTypeStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmDwarfBaseType* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmDwarfBaseType* isSgAsmDwarfBaseType ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmDwarfBaseType>;
...
// postdeclarations for SgAsmDwarfBaseType

/* #line 502 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfBaseType.h" */
...
/* #line 509 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfBaseType.h" */

#endif // ROSE_SgAsmDwarfBaseType_H
