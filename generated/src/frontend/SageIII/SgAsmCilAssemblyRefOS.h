...
#ifndef ROSE_SgAsmCilAssemblyRefOS_H
#define ROSE_SgAsmCilAssemblyRefOS_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmCilAssemblyRefOS

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmCilAssemblyRefOS.h" */
...
// Class Definition for SgAsmCilAssemblyRefOS
class ROSE_DLL_API SgAsmCilAssemblyRefOS  : public SgAsmCilMetadata
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmCilAssemblyRefOS.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 41007 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmCilAssemblyRefOS;
          enum { static_variant = V_SgAsmCilAssemblyRefOS };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmCilAssemblyRefOS* isSgAsmCilAssemblyRefOS(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmCilAssemblyRefOS* isSgAsmCilAssemblyRefOS( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmCilAssemblyRefOS * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmCilAssemblyRefOSStorageClass *); // 
          ...
          /// \private
          static SgAsmCilAssemblyRefOS * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmCilAssemblyRefOS * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmCilAssemblyRefOS::operator delete (pointer,sizeof(SgAsmCilAssemblyRefOS));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmCilAssemblyRefOS* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmCilAssemblyRefOS* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmCilAssemblyRefOS* sgnode);
     ...
     public:
       ...
       */
       // SgAsmCilAssemblyRefOS( SgAsmCilAssemblyRefOSStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmCilAssemblyRefOSStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmCilAssemblyRefOS( const SgAsmCilAssemblyRefOSStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmCilAssemblyRefOS* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmCilAssemblyRefOS* isSgAsmCilAssemblyRefOS ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmCilAssemblyRefOS>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilAssemblyRefOS, uint32_t,&SgAsmCilAssemblyRefOS::p_OSPlatformID>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilAssemblyRefOS, uint32_t,&SgAsmCilAssemblyRefOS::p_OSMajorVersion>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilAssemblyRefOS, uint32_t,&SgAsmCilAssemblyRefOS::p_OSMinorVersion>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilAssemblyRefOS, uint32_t,&SgAsmCilAssemblyRefOS::p_AssemblyRefOS>;
...
// postdeclarations for SgAsmCilAssemblyRefOS

/* #line 569 "/workspace/generated/src/frontend/SageIII//SgAsmCilAssemblyRefOS.h" */
...
/* #line 576 "/workspace/generated/src/frontend/SageIII//SgAsmCilAssemblyRefOS.h" */

#endif // ROSE_SgAsmCilAssemblyRefOS_H
