...
#ifndef ROSE_SgAsmDwarfInlinedSubroutine_H
#define ROSE_SgAsmDwarfInlinedSubroutine_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmDwarfInlinedSubroutine

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfInlinedSubroutine.h" */
/* #line 27006 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// Class Definition for SgAsmDwarfInlinedSubroutine
class ROSE_DLL_API SgAsmDwarfInlinedSubroutine  : public SgAsmDwarfConstruct
   {
     public:


/* #line 44 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfInlinedSubroutine.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 27023 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmDwarfInlinedSubroutine;
          enum { static_variant = V_SgAsmDwarfInlinedSubroutine };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmDwarfInlinedSubroutine* isSgAsmDwarfInlinedSubroutine(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmDwarfInlinedSubroutine* isSgAsmDwarfInlinedSubroutine( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmDwarfInlinedSubroutine * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmDwarfInlinedSubroutineStorageClass *); // 
          ...
          /// \private
          static SgAsmDwarfInlinedSubroutine * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmDwarfInlinedSubroutine * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmDwarfInlinedSubroutine::operator delete (pointer,sizeof(SgAsmDwarfInlinedSubroutine));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmDwarfInlinedSubroutine* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmDwarfInlinedSubroutine* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmDwarfInlinedSubroutine* sgnode);
     ...
     public:
       ...
       */
       // SgAsmDwarfInlinedSubroutine( SgAsmDwarfInlinedSubroutineStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmDwarfInlinedSubroutineStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmDwarfInlinedSubroutine( const SgAsmDwarfInlinedSubroutineStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmDwarfInlinedSubroutine* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmDwarfInlinedSubroutine* isSgAsmDwarfInlinedSubroutine ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmDwarfInlinedSubroutine>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmDwarfInlinedSubroutine, SgAsmDwarfConstructList*,&SgAsmDwarfInlinedSubroutine::p_body>;
...
// postdeclarations for SgAsmDwarfInlinedSubroutine

/* #line 520 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfInlinedSubroutine.h" */
...
/* #line 527 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfInlinedSubroutine.h" */

#endif // ROSE_SgAsmDwarfInlinedSubroutine_H
