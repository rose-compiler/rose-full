...
#ifndef ROSE_SgAsmNEModuleTable_H
#define ROSE_SgAsmNEModuleTable_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmNEModuleTable

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmNEModuleTable.h" */
/* #line 6448 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// Class Definition for SgAsmNEModuleTable
class ROSE_DLL_API SgAsmNEModuleTable  : public SgAsmGenericSection
   {
     public:


/* #line 46 "/workspace/generated/src/frontend/SageIII//SgAsmNEModuleTable.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 6479 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmNEModuleTable;
          enum { static_variant = V_SgAsmNEModuleTable };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmNEModuleTable* isSgAsmNEModuleTable(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmNEModuleTable* isSgAsmNEModuleTable( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmNEModuleTable * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmNEModuleTableStorageClass *); // 
          ...
          /// \private
          static SgAsmNEModuleTable * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmNEModuleTable * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmNEModuleTable::operator delete (pointer,sizeof(SgAsmNEModuleTable));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmNEModuleTable* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmNEModuleTable* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmNEModuleTable* sgnode);
     ...
     public:
       ...
       */
       // SgAsmNEModuleTable( SgAsmNEModuleTableStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmNEModuleTableStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmNEModuleTable( const SgAsmNEModuleTableStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmNEModuleTable* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmNEModuleTable* isSgAsmNEModuleTable ( SgNode* s );
...
// End of memberFunctionString
    ...
    protected:
// Start of memberFunctionString
SgAsmNEStringTable* p_strtab;
          
// End of memberFunctionString
// Start of memberFunctionString
SgAddressList p_nameOffsets;
          
// End of memberFunctionString
// Start of memberFunctionString
SgStringList p_names;
          
// End of memberFunctionString

    friend struct Rose::Traits::generated::describe_node_t<SgAsmNEModuleTable>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmNEModuleTable, SgAsmNEStringTable*,&SgAsmNEModuleTable::p_strtab>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmNEModuleTable, SgAddressList,&SgAsmNEModuleTable::p_nameOffsets>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmNEModuleTable, SgStringList,&SgAsmNEModuleTable::p_names>;
...
// postdeclarations for SgAsmNEModuleTable

/* #line 548 "/workspace/generated/src/frontend/SageIII//SgAsmNEModuleTable.h" */
...
/* #line 555 "/workspace/generated/src/frontend/SageIII//SgAsmNEModuleTable.h" */

#endif // ROSE_SgAsmNEModuleTable_H
