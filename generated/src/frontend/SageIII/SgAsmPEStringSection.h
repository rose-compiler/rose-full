...
#ifndef ROSE_SgAsmPEStringSection_H
#define ROSE_SgAsmPEStringSection_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmPEStringSection

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmPEStringSection.h" */
/* #line 2052 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// Class Definition for SgAsmPEStringSection
class ROSE_DLL_API SgAsmPEStringSection  : public SgAsmPESection
   {
     public:


/* #line 42 "/workspace/generated/src/frontend/SageIII//SgAsmPEStringSection.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 2068 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmPEStringSection;
          enum { static_variant = V_SgAsmPEStringSection };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmPEStringSection* isSgAsmPEStringSection(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmPEStringSection* isSgAsmPEStringSection( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmPEStringSection * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmPEStringSectionStorageClass *); // 
          ...
          /// \private
          static SgAsmPEStringSection * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmPEStringSection * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmPEStringSection::operator delete (pointer,sizeof(SgAsmPEStringSection));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmPEStringSection* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmPEStringSection* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmPEStringSection* sgnode);
     ...
     public:
       ...
       */
       // SgAsmPEStringSection( SgAsmPEStringSectionStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmPEStringSectionStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmPEStringSection( const SgAsmPEStringSectionStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmPEStringSection* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmPEStringSection* isSgAsmPEStringSection ( SgNode* s );
...
// End of memberFunctionString
    ...
    protected:
// Start of memberFunctionString
SgAsmCoffStrtab* p_strtab;
          
// End of memberFunctionString

    friend struct Rose::Traits::generated::describe_node_t<SgAsmPEStringSection>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmPEStringSection, SgAsmCoffStrtab*,&SgAsmPEStringSection::p_strtab>;
...
// postdeclarations for SgAsmPEStringSection

/* #line 523 "/workspace/generated/src/frontend/SageIII//SgAsmPEStringSection.h" */
...
/* #line 530 "/workspace/generated/src/frontend/SageIII//SgAsmPEStringSection.h" */

#endif // ROSE_SgAsmPEStringSection_H
