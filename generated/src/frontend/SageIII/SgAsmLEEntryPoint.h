...
#ifndef ROSE_SgAsmLEEntryPoint_H
#define ROSE_SgAsmLEEntryPoint_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmLEEntryPoint

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmLEEntryPoint.h" */
/* #line 9172 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// Class Definition for SgAsmLEEntryPoint
class ROSE_DLL_API SgAsmLEEntryPoint  : public SgAsmExecutableFileFormat
   {
     public:


/* #line 44 "/workspace/generated/src/frontend/SageIII//SgAsmLEEntryPoint.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 9219 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmLEEntryPoint;
          enum { static_variant = V_SgAsmLEEntryPoint };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmLEEntryPoint* isSgAsmLEEntryPoint(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmLEEntryPoint* isSgAsmLEEntryPoint( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmLEEntryPoint * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmLEEntryPointStorageClass *); // 
          ...
          /// \private
          static SgAsmLEEntryPoint * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmLEEntryPoint * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmLEEntryPoint::operator delete (pointer,sizeof(SgAsmLEEntryPoint));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmLEEntryPoint* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmLEEntryPoint* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmLEEntryPoint* sgnode);
     ...
     public:
       ...
       */
       // SgAsmLEEntryPoint( SgAsmLEEntryPointStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmLEEntryPointStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmLEEntryPoint( const SgAsmLEEntryPointStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmLEEntryPoint* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmLEEntryPoint* isSgAsmLEEntryPoint ( SgNode* s );
...
// End of memberFunctionString
    ...
    protected:
// Start of memberFunctionString
SgAsmLEEntryPointPtrList p_entries;
...
// End of memberFunctionString
// Start of memberFunctionString
Rose::BinaryAnalysis::Address p_entry_offset;
          
// End of memberFunctionString

    friend struct Rose::Traits::generated::describe_node_t<SgAsmLEEntryPoint>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmLEEntryPoint, SgAsmLEEntryPointPtrList,&SgAsmLEEntryPoint::p_entries>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmLEEntryPoint, unsigned,&SgAsmLEEntryPoint::p_flags>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmLEEntryPoint, unsigned,&SgAsmLEEntryPoint::p_objnum>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmLEEntryPoint, unsigned,&SgAsmLEEntryPoint::p_entry_type>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmLEEntryPoint, unsigned,&SgAsmLEEntryPoint::p_res1>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmLEEntryPoint, Rose::BinaryAnalysis::Address,&SgAsmLEEntryPoint::p_entry_offset>;
...
// postdeclarations for SgAsmLEEntryPoint

/* #line 607 "/workspace/generated/src/frontend/SageIII//SgAsmLEEntryPoint.h" */
...
/* #line 614 "/workspace/generated/src/frontend/SageIII//SgAsmLEEntryPoint.h" */

#endif // ROSE_SgAsmLEEntryPoint_H
