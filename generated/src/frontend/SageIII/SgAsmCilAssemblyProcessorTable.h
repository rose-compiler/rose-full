...
#ifndef ROSE_SgAsmCilAssemblyProcessorTable_H
#define ROSE_SgAsmCilAssemblyProcessorTable_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmCilAssemblyProcessorTable

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmCilAssemblyProcessorTable.h" */
...
// Class Definition for SgAsmCilAssemblyProcessorTable
class ROSE_DLL_API SgAsmCilAssemblyProcessorTable  : public SgAsmCilMetadata
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmCilAssemblyProcessorTable.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 41331 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmCilAssemblyProcessorTable;
          enum { static_variant = V_SgAsmCilAssemblyProcessorTable };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmCilAssemblyProcessorTable* isSgAsmCilAssemblyProcessorTable(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmCilAssemblyProcessorTable* isSgAsmCilAssemblyProcessorTable( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmCilAssemblyProcessorTable * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmCilAssemblyProcessorTableStorageClass *); // 
          ...
          /// \private
          static SgAsmCilAssemblyProcessorTable * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmCilAssemblyProcessorTable * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmCilAssemblyProcessorTable::operator delete (pointer,sizeof(SgAsmCilAssemblyProcessorTable));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmCilAssemblyProcessorTable* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmCilAssemblyProcessorTable* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmCilAssemblyProcessorTable* sgnode);
     ...
     public:
       ...
       */
       // SgAsmCilAssemblyProcessorTable( SgAsmCilAssemblyProcessorTableStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmCilAssemblyProcessorTableStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmCilAssemblyProcessorTable( const SgAsmCilAssemblyProcessorTableStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmCilAssemblyProcessorTable* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmCilAssemblyProcessorTable* isSgAsmCilAssemblyProcessorTable ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmCilAssemblyProcessorTable>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilAssemblyProcessorTable, std::vector<SgAsmCilAssemblyProcessor*>,&SgAsmCilAssemblyProcessorTable::p_elements>;
...
// postdeclarations for SgAsmCilAssemblyProcessorTable

/* #line 508 "/workspace/generated/src/frontend/SageIII//SgAsmCilAssemblyProcessorTable.h" */
...
/* #line 515 "/workspace/generated/src/frontend/SageIII//SgAsmCilAssemblyProcessorTable.h" */

#endif // ROSE_SgAsmCilAssemblyProcessorTable_H
