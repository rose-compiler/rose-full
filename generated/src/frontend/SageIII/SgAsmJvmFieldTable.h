...
#ifndef ROSE_SgAsmJvmFieldTable_H
#define ROSE_SgAsmJvmFieldTable_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmJvmFieldTable

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmJvmFieldTable.h" */
...
// Class Definition for SgAsmJvmFieldTable
class ROSE_DLL_API SgAsmJvmFieldTable  : public SgAsmGenericSection
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmJvmFieldTable.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 12893 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmJvmFieldTable;
          enum { static_variant = V_SgAsmJvmFieldTable };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmJvmFieldTable* isSgAsmJvmFieldTable(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmJvmFieldTable* isSgAsmJvmFieldTable( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmJvmFieldTable * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmJvmFieldTableStorageClass *); // 
          ...
          /// \private
          static SgAsmJvmFieldTable * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmJvmFieldTable * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmJvmFieldTable::operator delete (pointer,sizeof(SgAsmJvmFieldTable));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmJvmFieldTable* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmJvmFieldTable* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmJvmFieldTable* sgnode);
     ...
     public:
       ...
       */
       // SgAsmJvmFieldTable( SgAsmJvmFieldTableStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmJvmFieldTableStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmJvmFieldTable( const SgAsmJvmFieldTableStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmJvmFieldTable* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmJvmFieldTable* isSgAsmJvmFieldTable ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmJvmFieldTable>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmJvmFieldTable, SgAsmJvmFieldPtrList,&SgAsmJvmFieldTable::p_fields>;
...
// postdeclarations for SgAsmJvmFieldTable

/* #line 527 "/workspace/generated/src/frontend/SageIII//SgAsmJvmFieldTable.h" */
...
/* #line 534 "/workspace/generated/src/frontend/SageIII//SgAsmJvmFieldTable.h" */

#endif // ROSE_SgAsmJvmFieldTable_H
