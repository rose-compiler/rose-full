...
#ifndef ROSE_SgAsmDwarfTryBlock_H
#define ROSE_SgAsmDwarfTryBlock_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmDwarfTryBlock

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfTryBlock.h" */
...
// Class Definition for SgAsmDwarfTryBlock
class ROSE_DLL_API SgAsmDwarfTryBlock  : public SgAsmDwarfConstruct
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfTryBlock.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 25007 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmDwarfTryBlock;
          enum { static_variant = V_SgAsmDwarfTryBlock };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmDwarfTryBlock* isSgAsmDwarfTryBlock(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmDwarfTryBlock* isSgAsmDwarfTryBlock( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmDwarfTryBlock * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmDwarfTryBlockStorageClass *); // 
          ...
          /// \private
          static SgAsmDwarfTryBlock * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmDwarfTryBlock * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmDwarfTryBlock::operator delete (pointer,sizeof(SgAsmDwarfTryBlock));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmDwarfTryBlock* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmDwarfTryBlock* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmDwarfTryBlock* sgnode);
     ...
     public:
       ...
       */
       // SgAsmDwarfTryBlock( SgAsmDwarfTryBlockStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmDwarfTryBlockStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmDwarfTryBlock( const SgAsmDwarfTryBlockStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmDwarfTryBlock* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmDwarfTryBlock* isSgAsmDwarfTryBlock ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmDwarfTryBlock>;
...
// postdeclarations for SgAsmDwarfTryBlock

/* #line 502 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfTryBlock.h" */
...
/* #line 509 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfTryBlock.h" */

#endif // ROSE_SgAsmDwarfTryBlock_H
