...
#ifndef ROSE_SgAsmBinaryMsl_H
#define ROSE_SgAsmBinaryMsl_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmBinaryMsl

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmBinaryMsl.h" */
...
// Class Definition for SgAsmBinaryMsl
class ROSE_DLL_API SgAsmBinaryMsl  : public SgAsmBinaryExpression
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmBinaryMsl.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 42847 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmBinaryMsl;
          enum { static_variant = V_SgAsmBinaryMsl };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmBinaryMsl* isSgAsmBinaryMsl(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmBinaryMsl* isSgAsmBinaryMsl( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmBinaryMsl * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmBinaryMslStorageClass *); // 
          ...
          /// \private
          static SgAsmBinaryMsl * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmBinaryMsl * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmBinaryMsl::operator delete (pointer,sizeof(SgAsmBinaryMsl));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmBinaryMsl* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmBinaryMsl* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmBinaryMsl* sgnode);
     ...
     public:
       ...
       */
       // SgAsmBinaryMsl( SgAsmBinaryMslStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmBinaryMslStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmBinaryMsl( const SgAsmBinaryMslStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmBinaryMsl* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmBinaryMsl* isSgAsmBinaryMsl ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmBinaryMsl>;
...
// postdeclarations for SgAsmBinaryMsl

/* #line 501 "/workspace/generated/src/frontend/SageIII//SgAsmBinaryMsl.h" */
...
/* #line 508 "/workspace/generated/src/frontend/SageIII//SgAsmBinaryMsl.h" */

#endif // ROSE_SgAsmBinaryMsl_H
