...
#ifndef ROSE_SgAsmVectorType_H
#define ROSE_SgAsmVectorType_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmVectorType

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmVectorType.h" */
...
// Class Definition for SgAsmVectorType
class ROSE_DLL_API SgAsmVectorType  : public SgAsmType
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmVectorType.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 411 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmVectorType;
          enum { static_variant = V_SgAsmVectorType };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmVectorType* isSgAsmVectorType(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmVectorType* isSgAsmVectorType( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmVectorType * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmVectorTypeStorageClass *); // 
          ...
          /// \private
          static SgAsmVectorType * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmVectorType * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmVectorType::operator delete (pointer,sizeof(SgAsmVectorType));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmVectorType* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmVectorType* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmVectorType* sgnode);
     ...
     public:
       ...
       */
       // SgAsmVectorType( SgAsmVectorTypeStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmVectorTypeStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmVectorType( const SgAsmVectorTypeStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmVectorType* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmVectorType* isSgAsmVectorType ( SgNode* s );
...
// End of memberFunctionString
// Start of memberFunctionString
SgAsmType* p_elmtType;
          
// End of memberFunctionString

    friend struct Rose::Traits::generated::describe_node_t<SgAsmVectorType>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmVectorType, size_t,&SgAsmVectorType::p_nElmts>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmVectorType, SgAsmType*,&SgAsmVectorType::p_elmtType>;
...
// postdeclarations for SgAsmVectorType

/* #line 535 "/workspace/generated/src/frontend/SageIII//SgAsmVectorType.h" */
...
/* #line 542 "/workspace/generated/src/frontend/SageIII//SgAsmVectorType.h" */

#endif // ROSE_SgAsmVectorType_H
