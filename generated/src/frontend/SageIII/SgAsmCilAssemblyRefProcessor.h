...
#ifndef ROSE_SgAsmCilAssemblyRefProcessor_H
#define ROSE_SgAsmCilAssemblyRefProcessor_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmCilAssemblyRefProcessor

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmCilAssemblyRefProcessor.h" */
...
// Class Definition for SgAsmCilAssemblyRefProcessor
class ROSE_DLL_API SgAsmCilAssemblyRefProcessor  : public SgAsmCilMetadata
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmCilAssemblyRefProcessor.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 40836 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmCilAssemblyRefProcessor;
          enum { static_variant = V_SgAsmCilAssemblyRefProcessor };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmCilAssemblyRefProcessor* isSgAsmCilAssemblyRefProcessor(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmCilAssemblyRefProcessor* isSgAsmCilAssemblyRefProcessor( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmCilAssemblyRefProcessor * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmCilAssemblyRefProcessorStorageClass *); // 
          ...
          /// \private
          static SgAsmCilAssemblyRefProcessor * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmCilAssemblyRefProcessor * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmCilAssemblyRefProcessor::operator delete (pointer,sizeof(SgAsmCilAssemblyRefProcessor));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmCilAssemblyRefProcessor* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmCilAssemblyRefProcessor* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmCilAssemblyRefProcessor* sgnode);
     ...
     public:
       ...
       */
       // SgAsmCilAssemblyRefProcessor( SgAsmCilAssemblyRefProcessorStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmCilAssemblyRefProcessorStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmCilAssemblyRefProcessor( const SgAsmCilAssemblyRefProcessorStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmCilAssemblyRefProcessor* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmCilAssemblyRefProcessor* isSgAsmCilAssemblyRefProcessor ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmCilAssemblyRefProcessor>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilAssemblyRefProcessor, uint32_t,&SgAsmCilAssemblyRefProcessor::p_Processor>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilAssemblyRefProcessor, uint32_t,&SgAsmCilAssemblyRefProcessor::p_AssemblyRef>;
...
// postdeclarations for SgAsmCilAssemblyRefProcessor

/* #line 535 "/workspace/generated/src/frontend/SageIII//SgAsmCilAssemblyRefProcessor.h" */
...
/* #line 542 "/workspace/generated/src/frontend/SageIII//SgAsmCilAssemblyRefProcessor.h" */

#endif // ROSE_SgAsmCilAssemblyRefProcessor_H
