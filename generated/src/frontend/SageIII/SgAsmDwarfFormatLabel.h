...
#ifndef ROSE_SgAsmDwarfFormatLabel_H
#define ROSE_SgAsmDwarfFormatLabel_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmDwarfFormatLabel

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfFormatLabel.h" */
...
// Class Definition for SgAsmDwarfFormatLabel
class ROSE_DLL_API SgAsmDwarfFormatLabel  : public SgAsmDwarfConstruct
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfFormatLabel.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 27442 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmDwarfFormatLabel;
          enum { static_variant = V_SgAsmDwarfFormatLabel };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmDwarfFormatLabel* isSgAsmDwarfFormatLabel(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmDwarfFormatLabel* isSgAsmDwarfFormatLabel( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmDwarfFormatLabel * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmDwarfFormatLabelStorageClass *); // 
          ...
          /// \private
          static SgAsmDwarfFormatLabel * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmDwarfFormatLabel * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmDwarfFormatLabel::operator delete (pointer,sizeof(SgAsmDwarfFormatLabel));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmDwarfFormatLabel* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmDwarfFormatLabel* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmDwarfFormatLabel* sgnode);
     ...
     public:
       ...
       */
       // SgAsmDwarfFormatLabel( SgAsmDwarfFormatLabelStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmDwarfFormatLabelStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmDwarfFormatLabel( const SgAsmDwarfFormatLabelStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmDwarfFormatLabel* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmDwarfFormatLabel* isSgAsmDwarfFormatLabel ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmDwarfFormatLabel>;
...
// postdeclarations for SgAsmDwarfFormatLabel

/* #line 502 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfFormatLabel.h" */
...
/* #line 509 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfFormatLabel.h" */

#endif // ROSE_SgAsmDwarfFormatLabel_H
