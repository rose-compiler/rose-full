...
#ifndef ROSE_SgAsmElfStringSection_H
#define ROSE_SgAsmElfStringSection_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmElfStringSection

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmElfStringSection.h" */
/* #line 20326 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// Class Definition for SgAsmElfStringSection
class ROSE_DLL_API SgAsmElfStringSection  : public SgAsmElfSection
   {
     public:


/* #line 42 "/workspace/generated/src/frontend/SageIII//SgAsmElfStringSection.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 20344 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmElfStringSection;
          enum { static_variant = V_SgAsmElfStringSection };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmElfStringSection* isSgAsmElfStringSection(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmElfStringSection* isSgAsmElfStringSection( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmElfStringSection * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmElfStringSectionStorageClass *); // 
          ...
          /// \private
          static SgAsmElfStringSection * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmElfStringSection * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmElfStringSection::operator delete (pointer,sizeof(SgAsmElfStringSection));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmElfStringSection* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmElfStringSection* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmElfStringSection* sgnode);
     ...
     public:
       ...
       */
       // SgAsmElfStringSection( SgAsmElfStringSectionStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmElfStringSectionStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmElfStringSection( const SgAsmElfStringSectionStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmElfStringSection* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmElfStringSection* isSgAsmElfStringSection ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmElfStringSection>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmElfStringSection, SgAsmElfStrtab*,&SgAsmElfStringSection::p_strtab>;
...
// postdeclarations for SgAsmElfStringSection

/* #line 542 "/workspace/generated/src/frontend/SageIII//SgAsmElfStringSection.h" */
...
/* #line 549 "/workspace/generated/src/frontend/SageIII//SgAsmElfStringSection.h" */

#endif // ROSE_SgAsmElfStringSection_H
