...
#ifndef ROSE_SgAsmCilInstruction_H
#define ROSE_SgAsmCilInstruction_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmCilInstruction

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmCilInstruction.h" */
/* #line 37472 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// Class Definition for SgAsmCilInstruction
class ROSE_DLL_API SgAsmCilInstruction  : public SgAsmInstruction
   {
     public:


/* #line 42 "/workspace/generated/src/frontend/SageIII//SgAsmCilInstruction.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 37487 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmCilInstruction;
          enum { static_variant = V_SgAsmCilInstruction };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmCilInstruction* isSgAsmCilInstruction(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmCilInstruction* isSgAsmCilInstruction( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmCilInstruction * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmCilInstructionStorageClass *); // 
          ...
          /// \private
          static SgAsmCilInstruction * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmCilInstruction * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmCilInstruction::operator delete (pointer,sizeof(SgAsmCilInstruction));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmCilInstruction* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmCilInstruction* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmCilInstruction* sgnode);
     ...
     public:
       ...
       */
       // SgAsmCilInstruction( SgAsmCilInstructionStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmCilInstructionStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmCilInstruction( const SgAsmCilInstructionStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmCilInstruction* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmCilInstruction* isSgAsmCilInstruction ( SgNode* s );
...
// End of memberFunctionString
    ...
    protected:
// Start of memberFunctionString
Rose::BinaryAnalysis::CilInstructionKind p_kind;
          
// End of memberFunctionString

    friend struct Rose::Traits::generated::describe_node_t<SgAsmCilInstruction>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilInstruction, Rose::BinaryAnalysis::CilInstructionKind,&SgAsmCilInstruction::p_kind>;
...
// postdeclarations for SgAsmCilInstruction

/* #line 526 "/workspace/generated/src/frontend/SageIII//SgAsmCilInstruction.h" */
...
/* #line 533 "/workspace/generated/src/frontend/SageIII//SgAsmCilInstruction.h" */

#endif // ROSE_SgAsmCilInstruction_H
