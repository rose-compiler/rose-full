...
#ifndef ROSE_SgAsmDwarfConstType_H
#define ROSE_SgAsmDwarfConstType_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmDwarfConstType

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfConstType.h" */
...
// Class Definition for SgAsmDwarfConstType
class ROSE_DLL_API SgAsmDwarfConstType  : public SgAsmDwarfConstruct
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfConstType.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 27885 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmDwarfConstType;
          enum { static_variant = V_SgAsmDwarfConstType };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmDwarfConstType* isSgAsmDwarfConstType(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmDwarfConstType* isSgAsmDwarfConstType( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmDwarfConstType * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmDwarfConstTypeStorageClass *); // 
          ...
          /// \private
          static SgAsmDwarfConstType * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmDwarfConstType * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmDwarfConstType::operator delete (pointer,sizeof(SgAsmDwarfConstType));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmDwarfConstType* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmDwarfConstType* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmDwarfConstType* sgnode);
     ...
     public:
       ...
       */
       // SgAsmDwarfConstType( SgAsmDwarfConstTypeStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmDwarfConstTypeStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmDwarfConstType( const SgAsmDwarfConstTypeStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmDwarfConstType* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmDwarfConstType* isSgAsmDwarfConstType ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmDwarfConstType>;
...
// postdeclarations for SgAsmDwarfConstType

/* #line 502 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfConstType.h" */
...
/* #line 509 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfConstType.h" */

#endif // ROSE_SgAsmDwarfConstType_H
