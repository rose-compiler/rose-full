...
#ifndef ROSE_SgAsmJvmMethodParametersEntry_H
#define ROSE_SgAsmJvmMethodParametersEntry_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmJvmMethodParametersEntry

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmJvmMethodParametersEntry.h" */
...
// Class Definition for SgAsmJvmMethodParametersEntry
class ROSE_DLL_API SgAsmJvmMethodParametersEntry  : public SgAsmJvmNode
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmJvmMethodParametersEntry.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 11225 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmJvmMethodParametersEntry;
          enum { static_variant = V_SgAsmJvmMethodParametersEntry };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmJvmMethodParametersEntry* isSgAsmJvmMethodParametersEntry(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmJvmMethodParametersEntry* isSgAsmJvmMethodParametersEntry( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmJvmMethodParametersEntry * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmJvmMethodParametersEntryStorageClass *); // 
          ...
          /// \private
          static SgAsmJvmMethodParametersEntry * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmJvmMethodParametersEntry * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmJvmMethodParametersEntry::operator delete (pointer,sizeof(SgAsmJvmMethodParametersEntry));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmJvmMethodParametersEntry* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmJvmMethodParametersEntry* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmJvmMethodParametersEntry* sgnode);
     ...
     public:
       ...
       */
       // SgAsmJvmMethodParametersEntry( SgAsmJvmMethodParametersEntryStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmJvmMethodParametersEntryStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmJvmMethodParametersEntry( const SgAsmJvmMethodParametersEntryStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmJvmMethodParametersEntry* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmJvmMethodParametersEntry* isSgAsmJvmMethodParametersEntry ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmJvmMethodParametersEntry>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmJvmMethodParametersEntry, uint16_t,&SgAsmJvmMethodParametersEntry::p_name_index>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmJvmMethodParametersEntry, uint16_t,&SgAsmJvmMethodParametersEntry::p_access_flags>;
...
// postdeclarations for SgAsmJvmMethodParametersEntry

/* #line 544 "/workspace/generated/src/frontend/SageIII//SgAsmJvmMethodParametersEntry.h" */
...
/* #line 551 "/workspace/generated/src/frontend/SageIII//SgAsmJvmMethodParametersEntry.h" */

#endif // ROSE_SgAsmJvmMethodParametersEntry_H
