...
#ifndef ROSE_SgAsmDwarfPackedType_H
#define ROSE_SgAsmDwarfPackedType_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmDwarfPackedType

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfPackedType.h" */
...
// Class Definition for SgAsmDwarfPackedType
class ROSE_DLL_API SgAsmDwarfPackedType  : public SgAsmDwarfConstruct
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfPackedType.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 26041 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmDwarfPackedType;
          enum { static_variant = V_SgAsmDwarfPackedType };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmDwarfPackedType* isSgAsmDwarfPackedType(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmDwarfPackedType* isSgAsmDwarfPackedType( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmDwarfPackedType * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmDwarfPackedTypeStorageClass *); // 
          ...
          /// \private
          static SgAsmDwarfPackedType * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmDwarfPackedType * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmDwarfPackedType::operator delete (pointer,sizeof(SgAsmDwarfPackedType));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmDwarfPackedType* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmDwarfPackedType* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmDwarfPackedType* sgnode);
     ...
     public:
       ...
       */
       // SgAsmDwarfPackedType( SgAsmDwarfPackedTypeStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmDwarfPackedTypeStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmDwarfPackedType( const SgAsmDwarfPackedTypeStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmDwarfPackedType* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmDwarfPackedType* isSgAsmDwarfPackedType ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmDwarfPackedType>;
...
// postdeclarations for SgAsmDwarfPackedType

/* #line 502 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfPackedType.h" */
...
/* #line 509 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfPackedType.h" */

#endif // ROSE_SgAsmDwarfPackedType_H
