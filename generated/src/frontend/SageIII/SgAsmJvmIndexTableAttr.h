...
#ifndef ROSE_SgAsmJvmIndexTableAttr_H
#define ROSE_SgAsmJvmIndexTableAttr_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmJvmIndexTableAttr

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmJvmIndexTableAttr.h" */
/* #line 12307 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// Class Definition for SgAsmJvmIndexTableAttr
class ROSE_DLL_API SgAsmJvmIndexTableAttr  : public SgAsmJvmAttribute
   {
     public:


/* #line 42 "/workspace/generated/src/frontend/SageIII//SgAsmJvmIndexTableAttr.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 12360 "/workspace/src/ROSETTA/src/binaryInstruction.C" */


    //----------------------- Boost serialization for SgAsmJvmIndexTableAttr -----------------------
...
private:
    ...
    void serialize(S &s, const unsigned /*version*/) {
        debugSerializationBegin("SgAsmJvmIndexTableAttr");
        ...
        debugSerializationEnd("SgAsmJvmIndexTableAttr");
    }
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmJvmIndexTableAttr;
          enum { static_variant = V_SgAsmJvmIndexTableAttr };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmJvmIndexTableAttr* isSgAsmJvmIndexTableAttr(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmJvmIndexTableAttr* isSgAsmJvmIndexTableAttr( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmJvmIndexTableAttr * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmJvmIndexTableAttrStorageClass *); // 
          ...
          /// \private
          static SgAsmJvmIndexTableAttr * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmJvmIndexTableAttr * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmJvmIndexTableAttr::operator delete (pointer,sizeof(SgAsmJvmIndexTableAttr));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmJvmIndexTableAttr* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmJvmIndexTableAttr* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmJvmIndexTableAttr* sgnode);
     ...
     public:
       ...
       */
       // SgAsmJvmIndexTableAttr( SgAsmJvmIndexTableAttrStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmJvmIndexTableAttrStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmJvmIndexTableAttr( const SgAsmJvmIndexTableAttrStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmJvmIndexTableAttr* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmJvmIndexTableAttr* isSgAsmJvmIndexTableAttr ( SgNode* s );
...
// End of memberFunctionString
    ...
    protected:
// Start of memberFunctionString
unsigned p_attribute_type;
          
// End of memberFunctionString
// Start of memberFunctionString
std::vector<uint16_t> p_table;
          
// End of memberFunctionString

    friend struct Rose::Traits::generated::describe_node_t<SgAsmJvmIndexTableAttr>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmJvmIndexTableAttr, unsigned,&SgAsmJvmIndexTableAttr::p_attribute_type>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmJvmIndexTableAttr, std::vector<uint16_t>,&SgAsmJvmIndexTableAttr::p_table>;
...
// postdeclarations for SgAsmJvmIndexTableAttr

/* #line 565 "/workspace/generated/src/frontend/SageIII//SgAsmJvmIndexTableAttr.h" */
...
/* #line 572 "/workspace/generated/src/frontend/SageIII//SgAsmJvmIndexTableAttr.h" */

#endif // ROSE_SgAsmJvmIndexTableAttr_H
