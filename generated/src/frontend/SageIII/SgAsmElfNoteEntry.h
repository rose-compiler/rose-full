...
#ifndef ROSE_SgAsmElfNoteEntry_H
#define ROSE_SgAsmElfNoteEntry_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmElfNoteEntry

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmElfNoteEntry.h" */
/* #line 22146 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// Class Definition for SgAsmElfNoteEntry
class ROSE_DLL_API SgAsmElfNoteEntry  : public SgAsmExecutableFileFormat
   {
     public:


/* #line 48 "/workspace/generated/src/frontend/SageIII//SgAsmElfNoteEntry.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 22180 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmElfNoteEntry;
          enum { static_variant = V_SgAsmElfNoteEntry };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmElfNoteEntry* isSgAsmElfNoteEntry(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmElfNoteEntry* isSgAsmElfNoteEntry( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmElfNoteEntry * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmElfNoteEntryStorageClass *); // 
          ...
          /// \private
          static SgAsmElfNoteEntry * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmElfNoteEntry * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmElfNoteEntry::operator delete (pointer,sizeof(SgAsmElfNoteEntry));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmElfNoteEntry* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmElfNoteEntry* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmElfNoteEntry* sgnode);
     ...
     public:
       ...
       */
       // SgAsmElfNoteEntry( SgAsmElfNoteEntryStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmElfNoteEntryStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmElfNoteEntry( const SgAsmElfNoteEntryStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmElfNoteEntry* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmElfNoteEntry* isSgAsmElfNoteEntry ( SgNode* s );
...
// End of memberFunctionString
// Start of memberFunctionString
SgUnsignedCharList p_payload;
          
// End of memberFunctionString

    friend struct Rose::Traits::generated::describe_node_t<SgAsmElfNoteEntry>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmElfNoteEntry, unsigned,&SgAsmElfNoteEntry::p_type>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmElfNoteEntry, SgAsmGenericString*,&SgAsmElfNoteEntry::p_name>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmElfNoteEntry, SgUnsignedCharList,&SgAsmElfNoteEntry::p_payload>;
...
// postdeclarations for SgAsmElfNoteEntry

/* #line 596 "/workspace/generated/src/frontend/SageIII//SgAsmElfNoteEntry.h" */
...
/* #line 603 "/workspace/generated/src/frontend/SageIII//SgAsmElfNoteEntry.h" */

#endif // ROSE_SgAsmElfNoteEntry_H
