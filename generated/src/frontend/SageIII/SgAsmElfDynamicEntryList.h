...
#ifndef ROSE_SgAsmElfDynamicEntryList_H
#define ROSE_SgAsmElfDynamicEntryList_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmElfDynamicEntryList

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmElfDynamicEntryList.h" */
/* #line 23852 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// Class Definition for SgAsmElfDynamicEntryList
class ROSE_DLL_API SgAsmElfDynamicEntryList  : public SgAsmExecutableFileFormat
   {
     public:


/* #line 42 "/workspace/generated/src/frontend/SageIII//SgAsmElfDynamicEntryList.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 23871 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmElfDynamicEntryList;
          enum { static_variant = V_SgAsmElfDynamicEntryList };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmElfDynamicEntryList* isSgAsmElfDynamicEntryList(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmElfDynamicEntryList* isSgAsmElfDynamicEntryList( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmElfDynamicEntryList * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmElfDynamicEntryListStorageClass *); // 
          ...
          /// \private
          static SgAsmElfDynamicEntryList * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmElfDynamicEntryList * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmElfDynamicEntryList::operator delete (pointer,sizeof(SgAsmElfDynamicEntryList));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmElfDynamicEntryList* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmElfDynamicEntryList* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmElfDynamicEntryList* sgnode);
     ...
     public:
       ...
       */
       // SgAsmElfDynamicEntryList( SgAsmElfDynamicEntryListStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmElfDynamicEntryListStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmElfDynamicEntryList( const SgAsmElfDynamicEntryListStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmElfDynamicEntryList* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmElfDynamicEntryList* isSgAsmElfDynamicEntryList ( SgNode* s );
...
// End of memberFunctionString
    ...
    protected:
// Start of memberFunctionString
SgAsmElfDynamicEntryPtrList p_entries;
          
// End of memberFunctionString

    friend struct Rose::Traits::generated::describe_node_t<SgAsmElfDynamicEntryList>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmElfDynamicEntryList, SgAsmElfDynamicEntryPtrList,&SgAsmElfDynamicEntryList::p_entries>;
...
// postdeclarations for SgAsmElfDynamicEntryList

/* #line 516 "/workspace/generated/src/frontend/SageIII//SgAsmElfDynamicEntryList.h" */
...
/* #line 523 "/workspace/generated/src/frontend/SageIII//SgAsmElfDynamicEntryList.h" */

#endif // ROSE_SgAsmElfDynamicEntryList_H
