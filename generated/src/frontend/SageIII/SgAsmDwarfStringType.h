...
#ifndef ROSE_SgAsmDwarfStringType_H
#define ROSE_SgAsmDwarfStringType_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmDwarfStringType

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfStringType.h" */
...
// Class Definition for SgAsmDwarfStringType
class ROSE_DLL_API SgAsmDwarfStringType  : public SgAsmDwarfConstruct
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfStringType.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 25569 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmDwarfStringType;
          enum { static_variant = V_SgAsmDwarfStringType };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmDwarfStringType* isSgAsmDwarfStringType(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmDwarfStringType* isSgAsmDwarfStringType( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmDwarfStringType * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmDwarfStringTypeStorageClass *); // 
          ...
          /// \private
          static SgAsmDwarfStringType * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmDwarfStringType * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmDwarfStringType::operator delete (pointer,sizeof(SgAsmDwarfStringType));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmDwarfStringType* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmDwarfStringType* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmDwarfStringType* sgnode);
     ...
     public:
       ...
       */
       // SgAsmDwarfStringType( SgAsmDwarfStringTypeStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmDwarfStringTypeStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmDwarfStringType( const SgAsmDwarfStringTypeStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmDwarfStringType* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmDwarfStringType* isSgAsmDwarfStringType ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmDwarfStringType>;
...
// postdeclarations for SgAsmDwarfStringType

/* #line 502 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfStringType.h" */
...
/* #line 509 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfStringType.h" */

#endif // ROSE_SgAsmDwarfStringType_H
