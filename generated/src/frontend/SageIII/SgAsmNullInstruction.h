...
#ifndef ROSE_SgAsmNullInstruction_H
#define ROSE_SgAsmNullInstruction_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmNullInstruction

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmNullInstruction.h" */
...
// Class Definition for SgAsmNullInstruction
class ROSE_DLL_API SgAsmNullInstruction  : public SgAsmInstruction
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmNullInstruction.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 5511 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmNullInstruction;
          enum { static_variant = V_SgAsmNullInstruction };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmNullInstruction* isSgAsmNullInstruction(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmNullInstruction* isSgAsmNullInstruction( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmNullInstruction * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmNullInstructionStorageClass *); // 
          ...
          /// \private
          static SgAsmNullInstruction * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmNullInstruction * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmNullInstruction::operator delete (pointer,sizeof(SgAsmNullInstruction));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmNullInstruction* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmNullInstruction* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmNullInstruction* sgnode);
     ...
     public:
       ...
       */
       // SgAsmNullInstruction( SgAsmNullInstructionStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmNullInstructionStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmNullInstruction( const SgAsmNullInstructionStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmNullInstruction* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmNullInstruction* isSgAsmNullInstruction ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmNullInstruction>;
...
// postdeclarations for SgAsmNullInstruction

/* #line 506 "/workspace/generated/src/frontend/SageIII//SgAsmNullInstruction.h" */
...
/* #line 513 "/workspace/generated/src/frontend/SageIII//SgAsmNullInstruction.h" */

#endif // ROSE_SgAsmNullInstruction_H
