...
#ifndef ROSE_SgAsmDwarfSubroutineType_H
#define ROSE_SgAsmDwarfSubroutineType_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmDwarfSubroutineType

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfSubroutineType.h" */
/* #line 25239 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// Class Definition for SgAsmDwarfSubroutineType
class ROSE_DLL_API SgAsmDwarfSubroutineType  : public SgAsmDwarfConstruct
   {
     public:


/* #line 44 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfSubroutineType.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 25256 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmDwarfSubroutineType;
          enum { static_variant = V_SgAsmDwarfSubroutineType };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmDwarfSubroutineType* isSgAsmDwarfSubroutineType(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmDwarfSubroutineType* isSgAsmDwarfSubroutineType( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmDwarfSubroutineType * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmDwarfSubroutineTypeStorageClass *); // 
          ...
          /// \private
          static SgAsmDwarfSubroutineType * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmDwarfSubroutineType * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmDwarfSubroutineType::operator delete (pointer,sizeof(SgAsmDwarfSubroutineType));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmDwarfSubroutineType* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmDwarfSubroutineType* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmDwarfSubroutineType* sgnode);
     ...
     public:
       ...
       */
       // SgAsmDwarfSubroutineType( SgAsmDwarfSubroutineTypeStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmDwarfSubroutineTypeStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmDwarfSubroutineType( const SgAsmDwarfSubroutineTypeStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmDwarfSubroutineType* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmDwarfSubroutineType* isSgAsmDwarfSubroutineType ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmDwarfSubroutineType>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmDwarfSubroutineType, SgAsmDwarfConstructList*,&SgAsmDwarfSubroutineType::p_body>;
...
// postdeclarations for SgAsmDwarfSubroutineType

/* #line 520 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfSubroutineType.h" */
...
/* #line 527 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfSubroutineType.h" */

#endif // ROSE_SgAsmDwarfSubroutineType_H
