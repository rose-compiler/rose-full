...
#ifndef ROSE_SgAsmGenericSymbol_H
#define ROSE_SgAsmGenericSymbol_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmGenericSymbol

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmGenericSymbol.h" */
/* #line 31206 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// Class Definition for SgAsmGenericSymbol
class ROSE_DLL_API SgAsmGenericSymbol  : public SgAsmExecutableFileFormat
   {
     public:


/* #line 44 "/workspace/generated/src/frontend/SageIII//SgAsmGenericSymbol.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 31259 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmGenericSymbol;
          enum { static_variant = V_SgAsmGenericSymbol };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmGenericSymbol* isSgAsmGenericSymbol(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmGenericSymbol* isSgAsmGenericSymbol( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmGenericSymbol * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmGenericSymbolStorageClass *); // 
          ...
          /// \private
          static SgAsmGenericSymbol * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmGenericSymbol * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmGenericSymbol::operator delete (pointer,sizeof(SgAsmGenericSymbol));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmGenericSymbol* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmGenericSymbol* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmGenericSymbol* sgnode);
     ...
     public:
       ...
       */
       // SgAsmGenericSymbol( SgAsmGenericSymbolStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmGenericSymbolStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmGenericSymbol( const SgAsmGenericSymbolStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmGenericSymbol* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmGenericSymbol* isSgAsmGenericSymbol ( SgNode* s );
...
// End of memberFunctionString
    ...
    protected:
// Start of memberFunctionString
SgAsmGenericSymbol::SymbolDefState p_definitionState;
          
// End of memberFunctionString
// Start of memberFunctionString
SgAsmGenericSymbol::SymbolBinding p_binding;
          
// End of memberFunctionString
// Start of memberFunctionString
SgAsmGenericSymbol::SymbolType p_type;
          
// End of memberFunctionString
// Start of memberFunctionString
Rose::BinaryAnalysis::Address p_value;
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmGenericSymbol>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmGenericSymbol, SgAsmGenericSymbol::SymbolDefState,&SgAsmGenericSymbol::p_definitionState>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmGenericSymbol, SgAsmGenericSymbol::SymbolBinding,&SgAsmGenericSymbol::p_binding>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmGenericSymbol, SgAsmGenericSymbol::SymbolType,&SgAsmGenericSymbol::p_type>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmGenericSymbol, Rose::BinaryAnalysis::Address,&SgAsmGenericSymbol::p_value>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmGenericSymbol, Rose::BinaryAnalysis::Address,&SgAsmGenericSymbol::p_size>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmGenericSymbol, SgAsmGenericSection*,&SgAsmGenericSymbol::p_bound>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmGenericSymbol, SgAsmGenericString*,&SgAsmGenericSymbol::p_name>;
...
// postdeclarations for SgAsmGenericSymbol

/* #line 656 "/workspace/generated/src/frontend/SageIII//SgAsmGenericSymbol.h" */
...
/* #line 663 "/workspace/generated/src/frontend/SageIII//SgAsmGenericSymbol.h" */

#endif // ROSE_SgAsmGenericSymbol_H
