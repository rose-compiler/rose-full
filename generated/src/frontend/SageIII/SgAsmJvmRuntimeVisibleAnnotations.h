...
#ifndef ROSE_SgAsmJvmRuntimeVisibleAnnotations_H
#define ROSE_SgAsmJvmRuntimeVisibleAnnotations_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmJvmRuntimeVisibleAnnotations

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmJvmRuntimeVisibleAnnotations.h" */
/* #line 9827 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// Class Definition for SgAsmJvmRuntimeVisibleAnnotations
class ROSE_DLL_API SgAsmJvmRuntimeVisibleAnnotations  : public SgAsmJvmAttribute
   {
     public:


/* #line 42 "/workspace/generated/src/frontend/SageIII//SgAsmJvmRuntimeVisibleAnnotations.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 9848 "/workspace/src/ROSETTA/src/binaryInstruction.C" */


    //----------------------- Boost serialization for SgAsmJvmRuntimeVisibleAnnotations -----------------------
...
private:
    ...
    void serialize(S &s, const unsigned /*version*/) {
        debugSerializationBegin("SgAsmJvmRuntimeVisibleAnnotations");
        s & BOOST_SERIALIZATION_BASE_OBJECT_NVP(SgAsmJvmAttribute);
        s & BOOST_SERIALIZATION_NVP(p_annotations);
        debugSerializationEnd("SgAsmJvmRuntimeVisibleAnnotations");
    }
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmJvmRuntimeVisibleAnnotations;
          enum { static_variant = V_SgAsmJvmRuntimeVisibleAnnotations };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmJvmRuntimeVisibleAnnotations* isSgAsmJvmRuntimeVisibleAnnotations(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmJvmRuntimeVisibleAnnotations* isSgAsmJvmRuntimeVisibleAnnotations( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmJvmRuntimeVisibleAnnotations * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmJvmRuntimeVisibleAnnotationsStorageClass *); // 
          ...
          /// \private
          static SgAsmJvmRuntimeVisibleAnnotations * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmJvmRuntimeVisibleAnnotations * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmJvmRuntimeVisibleAnnotations::operator delete (pointer,sizeof(SgAsmJvmRuntimeVisibleAnnotations));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmJvmRuntimeVisibleAnnotations* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmJvmRuntimeVisibleAnnotations* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmJvmRuntimeVisibleAnnotations* sgnode);
     ...
     public:
       ...
       */
       // SgAsmJvmRuntimeVisibleAnnotations( SgAsmJvmRuntimeVisibleAnnotationsStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmJvmRuntimeVisibleAnnotationsStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmJvmRuntimeVisibleAnnotations( const SgAsmJvmRuntimeVisibleAnnotationsStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmJvmRuntimeVisibleAnnotations* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmJvmRuntimeVisibleAnnotations* isSgAsmJvmRuntimeVisibleAnnotations ( SgNode* s );
...
// End of memberFunctionString
    ...
    protected:
// Start of memberFunctionString
std::vector<SgAsmJvmRuntimeAnnotation*> p_annotations;
          
// End of memberFunctionString

    friend struct Rose::Traits::generated::describe_node_t<SgAsmJvmRuntimeVisibleAnnotations>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmJvmRuntimeVisibleAnnotations, std::vector<SgAsmJvmRuntimeAnnotation*>,&SgAsmJvmRuntimeVisibleAnnotations::p_annotations>;
...
// postdeclarations for SgAsmJvmRuntimeVisibleAnnotations

/* #line 530 "/workspace/generated/src/frontend/SageIII//SgAsmJvmRuntimeVisibleAnnotations.h" */
...
/* #line 537 "/workspace/generated/src/frontend/SageIII//SgAsmJvmRuntimeVisibleAnnotations.h" */

#endif // ROSE_SgAsmJvmRuntimeVisibleAnnotations_H
