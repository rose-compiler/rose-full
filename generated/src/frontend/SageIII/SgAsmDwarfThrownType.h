...
#ifndef ROSE_SgAsmDwarfThrownType_H
#define ROSE_SgAsmDwarfThrownType_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmDwarfThrownType

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfThrownType.h" */
...
// Class Definition for SgAsmDwarfThrownType
class ROSE_DLL_API SgAsmDwarfThrownType  : public SgAsmDwarfConstruct
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfThrownType.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 25066 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmDwarfThrownType;
          enum { static_variant = V_SgAsmDwarfThrownType };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmDwarfThrownType* isSgAsmDwarfThrownType(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmDwarfThrownType* isSgAsmDwarfThrownType( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmDwarfThrownType * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmDwarfThrownTypeStorageClass *); // 
          ...
          /// \private
          static SgAsmDwarfThrownType * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmDwarfThrownType * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmDwarfThrownType::operator delete (pointer,sizeof(SgAsmDwarfThrownType));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmDwarfThrownType* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmDwarfThrownType* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmDwarfThrownType* sgnode);
     ...
     public:
       ...
       */
       // SgAsmDwarfThrownType( SgAsmDwarfThrownTypeStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmDwarfThrownTypeStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmDwarfThrownType( const SgAsmDwarfThrownTypeStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmDwarfThrownType* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmDwarfThrownType* isSgAsmDwarfThrownType ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmDwarfThrownType>;
...
// postdeclarations for SgAsmDwarfThrownType

/* #line 502 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfThrownType.h" */
...
/* #line 509 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfThrownType.h" */

#endif // ROSE_SgAsmDwarfThrownType_H
