...
#ifndef ROSE_SgAsmDwarfUpcRelaxedType_H
#define ROSE_SgAsmDwarfUpcRelaxedType_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmDwarfUpcRelaxedType

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfUpcRelaxedType.h" */
...
// Class Definition for SgAsmDwarfUpcRelaxedType
class ROSE_DLL_API SgAsmDwarfUpcRelaxedType  : public SgAsmDwarfConstruct
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfUpcRelaxedType.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 24634 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmDwarfUpcRelaxedType;
          enum { static_variant = V_SgAsmDwarfUpcRelaxedType };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmDwarfUpcRelaxedType* isSgAsmDwarfUpcRelaxedType(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmDwarfUpcRelaxedType* isSgAsmDwarfUpcRelaxedType( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmDwarfUpcRelaxedType * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmDwarfUpcRelaxedTypeStorageClass *); // 
          ...
          /// \private
          static SgAsmDwarfUpcRelaxedType * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmDwarfUpcRelaxedType * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmDwarfUpcRelaxedType::operator delete (pointer,sizeof(SgAsmDwarfUpcRelaxedType));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmDwarfUpcRelaxedType* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmDwarfUpcRelaxedType* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmDwarfUpcRelaxedType* sgnode);
     ...
     public:
       ...
       */
       // SgAsmDwarfUpcRelaxedType( SgAsmDwarfUpcRelaxedTypeStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmDwarfUpcRelaxedTypeStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmDwarfUpcRelaxedType( const SgAsmDwarfUpcRelaxedTypeStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmDwarfUpcRelaxedType* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmDwarfUpcRelaxedType* isSgAsmDwarfUpcRelaxedType ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmDwarfUpcRelaxedType>;
...
// postdeclarations for SgAsmDwarfUpcRelaxedType

/* #line 502 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfUpcRelaxedType.h" */
...
/* #line 509 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfUpcRelaxedType.h" */

#endif // ROSE_SgAsmDwarfUpcRelaxedType_H
