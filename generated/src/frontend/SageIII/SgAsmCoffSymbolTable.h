...
#ifndef ROSE_SgAsmCoffSymbolTable_H
#define ROSE_SgAsmCoffSymbolTable_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmCoffSymbolTable

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmCoffSymbolTable.h" */
/* #line 30801 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// Class Definition for SgAsmCoffSymbolTable
class ROSE_DLL_API SgAsmCoffSymbolTable  : public SgAsmGenericSection
   {
     public:


/* #line 44 "/workspace/generated/src/frontend/SageIII//SgAsmCoffSymbolTable.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 30827 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmCoffSymbolTable;
          enum { static_variant = V_SgAsmCoffSymbolTable };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmCoffSymbolTable* isSgAsmCoffSymbolTable(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmCoffSymbolTable* isSgAsmCoffSymbolTable( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmCoffSymbolTable * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmCoffSymbolTableStorageClass *); // 
          ...
          /// \private
          static SgAsmCoffSymbolTable * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmCoffSymbolTable * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmCoffSymbolTable::operator delete (pointer,sizeof(SgAsmCoffSymbolTable));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmCoffSymbolTable* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmCoffSymbolTable* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmCoffSymbolTable* sgnode);
     ...
     public:
       ...
       */
       // SgAsmCoffSymbolTable( SgAsmCoffSymbolTableStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmCoffSymbolTableStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmCoffSymbolTable( const SgAsmCoffSymbolTableStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmCoffSymbolTable* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmCoffSymbolTable* isSgAsmCoffSymbolTable ( SgNode* s );
...
// End of memberFunctionString
    ...
    protected:
// Start of memberFunctionString
SgAsmGenericSection* p_strtab;
          
// End of memberFunctionString
// Start of memberFunctionString
SgAsmCoffSymbolList* p_symbols;
          
// End of memberFunctionString

    friend struct Rose::Traits::generated::describe_node_t<SgAsmCoffSymbolTable>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCoffSymbolTable, SgAsmGenericSection*,&SgAsmCoffSymbolTable::p_strtab>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCoffSymbolTable, SgAsmCoffSymbolList*,&SgAsmCoffSymbolTable::p_symbols>;
...
// postdeclarations for SgAsmCoffSymbolTable

/* #line 539 "/workspace/generated/src/frontend/SageIII//SgAsmCoffSymbolTable.h" */
...
/* #line 546 "/workspace/generated/src/frontend/SageIII//SgAsmCoffSymbolTable.h" */

#endif // ROSE_SgAsmCoffSymbolTable_H
