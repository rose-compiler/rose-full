...
#ifndef ROSE_SgAsmCilUint32Heap_H
#define ROSE_SgAsmCilUint32Heap_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmCilUint32Heap

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmCilUint32Heap.h" */
...
// Class Definition for SgAsmCilUint32Heap
class ROSE_DLL_API SgAsmCilUint32Heap  : public SgAsmCilDataStream
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmCilUint32Heap.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 32885 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmCilUint32Heap;
          enum { static_variant = V_SgAsmCilUint32Heap };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmCilUint32Heap* isSgAsmCilUint32Heap(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmCilUint32Heap* isSgAsmCilUint32Heap( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmCilUint32Heap * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmCilUint32HeapStorageClass *); // 
          ...
          /// \private
          static SgAsmCilUint32Heap * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmCilUint32Heap * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmCilUint32Heap::operator delete (pointer,sizeof(SgAsmCilUint32Heap));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmCilUint32Heap* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmCilUint32Heap* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmCilUint32Heap* sgnode);
     ...
     public:
       ...
       */
       // SgAsmCilUint32Heap( SgAsmCilUint32HeapStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmCilUint32HeapStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmCilUint32Heap( const SgAsmCilUint32HeapStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmCilUint32Heap* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmCilUint32Heap* isSgAsmCilUint32Heap ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmCilUint32Heap>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilUint32Heap, std::vector<uint32_t>,&SgAsmCilUint32Heap::p_Stream>;
...
// postdeclarations for SgAsmCilUint32Heap

/* #line 517 "/workspace/generated/src/frontend/SageIII//SgAsmCilUint32Heap.h" */
...
/* #line 524 "/workspace/generated/src/frontend/SageIII//SgAsmCilUint32Heap.h" */

#endif // ROSE_SgAsmCilUint32Heap_H
