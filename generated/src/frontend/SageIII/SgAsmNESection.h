...
#ifndef ROSE_SgAsmNESection_H
#define ROSE_SgAsmNESection_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmNESection

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmNESection.h" */
/* #line 5909 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// Class Definition for SgAsmNESection
class ROSE_DLL_API SgAsmNESection  : public SgAsmGenericSection
   {
     public:


/* #line 45 "/workspace/generated/src/frontend/SageIII//SgAsmNESection.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 5933 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmNESection;
          enum { static_variant = V_SgAsmNESection };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmNESection* isSgAsmNESection(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmNESection* isSgAsmNESection( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmNESection * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmNESectionStorageClass *); // 
          ...
          /// \private
          static SgAsmNESection * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmNESection * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmNESection::operator delete (pointer,sizeof(SgAsmNESection));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmNESection* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmNESection* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmNESection* sgnode);
     ...
     public:
       ...
       */
       // SgAsmNESection( SgAsmNESectionStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmNESectionStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmNESection( const SgAsmNESectionStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmNESection* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmNESection* isSgAsmNESection ( SgNode* s );
...
// End of memberFunctionString
    ...
    protected:
// Start of memberFunctionString
SgAsmNESectionTableEntry* p_sectionTableEntry;
          
// End of memberFunctionString
// Start of memberFunctionString
SgAsmNERelocTable* p_relocationTable;
          
// End of memberFunctionString

    friend struct Rose::Traits::generated::describe_node_t<SgAsmNESection>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmNESection, SgAsmNESectionTableEntry*,&SgAsmNESection::p_sectionTableEntry>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmNESection, SgAsmNERelocTable*,&SgAsmNESection::p_relocationTable>;
...
// postdeclarations for SgAsmNESection

/* #line 537 "/workspace/generated/src/frontend/SageIII//SgAsmNESection.h" */
...
/* #line 544 "/workspace/generated/src/frontend/SageIII//SgAsmNESection.h" */

#endif // ROSE_SgAsmNESection_H
