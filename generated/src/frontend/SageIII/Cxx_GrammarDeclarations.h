...
// #line 2820 "/workspace/src/ROSETTA/src/grammar.C"
#include <RoseFirst.h>
class SgAbsOp;
...
class SgAsmJvmAnnotationDefault;
...
class SgAsmJvmIndexTableAttr;
class SgAsmJvmIndexedAttr;
...
class SgAsmJvmModule;
class SgAsmJvmNode;
class SgAsmJvmRuntimeAnnotation;
class SgAsmJvmRuntimeAnnotationPair;
class SgAsmJvmRuntimeAnnotationValue;
class SgAsmJvmRuntimeInvisibleAnnotations;
class SgAsmJvmRuntimeParameterAnnotation;
class SgAsmJvmRuntimeVisibilityParamAnnotations;
class SgAsmJvmRuntimeVisibleAnnotations;
...
class SgTypeFloat16;
class SgTypeFloat32;
class SgTypeFloat32x;
class SgTypeFloat64;
class SgTypeFloat64x;
class SgTypeFloat80;
class SgTypeFp16;
