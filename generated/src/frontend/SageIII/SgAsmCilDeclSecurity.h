...
#ifndef ROSE_SgAsmCilDeclSecurity_H
#define ROSE_SgAsmCilDeclSecurity_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmCilDeclSecurity

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmCilDeclSecurity.h" */
...
// Class Definition for SgAsmCilDeclSecurity
class ROSE_DLL_API SgAsmCilDeclSecurity  : public SgAsmCilMetadata
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmCilDeclSecurity.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 39822 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmCilDeclSecurity;
          enum { static_variant = V_SgAsmCilDeclSecurity };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmCilDeclSecurity* isSgAsmCilDeclSecurity(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmCilDeclSecurity* isSgAsmCilDeclSecurity( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmCilDeclSecurity * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmCilDeclSecurityStorageClass *); // 
          ...
          /// \private
          static SgAsmCilDeclSecurity * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmCilDeclSecurity * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmCilDeclSecurity::operator delete (pointer,sizeof(SgAsmCilDeclSecurity));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmCilDeclSecurity* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmCilDeclSecurity* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmCilDeclSecurity* sgnode);
     ...
     public:
       ...
       */
       // SgAsmCilDeclSecurity( SgAsmCilDeclSecurityStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmCilDeclSecurityStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmCilDeclSecurity( const SgAsmCilDeclSecurityStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmCilDeclSecurity* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmCilDeclSecurity* isSgAsmCilDeclSecurity ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmCilDeclSecurity>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilDeclSecurity, uint16_t,&SgAsmCilDeclSecurity::p_Action>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilDeclSecurity, uint32_t,&SgAsmCilDeclSecurity::p_Parent>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilDeclSecurity, uint32_t,&SgAsmCilDeclSecurity::p_PermissionSet>;
...
// postdeclarations for SgAsmCilDeclSecurity

/* #line 553 "/workspace/generated/src/frontend/SageIII//SgAsmCilDeclSecurity.h" */
...
/* #line 560 "/workspace/generated/src/frontend/SageIII//SgAsmCilDeclSecurity.h" */

#endif // ROSE_SgAsmCilDeclSecurity_H
