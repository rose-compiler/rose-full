...
#ifndef ROSE_SgAsmCilModule_H
#define ROSE_SgAsmCilModule_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmCilModule

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmCilModule.h" */
...
// Class Definition for SgAsmCilModule
class ROSE_DLL_API SgAsmCilModule  : public SgAsmCilMetadata
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmCilModule.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 34611 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmCilModule;
          enum { static_variant = V_SgAsmCilModule };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmCilModule* isSgAsmCilModule(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmCilModule* isSgAsmCilModule( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmCilModule * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmCilModuleStorageClass *); // 
          ...
          /// \private
          static SgAsmCilModule * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmCilModule * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmCilModule::operator delete (pointer,sizeof(SgAsmCilModule));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmCilModule* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmCilModule* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmCilModule* sgnode);
     ...
     public:
       ...
       */
       // SgAsmCilModule( SgAsmCilModuleStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmCilModuleStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmCilModule( const SgAsmCilModuleStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmCilModule* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmCilModule* isSgAsmCilModule ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmCilModule>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilModule, uint16_t,&SgAsmCilModule::p_Generation>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilModule, uint32_t,&SgAsmCilModule::p_Name>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilModule, uint32_t,&SgAsmCilModule::p_Mvid>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilModule, uint32_t,&SgAsmCilModule::p_Encld>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilModule, uint32_t,&SgAsmCilModule::p_EncBaseId>;
...
// postdeclarations for SgAsmCilModule

/* #line 589 "/workspace/generated/src/frontend/SageIII//SgAsmCilModule.h" */
...
/* #line 596 "/workspace/generated/src/frontend/SageIII//SgAsmCilModule.h" */

#endif // ROSE_SgAsmCilModule_H
