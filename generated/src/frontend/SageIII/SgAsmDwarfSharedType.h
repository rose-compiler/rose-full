...
#ifndef ROSE_SgAsmDwarfSharedType_H
#define ROSE_SgAsmDwarfSharedType_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmDwarfSharedType

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfSharedType.h" */
...
// Class Definition for SgAsmDwarfSharedType
class ROSE_DLL_API SgAsmDwarfSharedType  : public SgAsmDwarfConstruct
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfSharedType.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 25628 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmDwarfSharedType;
          enum { static_variant = V_SgAsmDwarfSharedType };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmDwarfSharedType* isSgAsmDwarfSharedType(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmDwarfSharedType* isSgAsmDwarfSharedType( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmDwarfSharedType * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmDwarfSharedTypeStorageClass *); // 
          ...
          /// \private
          static SgAsmDwarfSharedType * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmDwarfSharedType * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmDwarfSharedType::operator delete (pointer,sizeof(SgAsmDwarfSharedType));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmDwarfSharedType* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmDwarfSharedType* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmDwarfSharedType* sgnode);
     ...
     public:
       ...
       */
       // SgAsmDwarfSharedType( SgAsmDwarfSharedTypeStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmDwarfSharedTypeStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmDwarfSharedType( const SgAsmDwarfSharedTypeStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmDwarfSharedType* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmDwarfSharedType* isSgAsmDwarfSharedType ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmDwarfSharedType>;
...
// postdeclarations for SgAsmDwarfSharedType

/* #line 502 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfSharedType.h" */
...
/* #line 509 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfSharedType.h" */

#endif // ROSE_SgAsmDwarfSharedType_H
