...
#ifndef ROSE_SgAsmCilEventTable_H
#define ROSE_SgAsmCilEventTable_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmCilEventTable

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmCilEventTable.h" */
...
// Class Definition for SgAsmCilEventTable
class ROSE_DLL_API SgAsmCilEventTable  : public SgAsmCilMetadata
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmCilEventTable.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 39343 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmCilEventTable;
          enum { static_variant = V_SgAsmCilEventTable };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmCilEventTable* isSgAsmCilEventTable(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmCilEventTable* isSgAsmCilEventTable( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmCilEventTable * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmCilEventTableStorageClass *); // 
          ...
          /// \private
          static SgAsmCilEventTable * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmCilEventTable * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmCilEventTable::operator delete (pointer,sizeof(SgAsmCilEventTable));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmCilEventTable* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmCilEventTable* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmCilEventTable* sgnode);
     ...
     public:
       ...
       */
       // SgAsmCilEventTable( SgAsmCilEventTableStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmCilEventTableStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmCilEventTable( const SgAsmCilEventTableStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmCilEventTable* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmCilEventTable* isSgAsmCilEventTable ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmCilEventTable>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilEventTable, std::vector<SgAsmCilEvent*>,&SgAsmCilEventTable::p_elements>;
...
// postdeclarations for SgAsmCilEventTable

/* #line 508 "/workspace/generated/src/frontend/SageIII//SgAsmCilEventTable.h" */
...
/* #line 515 "/workspace/generated/src/frontend/SageIII//SgAsmCilEventTable.h" */

#endif // ROSE_SgAsmCilEventTable_H
