...
#ifndef ROSE_SgAsmDwarfTypedef_H
#define ROSE_SgAsmDwarfTypedef_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmDwarfTypedef

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfTypedef.h" */
...
// Class Definition for SgAsmDwarfTypedef
class ROSE_DLL_API SgAsmDwarfTypedef  : public SgAsmDwarfConstruct
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfTypedef.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 24948 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmDwarfTypedef;
          enum { static_variant = V_SgAsmDwarfTypedef };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmDwarfTypedef* isSgAsmDwarfTypedef(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmDwarfTypedef* isSgAsmDwarfTypedef( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmDwarfTypedef * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmDwarfTypedefStorageClass *); // 
          ...
          /// \private
          static SgAsmDwarfTypedef * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmDwarfTypedef * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmDwarfTypedef::operator delete (pointer,sizeof(SgAsmDwarfTypedef));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmDwarfTypedef* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmDwarfTypedef* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmDwarfTypedef* sgnode);
     ...
     public:
       ...
       */
       // SgAsmDwarfTypedef( SgAsmDwarfTypedefStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmDwarfTypedefStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmDwarfTypedef( const SgAsmDwarfTypedefStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmDwarfTypedef* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmDwarfTypedef* isSgAsmDwarfTypedef ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmDwarfTypedef>;
...
// postdeclarations for SgAsmDwarfTypedef

/* #line 502 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfTypedef.h" */
...
/* #line 509 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfTypedef.h" */

#endif // ROSE_SgAsmDwarfTypedef_H
