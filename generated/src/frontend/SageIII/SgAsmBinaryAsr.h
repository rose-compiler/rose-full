...
#ifndef ROSE_SgAsmBinaryAsr_H
#define ROSE_SgAsmBinaryAsr_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmBinaryAsr

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmBinaryAsr.h" */
...
// Class Definition for SgAsmBinaryAsr
class ROSE_DLL_API SgAsmBinaryAsr  : public SgAsmBinaryExpression
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmBinaryAsr.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 43201 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmBinaryAsr* isSgAsmBinaryAsr(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmBinaryAsr* isSgAsmBinaryAsr( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmBinaryAsr * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmBinaryAsrStorageClass *); // 
          ...
          /// \private
          static SgAsmBinaryAsr * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmBinaryAsr * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmBinaryAsr::operator delete (pointer,sizeof(SgAsmBinaryAsr));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmBinaryAsr* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmBinaryAsr* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmBinaryAsr* sgnode);
     ...
     public:
       ...
       */
       // SgAsmBinaryAsr( SgAsmBinaryAsrStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmBinaryAsrStorageClass;
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmBinaryAsr* isSgAsmBinaryAsr ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmBinaryAsr>;
...
// postdeclarations for SgAsmBinaryAsr

/* #line 501 "/workspace/generated/src/frontend/SageIII//SgAsmBinaryAsr.h" */
...
/* #line 508 "/workspace/generated/src/frontend/SageIII//SgAsmBinaryAsr.h" */

#endif // ROSE_SgAsmBinaryAsr_H
