...
#ifndef ROSE_SgAsmPEExportSection_H
#define ROSE_SgAsmPEExportSection_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmPEExportSection

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmPEExportSection.h" */
/* #line 4654 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// Class Definition for SgAsmPEExportSection
class ROSE_DLL_API SgAsmPEExportSection  : public SgAsmPESection
   {
     public:


/* #line 45 "/workspace/generated/src/frontend/SageIII//SgAsmPEExportSection.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 4679 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmPEExportSection;
          enum { static_variant = V_SgAsmPEExportSection };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmPEExportSection* isSgAsmPEExportSection(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmPEExportSection* isSgAsmPEExportSection( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmPEExportSection * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmPEExportSectionStorageClass *); // 
          ...
          /// \private
          static SgAsmPEExportSection * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmPEExportSection * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmPEExportSection::operator delete (pointer,sizeof(SgAsmPEExportSection));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmPEExportSection* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmPEExportSection* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmPEExportSection* sgnode);
     ...
     public:
       ...
       */
       // SgAsmPEExportSection( SgAsmPEExportSectionStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmPEExportSectionStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmPEExportSection( const SgAsmPEExportSectionStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmPEExportSection* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmPEExportSection* isSgAsmPEExportSection ( SgNode* s );

          typedef SgAsmPESection base_node_type;
...
// End of memberFunctionString
    ...
    protected:
// Start of memberFunctionString
SgAsmPEExportDirectory* p_exportDirectory;
          
// End of memberFunctionString
// Start of memberFunctionString
SgAsmPEExportEntryList* p_exports;
          
// End of memberFunctionString

    friend struct Rose::Traits::generated::describe_node_t<SgAsmPEExportSection>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmPEExportSection, SgAsmPEExportDirectory*,&SgAsmPEExportSection::p_exportDirectory>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmPEExportSection, SgAsmPEExportEntryList*,&SgAsmPEExportSection::p_exports>;
...
// postdeclarations for SgAsmPEExportSection

/* #line 566 "/workspace/generated/src/frontend/SageIII//SgAsmPEExportSection.h" */
...
/* #line 573 "/workspace/generated/src/frontend/SageIII//SgAsmPEExportSection.h" */

#endif // ROSE_SgAsmPEExportSection_H
