...
#ifndef ROSE_SgAsmCilMemberRef_H
#define ROSE_SgAsmCilMemberRef_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmCilMemberRef

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmCilMemberRef.h" */
...
// Class Definition for SgAsmCilMemberRef
class ROSE_DLL_API SgAsmCilMemberRef  : public SgAsmCilMetadata
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmCilMemberRef.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 37029 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmCilMemberRef;
          enum { static_variant = V_SgAsmCilMemberRef };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmCilMemberRef* isSgAsmCilMemberRef(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmCilMemberRef* isSgAsmCilMemberRef( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmCilMemberRef * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmCilMemberRefStorageClass *); // 
          ...
          /// \private
          static SgAsmCilMemberRef * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmCilMemberRef * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmCilMemberRef::operator delete (pointer,sizeof(SgAsmCilMemberRef));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmCilMemberRef* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmCilMemberRef* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmCilMemberRef* sgnode);
     ...
     public:
       ...
       */
       // SgAsmCilMemberRef( SgAsmCilMemberRefStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmCilMemberRefStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmCilMemberRef( const SgAsmCilMemberRefStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmCilMemberRef* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmCilMemberRef* isSgAsmCilMemberRef ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmCilMemberRef>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilMemberRef, uint32_t,&SgAsmCilMemberRef::p_Class>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilMemberRef, uint32_t,&SgAsmCilMemberRef::p_Name>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilMemberRef, uint32_t,&SgAsmCilMemberRef::p_Signature>;
...
// postdeclarations for SgAsmCilMemberRef

/* #line 554 "/workspace/generated/src/frontend/SageIII//SgAsmCilMemberRef.h" */
...
/* #line 561 "/workspace/generated/src/frontend/SageIII//SgAsmCilMemberRef.h" */

#endif // ROSE_SgAsmCilMemberRef_H
