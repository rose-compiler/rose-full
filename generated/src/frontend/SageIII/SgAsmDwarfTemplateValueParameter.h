...
#ifndef ROSE_SgAsmDwarfTemplateValueParameter_H
#define ROSE_SgAsmDwarfTemplateValueParameter_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmDwarfTemplateValueParameter

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfTemplateValueParameter.h" */
...
// Class Definition for SgAsmDwarfTemplateValueParameter
class ROSE_DLL_API SgAsmDwarfTemplateValueParameter  : public SgAsmDwarfConstruct
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfTemplateValueParameter.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 25125 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmDwarfTemplateValueParameter;
          enum { static_variant = V_SgAsmDwarfTemplateValueParameter };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmDwarfTemplateValueParameter* isSgAsmDwarfTemplateValueParameter(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmDwarfTemplateValueParameter* isSgAsmDwarfTemplateValueParameter( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmDwarfTemplateValueParameter * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmDwarfTemplateValueParameterStorageClass *); // 
          ...
          /// \private
          static SgAsmDwarfTemplateValueParameter * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmDwarfTemplateValueParameter * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmDwarfTemplateValueParameter::operator delete (pointer,sizeof(SgAsmDwarfTemplateValueParameter));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmDwarfTemplateValueParameter* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmDwarfTemplateValueParameter* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmDwarfTemplateValueParameter* sgnode);
     ...
     public:
       ...
       */
       // SgAsmDwarfTemplateValueParameter( SgAsmDwarfTemplateValueParameterStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmDwarfTemplateValueParameterStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmDwarfTemplateValueParameter( const SgAsmDwarfTemplateValueParameterStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmDwarfTemplateValueParameter* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmDwarfTemplateValueParameter* isSgAsmDwarfTemplateValueParameter ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmDwarfTemplateValueParameter>;
...
// postdeclarations for SgAsmDwarfTemplateValueParameter

/* #line 502 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfTemplateValueParameter.h" */
...
/* #line 509 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfTemplateValueParameter.h" */

#endif // ROSE_SgAsmDwarfTemplateValueParameter_H
