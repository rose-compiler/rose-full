...
#ifndef ROSE_SgAsmCilExceptionData_H
#define ROSE_SgAsmCilExceptionData_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmCilExceptionData

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmCilExceptionData.h" */
...
// Class Definition for SgAsmCilExceptionData
class ROSE_DLL_API SgAsmCilExceptionData  : public SgAsmCilNode
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmCilExceptionData.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 39225 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmCilExceptionData;
          enum { static_variant = V_SgAsmCilExceptionData };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmCilExceptionData* isSgAsmCilExceptionData(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmCilExceptionData* isSgAsmCilExceptionData( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmCilExceptionData * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmCilExceptionDataStorageClass *); // 
          ...
          /// \private
          static SgAsmCilExceptionData * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmCilExceptionData * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmCilExceptionData::operator delete (pointer,sizeof(SgAsmCilExceptionData));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmCilExceptionData* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmCilExceptionData* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmCilExceptionData* sgnode);
     ...
     public:
       ...
       */
       // SgAsmCilExceptionData( SgAsmCilExceptionDataStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmCilExceptionDataStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmCilExceptionData( const SgAsmCilExceptionDataStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmCilExceptionData* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmCilExceptionData* isSgAsmCilExceptionData ( SgNode* s );
...
// End of memberFunctionString
// Start of memberFunctionString
std::uint32_t p_tryOffset;
          
// End of memberFunctionString
// Start of memberFunctionString
std::uint32_t p_tryLength;
          
// End of memberFunctionString
// Start of memberFunctionString
std::uint32_t p_handlerOffset;
          
// End of memberFunctionString
// Start of memberFunctionString
std::uint32_t p_handlerLength;
          
// End of memberFunctionString
// Start of memberFunctionString
std::uint32_t p_classTokenOrFilterOffset;
          
// End of memberFunctionString
// Start of memberFunctionString
bool p_standardConforming;
          
// End of memberFunctionString

    friend struct Rose::Traits::generated::describe_node_t<SgAsmCilExceptionData>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilExceptionData, std::uint32_t,&SgAsmCilExceptionData::p_flags>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilExceptionData, std::uint32_t,&SgAsmCilExceptionData::p_tryOffset>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilExceptionData, std::uint32_t,&SgAsmCilExceptionData::p_tryLength>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilExceptionData, std::uint32_t,&SgAsmCilExceptionData::p_handlerOffset>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilExceptionData, std::uint32_t,&SgAsmCilExceptionData::p_handlerLength>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilExceptionData, std::uint32_t,&SgAsmCilExceptionData::p_classTokenOrFilterOffset>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilExceptionData, bool,&SgAsmCilExceptionData::p_standardConforming>;
...
// postdeclarations for SgAsmCilExceptionData

/* #line 596 "/workspace/generated/src/frontend/SageIII//SgAsmCilExceptionData.h" */
...
/* #line 603 "/workspace/generated/src/frontend/SageIII//SgAsmCilExceptionData.h" */

#endif // ROSE_SgAsmCilExceptionData_H
