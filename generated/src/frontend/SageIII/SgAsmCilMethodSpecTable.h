...
#ifndef ROSE_SgAsmCilMethodSpecTable_H
#define ROSE_SgAsmCilMethodSpecTable_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmCilMethodSpecTable

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmCilMethodSpecTable.h" */
...
// Class Definition for SgAsmCilMethodSpecTable
class ROSE_DLL_API SgAsmCilMethodSpecTable  : public SgAsmCilMetadata
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmCilMethodSpecTable.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 34734 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmCilMethodSpecTable;
          enum { static_variant = V_SgAsmCilMethodSpecTable };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmCilMethodSpecTable* isSgAsmCilMethodSpecTable(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmCilMethodSpecTable* isSgAsmCilMethodSpecTable( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmCilMethodSpecTable * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmCilMethodSpecTableStorageClass *); // 
          ...
          /// \private
          static SgAsmCilMethodSpecTable * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmCilMethodSpecTable * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmCilMethodSpecTable::operator delete (pointer,sizeof(SgAsmCilMethodSpecTable));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmCilMethodSpecTable* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmCilMethodSpecTable* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmCilMethodSpecTable* sgnode);
     ...
     public:
       ...
       */
       // SgAsmCilMethodSpecTable( SgAsmCilMethodSpecTableStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmCilMethodSpecTableStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmCilMethodSpecTable( const SgAsmCilMethodSpecTableStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmCilMethodSpecTable* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmCilMethodSpecTable* isSgAsmCilMethodSpecTable ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmCilMethodSpecTable>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilMethodSpecTable, std::vector<SgAsmCilMethodSpec*>,&SgAsmCilMethodSpecTable::p_elements>;
...
// postdeclarations for SgAsmCilMethodSpecTable

/* #line 508 "/workspace/generated/src/frontend/SageIII//SgAsmCilMethodSpecTable.h" */
...
/* #line 515 "/workspace/generated/src/frontend/SageIII//SgAsmCilMethodSpecTable.h" */

#endif // ROSE_SgAsmCilMethodSpecTable_H
