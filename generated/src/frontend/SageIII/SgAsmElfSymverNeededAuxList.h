...
#ifndef ROSE_SgAsmElfSymverNeededAuxList_H
#define ROSE_SgAsmElfSymverNeededAuxList_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmElfSymverNeededAuxList

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmElfSymverNeededAuxList.h" */
/* #line 18663 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// Class Definition for SgAsmElfSymverNeededAuxList
class ROSE_DLL_API SgAsmElfSymverNeededAuxList  : public SgAsmExecutableFileFormat
   {
     public:


/* #line 42 "/workspace/generated/src/frontend/SageIII//SgAsmElfSymverNeededAuxList.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 18682 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmElfSymverNeededAuxList;
          enum { static_variant = V_SgAsmElfSymverNeededAuxList };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmElfSymverNeededAuxList* isSgAsmElfSymverNeededAuxList(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmElfSymverNeededAuxList* isSgAsmElfSymverNeededAuxList( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmElfSymverNeededAuxList * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmElfSymverNeededAuxListStorageClass *); // 
          ...
          /// \private
          static SgAsmElfSymverNeededAuxList * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmElfSymverNeededAuxList * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmElfSymverNeededAuxList::operator delete (pointer,sizeof(SgAsmElfSymverNeededAuxList));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmElfSymverNeededAuxList* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmElfSymverNeededAuxList* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmElfSymverNeededAuxList* sgnode);
     ...
     public:
       ...
       */
       // SgAsmElfSymverNeededAuxList( SgAsmElfSymverNeededAuxListStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmElfSymverNeededAuxListStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmElfSymverNeededAuxList( const SgAsmElfSymverNeededAuxListStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmElfSymverNeededAuxList* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmElfSymverNeededAuxList* isSgAsmElfSymverNeededAuxList ( SgNode* s );
...
// End of memberFunctionString
    ...
    protected:
// Start of memberFunctionString
SgAsmElfSymverNeededAuxPtrList p_entries;
          
// End of memberFunctionString

    friend struct Rose::Traits::generated::describe_node_t<SgAsmElfSymverNeededAuxList>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmElfSymverNeededAuxList, SgAsmElfSymverNeededAuxPtrList,&SgAsmElfSymverNeededAuxList::p_entries>;
...
// postdeclarations for SgAsmElfSymverNeededAuxList

/* #line 516 "/workspace/generated/src/frontend/SageIII//SgAsmElfSymverNeededAuxList.h" */
...
/* #line 523 "/workspace/generated/src/frontend/SageIII//SgAsmElfSymverNeededAuxList.h" */

#endif // ROSE_SgAsmElfSymverNeededAuxList_H
