...
#ifndef ROSE_SgAsmElfSymverNeededEntryList_H
#define ROSE_SgAsmElfSymverNeededEntryList_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmElfSymverNeededEntryList

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmElfSymverNeededEntryList.h" */
/* #line 18422 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// Class Definition for SgAsmElfSymverNeededEntryList
class ROSE_DLL_API SgAsmElfSymverNeededEntryList  : public SgAsmExecutableFileFormat
   {
     public:


/* #line 42 "/workspace/generated/src/frontend/SageIII//SgAsmElfSymverNeededEntryList.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 18441 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmElfSymverNeededEntryList;
          enum { static_variant = V_SgAsmElfSymverNeededEntryList };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmElfSymverNeededEntryList* isSgAsmElfSymverNeededEntryList(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmElfSymverNeededEntryList* isSgAsmElfSymverNeededEntryList( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmElfSymverNeededEntryList * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmElfSymverNeededEntryListStorageClass *); // 
          ...
          /// \private
          static SgAsmElfSymverNeededEntryList * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmElfSymverNeededEntryList * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmElfSymverNeededEntryList::operator delete (pointer,sizeof(SgAsmElfSymverNeededEntryList));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmElfSymverNeededEntryList* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmElfSymverNeededEntryList* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmElfSymverNeededEntryList* sgnode);
     ...
     public:
       ...
       */
       // SgAsmElfSymverNeededEntryList( SgAsmElfSymverNeededEntryListStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmElfSymverNeededEntryListStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmElfSymverNeededEntryList( const SgAsmElfSymverNeededEntryListStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmElfSymverNeededEntryList* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmElfSymverNeededEntryList* isSgAsmElfSymverNeededEntryList ( SgNode* s );
...
// End of memberFunctionString
    ...
    protected:
// Start of memberFunctionString
SgAsmElfSymverNeededEntryPtrList p_entries;
          
// End of memberFunctionString

    friend struct Rose::Traits::generated::describe_node_t<SgAsmElfSymverNeededEntryList>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmElfSymverNeededEntryList, SgAsmElfSymverNeededEntryPtrList,&SgAsmElfSymverNeededEntryList::p_entries>;
...
// postdeclarations for SgAsmElfSymverNeededEntryList

/* #line 516 "/workspace/generated/src/frontend/SageIII//SgAsmElfSymverNeededEntryList.h" */
...
/* #line 523 "/workspace/generated/src/frontend/SageIII//SgAsmElfSymverNeededEntryList.h" */

#endif // ROSE_SgAsmElfSymverNeededEntryList_H
