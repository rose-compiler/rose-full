...
#ifndef ROSE_SgAsmElfRelocEntry_H
#define ROSE_SgAsmElfRelocEntry_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmElfRelocEntry

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmElfRelocEntry.h" */
/* #line 21672 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// Class Definition for SgAsmElfRelocEntry
class ROSE_DLL_API SgAsmElfRelocEntry  : public SgAsmExecutableFileFormat
   {
     public:


/* #line 44 "/workspace/generated/src/frontend/SageIII//SgAsmElfRelocEntry.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 21714 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmElfRelocEntry;
          enum { static_variant = V_SgAsmElfRelocEntry };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmElfRelocEntry* isSgAsmElfRelocEntry(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmElfRelocEntry* isSgAsmElfRelocEntry( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmElfRelocEntry * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmElfRelocEntryStorageClass *); // 
          ...
          /// \private
          static SgAsmElfRelocEntry * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmElfRelocEntry * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmElfRelocEntry::operator delete (pointer,sizeof(SgAsmElfRelocEntry));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmElfRelocEntry* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmElfRelocEntry* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmElfRelocEntry* sgnode);
     ...
     public:
       ...
       */
       // SgAsmElfRelocEntry( SgAsmElfRelocEntryStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmElfRelocEntryStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmElfRelocEntry( const SgAsmElfRelocEntryStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmElfRelocEntry* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmElfRelocEntry* isSgAsmElfRelocEntry ( SgNode* s );
...
// End of memberFunctionString
    ...
    protected:
// Start of memberFunctionString
Rose::BinaryAnalysis::Address p_r_offset;
          
// End of memberFunctionString
// Start of memberFunctionString
Rose::BinaryAnalysis::Address p_r_addend;
...
// End of memberFunctionString
// Start of memberFunctionString
SgAsmElfRelocEntry::RelocType p_type;
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmElfRelocEntry>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmElfRelocEntry, Rose::BinaryAnalysis::Address,&SgAsmElfRelocEntry::p_r_offset>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmElfRelocEntry, Rose::BinaryAnalysis::Address,&SgAsmElfRelocEntry::p_r_addend>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmElfRelocEntry, unsigned long,&SgAsmElfRelocEntry::p_sym>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmElfRelocEntry, SgAsmElfRelocEntry::RelocType,&SgAsmElfRelocEntry::p_type>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmElfRelocEntry, SgUnsignedCharList,&SgAsmElfRelocEntry::p_extra>;
...
// postdeclarations for SgAsmElfRelocEntry

/* #line 747 "/workspace/generated/src/frontend/SageIII//SgAsmElfRelocEntry.h" */
...
/* #line 754 "/workspace/generated/src/frontend/SageIII//SgAsmElfRelocEntry.h" */

#endif // ROSE_SgAsmElfRelocEntry_H
