...
#ifndef ROSE_SgAsmCilAssemblyRefTable_H
#define ROSE_SgAsmCilAssemblyRefTable_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmCilAssemblyRefTable

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmCilAssemblyRefTable.h" */
...
// Class Definition for SgAsmCilAssemblyRefTable
class ROSE_DLL_API SgAsmCilAssemblyRefTable  : public SgAsmCilMetadata
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmCilAssemblyRefTable.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 40698 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmCilAssemblyRefTable;
          enum { static_variant = V_SgAsmCilAssemblyRefTable };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmCilAssemblyRefTable* isSgAsmCilAssemblyRefTable(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmCilAssemblyRefTable* isSgAsmCilAssemblyRefTable( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmCilAssemblyRefTable * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmCilAssemblyRefTableStorageClass *); // 
          ...
          /// \private
          static SgAsmCilAssemblyRefTable * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmCilAssemblyRefTable * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmCilAssemblyRefTable::operator delete (pointer,sizeof(SgAsmCilAssemblyRefTable));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmCilAssemblyRefTable* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmCilAssemblyRefTable* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmCilAssemblyRefTable* sgnode);
     ...
     public:
       ...
       */
       // SgAsmCilAssemblyRefTable( SgAsmCilAssemblyRefTableStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmCilAssemblyRefTableStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmCilAssemblyRefTable( const SgAsmCilAssemblyRefTableStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmCilAssemblyRefTable* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmCilAssemblyRefTable* isSgAsmCilAssemblyRefTable ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmCilAssemblyRefTable>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilAssemblyRefTable, std::vector<SgAsmCilAssemblyRef*>,&SgAsmCilAssemblyRefTable::p_elements>;
...
// postdeclarations for SgAsmCilAssemblyRefTable

/* #line 508 "/workspace/generated/src/frontend/SageIII//SgAsmCilAssemblyRefTable.h" */
...
/* #line 515 "/workspace/generated/src/frontend/SageIII//SgAsmCilAssemblyRefTable.h" */

#endif // ROSE_SgAsmCilAssemblyRefTable_H
