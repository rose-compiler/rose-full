...
#ifndef ROSE_SgAsmDwarfMacro_H
#define ROSE_SgAsmDwarfMacro_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmDwarfMacro

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfMacro.h" */
...
// Class Definition for SgAsmDwarfMacro
class ROSE_DLL_API SgAsmDwarfMacro  : public SgAsmDwarfInformation
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfMacro.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 26560 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmDwarfMacro;
          enum { static_variant = V_SgAsmDwarfMacro };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmDwarfMacro* isSgAsmDwarfMacro(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmDwarfMacro* isSgAsmDwarfMacro( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmDwarfMacro * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmDwarfMacroStorageClass *); // 
          ...
          /// \private
          static SgAsmDwarfMacro * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmDwarfMacro * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmDwarfMacro::operator delete (pointer,sizeof(SgAsmDwarfMacro));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmDwarfMacro* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmDwarfMacro* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmDwarfMacro* sgnode);
     ...
     public:
       ...
       */
       // SgAsmDwarfMacro( SgAsmDwarfMacroStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmDwarfMacroStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmDwarfMacro( const SgAsmDwarfMacroStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmDwarfMacro* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmDwarfMacro* isSgAsmDwarfMacro ( SgNode* s );
...
// End of memberFunctionString
    ...
    protected:
// Start of memberFunctionString
std::string p_macro_string;
          
// End of memberFunctionString

    friend struct Rose::Traits::generated::describe_node_t<SgAsmDwarfMacro>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmDwarfMacro, std::string,&SgAsmDwarfMacro::p_macro_string>;
...
// postdeclarations for SgAsmDwarfMacro

/* #line 507 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfMacro.h" */
...
/* #line 514 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfMacro.h" */

#endif // ROSE_SgAsmDwarfMacro_H
