...
#ifndef ROSE_SgAsmElfSymverNeededSection_H
#define ROSE_SgAsmElfSymverNeededSection_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmElfSymverNeededSection

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmElfSymverNeededSection.h" */
/* #line 18300 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// Class Definition for SgAsmElfSymverNeededSection
class ROSE_DLL_API SgAsmElfSymverNeededSection  : public SgAsmElfSection
   {
     public:


/* #line 46 "/workspace/generated/src/frontend/SageIII//SgAsmElfSymverNeededSection.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 18324 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmElfSymverNeededSection;
          enum { static_variant = V_SgAsmElfSymverNeededSection };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmElfSymverNeededSection* isSgAsmElfSymverNeededSection(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmElfSymverNeededSection* isSgAsmElfSymverNeededSection( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmElfSymverNeededSection * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmElfSymverNeededSectionStorageClass *); // 
          ...
          /// \private
          static SgAsmElfSymverNeededSection * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmElfSymverNeededSection * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmElfSymverNeededSection::operator delete (pointer,sizeof(SgAsmElfSymverNeededSection));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmElfSymverNeededSection* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmElfSymverNeededSection* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmElfSymverNeededSection* sgnode);
     ...
     public:
       ...
       */
       // SgAsmElfSymverNeededSection( SgAsmElfSymverNeededSectionStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmElfSymverNeededSectionStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmElfSymverNeededSection( const SgAsmElfSymverNeededSectionStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmElfSymverNeededSection* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmElfSymverNeededSection* isSgAsmElfSymverNeededSection ( SgNode* s );
...
// End of memberFunctionString
    ...
    protected:
// Start of memberFunctionString
SgAsmElfSymverNeededEntryList* p_entries;
          
// End of memberFunctionString

    friend struct Rose::Traits::generated::describe_node_t<SgAsmElfSymverNeededSection>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmElfSymverNeededSection, SgAsmElfSymverNeededEntryList*,&SgAsmElfSymverNeededSection::p_entries>;
...
// postdeclarations for SgAsmElfSymverNeededSection

/* #line 559 "/workspace/generated/src/frontend/SageIII//SgAsmElfSymverNeededSection.h" */
...
/* #line 566 "/workspace/generated/src/frontend/SageIII//SgAsmElfSymverNeededSection.h" */

#endif // ROSE_SgAsmElfSymverNeededSection_H
