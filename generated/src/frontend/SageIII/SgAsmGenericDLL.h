...
#ifndef ROSE_SgAsmGenericDLL_H
#define ROSE_SgAsmGenericDLL_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmGenericDLL

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmGenericDLL.h" */
/* #line 16845 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// Class Definition for SgAsmGenericDLL
class ROSE_DLL_API SgAsmGenericDLL  : public SgAsmExecutableFileFormat
   {
     public:


/* #line 46 "/workspace/generated/src/frontend/SageIII//SgAsmGenericDLL.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 16871 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmGenericDLL;
          enum { static_variant = V_SgAsmGenericDLL };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmGenericDLL* isSgAsmGenericDLL(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmGenericDLL* isSgAsmGenericDLL( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmGenericDLL * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmGenericDLLStorageClass *); // 
          ...
          /// \private
          static SgAsmGenericDLL * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmGenericDLL * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmGenericDLL::operator delete (pointer,sizeof(SgAsmGenericDLL));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmGenericDLL* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmGenericDLL* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmGenericDLL* sgnode);
     ...
     public:
       ...
       */
       // SgAsmGenericDLL( SgAsmGenericDLLStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmGenericDLLStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmGenericDLL( const SgAsmGenericDLLStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmGenericDLL* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmGenericDLL* isSgAsmGenericDLL ( SgNode* s );
...
// End of memberFunctionString
// Start of memberFunctionString
SgStringList p_symbols;
          
// End of memberFunctionString

    friend struct Rose::Traits::generated::describe_node_t<SgAsmGenericDLL>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmGenericDLL, SgAsmGenericString*,&SgAsmGenericDLL::p_name>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmGenericDLL, SgStringList,&SgAsmGenericDLL::p_symbols>;
...
// postdeclarations for SgAsmGenericDLL

/* #line 547 "/workspace/generated/src/frontend/SageIII//SgAsmGenericDLL.h" */
...
/* #line 554 "/workspace/generated/src/frontend/SageIII//SgAsmGenericDLL.h" */

#endif // ROSE_SgAsmGenericDLL_H
