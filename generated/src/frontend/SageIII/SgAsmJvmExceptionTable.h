...
#ifndef ROSE_SgAsmJvmExceptionTable_H
#define ROSE_SgAsmJvmExceptionTable_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmJvmExceptionTable

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmJvmExceptionTable.h" */
/* #line 13110 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// Class Definition for SgAsmJvmExceptionTable
class ROSE_DLL_API SgAsmJvmExceptionTable  : public SgAsmJvmNode
   {
     public:


/* #line 42 "/workspace/generated/src/frontend/SageIII//SgAsmJvmExceptionTable.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 13129 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmJvmExceptionTable;
          enum { static_variant = V_SgAsmJvmExceptionTable };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmJvmExceptionTable* isSgAsmJvmExceptionTable(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmJvmExceptionTable* isSgAsmJvmExceptionTable( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmJvmExceptionTable * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmJvmExceptionTableStorageClass *); // 
          ...
          /// \private
          static SgAsmJvmExceptionTable * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmJvmExceptionTable * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmJvmExceptionTable::operator delete (pointer,sizeof(SgAsmJvmExceptionTable));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmJvmExceptionTable* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmJvmExceptionTable* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmJvmExceptionTable* sgnode);
     ...
     public:
       ...
       */
       // SgAsmJvmExceptionTable( SgAsmJvmExceptionTableStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmJvmExceptionTableStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmJvmExceptionTable( const SgAsmJvmExceptionTableStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmJvmExceptionTable* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmJvmExceptionTable* isSgAsmJvmExceptionTable ( SgNode* s );
...
// End of memberFunctionString
    ...
    protected:
// Start of memberFunctionString
SgAsmJvmExceptionHandlerPtrList p_handlers;
          
// End of memberFunctionString

    friend struct Rose::Traits::generated::describe_node_t<SgAsmJvmExceptionTable>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmJvmExceptionTable, SgAsmJvmExceptionHandlerPtrList,&SgAsmJvmExceptionTable::p_handlers>;
...
// postdeclarations for SgAsmJvmExceptionTable

/* #line 532 "/workspace/generated/src/frontend/SageIII//SgAsmJvmExceptionTable.h" */
...
/* #line 539 "/workspace/generated/src/frontend/SageIII//SgAsmJvmExceptionTable.h" */

#endif // ROSE_SgAsmJvmExceptionTable_H
