...
#ifndef ROSE_SgAsmJvmStackMapFrame_H
#define ROSE_SgAsmJvmStackMapFrame_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmJvmStackMapFrame

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmJvmStackMapFrame.h" */
/* #line 9628 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// Class Definition for SgAsmJvmStackMapFrame
class ROSE_DLL_API SgAsmJvmStackMapFrame  : public SgAsmJvmNode
   {
     public:


/* #line 42 "/workspace/generated/src/frontend/SageIII//SgAsmJvmStackMapFrame.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 9664 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmJvmStackMapFrame;
          enum { static_variant = V_SgAsmJvmStackMapFrame };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmJvmStackMapFrame* isSgAsmJvmStackMapFrame(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmJvmStackMapFrame* isSgAsmJvmStackMapFrame( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmJvmStackMapFrame * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmJvmStackMapFrameStorageClass *); // 
          ...
          /// \private
          static SgAsmJvmStackMapFrame * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmJvmStackMapFrame * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmJvmStackMapFrame::operator delete (pointer,sizeof(SgAsmJvmStackMapFrame));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmJvmStackMapFrame* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmJvmStackMapFrame* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmJvmStackMapFrame* sgnode);
     ...
     public:
       ...
       */
       // SgAsmJvmStackMapFrame( SgAsmJvmStackMapFrameStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmJvmStackMapFrameStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmJvmStackMapFrame( const SgAsmJvmStackMapFrameStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmJvmStackMapFrame* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmJvmStackMapFrame* isSgAsmJvmStackMapFrame ( SgNode* s );
...
// End of memberFunctionString
    ...
    protected:
// Start of memberFunctionString
SgAsmJvmStackMapVerificationTypePtrList p_stack;
          
// End of memberFunctionString
// Start of memberFunctionString
SgAsmJvmStackMapVerificationTypePtrList p_locals;
          
// End of memberFunctionString
// Start of memberFunctionString
uint8_t p_frame_type;
          
// End of memberFunctionString
// Start of memberFunctionString
uint16_t p_offset_delta;
          
// End of memberFunctionString

    friend struct Rose::Traits::generated::describe_node_t<SgAsmJvmStackMapFrame>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmJvmStackMapFrame, SgAsmJvmStackMapVerificationTypePtrList,&SgAsmJvmStackMapFrame::p_stack>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmJvmStackMapFrame, SgAsmJvmStackMapVerificationTypePtrList,&SgAsmJvmStackMapFrame::p_locals>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmJvmStackMapFrame, uint8_t,&SgAsmJvmStackMapFrame::p_frame_type>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmJvmStackMapFrame, uint16_t,&SgAsmJvmStackMapFrame::p_offset_delta>;
...
// postdeclarations for SgAsmJvmStackMapFrame

/* #line 638 "/workspace/generated/src/frontend/SageIII//SgAsmJvmStackMapFrame.h" */
...
/* #line 645 "/workspace/generated/src/frontend/SageIII//SgAsmJvmStackMapFrame.h" */

#endif // ROSE_SgAsmJvmStackMapFrame_H
