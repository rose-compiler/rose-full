...
#ifndef ROSE_SgAsmCilExportedTypeTable_H
#define ROSE_SgAsmCilExportedTypeTable_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmCilExportedTypeTable

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmCilExportedTypeTable.h" */
...
// Class Definition for SgAsmCilExportedTypeTable
class ROSE_DLL_API SgAsmCilExportedTypeTable  : public SgAsmCilMetadata
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmCilExportedTypeTable.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 38974 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmCilExportedTypeTable;
          enum { static_variant = V_SgAsmCilExportedTypeTable };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmCilExportedTypeTable* isSgAsmCilExportedTypeTable(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmCilExportedTypeTable* isSgAsmCilExportedTypeTable( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmCilExportedTypeTable * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmCilExportedTypeTableStorageClass *); // 
          ...
          /// \private
          static SgAsmCilExportedTypeTable * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmCilExportedTypeTable * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmCilExportedTypeTable::operator delete (pointer,sizeof(SgAsmCilExportedTypeTable));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmCilExportedTypeTable* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmCilExportedTypeTable* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmCilExportedTypeTable* sgnode);
     ...
     public:
       ...
       */
       // SgAsmCilExportedTypeTable( SgAsmCilExportedTypeTableStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmCilExportedTypeTableStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmCilExportedTypeTable( const SgAsmCilExportedTypeTableStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmCilExportedTypeTable* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmCilExportedTypeTable* isSgAsmCilExportedTypeTable ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmCilExportedTypeTable>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilExportedTypeTable, std::vector<SgAsmCilExportedType*>,&SgAsmCilExportedTypeTable::p_elements>;
...
// postdeclarations for SgAsmCilExportedTypeTable

/* #line 508 "/workspace/generated/src/frontend/SageIII//SgAsmCilExportedTypeTable.h" */
...
/* #line 515 "/workspace/generated/src/frontend/SageIII//SgAsmCilExportedTypeTable.h" */

#endif // ROSE_SgAsmCilExportedTypeTable_H
