...
#ifndef ROSE_SgAsmDwarfArrayType_H
#define ROSE_SgAsmDwarfArrayType_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmDwarfArrayType

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfArrayType.h" */
/* #line 28802 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// Class Definition for SgAsmDwarfArrayType
class ROSE_DLL_API SgAsmDwarfArrayType  : public SgAsmDwarfConstruct
   {
     public:


/* #line 44 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfArrayType.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 28819 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmDwarfArrayType;
          enum { static_variant = V_SgAsmDwarfArrayType };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmDwarfArrayType* isSgAsmDwarfArrayType(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmDwarfArrayType* isSgAsmDwarfArrayType( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmDwarfArrayType * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmDwarfArrayTypeStorageClass *); // 
          ...
          /// \private
          static SgAsmDwarfArrayType * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmDwarfArrayType * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmDwarfArrayType::operator delete (pointer,sizeof(SgAsmDwarfArrayType));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmDwarfArrayType* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmDwarfArrayType* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmDwarfArrayType* sgnode);
     ...
     public:
       ...
       */
       // SgAsmDwarfArrayType( SgAsmDwarfArrayTypeStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmDwarfArrayTypeStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmDwarfArrayType( const SgAsmDwarfArrayTypeStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmDwarfArrayType* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmDwarfArrayType* isSgAsmDwarfArrayType ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmDwarfArrayType>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmDwarfArrayType, SgAsmDwarfConstructList*,&SgAsmDwarfArrayType::p_body>;
...
// postdeclarations for SgAsmDwarfArrayType

/* #line 520 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfArrayType.h" */
...
/* #line 527 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfArrayType.h" */

#endif // ROSE_SgAsmDwarfArrayType_H
