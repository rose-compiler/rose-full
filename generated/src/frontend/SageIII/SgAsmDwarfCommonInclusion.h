...
#ifndef ROSE_SgAsmDwarfCommonInclusion_H
#define ROSE_SgAsmDwarfCommonInclusion_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmDwarfCommonInclusion

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfCommonInclusion.h" */
...
// Class Definition for SgAsmDwarfCommonInclusion
class ROSE_DLL_API SgAsmDwarfCommonInclusion  : public SgAsmDwarfConstruct
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfCommonInclusion.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 28414 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmDwarfCommonInclusion;
          enum { static_variant = V_SgAsmDwarfCommonInclusion };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmDwarfCommonInclusion* isSgAsmDwarfCommonInclusion(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmDwarfCommonInclusion* isSgAsmDwarfCommonInclusion( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmDwarfCommonInclusion * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmDwarfCommonInclusionStorageClass *); // 
          ...
          /// \private
          static SgAsmDwarfCommonInclusion * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmDwarfCommonInclusion * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmDwarfCommonInclusion::operator delete (pointer,sizeof(SgAsmDwarfCommonInclusion));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmDwarfCommonInclusion* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmDwarfCommonInclusion* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmDwarfCommonInclusion* sgnode);
     ...
     public:
       ...
       */
       // SgAsmDwarfCommonInclusion( SgAsmDwarfCommonInclusionStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmDwarfCommonInclusionStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmDwarfCommonInclusion( const SgAsmDwarfCommonInclusionStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmDwarfCommonInclusion* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmDwarfCommonInclusion* isSgAsmDwarfCommonInclusion ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmDwarfCommonInclusion>;
...
// postdeclarations for SgAsmDwarfCommonInclusion

/* #line 502 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfCommonInclusion.h" */
...
/* #line 509 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfCommonInclusion.h" */

#endif // ROSE_SgAsmDwarfCommonInclusion_H
