...
#ifndef ROSE_SgAsmJvmInnerClasses_H
#define ROSE_SgAsmJvmInnerClasses_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmJvmInnerClasses

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmJvmInnerClasses.h" */
/* #line 12185 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// Class Definition for SgAsmJvmInnerClasses
class ROSE_DLL_API SgAsmJvmInnerClasses  : public SgAsmJvmAttribute
   {
     public:


/* #line 42 "/workspace/generated/src/frontend/SageIII//SgAsmJvmInnerClasses.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 12205 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmJvmInnerClasses;
          enum { static_variant = V_SgAsmJvmInnerClasses };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmJvmInnerClasses* isSgAsmJvmInnerClasses(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmJvmInnerClasses* isSgAsmJvmInnerClasses( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmJvmInnerClasses * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmJvmInnerClassesStorageClass *); // 
          ...
          /// \private
          static SgAsmJvmInnerClasses * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmJvmInnerClasses * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmJvmInnerClasses::operator delete (pointer,sizeof(SgAsmJvmInnerClasses));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmJvmInnerClasses* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmJvmInnerClasses* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmJvmInnerClasses* sgnode);
     ...
     public:
       ...
       */
       // SgAsmJvmInnerClasses( SgAsmJvmInnerClassesStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmJvmInnerClassesStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmJvmInnerClasses( const SgAsmJvmInnerClassesStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmJvmInnerClasses* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmJvmInnerClasses* isSgAsmJvmInnerClasses ( SgNode* s );
...
// End of memberFunctionString
    ...
    protected:
// Start of memberFunctionString
std::vector<SgAsmJvmInnerClasses::Entry*> p_classes;
          
// End of memberFunctionString

    friend struct Rose::Traits::generated::describe_node_t<SgAsmJvmInnerClasses>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmJvmInnerClasses, std::vector<SgAsmJvmInnerClasses::Entry*>,&SgAsmJvmInnerClasses::p_classes>;
...
// postdeclarations for SgAsmJvmInnerClasses

/* #line 559 "/workspace/generated/src/frontend/SageIII//SgAsmJvmInnerClasses.h" */
...
/* #line 566 "/workspace/generated/src/frontend/SageIII//SgAsmJvmInnerClasses.h" */

#endif // ROSE_SgAsmJvmInnerClasses_H
