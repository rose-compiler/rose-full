...
#ifndef ROSE_SgAsmCilEventMap_H
#define ROSE_SgAsmCilEventMap_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmCilEventMap

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmCilEventMap.h" */
...
// Class Definition for SgAsmCilEventMap
class ROSE_DLL_API SgAsmCilEventMap  : public SgAsmCilMetadata
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmCilEventMap.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 39481 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmCilEventMap;
          enum { static_variant = V_SgAsmCilEventMap };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmCilEventMap* isSgAsmCilEventMap(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmCilEventMap* isSgAsmCilEventMap( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmCilEventMap * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmCilEventMapStorageClass *); // 
          ...
          /// \private
          static SgAsmCilEventMap * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmCilEventMap * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmCilEventMap::operator delete (pointer,sizeof(SgAsmCilEventMap));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmCilEventMap* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmCilEventMap* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmCilEventMap* sgnode);
     ...
     public:
       ...
       */
       // SgAsmCilEventMap( SgAsmCilEventMapStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmCilEventMapStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmCilEventMap( const SgAsmCilEventMapStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmCilEventMap* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmCilEventMap* isSgAsmCilEventMap ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmCilEventMap>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilEventMap, uint32_t,&SgAsmCilEventMap::p_Parent>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilEventMap, uint32_t,&SgAsmCilEventMap::p_EventList>;
...
// postdeclarations for SgAsmCilEventMap

/* #line 536 "/workspace/generated/src/frontend/SageIII//SgAsmCilEventMap.h" */
...
/* #line 543 "/workspace/generated/src/frontend/SageIII//SgAsmCilEventMap.h" */

#endif // ROSE_SgAsmCilEventMap_H
