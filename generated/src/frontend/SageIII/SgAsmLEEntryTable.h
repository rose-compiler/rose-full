...
#ifndef ROSE_SgAsmLEEntryTable_H
#define ROSE_SgAsmLEEntryTable_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmLEEntryTable

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmLEEntryTable.h" */
/* #line 9088 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// Class Definition for SgAsmLEEntryTable
class ROSE_DLL_API SgAsmLEEntryTable  : public SgAsmGenericSection
   {
     public:


/* #line 42 "/workspace/generated/src/frontend/SageIII//SgAsmLEEntryTable.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 9109 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmLEEntryTable;
          enum { static_variant = V_SgAsmLEEntryTable };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmLEEntryTable* isSgAsmLEEntryTable(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmLEEntryTable* isSgAsmLEEntryTable( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmLEEntryTable * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmLEEntryTableStorageClass *); // 
          ...
          /// \private
          static SgAsmLEEntryTable * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmLEEntryTable * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmLEEntryTable::operator delete (pointer,sizeof(SgAsmLEEntryTable));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmLEEntryTable* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmLEEntryTable* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmLEEntryTable* sgnode);
     ...
     public:
       ...
       */
       // SgAsmLEEntryTable( SgAsmLEEntryTableStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmLEEntryTableStorageClass;
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmLEEntryTable* isSgAsmLEEntryTable ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmLEEntryTable>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmLEEntryTable, SgSizeTList,&SgAsmLEEntryTable::p_bundle_sizes>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmLEEntryTable, SgAsmLEEntryPointPtrList,&SgAsmLEEntryTable::p_entries>;
...
// postdeclarations for SgAsmLEEntryTable

/* #line 526 "/workspace/generated/src/frontend/SageIII//SgAsmLEEntryTable.h" */
...
/* #line 533 "/workspace/generated/src/frontend/SageIII//SgAsmLEEntryTable.h" */

#endif // ROSE_SgAsmLEEntryTable_H
