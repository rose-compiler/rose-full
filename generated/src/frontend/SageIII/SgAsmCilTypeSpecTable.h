...
#ifndef ROSE_SgAsmCilTypeSpecTable_H
#define ROSE_SgAsmCilTypeSpecTable_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmCilTypeSpecTable

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmCilTypeSpecTable.h" */
...
// Class Definition for SgAsmCilTypeSpecTable
class ROSE_DLL_API SgAsmCilTypeSpecTable  : public SgAsmCilMetadata
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmCilTypeSpecTable.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 32960 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmCilTypeSpecTable;
          enum { static_variant = V_SgAsmCilTypeSpecTable };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmCilTypeSpecTable* isSgAsmCilTypeSpecTable(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmCilTypeSpecTable* isSgAsmCilTypeSpecTable( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmCilTypeSpecTable * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmCilTypeSpecTableStorageClass *); // 
          ...
          /// \private
          static SgAsmCilTypeSpecTable * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmCilTypeSpecTable * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmCilTypeSpecTable::operator delete (pointer,sizeof(SgAsmCilTypeSpecTable));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmCilTypeSpecTable* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmCilTypeSpecTable* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmCilTypeSpecTable* sgnode);
     ...
     public:
       ...
       */
       // SgAsmCilTypeSpecTable( SgAsmCilTypeSpecTableStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmCilTypeSpecTableStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmCilTypeSpecTable( const SgAsmCilTypeSpecTableStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmCilTypeSpecTable* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmCilTypeSpecTable* isSgAsmCilTypeSpecTable ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmCilTypeSpecTable>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilTypeSpecTable, std::vector<SgAsmCilTypeSpec*>,&SgAsmCilTypeSpecTable::p_elements>;
...
// postdeclarations for SgAsmCilTypeSpecTable

/* #line 508 "/workspace/generated/src/frontend/SageIII//SgAsmCilTypeSpecTable.h" */
...
/* #line 515 "/workspace/generated/src/frontend/SageIII//SgAsmCilTypeSpecTable.h" */

#endif // ROSE_SgAsmCilTypeSpecTable_H
