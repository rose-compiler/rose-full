...
#ifndef ROSE_SgAsmJvmSignature_H
#define ROSE_SgAsmJvmSignature_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmJvmSignature

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmJvmSignature.h" */
...
// Class Definition for SgAsmJvmSignature
class ROSE_DLL_API SgAsmJvmSignature  : public SgAsmJvmAttribute
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmJvmSignature.h" */

          virtual SgNode* copy ( SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 9991 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmJvmSignature;
          enum { static_variant = V_SgAsmJvmSignature };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmJvmSignature* isSgAsmJvmSignature(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmJvmSignature* isSgAsmJvmSignature( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmJvmSignature * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmJvmSignatureStorageClass *); // 
          ...
          /// \private
          static SgAsmJvmSignature * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmJvmSignature * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmJvmSignature::operator delete (pointer,sizeof(SgAsmJvmSignature));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmJvmSignature* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmJvmSignature* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmJvmSignature* sgnode);
     ...
     public:
       ...
       */
       // SgAsmJvmSignature( SgAsmJvmSignatureStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmJvmSignatureStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmJvmSignature( const SgAsmJvmSignatureStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmJvmSignature* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 670 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmJvmSignature* isSgAsmJvmSignature ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmJvmSignature>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmJvmSignature, uint16_t,&SgAsmJvmSignature::p_signature_index>;
...
// postdeclarations for SgAsmJvmSignature

/* #line 526 "/workspace/generated/src/frontend/SageIII//SgAsmJvmSignature.h" */
...
/* #line 533 "/workspace/generated/src/frontend/SageIII//SgAsmJvmSignature.h" */

#endif // ROSE_SgAsmJvmSignature_H
