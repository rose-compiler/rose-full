...
#ifndef ROSE_SgAsmCilConstantTable_H
#define ROSE_SgAsmCilConstantTable_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmCilConstantTable

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmCilConstantTable.h" */
...
// Class Definition for SgAsmCilConstantTable
class ROSE_DLL_API SgAsmCilConstantTable  : public SgAsmCilMetadata
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmCilConstantTable.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 40262 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmCilConstantTable;
          enum { static_variant = V_SgAsmCilConstantTable };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmCilConstantTable* isSgAsmCilConstantTable(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmCilConstantTable* isSgAsmCilConstantTable( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmCilConstantTable * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmCilConstantTableStorageClass *); // 
          ...
          /// \private
          static SgAsmCilConstantTable * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmCilConstantTable * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmCilConstantTable::operator delete (pointer,sizeof(SgAsmCilConstantTable));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmCilConstantTable* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmCilConstantTable* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmCilConstantTable* sgnode);
     ...
     public:
       ...
       */
       // SgAsmCilConstantTable( SgAsmCilConstantTableStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmCilConstantTableStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmCilConstantTable( const SgAsmCilConstantTableStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmCilConstantTable* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmCilConstantTable* isSgAsmCilConstantTable ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmCilConstantTable>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilConstantTable, std::vector<SgAsmCilConstant*>,&SgAsmCilConstantTable::p_elements>;
...
// postdeclarations for SgAsmCilConstantTable

/* #line 508 "/workspace/generated/src/frontend/SageIII//SgAsmCilConstantTable.h" */
...
/* #line 515 "/workspace/generated/src/frontend/SageIII//SgAsmCilConstantTable.h" */

#endif // ROSE_SgAsmCilConstantTable_H
