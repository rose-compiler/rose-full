...
#ifndef ROSE_SgAsmLESectionTable_H
#define ROSE_SgAsmLESectionTable_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmLESectionTable

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmLESectionTable.h" */
/* #line 7612 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// Class Definition for SgAsmLESectionTable
class ROSE_DLL_API SgAsmLESectionTable  : public SgAsmGenericSection
   {
     public:


/* #line 42 "/workspace/generated/src/frontend/SageIII//SgAsmLESectionTable.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 7621 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmLESectionTable;
          enum { static_variant = V_SgAsmLESectionTable };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmLESectionTable* isSgAsmLESectionTable(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmLESectionTable* isSgAsmLESectionTable( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmLESectionTable * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmLESectionTableStorageClass *); // 
          ...
          /// \private
          static SgAsmLESectionTable * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmLESectionTable * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmLESectionTable::operator delete (pointer,sizeof(SgAsmLESectionTable));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmLESectionTable* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmLESectionTable* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmLESectionTable* sgnode);
     ...
     public:
       ...
       */
       // SgAsmLESectionTable( SgAsmLESectionTableStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmLESectionTableStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmLESectionTable( const SgAsmLESectionTableStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmLESectionTable* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmLESectionTable* isSgAsmLESectionTable ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmLESectionTable>;
...
// postdeclarations for SgAsmLESectionTable

/* #line 503 "/workspace/generated/src/frontend/SageIII//SgAsmLESectionTable.h" */
...
/* #line 510 "/workspace/generated/src/frontend/SageIII//SgAsmLESectionTable.h" */

#endif // ROSE_SgAsmLESectionTable_H
