...
#ifndef ROSE_SgAsmDwarfVariantPart_H
#define ROSE_SgAsmDwarfVariantPart_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmDwarfVariantPart

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfVariantPart.h" */
...
// Class Definition for SgAsmDwarfVariantPart
class ROSE_DLL_API SgAsmDwarfVariantPart  : public SgAsmDwarfConstruct
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfVariantPart.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 24316 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmDwarfVariantPart;
          enum { static_variant = V_SgAsmDwarfVariantPart };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmDwarfVariantPart* isSgAsmDwarfVariantPart(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmDwarfVariantPart* isSgAsmDwarfVariantPart( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmDwarfVariantPart * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmDwarfVariantPartStorageClass *); // 
          ...
          /// \private
          static SgAsmDwarfVariantPart * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmDwarfVariantPart * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmDwarfVariantPart::operator delete (pointer,sizeof(SgAsmDwarfVariantPart));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmDwarfVariantPart* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmDwarfVariantPart* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmDwarfVariantPart* sgnode);
     ...
     public:
       ...
       */
       // SgAsmDwarfVariantPart( SgAsmDwarfVariantPartStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmDwarfVariantPartStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmDwarfVariantPart( const SgAsmDwarfVariantPartStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmDwarfVariantPart* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmDwarfVariantPart* isSgAsmDwarfVariantPart ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmDwarfVariantPart>;
...
// postdeclarations for SgAsmDwarfVariantPart

/* #line 502 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfVariantPart.h" */
...
/* #line 509 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfVariantPart.h" */

#endif // ROSE_SgAsmDwarfVariantPart_H
