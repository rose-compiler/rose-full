...
#ifndef ROSE_SgAsmDwarfInterfaceType_H
#define ROSE_SgAsmDwarfInterfaceType_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmDwarfInterfaceType

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfInterfaceType.h" */
...
// Class Definition for SgAsmDwarfInterfaceType
class ROSE_DLL_API SgAsmDwarfInterfaceType  : public SgAsmDwarfConstruct
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfInterfaceType.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 26951 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmDwarfInterfaceType;
          enum { static_variant = V_SgAsmDwarfInterfaceType };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmDwarfInterfaceType* isSgAsmDwarfInterfaceType(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmDwarfInterfaceType* isSgAsmDwarfInterfaceType( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmDwarfInterfaceType * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmDwarfInterfaceTypeStorageClass *); // 
          ...
          /// \private
          static SgAsmDwarfInterfaceType * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmDwarfInterfaceType * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmDwarfInterfaceType::operator delete (pointer,sizeof(SgAsmDwarfInterfaceType));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmDwarfInterfaceType* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmDwarfInterfaceType* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmDwarfInterfaceType* sgnode);
     ...
     public:
       ...
       */
       // SgAsmDwarfInterfaceType( SgAsmDwarfInterfaceTypeStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmDwarfInterfaceTypeStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmDwarfInterfaceType( const SgAsmDwarfInterfaceTypeStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmDwarfInterfaceType* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmDwarfInterfaceType* isSgAsmDwarfInterfaceType ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmDwarfInterfaceType>;
...
// postdeclarations for SgAsmDwarfInterfaceType

/* #line 502 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfInterfaceType.h" */
...
/* #line 509 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfInterfaceType.h" */

#endif // ROSE_SgAsmDwarfInterfaceType_H
