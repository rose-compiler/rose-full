...
#ifndef ROSE_SgAsmElfEHFrameEntryCI_H
#define ROSE_SgAsmElfEHFrameEntryCI_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmElfEHFrameEntryCI

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmElfEHFrameEntryCI.h" */
/* #line 23195 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// Class Definition for SgAsmElfEHFrameEntryCI
class ROSE_DLL_API SgAsmElfEHFrameEntryCI  : public SgAsmExecutableFileFormat
   {
     public:


/* #line 48 "/workspace/generated/src/frontend/SageIII//SgAsmElfEHFrameEntryCI.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 23297 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmElfEHFrameEntryCI;
          enum { static_variant = V_SgAsmElfEHFrameEntryCI };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmElfEHFrameEntryCI* isSgAsmElfEHFrameEntryCI(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmElfEHFrameEntryCI* isSgAsmElfEHFrameEntryCI( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmElfEHFrameEntryCI * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmElfEHFrameEntryCIStorageClass *); // 
          ...
          /// \private
          static SgAsmElfEHFrameEntryCI * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmElfEHFrameEntryCI * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmElfEHFrameEntryCI::operator delete (pointer,sizeof(SgAsmElfEHFrameEntryCI));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmElfEHFrameEntryCI* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmElfEHFrameEntryCI* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmElfEHFrameEntryCI* sgnode);
     ...
     public:
       ...
       */
       // SgAsmElfEHFrameEntryCI( SgAsmElfEHFrameEntryCIStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmElfEHFrameEntryCIStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmElfEHFrameEntryCI( const SgAsmElfEHFrameEntryCIStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmElfEHFrameEntryCI* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmElfEHFrameEntryCI* isSgAsmElfEHFrameEntryCI ( SgNode* s );
...
// End of memberFunctionString
// Start of memberFunctionString
std::string p_augmentation_string;
...
// End of memberFunctionString
// Start of memberFunctionString
uint64_t p_code_alignment_factor;
          
// End of memberFunctionString
// Start of memberFunctionString
int64_t p_data_alignment_factor;
          
// End of memberFunctionString
// Start of memberFunctionString
uint64_t p_augmentation_data_length;
...
// End of memberFunctionString
// Start of memberFunctionString
Rose::BinaryAnalysis::Address p_prh_addr;
...
// End of memberFunctionString
// Start of memberFunctionString
SgUnsignedCharList p_instructions;
          
// End of memberFunctionString
// Start of memberFunctionString
SgAsmElfEHFrameEntryFDList* p_fd_entries;
          
// End of memberFunctionString

    friend struct Rose::Traits::generated::describe_node_t<SgAsmElfEHFrameEntryCI>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmElfEHFrameEntryCI, int,&SgAsmElfEHFrameEntryCI::p_version>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmElfEHFrameEntryCI, std::string,&SgAsmElfEHFrameEntryCI::p_augmentation_string>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmElfEHFrameEntryCI, uint64_t,&SgAsmElfEHFrameEntryCI::p_eh_data>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmElfEHFrameEntryCI, uint64_t,&SgAsmElfEHFrameEntryCI::p_code_alignment_factor>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmElfEHFrameEntryCI, int64_t,&SgAsmElfEHFrameEntryCI::p_data_alignment_factor>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmElfEHFrameEntryCI, uint64_t,&SgAsmElfEHFrameEntryCI::p_augmentation_data_length>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmElfEHFrameEntryCI, int,&SgAsmElfEHFrameEntryCI::p_lsda_encoding>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmElfEHFrameEntryCI, int,&SgAsmElfEHFrameEntryCI::p_prh_encoding>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmElfEHFrameEntryCI, unsigned,&SgAsmElfEHFrameEntryCI::p_prh_arg>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmElfEHFrameEntryCI, Rose::BinaryAnalysis::Address,&SgAsmElfEHFrameEntryCI::p_prh_addr>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmElfEHFrameEntryCI, int,&SgAsmElfEHFrameEntryCI::p_addr_encoding>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmElfEHFrameEntryCI, bool,&SgAsmElfEHFrameEntryCI::p_sig_frame>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmElfEHFrameEntryCI, SgUnsignedCharList,&SgAsmElfEHFrameEntryCI::p_instructions>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmElfEHFrameEntryCI, SgAsmElfEHFrameEntryFDList*,&SgAsmElfEHFrameEntryCI::p_fd_entries>;
...
// postdeclarations for SgAsmElfEHFrameEntryCI

/* #line 757 "/workspace/generated/src/frontend/SageIII//SgAsmElfEHFrameEntryCI.h" */
...
/* #line 764 "/workspace/generated/src/frontend/SageIII//SgAsmElfEHFrameEntryCI.h" */

#endif // ROSE_SgAsmElfEHFrameEntryCI_H
