...
#ifndef ROSE_SgAsmCilFieldMarshalTable_H
#define ROSE_SgAsmCilFieldMarshalTable_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmCilFieldMarshalTable

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmCilFieldMarshalTable.h" */
...
// Class Definition for SgAsmCilFieldMarshalTable
class ROSE_DLL_API SgAsmCilFieldMarshalTable  : public SgAsmCilMetadata
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmCilFieldMarshalTable.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 38518 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmCilFieldMarshalTable;
          enum { static_variant = V_SgAsmCilFieldMarshalTable };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmCilFieldMarshalTable* isSgAsmCilFieldMarshalTable(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmCilFieldMarshalTable* isSgAsmCilFieldMarshalTable( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmCilFieldMarshalTable * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmCilFieldMarshalTableStorageClass *); // 
          ...
          /// \private
          static SgAsmCilFieldMarshalTable * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmCilFieldMarshalTable * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmCilFieldMarshalTable::operator delete (pointer,sizeof(SgAsmCilFieldMarshalTable));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmCilFieldMarshalTable* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmCilFieldMarshalTable* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmCilFieldMarshalTable* sgnode);
     ...
     public:
       ...
       */
       // SgAsmCilFieldMarshalTable( SgAsmCilFieldMarshalTableStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmCilFieldMarshalTableStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmCilFieldMarshalTable( const SgAsmCilFieldMarshalTableStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmCilFieldMarshalTable* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmCilFieldMarshalTable* isSgAsmCilFieldMarshalTable ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmCilFieldMarshalTable>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilFieldMarshalTable, std::vector<SgAsmCilFieldMarshal*>,&SgAsmCilFieldMarshalTable::p_elements>;
...
// postdeclarations for SgAsmCilFieldMarshalTable

/* #line 508 "/workspace/generated/src/frontend/SageIII//SgAsmCilFieldMarshalTable.h" */
...
/* #line 515 "/workspace/generated/src/frontend/SageIII//SgAsmCilFieldMarshalTable.h" */

#endif // ROSE_SgAsmCilFieldMarshalTable_H
