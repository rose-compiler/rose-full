...
#ifndef ROSE_SgAsmElfNoteEntryList_H
#define ROSE_SgAsmElfNoteEntryList_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmElfNoteEntryList

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmElfNoteEntryList.h" */
/* #line 22068 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// Class Definition for SgAsmElfNoteEntryList
class ROSE_DLL_API SgAsmElfNoteEntryList  : public SgAsmExecutableFileFormat
   {
     public:


/* #line 42 "/workspace/generated/src/frontend/SageIII//SgAsmElfNoteEntryList.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 22087 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmElfNoteEntryList;
          enum { static_variant = V_SgAsmElfNoteEntryList };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmElfNoteEntryList* isSgAsmElfNoteEntryList(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmElfNoteEntryList* isSgAsmElfNoteEntryList( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmElfNoteEntryList * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmElfNoteEntryListStorageClass *); // 
          ...
          /// \private
          static SgAsmElfNoteEntryList * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmElfNoteEntryList * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmElfNoteEntryList::operator delete (pointer,sizeof(SgAsmElfNoteEntryList));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmElfNoteEntryList* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmElfNoteEntryList* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmElfNoteEntryList* sgnode);
     ...
     public:
       ...
       */
       // SgAsmElfNoteEntryList( SgAsmElfNoteEntryListStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmElfNoteEntryListStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmElfNoteEntryList( const SgAsmElfNoteEntryListStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmElfNoteEntryList* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmElfNoteEntryList* isSgAsmElfNoteEntryList ( SgNode* s );
...
// End of memberFunctionString
    ...
    protected:
// Start of memberFunctionString
SgAsmElfNoteEntryPtrList p_entries;
          
// End of memberFunctionString

    friend struct Rose::Traits::generated::describe_node_t<SgAsmElfNoteEntryList>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmElfNoteEntryList, SgAsmElfNoteEntryPtrList,&SgAsmElfNoteEntryList::p_entries>;
...
// postdeclarations for SgAsmElfNoteEntryList

/* #line 516 "/workspace/generated/src/frontend/SageIII//SgAsmElfNoteEntryList.h" */
...
/* #line 523 "/workspace/generated/src/frontend/SageIII//SgAsmElfNoteEntryList.h" */

#endif // ROSE_SgAsmElfNoteEntryList_H
