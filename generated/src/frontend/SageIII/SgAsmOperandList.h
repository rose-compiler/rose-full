...
#ifndef ROSE_SgAsmOperandList_H
#define ROSE_SgAsmOperandList_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmOperandList

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmOperandList.h" */
/* #line 5421 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
class ROSE_DLL_API SgAsmOperandList  : public SgAsmNode
   {
     public:


/* #line 42 "/workspace/generated/src/frontend/SageIII//SgAsmOperandList.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 5437 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmOperandList* isSgAsmOperandList(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmOperandList* isSgAsmOperandList( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmOperandList * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmOperandListStorageClass *); // 
          ...
          /// \private
          static SgAsmOperandList * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmOperandList * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmOperandList::operator delete (pointer,sizeof(SgAsmOperandList));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmOperandList* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmOperandList* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmOperandList* sgnode);
     ...
     public:
       ...
       */
       // SgAsmOperandList( SgAsmOperandListStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmOperandListStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmOperandList( const SgAsmOperandListStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmOperandList* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmOperandList* isSgAsmOperandList ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmOperandList>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmOperandList, SgAsmExpressionPtrList,&SgAsmOperandList::p_operands>;
...
// postdeclarations for SgAsmOperandList

/* #line 527 "/workspace/generated/src/frontend/SageIII//SgAsmOperandList.h" */
...
/* #line 534 "/workspace/generated/src/frontend/SageIII//SgAsmOperandList.h" */

#endif // ROSE_SgAsmOperandList_H
