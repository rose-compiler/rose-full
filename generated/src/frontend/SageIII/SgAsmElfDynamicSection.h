...
#ifndef ROSE_SgAsmElfDynamicSection_H
#define ROSE_SgAsmElfDynamicSection_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmElfDynamicSection

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmElfDynamicSection.h" */
/* #line 23513 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// Class Definition for SgAsmElfDynamicSection
class ROSE_DLL_API SgAsmElfDynamicSection  : public SgAsmElfSection
   {
     public:


/* #line 46 "/workspace/generated/src/frontend/SageIII//SgAsmElfDynamicSection.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 23533 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmElfDynamicSection;
          enum { static_variant = V_SgAsmElfDynamicSection };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmElfDynamicSection* isSgAsmElfDynamicSection(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmElfDynamicSection* isSgAsmElfDynamicSection( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmElfDynamicSection * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmElfDynamicSectionStorageClass *); // 
          ...
          /// \private
          static SgAsmElfDynamicSection * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmElfDynamicSection * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmElfDynamicSection::operator delete (pointer,sizeof(SgAsmElfDynamicSection));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmElfDynamicSection* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmElfDynamicSection* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmElfDynamicSection* sgnode);
     ...
     public:
       ...
       */
       // SgAsmElfDynamicSection( SgAsmElfDynamicSectionStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmElfDynamicSectionStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmElfDynamicSection( const SgAsmElfDynamicSectionStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmElfDynamicSection* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmElfDynamicSection* isSgAsmElfDynamicSection ( SgNode* s );
...
// End of memberFunctionString
    ...
    protected:
// Start of memberFunctionString
SgAsmElfDynamicEntryList* p_entries;
          
// End of memberFunctionString

    friend struct Rose::Traits::generated::describe_node_t<SgAsmElfDynamicSection>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmElfDynamicSection, SgAsmElfDynamicEntryList*,&SgAsmElfDynamicSection::p_entries>;
...
// postdeclarations for SgAsmElfDynamicSection

/* #line 552 "/workspace/generated/src/frontend/SageIII//SgAsmElfDynamicSection.h" */
...
/* #line 559 "/workspace/generated/src/frontend/SageIII//SgAsmElfDynamicSection.h" */

#endif // ROSE_SgAsmElfDynamicSection_H
