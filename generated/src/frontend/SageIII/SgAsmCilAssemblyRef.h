...
#ifndef ROSE_SgAsmCilAssemblyRef_H
#define ROSE_SgAsmCilAssemblyRef_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmCilAssemblyRef

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmCilAssemblyRef.h" */
...
// Class Definition for SgAsmCilAssemblyRef
class ROSE_DLL_API SgAsmCilAssemblyRef  : public SgAsmCilMetadata
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmCilAssemblyRef.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 41164 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmCilAssemblyRef;
          enum { static_variant = V_SgAsmCilAssemblyRef };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmCilAssemblyRef* isSgAsmCilAssemblyRef(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmCilAssemblyRef* isSgAsmCilAssemblyRef( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmCilAssemblyRef * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmCilAssemblyRefStorageClass *); // 
          ...
          /// \private
          static SgAsmCilAssemblyRef * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmCilAssemblyRef * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmCilAssemblyRef::operator delete (pointer,sizeof(SgAsmCilAssemblyRef));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmCilAssemblyRef* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmCilAssemblyRef* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmCilAssemblyRef* sgnode);
     ...
     public:
       ...
       */
       // SgAsmCilAssemblyRef( SgAsmCilAssemblyRefStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmCilAssemblyRefStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmCilAssemblyRef( const SgAsmCilAssemblyRefStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmCilAssemblyRef* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmCilAssemblyRef* isSgAsmCilAssemblyRef ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmCilAssemblyRef>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilAssemblyRef, uint16_t,&SgAsmCilAssemblyRef::p_MajorVersion>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilAssemblyRef, uint16_t,&SgAsmCilAssemblyRef::p_MinorVersion>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilAssemblyRef, uint16_t,&SgAsmCilAssemblyRef::p_BuildNumber>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilAssemblyRef, uint16_t,&SgAsmCilAssemblyRef::p_RevisionNumber>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilAssemblyRef, uint32_t,&SgAsmCilAssemblyRef::p_Flags>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilAssemblyRef, uint32_t,&SgAsmCilAssemblyRef::p_PublicKeyOrToken>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilAssemblyRef, uint32_t,&SgAsmCilAssemblyRef::p_Name>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilAssemblyRef, uint32_t,&SgAsmCilAssemblyRef::p_Culture>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilAssemblyRef, uint32_t,&SgAsmCilAssemblyRef::p_HashValue>;
...
// postdeclarations for SgAsmCilAssemblyRef

/* #line 657 "/workspace/generated/src/frontend/SageIII//SgAsmCilAssemblyRef.h" */
...
/* #line 664 "/workspace/generated/src/frontend/SageIII//SgAsmCilAssemblyRef.h" */

#endif // ROSE_SgAsmCilAssemblyRef_H
