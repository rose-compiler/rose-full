...
#ifndef ROSE_SgAsmJvmNode_H
#define ROSE_SgAsmJvmNode_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmJvmNode

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmJvmNode.h" */
...
// Class Definition for SgAsmJvmNode
class ROSE_DLL_API SgAsmJvmNode  : public SgAsmNode
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmJvmNode.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 14838 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmJvmNode;
          enum { static_variant = V_SgAsmJvmNode };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmJvmNode* isSgAsmJvmNode(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmJvmNode* isSgAsmJvmNode( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmJvmNode * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmJvmNodeStorageClass *); // 
          ...
          /// \private
          static SgAsmJvmNode * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmJvmNode * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmJvmNode::operator delete (pointer,sizeof(SgAsmJvmNode));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmJvmNode* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmJvmNode* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmJvmNode* sgnode);
     ...
     public:
       ...
       */
       // SgAsmJvmNode( SgAsmJvmNodeStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmJvmNodeStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmJvmNode( const SgAsmJvmNodeStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmJvmNode* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmJvmNode* isSgAsmJvmNode ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmJvmNode>;
...
// postdeclarations for SgAsmJvmNode

/* #line 501 "/workspace/generated/src/frontend/SageIII//SgAsmJvmNode.h" */
...
/* #line 508 "/workspace/generated/src/frontend/SageIII//SgAsmJvmNode.h" */

#endif // ROSE_SgAsmJvmNode_H
