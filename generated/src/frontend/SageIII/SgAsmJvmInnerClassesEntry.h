...
#ifndef ROSE_SgAsmJvmInnerClassesEntry_H
#define ROSE_SgAsmJvmInnerClassesEntry_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmJvmInnerClassesEntry

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmJvmInnerClassesEntry.h" */
...
// Class Definition for SgAsmJvmInnerClassesEntry
class ROSE_DLL_API SgAsmJvmInnerClassesEntry  : public SgAsmJvmNode
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmJvmInnerClassesEntry.h" */

          virtual SgNode* copy ( SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 11709 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmJvmInnerClassesEntry;
          enum { static_variant = V_SgAsmJvmInnerClassesEntry };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmJvmInnerClassesEntry* isSgAsmJvmInnerClassesEntry(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmJvmInnerClassesEntry* isSgAsmJvmInnerClassesEntry( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmJvmInnerClassesEntry * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmJvmInnerClassesEntryStorageClass *); // 
          ...
          /// \private
          static SgAsmJvmInnerClassesEntry * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmJvmInnerClassesEntry * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmJvmInnerClassesEntry::operator delete (pointer,sizeof(SgAsmJvmInnerClassesEntry));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmJvmInnerClassesEntry* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmJvmInnerClassesEntry* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmJvmInnerClassesEntry* sgnode);
     ...
     public:
       ...
       */
       // SgAsmJvmInnerClassesEntry( SgAsmJvmInnerClassesEntryStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmJvmInnerClassesEntryStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmJvmInnerClassesEntry( const SgAsmJvmInnerClassesEntryStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmJvmInnerClassesEntry* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 670 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmJvmInnerClassesEntry* isSgAsmJvmInnerClassesEntry ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmJvmInnerClassesEntry>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmJvmInnerClassesEntry, uint16_t,&SgAsmJvmInnerClassesEntry::p_inner_class_info_index>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmJvmInnerClassesEntry, uint16_t,&SgAsmJvmInnerClassesEntry::p_outer_class_info_index>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmJvmInnerClassesEntry, uint16_t,&SgAsmJvmInnerClassesEntry::p_inner_name_index>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmJvmInnerClassesEntry, uint16_t,&SgAsmJvmInnerClassesEntry::p_inner_class_access_flags>;
...
// postdeclarations for SgAsmJvmInnerClassesEntry

/* #line 582 "/workspace/generated/src/frontend/SageIII//SgAsmJvmInnerClassesEntry.h" */
...
/* #line 589 "/workspace/generated/src/frontend/SageIII//SgAsmJvmInnerClassesEntry.h" */

#endif // ROSE_SgAsmJvmInnerClassesEntry_H
