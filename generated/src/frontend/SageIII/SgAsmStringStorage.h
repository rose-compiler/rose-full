...
#ifndef ROSE_SgAsmStringStorage_H
#define ROSE_SgAsmStringStorage_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmStringStorage

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmStringStorage.h" */
/* #line 1203 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// Class Definition for SgAsmStringStorage
class ROSE_DLL_API SgAsmStringStorage  : public SgAsmExecutableFileFormat
   {
     public:


/* #line 42 "/workspace/generated/src/frontend/SageIII//SgAsmStringStorage.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 1231 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmStringStorage;
          enum { static_variant = V_SgAsmStringStorage };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmStringStorage* isSgAsmStringStorage(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmStringStorage* isSgAsmStringStorage( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmStringStorage * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmStringStorageStorageClass *); // 
          ...
          /// \private
          static SgAsmStringStorage * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmStringStorage * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmStringStorage::operator delete (pointer,sizeof(SgAsmStringStorage));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmStringStorage* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmStringStorage* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmStringStorage* sgnode);
     ...
     public:
       ...
       */
       // SgAsmStringStorage( SgAsmStringStorageStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmStringStorageStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmStringStorage( const SgAsmStringStorageStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmStringStorage* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmStringStorage* isSgAsmStringStorage ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmStringStorage>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmStringStorage, SgAsmGenericStrtab*,&SgAsmStringStorage::p_strtab>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmStringStorage, std::string,&SgAsmStringStorage::p_string>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmStringStorage, Rose::BinaryAnalysis::Address,&SgAsmStringStorage::p_offset>;
...
// postdeclarations for SgAsmStringStorage

/* #line 557 "/workspace/generated/src/frontend/SageIII//SgAsmStringStorage.h" */
...
/* #line 564 "/workspace/generated/src/frontend/SageIII//SgAsmStringStorage.h" */

#endif // ROSE_SgAsmStringStorage_H
