...
#ifndef ROSE_SgAsmPEExportEntryList_H
#define ROSE_SgAsmPEExportEntryList_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmPEExportEntryList

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmPEExportEntryList.h" */
/* #line 4888 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// Class Definition for SgAsmPEExportEntryList
class ROSE_DLL_API SgAsmPEExportEntryList  : public SgAsmExecutableFileFormat
   {
     public:


/* #line 42 "/workspace/generated/src/frontend/SageIII//SgAsmPEExportEntryList.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 4907 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmPEExportEntryList;
          enum { static_variant = V_SgAsmPEExportEntryList };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmPEExportEntryList* isSgAsmPEExportEntryList(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmPEExportEntryList* isSgAsmPEExportEntryList( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmPEExportEntryList * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmPEExportEntryListStorageClass *); // 
          ...
          /// \private
          static SgAsmPEExportEntryList * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmPEExportEntryList * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmPEExportEntryList::operator delete (pointer,sizeof(SgAsmPEExportEntryList));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmPEExportEntryList* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmPEExportEntryList* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmPEExportEntryList* sgnode);
     ...
     public:
       ...
       */
       // SgAsmPEExportEntryList( SgAsmPEExportEntryListStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmPEExportEntryListStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmPEExportEntryList( const SgAsmPEExportEntryListStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmPEExportEntryList* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmPEExportEntryList* isSgAsmPEExportEntryList ( SgNode* s );
...
// End of memberFunctionString
    ...
    protected:
// Start of memberFunctionString
SgAsmPEExportEntryPtrList p_exports;
          
// End of memberFunctionString

    friend struct Rose::Traits::generated::describe_node_t<SgAsmPEExportEntryList>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmPEExportEntryList, SgAsmPEExportEntryPtrList,&SgAsmPEExportEntryList::p_exports>;
...
// postdeclarations for SgAsmPEExportEntryList

/* #line 516 "/workspace/generated/src/frontend/SageIII//SgAsmPEExportEntryList.h" */
...
/* #line 523 "/workspace/generated/src/frontend/SageIII//SgAsmPEExportEntryList.h" */

#endif // ROSE_SgAsmPEExportEntryList_H
