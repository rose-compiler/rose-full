...
#ifndef ROSE_SgAsmUnaryExpression_H
#define ROSE_SgAsmUnaryExpression_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmUnaryExpression

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmUnaryExpression.h" */
...
// Class Definition for SgAsmUnaryExpression
class ROSE_DLL_API SgAsmUnaryExpression  : public SgAsmExpression
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmUnaryExpression.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 963 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmUnaryExpression* isSgAsmUnaryExpression(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmUnaryExpression* isSgAsmUnaryExpression( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmUnaryExpression * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmUnaryExpressionStorageClass *); // 
          ...
          /// \private
          static SgAsmUnaryExpression * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmUnaryExpression * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmUnaryExpression::operator delete (pointer,sizeof(SgAsmUnaryExpression));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmUnaryExpression* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmUnaryExpression* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmUnaryExpression* sgnode);
     ...
     public:
       ...
       */
       // SgAsmUnaryExpression( SgAsmUnaryExpressionStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmUnaryExpressionStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmUnaryExpression( const SgAsmUnaryExpressionStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmUnaryExpression* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmUnaryExpression* isSgAsmUnaryExpression ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmUnaryExpression>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmUnaryExpression, SgAsmExpression*,&SgAsmUnaryExpression::p_operand>;
...
// postdeclarations for SgAsmUnaryExpression

/* #line 515 "/workspace/generated/src/frontend/SageIII//SgAsmUnaryExpression.h" */
...
/* #line 522 "/workspace/generated/src/frontend/SageIII//SgAsmUnaryExpression.h" */

#endif // ROSE_SgAsmUnaryExpression_H
