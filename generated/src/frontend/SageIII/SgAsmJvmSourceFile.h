...
#ifndef ROSE_SgAsmJvmSourceFile_H
#define ROSE_SgAsmJvmSourceFile_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmJvmSourceFile

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmJvmSourceFile.h" */
...
// Class Definition for SgAsmJvmSourceFile
class ROSE_DLL_API SgAsmJvmSourceFile  : public SgAsmJvmAttribute
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmJvmSourceFile.h" */

          virtual SgNode* copy ( SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 9904 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmJvmSourceFile;
          enum { static_variant = V_SgAsmJvmSourceFile };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmJvmSourceFile* isSgAsmJvmSourceFile(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmJvmSourceFile* isSgAsmJvmSourceFile( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmJvmSourceFile * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmJvmSourceFileStorageClass *); // 
          ...
          /// \private
          static SgAsmJvmSourceFile * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmJvmSourceFile * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmJvmSourceFile::operator delete (pointer,sizeof(SgAsmJvmSourceFile));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmJvmSourceFile* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmJvmSourceFile* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmJvmSourceFile* sgnode);
     ...
     public:
       ...
       */
       // SgAsmJvmSourceFile( SgAsmJvmSourceFileStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmJvmSourceFileStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmJvmSourceFile( const SgAsmJvmSourceFileStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmJvmSourceFile* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 670 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmJvmSourceFile* isSgAsmJvmSourceFile ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmJvmSourceFile>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmJvmSourceFile, uint16_t,&SgAsmJvmSourceFile::p_sourcefile_index>;
...
// postdeclarations for SgAsmJvmSourceFile

/* #line 526 "/workspace/generated/src/frontend/SageIII//SgAsmJvmSourceFile.h" */
...
/* #line 533 "/workspace/generated/src/frontend/SageIII//SgAsmJvmSourceFile.h" */

#endif // ROSE_SgAsmJvmSourceFile_H
