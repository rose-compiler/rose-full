...
#ifndef ROSE_SgAsmCilModuleRef_H
#define ROSE_SgAsmCilModuleRef_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmCilModuleRef

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmCilModuleRef.h" */
...
// Class Definition for SgAsmCilModuleRef
class ROSE_DLL_API SgAsmCilModuleRef  : public SgAsmCilMetadata
   {
     public:


/* #line 38 "/workspace/generated/src/frontend/SageIII//SgAsmCilModuleRef.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 34511 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmCilModuleRef;
          enum { static_variant = V_SgAsmCilModuleRef };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmCilModuleRef* isSgAsmCilModuleRef(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmCilModuleRef* isSgAsmCilModuleRef( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmCilModuleRef * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmCilModuleRefStorageClass *); // 
          ...
          /// \private
          static SgAsmCilModuleRef * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmCilModuleRef * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmCilModuleRef::operator delete (pointer,sizeof(SgAsmCilModuleRef));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmCilModuleRef* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmCilModuleRef* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmCilModuleRef* sgnode);
     ...
     public:
       ...
       */
       // SgAsmCilModuleRef( SgAsmCilModuleRefStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmCilModuleRefStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmCilModuleRef( const SgAsmCilModuleRefStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmCilModuleRef* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmCilModuleRef* isSgAsmCilModuleRef ( SgNode* s );
...
// End of memberFunctionString
    ...
    friend struct Rose::Traits::generated::describe_node_t<SgAsmCilModuleRef>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmCilModuleRef, uint32_t,&SgAsmCilModuleRef::p_Name>;
...
// postdeclarations for SgAsmCilModuleRef

/* #line 518 "/workspace/generated/src/frontend/SageIII//SgAsmCilModuleRef.h" */
...
/* #line 525 "/workspace/generated/src/frontend/SageIII//SgAsmCilModuleRef.h" */

#endif // ROSE_SgAsmCilModuleRef_H
