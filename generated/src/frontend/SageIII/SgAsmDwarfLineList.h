...
#ifndef ROSE_SgAsmDwarfLineList_H
#define ROSE_SgAsmDwarfLineList_H
#include <RoseFirst.h>
...
// predeclarations for SgAsmDwarfLineList

/* #line 25 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfLineList.h" */
/* #line 26614 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// Class Definition for SgAsmDwarfLineList
class ROSE_DLL_API SgAsmDwarfLineList  : public SgAsmDwarfInformation
   {
     public:


/* #line 42 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfLineList.h" */

    virtual SgNode* copy(SgCopyHelp& help) const override;
// Start of memberFunctionString
/* #line 26629 "/workspace/src/ROSETTA/src/binaryInstruction.C" */
...
// *** COMMON CODE SECTION BEGINS HERE ***
    ...
    public:
      ...
      /*! \brief static variant value */
       ...
       // static const VariantT static_variant = V_SgAsmDwarfLineList;
          enum { static_variant = V_SgAsmDwarfLineList };

       /* the generated cast function */
      /*! \brief Casts pointer from base class to derived class */
          ROSE_DLL_API friend       SgAsmDwarfLineList* isSgAsmDwarfLineList(       SgNode * s );

      /*! \brief Casts pointer from base class to derived class (for const pointers) */
          ROSE_DLL_API friend const SgAsmDwarfLineList* isSgAsmDwarfLineList( const SgNode * s );
     ...
     public:
          ...
          /// \private
          static SgAsmDwarfLineList * next_node; // 

          /// \private
          static unsigned long initializeStorageClassArray(SgAsmDwarfLineListStorageClass *); // 
          ...
          /// \private
          static SgAsmDwarfLineList * getPointerFromGlobalIndex(unsigned long); // 
          /// \private
          static SgAsmDwarfLineList * getPointerFromGlobalIndex(AstSpecificDataManagingClass *, unsigned long); // 
       ...
       // DQ (4/5/2007): This is not the correct operator that we want, but appears to be required to compile ROSE with ROSE.
          void operator delete (void* pointer)
            ...
            // This is the generated delete operator...
               SgAsmDwarfLineList::operator delete (pointer,sizeof(SgAsmDwarfLineList));
             }
	...
	/* NodeId support functions */
 	...
 	static SgNode* getNodeByNodeId(VariantT variantT, size_t poolIdx, size_t itemIdx);
       ...
       */
 	static SgAsmDwarfLineList* getNodeByNodeIdInternal(size_t poolIdx, size_t itemIdx);
      /*! \brief compute the NodeId for a particular SgNode*.
       */
 	static std::string getNodeIdString(SgAsmDwarfLineList* sgnode);
 	static std::string getNodeIdStringInternal(SgAsmDwarfLineList* sgnode);
     ...
     public:
       ...
       */
       // SgAsmDwarfLineList( SgAsmDwarfLineListStorageClass& source );
 ...
 // JH (10/24/2005): methods added to support the ast file IO
    private:
      ...
      /*! \brief friend class declaration to support AST File I/O */
          friend class SgAsmDwarfLineListStorageClass;
    ...
    public:
      /*! \brief IR node constructor to support AST File I/O */
          SgAsmDwarfLineList( const SgAsmDwarfLineListStorageClass& source );
 ...
 // private: // JJW hack
    ...
    public:
       ...
       */
          SgAsmDwarfLineList* addRegExpAttribute(std::string s, AstRegExAttribute* a);
...
/* #line 638 "/workspace/generated/src/ROSETTA/Grammar/Node.code" */
     ...
     // the generated cast function
     // friend ROSE_DLL_API SgAsmDwarfLineList* isSgAsmDwarfLineList ( SgNode* s );
...
// End of memberFunctionString
    ...
    protected:
// Start of memberFunctionString
SgAsmDwarfLinePtrList p_line_list;
          
// End of memberFunctionString

    friend struct Rose::Traits::generated::describe_node_t<SgAsmDwarfLineList>;
    friend struct Rose::Traits::generated::describe_field_t<SgAsmDwarfLineList, SgAsmDwarfLinePtrList,&SgAsmDwarfLineList::p_line_list>;
...
// postdeclarations for SgAsmDwarfLineList

/* #line 533 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfLineList.h" */
...
/* #line 540 "/workspace/generated/src/frontend/SageIII//SgAsmDwarfLineList.h" */

#endif // ROSE_SgAsmDwarfLineList_H
