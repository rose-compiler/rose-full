...
#define BACKEND_CXX_COMPILER_NAME_WITH_PATH "/opt/rh/gcc-toolset-13/root/usr/bin/g++"
#define BACKEND_CXX_COMPILER_NAME_WITHOUT_PATH "g++"
#define BACKEND_CXX_COMPILER_MAJOR_VERSION_NUMBER 13
#define BACKEND_CXX_COMPILER_MINOR_VERSION_NUMBER 3
#define BACKEND_CXX_COMPILER_PATCH_VERSION_NUMBER  
#define ROSE_BACKEND_CXX_COMPILER "g++"
/* BACKEND C */ 
#define BACKEND_C_COMPILER_NAME_WITH_PATH "/opt/rh/gcc-toolset-13/root/usr/bin/gcc" 
#define BACKEND_C_COMPILER_NAME_WITHOUT_PATH "gcc"
#define BACKEND_C_COMPILER_MAJOR_VERSION_NUMBER 13
#define BACKEND_C_COMPILER_MINOR_VERSION_NUMBER 3 
...
#define CXX_INCLUDE_STRING {"g++_HEADERS" , "g++_HEADERS/compiler_macro_hdrs", "g++_HEADERS/hdrs", "g++_HEADERS/hdrs1", "g++_HEADERS/hdrs2", "/opt/rh/gcc-toolset-13/root/usr/lib/gcc/x86_64-redhat-linux/13/../../../../include/c++/13", "/opt/rh/gcc-toolset-13/root/usr/lib/gcc/x86_64-redhat-linux/13/../../../../include/c++/13/x86_64-redhat-linux", "/opt/rh/gcc-toolset-13/root/usr/lib/gcc/x86_64-redhat-linux/13/../../../../include/c++/13/backward", "/opt/rh/gcc-toolset-13/root/usr/lib/gcc/x86_64-redhat-linux/13/include", "/usr/local/include", "/usr/include"}

/* Include path for backend C compiler. */
#define C_INCLUDE_STRING {"gcc_HEADERS" , "gcc_HEADERS/compiler_macro_hdrs", "gcc_HEADERS/hdrs", "/opt/rh/gcc-toolset-13/root/usr/lib/gcc/x86_64-redhat-linux/13/include", "/usr/local/include", "/usr/include"}
...
#define CXX_SPEC_DEF {"-D__GNUG__=13", "-D__GNUC__=13", "-D__GNUC_MINOR__=3", "-D__GNUC_PATCHLEVEL__=1", "--preinclude", "rose_edg_required_macros_and_functions.h"}
...
#define BACKEND_C_COMPILER_SUPPORTS_UNDESCORE_ASM
